...
**Sample coverage (by URL type):** `articles` 22/432 · `bands` 22/48 · `drummer` 22/621 · `guides` 21/354 · `licks` 21/295 · `lists` 21/98 · `other` 21/1332

> ⚠️ Cap reached — not every URL was scanned this run: `other` 1311 skipped, `guides` 333 skipped, `lists` 77 skipped, `articles` 410 skipped, `drummer` 599 skipped, `bands` 26 skipped, `licks` 274 skipped.
