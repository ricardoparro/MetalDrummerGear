...
**Generated:** 2026-07-13T11:02:37.451Z
**Sitemap URLs total:** 6052 · **Sampled this run:** 150 (cap 150)
**Compared against:** 2026-07-06.json

**150 URLs scanned · 150 clean · 0 with issues · WoW: +0 new, −0 fixed**

**Counts:** `ok`=150

**Sample coverage (by URL type):** `articles` 22/432 · `bands` 19/19 · `drummer` 22/524 · `guides` 22/349 · `licks` 22/290 · `lists` 22/98 · `other` 21/2912

> ⚠️ Cap reached — not every URL was scanned this run: `other` 2891 skipped, `guides` 327 skipped, `lists` 76 skipped, `articles` 410 skipped, `drummer` 502 skipped, `licks` 268 skipped.
