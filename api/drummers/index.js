...
const drummers = [
  ...
  },
  {
    ...
    kitOverview: 'Matt Garstka\'s drum kit is a DW Collector\'s Series custom shop build — Garstka switched to DW in September 2021 after previously playing Tama and, before that, Pearl, mixing Collector\'s Series shell and wood-species configurations chosen for the warm low end and crisp attack his polyrhythmic, jazz-fusion-infused metal requires. The Matt Garstka drum set centers on a DW Collector\'s Series Purpleheart snare, delivering the articulate crack that cuts through dense odd-meter passages.\n\nMeinl Byzance Series cymbals complete the Matt Garstka drum kit: 15" Dual Hi-Hats for nuanced, washy articulation; 18" and 20" Extra Dry Medium Crashes for quick-decaying accents; and a 22" Dual Ride for complex rhythmic definition. Garstka has driven his double bass patterns with a Tama Speed Cobra 910 double pedal, though his current pedal brand following the DW switch is unconfirmed. Vic Firth Matt Garstka Signature sticks and Evans heads complete a drum set built for the technical demands of instrumental progressive metal. For the full gear breakdown, see [what\'s in Matt Garstka\'s kit](/articles/whats-in-matt-garstkas-kit), the [Mike Mangini vs. Matt Garstka technique comparison](/vs/mike-mangini-vs-matt-garstka), and the [complete cymbal setup](/drummer/matt-garstka/cymbals).',
    sameAs: [
    ...
    gear: {
      ...
      hardware: 'Tama Speed Cobra 910 Double Pedal (pre-dates Sept 2021 DW switch; current pedal brand unverified)',
      sticks: 'Vic Firth Matt Garstka Signature',
      heads: 'Evans',
      verified: true,
      sources: ['https://en.wikipedia.org/wiki/Matt_Garstka', 'https://meinlcymbals.com/en/artists', 'https://www.moderndrummer.com/2021/09/matt-garstka-joins-dw/', 'https://www.musicradar.com/news/animals-as-leaders-matt-garstka-switches-to-playing-dw-drums', 'https://ggd.co/products/matt-garstka-signature-drums']
    },
    photos: [
