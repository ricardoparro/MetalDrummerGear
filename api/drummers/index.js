...
const drummers = [
  ...
  },
  {
    ...
    kitOverview: 'Abe Cunningham plays a Tama Starclassic Bubinga drum kit in the Egyptian Night Mist finish with Zildjian A Custom and K Custom cymbals — his official Tama endorsement that has anchored the Deftones\' atmospheric alt-metal sound across Koi No Yokan, Gore, and Ohms. The Abe Cunningham drum kit is rounded out by a matching Tama Starclassic snare, chosen for the warm, cutting crack that projects through Deftones\' layered guitar textures without overwhelming the band\'s dynamic range. A Tama Iron Cobra Power Glide Twin Pedal (HP900PTW) and Iron Cobra Lever Glide Hi-Hat (HH905) anchor the drum set.\n\nZildjian cymbals define the Abe Cunningham drum kit\'s sonic character: the A Custom / K Custom combination pairs bright projection with warmer, complex overtones suited to Deftones\' shifts between crushing and delicate passages. Pro-Mark sticks and Remo drumheads (Powerstroke P3, Pinstripe, Ambassador) complete the rig. For the full gear breakdown, see the [White Pony drum setup](/articles/white-pony-drum-setup).',
    sameAs: [
