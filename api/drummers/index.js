...
const drummers = [
  ...
  },
  {
    ...
    kitOverview: 'Vinnie Paul was a ddrum-endorsed drummer, confirmed on ddrum\'s own current artist page. As the rhythmic backbone alongside his brother Dimebag Darrell, Vinnie Paul built one of the most powerful drum sets in heavy metal history, defined by massive grooves, thunderous authority, and relentless double bass precision.\n\nThe cornerstone of the Vinnie Paul drum kit was his ddrum Vinnie Paul Signature snare drum — a deep 14×8" 8-ply maple model with 10 lugs and die-cast hoops, confirmed on ddrum\'s official product page, engineered for maximum projection and crack that cut through Pantera\'s wall of distorted guitars on Cowboys from Hell, Vulgar Display of Power, and Far Beyond Driven. Beyond the snare, ddrum\'s page does not specify a full shell-pack model, and no Sabian artist listing or press release names his specific cymbal setup — the drum-kit series, cymbal models, pedal/throne models, and stick model should be read as brand-level facts only, not confirmed against a source naming exact products.',
    sameAs: [
  ...
  },
  {
    ...
    kitOverview: 'Mike Portnoy plays a dual Tama Starclassic drum kit — a side-by-side "Dream Monster" configuration combining Starclassic Maple and Starclassic Bubinga shells, confirmed on Tama\'s own current artist page. The defining component of the Mike Portnoy drum set is his Tama Melody Master signature snare (14×5.5"): a steel shell tuned for a punchy, cutting crack that sits clearly in Dream Theater\'s densely layered arrangements.\n\nSabian HHX MAX and AAX MAXX cymbals complete the Mike Portnoy drum kit, per Sabian\'s current official artist listing: a 22" HHX MAX Ride, 18" AAX X-Plosion and 19" HHX X-Plosion Crashes, an 18" AAX O-Zone Crash, 18" HHX and 19" Paragon Chinas, 7"/9"/11" AAX MAXX Splashes, and 6"/6.5"/7" AA MAX Chimes. A Tama Iron Cobra Power Glide Twin Pedal (HP900PSW) drives his demanding double-bass lines.\n\nThe Mike Portnoy drum set configuration has served across Dream Theater (1985–2010, 2023–present), The Winery Dogs, Sons of Apollo, Transatlantic, and Liquid Tension Experiment — each demanding adaptability from the same core rig. His Promark Mike Portnoy Signature TX420N drumsticks are heavier than average, chosen for the power progressive metal\'s complex, high-tempo compositions require.',
    sameAs: [
  ...
  },
  {
    ...
    gear: {
      ...
      verifiedAt: '2026-08-08',
      sources: [
        'https://www.sonor.com/drums/artists/artists-detail/danny-carey',
        'https://www.paiste.com/en/musicians/danny-carey'
      ]
    },
    photos: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'For Fear Inoculum (2019), Danny Carey used a Sonor SQ2 Heavy Beech kit in an expanded configuration with 14" Sound Edge Hi-Hats, 18" & 20" Power Crashes, 22" Dry Heavy Ride, 20" & 22" China cymbals, and an expanded Mandala Drum electronic pad rig. The larger cymbal spread and deeper electronics created the cinematic, ambient textures on tracks like "Pneuma" and "Culling Voices".'
      },
      {
  ...
  },
  {
    ...
    endorsements: [
      { name: 'British Drum Co.', url: 'https://www.britishdrumco.com/artists/nicko-mcbrain' },
      { name: 'Paiste Cymbals', url: 'https://www.paiste.com' },
      { name: 'Vic Firth Sticks', url: 'https://vicfirth.zildjian.com' },
      { name: 'Remo Drumheads', url: 'https://remo.com' }
    ],
  ...
  },
  {
    ...
    kitOverview: 'Mikkey Dee plays a Sonor SQ2 drum kit — a fully custom-build German platform he moved to for Scorpions, having been part of the Sonor artist family since the early 1980s. At the center of the Mikkey Dee drum set is his own Sonor Mikkey Dee Signature 14x7.25" birch snare, released by Sonor in 2012 and voiced to cut through Lemmy Kilmister\'s wall of bass on anthems like "Ace of Spades" without ever sounding thin live. (Mikkey Dee was historically cited here on a Yamaha kit and Zildjian cymbals; Sonor\'s and Paiste\'s own current artist pages, plus a dated Modern Drummer gear feature, confirm the Sonor/Paiste setup below is what he currently plays.)\n\nPaiste Signature cymbals — an endorsement Dee has held since April 1987 — round out the Mikkey Dee drum kit: 14" Sound Edge Hi-Hats for tight, driving eighth-note patterns; 18" and 20" Power Crashes for the big accents his hard-rock phrasing demands; a 22" Power Ride for steady time-keeping through extended Scorpions sets; and an 18" Heavy China for explosive crash-china flourishes. Sonor hardware anchors the kit (the specific pedal model is unconfirmed), while Wincent\'s Mikkey Dee signature sticks — sized for maximum impact — and Remo heads complete a setup engineered purely for hard-hitting, high-volume rock drumming.',
    sameAs: [
    ...
    gear: {
      ...
      cymbals: 'Paiste Signature Series (14" Sound Edge Hi-Hats, 18" & 20" Power Crashes, 22" Power Ride, 18" Heavy China)',
      hardware: 'Sonor Hardware (specific pedal model unconfirmed)',
      sticks: 'Wincent Mikkey Dee Signature (W-MDS)',
      heads: 'Remo',
      verified: true,
      verifiedAt: '2026-08-10',
      notes: 'Drums (Sonor), snare, and cymbals (Paiste) corrected from a stale Yamaha/Zildjian citation — the prior Zildjian source URL was a copy-paste of another drummer\'s artist-page slug and 404s for Mikkey Dee. Pedal/hardware model not independently confirmed — omitted rather than guessed.',
    ...
    endorsements: [
      { name: 'Sonor Drums', url: 'https://www.sonor.com' },
      { name: 'Paiste Cymbals', url: 'https://www.paiste.com' },
      { name: 'Wincent Sticks', url: 'https://wincentdrumsticks.com' },
      { name: 'Remo Drumheads', url: 'https://remo.com' }
    ],
    videos: [
  ...
  },
  {
    ...
    gear: {
      ...
      cymbals: 'Meinl Byzance Brilliant & Classics Custom Dark Series (14" Byzance Brilliant Hi-Hats, 19", 20" & 21" Classics Custom Dark Crashes, 22" Byzance Brilliant Ride, 18" Byzance Brilliant China)',
      hardware: 'Tama Speed Cobra 910 Double Pedal, Tama Iron Cobra Hi-Hat Stand',
      sticks: 'Tama O-DVM2 Dirk Verbeuren Signature',
      heads: 'Evans',
      verified: true,
      verifiedAt: '2026-08-10',
      notes: 'Cymbal brand corrected from a stale Zildjian citation (dead zildjian.com/artists hub) to Meinl, confirmed via Meinl\'s own current artist page plus a dated Modern Drummer (Oct 2024) gear feature and Blabbermouth reporting. Drums/snare unchanged — not part of this pass.',
  ...
  },
  {
    ...
    kitOverview: 'Frost plays a Tama Starclassic Bubinga drum kit in Piano Black finish — confirmed on Tama\'s own current artist roster, which profiles him with dense, bass-heavy shells suited to the extreme blast beat tempos that define Satyricon\'s Nordic black metal sound. As Satyricon\'s drummer since 1993 and a founding member of 1349 since 2001, Frost has built one of black metal\'s most distinctive drum sets around a Tama Starclassic Bubinga 14x5.5" snare that delivers the dry, cutting crack heard on albums like Nemesis Divina, Volcano, and Now, Diabolical. (Frost was historically cited as a Sonor artist, but Sonor\'s current artist roster no longer lists him, while Tama\'s own artist page profiles his kit in detail — the drum brand claim has been updated accordingly.)\n\nZildjian cymbals round out the tonal character of the Frost drum kit, though the specific series and sizes are not confirmed by a live official source this run — Zildjian\'s current artist pages return a 404 for Frost, so only the brand is asserted here. A Tama Iron Cobra Power Glide pedal and Iron Cobra Lever Glide hi-hat stand drive Frost\'s precise, powerful kick drum work. Vic Firth American Classic Extreme 5B sticks and Remo drumheads complete the Frost drum set — a configuration built for the sustained physical demands of Satyricon and 1349\'s uncompromising live performances.',
    sameAs: [
    ...
    gear: {
      ...
      cymbals: 'Zildjian (specific series/models unconfirmed)',
      ...
      verified: true,
      verifiedAt: '2026-08-10',
      notes: 'Drums/snare/hardware confirmed via Tama\'s current official artist page (replaces a stale Sonor citation that no longer lists Frost). Cymbal brand (Zildjian) is corroborated by secondary sources but no live official Zildjian artist page exists for Frost as of this run — specific series/model claims omitted rather than guessed.',
      sources: ['https://www.tama.com/usa/artists/detail/945.html']
    },
    photos: [
