// Vercel Serverless Function - Get gear by slug

// Import drummers data to get the list of who uses each gear
const drummers = [
  { id: 1, name: 'Lars Ulrich', band: 'Metallica', image: 'https://upload.wikimedia.org/wikipedia/commons/7/79/Lars_Ulrich_by_Gage_Skidmore_%28cropped%29.jpg' },
  { id: 2, name: 'Joey Jordison', band: 'Slipknot', image: 'https://upload.wikimedia.org/wikipedia/commons/b/b4/JoeyJordison.jpg' },
  { id: 3, name: 'Gene Hoglan', band: 'Death / Testament / Dethklok', image: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Gene_Hoglan_-_Testament_%28cropped%29.jpg' },
  { id: 4, name: 'Dave Lombardo', band: 'Slayer', image: 'https://upload.wikimedia.org/wikipedia/commons/d/df/Dave_Lombardo_8.5.14.jpeg' },
  { id: 5, name: 'Tomas Haake', band: 'Meshuggah', image: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Meshuggah_-_Rock_am_Ring_2023-44313.jpg' },
  { id: 6, name: 'George Kollias', band: 'Nile', image: 'https://upload.wikimedia.org/wikipedia/commons/e/e8/GK_10.jpg' },
  { id: 7, name: 'Eloy Casagrande', band: 'Sepultura / Slipknot', image: 'https://upload.wikimedia.org/wikipedia/commons/8/86/Sepultura_-_2023219214143_2023-08-07_Sepultura_-_Sven_-_1D_X_MK_II_-_0650_-_AK8I2527.jpg' },
  { id: 8, name: 'Ray Luzier', band: 'Korn', image: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Ray_Luzier_of_Korn.jpg' },
  { id: 9, name: 'John Otto', band: 'Limp Bizkit', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0a/Drummer_John_Otto_of_Limp_Bizkit_in_2006.jpg' },
  { id: 10, name: 'Jay Weinberg', band: 'Slipknot / Suicidal Tendencies', image: 'https://upload.wikimedia.org/wikipedia/commons/4/46/Suicidal_Tendencies_Rockharz_2024_18.jpg' },
  { id: 11, name: 'Vinnie Paul', band: 'Pantera / Damageplan / Hellyeah', image: 'https://upload.wikimedia.org/wikipedia/commons/5/55/VinniePaul2008.JPG' },
  { id: 12, name: 'Charlie Benante', band: 'Anthrax / S.O.D. / Pantera', image: 'https://upload.wikimedia.org/wikipedia/commons/1/11/2017_Anthrax_-_Charlie_Benante_-_by_2eight_-_DSC1986_%28cropped%29.jpg' },
  { id: 13, name: 'Mike Portnoy', band: 'Dream Theater', image: 'https://upload.wikimedia.org/wikipedia/commons/7/77/Mike_Portnoy.jpg' },
  { id: 14, name: 'Danny Carey', band: 'Tool', image: 'https://upload.wikimedia.org/wikipedia/commons/c/c1/Danny_Carey_Hellfest_2019.jpg' },
  { id: 15, name: 'Mario Duplantier', band: 'Gojira', image: 'https://upload.wikimedia.org/wikipedia/commons/8/83/2017_RiP_-_Gojira_-_Mario_Duplantier_-_by_2eight_-_8SC9168.jpg' },
  { id: 16, name: 'Brann Dailor', band: 'Mastodon', image: 'https://upload.wikimedia.org/wikipedia/commons/6/6b/20150612-054-Nova_Rock_2015-Mastodon-Brann_Dailor.jpg' },
  { id: 17, name: 'Chris Adler', band: 'Lamb of God', image: 'https://upload.wikimedia.org/wikipedia/commons/d/d8/Lamb_Of_God_-_Rock_am_Ring_2015-9876_%28cropped%29.jpg' },
  { id: 18, name: 'Matt Halpern', band: 'Periphery', image: 'https://upload.wikimedia.org/wikipedia/commons/2/26/20151122_Eindhoven_Epic_Metal_Fest_Periphery_0116.jpg' },
  { id: 19, name: 'Inferno', band: 'Behemoth', image: 'https://upload.wikimedia.org/wikipedia/commons/8/8d/Behemoth_Rockharz_2015_02.jpg' },
  { id: 20, name: 'Hellhammer', band: 'Mayhem', image: 'https://upload.wikimedia.org/wikipedia/commons/5/58/Mayhem_-_Jalometalli_2008_-_Hellhammer_01_crop.JPG' },
  { id: 21, name: 'Pete Sandoval', band: 'Morbid Angel', image: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Pete_Sandoval.jpg' }
];
