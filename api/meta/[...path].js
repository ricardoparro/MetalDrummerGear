          ...
          '@graph': [
            {
              ...
              inLanguage: 'en-US',
              ...(top10Article.seoKeywords && top10Article.seoKeywords.length > 0 ? { keywords: top10Article.seoKeywords.join(', ') } : {}),
              datePublished: top10ArticleDatePublished,
              dateModified: top10ArticleDateModified,
              author: {
                '@type': 'Organization',
          ...
          '@graph': [
            {
              ...
              inLanguage: 'en-US',
              ...(list.seoKeywords && list.seoKeywords.length > 0 ? { keywords: list.seoKeywords.join(', ') } : {}),
              datePublished: listDatePublished,
              dateModified: listDateModified,
              author: {
                '@type': 'Organization',
