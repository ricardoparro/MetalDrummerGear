...
// BRAND_DATA (brands.js) keys further down this file, the source of truth for
// which gear-brand slugs actually resolve to a live page.
...
export function getMetaForPath(pathname) {
  ...
  const BRAND_TYPE_BEST_FOR_METAL = {
    // Issue #4887: brands.js uses type: "sticks" (not "drumsticks") for its
    // 5 stick brands — key must match that value or the link silently drops.
    sticks: { href: '/drumsticks/best-for-metal', label: 'Best Drumsticks for Metal' },
      ...
      return {
        ...
        articleSchema: JSON.stringify({
          ...
          '@graph': [
            ...
            {
              '@type': 'FAQPage',
              // Issue #4887: real curated FAQ from brands.js, not generic boilerplate.
