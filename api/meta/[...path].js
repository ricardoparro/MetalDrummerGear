      ...
      articleSchema: JSON.stringify({
        ...
        itemListElement: songs.map((s, i) => ({
          ...
          item: {
            ...
            url: songPageSlugs.has(s.slug) ? `${BASE_URL}/songs/${s.slug}` : `${BASE_URL}/songs/fastest-metal-songs#${s.slug}`,
          },
        })),
      }),
      breadcrumbSchema: [
        ...
        articleSchema: JSON.stringify({
          ...
          itemListElement: tier.songs.map((s, i) => ({
            ...
            item: {
              ...
              name: s.song,
              byArtist: { '@type': 'MusicGroup', name: s.band },
              url: songPageSlugs.has(s.slug) ? `${BASE_URL}/songs/${s.slug}` : `${BASE_URL}/songs/tempo/${tier.slug}#${s.slug}`,
            },
          })),
        }),
        breadcrumbSchema: [
        ...
        articleSchema: JSON.stringify({
          ...
          itemListElement: songs.map((s, i) => ({
            ...
            item: {
              ...
              name: s.song,
              byArtist: { '@type': 'MusicGroup', name: s.band },
              url: songPageSlugs.has(s.slug) ? `${BASE_URL}/songs/${s.slug}` : `${BASE_URL}/songs/drummer/${drummerSlug}#${s.slug}`,
            },
          })),
        }),
        breadcrumbSchema: [
