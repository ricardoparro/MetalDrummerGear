...
export function buildSitemapXml() {
  const urls = [
    ...
    // Issue #4578: /snares/signature/<drummer> LLM citation surface — one
    // file per SIGNATURE_SNARES entry (generated by
    // scripts/generate-llms-snares-signature.cjs), matching the
    // /cymbals/setups (#4518) and /pedals/setups (#4497) precedent.
