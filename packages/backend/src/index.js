...
const drummers = [
  ...
  },
  {
    ...
    kitOverview: 'Joey Jordison played a Pearl Masters Premium Maple drum kit — the setup that powered Slipknot\'s most devastating live performances and studio recordings. As one of Pearl\'s most celebrated endorsers, Jordison built a drum set engineered for extreme speed, precision, and durability through years of intense worldwide touring.\n\nThe crown jewel of the Joey Jordison drum kit was his Pearl Joey Jordison Signature snare drum — an unusually compact 13"×6.5" model chosen specifically for its faster response compared to the standard 14" snare. This smaller diameter allowed Jordison to achieve his trademark machine-gun fills and rapid-fire patterns at tempos exceeding 280 BPM. The Joey Jordison drum set was completed with Paiste RUDE Series cymbals throughout: 14" hi-hats, 18" and 19" crashes, 20" Chinas, and a 22" Power Ride — chosen for their extreme durability and aggressive cut during Slipknot\'s wall-of-sound performances. Pearl Demon Drive double bass pedals powered the relentless double kick patterns that defined Slipknot\'s most brutal tracks. Promark Joey Jordison Signature TX515W sticks completed the rig.',
    faq: [
      { q: 'What drum set did Joey Jordison use?', a: 'Joey Jordison used a Pearl Masters Premium Maple drum set throughout his Slipknot career. The kit was built around his signature Pearl Joey Jordison 13"×6.5" snare — smaller than the standard 14" for faster machine-gun fills — and powered by Pearl Demon Drive double bass pedals. He paired the drum set with Paiste RUDE Series cymbals for their extreme durability and aggressive cut on stage.' },
      { q: 'What drum kit did Joey Jordison use?', a: 'Joey Jordison\'s drum kit was a Pearl Masters Premium Maple configuration, the setup Slipknot fans worldwide associate with his iconic masked performances. The drum kit featured his signature 13"×6.5" Pearl Joey Jordison snare drum, Paiste RUDE Series cymbals (14" hi-hats, 18" & 19" crashes, 20" Chinas, 22" Power Ride), and Pearl Demon Drive double bass pedals — the combination that defined Slipknot\'s crushing live sound across Iowa, Vol. 3, and All Hope Is Gone.' }
    ],
    photos: [
  ...
  },
  {
    ...
    kitOverview: 'Eloy Casagrande plays a Tama Starclassic Bubinga drum kit — a massive, dual-bass-drum configuration built for the extreme dynamics of both his 13 years with Sepultura and his current role as Slipknot\'s drummer. Named Modern Drummer\'s No. 1 Metal Drummer in their 2024 Readers\' Poll, Casagrande has assembled one of the most formidable drum sets in contemporary metal, balancing explosive speed with controlled musical precision.\n\nThe centerpiece of the Eloy Casagrande drum kit is his Tama Bell Brass snare drum (14×6.5"), chosen for its bright, cutting attack that slices through dense metal arrangements. The Eloy Casagrande drum set features Paiste cymbals throughout: 15" Masters Dark Hi-Hats for a dark, nuanced feel; 20" Formula 602 and Masters Dark Crashes for explosive dynamic accents; a 20" 2002 Power Ride for cutting rhythmic clarity; and a 20" 2002 Novo China for aggressive punctuation. A Tama Iron Cobra Power Glide double pedal powers the explosive double bass passages that defined Sepultura\'s Roots and Machine Messiah eras, as well as the relentless intensity Casagrande brings to Slipknot\'s live performances.',
    sameAs: [
  ...
  },
  {
    ...
    kitOverview: 'John Otto plays an Orange County Drum & Percussion (OCDP) Custom drum kit, the setup behind Limp Bizkit\'s signature rap-metal groove. As a founding member of Limp Bizkit since the band\'s formation in Jacksonville, Florida in 1994, Otto\'s drum set became integral to defining the nu-metal sound that dominated mainstream rock at the turn of the millennium — fusing hip-hop\'s pocket-driven feel with hard rock\'s raw power.\n\nThe centerpiece of the John Otto drum kit is his OCDP 14x7" Maple/Ash snare drum, chosen for its deep, punchy crack that drives Limp Bizkit\'s groove-centric arrangements on Three Dollar Bill Y\'all, Significant Other, and Chocolate Starfish and the Hot Dog Flavored Water. The John Otto drum set features Zildjian K Custom Series cymbals throughout: 14" K Custom Hi-Hats for nuanced, washy articulation suited to hip-hop-influenced rhythms; 17" and 18" Dark Crashes for explosive accents; a 20" Ride for rhythmic clarity; and an 18" China for aggressive punctuation. A DW 9000 Series Double Pedal powers his double kick work. Promark 747 Rock Wood Tip sticks complete the rig.',
    sameAs: [
  ...
  },
  {
    ...
    kitOverview: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch drum kit — the powerful, versatile configuration that drives Gojira\'s progressive death metal sound across albums from From Mars to Sirius through Fortitude. As co-founder and drummer of Gojira, Mario has developed a drum set that balances crushing technical precision with an almost tribal, organic quality that defines the band\'s unique approach to extreme metal.\n\nThe centerpiece of the Mario Duplantier drum kit is his Tama S.L.P. 14×6" G-Maple snare drum — chosen for its warm, resonant crack that cuts through Gojira\'s layered guitar arrangements. The Mario Duplantier drum set features Meinl Byzance Series cymbals throughout: 14" Dark Hi-Hats for nuanced, complex wash; 18" and 20" Brilliant Heavy Hammered Crashes for explosive dynamic accents; a 21" Transition Ride for cutting rhythmic clarity; and an 18" Extra Dry China for tribal, aggressive punctuation. A Tama Iron Cobra 900 Power Glide Double Pedal drives the complex double bass patterns that define Gojira\'s heaviest arrangements. Vic Firth X5A sticks complete a drum set built for both power and precision.',
    gear: {
      drums: 'Tama Starclassic Walnut/Birch',
  ...
  },
  {
    ...
    kitOverview: 'Brann Dailor plays a DW Collector\'s Series Maple drum kit, the setup behind Mastodon\'s polyrhythmic progressive metal sound. As both drummer and vocalist for Mastodon, Dailor has built one of the most distinctively melodic drum sets in metal — driven by complex fills and jazz-influenced patterns across albums like Leviathan, Blood Mountain, and Crack the Skye.\n\nThe Brann Dailor drum kit centers on a DW Collector\'s Series 14x6.5" Brass snare drum, delivering cutting attack and warm overtones that cut through Mastodon\'s dense arrangements. The Brann Dailor drum set features Sabian AAX Series cymbals throughout: 14" Stage Hi-Hats for crisp articulation, 18" and 19" X-Plosion Crashes for explosive accents, a 21" Raw Bell Dry Ride for rhythmic clarity, and an 18" Chinese cymbal for aggressive color. His foot control comes from the DW 9000 Series Double Pedal, enabling the intricate kick patterns that underpin Mastodon\'s complex compositions. Brann Dailor\'s drum set is completed with his signature Vater Brann Dailor Signature sticks.',
    gear: {
  ...
  },
  {
    ...
    kitOverview: 'Matt Halpern plays a Mapex Saturn V MH Exotic drum kit — a setup engineered for the polyrhythmic precision and dynamic control that defines Periphery\'s djent sound. As one of the key architects of progressive metal\'s djent movement and a Berklee College of Music graduate, Halpern has assembled a drum set that demands both technical accuracy and musical sensitivity across the complex time signatures that define Periphery\'s catalog.\n\nThe centerpiece of the Matt Halpern drum kit is his Mapex Black Panther Sledgehammer snare drum (14×6.5"), selected for its powerful, focused attack within Periphery\'s densely layered arrangements on albums like Periphery II, Juggernaut, and Hail Stan. The Matt Halpern drum set features Meinl Byzance Series cymbals throughout: 15" Dark Hi-Hats for dry, controlled articulation; 18" and 20" Extra Dry Medium Crashes for quick-decaying accents; a 22" Transition Ride for clear rhythmic patterns; and an 18" Extra Dry China for aggressive punctuation. A Mapex Falcon double pedal powers the syncopated double bass lines that underpin djent\'s signature rhythmic attack.',
    gear: {
  ...
  },
  {
    ...
    kitOverview: 'Hellhammer plays a Pearl Masters Premium drum kit, the foundational setup behind Mayhem\'s landmark De Mysteriis Dom Sathanas and the black metal sound he helped define from the late 1980s onward. As Jan Axel Blomberg, he has maintained Pearl as his primary drum set throughout his career — a choice that balances the raw aggression of black metal with reliable performance across relentless touring and studio work.\n\nThe Hellhammer drum kit is anchored by a Pearl Sensitone 14x5.5" Steel snare drum, a focused, cutting model that drives the blast beats and hypnotic rhythmic patterns that characterize Mayhem\'s live and studio performances. The Hellhammer drum set features Meinl Byzance Series cymbals throughout: 14" Dark Hi-Hats for a dark, complex wash; 18" and 19" Dark Crashes for explosive, sustained accents; a 20" Dark Ride for rhythmic definition; and an 18" Dark China for aggressive color. A Pearl Eliminator Double Pedal drives the extreme double bass passages that underpin Mayhem\'s blackened intensity. Vic Firth American Classic 5B sticks complete this iconic extreme metal setup.',
    gear: {
  ...
  },
  {
    ...
    kitOverview: 'Shannon Larkin plays a Pearl Reference Pure drum kit — a premium setup reflecting his decades of groove-centric, power-driven hard rock drumming with Godsmack across more than 20 years of multi-platinum albums. As one of hard rock\'s most recognizable drummers, Larkin built a drum set that delivers maximum impact while maintaining the musical sensitivity that defined Godsmack\'s signature sound.\n\nThe cornerstone of the Shannon Larkin drum kit is his Pearl Reference 14×6.5" Brass snare drum, chosen for its powerful, cutting attack that drives Godsmack\'s groove-oriented rhythms on albums like Faceless, IV, and When Legends Rise. The Shannon Larkin drum set features Sabian AAX Series cymbals throughout: 14" Stage Hi-Hats for crisp articulation; 18" and 19" X-Plosion Crashes for explosive dynamic accents; a 21" Raw Bell Dry Ride for focused rhythmic clarity; and an 18" AAX Chinese cymbal for aggressive punctuation. A Pearl Demon Drive double pedal powers the solid double kick foundation beneath Godsmack\'s heaviest arrangements. Promark Shannon Larkin Signature sticks complete the rig.',
    sameAs: [
  ...
  },
  {
    ...
    kitOverview: 'Flo Mounier plays a Pearl Reference Series drum kit — the platform behind Cryptopsy\'s technical death metal brutality and some of the most demanding drumming ever recorded. As the only constant member of Cryptopsy since 1992, Mounier\'s drum set has been his instrument for landmark albums like None So Vile and Whisper Supremacy, records that redefined the upper limits of extreme metal drumming with inhuman blast beat speed and complex polyrhythmic patterns.\n\nThe Flo Mounier drum kit centers on a Pearl Reference 14x5" Steel snare drum, chosen for its tight, cutting attack that slices through Cryptopsy\'s dense, churning arrangements. The Flo Mounier drum set features Sabian AAX Series cymbals throughout: 14" Stage Hi-Hats for precise articulation; 17" and 18" X-Plosion Crashes for explosive, rapid-decaying accents; a 21" Raw Bell Dry Ride for cutting rhythmic clarity; and an 18" AAXtreme China for aggressive punctuation. A Pearl Demon Drive Double Pedal powers the machine-gun double bass passages that define Cryptopsy\'s technical brutality. Vater Power 5B sticks complete the rig.',
    sameAs: [
