...
export const articles = {
  "arin-ilejay-drum-setup": {
    ...
    "description": "Full breakdown of Arin Ilejay's drum setup for Avenged Sevenfold. DW Collector's Series kit, Zildjian A Custom cymbals, DW 9000 Series double pedal specs and pricing.",
    "keywords": [
      "arin ilejay drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "DW Collector's Series kit — arena-grade shells built for stadium projection and touring consistency",
        "Zildjian A Custom cymbals — bright, cutting, the standard for mainstream heavy metal at arena scale",
        "DW 9000 Series double bass pedals — smooth action for the double-kick patterns across A7X's catalogue",
    ...
    "drumKit": {
      ...
      "estimatedValue": "$3,000–6,000 (DW Collector's Series shell pack with hardware)"
    },
    "snare": {
    ...
    "hardware": {
      "title": "DW 9000 Series: Consistent Double Kick Across 200+ Shows Per Year",
      "items": [
        {
    ...
    "gearTimeline": [
      ...
      },
      {
        ...
        "gear": {
          ...
          "snare": "DW Collector's Series snare — power and projection focus",
      ...
      },
      {
        ...
        "gear": {
          ...
          "snare": "DW Collector's Series snare — medium tension for classic metal crack",
  ...
  "hail-to-the-king-drum-setup": {
    ...
    "description": "Complete breakdown of Arin Ilejay's drum setup on Avenged Sevenfold's Hail to the King (2013). DW Collector's Series kit, Zildjian A Custom cymbals, DW 9000 Series double pedal — the gear behind A7X's #1 Billboard 200 album.",
    "seoKeywords": [
      "hail to the king drum setup",
      "arin ilejay drum setup",
      "avenged sevenfold hail to the king drums",
      "arin ilejay 2013 kit",
      "dw collectors series arin ilejay",
      ...
      "items": [
        {
          ...
          "description": "The DW 9000 Series double bass pedal was the hardware backbone of Ilejay's A7X setup. On a world tour spanning two years and hundreds of shows, hardware consistency is as important as initial performance feel. The DW 9000 Series is engineered for this level of touring demand, built for durable, repeatable action night after night. The smooth cam action suited Ilejay's style — a fluid, responsive feel that supported Hail to the King's classic heavy metal double-kick patterns."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "Minimal reverb preserved the attack-focused character of the DW Collector's Series shells"
      ]
    },
    "trackAnalysis": [
      {
        ...
        "gearNotes": "DW 9000 Series double pedal handles the kick drum figures in the chorus. A Custom China cymbal prominent on riff punches. The 18\" crash closes major sections."
      },
      {
        ...
        "gearNotes": "The DW Collector's Series snare is front and center on this track. DW 9000 Series pedal carries the galloping kick figure. Ride cymbal used throughout for measured, controlled feel."
      },
      {
        ...
        "highlights": [
          ...
          "Demonstrates the full DW 9000 Series double pedal capability"
        ],
        "gearNotes": "DW 9000 Series double pedal essential for the sustained driving kick patterns. DW Collector's Series toms audible in the fill sequences leading into each chorus."
      },
      {
        "track": "Coming Home",
        "bpm": "96",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        {
          "category": "Pedals",
          "then": "DW 9000 Series Double Bass Pedal",
    ...
    "faq": [
      {
        ...
        "answer": "Arin Ilejay recorded Hail to the King (2013) using a DW Collector's Series drum kit. His configuration included double 22\" x 18\" bass drums, three rack toms (10\", 12\", 14\"), and two floor toms (16\", 18\"). The shells are built for attack, projection, and tonal clarity — essential characteristics for the arena-scale performances A7X's touring demands. The Collector's Series is one of DW's premier professional touring lineups, used by drummers across mainstream metal."
      },
      {
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Arin Ilejay recorded Hail to the King (2013) using a DW Collector's Series drum kit with double 22x18 inch bass drums, three rack toms (10, 12, 14 inch), and two floor toms (16, 18 inch). The shells provided the attack and projection required for A7X's arena-scale performances."
              }
            },
            {
              "@type": "Question",
