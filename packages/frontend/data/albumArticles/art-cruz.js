...
export const articles = {
  "whats-in-art-cruzs-kit": {
    ...
    "drumKit": {
      "title": "Art's Lamb of God Arsenal: The Ludwig Setup",
      "brand": "Ludwig",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Bright, articulate for fast patterns and groove work"
        },
        {
          "type": "Crash",
          "model": "Zildjian 17\" A Custom Fast Crash",
          "position": "Far left",
        ...
        },
        {
          ...
          "position": "Far right",
          "notes": "Articulate ride with defined bell"
        },
        {
          "type": "China",
      ...
      "items": [
        {
          ...
          "notes": "Direct drive for maximum speed and responsiveness",
          "description": "Art Cruz relies on Trick Pro 1-V Bigfoot pedals for Lamb of God's demanding double bass patterns. The direct-drive action provides instantaneous response — essential for executing Chris Adler's intricate kick patterns and adding Cruz's own powerful footwork."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Gibraltar",
        ...
        },
        {
          "type": "Cymbal Stands",
          "brand": "Gibraltar",
          "model": "Gibraltar 9709 Series",
          "notes": "Professional-grade stability for aggressive playing"
        },
        {
          "type": "Throne",
          "brand": "Roc-N-Soc",
          "model": "Roc-N-Soc Nitro Original",
          "notes": "Comfort essential for two-hour sets"
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
          "model": "Vic Firth 5B or Power 5B",
          "notes": "Balance between speed and power"
        }
      ],
      "heads": {
    ...
    "gearTimeline": [
      {
        "era": "Winds of Plague Era",
        "years": "2008-2012, 2015-2021",
        "albums": [
          "The Great Stone War",
          "Against the World",
          "Blood of My Enemy"
        ],
        "description": "Developed his aggressive deathcore style and touring stamina.",
        "gear": {
          "drums": "Various kits during developing years",
          "cymbals": "Various brands before Zildjian endorsement",
          "hardware": "Developing preferences"
        },
        "notes": "Winds of Plague toured extensively, building Cruz's experience with grueling tour schedules and demanding performances."
      },
      {
        "era": "Prong Era",
        "years": "2012-2018",
        ...
        "description": "Added industrial groove sensibility to his style.",
        "gear": {
          "drums": "Transitional period",
          "cymbals": "Developing Zildjian relationship",
          "hardware": "Refining preferences"
        },
        "notes": "Tommy Victor's Prong added industrial metal precision to Cruz's repertoire — a different dynamic from deathcore."
      },
      {
        "era": "Lamb of God Fill-In",
        "years": "2018",
        "albums": [
          "N/A (touring only)"
        ],
        "description": "First Lamb of God performances filling in for Chris Adler on Slayer Farewell Tour support dates.",
        "gear": {
          "drums": "Transitioning to LOG setup",
          "cymbals": "Zildjian",
          "hardware": "Establishing Trick pedal preference"
        },
        "notes": "The audition that became a permanent job. Cruz had to learn LOG's entire catalog — including Chris Adler's notoriously complex parts — in weeks."
      },
      {
        "era": "Lamb of God Era",
        "years": "2019-Present",
        ...
        "description": "Full integration as Lamb of God's drummer.",
        "gear": {
          "drums": "Ludwig Classic Maple",
          "snare": "Ludwig 14\"x6.5\"",
          "cymbals": "Zildjian A Custom Series",
          "hardware": "Trick Pro 1-V Bigfoot, Gibraltar hardware"
        },
        "notes": "Two studio albums and extensive touring have proven Cruz a worthy successor to Chris Adler's legacy."
      }
    ],
    "getThisSound": {
      "title": "Get This Sound",
      "content": "Want to capture Art Cruz's Lamb of God sound? Here's how to approach his setup at different budgets:\n\n**The Key Elements:**\n- **Powerful but Articulate Bass Drum:** Cruz's kick cuts through without being clicky. Controlled low-end with clear attack.\n- **Punchy Snare:** Medium-high tuning with body. Not thin or papery — authoritative crack.\n- **Bright, Cutting Cymbals:** A Custom-style cymbals that project without harshness.\n- **Reliable Double Pedal:** Trick direct-drive for instantaneous response.\n\n**Budget Build (~$2,500):**\n- Ludwig Accent or Element kit\n- Ludwig Supralite or similar steel snare\n- Zildjian A Series or S Family cymbals\n- Pearl Demon Drive or DW 3000 double pedal\n\n**Mid-Range Build (~$5,000):**\n- Ludwig Classic Maple or Keystone\n- Ludwig Supraphonic or Acrolite\n- Zildjian A Custom cymbals\n- Trick Dominator or DW 5000 double pedal\n\n**Pro Build (~$8,000+):**\n- Ludwig Classic Maple (exact spec)\n- Ludwig signature or custom snare\n- Full Zildjian A Custom/K setup\n- Trick Pro 1-V Bigfoot double pedal\n- Complete Gibraltar hardware package",
      "keyPoints": [
        "Focus on groove and consistency before gear",
        "Study Chris Adler's parts to understand LOG's vocabulary",
        "Direct-drive pedals help with Adler's intricate kick patterns",
        "Cymbal articulation matters — don't just bash",
        "Watch Cruz's live footage for technique insights"
      ]
    },
    "songsToStudy": {
      ...
      "songs": [
        {
          ...
          "year": 2020,
          "description": "Cruz's first recorded track with LOG. Shows his integration with the band's style.",
          "difficulty": "Advanced",
          "focus": "Groove-power balance, double bass precision"
        },
        {
          "name": "Nevermore",
          "album": "Omens",
          "year": 2022,
          "description": "Showcase of Cruz's evolved approach with LOG — powerful but musical.",
          "difficulty": "Advanced",
          "focus": "Dynamic control, snare accents"
        },
        {
          "name": "Grayscale",
          "album": "Omens",
          "year": 2022,
          "description": "Technical track demonstrating Cruz's ability to handle complex arrangements.",
          "difficulty": "Advanced",
          "focus": "Intricate patterns, time feel"
        },
        {
          "name": "Laid to Rest",
          "album": "Ashes of the Wake (live)",
          "year": "Live",
          "description": "Classic LOG track Cruz performs nightly — proves he can handle the catalog.",
          "difficulty": "Advanced",
          "focus": "Chris Adler's original patterns, stamina"
        },
        {
          "name": "Redneck",
          "album": "Sacrament (live)",
          "year": "Live",
          "description": "LOG's biggest hit — Cruz must nail this every show.",
          "difficulty": "Intermediate-Advanced",
          "focus": "Groove, dynamics, crowd energy"
        }
      ]
    },
    "videos": [],
    ...
    "gearAvailability": {
      ...
      "items": [
        {
          "item": "Ludwig Classic Maple Kit",
          "available": true,
          "priceRange": "$3,500-5,500 (configuration dependent)",
          "notes": "Available through authorized Ludwig dealers"
        },
        {
          "item": "Zildjian A Custom Cymbals",
          "available": true,
          "priceRange": "$200-400 per cymbal",
          "notes": "Flagship Zildjian line, widely available"
        },
        {
          "item": "Trick Pro 1-V Bigfoot Double Pedal",
          "available": true,
          "priceRange": "$600-800",
          "notes": "Direct-drive precision pedal"
        },
        {
          "item": "Evans EMAD2 Bass Drum Heads",
          "available": true,
          "priceRange": "$40-50",
          "notes": "Industry standard for controlled bass drum sound"
        },
        {
          "item": "Vic Firth 5B Sticks",
          "available": true,
          "priceRange": "$10-15 per pair",
          "notes": "Classic stick choice, available everywhere"
        }
      ]
    },
    "relatedDrummers": [
