...
export const articles = {
  ...
  "the-parallax-ii-future-sequence-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "DW 9002 chain-drive double pedal — compositional kick approach at its most developed in tracks like Telos",
    ...
    "drumKit": {
      ...
      "notes": [
        ...
        "Configuration continues through touring cycle post-Parallax II — the peak DW/Meinl era in Richardson's career"
      ],
    ...
    "cymbals": {
      ...
      "setup": [
        ...
        {
          "type": "Splash",
          "model": "Meinl Byzance Dark 10\" Splash",
    ...
    "faq": [
      {
        ...
        "answer": "Blake Richardson used a refined DW Collector's Series kit on The Parallax II: Future Sequence (2012) — the same shell design he had established on Alaska (2005) and Colors (2007), precisely dialed in after seven years of touring. The kit features Maple shells: 22\"x18\" bass drum (driven by DW 9002 chain-drive double pedal), three rack toms (10\", 12\", 13\"), and a 16\" floor tom. Full drummer profile at [Blake Richardson at MetalForge](/drummer/blake-richardson)."
      },
      {
        "question": "What is Blake Richardson's drum setup on 'Telos' from The Parallax II?",
        "answer": "'Telos' is the most studied drum performance in Richardson's BTBAM catalog — a nine-minute track on The Parallax II (2012) demonstrating his metric modulation approach and compositional double-bass technique at full development. His setup for this and the rest of the album: DW Collector's Series 22\"x18\" kick driven by a DW 9002 chain-drive double pedal, three rack toms, 16\" floor tom, Meinl Byzance Dark 14\" Hi-Hats, Extra Dry Thin Crashes, Extra Dry Ride, Dark Crash, and Meinl Byzance China. The Meinl Byzance Extra Dry Ride is particularly critical on 'Telos' — its controlled, minimal wash keeps Richardson's metric modulation sequences clearly articulated through the track's most complex rhythmic passages. See the [odd-time signatures technique guide](/technique/odd-time-signatures) for a breakdown of the metric modulation concepts deployed."
      },
      {
      ...
      },
      {
        ...
        "answer": "Blake Richardson played an expanded Meinl Byzance setup on The Parallax II (2012), combining Dark and Extra Dry sub-series for a wider tonal palette than his earlier primarily Extra Dry Alaska-era setup. Configuration: Meinl Byzance Dark 14\" Hi-Hats (jazz-inflected passages), Extra Dry 17\" Thin Crash (fast accent), Dark 18\" Crash (fuller sustain), Extra Dry 20\" Ride (controlled odd-time articulation), 10\" Dark Splash (rapid transition punctuation), and 18\" Meinl Byzance China (death metal accents). The dual Dark/Extra Dry approach reflects the 74-minute concept album's greater tonal range requirements."
      }
    ],
    "relatedAlbums": [
      "alaska-drum-setup",
  ...
  "coma-ecliptic-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Tama Starclassic Bubinga continuing as the kit foundation — warm, versatile setup suited to progressive rock textures",
        "Sabian Dark and Extra Dry — full dual-series setup from The Parallax II era maintained",
    ...
    "drumKit": {
      "title": "Tama Starclassic Bubinga: Warmth for a Rock Opera",
      "brand": "Tama",
      "model": "Tama Starclassic Bubinga",
      ...
      "config": {
        ...
        "shells": "African Bubinga — warm, resonant tone suited to Coma Ecliptic's progressive rock character"
      },
      "description": "The Tama Starclassic Bubinga kit that Richardson used on Coma Ecliptic was the most fully evolved version of the Tama configuration he had established on Alaska (2005). By 2015, after a decade of touring and recording on this kit, every head choice, tuning preference, and hardware setting was precisely calibrated to serve Richardson's technique and BTBAM's musical requirements. The Bubinga fundamental suited Coma Ecliptic's progressive rock-leaning production particularly well: the kit sounded full and resonant across the album's melodically rich arrangements without the aggressive attack character that would suit a more extreme metal record.\n\nJamie King's Basement Studio production on Coma Ecliptic gave the Tama Starclassic Bubinga more room to breathe than it had on The Parallax II — a production choice that reflected the album's more open, accessible musical direction. The bass drum sits with less density than on the Parallax record; the toms have more natural decay; the overall drum sound is warmer and more present rather than dense and driving. For a rock opera where the drums are telling a story rather than demonstrating extremes, this production approach was precisely correct.\n\nThe three-rack-tom layout (10\", 12\", 13\") continued to serve Richardson's melodic fill approach. On Coma Ecliptic, tom fills function as emotional punctuation in the narrative: a descending fill marking a story's low point, an ascending fill building toward a climax, a held cymbal note sustaining through a dramatic pause. The Starclassic Bubinga's warm fundamental makes these narrative fill patterns sing as musical statements rather than technical displays. See the [Blake Richardson drummer profile](/drummer/blake-richardson) for how this storytelling approach developed across his career.\n\nComa Ecliptic also marked a period where Richardson was exploring the balance between the Tama setup that had defined his sound and the Pearl Reference Pure that would become central to the Automata era (2018). The Tama foundation remained primary for this album, but the broader gear evolution was underway.",
      "notes": [
        ...
        "Bubinga fundamental suits Coma Ecliptic's progressive rock melodic character",
    ...
    "cymbals": {
      "title": "Sabian Dark and Extra Dry: Storytelling Tonal Vocabulary",
      "brand": "Sabian",
      ...
      "items": [
        {
          ...
          "description": "The Tama Iron Cobra continues as Richardson's kick foundation on Coma Ecliptic — the same pedal used since the Alaska era, now deployed in service of a rock opera where kick density is a storytelling tool rather than a technical demonstration. Coma Ecliptic's production uses the kick drum more dynamically than The Parallax II: quieter passages feature sparse kick deployment that creates narrative tension, while the album's peak intensity sections deploy the Iron Cobra's full double-bass capability to drive dramatic climaxes."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
  ...
  "colors-drum-setup": {
    ...
    "description": "Blake Richardson's drum kit and gear on BTBAM's landmark Colors (2007): DW Collector's Series drums, Meinl Byzance Extra Dry cymbals, DW 9002 chain-drive double pedal, and the metric modulation performance that defined progressive metal's gold standard.",
    "seoKeywords": [
      "colors drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "DW Collector's Series refined from Alaska — same maple foundation, more precisely calibrated after two years of touring",
        "Meinl Byzance Extra Dry — dark, controlled cymbal voice for clean articulation through Colors' densest arrangements",
        "DW 9002 chain-drive double pedal — compositional kick deployment across BTBAM's most intense passages",
    ...
    "faq": [
      {
        ...
        "answer": "Blake Richardson played a DW Collector's Series kit on *Colors* (2007) — BTBAM's landmark progressive metal record. The DW Collector's Series uses Maple shells, delivering the warm, resonant tone that suited *Colors*' 65-minute single-arc composition spanning death metal, jazz, and ambient textures. Configuration: single 22\"x18\" bass drum driven by a DW 9002 chain-drive double pedal, three rack toms (10\", 12\", 13\"), and a 16\" floor tom. Meinl Byzance Extra Dry cymbals completed the setup. Full drummer profile at [Blake Richardson at MetalForge](/drummer/blake-richardson)."
      },
      {
  ...
  "great-misdirect-drum-setup": {
    ...
    "description": "Blake Richardson's drum kit and gear on BTBAM's The Great Misdirect (2009): DW Collector's Series drums, Meinl Byzance Extra Dry cymbals, DW 9002 chain-drive double pedal, and the performance that closed the Colors era's pre-Parallax arc.",
    "seoKeywords": [
      "great misdirect drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "DW Collector's Series in its most refined Colors-era configuration — same maple foundation, precisely calibrated",
        "Meinl Byzance Extra Dry — final album before the Parallax-era Dark series expansion",
    ...
    "drumKit": {
      ...
      "notes": [
        ...
        "Final album in the foundational DW/Meinl era before the Parallax-era gear evolution began"
      ],
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Blake Richardson played a DW Collector's Series kit on *The Great Misdirect* (2009) — the same Maple configuration he had used on *Alaska* (2005) and *Colors* (2007), at its most refined state after two years of post-*Colors* touring. Configuration: single 22\"x18\" bass drum driven by a DW 9002 chain-drive double pedal, three rack toms (10\", 12\", 13\"), and a 16\" floor tom. Meinl Byzance Extra Dry cymbals completed the setup. Full drummer profile at [Blake Richardson at MetalForge](/drummer/blake-richardson)."
      },
      {
  ...
  "automata-i-drum-setup": {
    ...
    "cymbals": {
      "title": "Sabian: Full Three-Series Palette for BTBAM's Most Produced Record",
      "brand": "Sabian",
      ...
      "items": [
        {
          ...
          "description": "The Tama Iron Cobra Power Glide double pedal continues as Richardson's kick hardware foundation on Automata I, operating in conjunction with the double bass drum configuration. The Iron Cobra's chain-drive mechanism and adjustable cam deliver the consistent, controllable feel Richardson's compositional double-bass approach requires: varying kick density from sparse single-strokes through dense double-bass passages within the same track, following the music's emotional arc rather than maintaining a constant density level. Automata I's concept album structure — with its dramatic narrative swings between intense sections and atmospheric passages — demands this kind of dynamic kick deployment, and the Tama Iron Cobra provides the mechanical platform that makes it possible."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
  ...
  "blake-richardson-drum-setup": {
    ...
    "snare": {
      ...
      "size": "14\" x 6.5\"",
      "shell": "Brass",
      "description": "Blake Richardson's primary snare for studio and touring work has been a Tama STARPHONIC brass snare at the standard 14\" x 6.5\" configuration. The brass shell construction delivers a bright, cutting crack — distinct from the brighter attack of steel or aluminum alternatives — that sits well in BTBAM's dense production where the snare needs authority without being harsh.\n\nIn a band whose guitar arrangements cover death metal riffing, jazz voicings, and ambient textures within a single track, the snare must be versatile. The Tama STARPHONIC brass provides that versatility: tuned medium-high it delivers the cutting crack needed to drive blast beat passages; tuned medium it settles into the more restrained, groove-oriented sections of BTBAM's arrangements. Richardson's ghost note work — a critical element of his jazz-influenced technique — reads clearly through the brass's cutting midrange, giving his dense hi-hat-and-ghost-note patterns the definition they require.\n\nThe 6.5\" depth adds body to each stroke, ensuring the snare doesn't disappear in the band's heaviest arrangements. Evans G2 Coated batter heads provide the two-ply control and slightly dampened sustain his technique demands, with a transparent snare-side head allowing full wire sensitivity for the delicate ghost note work that appears throughout BTBAM's catalog.\n\nRichardson has noted the importance of a snare that sounds musical rather than aggressive in isolation — a preference that reflects BTBAM's compositional approach, where even the most intense passages are arranged with jazz-musician's attention to tone.",
    ...
    "cymbals": {
      ...
      "setup": [
        {
          ...
          "model": "Sabian 14\" Dark Hi-Hats",
          "position": "Left side",
          "notes": "Dark, complex voice — nuanced foot and stick response for jazz-inflected hi-hat work"
        },
        {
          "type": "Crash",
          "model": "Sabian Extra Dry 17\" Thin Crash",
          "position": "Left crash",
          "notes": "Dry, focused attack — fast response without excess wash in dense progressive arrangements"
        },
        {
          "type": "Crash",
          "model": "Sabian 18\" Dark Crash",
          "position": "Right crash",
          "notes": "Fuller, darker crash voice for heavier accents and section-ending explosions"
        },
        {
          "type": "Ride",
          "model": "Sabian 20\" Extra Dry Ride",
          "position": "Far right",
        ...
        },
        {
          ...
          "model": "Sabian 10\" Dark Splash",
          "position": "Effects position",
          "notes": "Quick, dark accent tool for transitions between BTBAM's genre-shifting sections"
        },
        {
          "type": "China",
          "model": "Sabian 18\" China",
      ...
      "description": "Blake Richardson's Sabian setup is one of the most musically sophisticated cymbal configurations in progressive metal. The Sabian line — Sabian's top-tier hand-hammered Turkish-style cymbal series — produces complex, dark, warm tones with a richness of overtone that machine-made cymbals cannot replicate. For a drummer playing music that ranges from extreme metal to jazz within a single song, this tonal complexity is not a luxury; it is a functional necessity.\n\nThe Dark and Extra Dry sub-series within Sabian provide Richardson with contrasting voices for different musical contexts. Sabian Dark cymbals are characterized by warm, earthy tones with a fast decay — ideal for the jazz-inflected passages where overtone complexity enriches the sound without creating wash that obscures melodic content. Sabian Extra Dry cymbals are drier, more controlled, with faster response and minimal sustain — ideal for the precise rhythmic passages in BTBAM's most intense metal sections, where clarity is paramount.\n\nThe 14\" Dark Hi-Hats are the rhythmic center of Richardson's playing. His hi-hat work is one of the most discussed aspects of his technique: dense ghost-note patterns around the hi-hat, frequent transitions between open and closed positions, and use of the hi-hat foot as an independent voice in polyrhythmic passages. The Dark voicing provides the warm, nuanced response these demanding hi-hat patterns require — a cymbal that speaks clearly under light ghost-note strokes and responds immediately to full accent hits without becoming harsh.\n\nHis crash configuration covers the full dynamic spectrum: the 17\" Extra Dry Thin Crash for fast, precise accents in technical passages; the 18\" Dark Crash for larger, more sustained explosions at section peaks. The Extra Dry ride maintains clean articulation through BTBAM's most rhythmically complex passages, where a washy ride would blur the metric modulations Richardson is executing.\n\nThe Sabian China and Dark Splash complete the setup: the China for extreme metal passages where an aggressive, upward-projecting attack is needed; the Splash for the quick accent punctuations that mark BTBAM's most rapid genre transitions. Every cymbal in Richardson's setup exists to serve specific musical functions across the full range of what Between the Buried and Me demands.",
      ...
      "items": [
        {
          ...
          "description": "Blake Richardson's Tama Iron Cobra Power Glide double pedal is the foot hardware foundation of BTBAM's progressive metal sound. The Tama Iron Cobra is a professional chain-drive double pedal with adjustable cam, dual-chain drive, and precision-machined components — the kind of hardware that delivers consistent feel across years of intensive touring and recording. Richardson's use of double bass is compositional rather than constant: he varies kick density across BTBAM's arrangements to follow the music's emotional arc, deploying dense double-bass passages at peak intensity and pulling back to single-foot or sparse patterns during the band's more restrained sections. The Iron Cobra's adjustable cam allows Richardson to dial in precisely the power curve and return speed his compositional approach requires — heavier spring for fast, dense passages; lighter for more controlled, dynamic playing. Songs like 'Lay Your Ghosts to Rest' and 'Mordecai' demonstrate this compositional kick approach at its most developed."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "gearTimeline": [
      ...
      },
      {
        ...
        "gear": {
          ...
          "snare": "Tama STARPHONIC Brass 14\" x 6.5\"",
          "cymbals": "Sabian Dark and Extra Dry — expanded setup for wider tonal range",
          "hardware": "Tama Iron Cobra Power Glide double pedal continued; expanded rack tom configuration"
        },
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Blake Richardson plays Sabian series cymbals across the Dark, Extra Dry, and Traditional sub-lines. His setup includes Sabian 14\" Dark Hi-Hats, 17\" Extra Dry Thin Crash, 18\" Dark Crash, 20\" Extra Dry Ride, 10\" Dark Splash, and 18\" Sabian China. The Sabian line's hand-hammered Turkish-style construction produces complex, warm, nuanced tones that serve BTBAM's genre-spanning arrangements — from extreme metal to jazz-inflected passages — without requiring cymbal changes between sections. The Dark sub-series provides warm, fast-decaying tones for dynamic passages; the Extra Dry sub-series delivers dry, controlled articulation for BTBAM's most technically demanding rhythmic material."
      },
      {
      ...
      },
      {
        ...
        "answer": "Blake Richardson uses the Tama Iron Cobra Power Glide double pedal. The Tama Iron Cobra is a professional chain-drive double pedal with adjustable cam and dual-chain mechanism that delivers consistent, precise feel across intensive touring and recording demands. Richardson's double-bass approach is compositional: he varies kick density to follow BTBAM's emotional arc rather than running constant patterns, using the Iron Cobra's adjustable cam to dial in the power curve and return speed his dynamic approach requires. The pedal appears across his recorded work from the Colors period through the Automata era."
      },
      {
