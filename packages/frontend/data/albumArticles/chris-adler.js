...
export const articles = {
  "whats-in-chris-adlers-kit": {
    ...
    "snare": {
      ...
      "description": "The Mapex Warbird signature snare was designed specifically around Chris Adler's groove metal requirements. At 14\" x 5.5\", it sits at the standard metal diameter, but the shallower 5.5\" depth is what sets it apart from the deeper 6.5\"-7\" snares many metal drummers favor for maximum punch. Adler's choice reveals his priorities: response over raw power, speed over sheer size.\n\nThe shallower depth gives the Warbird faster response and a tighter, more focused sound. When you're playing grooves as intricate as Adler's — with ghost notes woven throughout heavy patterns — you need a snare that reacts instantly to every touch. The Warbird delivers that response while still hitting hard enough to cut through Lamb of God's wall of guitars.\n\nThe 5.5\" depth keeps the drum punchy without excessive body. Adler's playing relies on crack and definition, not the deep, resonant tone that deeper snares provide. The maple shell adds warmth without sacrificing attack, and Mapex's SONIClear bearing edge ensures consistent head contact for even tone across the head.\n\nWhat makes the Warbird truly signature is how it complements Adler's playing style. His patterns often feature rapid snare work — buzzes, drags, and ghost notes that add texture to heavy grooves. A deeper, slower snare would muddy these details. The Warbird keeps them crisp and defined.\n\nThe snare sound on albums like \"Ashes of the Wake\" and \"Sacrament\" became a benchmark for groove metal production. That cracking, cutting tone — tight but not thin, powerful but not boomy — is the Warbird's signature.",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Quick response for pivot technique"
        },
        {
          "type": "Crash",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Standard 14\" hats — pivot technique still developing"
        },
        {
          "type": "Crash",
        ...
        },
        {
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Both albums used the Mapex Pro M kit, but As the Palaces Burn features Zildjian A Custom cymbals with 14\" hi-hats, while Ashes of the Wake switched to Meinl Byzance, keeping the same 14\" hi-hat size but delivering a darker top-end character as the pivot technique footwork became fully developed."
              }
            }
          ]
        }
  ...
  "ashes-of-the-wake-drum-setup": {
      ...
      "setup": [
        {
          ...
          "model": "Meinl 14\" Byzance Traditional Hi-Hats",
          "position": "Left side",
          "notes": "Quick pivot technique response"
        },
        {
          "type": "Crash",
          "model": "Meinl 18\" Byzance Traditional Medium Thin Crash",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Chris Adler used Meinl Byzance cymbals throughout Ashes of the Wake. His setup included 14 inch Byzance Traditional hi-hats, Byzance crashes from 18 to 20 inches, a 21 inch Byzance Traditional Medium Ride, Byzance 18 and 20 inch Chinas, and a 10 inch Splash. The Byzance series is handcrafted in Turkey and known for its warm, dark, and complex tonal response, which gave Adler's playing a rich, musical quality that set Lamb of God apart from their peers at the time."
      },
      {
      ...
      "setup": [
        {
          ...
          "model": "Meinl 14\" Byzance Traditional Hi-Hats",
          "position": "Left side",
          "notes": "Fast pivot technique response — essential for 'Ghost Walking' patterns"
        },
        {
          "type": "Crash",
          "model": "Meinl 18\" Byzance Traditional Medium Thin Crash",
      ...
      "setup": [
        {
          ...
          "model": "Meinl 14\" Byzance Traditional Hi-Hats",
          "position": "Left side",
          "notes": "Pivot technique response — driving \"512\" and \"Engage the Fear Machine\""
        },
        {
          "type": "Crash",
          "model": "Meinl 18\" Byzance Traditional Medium Thin Crash",
      ...
      "setup": [
        {
          ...
          "model": "Meinl 14\" Byzance Traditional Hi-Hats",
          "position": "Left side",
          "notes": "Adler's pivot technique response"
        },
        {
          "type": "Crash",
          "model": "Meinl 18\" Byzance Traditional Medium Thin Crash",
