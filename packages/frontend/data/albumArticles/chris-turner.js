// Album drum-setup articles — Chris Turner. Auto-split from the former monolith.
export const articles = {
  "chris-turner-drum-setup": {
    ...
    "seoKeywords": [
      ...
      "oceans ate alaska drummer",
      "chris turner meinl cymbals",
      "chris turner tama drums",
      "oceans ate alaska drums",
      "chris turner speed cobra",
      "hikari album drums",
      "chris turner gear",
      "progressive metalcore drums"
    ],
    ...
    "drumKit": {
      ...
      "config": {
        "bassdrums": [
          "22\" Bass Drum (double pedal configuration with Speed Cobra 910)"
        ],
        "toms": [
          "10\" Rack Tom",
          "12\" Rack Tom"
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Dual-configuration for tightly closed patterns and semi-open wash; 15\" diameter for fuller hi-hat body than standard 14\""
        },
        {
          "type": "Crash",
          "model": "Meinl Byzance Extra Dry 18\" Medium Crash",
          "position": "Left crash",
          "notes": "Extra Dry finish for fast, controlled attack with minimal sustain — precise accent placement in complex patterns"
        },
        {
          "type": "Crash",
          "model": "Meinl Byzance Extra Dry 20\" Medium Crash",
          "position": "Right crash",
          "notes": "Fuller crash for larger structural accents and section-ending moments"
        },
        {
          "type": "Ride",
          "model": "Meinl Byzance 22\" Dual Ride",
          "position": "Right",
          "notes": "Dual-configuration ride for versatile tonal response across progressive metalcore's dynamic range"
        },
        {
          "type": "China",
          "model": "Meinl Byzance Extra Dry 18\" China",
          "position": "Over rack toms",
          "notes": "Extra Dry finish for controlled, non-washy china accent in technical passages"
        }
      ],
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          ...
          "pedals": "Standard double pedal (no fixed brand documented)"
        },
  ...
  "chris-turner-hikari-2017": {
    ...
    "description": "The drum setup Chris Turner used to record Oceans Ate Alaska's 2017 breakthrough 'Hikari' — Tama Starclassic Maple/Birch, Meinl Byzance Extra Dry cymbals, and the stock Starclassic snare and standard double pedal behind the album that made his playthrough videos go viral.",
    "seoKeywords": [
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Tama Starclassic Maple/Birch kit with a stock Tama Starclassic matching snare",
        "Meinl Byzance Extra Dry crashes and china for fast-decay accent placement",
        "A standard double pedal — no fixed Tama endorsement documented yet for this era — drove the velocity-even double bass on \"Escapist\""
      ]
    },
    "drumKit": {
    ...
    "snare": {
      "title": "Stock Starclassic Snare for a Record That Swings Between Extremes",
      "brand": "Tama",
      "model": "Tama Starclassic matching snare",
      "size": "Stock configuration (bundled with the Starclassic shell pack)",
      "shell": "Stock Starclassic shell, bright attack",
      "description": "Turner recorded \"Hikari\" on the stock matching snare from his Tama Starclassic Maple/Birch shell pack — the first documented Tama snare in his setup, and the drum he used before later switching to a dedicated Tama S.L.P. G-Maple. Its bright attack still had to carry \"Hansha\"'s cross-stick accents and rimshots within the same phrase as Turner's polyrhythmic kick work, where a duller, longer-sustaining shell would have smeared those closely spaced hits together under Nick Sampson's dense mix, while also registering the lower-velocity ghost notes that run through \"Veridical\"'s quieter passages.\n\nEvans heads (batter and snare side) rounded out the setup, tuned to a medium tension that Sampson's production could push bright without the drum turning harsh — a balance that let the snare sit clearly against the album's layered, downtuned guitar arrangements without dominating the mix.",
      "tuningSetting": "Medium tension, tuned for both ghost note sensitivity and rimshot cut",
      "heads": "Evans (batter and snare side)",
      "estimatedValue": "$150–250 (stock Starclassic matching snare, bundled with the shell pack)"
    },
    "cymbals": {
    ...
    "hardware": {
      "title": "The Standard Double Pedal Behind 'Escapist'",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "Unknown",
          "model": "Standard double pedal (no fixed brand confirmed for this era)",
          "notes": "Predates Turner's later Tama Speed Cobra 910 endorsement",
          "description": "No single pedal brand is documented for Turner's \"Hikari\" sessions — this era predates the Tama Speed Cobra 910 endorsement he would later establish during Oceans Ate Alaska's Disparity/viral-playthrough years. What mattered on \"Escapist,\" recorded at roughly 170 BPM, was pedal consistency between the primary and secondary beater: Turner's double bass technique needs both feet to produce identical note weight regardless of which one leads, and any mechanical inconsistency between sides would have undercut the evenness the syncopated, triplet-interpolated kick figures on \"Escapist\" depend on."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "highlights": [
          ...
          "Consistent double pedal action keeps both feet mechanically even at tempo"
        ],
        "gearNotes": "A standard double pedal — no fixed Tama endorsement documented yet for this era — is the defining piece of gear on this track, its mechanical consistency supporting the note-for-note evenness between feet."
      },
      {
        "track": "Hikari",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Chris Turner played a standard double pedal on 'Escapist,' the closing track from 'Hikari' — no fixed pedal brand is documented for this era, predating his later Tama Speed Cobra 910 endorsement. What the track's velocity-even double bass technique required was mechanical consistency between both feet, striking with identical force and timing at roughly 170 BPM. For more on his gear: [Chris Turner drum setup at MetalForge](/articles/chris-turner-drum-setup)."
      },
      {
