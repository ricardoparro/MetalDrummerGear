...
export const articles = {
  "daniel-erlandsson-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AAX/HHX cymbals — AAX brightness for projection, HHX complexity for musical context",
    ...
    "cymbals": {
      "title": "Sabian AAX / HHX: Brightness and Complexity for Melodic Death Metal",
      "brand": "Sabian",
    ...
    "playingStyle": {
      ...
      "keyTechniques": [
        ...
        "Pearl Eliminator cam-based response for consistent double-kick across multi-year international touring"
      ]
    },
    "gearTimeline": [
      {
      ...
      },
      {
        ...
        "notes": "War Eternal (2014) introduced Alissa White-Gluz as vocalist, sustaining Arch Enemy's global profile through another decade. Will to Power (2017) represented the band's commercial peak. Through this period, Erlandsson's setup remained the same Sabian AAX/HHX cymbals and Pearl Eliminator pedal he had used since the Angela Gossow era. Deceivers (2022) continued the trajectory with the same professional reliability that characterizes his entire career with the band."
      }
    ],
    "faq": [
      {
  ...
  "anthems-of-rebellion-drum-setup": {
    ...
    "cymbals": {
      "title": "Sabian AAX / HHX: Daniel Erlandsson's 2003 Cymbal Setup",
      "brand": "Sabian",
      "series": "Sabian AAX / HHX Series",
      "setup": [
        {
        ...
        },
        {
          ...
          "position": "Left crash",
          "notes": "Fast attack with musical sustain — AAX/HHX warmth without brightness sacrificed"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 18\" X-Plosion Crash",
        ...
        {
          "type": "Ride",
          "model": "Sabian HHX 20\" Evolution Ride",
          "position": "Far right",
          "notes": "Defined stick articulation with AAX/HHX tonal complexity for groove passage ride work"
        },
        {
          "type": "China",
          "model": "Sabian AAX 18\" China",
    ...
    "soundCharacter": {
      ...
      "keyAttributes": [
        ...
        "Sabian HHX complexity — hand-hammered B20 warmth vs the brighter Sabian AA character of Wages",
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "Sabian AAX crashes provide the musical wash for the chorus entries. MMX warmth suits the melodic verse groove. Pearl Eliminator double-kick consistency drives the verse-to-chorus momentum build."
      },
      {
        ...
        "highlights": [
          ...
          "China cymbal accents from AAX/HHX 18\" mark riff transitions in classic Gothenburg style"
        ],
      ...
      },
      {
        ...
        "highlights": [
          ...
          "HH ride on the HHX 20\" Evolution provides the textural contrast for groove-oriented sections",
      ...
      },
      {
        ...
        "highlights": [
          ...
          "AAX china accents punctuate section boundaries with aggressive trashy character"
        ],
        "gearNotes": "MMX toms provide the warmer-than-maple fill character that gives Burning Angel's transitions body. AAX china delivers aggressive accent character in the Gothenburg style."
      }
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson played Sabian AAX/HHX cymbals on Anthems of Rebellion (2003), representing an evolution from the Sabian AA/HH setup he had used on Wages of Sin (2002). The HHX series is hand-hammered B20 bronze — producing a warmer, more tonally complex character than machine-hammered alternatives. His configuration included 14\" AAX hi-hats for verse groove articulation, 16\" and 18\" AAX X-Plosion Crash cymbals for section-entry accents, a 20\" HHX Evolution Ride for groove-oriented passage texture, an 18\" AAX China for the trashy Gothenburg-style riff-transition accents, and a 10\" AAX/HHX Splash for fast syncopated accents. The AAX/HHX character suited the more melodically developed arrangements of Anthems of Rebellion, providing warmth and musical depth that integrated with Amott's layered guitar harmonics rather than cutting aggressively above them."
      },
      {
  ...
  "rise-of-the-tyrant-drum-setup": {
    ...
    "description": "Daniel Erlandsson's drum setup on Arch Enemy's Rise of the Tyrant (2007) — peak commercial Angela Gossow era, Pearl Masters Premium shells, Sabian HHX cymbals, Pearl Eliminator pedals, and the album that landed on Guitar Hero: Smash Hits.",
    "seoKeywords": [
      "rise of the tyrant drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian HHX series added to the AAX lineup — expanded tonal palette",
    ...
    "cymbals": {
      "title": "Sabian AAX / HHX: Erlandsson's Expanded 2007 Palette",
      "brand": "Sabian",
      "series": "Sabian AAX / HHX Series",
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "HHX — deeper, warmer hi-hat voice than AAX for more complex groove texture"
        },
        {
          "type": "Crash",
          "model": "Sabian HHX 16\" Evolution Crash",
          "position": "Left crash",
          "notes": "HHX series — aged tonal character with fast attack and musical sustain"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 18\" X-Plosion Crash",
          "position": "Right crash",
          "notes": "AAX — warm B20 bronze for larger structural accent work"
        },
        {
          "type": "Ride",
          "model": "Sabian HHX 20\" Evolution Ride",
        ...
        },
        {
          ...
          "model": "Sabian AAX 18\" China",
          "position": "Over rack toms",
          "notes": "AAX china — aggressive trashy accent for riff-change punctuation in Gothenburg style"
        },
        {
          "type": "Splash",
          "model": "Sabian AAX 10\" Splash",
      ...
      "description": "The Sabian HHX series additions that characterise Erlandsson's Rise of the Tyrant cymbal setup represent a significant expansion of tonal palette relative to his earlier AAX work on Anthems of Rebellion. Where the AAX line delivers a brighter, more conventional attack and sustain, the HHX series pushes further into complex tonal territory.\n\nThe HHX series is produced with a specific lathing and hammering process that creates a darker, more overtone-rich tonal character — warmer and more complex than the AAX line, with a slower attack and longer wash that suits groove-oriented playing and texturally rich ride work. The 14\" HHX hi-hats and 20\" HHX Evolution Ride that anchor Erlandsson's 2007 setup give his groove playing a deeper, more enveloping texture than the brighter-attacking AAX hi-hats of the Anthems era, complementing the melodic sophistication of Rise of the Tyrant's arrangements.\n\nThe HHX series, meanwhile, is manufactured with a process intended to reproduce the tonal characteristics of aged B20 cymbals — the slight oxidation and micro-surface variation of well-played vintage alloy. The result is a crash cymbal with a distinctly musical, complex quality: more overtone complexity than new-alloy equivalents, a slightly drier attack, and the warm, rounded sustain of truly broken-in bronze. The 16\" HHX Evolution Crash gives Erlandsson's left-side crash work a musical warmth on Rise of the Tyrant that suits the album's more melodically developed crash-accent moments.\n\nTogether, the HHX and AAX elements give Erlandsson the most tonally sophisticated cymbal setup of his Angela Gossow–era Arch Enemy work — a palette matched to the musical ambitions of the album and the larger production budgets and listener expectations that came with being one of extreme metal's commercially leading acts.",
      "estimatedValue": "$1,800-2,800 total (Sabian AAX/HHX full setup, 2007)"
    },
    "hardware": {
    ...
    "soundCharacter": {
      ...
      "keyAttributes": [
        ...
        "Sabian HHX complexity — tonally sophisticated cymbal character for mainstream melodic death metal",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "Hi-hat articulation on the HHX 14\" drives the groove-forward verse feel"
        ],
        "gearNotes": "HHX hi-hats provide the warm, articulate groove texture that makes the verse sections driving without being aggressive. Sample-augmented kick delivers the impact at commercial level without losing the Pearl Masters Premium live character."
      },
      {
      ...
      },
      {
        ...
        "highlights": [
          ...
          "HHX ride provides textural contrast in the track's more spacious mid-sections",
          "Tom fills follow guitar melodic contours — double-kick articulates riff rhythmic shapes",
          "AAX china accents mark riff-transition moments with aggressive Gothenburg character"
        ],
        "gearNotes": "Masters Premium all-maple shells speak with maximum articulation under blast conditions. AAX china provides the aggressive trash character essential to the Gothenburg riff-change accent vocabulary."
      },
      {
        ...
        "highlights": [
          ...
          "HHX crashes provide warm, musical accent character for more melodic sections",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson played an expanded Sabian AAX/HHX setup on Rise of the Tyrant (2007), incorporating the HHX series alongside the AAX line that had characterised his Anthems of Rebellion work. The configuration included 14\" HHX hi-hats (deeper, warmer character than AAX for groove-oriented verse playing), a 16\" HHX Evolution Crash (aged-alloy tonal complexity for musical left-side accent work), an 18\" AAX X-Plosion Crash (standard AAX/HHX warmth for larger structural accents), a 20\" HHX Evolution Ride (complex, warm texture for groove sections), an 18\" AAX China (aggressive trashy Gothenburg-style riff accents), and a 10\" AAX/HHX Splash. The multi-series AAX/HHX palette gave Rise of the Tyrant's cymbal work more tonal variety than any previous Arch Enemy album's cymbal setup."
      },
      {
  ...
  "khaos-legions-drum-setup": {
    ...
    "description": "Daniel Erlandsson's drum setup on Arch Enemy's Khaos Legions (2011) — Angela Gossow's final album, highest-charting Arch Enemy record (Sweden #4), Pearl Masterworks Custom shells, Sabian AAX/HHX cymbals, Pearl Eliminator pedals, and the closing statement of the Gossow era.",
    "seoKeywords": [
      "khaos legions drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Pearl Eliminator double bass pedal — the same cam-based foot technique foundation used across his entire Arch Enemy career",
        "Sabian cymbal relationship continued — complex AAX/HHX tonal palette at its 2011 form",
    ...
    "cymbals": {
      "title": "Sabian AAX / HHX: Erlandsson's 2011 Configuration",
      "brand": "Sabian",
      ...
      "setup": [
        {
          ...
          "model": "Sabian HHX 14\" Evolution Hi-Hats",
          "position": "Left side",
          "notes": "HHX — warm, complex hi-hat texture for the full dynamic range of Khaos Legions"
        },
        {
          "type": "Crash",
          "model": "Sabian HHX 16\" Evolution Crash",
          "position": "Left crash",
          "notes": "HHX warmth for musical, dynamically sensitive left-side accent work"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 18\" X-Plosion Crash",
          "position": "Right crash",
          "notes": "AAX for larger structural accent entry work"
        },
        {
          "type": "Ride",
          "model": "Sabian HHX 20\" Evolution Ride",
          "position": "Far right",
          "notes": "HHX — deep, complex ride texture for groove passage tonal contrast"
        },
        {
          "type": "China",
          "model": "Sabian AAX 18\" China",
          "position": "Over rack toms",
          "notes": "Aggressive AAX china for Gothenburg-style riff-transition accents"
        },
        {
          "type": "Splash",
          "model": "Sabian AAX 10\" Splash",
      ...
      "description": "The Sabian AAX/HHX cymbal setup that Daniel Erlandsson deployed on Khaos Legions represents the mature form of the AAX/HHX relationship he had developed across the previous albums — a configuration where the AAX and HHX series elements have been calibrated to deliver maximum tonal variety within a coherent overall palette. By 2011, Erlandsson's cymbal work with Sabian's AAX/HHX line had moved beyond the discovery phase of the Anthems era to a state of settled, precise configuration: he knew exactly what each cymbal was contributing to the Arch Enemy sound, and the Khaos Legions setup reflects that knowledge.\n\nThe HHX hi-hats and ride provide the warm, complex low-mid texture for Khaos Legions' more dynamically nuanced passages — the album's compositional variety includes quieter, more melodic sections that demand cymbal work with musical depth rather than aggressive brightness, and the HHX series' slower attack and longer wash suit these moments. The HHX crash contributes the aged-alloy warmth on the left side, giving the musical moment of crash accent work a rounded quality rather than the sharp, decisive attack of a new-alloy cymbal.\n\nThe AAX elements — the 18\" Medium Crash and the 18\" China — provide the more decisive character that the album's intense sections demand: the AAX crash speaks with direct impact for structural entry accents, and the China delivers the aggressive Gothenburg-style trashy character for riff transitions. Together the three-series AAX/HHX configuration gives the Khaos Legions cymbal work its characteristic combination of musical depth and aggressive punctuation — the tonal variety that matches the album's compositional range.",
      "estimatedValue": "$1,800-2,800 total (Sabian AAX/HHX setup, 2011)"
    },
    "hardware": {
      "title": "Hardware: Pearl Eliminator — Continued Foot Technique Foundation",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Consistent foot technique foundation for Khaos Legions — the same cam-based drive system used since the early 2000s",
          "description": "The Pearl Eliminator remained Daniel Erlandsson's foot technique foundation for Khaos Legions, exactly as it had been across the previous decade of studio albums and international touring. The Eliminator's interchangeable cam system lets the player tune the acceleration curve to personal technique, and that adjustable, consistent response continued to serve Erlandsson's double-kick work without change. For Khaos Legions' most demanding double-kick passages, that mechanical consistency provided the same reliable foot technique foundation it always had — a decade of accumulated familiarity with the pedal, rather than any hardware change, is what produced the confident foot-technique performances on the Khaos Legions sessions."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "HHX hi-hats provide the warm, articulate groove texture for the verse foundation"
        ],
        "gearNotes": "Masterworks Custom shells' coherent tonal identity is most audible in the verse passages where individual kit components speak in the mix. HHX hi-hats' warm, complex texture suits the restrained verse character."
      },
      {
        ...
        "highlights": [
          ...
          "Pearl Eliminator's familiar cam-based response audible in the sustained double-kick texture",
          "Blast beat architecture: deployed as structural intensification rather than constant texture",
          "AAX china accents mark riff-transition moments with aggressive Gothenburg character"
        ],
        "gearNotes": "Pearl Eliminator's cam-based response produces the same reliable kick texture that has defined Erlandsson's foot technique for over a decade. Masterworks Custom shells respond with precisely designed attack and body under full blast conditions."
      },
      {
        ...
        "highlights": [
          ...
          "HHX crash warmth in the melodic passage accent work",
          "Double-kick patterns follow guitar riff rhythmic contours in the tradition of Erlandsson's entire Arch Enemy career"
        ],
        "gearNotes": "HHX 16\" Evolution crash provides musical warmth for the melodic section entries. Masterworks Custom toms carry pitch definition through the melodic fill content."
      },
      {
        ...
        "highlights": [
          ...
          "HHX ride provides textural contrast in the track's groove-oriented mid-sections",
          "Erlandsson's compositional blast-beat deployment: structural events with musical context before and after"
        ],
        "gearNotes": "Pearl Eliminator mechanical consistency across extended double-kick sections. HHX 20\" Evolution ride warmth in the groove sections contrasts with the AAX crash brightness at full-intensity passages."
      }
    ],
    "faq": [
      {
        "question": "What drum kit did Daniel Erlandsson use on Arch Enemy's Khaos Legions?",
        "answer": "Daniel Erlandsson recorded Arch Enemy's Khaos Legions (2011) on a Pearl Masterworks Custom kit — Pearl's fully bespoke program where shells are built to the individual artist's specification rather than from production templates. The configuration maintained his established Arch Enemy setup: two 22\" x 18\" bass drums in a true double-kick configuration, 10\" and 12\" rack toms, 14\" and 16\" floor toms, and the Pearl Daniel Erlandsson Signature snare 14\" x 5.5\". His cymbal setup continued with Sabian AAX/HHX cymbals in the multi-series configuration developed across the previous albums. The Pearl Eliminator double bass pedal, his foot technique foundation since the early 2000s, remained unchanged. The album was produced by Andy Sneap at Backstage Studio. For the full Erlandsson gear context: [Daniel Erlandsson drum setup at MetalForge](/articles/daniel-erlandsson-drum-setup)."
      },
      {
      ...
      {
        "question": "What is the Pearl Eliminator double bass pedal and why has Daniel Erlandsson used it for so long?",
        "answer": "The Pearl Eliminator is a cam-based double bass pedal — its defining feature is an interchangeable cam system that lets a player swap cam profiles to adjust the acceleration curve between foot pressure and beater velocity, tuning the pedal's mechanical feel to personal technique. For Daniel Erlandsson, the Eliminator has been his foot technique foundation for his entire Arch Enemy career, from Wages of Sin (2002) through Khaos Legions (2011) and on to Deceivers (2022). That two-decade consistency means each stroke produces the same response whether on the first song of a tour or the last, or the first take of a session or the fiftieth — exactly the reliability that Arch Enemy's sustained double-kick material and demanding touring schedule require."
      },
      {
      ...
      },
      {
        ...
        "answer": "Khaos Legions (2011) closes the Angela Gossow era arc that began with Wages of Sin (2002) — a nine-year, five-album period that is the most commercially successful and critically recognised stretch of Arch Enemy's career. Across that arc, Daniel Erlandsson's setup evolved through Pearl Masters / Reference-era (Wages of Sin, 2002) → Pearl Masters MMX (Anthems of Rebellion, 2003) → Pearl Reference Pure (Doomsday Machine, 2005) → Pearl Masters Premium (Rise of the Tyrant, 2007) → Pearl Masterworks Custom (Khaos Legions, 2011), from Sabian AA/HH cymbals through Sabian AAX to the full AAX/HHX multi-series palette, with the Pearl Eliminator as the constant foot technique foundation throughout. Each album documents a chapter in Erlandsson's professional development as well as Arch Enemy's commercial arc. Khaos Legions' fully bespoke Masterworks Custom kit and multi-series AAX/HHX setup represent the apex of that evolution within the Gossow era. For the full discography chain: [Wages of Sin (2002)](/articles/wages-of-sin-drum-setup) · [Anthems of Rebellion (2003)](/articles/anthems-of-rebellion-drum-setup) · [Doomsday Machine (2005)](/articles/doomsday-machine-drum-setup) · [Rise of the Tyrant (2007)](/articles/rise-of-the-tyrant-drum-setup)."
      }
    ],
    "relatedAlbums": [
      "rise-of-the-tyrant-drum-setup",
  ...
  "war-eternal-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AAX/HHX cymbal palette — hand-hammered B20 bronze complexity",
        "Pearl Eliminator double bass pedal — cam-based mechanics consistent across his entire career",
      ...
      "items": [
        {
          ...
          "description": "The Pearl Eliminator, Erlandsson's foot technique foundation since the early 2000s, continued as his double bass pedal for War Eternal and the entire White-Gluz era. The Eliminator's interchangeable cam system — letting the player tune the acceleration curve between foot pressure and beater velocity — provides the consistent, reliable response his technique depends on. War Eternal's most intensive double-kick sections ('You Will Know My Name', 'Avalanche') rely on that mechanical reliability across full performance demands."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson used his Pearl Reference Pure kit on War Eternal (2014) — the same all-maple flagship Pearl shell configuration that had defined his Arch Enemy setup since Doomsday Machine (2005). The drum configuration maintained his established standard: two 22\" x 18\" bass drums in a true double-kick setup, 10\" and 12\" rack toms, 14\" and 16\" floor toms. His signature Pearl Daniel Erlandsson Signature snare (14\" x 5.5\") continued as the snare, and Sabian AAX/HHX cymbals provided the hand-hammered B20 bronze palette that Jens Bogren's Fascination Street Studio production captured with particular depth. The Pearl Eliminator double bass pedal, his foot technique foundation since the early 2000s, remained unchanged. For the full Erlandsson gear timeline: [Daniel Erlandsson drum setup at MetalForge](/articles/daniel-erlandsson-drum-setup)."
      },
      {
  ...
  "will-to-power-drum-setup": {
    ...
    "cymbals": {
      ...
      "setup": [
        {
          "type": "Hi-Hats",
          "model": "Sabian AAX/HHX 14\" Hi-Hats",
          "position": "Left side",
      ...
      "description": "The Sabian AAX/HHX setup on Will to Power represents Erlandsson's most musically integrated cymbal work in the Arch Enemy studio discography. The hand-hammered B20 bronze complexity of the HHX line is particularly well-served by Jens Bogren's polished Fascination Street production — the cymbals' overtone-rich character, musical sustain, and tonal warmth translate naturally into a mix environment that values dynamic complexity over maximum brightness.\n\nBy Will to Power, Erlandsson's AAX/HHX palette had been his consistent cymbal configuration for over a decade, and the deep familiarity with how each component responds in a studio context gave his cymbal work on this album a particularly assured character. The AAX/HHX hi-hats provide warm, articulate rhythmic foundation; the HHX crashes give section entries the musical body that Bogren's production context rewards; the Dark ride delivers the textural contrast point that separates groove-oriented passages from the more aggressive crash-heavy sections.",
      "estimatedValue": "$1,800–3,000 (full Sabian AAX/HHX setup)"
    },
    "hardware": {
  ...
  "deceivers-drum-setup": {
    ...
    "cymbals": {
      ...
      "description": "Erlandsson's Sabian AAX/HHX cymbal setup on Deceivers represents the most sophisticated capture of his cymbal palette in the entire Arch Enemy studio discography. By the third Fascination Street production (2022), Jens Bogren's deep familiarity with both Erlandsson's AAX/HHX setup and Fascination Street's acoustic environment allowed for the most nuanced tonal shaping of any Arch Enemy album: the hi-hats' complex B20 character preserved with full warmth, the crash cymbals' musical sustain integrated into the mix with sophisticated balance, the dark ride's textural depth captured as a true tonal contrast point rather than a secondary accent choice.\n\nDeceivers' compositional variety places the cymbal setup's full range in play across a single album in a way that no previous Arch Enemy record had done to quite the same degree. The album's more melodic passages — 'Poisoned Arrow,' 'One Last Time,' 'In the Eye of the Storm' — ask the cymbals to function as musical elements rather than pure accent markers. The HHX series' hand-hammered complexity serves those passages well: the overtone-rich character, musical sustain, and tonal warmth that Sabian's HHX line delivers integrate naturally into melodic arrangements in a way that brighter, faster-decaying cymbals could not.",
      "estimatedValue": "$1,800–3,000 (full Sabian AAX/HHX setup)"
    },
    "hardware": {
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Cam-based mechanics — two decades of consistency from Wages of Sin (2002) to Deceivers (2022)",
          "description": "The Pearl Eliminator had served as Erlandsson's primary foot technique tool since the early 2000s, through the Gossow era and the entire White-Gluz era alike. By Deceivers (2022), the cam-based pedal had accumulated two decades of touring and studio use — the physical familiarity between Erlandsson and the Eliminator's mechanical response was at its peak. The pedal's consistent cam-tuned acceleration curve provided the reliable double-kick character that Deceivers' most intensive passages demanded, executing the band's sustained double-kick patterns with the same efficiency that had characterised Erlandsson's foot technique across all three White-Gluz era albums."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
