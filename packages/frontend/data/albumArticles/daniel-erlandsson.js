...
export const articles = {
  "daniel-erlandsson-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AAX/HHX Series cymbals — AAX brightness for projection, HHX complexity for musical context",
    ...
    "playingStyle": {
      ...
      "keyTechniques": [
        ...
        "Pearl Eliminator cam-drive response for consistent double-kick across multi-year international touring"
      ]
    },
    "gearTimeline": [
      {
      ...
      },
      {
        ...
        "gear": {
          ...
          "cymbals": "Sabian AA and HH series (full setup established)",
      ...
      },
      {
        ...
        "notes": "War Eternal (2014) introduced Alissa White-Gluz as vocalist, sustaining Arch Enemy's global profile through another decade. Will to Power (2017) represented the band's commercial peak. Through this period, Erlandsson's setup refined further — Sabian's AAX/HHX series replacing the earlier AA/HH configuration, with the Eliminator pedal and ProMark sticks continuing unchanged. Deceivers (2022) continued the trajectory with the same professional reliability that characterizes his entire career with the band."
      }
    ],
    "faq": [
      {
  ...
  "anthems-of-rebellion-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AA/HH cymbals — bright B20 bronze attack and darker tonal complexity for studio and touring work",
    ...
    "cymbals": {
      "title": "Sabian AA/HH: Daniel Erlandsson's 2003 Cymbal Setup",
      "brand": "Sabian",
      "series": "Sabian AA and HH Series",
      "setup": [
        {
          ...
          "model": "Sabian AA 14\" Rock Hi-Hats",
          "position": "Left side",
          "notes": "Bright, cutting AA articulation for verse groove and blast accompaniment"
        },
        {
          "type": "Crash",
          "model": "Sabian AA 16\" Medium Crash",
        ...
        },
        {
          ...
          "model": "Sabian HH 20\" Heavy Ride",
          "position": "Far right",
          "notes": "Defined stick articulation with darker HH tonal complexity for groove passage ride work"
        },
        {
          "type": "China",
          "model": "Sabian AA 18\" Mini China",
      ...
      "description": "Daniel Erlandsson's Sabian setup on Anthems of Rebellion continues the AA/HH pairing established on Wages of Sin — the AA series delivering bright B20 bronze attack and cutting projection, the HH series providing darker, hand-hammered tonal complexity. The AA/HH combination remained the standard professional metal configuration through the Gossow era: durable enough for tour-grade abuse, articulate enough for studio tracking, and tonally varied enough to give the drummer real musical range across a single recording.\n\nFor Arch Enemy's Anthems of Rebellion sessions, that tonal range suits the album's more melodic compositional direction. The AA crashes cut cleanly above Amott's layered guitar harmonics, while the HH ride provides a textured canvas for groove passages that feels compositionally integrated rather than purely functional.\n\nThe 14\" AA Rock hi-hats drive the album's rhythmic foundation with the articulate clarity Sabian's AA line is known for — every stroke registers distinctly even within the blast beat passages, where hi-hat definition separates competent drumming from exceptional drumming. The 16\" and 18\" crash configuration provides the accent range from fast-decay structural markers to a longer, more sustained crash voice for the bigger section moments on \"We Will Rise.\"\n\nThe AA 18\" Mini China maintains the Gothenburg melodic death metal china accent vocabulary that Erlandsson established on earlier albums — the aggressive, trashy character for riff transitions and dynamic punctuation. And the HH 20\" Heavy Ride provides the low-frequency texture that the more spacious passages on Anthems require, offering a contrasting sonic character to the crashes that expands the album's tonal palette.",
      "estimatedValue": "$1,500-2,200 total (Sabian AA/HH studio configuration, 2003)"
    },
    "hardware": {
    ...
    "soundCharacter": {
      ...
      "content": "The drum sound on Anthems of Rebellion is distinctly warmer than the Wages of Sin production — the Pearl Masters MMX mixed-shell character gives the kit more low-mid body and tonal depth than the brighter, more focused Pearl Masters / Reference-era kit of the previous album. This warmth is not softness: the Studio Fredman close-mic approach maintains the attack and articulation that melodic death metal demands, but the overall tonal character has more musical roundness that suits the album's more harmonically developed guitar arrangements.\n\nThe kick drum sound on Anthems carries more sub-bass body than Wages of Sin — the MMX shells' mahogany contribution in the low end gives the two 22\"x18\" bass drums a fuller, rounder fundamental that sits differently in the mix. The snare retains the brass-shell brightness and cut that allows it to speak above the guitar density. The Sabian AA/HH cymbals carry the same bright-attack-with-darker-ride contrast established on Wages of Sin, giving the album's cymbal work a musically integrated character within the fuller overall arrangement.",
      "keyAttributes": [
        "Pearl Masters MMX warmth — mahogany contribution adds low-mid body and tonal depth",
        "Sabian AA/HH continuity — the same bright-attack, darker-ride pairing established on Wages of Sin",
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "Sabian AA crashes provide the bright accent wash for the chorus entries. MMX warmth suits the melodic verse groove. Pearl Eliminator double-kick consistency drives the verse-to-chorus momentum build."
      },
      {
        ...
        "highlights": [
          ...
          "China cymbal accents from the AA 18\" Mini China mark riff transitions in classic Gothenburg style"
        ],
      ...
      },
      {
        ...
        "highlights": [
          ...
          "HH ride on the Sabian HH 20\" Heavy Ride provides the textural contrast for groove-oriented sections",
        ...
        "gearNotes": "HH ride warmth contrasts with AA crash brightness across the dynamic range. MMX shell body carries well in the more spacious arrangement of the mid-tempo sections."
      },
      {
        "track": "Burning Angel",
        "bpm": "160-175",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson played Sabian AA and HH cymbals on Anthems of Rebellion (2003), continuing the same setup he had used on Wages of Sin (2002). His configuration included 14\" AA Rock hi-hats for verse groove articulation, 16\" AA Medium Crash and 18\" AA Rock Crash cymbals for section-entry accents, a 20\" HH Heavy Ride for groove-oriented passage texture, an 18\" AA Mini China for the trashy Gothenburg-style riff-transition accents, and a 10\" AA Splash for fast syncopated accents. The AA/HH pairing suited the more melodically developed arrangements of Anthems of Rebellion, the bright AA attack cutting cleanly above Amott's layered guitar harmonics and the HH ride providing musical depth for groove-oriented passages."
      },
      {
  ...
  "rise-of-the-tyrant-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AA/HH cymbal setup — consistent bright-and-dark tonal pairing continued from previous albums",
    ...
    "cymbals": {
      "title": "Sabian AA/HH: Erlandsson's 2007 Cymbal Setup",
      "brand": "Sabian",
      "series": "Sabian AA and HH Series",
      "setup": [
        {
        ...
        },
        {
          ...
          "model": "Sabian AA 16\" Medium Crash",
          "position": "Left crash",
          "notes": "Fast attack and decay for accent work in high-velocity melodic passages"
        },
        {
          "type": "Crash",
          "model": "Sabian AA 18\" Medium Crash",
      ...
      "description": "Daniel Erlandsson's Sabian AA/HH setup on Rise of the Tyrant continues the same pairing that had defined his cymbal work since Wages of Sin — the AA series delivering bright, cutting attack for hi-hats and crashes, the HH series providing darker, more complex tonal contrast for the ride. Andy Sneap's production approach at Backstage Studio captures this setup with the same discipline and clarity that had characterised the previous two albums.\n\nThe 14\" AA Rock hi-hats anchor Erlandsson's rhythmic pulse across Rise of the Tyrant's tempo range — from the driving mid-tempo grooves of \"Revolution Begins\" through the higher-velocity material of \"Blood on Your Hands.\" The AA crashes provide the upper-frequency projection needed to cut through Michael Amott's layered guitar production, while the HH 22\" Medium Ride introduces tonal contrast in groove-oriented passages where the brighter crash character would be too aggressive.\n\nThe consistency of the AA/HH setup across five studio albums by 2007 — Wages of Sin, Anthems of Rebellion, Doomsday Machine, and now Rise of the Tyrant — reflects Erlandsson's long-standing Sabian artist relationship. The setup's durability and tonal range have made it the reliable foundation for his cymbal work across the entire Angela Gossow era.",
      "estimatedValue": "$1,600-2,800 total (Sabian AA/HH full setup, 2007)"
    },
    "hardware": {
    ...
    "soundCharacter": {
      ...
      "keyAttributes": [
        ...
        "Sabian AA/HH tonal range — consistent bright-and-dark cymbal pairing for mainstream melodic death metal",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "Hi-hat articulation on the AA 14\" Rock Hi-Hats drives the groove-forward verse feel"
        ],
      ...
      },
      {
        ...
        "highlights": [
          ...
          "AA china accents mark riff-transition moments with aggressive Gothenburg character"
        ],
        "gearNotes": "Masters Premium all-maple shells speak with maximum articulation under blast conditions. AA china provides the aggressive trash character essential to the Gothenburg riff-change accent vocabulary."
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson played Sabian AA and HH cymbals on Rise of the Tyrant (2007), continuing the same pairing that had characterised his setup since Wages of Sin (2002). The configuration included 14\" AA Rock hi-hats, a 16\" AA Medium Crash and an 18\" AA Medium Crash for structural accents, a 22\" HH Medium Ride for groove-section tonal contrast, an 18\" AA Chinese for aggressive trashy Gothenburg-style riff accents, and a 10\" AA Splash. The AA/HH pairing gave Rise of the Tyrant's cymbal work the same tonal variety that had defined every Erlandsson Arch Enemy album since the Gossow era began."
      },
      {
        "question": "How does Rise of the Tyrant compare to Doomsday Machine and Khaos Legions in Erlandsson's discography?",
        "answer": "Rise of the Tyrant (2007) sits between Doomsday Machine (2005) and Khaos Legions (2011) as the commercial peak of the Angela Gossow era and the midpoint of Erlandsson's most documented decade as a professional drummer. Compared to Doomsday Machine, Rise of the Tyrant has a more commercially polished production and a more melodically accessible composition style — the Guitar Hero crossover confirms the album's mainstream reach. Compared to Khaos Legions (2011), Rise of the Tyrant is more energetically consistent, while Khaos Legions features the more varied compositional architecture and the Pearl Masterworks Custom configuration that represents Erlandsson's most refined kit. Together the three albums document the full arc of the Gossow era's commercial expansion and Erlandsson's gear evolution through some of melodic death metal's most consequential records. For the follow-up: [Khaos Legions drum setup (2011)](/articles/khaos-legions-drum-setup)."
      },
      {
  ...
  "khaos-legions-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Pearl Eliminator double bass pedal — continued foot technique foundation across the entire Gossow era",
        "Sabian AA/HH cymbal setup continued — the same bright-and-dark tonal pairing used since Wages of Sin",
    ...
    "cymbals": {
      ...
      "brand": "Sabian",
      "series": "Sabian AA and HH Series (2011 configuration)",
      "setup": [
        {
          "type": "Hi-Hats",
          "model": "Sabian AA 14\" Rock Hi-Hats",
          "position": "Left side",
          "notes": "Bright, cutting AA hi-hat texture for the full dynamic range of Khaos Legions"
        },
        {
          "type": "Crash",
          "model": "Sabian AA 16\" Medium Crash",
          "position": "Left crash",
          "notes": "Fast attack for musical, dynamically sensitive left-side accent work"
        },
        {
          "type": "Crash",
          "model": "Sabian AA 18\" Medium Crash",
          "position": "Right crash",
          "notes": "Fuller AA crash for larger structural accent entry work"
        },
        {
          "type": "Ride",
          "model": "Sabian HH 20\" Ride",
          "position": "Far right",
          "notes": "Dark, complex HH ride texture for groove passage tonal contrast"
        },
        {
          "type": "China",
          "model": "Sabian AA 18\" China",
          "position": "Over rack toms",
          "notes": "Aggressive AA china for Gothenburg-style riff-transition accents"
        },
        {
          "type": "Splash",
          "model": "Sabian AA 10\" Splash",
      ...
      "description": "The Sabian AA/HH setup that Daniel Erlandsson deployed on Khaos Legions represents the mature, settled form of the cymbal relationship he had maintained across every previous album — a configuration where the AA and HH elements have been calibrated to deliver maximum tonal variety within a coherent overall palette. By 2011, Erlandsson's cymbal work with Sabian had moved well past the early-career configuration to a state of settled, precise application: he knew exactly what each cymbal was contributing to the Arch Enemy sound, and the Khaos Legions setup reflects that knowledge.\n\nThe AA hi-hats and crashes provide the bright, cutting texture for Khaos Legions' more dynamically nuanced passages — the album's compositional variety includes quieter, more melodic sections alongside the aggressive intensity peaks, and the AA series' fast attack and clean decay suit both. The HH ride contributes the warm, complex low-mid texture on the other end of the tonal spectrum, giving the musical moments of groove-oriented playing a rounded quality distinct from the crash brightness.\n\nTogether the AA/HH configuration gives the Khaos Legions cymbal work its characteristic combination of musical depth and aggressive punctuation — the tonal variety that matches the album's compositional range, continuing unchanged from the setup Erlandsson has used since Wages of Sin.",
      "estimatedValue": "$1,600-2,800 total (Sabian AA/HH setup, 2011)"
    },
    "hardware": {
      "title": "Hardware: Pearl Eliminator — The Continued Foot Technique Foundation",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Long-standing foot technique foundation for Khaos Legions — cam-adjustable system providing continued mechanical consistency",
          "description": "The Pearl Eliminator has remained the foundation of Daniel Erlandsson's foot technique across his entire Arch Enemy career, and Khaos Legions is no exception. The Eliminator's interchangeable cam system — swappable cam profiles that adjust the acceleration curve — lets Erlandsson tune the pedal's mechanical feel to his specific technique. For Khaos Legions' most demanding double-kick passages, the Eliminator's mechanical consistency provides the same reliable foundation it has delivered since Wages of Sin, more than a decade of accumulated familiarity between drummer and pedal contributing to the precision of the performance."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "AA hi-hats provide the bright, articulate groove texture for the verse foundation"
        ],
        "gearNotes": "Masterworks Custom shells' coherent tonal identity is most audible in the verse passages where individual kit components speak in the mix. AA hi-hats' bright, clean texture suits the restrained verse character."
      },
      {
        ...
        "highlights": [
          ...
          "Pearl Eliminator's mechanical consistency audible in the sustained double-kick texture",
          "Blast beat architecture: deployed as structural intensification rather than constant texture",
          "AA china accents mark riff-transition moments with aggressive Gothenburg character"
        ],
        "gearNotes": "Pearl Eliminator's cam-driven response continues the mechanical consistency established since Wages of Sin. Masterworks Custom shells respond with precisely designed attack and body under full blast conditions."
      },
      {
        ...
        "highlights": [
          ...
          "AA crash brightness in the melodic passage accent work",
          "Double-kick patterns follow guitar riff rhythmic contours in the tradition of Erlandsson's entire Arch Enemy career"
        ],
        "gearNotes": "AA 16\" Medium Crash provides musical brightness for the melodic section entries. Masterworks Custom toms carry pitch definition through the melodic fill content."
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson used the Pearl Eliminator double bass pedal on Khaos Legions (2011), the same pedal that had served as his foot technique foundation since Wages of Sin (2002). The Eliminator's interchangeable cam system allows players to swap cam profiles for different acceleration characters, letting Erlandsson tune the pedal's mechanical feel to his specific double-kick technique. By Khaos Legions, more than a decade of accumulated familiarity between drummer and pedal had refined the mechanical consistency to its most precise form, evident across the album's most demanding double-kick passages."
      },
      {
  ...
  "war-eternal-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AAX/HHX cymbal setup — refined from the AA/HH pairing used through the Gossow era",
        "Pearl Eliminator double bass pedal — consistent foot technique foundation since the early 2000s",
    ...
    "cymbals": {
      "title": "Sabian AAX/HHX: Refined Brightness for the White-Gluz Era",
      "brand": "Sabian",
      "series": "Sabian AAX/HHX Series",
      "setup": [
        {
          ...
          "model": "Sabian AAX 14\" Hi-Hats",
          "position": "Left side",
          "notes": "Bright, cutting AAX articulation for melodic passages and fast patterns"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 16\" Crash",
          "position": "Left crash",
          "notes": "Fast, bright attack — section entry accents in melodic-oriented arrangements"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 18\" Crash",
      ...
      "description": "Erlandsson's cymbal setup on War Eternal marks the one documented refinement point in his Sabian relationship — moving from the AA/HH pairing that had defined the entire Angela Gossow era to the brighter AAX crashes and darker HHX ride. The move coincided with the vocalist transition and Jens Bogren's new production approach at Fascination Street Studio, giving the White-Gluz era a subtly distinct cymbal character alongside its new production identity.\n\nThe AAX hi-hats and crashes anchor Erlandsson's rhythmic work with the same bright, cutting articulation that has always defined the AA-family Sabian cymbals, now in AAX's more contemporary voicing — well suited to the melodic richness of the White-Gluz-era arrangements. The HHX ride provides the textural contrast point, its darker, more complex character giving Erlandsson a musically distinct option for the album's more spacious groove passages.",
      "estimatedValue": "$1,800–3,000 (full Sabian AAX/HHX setup)"
    },
    "hardware": {
      "title": "Pearl Eliminator: Continued Consistency for the White-Gluz Era",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Cam-adjustable mechanics — consistent double-kick across White-Gluz era touring",
          "description": "The Pearl Eliminator, Erlandsson's double bass pedal since the early 2000s, continued through War Eternal and the entire White-Gluz era. The Eliminator's interchangeable cam system provides a consistent, adjustable acceleration curve tuned to Erlandsson's technique. War Eternal's most intensive double-kick sections ('You Will Know My Name', 'Avalanche') rely on the Eliminator's mechanical reliability across full performance demands."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson used his Pearl Reference Pure kit on War Eternal (2014) — the same all-maple flagship Pearl shell configuration that had defined his Arch Enemy setup since Doomsday Machine (2005). The drum configuration maintained his established standard: two 22\" x 18\" bass drums in a true double-kick setup, 10\" and 12\" rack toms, 14\" and 16\" floor toms. His signature Pearl Daniel Erlandsson Signature snare (14\" x 5.5\") continued as the snare, and his refined Sabian AAX/HHX cymbal setup provided the bright-and-dark tonal palette that Jens Bogren's Fascination Street Studio production captured with particular depth. The Pearl Eliminator double bass pedal, his foot technique foundation since the early 2000s, remained unchanged. For the full Erlandsson gear timeline: [Daniel Erlandsson drum setup at MetalForge](/articles/daniel-erlandsson-drum-setup)."
      },
      {
  ...
  "will-to-power-drum-setup": {
    ...
    "cymbals": {
      ...
      "setup": [
        {
          ...
          "model": "Sabian AAX 14\" Hi-Hats",
          "position": "Left side",
          "notes": "Bright AAX articulation — cutting, musical rhythmic foundation"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 16\" Crash",
          "position": "Left crash",
          "notes": "Fast, bright sustain for melodically rich section entries"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 18\" Crash",
        ...
        },
        {
          ...
          "model": "Sabian HHX 20\" Ride",
          "position": "Right side",
          "notes": "Dark, complex tonal depth for groove passages — musical contrast from the crash brightness"
        },
        {
          "type": "China",
          "model": "Sabian AAX 18\" China",
      ...
      "description": "The Sabian AAX/HHX setup on Will to Power represents Erlandsson's most musically integrated cymbal work in the Arch Enemy studio discography. The AAX series' bright, cutting attack and the HHX series' darker complexity are particularly well-served by Jens Bogren's polished Fascination Street production — the cymbals' character translates naturally into a mix environment that values dynamic complexity over maximum brightness alone.\n\nBy Will to Power, Erlandsson's AAX/HHX palette — refined from the AA/HH pairing on War Eternal three years earlier — had settled into its mature form, and the deep familiarity with how each component responds in a studio context gave his cymbal work on this album a particularly assured character. The AAX hi-hats provide bright, articulate rhythmic foundation; the AAX crashes give section entries the sustained body that Bogren's production context rewards; the HHX ride delivers the textural contrast point that separates groove-oriented passages from the more aggressive crash-heavy sections.",
      "estimatedValue": "$1,800–3,000 (full Sabian AAX/HHX setup)"
    },
    "hardware": {
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Cam-adjustable mechanics — consistent double-kick across years of White-Gluz era touring",
          "description": "The Pearl Eliminator continued as Erlandsson's primary foot technique tool on Will to Power. The cam-adjustable system's consistent acceleration curve produced the reliable double-kick character that Will to Power's most intensive passages required — the same mechanical consistency that had served him since the early 2000s, now with additional years of touring familiarity adding physical certainty to the foot technique."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
  ...
  "deceivers-drum-setup": {
    ...
    "cymbals": {
      ...
      "setup": [
        {
          ...
          "model": "Sabian AAX 14\" Hi-Hats",
          "position": "Left side",
          "notes": "Bright AAX articulation — most nuanced hi-hat capture of the Arch Enemy discography"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 16\" Crash",
          "position": "Left crash",
          "notes": "Bright, cutting attack for the album's melodically rich section entries"
        },
        {
          "type": "Crash",
          "model": "Sabian AAX 18\" Crash",
      ...
      "description": "Erlandsson's Sabian AAX/HHX cymbal setup on Deceivers represents the most sophisticated capture of his cymbal palette in the entire Arch Enemy studio discography. By the third Fascination Street production (2022), Jens Bogren's deep familiarity with both Erlandsson's AAX/HHX setup and Fascination Street's acoustic environment allowed for the most nuanced tonal shaping of any Arch Enemy album: the hi-hats' bright character preserved with full clarity, the crash cymbals' sustain integrated into the mix with sophisticated balance, the HHX ride's textural depth captured as a true tonal contrast point rather than a secondary accent choice.\n\nDeceivers' compositional variety places the cymbal setup's full range in play across a single album in a way that no previous Arch Enemy record had done to quite the same degree. The album's more melodic passages — 'Poisoned Arrow,' 'One Last Time,' 'In the Eye of the Storm' — ask the cymbals to function as musical elements rather than pure accent markers. The AAX/HHX pairing's bright-and-dark tonal range serves those passages well: the cutting AAX attack and the darker HHX complexity integrate naturally into melodic arrangements in a way a single-character cymbal line could not.",
      "estimatedValue": "$1,800–3,000 (full Sabian AAX/HHX setup)"
    },
    "hardware": {
      "title": "Pearl Eliminator in 2022: Two Decades of Consistency",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Cam-adjustable mechanics — two decades of consistency from the early 2000s to Deceivers (2022)",
          "description": "The Pearl Eliminator has served as Erlandsson's primary foot technique tool since the early 2000s, through the entire Gossow and White-Gluz eras. By Deceivers (2022), the cam-driven pedal had accumulated two decades of touring and studio use — the physical familiarity between Erlandsson and the Eliminator's mechanical response was at its peak. The pedal's consistent, cam-adjustable acceleration curve provided the reliable double-kick character that Deceivers' most intensive passages demanded, executing the band's sustained double-kick patterns with the same efficiency that had characterised Erlandsson's foot technique across all three White-Gluz era albums."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
