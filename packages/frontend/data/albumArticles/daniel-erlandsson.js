...
export const articles = {
  "daniel-erlandsson-drum-setup": {
    ...
    "description": "Daniel Erlandsson's complete drum setup for Arch Enemy — Pearl Reference Pure, Paiste RUDE and 2002 Series cymbals, Pearl Demon Drive pedal, and his signature snare. Gothenburg melodic death metal drum gear breakdown.",
    "seoKeywords": [
      "daniel erlandsson drum setup",
      "arch enemy drummer",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Paiste RUDE and 2002 Series cymbals — RUDE brightness for projection, 2002 Series complexity for musical context",
    ...
    "cymbals": {
      "title": "Paiste RUDE and 2002 Series: Brightness and Complexity for Melodic Death Metal",
      "brand": "Paiste",
      ...
      "setup": [
        ...
        },
        {
          ...
          "position": "Right side",
          "notes": "Cutting RUDE power ride providing weight and projection for sustained groove passages"
        }
      ],
      "description": "Daniel Erlandsson's Paiste setup pairs the RUDE and 2002 Series — durable, cutting cymbal lines built for the volume and abuse of professional metal touring. The RUDE series delivers the defined, cutting attack that his hi-hats and crash cymbals require in Arch Enemy's dense guitar environment, while the 2002 Series contributes tonal depth and complexity to round out the full setup.\n\nThe logic mirrors a distinction common among serious melodic death metal drummers: crash cymbals need to project through the mix with fast attack and clear articulation, while the rest of the setup needs to provide something texturally different for the passages where sustained groove replaces explosive intensity. Pairing RUDE and 2002 Series cymbals accomplishes both without requiring Erlandsson to switch cymbal manufacturers mid-performance.\n\nThe 14\" RUDE hi-hats anchor his rhythmic pulse in Arch Enemy's tempo range — from the driving mid-tempo grooves of \"We Will Rise\" through the higher-velocity material of \"Enemy Within\" and the band's most aggressive catalog entries. RUDE's fast, focused decay means every hi-hat stroke registers distinctly in the mix, even as guitar layering competes for frequency space. This definition is not incidental: in melodic death metal, where rhythmic precision distinguishes credibility from approximation, every component of the cymbal setup's clarity matters.",
      "estimatedValue": "$1,600–2,800 (full Paiste RUDE and 2002 Series setup)"
    },
    "hardware": {
    ...
    "playingStyle": {
      ...
      "keyTechniques": [
        ...
        "Pearl Demon Drive consistency for consistent double-kick across multi-year international touring"
      ]
    },
    "gearTimeline": [
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson plays Paiste RUDE and 2002 Series cymbals. His setup pairs the RUDE series — Paiste's durable, cutting professional line — for hi-hats and crash cymbals, with the 2002 Series rounding out the setup with tonal depth. The 14\" RUDE hi-hats provide fast, defined attack for rapid 16th-note patterns at Arch Enemy's tempos. RUDE crashes deliver the upper-frequency projection needed to cut through Michael Amott's layered guitar production. The 22\" RUDE Power Ride introduces weight and projection in groove-oriented passages where the brighter crash character would be too aggressive. The pairing of two series within one cymbal setup is a deliberate tonal choice that gives Erlandsson musical range across Arch Enemy's dynamic spectrum."
      },
      {
        "question": "What bass drum pedal does Daniel Erlandsson use?",
        "answer": "Daniel Erlandsson uses the Pearl Demon Drive double bass pedal. As Pearl's flagship double pedal, the Demon Drive is built for the durability and mechanical consistency that sustained double-kick work across long live sets and extensive world touring demands: each stroke produces the same response on the final song of a tour as on the first. The Pearl Demon Drive has been Erlandsson's primary foot tool across Arch Enemy's career, providing the reliability that multi-year international touring schedules require. For double bass pedal technique context: [double-bass drumming at MetalForge](/technique/double-bass-drumming)."
      }
    ],
    "relatedAlbums": [
  ...
  "wages-of-sin-drum-setup": {
    ...
    "cymbals": {
      "title": "Paiste RUDE and 2002 Series: Daniel Erlandsson's Workhorse 2002 Cymbal Setup",
      "brand": "Paiste",
      ...
      "setup": [
        ...
        {
          "type": "Splash",
          "model": "Paiste 2002 Series 10\" Splash",
          "position": "Above hi-hats",
          "notes": "Short, bright accent for syncopated fill content and small dynamic punctuation"
        }
      ],
      "description": "Daniel Erlandsson has been a long-standing Paiste artist, and his 2002 cymbal setup for Wages of Sin draws from Paiste's professional lines: the RUDE series, with its raw, cutting attack and projection, and the 2002 Series, with its tonal depth and complexity. The RUDE/2002 pairing was a standard professional metal configuration of the era — durable enough for tour-grade abuse, articulate enough for studio tracking, and tonally varied enough to give the drummer real musical range across a single recording.\n\nThe 14\" RUDE Hi-Hats are central to the album's drum identity. Erlandsson's hi-hat work on Wages of Sin moves between driving 8th-note patterns under verse riffs, rapid 16th-note articulation in chorus and transition sections, and tight closed-hat blast accompaniment. The RUDE weight gives the cymbals the body needed to cut through the album's dense guitar mix without disappearing — and the cutting character delivers the immediate stick definition that close-mic studio capture demands.\n\nThe RUDE crash cymbals provide the upper-frequency accent palette. The 18\" Crash speaks fast and decays quickly — ideal for the rapid accent work in melodic-passage transitions. The 19\" Crash delivers a fuller, more sustained crash voice for major structural moments, including the chorus entries on \"Ravenous\" and the section transitions on \"Heart of Darkness.\" Both cymbals carry the cutting power needed to project above Sneap's layered guitar production without requiring heavy EQ correction in the mix.\n\nThe RUDE 22\" Power Ride provides the tonal contrast point in the setup. Where the RUDE crashes are bright and cutting, the Power Ride delivers a darker, more complex character that gives the setup extra tonal depth. On groove-oriented sections — the more spacious passages on \"Dead Bury Their Dead\" and the bridge on \"Behind the Smile\" — the Power Ride's defined stick articulation gives Erlandsson a tonally distinct option from the brighter RUDE crashes, expanding the album's textural range.\n\nThe 2002 Series 10\" Splash rounds out the accent vocabulary, providing shorter accent texture for syncopated fill content where a full crash would be too long. Together the five-cymbal setup gives Erlandsson the full range of accent options the album's compositional density demands.",
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Daniel Erlandsson's long-term double bass pedal — Pearl's flagship double pedal, built for durability and mechanical consistency",
          "description": "The Pearl Demon Drive was Daniel Erlandsson's primary foot technique tool through the early 2000s and remains a centerpiece of his rig today. As Pearl's flagship double pedal, the Demon Drive is built for durability and mechanical consistency across long touring schedules. For Wages of Sin's sustained double-kick patterns — particularly the extended sections on \"Ravenous\" and \"Enemy Within\" — that mechanical consistency was essential. Each stroke produces the same response across a full tracking day, the kind of reliability extended studio sessions require."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
        ...
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
          "model": "American Classic 5B hickory drumsticks",
    ...
    "soundCharacter": {
      ...
      "keyAttributes": [
        ...
        "Paiste RUDE brightness with 2002 Series darker contrast across the cymbal palette"
      ]
    },
    "trackAnalysis": [
      {
      ...
      },
      {
        ...
        "gearNotes": "The RUDE crash voices come to the front in the chorus sections. Hi-hat articulation drives the verse groove."
      },
      {
        ...
        "gearNotes": "The Power Ride enters during the more spacious bridge sections. Tom fills demonstrate the four-tom range. Bass drum patterns lock to the riff articulation throughout."
      },
      {
        ...
        "highlights": [
          ...
          "Crash cymbal accents punctuate riff transitions in the Gothenburg style",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson played Paiste cymbals on Wages of Sin, combining the RUDE and 2002 professional series. The setup typically included 14\" RUDE Hi-Hats for cutting articulation, 18\" and 19\" RUDE Crashes for accent and section-marker work, a 2002 Series 10\" Splash for shorter syncopated accents, and a 22\" RUDE Power Ride providing darker tonal contrast for groove-oriented passages and ride patterns. The RUDE series delivered the bright, cutting attack that cut through Andy Sneap's dense mix; the 2002 Series added tonal complexity that gave Erlandsson musical range across the album's compositional variety. Erlandsson has been a long-standing Paiste artist throughout his Arch Enemy career."
      }
    ],
    "relatedAlbums": [
  ...
  "doomsday-machine-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Paiste RUDE and 2002 Series cymbal setup providing the brightness and complexity Andy Sneap's production captured"
      ]
    },
    "drumKit": {
    ...
    "cymbals": {
      ...
      "setup": [
        ...
        },
        {
          ...
          "model": "Paiste RUDE 22\" Power Ride",
          "position": "Right side",
          "notes": "Dark, complex character contrasting RUDE brightness — musical tonal range"
        }
      ],
      "description": "Daniel Erlandsson's Paiste setup on Doomsday Machine pairs two series with deliberately contrasting tonal characters. The RUDE series — Paiste's raw, cutting line — delivers the defined, cutting attack that his hi-hats and crash cymbals require in Arch Enemy's dense guitar environment. The 2002 Series — darker, more complex, with more tonal depth — provides the contrasting texture his ride work needs to separate musically from the aggressive crash passages.\n\nThe logic mirrors a distinction common among serious melodic death metal drummers: crash cymbals need to project through the mix with fast attack and clear articulation, while the ride needs to provide something texturally different for the passages where sustained groove replaces explosive intensity. RUDE crashes and the RUDE Power Ride accomplish both simultaneously without requiring Erlandsson to switch cymbal manufacturers or series mid-performance.\n\nThe 14\" RUDE hi-hats anchor his rhythmic pulse across Doomsday Machine's tempo range — from the driving mid-tempo grooves of \"Nemesis\" through the higher-velocity material of \"My Apocalypse\" and the band's most aggressive catalog entries. The RUDE's fast, focused decay means every hi-hat stroke registers distinctly in the mix, even as guitar layering competes for frequency space. This definition is not incidental: in melodic death metal, where rhythmic precision distinguishes credibility from approximation, every component of the cymbal setup's clarity matters.\n\nAndy Sneap's production captured this cymbal setup with discipline and clarity. Sneap's overhead microphone placement and EQ choices preserved the natural tonal character of each cymbal without forcing them to compete for upper-frequency space. The result is a cymbal sound that breathes within the mix rather than sitting on top of it — a production approach that aged well and continues to sound modern.",
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Pearl's flagship double pedal, built for durability and mechanical consistency across Doomsday Machine and the Arch Enemy world tour that followed",
          "description": "The Pearl Demon Drive double bass pedal is Daniel Erlandsson's primary foot technique tool and one of the most important pieces of his entire setup. Arch Enemy's material on Doomsday Machine places continuous demands on double-kick work — sustained patterns at tempos ranging from mid-paced grooves through full-velocity sections — and the pedal must deliver consistent response across the album's most demanding passages.\n\nAs Pearl's flagship double pedal, the Demon Drive is engineered for durability and mechanical consistency. Erlandsson's heel-up double-kick technique at Arch Enemy's tempos benefits from that consistency — enough drive for impact, enough reliability to sustain patterns without physical deterioration across a full touring schedule.\n\nFor double-bass technique context and how the Demon Drive serves melodic death metal's specific demands: see [double-bass drumming at MetalForge](/technique/double-bass-drumming)."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        {
          "category": "Cymbals",
          "then": "Paiste RUDE and 2002 Series setup (2005)",
          "now": "Paiste RUDE and 2002 Series (consistent across multi-decade career)"
        },
        {
          "category": "Pedals",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson used Paiste RUDE and 2002 Series cymbals on Doomsday Machine. His setup paired the RUDE series — Paiste's raw, cutting line — for hi-hats and crash cymbals, with the 2002 Series — darker, more tonally complex — for his ride. The 14\" RUDE hi-hats provided fast, defined attack for rapid 16th-note patterns at Arch Enemy's tempos. RUDE crashes delivered the upper-frequency projection needed to cut through Michael Amott's layered guitar production. The RUDE 22\" Power Ride introduced tonal contrast in groove-oriented passages where the brighter crash character would be too aggressive. Andy Sneap's production captured this cymbal setup with disciplined overhead microphone placement and EQ choices, preserving the natural tonal character of each cymbal. The same fundamental cymbal approach continued to define Erlandsson's Arch Enemy work for the rest of his career."
      },
      {
        "question": "What bass drum pedal did Daniel Erlandsson use on Doomsday Machine?",
        "answer": "Daniel Erlandsson used the Pearl Demon Drive double bass pedal on Doomsday Machine. As Pearl's flagship double pedal, the Demon Drive is built for durability and mechanical consistency. For Arch Enemy's material, which demands sustained double-kick work across full albums and the extensive world touring that followed Doomsday Machine's release, that mechanical consistency is essential: each stroke produces the same response across an entire tour cycle. The Pearl Demon Drive has been Erlandsson's primary foot tool across Arch Enemy's career, providing the reliability that multi-year international touring schedules require. For double bass pedal technique context: [double-bass drumming at MetalForge](/technique/double-bass-drumming)."
      }
    ],
    "conclusion": {
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Daniel Erlandsson's long-term double bass pedal — Pearl's flagship double pedal, built for consistent response at sustained tempos",
          "description": "The Pearl Demon Drive remained Erlandsson's foot technique foundation through the Anthems of Rebellion sessions, as it had on Wages of Sin and would continue across the subsequent Arch Enemy decade. As Pearl's flagship double pedal, the Demon Drive gives the player durability and mechanical consistency, allowing Erlandsson's specific double-kick technique to translate reliably take after take. For Anthems of Rebellion's sustained double-kick sections, this consistency of mechanical response means each stroke produces the same result regardless of session length or stage in a long touring schedule."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
  ...
  "rise-of-the-tyrant-drum-setup": {
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Daniel Erlandsson's long-term foot technique foundation — Pearl's flagship double pedal, built for mechanical consistency across sustained double-kick passages",
          "description": "The Pearl Demon Drive double bass pedal has been the foundation of Daniel Erlandsson's foot technique since the early Arch Enemy years, and on Rise of the Tyrant it provides the mechanical consistency that the album's sustained double-kick passages — particularly on 'Revolution Begins' and 'Blood on Your Hands' — require at professional recording and touring standards. As Pearl's flagship double pedal, the Demon Drive lets Erlandsson translate his specific heel-up technique reliably, ensuring that every stroke produces the same result regardless of tempo, duration, or stage in a long touring cycle."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Pearl Demon Drive's mechanical consistency is essential across the extended double-kick passages. Erlandsson Signature snare 5.5\" depth provides the crack-and-body balance needed to project above Masters Premium double-kick weight."
      },
      {
  ...
  "khaos-legions-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Pearl Demon Drive double bass pedal — the long-standing foot technique foundation of Erlandsson's setup",
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Pearl's flagship double pedal, built for durability and mechanical consistency across Khaos Legions and beyond",
          "description": "The Pearl Demon Drive remained the foundation of Daniel Erlandsson's foot technique on Khaos Legions, as it had across his previous studio albums and international touring. As Pearl's flagship double pedal, the Demon Drive is built for durability and mechanical consistency. For Khaos Legions' most demanding double-kick passages, that reliable, consistent response provides the foot technique foundation Erlandsson's playing requires across a full touring cycle."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
    ...
    "soundCharacter": {
      ...
      "keyAttributes": [
        ...
        "Pearl Demon Drive mechanical consistency — dependable foot-technique response across the album"
      ]
    },
    "trackAnalysis": [
      {
      ...
      },
      {
        ...
        "highlights": [
          ...
          "Pearl Demon Drive mechanical consistency audible in the sustained double-kick texture",
          "Blast beat architecture: deployed as structural intensification rather than constant texture",
          "Byzance china accents mark riff-transition moments with aggressive Gothenburg character"
        ],
        "gearNotes": "Pearl Demon Drive's mechanical consistency produces a dependable kick texture throughout. Masterworks Custom shells respond with precisely designed attack and body under full blast conditions."
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "The Pearl Demon Drive is Pearl's flagship double bass pedal, built for the durability and mechanical consistency that professional touring and recording demand. For Daniel Erlandsson, the Demon Drive has been his foot technique foundation across his Arch Enemy studio albums, including Khaos Legions, providing a reliable, repeatable response on every stroke regardless of tempo, duration, or stage in a long touring cycle. That mechanical consistency is essential to sustaining the precise double-kick patterns that define his playing across Arch Enemy's catalog."
      },
      {
  ...
  "war-eternal-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Pearl Demon Drive double bass pedal — Pearl's flagship double pedal, in continuous use since Khaos Legions",
    ...
    "hardware": {
      "title": "Pearl Demon Drive: Mechanical Consistency for the White-Gluz Era",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Pearl's flagship double pedal — consistent double-kick across White-Gluz era touring",
          "description": "The Pearl Demon Drive, in use since Khaos Legions (2011), continued as Erlandsson's double bass pedal for War Eternal and the entire White-Gluz era. As Pearl's flagship double pedal, the Demon Drive is built for durability and mechanical consistency. War Eternal's most intensive double-kick sections ('You Will Know My Name', 'Avalanche') rely on the Demon Drive's mechanical reliability across full performance demands."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Pearl's flagship double pedal — consistent double-kick across years of White-Gluz era touring",
          "description": "The Pearl Demon Drive continued as Erlandsson's primary foot technique tool on Will to Power. As Pearl's flagship double pedal, its durability and mechanical consistency produced the reliable double-kick character that Will to Power's most intensive passages required — the same reliability that had served him through War Eternal and the subsequent tour cycle, now with years of touring familiarity adding additional physical certainty to the foot technique."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
  ...
  "deceivers-drum-setup": {
    ...
    "hardware": {
      "title": "Pearl Demon Drive in 2022: Over a Decade of Mechanical Consistency",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Bass Pedal",
          "notes": "Pearl's flagship double pedal — over a decade of consistency from Khaos Legions (2011) to Deceivers (2022)",
          "description": "The Pearl Demon Drive had served as Erlandsson's primary foot technique tool from Khaos Legions (2011) through the entire White-Gluz era. By Deceivers (2022), the pedal had accumulated over a decade of touring and studio use — the physical familiarity between Erlandsson and the Demon Drive's mechanical response was at its peak. As Pearl's flagship double pedal, its durability and mechanical consistency provided the reliable double-kick character that Deceivers' most intensive passages demanded, executing the band's sustained double-kick patterns with the same efficiency that had characterised Erlandsson's foot technique across all three White-Gluz era albums."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
