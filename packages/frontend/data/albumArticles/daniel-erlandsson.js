...
export const articles = {
  ...
  "deceivers-drum-setup": {
    ...
    "hardware": {
      "title": "Pearl Eliminator in 2022: Over Two Decades of Cam-Driven Consistency",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Eliminator Double Bass Pedal",
          "notes": "Interchangeable cam system — over two decades of consistency from Wages of Sin (2002) to Deceivers (2022)",
          "description": "The Pearl Eliminator had served as Erlandsson's primary foot technique tool since the earliest Arch Enemy albums, through the Gossow era and the entire White-Gluz era. By Deceivers (2022), the cam-driven pedal had accumulated decades of touring and studio use — the physical familiarity between Erlandsson and the Eliminator's mechanical response was at its peak. The pedal's consistent, cam-tuned acceleration curve provided the reliable double-kick character that Deceivers' most intensive passages demanded, executing the band's sustained double-kick patterns with the same efficiency that had characterised Erlandsson's foot technique across all three White-Gluz era albums."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Daniel Erlandsson used his Pearl Reference Pure kit on Deceivers (2022) — the same all-maple flagship Pearl configuration that had been his studio and touring setup since Doomsday Machine (2005), now in its seventeenth year as Erlandsson's primary Arch Enemy kit. The configuration maintained his consistent standard: two 22\" x 18\" bass drums, 10\" and 12\" rack toms, 14\" and 16\" floor toms, Pearl Daniel Erlandsson Signature snare (14\" x 5.5\"), and Sabian AAX/HHX multi-series cymbals. Jens Bogren's third Fascination Street production captured this setup with the greatest tonal nuance of the three-album partnership. The Pearl Eliminator double bass pedal, used since Khaos Legions (2011), drove the double-kick work. For the full setup history: [Daniel Erlandsson drum setup](/articles/daniel-erlandsson-drum-setup)."
      },
      {
