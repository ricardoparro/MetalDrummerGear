...
export const articles = {
  ...
  "hell-awaits-drum-setup": {
    ...
    "cymbals": {
      "title": "Zildjian A: The Last Pre-Paiste Album",
      "brand": "Zildjian",
      "series": "Zildjian A Series",
      "setup": [
        {
  ...
  "reign-in-blood-anniversary": {
    ...
    "gearLegacy": {
      ...
      "content": "Every major piece of Lombardo's Reign in Blood rig is documented in detail on MetalForge, and the Paiste cymbal lineup he used is still in production 40 years later.",
      "links": [
        ...
        { "href": "/cymbals/setups/dave-lombardo", "label": "Cymbal Setup — Paiste RUDE & 2002 Series", "note": "Full per-piece breakdown of the hi-hats, crashes, ride, and China" },
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Lombardo recorded Reign in Blood on a Tama Artstar II kit (Piano Black finish) with twin independent 22\" bass drums, a Tama Superstar Steel 14\" x 6.5\" snare, and Paiste RUDE and 2002 series cymbals. The full track-by-track breakdown, including hardware and recording technique, is in our Reign in Blood drum setup article."
      },
      {
        "question": "Is Dave Lombardo's Reign in Blood-era gear still available?",
        "answer": "The Paiste RUDE and 2002 series cymbals he used remain in production largely unchanged. The Tama Artstar II itself is a discontinued vintage model found through Reverb and used-gear dealers; Lombardo's current signature ProMark TX2BXN sticks are a separate, present-day product."
      }
    ],
    "relatedAlbums": [
      "reign-in-blood-drum-setup",
