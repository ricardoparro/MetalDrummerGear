...
export const articles = {
  "whats-in-derek-roddys-kit": {
    ...
    "description": "Discover Derek Roddy's complete drum setup — the Tama drums, Meinl cymbals, Axis pedals, and technique-focused gear that power death metal's most influential educator. Complete breakdown of the blast beat pioneer's equipment.",
    "seoKeywords": [
    ...
    "drumKit": {
      ...
      "config": {
        ...
        "shells": "Bubinga shells with reinforcement rings"
      },
      "description": "Derek Roddy's drum setup reflects his philosophy: the kit should support technique, not compensate for it. His Tama Starclassic Bubinga drums provide the attack, projection, and tuning stability needed for extreme metal's demands without being overly specialized.\n\nThe 22\" x 18\" bass drum is deeper than many metal drummers prefer. Where some favor 20\" or smaller kicks for speed, Derek's 22\" provides the low-end punch that cuts through Hate Eternal's wall of guitars. The depth (18\") adds body without sacrificing articulation — crucial for blast beats where every stroke must speak clearly.\n\nThe rack toms (10\" and 12\") and floor toms (14\" and 16\") are standard sizes that work across multiple musical contexts. Derek isn't interested in exotic configurations; he wants drums that respond predictably so technique can shine. Tama's consistent shell construction and hardware deliver that reliability.\n\nBubinga shells provide the attack and projection death metal demands. The dense wood offers a focused, slightly darker tone than maple that still lets Derek's playing determine the sound. The shells project without being harsh — essential for sustained blast sections.\n\nTama's hardware and tuning system ensure the kit stays in tune through brutal performances. When you're playing 250+ BPM blast beats, the last thing you need is a lug drifting out of tune. This attention to stability reflects Derek's methodical approach.",
      "notes": [
        "22\" bass drum — deeper than typical extreme metal for low-end punch",
        "Standard tom sizes for predictable response",
        "Bubinga shells for focused attack and projection",
        "Tama hardware for stability during intense playing",
    ...
    "cymbals": {
      "title": "Meinl Byzance & Mb20: Power and Durability",
      "brand": "Meinl",
      ...
      "description": "Derek Roddy's cymbal setup draws on Meinl's Byzance and Mb20 Heavy Series lines for a versatile palette that works across extreme metal's demands.\n\nThe 14\" hi-hats are crucial to Derek's sound. At high speeds, hi-hats must cut without becoming washy. Their weight and profile provide stick definition even during sustained 16th-note patterns at extreme tempos. The \"chick\" sound is tight and defined — essential for the precision Derek demands.\n\nThe 16\" and 18\" crashes deliver the fast attack and controlled sustain ideal for blast beat accents. Where traditional crashes might wash out during constant playing, they cut through and decay quickly, ready for the next hit. This quick response prevents cymbal buildup that would muddy the mix.\n\nThe 20\" ride provides articulation without excessive wash. Its controlled character means Derek can ride during intense sections without creating a wall of cymbal noise. The bell offers a cutting ping for accents.\n\nDerek's cymbal choices reflect his practical approach: they need to survive brutal playing while producing a controllable sound. He's not interested in exotic cymbals that record well but break easily. Durability matters when you're touring extreme metal.\n\nThe china cymbal adds aggression without overwhelming sustain. Positioned for quick access, it punctuates transitions and accents without lingering in the mix.",
      "estimatedValue": "$1,400-2,200 total (Meinl Byzance/Mb20 setup)"
    },
    "hardware": {
    ...
    "buyingGuide": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "items": [
            "Tama Starclassic Performer — $2,500",
          ...
          "notes": "The Starclassic Performer offers Tama quality at a more accessible price. Axis Longboards are essential for heel-toe technique."
        },
        {
          ...
          "items": [
            ...
            "Axis A Longboard Double Pedal — $700",
            "Tama Speed Cobra complete hardware pack — $800",
    ...
    "faq": [
      {
        ...
        "answer": "Derek Roddy plays a Tama Starclassic Bubinga kit built with dense bubinga shells. His configuration includes a 22x18 inch bass drum, 10 and 12 inch rack toms, and 14 and 16 inch floor toms. The Starclassic Bubinga is Tama's premium professional line, known for its focused attack and consistent shell quality, making it a go-to choice for extreme metal drummers who demand both speed response and tonal depth."
      },
      {
        "question": "What cymbals does Derek Roddy use?",
        "answer": "Derek Roddy uses Meinl Byzance and Mb20 Heavy series cymbals. His setup includes 14 inch hi-hats, 16 and 18 inch crashes, a 20 inch ride, an 18 inch china, and a 10 inch splash. The Byzance line delivers a darker, more complex wash while the Mb20 Heavy pieces cut through dense metal mixes with focused projection."
      },
      {
        "question": "How much does Derek Roddy's drum kit cost?",
        "answer": "Derek Roddy's Tama Starclassic Bubinga shell pack is estimated at $3,000 to $5,500 new. His Tama SLP Black Brass snare adds approximately $300 to $500. The Meinl Byzance and Mb20 Heavy cymbal setup runs roughly $1,400 to $2,200 complete. A full comparable setup including hardware and pedals can total between $6,000 and $10,000."
      }
    ],
    "conclusion": {
  ...
  "king-of-all-kings-drum-setup": {
    ...
    "drumKit": {
      ...
      "notes": [
        ...
        "Tama hardware held tuning through extreme-tempo studio takes",
    ...
    "cymbals": {
      ...
      "description": "Roddy's Meinl Byzance/Mb20 Heavy setup on King of All Kings was chosen for durability and control as much as tone. The 14\" hi-hats kept their definition during the album's longest sustained blast passages, where a washier hi-hat would have blurred into an indistinct texture. The crash's fast decay let accents punch through and clear out before the next blast section resumed, which mattered on a record where blast beats made up the majority of the runtime.\n\nThe 20\" ride saw limited use given the album's blast-heavy structure, but provided a controlled, non-washy option for the handful of sections where Roddy dropped out of blast tempo. The china added the aggressive punctuation Rutan's arrangements needed at song transitions.",
    ...
    "faq": [
      {
        ...
        "answer": "Derek Roddy tracked Hate Eternal's King of All Kings (2002) on a Tama Starclassic Bubinga kit — a 22\" x 18\" bass drum, 10\" and 12\" rack toms, and 14\" and 16\" floor toms, built from dense bubinga shells. The kit's focused attack and Tama's hardware kept it stable through the album's extended blast beat sessions, which demanded consistent tuning across a full day of extreme-tempo takes."
      },
      {
