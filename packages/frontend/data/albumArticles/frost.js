// Album drum-setup articles — Frost. Auto-split from the former monolith.
export const articles = {
  ...
  "frost-satyricon-drum-setup": {
    ...
    "seoKeywords": [
      "frost satyricon drum setup",
      "satyricon drummer gear",
      "frost drum kit black metal",
      "frost drumming style",
    ...
    "drumKit": {
      "title": "Frost's Tama Kit: Built for Black Metal",
      "brand": "Tama",
      "model": "Tama Starclassic Bubinga Series",
      "finish": "Piano Black",
      "config": {
        "bassdrums": [
      ...
      "notes": [
        ...
        "Piano Black finish matching Satyricon's visual aesthetic"
      ],
    ...
    "snare": {
      ...
      "estimatedValue": "$300–550 (Starclassic Bubinga snare)"
    },
    "cymbals": {
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Tight, cutting hi-hat response for fast blast patterns"
        },
        {
          "type": "Crash",
          "model": "Zildjian A 16\" Medium Thin Crash",
          "position": "Left crash",
          "notes": "Fast, explosive crash for high-tempo accent work"
        },
        {
          "type": "Crash",
          "model": "Zildjian A 18\" Medium Crash",
          "position": "Right crash",
          "notes": "Fuller crash for section endings and dynamic peaks"
        },
        {
          "type": "Ride",
          "model": "Zildjian A 20\" Medium Ride",
          "position": "Right side",
          "notes": "Defined stick sound for ride patterns; also used as crash"
        },
        {
          "type": "China",
          "model": "Zildjian 18\" China Boy",
          "position": "Above floor tom",
          "notes": "Aggressive, trashy accents for extreme passage punctuation"
        },
        {
          "type": "Splash",
          "model": "Zildjian A 10\" Splash",
          "position": "Effects position",
          "notes": "Quick accent texture between riff sections"
        }
      ],
      ...
      "items": [
        {
          ...
          "notes": "High-performance drive system for sustained extreme tempos",
          "description": "Frost uses the Tama Iron Cobra Power Glide double pedal, capable of sustaining consistent response at the extreme tempos Satyricon and 1349 demand — a flagship model with the mechanical precision that blast beat foot technique requires.\n\nAt 200+ BPM blast tempos, pedal rebound speed and consistency are critical. The Power Glide's adjustable cam system allows dialing in the exact acceleration and return timing that heel-up technique demands, ensuring each stroke in a sustained double-kick pattern returns identically."
        },
        {
    ...
    "faq": [
      {
        ...
        "answer": "Frost plays Tama drums — he is a longtime Tama Drums endorser, playing their Starclassic Bubinga series. The setup centers on Bubinga shells with a double 22\" x 18\" bass drum configuration for his extreme-tempo double-kick work. Bubinga shell construction delivers the immediate attack and focused mid-range projection that black metal demands — drums that cut through densely saturated guitar frequencies without losing definition during blast beat patterns. His full drummer profile is at [Frost's MetalForge page](/drummer/46)."
      },
      {
