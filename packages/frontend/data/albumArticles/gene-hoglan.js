...
export const articles = {
  ...
  "darkness-descends-drum-setup": {
    ...
    "cymbals": {
      ...
      "setup": [
        {
          "type": "Hi-Hats",
          "model": "Sabian AA 14\" Medium Hi-Hats",
          "position": "Left side",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          ...
          "now": "Pearl Eliminator Singles (x2)"
        },
        {
          "category": "Sticks",
  ...
  "brotherhood-of-the-snake-drum-setup": {
    ...
    "description": "Gene Hoglan's return to Testament after 22 years — Brotherhood of the Snake (2016) drum setup breakdown. Pearl Reference Series drums, Sabian AAX cymbals, Pearl Eliminator pedals, and the Grammy-nominated comeback album that cemented The Atomic Clock's legacy.",
    "seoKeywords": [
      "brotherhood of the snake drum setup",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Snare dynamics are central — the Grammy nomination reflects how well the Pearl Reference Brass was captured. Pearl Eliminator pedals provide measured, deliberate kick work."
      },
      {
        "track": "Seven Seals",
        "bpm": "185",
        ...
        "gearNotes": "Pearl Eliminator pedals at near-maximum speed. China cymbal accents the heaviest passages."
      },
      {
        "track": "Born in a Rut",
        "bpm": "170",
  ...
  "gene-hoglan-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian AAX cymbal series throughout key career periods",
        "Pearl Eliminator double bass pedal — the engine behind his legendary foot technique",
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          ...
          "cymbals": "Sabian AA (developing relationship)",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          "category": "Cymbals",
          "then": "Sabian HHX",
          "now": "Sabian HHX (same series, updated models)"
        },
        {
  ...
  "alien-drum-setup": {
    ...
    "description": "Complete breakdown of Gene Hoglan's drum performance on Strapping Young Lad's Alien (2005). Discover the Pearl Masters Premium MCX kit, Sabian HHX cymbals, and the triggered-and-live hybrid technique behind SYL's most polyrhythmic, progressive extreme metal record.",
    "seoKeywords": [
      "alien drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian HHX cymbals carried over from the City era, paired with the upgraded MCX shells",
      ...
      "setup": [
        {
          ...
          "model": "Sabian HHX 14\" Hi-Hats",
          "position": "Left side",
          "notes": "Same bright, cutting wash carried over from City — cuts through the album's denser mix"
        },
        {
          "type": "Crash",
          "model": "Sabian HHX 17\" Crash",
        ...
        },
        {
          ...
          "position": "Far right",
          "notes": "Clear bell tone for groove sections between blast passages"
        }
      ],
      "description": "Hoglan kept his Sabian HHX series for \"Alien,\" the same bright, computer-hammered cymbal platform he'd played on \"City.\" With the shell kit, the bass drum approach, and the compositional vocabulary all changing at once, the cymbal setup was one constant Hoglan didn't need to relearn — a familiar voice he could rely on while adapting to the record's odd-meter demands.\n\nThe HHX's bright, cutting character remained well suited to \"Alien\"'s dense, layered production: the same fast response and clean attack that had cut through \"City\"'s wall-of-sound guitars continued to hold up against Townsend's even more heavily layered \"Alien\" mix.\n\nThe 21\" ride's clear bell tone became particularly important on the album's groove-based passages — the moments of relative rhythmic stability between odd-meter sections — where Hoglan needed a cymbal voice with enough character to hold listener attention on its own, not just as a timekeeping device between blast beats.",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          "category": "Cymbals",
          "then": "Sabian HHX",
          "now": "Sabian HHX / Sabian AAX (modern eras)"
        },
        {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Hoglan kept his Sabian HHX series for Alien, the same cymbal platform he'd used on City. The setup included 14\" HHX hi-hats, 17\" and 18\" crashes, a 19\" China, and a 21\" ride. The HHX's bright, computer-hammered, fast-responding character that had cut through City's mix continued to serve Alien's denser, more layered guitar production."
      },
      {
  ...
  "titans-of-creation-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Pearl Eliminator pedals continued from the 2016 sessions, now paired with the upgraded Reference Pure kit",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        {
          "category": "Pedals",
          "then": "Pearl Eliminator Singles x2 (2016)",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Gene Hoglan used Pearl Eliminator single pedals on Titans of Creation (2020) — one pedal per bass drum, maintaining his independent double-kick philosophy rather than using a double pedal configuration. This was consistent with the Pearl Eliminator single pedals he used on Brotherhood of the Snake (2016). As a Pearl endorser, the Eliminator platform aligned with his drum brand. The Pearl Eliminator's interchangeable cam system allowed Hoglan to fine-tune the pedal's feel and power stroke to match the specific requirements of the 2020 material."
      }
    ],
    "conclusion": {
  ...
  "leave-scars-drum-setup": {
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Paiste 2002 Novo China accent — tonally cleaner than Sabian AA Chinese. Twin Iron Cobra pedals at near-maximum speed."
      },
      {
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          ...
          "now": "Sabian AA Series (Death era)"
        },
        {
          "category": "Pedals",
          "then": "Tama Iron Cobra Singles x2",
