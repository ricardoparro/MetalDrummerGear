// Album drum-setup articles — Gene Hoglan. Auto-split from the former monolith.
export const articles = {
  ...
  "darkness-descends-drum-setup": {
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Acrolite snare dynamics particularly evident at this tempo. AA-series cymbals provide musical contrast."
      },
      {
        ...
        "gearNotes": "Sabian AA China prominent in the arrangement. Independent kick drums executing compositional patterns at 220 BPM."
      }
    ],
    "evolution": {
  ...
  "individual-thought-patterns-drum-setup": {
    ...
    "cymbals": {
      "title": "Sabian HH: Clarity for Technical Complexity",
      "brand": "Sabian",
      "series": "Sabian HH Series",
      "setup": [
        {
          "type": "Hi-Hats",
          "model": "Sabian HH 14\" Rock Hi-Hats",
          "position": "Left side",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Full kit utilization — crashes, toms, and double kick all integral. Sabian HH crashes serve the compositions rather than punctuating randomly."
      }
    ],
    "evolution": {
  ...
  "gene-hoglan-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian cymbal series (AA, HH, HHX, AAX) across key career periods",
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Pedal",
          "notes": "Direct-drive with NiNjA bearings — his standard since signing with Pearl in 2008",
          "description": "The Pearl Demon Drive double bass pedal is Gene Hoglan's primary foot weapon, and the choice is no accident. Pearl's Demon Drive represents the pinnacle of direct-drive pedal engineering: NiNjA bearings, fully adjustable throw angle, board weight, spring tension, and beater angle, and the precision manufacturing that makes it the industry benchmark for professional double-bass work. The adjustable settings allow Hoglan to dial in the exact acceleration curve that matches his heel-up technique — the relationship between where the pedal starts moving and how quickly it builds force through the stroke determines feel more than almost any other pedal specification. Hoglan's double-kick technique is built on consistency: same force, same timing, same recovery position, thousands of times per night. The Demon Drive's engineering supports that consistency across the full arc of a demanding live set. On Death's Human and Individual Thought Patterns, the double-kick is not merely fast — it is precise. Every kick stroke occupies its exact rhythmic position in the grid. That's 'The Atomic Clock' in its most fundamental expression, and the Demon Drive is the mechanism that translates technique into sound."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          ...
          "hardware": "Tama Iron Cobra pedals — early chain-drive models"
        },
      ...
      },
      {
        ...
        "gear": {
          ...
          "hardware": "Pearl Demon Drive double pedal, ProMark Classic Forward 2B sticks"
        },
    ...
    "buyingGuide": {
      ...
      "budgetTiers": [
        ...
        },
        {
          "tier": "Mid-Range",
          "range": "$2,500–5,000",
          "notes": "Session Studio + AAX crashes + Pearl Demon Drive pedal"
        },
        {
          "tier": "Professional",
          "range": "$6,000+",
          "notes": "Reference Pure + full AAX + Pearl Demon Drive + Free-Floating snare"
        }
      ]
    },
    "faq": [
  ...
  "city-drum-setup": {
    ...
    "cymbals": {
      "title": "Sabian HH: Brightness Through the Industrial Wall",
      "brand": "Sabian",
      "series": "Sabian HH Series",
      "setup": [
        {
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "Tama double kicks drive the album's defining opening assault. SPD-20 electronic accents first appear here. Sabian HH hi-hats cut through the densest guitar arrangement of the album."
      },
      {
      ...
      },
      {
        ...
        "gearNotes": "SPD-20 pads prominent in the industrial sections. Sabian HH crashes serve clear compositional purposes. Double kick at maximum speed."
      },
      {
        "track": "Room 429",
        "bpm": "160",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          "category": "Cymbals",
          "then": "Sabian HH Series",
          "now": "Sabian AAX Series (modern era)"
        },
        {
  ...
  "alien-drum-setup": {
    ...
    "description": "Complete breakdown of Gene Hoglan's drum performance on Strapping Young Lad's Alien (2005). Discover the Pearl Masters Premium MCX kit, Sabian HHX Evolution cymbals, and the triggered-and-live hybrid technique behind SYL's most polyrhythmic, progressive extreme metal record.",
    "seoKeywords": [
      "alien drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Sabian HHX Evolution cymbals, replacing the HH series from the City era",
    ...
    "cymbals": {
      ...
      "setup": [
        ...
        {
          "type": "China",
          "model": "Sabian HHX Evolution 19\" China",
          "position": "Above floor tom",
      ...
      "description": "Hoglan's move to Sabian's HHX Evolution series for \"Alien\" marked a deliberate departure from the bright, cutting HH cymbals he'd used on \"City.\" The HHX Evolution line combines traditional hand-hammering with computer-controlled lathing, producing a darker, more complex cymbal voice with more overtone content than the HH series' clean, focused attack.\n\nThat added complexity suited \"Alien\"'s production, which layered guitars far more densely than \"City\" had. A brighter cymbal cutting cleanly through a sparser mix works well; inside \"Alien\"'s wall of layered riffs, the HHX Evolution's darker wash sat inside the mix rather than slicing through the top of it, giving Townsend more room to push the guitars without the cymbals fighting for the same frequency space.\n\nThe 21\" ride's dark, complex bell tone became particularly important on the album's groove-based passages — the moments of relative rhythmic stability between odd-meter sections — where Hoglan needed a cymbal voice with enough character to hold listener attention on its own, not just as a timekeeping device between blast beats.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Hoglan switched to Sabian's HHX Evolution series for Alien, moving away from the brighter HH cymbals he'd used on City. The setup included 14\" HHX Evolution hi-hats, 17\" and 18\" crashes, a 19\" China, and a 21\" ride. The HHX Evolution line's darker, more complex tone — a blend of traditional hand-hammering with computer-controlled lathing — suited Alien's denser, more layered guitar production better than the cutting HH sound had suited City's sparser mix."
      },
      {
  ...
  "titans-of-creation-drum-setup": {
    ...
    "description": "Gene Hoglan's definitive modern testament to precision — Titans of Creation (2020) drum setup breakdown. Pearl Reference Pure drums, Sabian AAX cymbals, Pearl Demon Drive pedals. Recorded during COVID lockdown, the album closes Hoglan's Testament arc with his most refined setup yet.",
    "seoKeywords": [
      "titans of creation drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Pearl Demon Drive pedals carried over unchanged from the 2016 sessions",
    ...
    "hardware": {
      "title": "Pearl Demon Drive: The Continuing Engine for The Atomic Clock",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Demon Drive Single Pedals (x2)",
          "notes": "Individual pedals for each bass drum — his standard since signing with Pearl in 2008, unchanged from the 2016 Brotherhood sessions",
          "description": "For *Titans of Creation*, Hoglan continued to use Pearl Demon Drive single pedals — one per bass drum — the same direct-drive platform he has used since signing with Pearl in 2008. The Demon Drive delivered the high-performance characteristics his independent double-kick technique demands. Its NiNjA bearings and fully adjustable throw angle, board weight, spring tension, and beater angle allowed Hoglan to fine-tune the pedal's feel, power stroke, and rebound to match the requirements of the 2020 material. At the speeds and precision levels Hoglan executes throughout *Titans of Creation*, the Demon Drive's direct-drive response and adjustability provided the mechanical optimization that separates endorsed equipment from commodity alternatives."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "Pearl Reference Pure snare central to the Grammy-consideration production. Pearl Demon Drive pedals drive the kick pattern with measured precision."
      },
      {
        ...
        "highlights": [
          ...
          "Sabian AAX 18\" Chinese used for the most aggressive riff passages"
        ],
        "gearNotes": "Pearl Reference Pure floor toms — 14\" and 16\" — descend melodically through fill sequences. AAX Chinese accents the heaviest moments."
      },
      {
        ...
        "highlights": [
          ...
          "Sabian AAX 19\" X-Plosion crash used for the climactic section endings"
        ],
        "gearNotes": "Pearl Demon Drive pedals at near-maximum speed. Independent twin 22\" x 18\" bass drums — separate instruments, not double pedal."
      },
      {
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          ...
          "now": "Pearl Demon Drive Singles x2 (2020, continued)"
        },
        {
          "category": "Producer",
    ...
    "faq": [
      {
        ...
        "answer": "Gene Hoglan recorded Titans of Creation (2020) using a Pearl Reference Pure kit — Pearl's pure maple professional flagship, a step above the maple/birch hybrid Reference Series he used on Brotherhood of the Snake (2016). His configuration retained his signature twin 22\" x 18\" bass drums for independent double-kick, 10\" and 12\" rack toms, and 14\" and 16\" floor toms. His snare was a Pearl Reference Pure Free-Floating model at 14\" x 6.5\". Cymbals were Sabian AAX series, and he continued using Pearl Demon Drive single pedals (one per bass drum), unchanged from the 2016 sessions."
      },
      {
        "question": "How does Titans of Creation differ from Brotherhood of the Snake gear-wise?",
        "answer": "Two key gear changes distinguish Titans of Creation (2020) from Brotherhood of the Snake (2016). First, Hoglan upgraded from Pearl Reference Series (16-ply maple/birch hybrid) to Pearl Reference Pure (6-ply pure maple) — a warmer, more resonant shell construction that gave the 2020 album a more open, spacious drum character. Second, his snare changed from Pearl Reference Brass to Pearl Reference Pure Free-Floating, shifting from the brass shell's midrange cut to maple's warmer resonance. His bass drum pedals — Pearl Demon Drive singles — remained unchanged across both albums, as did his Sabian AAX cymbal setup."
      },
      {
  ...
  "leave-scars-drum-setup": {
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Paiste 2002 Novo China accent — tonally cleaner than Sabian AA China. Twin Iron Cobra pedals at near-maximum speed."
      },
      {
