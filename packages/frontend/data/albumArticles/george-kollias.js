...
export const articles = {
  ...
  "george-kollias-nile-annihilation-drum-setup": {
    ...
    "drumKit": {
      ...
      "finish": "Maple/Birch Hybrid Shell Pack",
      "config": {
        "bassdrums": [
      ...
      "description": "For the Annihilation of the Wicked sessions, George Kollias played a Pearl Reference Series kit — his first Pearl endorsement after joining Nile. The Reference Series' maple/birch hybrid shell construction delivered the projection and focused attack essential for recording at extreme tempos while maintaining clarity in Neil Kernon's dense mix.\n\nThe hybrid shell balanced maple's natural warmth against birch's cutting attack — a combination that prevented the drums from sounding thin or brittle at high speeds while still projecting through Nile's dense, down-tuned guitar work. Even at 280 BPM blast beats, each stroke retained its individual character rather than blurring into indistinct noise.\n\nThe double 22\" bass drum setup was non-negotiable. Two separate kick drums gave George the independent control and feel per foot that a double pedal on a single bass drum cannot replicate. The independent resonance of two drums also produced a fuller, more authoritative low-end — critical for the Egyptian-themed heaviness Nile demanded.\n\nThe Reference Series' free-floating tom mounts allowed the toms to resonate freely, preserving sustain and tone. For Nile's compositionally complex material — where tom passages often serve melodic functions between blast sections — sustain and pitch definition mattered as much as attack.\n\nThe compact tom configuration (10\", 12\", 14\", 16\") gave George maximum reach efficiency between blast beats. Every millisecond counts when transitioning at 240+ BPM.",
      "notes": [
        "Pearl Reference Series — maple/birch hybrid shells for warmth and projection",
        "Free-floating tom mounts for free-resonating toms",
        "Double 22\" kick drums — independent control per foot",
        "Compact tom configuration for reach efficiency at extreme speeds",
        "Kollias's first Pearl endorsement, upgraded to all-maple Reference Pure shells for later Nile records"
      ],
      "estimatedValue": "$4,000–5,500 (Reference Series shell pack, 2005)"
    },
    "snare": {
    ...
    "cymbals": {
      ...
      "description": "George Kollias's relationship with Zildjian dates back to when he joined Nile in 2005. For Annihilation of the Wicked, he relied on the A Custom series — Zildjian's bright, professional touring line built for cut and projection.\n\nThe A Custom hi-hats were chosen for their articulation at extreme speeds. At 240+ BPM, a hi-hat that smears or loses definition between strokes collapses the rhythmic clarity Nile's music demands. The A Custom weights provided enough mass to project through the guitars while remaining quick enough for Kollias's intricate foot and hand patterns.\n\nThe crash setup ranged from 17\" to 18\" — a spread that allowed dynamic contrast between quick accents (17\") and heavier section endings (18\"). In Nile's epic compositions, these moments of transition are compositionally important; the right cymbal creates the drama the album calls for.\n\nThe A Custom ride provided clear stick definition for the passages where Kollias shifts from blast beats to more measured ride-based patterns. Nile's music demands this versatility — extreme speed sections alternating with hypnotic, more atmospheric passages.\n\nThe 18\" A Custom China added the aggressive, trashy accent texture that punctuates Nile's heaviest transitions — an essential color in the band's sonic palette.",
      "estimatedValue": "$2,600–3,400 total (A Custom setup, 2005 era)"
    },
    "hardware": {
      "title": "The Tama Iron Cobra HP900: Powering 280 BPM",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Tama",
          "model": "Tama Iron Cobra HP900 Double Bass Drum Pedal",
          "notes": "Power Glide cam-drive with smooth, consistent action — Kollias's pedal of choice for Annihilation",
          "description": "The Tama Iron Cobra HP900 was George Kollias's double bass pedal during the Annihilation of the Wicked era — the pedal he'd built his blast-beat technique around back in the Greek underground, carried unchanged into his Pearl-kit era with Nile. The HP900's Power Glide cam system provided the smooth, consistent action that Kollias needed for sustained high-speed playing, delivering genuine attack on every stroke at maximum tempo.\n\nThe Iron Cobra's adjustability allowed Kollias to dial in the exact spring tension and beater angle that suited his heel-toe technique. This calibration is critical: at 280 BPM, even slight misalignment between foot motion and beater response creates fatigue and inconsistency. The HP900 gave him the mechanical precision to execute his technique reliably across a full recording session and live performance.\n\nThis pedal predates Kollias's later signature collaboration with Pearl (the Demon XR, 2015). For many drummers studying his early Nile work, the Iron Cobra HP900 remains the accessible entry point to his pedal technique — widely available, highly adjustable, and still capable of extreme performance."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "DW",
    ...
    "technique": {
      ...
      "tips": [
        ...
        "The Iron Cobra HP900 spring tension calibration matters — experiment to find your feel"
      ]
    },
    "trackAnalysis": [
      {
        ...
        "gearNotes": "The Pearl Reference Series' attack cuts through the opening blast. Iron Cobra HP900 double bass consistency is audible on the kick pattern."
      },
      {
        ...
        "gearNotes": "The steel snare's fast decay is critical here — wooden shells would wash out. Zildjian crash accents punctuate transitions between riff sections."
      },
      {
        "track": "User-Maat-Re",
        ...
        "gearNotes": "The full kit range is displayed — from delicate ride passages to full blast sections. The Reference Series tom tuning contributes to the track's melodic fill work."
      },
      {
        ...
        "highlights": [
          ...
          "The Zildjian China cymbal accent punctuates the heaviest transitions"
        ],
        "gearNotes": "Iron Cobra HP900 heel-toe technique is the engine behind the sustained double-bass intensity. Steel snare provides the crack that defines the track's aggressive character."
      }
    ],
    "evolution": {
      "title": "From Annihilation to Today: How Kollias's Gear Evolved",
      "content": "The Annihilation of the Wicked sessions captured George Kollias at the very start of his Nile tenure — before signature endorsements, before co-designed pedals, but already on the Pearl/Zildjian foundation that would define his entire career. Understanding where he started makes the evolution meaningful.\n\n**The Pearl Reference Era (2005):**\nThe Reference Series maple/birch hybrid kit was Kollias's tool for establishing his Nile identity — his first Pearl endorsement after joining the band. It served well — the album's drum tone holds up decades later. The Tama Iron Cobra HP900, the pedal he'd built his blast-beat technique around in the Greek underground, provided reliable, adjustable double-bass performance before he developed the specific technique refinements that led to the Pearl Demon XR collaboration.\n\n**Upgrading Within Pearl (2009 onward):**\nAs Kollias's relationship with Pearl deepened, his shells evolved from the Reference Series hybrid to all-maple Pearl Reference Pure, and he picked up his first Vic Firth signature stick for \"Those Whom the Gods Detest\" (2009). He stayed on the Iron Cobra pedal and Zildjian A Custom cymbals throughout this stretch — the collaboration grew from his desire for equipment specifically engineered for sustained extreme-speed playing.\n\n**Pearl Demon XR (2015):**\nThe culmination of Kollias's pedal evolution: a co-designed double pedal built specifically for the demands he'd been placing on equipment since 2005. Every feature — the NiNjA Bearing, Click-Lock spring system, Direct Link drive — addresses something he encountered on the road playing Annihilation-era material.\n\n**Today:**\nKollias's current setup is the mature expression of everything he began developing on Annihilation of the Wicked, now running Zildjian K Mastersound hi-hats, K Custom Dark crashes, and an A Custom Mega Bell ride alongside ddrum triggers added for \"Vile Nilotic Rites\" (2019). Same Pearl/Zildjian philosophy, elevated engineering.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Pearl Reference Series (maple/birch hybrid)",
          "now": "Pearl Reference Pure / Masterworks Stadium Exotic"
        },
        {
          "category": "Snare",
        ...
        {
          "category": "Cymbals",
          "then": "Zildjian A Custom (early setup)",
          "now": "Zildjian K Mastersound / K Custom Dark series"
        },
        {
          "category": "Pedals",
        ...
        },
        {
          "category": "Sticks",
          "then": "Vic Firth 5B",
          "now": "Vic Firth George Kollias Signature"
        }
      ]
    },
    "videos": [
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "During the Annihilation of the Wicked sessions (2005), George Kollias played a Pearl Reference Series kit — his first Pearl endorsement after joining Nile — with a double 22\" kick drum setup. His current setup is a Pearl Masterworks Stadium Exotic kit — the result of a long endorsement and co-design partnership with Pearl. Both setups share the same philosophy: maple-heavy shells for warmth and projection, double kick for independent control per foot, and compact tom configurations for reach efficiency at extreme speeds. Full current setup breakdown: [George Kollias complete kit article](/articles/whats-in-george-kollias-kit)."
      },
      {
        "question": "What pedals does George Kollias use?",
        "answer": "For 'Annihilation of the Wicked,' George Kollias used the Tama Iron Cobra HP900 double bass drum pedal — a Power Glide cam-drive system known for smooth, consistent action and extensive adjustability, and the same pedal he'd built his technique around in the Greek underground. He later co-designed the Pearl Demon XR double pedal, engineered specifically for his requirements at 280 BPM. The Demon XR's NiNjA Bearing Universal Joint and Click-Lock spring tension system address the mechanical demands he identified during years of performing Annihilation-era material live. The Iron Cobra HP900 remains the accessible starting point for drummers studying his early technique."
      },
      {
