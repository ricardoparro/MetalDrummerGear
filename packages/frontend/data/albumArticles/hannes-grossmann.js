      ...
      "items": [
        {
          ...
          "description": "Hannes Grossmann's high-speed double pedal setup on Epitaph provided the mechanical foundation for the album's sustained double-kick work. Tracks like \"Stabwound,\" \"Ignominious & Pale,\" and \"Mutilate the Stillborn\" demand sustained 16th-note double-bass at tempos where pedal response curve determines whether the passages survive the mix as music or collapse.\n\nGrossmann's heel-toe and swivel foot technique distributes pedal work across the foot rather than concentrating it in the ankle, which is essential for the sustained passages on Epitaph. For double-bass technique context: [double-bass drumming at MetalForge](/technique/double-bass-drumming)."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
