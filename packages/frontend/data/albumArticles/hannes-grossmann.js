// Album drum-setup articles — Hannes Grossmann. Auto-split from the former monolith.
  ...
  "cosmogenesis-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "DW Collectors Series shell pack with double 22\" x 18\" kick drums for sustained blast and double-bass work",
        "Meinl Byzance cymbals — Grossmann is a Meinl artist and his Byzance setup defines his signature sound",
        "DW 9000 Series double pedal delivering the high-velocity foot technique the material demands",
    ...
    "drumKit": {
      "title": "Hannes's Studio Kit: The DW Collectors Series",
      "brand": "DW",
      "model": "DW Collectors Series",
      ...
      "items": [
        {
          ...
          "brand": "DW",
          "model": "DW 9000 Series Double Pedal",
          "notes": "Floating rotor mechanism and adjustable cam action for sustained double-bass at Cosmogenesis tempos",
          "description": "Hannes Grossmann's DW 9000 Series double pedal provided the mechanical foundation for the album's sustained double-kick passages. Cosmogenesis demands sustained 16th-note double-bass at tempos where each individual stroke must register cleanly, and the pedal's response curve determines whether those passages survive the mix as music or collapse into rhythmic mud.\n\nThe 9000's floating rotor mechanism and interchangeable cam system are particularly well suited to Grossmann's heel-toe and swivel technique — a foot-pedal vocabulary he uses to sustain double-bass at velocities that would otherwise require excessive physical exertion. Consistent feel between the primary and secondary pedal sides distributes the work across the foot rather than concentrating it in the ankle alone.\n\nFor double-bass technique context and how high-speed pedals serve technical death metal: see [double-bass drumming at MetalForge](/technique/double-bass-drumming)."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "DW 9000 Series double pedal delivering the sustained double-bass that defines the track's structural arc. China and splash accents at climactic transitions."
      },
      {
    ...
    "evolution": {
      ...
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "DW Collectors Series shell pack (2009)",
          "now": "Continued DW Collectors Series with refined configuration"
        },
        {
          "category": "Cymbals",
        ...
        },
        {
          ...
          "now": "Continued DW 9000 Series double pedal"
        },
        {
          "category": "Sticks",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "During the Cosmogenesis era, Hannes Grossmann used a DW 9000 Series double pedal. Its floating rotor mechanism and interchangeable cam system suit the heel-toe and swivel foot technique Grossmann uses to sustain 16th-note double-bass at the album's tempos. The pedal's consistent feel between the primary and secondary sides distributes pedal work across the foot rather than concentrating it in the ankle, which is essential for the sustained passages on tracks like \"Cosmogenesis\" and \"Anticosmic Overload.\" For double-bass technique context: [double-bass drumming at MetalForge](/technique/double-bass-drumming)."
      },
      {
