    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          "drums": "Various Pearl kits — developing endorsement relationship during formative period",
          "snare": "Pearl models tuned for maximum crack in raw black metal production",
          "cymbals": "Zildjian (developing the bright, cutting character he would refine across the career)",
          "hardware": "Pearl double bass pedals — early configuration"
        },
      ...
      },
      {
        ...
        "gear": {
          "drums": "Pearl (recorded at Grieghallen Studio, Bergen, with Pytten producing)",
          "snare": "Pearl model tuned bright — essential for cutting through the album's cold, layered guitar production",
          "cymbals": "Zildjian — cold brightness serving Euronymous and Blackthorn's guitar tones",
          "hardware": "Pearl double bass pedal"
        },
      ...
      },
      {
        ...
        "gear": {
          "drums": "Pearl Reference series — flagship production kit for demanding dual-band schedule",
          "snare": "Pearl Reference Snare 14\" x 6.5\"",
          "cymbals": "Full Zildjian A Custom setup — consistent across both bands' production contexts",
          "hardware": "Pearl Demon Drive double pedal, Vic Firth 5B sticks"
        },
        "notes": "The dual Dimmu Borgir / Mayhem period demonstrates Hellhammer's extraordinary versatility. Dimmu Borgir's orchestrated, symphonic black metal required precision in a different context than Mayhem's raw, atmospheric approach — but the same Pearl Reference kit and Demon Drive pedals served both demands. Ordo Ad Chao (2007) with Mayhem was recorded without a bassist, the drums and guitars doing the full structural work — Hellhammer's performance there is among his most demanding on record."
      },
      {
        "era": "Modern Era",
        "years": "2014–Present",
