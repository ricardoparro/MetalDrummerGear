// Album drum-setup articles — Igor Cavalera. Auto-split from the former monolith.
export const articles = {
  ...
  "inflikted-drum-setup": {
    ...
    "drumKit": {
      ...
      "config": {
        ...
        "shells": "Maple shells — ddrum Hybrid Kit construction"
      },
      "description": "For Cavalera Conspiracy's debut album, Igor Cavalera played a ddrum Hybrid Kit — the setup he moved to in 2006 after leaving Sepultura and reuniting with brother Max. The kit's maple shells provide a full-bodied warmth combined with punchy attack, making it equally suitable for mid-paced groove sections and flat-out thrash.\n\nThe move to ddrum after years on Tama equipment marked a clean break tied to the Cavalera Conspiracy reunion itself — new band, new brotherhood chapter, new gear partnership. On \"Inflikted,\" the toms sound open and responsive — they cut through the dense guitar mix without sounding choked or compressed.\n\nThe single 22\" bass drum was a deliberate choice consistent with Igor's groove-first philosophy. Double bass setups dominate contemporary thrash and death metal, but Igor's signature has always been exceptional single-pedal technique with strategic double-bass deployment. His kick patterns on \"Inflikted\" are powerful precisely because they leave space — every hit counts.\n\nWith two rack toms and two floor toms, Igor had the fill vocabulary needed for the album's dynamic range. The \"Inflikted\" title track and \"Hunt You Down\" showcase his tom work — not flashy cascades, but purposeful accents that serve the riff and drive the song forward.\n\nThe ddrum Hybrid Kit remained Igor's setup throughout the Cavalera Conspiracy era, making this a defining reference point for drummers looking to replicate his sound from this period. The maple construction remains the defining character of the kit.",
      "notes": [
        "Moved to ddrum Hybrid Kit from Tama in 2006, alongside the switch to Cavalera Conspiracy",
    ...
    "cymbals": {
      ...
      "description": "Igor Cavalera switched to Zildjian in 2006 for the Cavalera Conspiracy era, moving on from the Paiste cymbals he had used throughout his Sepultura years. For \"Inflikted,\" he set up a full Zildjian A Custom Series rig — a range known for its bright, cutting projection and its ability to sit clearly on top of dense, aggressive mixes.\n\nThe A Custom series was built for exactly this kind of playing. Igor's hard-hitting style, developed over two decades of metal drumming, works naturally with the series' bright, articulate character. The cymbals cut through without requiring aggressive EQ to be heard.\n\nFor \"Inflikted,\" the 14\" A Custom hi-hats provide the cutting definition required for Igor's groove patterns. The multiple crash options — 16\", 18\", and 19\" — give Igor choices for different sections, from quick accent crashes to full explosive washes.\n\nThe China cymbal is a Cavalera Conspiracy signature sound. The trashy, cutting explosions of the A Custom China punctuate the album's heaviest riff transitions, adding aggression that a standard crash cannot deliver.\n\nThe switch to Zildjian was part of Igor's broader gear reset tied to the Cavalera Conspiracy reunion — new cymbals in service of a familiar-but-reinvented direction.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "On Cavalera Conspiracy's Inflikted recorded in 2007 and 2008, Igor Cavalera played a ddrum Hybrid Kit — the kit he moved to in 2006 after leaving Sepultura and reuniting with brother Max. The setup featured a single 22x18 inch bass drum, rack toms in 10 and 12 inches, and floor toms in 14 and 16 inches. The kit's maple shells provided the full-bodied warmth and punchy attack suited to the album's aggressive thrash and death metal direction."
      },
      {
        "question": "What cymbals did Igor Cavalera use on Inflikted?",
        "answer": "On Inflikted in 2008, Igor Cavalera used the Zildjian A Custom series, having switched to Zildjian in 2006 for the Cavalera Conspiracy era after years on Paiste during Sepultura. His Cavalera Conspiracy setup included Zildjian A Custom 14 inch hi-hats, A Custom 16 and 18 inch crashes, an A Custom 19 inch crash, an A Custom 20 inch ride, and an A Custom 18 inch China. The A Custom series is known for its bright, cutting projection, matching Igor's hard-hitting approach on the album."
      },
      {
  ...
  "blunt-force-trauma-drum-setup": {
    ...
    "cymbals": {
      ...
      "description": "The Zildjian A Custom Series cymbal setup remained Igor's choice for \"Blunt Force Trauma\" — the same configuration he had used on \"Inflikted\" since switching from Paiste in 2006. By 2011, the Zildjian A Custom series was firmly established as part of Igor's Cavalera Conspiracy sound, as closely associated with his playing as his ddrum Hybrid Kit.\n\nFor a band that was explicitly not trying to reinvent its sound on the second album, cymbal continuity made sense. The A Custom series' bright, cutting character and high-volume projection are defining elements of Cavalera Conspiracy's sonic profile. Switching to a different cymbal line would have altered the band's character without obvious musical justification.\n\nThe 14\" A Custom hi-hats drive the album's thrash and death metal sections with consistent power. The multiple crash options give Igor the ability to match crash size to musical intensity — smaller crashes for rapid accent hits, larger crashes for full-band climaxes. The 20\" ride provides weight and articulation for sections where a crash sound would be excessive.\n\nListening across both Cavalera Conspiracy albums, the Zildjian cymbals create a sonic thread that connects the two records. Fans who attended Cavalera Conspiracy shows in 2008 and 2009 recognized the same cymbal character on \"Blunt Force Trauma\" — intentional continuity that reinforces the band's identity.\n\nZildjian's A Custom series remains available today, making it accessible for drummers looking to capture Igor's Cavalera Conspiracy era sound.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "On Blunt Force Trauma in 2011, Igor Cavalera continued with the Zildjian A Custom series that had been his primary cymbal choice since switching to Zildjian in 2006 for the Cavalera Conspiracy era. His setup included Zildjian A Custom 14 inch hi-hats, A Custom 16, 18, and 19 inch crashes, an A Custom 20 inch ride, and an A Custom 18 inch China. The A Custom series remained consistent across both Cavalera Conspiracy albums, reinforcing the sonic identity between Inflikted and Blunt Force Trauma."
      },
      {
