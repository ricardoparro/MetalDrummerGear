...
export const articles = {
  "whats-in-infernos-kit": {
    ...
    "cymbals": {
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Durable, cutting sound for fast patterns"
        },
        {
          "type": "China",
          "model": "Paiste RUDE 14\" Blast China",
          "position": "Far left",
          "notes": "Quick, explosive accent"
        },
        {
          "type": "Crash",
        ...
        {
          "type": "Ride",
          "model": "Paiste RUDE 24\" Mega Power Ride",
          "position": "Far right",
          "notes": "Massive projection with defined bell"
        },
        {
          "type": "China",
      ...
      "description": "Inferno's cymbal setup is built around Paiste's RUDE series—cymbals engineered for raw, unlathed durability while maintaining the cutting projection needed for extreme metal playing.\n\nThe RUDE line is designed to survive relentless, heavy-handed playing without losing its cutting edge. Unlike darker, more controlled cymbals favored by some metal drummers, the RUDE series offers a bright, aggressive tone built for maximum cut. This serves Behemoth's sound perfectly: the cymbals project above the heavily distorted guitars rather than blending into them.\n\nThe 14\" RUDE Sound Edge hi-hats provide the articulation needed for Inferno's demanding foot patterns while offering enough weight to project during open crashes. His closed hi-hat technique during blast beats is exceptionally clean—each hit speaks clearly without excessive sustain.\n\nMultiple crash cymbals give dynamic options: the 14\" Blast China for quick accents, the 18\" and 19\" RUDE crashes for standard crashes, and the 24\" Mega Power Ride serving multiple functions—riding, crashing, and bell work.\n\nThe 18\" China cymbal is essential for Behemoth's sound. Those trashy, explosive accents punctuate transitions and add aggression to key moments. Paiste's RUDE chinas are durable enough to withstand Inferno's heavy hitting while delivering consistent tone.",
      "estimatedValue": "$2,000-2,500 total (Paiste RUDE professional setup)"
    },
    "hardware": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Inferno uses Paiste RUDE series cymbals. His setup includes a 14 inch RUDE Sound Edge Hi-Hats, a 14 inch RUDE Blast China, 18 and 19 inch RUDE crashes, a 24 inch RUDE Mega Power Ride, and an 18 inch RUDE China. The RUDE series produces a raw, cutting response that projects through Behemoth's dense wall of guitar."
      },
      {
