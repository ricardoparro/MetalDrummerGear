...
export const articles = {
  "jason-bittner-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Mapex Saturn V — power and durability for dense metal contexts",
        "Zildjian A Custom / K cymbals — cutting brightness for projection through NWOAHM and thrash guitar density",
    ...
    "drumKit": {
      ...
      "config": {
        ...
        "shells": "Mapex Saturn V shell pack, engineered for power and durability"
      },
      "description": "Jason Bittner's Mapex Saturn V kit is the physical foundation of his dual NWOAHM/thrash approach. Mapex's Saturn V shell pack is built for exactly this kind of dual-purpose durability, delivering a focused, powerful attack with enough tonal body to avoid sounding brittle in the mid-range frequencies where metal guitars live.\n\nFor Bittner's context — alternating between the groove-forward arrangements of Shadows Fall and the straightforward thrash velocity of Overkill — shell character matters enormously. Shadows Fall's arrangements demand toms that respond with articulate attack on fills and transitions while sustaining enough to support the melodic character of the music; Overkill's thrash context requires a sharper, more percussive decay that keeps the rhythm section's articulation distinct at high tempos. The Saturn V navigates both demands: its shell pack delivers a drum sound with real character and low-end authority while maintaining the front-end definition that metalcore and thrash drumming require.\n\nHis double bass drum configuration — two 22\" kick drums — drives the sustained double-kick patterns that both bands demand. At Shadows Fall's NWOAHM tempos, these kicks lay down the rhythmic foundation beneath polyrhythmic cymbal patterns and snare placement. At Overkill's thrash velocities, the same two kicks fire at machine-gun rates that require consistent beater response from both pedal sides. The 22\" diameter supplies the sub-bass body that carries the kick through both bands' dense guitar arrangements.\n\nTom configuration follows a practical logic: two rack toms (10\" and 12\") and two floor toms (14\" and 16\") give Bittner the full range needed for descending fills and tom-driven transitions without excess hardware. In NWOAHM arrangements, toms serve a structural role — marking section changes and amplifying breakdown moments — while in Overkill's thrash context, they supply the rapid fill vocabulary between riff cycles.",
      "notes": [
        "Mapex Saturn V — engineered for power and durability across NWOAHM and thrash contexts",
        ...
        "Shell character suited to both bands: focused attack for clarity, full body for tonal warmth"
      ],
    ...
    "cymbals": {
      "title": "Zildjian A Custom / K: Brightness and Definition for Dense Metal",
      "brand": "Zildjian",
      "series": "Zildjian A Custom and K Series",
      "setup": [
        {
          "type": "Hi-Hats",
      ...
      "description": "Jason Bittner's Zildjian A Custom and K cymbal setup is engineered around the acoustic challenge both Shadows Fall and Overkill present: how to maintain cymbal definition and rhythmic clarity in guitar environments where mid-frequency density is extremely high.\n\nZildjian's A Custom series is B20 bronze with a brilliant finish that emphasizes upper harmonics. In practice, this means A Custom cymbals project their attack frequencies at a higher pitch than the guitar frequencies occupying the mix's mid range — the hi-hat pulse and crash accents sit above the guitar density rather than competing with it. At Overkill's thrash tempos, where the ride and hi-hat patterns define the rhythmic grid against rapid-fire riff cycling, this upper-frequency projection ensures the rhythmic pulse is always audible to both the room and the listener on record.\n\nThe K ride's defined bell suits Overkill's thrash context specifically. Classic thrash drumming — as pioneered by Lombardo, Benante, and Gar Samuelson — uses the ride bell as a sharp, pitched accent that cuts above the guitar mass to mark rhythmic divisions. Bittner's K ride supplies exactly this functionality: the bell cuts through at maximum guitar density, making the rhythmic structure of thrash riffs audible in the mix.\n\nThe china cymbal's role in Bittner's setup is characteristically NWOAHM: it marks breakdown arrivals and serves as the punctuation for the most aggressive moments in Shadows Fall's heaviest material. On Overkill records, the china appears at moments of maximum thrash intensity — the functional equivalent of the crash in classic thrash, but with more aggressive decay that matches the harder-edged sound of Overkill's modern material.",
      "estimatedValue": "$1,200–2,000 (full Zildjian A Custom / K setup)"
    },
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          ...
          "description": "ProMark Jason Bittner Signature 5BX sticks provide the balance of weight and durability that Bittner's high-velocity playing across two active bands demands. The 5B's larger diameter compared to 5A offers additional mass for driving Zildjian A Custom cymbals and Mapex Saturn V shells at full metal volume; the standard taper maintains the wrist balance needed for the rapid ghost note patterns and cross-stick work that appear in Shadows Fall's more textural NWOAHM passages."
        },
        {
    ...
    "playingStyle": {
      ...
      "keyTechniques": [
        ...
        "Mapex Saturn V delivering matched attack across both NWOAHM and thrash drumming contexts",
        "Mapex Falcon chain-drive consistency — metronomic double-kick precision at both NWOAHM and thrash tempos"
      ]
    },
    "gearTimeline": [
      {
    ...
    "faq": [
      {
        ...
        "answer": "Jason Bittner plays a Mapex Saturn V kit — a shell pack engineered for power and durability. His setup runs a double bass drum configuration with two 22\" kick drums, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). The Saturn V's shells provide the focused attack and low-end body suited to both Shadows Fall's NWOAHM arrangements and Overkill's thrash material. Bittner has been a Mapex endorser throughout his career, using Saturn V kits as the foundation of his setup across both bands. Full profile: [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
        "question": "What cymbals does Jason Bittner play?",
        "answer": "Jason Bittner plays Zildjian A Custom and K series cymbals. His setup includes Zildjian A Custom 14\" hi-hats, 16\" and 18\" A Custom crash cymbals, an K 20\" ride, and an A Custom china cymbal. The A Custom series — B20 bronze with brilliant finish — emphasizes upper-frequency harmonics that project above the mid-range density of both Shadows Fall's layered NWOAHM guitar arrangements and Overkill's thrash wall. The K ride's defined bell is particularly suited to Overkill's thrash context, where ride bell accents cut through the guitar mass to mark rhythmic divisions in the arrangement. Zildjian is Bittner's primary cymbal endorsement across his career with both bands."
      },
      {
        "question": "What double bass pedal does Jason Bittner use?",
        "answer": "Jason Bittner uses the Mapex Falcon double bass pedal. The Falcon's chain-drive system provides consistent action across both the primary and slave pedal sides — a critical feature for the sustained double-bass passages that define Bittner's drumming in both Shadows Fall and Overkill. At Overkill's thrash tempos, where double-kick patterns sustain at high velocities for extended passages, any mechanical variation between the two pedal sides becomes audible as rhythmic unevenness; Mapex Falcon's engineering prioritizes matched action to support the metronomic precision both bands require. The pedal's adjustable spring tension and beater weight allow configuration for NWOAHM's syncopated kick patterns as well as thrash's sustained velocity demands. See [double-bass technique at MetalForge](/technique/double-bass/drummers) for related context."
      },
      {
  ...
  "the-war-within-drum-setup": {
    ...
    "description": "Complete breakdown of the drum kit, snare, cymbals, and hardware Jason Bittner used to record Shadows Fall's Grammy-nominated, RIAA Gold-certified album The War Within (2004). Mapex Saturn V kit, Zildjian A Custom cymbals, Mapex Falcon double pedal, and the NWOAHM drumming that charted at #43 on the Billboard 200.",
    "seoKeywords": [
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Bittner played a Mapex Saturn V kit with Zildjian A Custom cymbals and a Mapex Falcon double bass pedal — the NWOAHM benchmark setup"
      ]
    },
    "drumKit": {
    ...
    "cymbals": {
      "title": "Zildjian A Custom: Brightness and Definition Above the NWOAHM Wall",
      "brand": "Zildjian",
      "series": "Zildjian A Custom and K Series",
      "setup": [
        {
    ...
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          ...
          "description": "ProMark Jason Bittner Signature 5BX sticks provided the mass and durability Bittner's playing demanded across *The War Within*'s dense arrangements. The 5B's larger diameter relative to 5A offers more mass for driving the Zildjian A Custom cymbals at full NWOAHM volume while retaining the wrist balance needed for the ghost note patterns and cross-stick work that appear in the album's more dynamic passages."
        },
        {
          "type": "Drumheads (Bass, Batter)",
          "brand": "Remo",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "A Custom cymbal overheads preserving the upper-frequency projection that distinguishes cymbal work in the mix",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "Snare backbeat sits clearly above the guitar density — the steel snare's projection on full display",
          "Dynamic control through the bridge: Bittner reduces cymbal density to create space for the melodic guitar passage"
        ],
        "gearNotes": "The Mapex Falcon's matched pedal action is most clearly demonstrated here — the double-bass patterns sustain through verse and chorus with consistent attack. The Zildjian A Custom hi-hats' upper-frequency projection keeps the rhythmic grid audible throughout."
      },
      {
        "track": "Lead Me Home",
        "bpm": "165",
        ...
        "gearNotes": "The 18\" A Custom crash provides the full-response accent for the chorus arrivals. The Mapex Saturn V's tonal warmth is audible in the verse's half-time groove — less attack-forward than the kit's heaviest moments."
      },
      {
  ...
  "art-of-balance-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Bittner played a Mapex Saturn V kit with Zildjian cymbals and a Mapex Falcon double pedal — the foundation of his career-long setup"
      ]
    },
    "drumKit": {
    ...
    "cymbals": {
      ...
      "description": "Jason Bittner's Zildjian cymbal setup on The Art of Balance was built to register clearly inside Zeuss's dry, forward production -- a mix with little natural reverb to soften or blend the cymbal wash into the rest of the kit. Zildjian's B20 bronze construction gives both the K and A Custom series a bright, articulate character that translates directly into a dry mix without losing definition.\n\nThe hi-hats are the rhythmic backbone of \"Idle Hands\": tight, controlled 16th-note patterns that lock with the double-kick foundation and give the song's opening its mechanical precision. The 16\" and 18\" crashes split structural duty across the album -- the 16\" answers quick riff-change accents on uptempo tracks, the 18\" delivers the fuller response Shadows Fall's chorus arrivals and bridge climaxes need. The K 20\" ride's defined stick articulation carries the verse sections on the album's more melodic tracks, where Bittner pulls back from constant crash density and lets the ride pattern do the rhythmic work. The china cymbal supplies the harshest textural accent for the album's most aggressive breakdown passages, most notably on \"Destroyer of Senses.\"",
      "estimatedValue": "$1,000-1,800 (full Zildjian K / A Custom setup, 2002 era)"
    },
    "hardware": {
      "title": "Mapex Double Pedal: The Engine Behind Idle Hands",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Mapex",
          "model": "Mapex Falcon Double Pedal",
          "notes": "Chain-drive providing the matched, even action behind the Idle Hands double-kick pattern",
          "description": "The Mapex Falcon double pedal is the mechanical foundation of \"Idle Hands\" -- the double-kick pattern that opens The Art of Balance and remains the single most-cited piece of drumming in the Shadows Fall catalog. The pattern alternates rapid single strokes between feet at a tempo that exposes any inconsistency between primary and slave pedal response; Mapex's chain-drive system delivers matched beater action across both sides, which is what makes the pattern sound mechanically even rather than lopsided toward the stronger foot.\n\nFor Bittner, the pedal's reliability under sustained use mattered as much as its raw speed capability. The Art of Balance asks for double-bass not as an occasional accent but as a structural element across most of the record -- the kind of workload that punishes pedals with inconsistent spring tension or beater wear. The Mapex Falcon platform's adjustability let Bittner dial in the beater angle and spring response for the specific demands of NWOAHM's syncopated kick vocabulary, distinct from straight thrash velocity. See [double-bass technique at MetalForge](/technique/double-bass/drummers) for a breakdown of the pattern style."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
          ...
          "description": "ProMark Jason Bittner Signature 5BX sticks gave Bittner the weight needed to drive the Zildjian setup at full volume while retaining the control required for the album's more dynamic, ghost-note-driven passages. The 5B's larger diameter relative to a 5A provides extra mass for cymbal projection without sacrificing the wrist feel Bittner's technique depends on."
        },
        {
          "type": "Drumheads (Bass, Batter)",
          "brand": "Remo",
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "The Mapex Falcon double pedal's matched consistent chain-drive action is most audible here — both feet deliver even velocity across the opening pattern. The Mapex Saturn V's attack cuts cleanly through Zeuss's dry, forward mix."
      },
      {
        ...
        "highlights": [
          ...
          "The Zildjian A Custom china supplies the harshest textural accent on the record at the breakdown sections",
      ...
      },
      {
        ...
        "highlights": [
          ...
          "K 20\" ride carries verse sections where Bittner steps back from constant crash density",
          "Showcases the melodic-to-heavy dynamic arc that became a Shadows Fall arrangement signature"
        ],
        "gearNotes": "The K ride's defined stick articulation is the clearest demonstration of Bittner pulling dynamics back to serve a verse — a contrast to the maximum-velocity approach on Idle Hands and Destroyer of Senses."
      }
    ],
    "faq": [
      {
        "question": "What drums did Jason Bittner use on The Art of Balance?",
        "answer": "On The Art of Balance (2002), Jason Bittner played a Mapex Saturn V kit — engineered for power and durability — in a double bass drum configuration with two 22\" x 18\" kicks, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). This was the setup that became Bittner's signature for the rest of his Shadows Fall tenure and into his later work with Overkill. For full career gear context, see [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
        "question": "What cymbals did Jason Bittner use on The Art of Balance?",
        "answer": "Jason Bittner played Zildjian K and A Custom series cymbals on The Art of Balance — K 14\" hi-hats, A Custom 16\" and 18\" crashes, an K 20\" ride, and an A Custom china. The B20 bronze construction gives both series a bright, articulate character built to register clearly inside Zeuss's dry, forward production, where there was little natural reverb to soften the cymbal wash."
      },
      {
  ...
  "threads-of-life-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Bittner played the same Mapex Saturn V / Zildjian / Mapex setup that defined his Art of Balance and War Within performances"
      ]
    },
    "drumKit": {
    ...
    "cymbals": {
      ...
      "description": "Jason Bittner's Zildjian setup on Threads of Life carried forward the same K and A Custom combination that had defined his playing since The Art of Balance, now working inside Nick Raskulinecz's bigger, more layered major-label production. The B20 bronze construction's upper-frequency emphasis remained essential -- Raskulinecz's fuller guitar and bass presence on Threads of Life demanded cymbal work that could still project clearly above a denser overall mix than Bittner's earlier, leaner-sounding Shadows Fall records.\n\nThe hi-hats drive the rhythmic foundation on \"Redemption\" and \"Burning the Lives,\" locking tight with the double-bass patterns beneath them. The 16\" and 18\" A Custom crashes split structural duty as they had on prior albums -- quick accents from the 16\", fuller response from the 18\" for the bigger, more arena-scaled chorus arrivals that characterize Raskulinecz's production approach. The K ride's defined character carries the album's more melodic sections, and the china cymbal supplies the harshest accent for the record's heaviest moments, including the breakdown passages on \"Venomous\" and \"Dread Uprising.\"",
      "estimatedValue": "$1,100-1,900 (full Zildjian K / A Custom setup, 2007 era)"
    },
    "hardware": {
      "title": "Mapex Double Pedal: Five Years of Refined Double-Bass Precision",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Mapex",
          "model": "Mapex Falcon Double Pedal",
          "notes": "Chain-drive providing the matched action behind Redemption's sustained double-bass work",
          "description": "By Threads of Life, Bittner's Mapex Falcon double pedal setup represented five years of refinement on the same mechanical platform he'd used since The Art of Balance. The chain-drive system's matched action across both pedal sides remained the foundation of his sustained double-bass work -- most prominently on \"Redemption,\" where the verse and chorus patterns demand the same metronomic evenness between feet that made \"Idle Hands\" a technical landmark five years earlier.\n\nNick Raskulinecz's fuller, more polished production approach made pedal consistency just as critical as it had been under Zeuss's dry mix -- any unevenness between the primary and slave pedal sides would register clearly against the album's bigger, more layered arrangement. The Mapex Falcon platform's adjustable beater weight and spring tension let Bittner configure the pedal feel for Threads of Life's combination of aggressive verses and more melodic, structurally varied choruses. See [double-bass technique at MetalForge](/technique/double-bass/drummers) for related context."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "Sustained double-bass through verse and chorus demonstrates the same metronomic precision the Mapex pedal delivered on Idle Hands",
        ...
        "gearNotes": "The Mapex Falcon double pedal's matched consistent chain-drive action is essential to the verse's sustained double-bass pattern. The A Custom 18\" crash delivers the fuller response needed for the chorus arrivals' arena-scaled impact."
      },
      {
        ...
        "gearNotes": "The Mapex Saturn V's attack cuts through Raskulinecz's fuller mix on this track's heaviest passages. Remo Powerstroke 3 kick heads sustain controlled low-end through the extended double-bass sections."
      },
      {
        "track": "Storm Winds",
        "bpm": "155",
        ...
        "highlights": [
          ...
          "K 20\" ride carries melodic verse passages where Bittner reduces crash density",
        ...
        "gearNotes": "The K ride's defined articulation is the clearest example of Bittner's restraint on the record — pulling back from constant double-bass to let the arrangement breathe before returning to full velocity."
      }
    ],
    "faq": [
      {
        "question": "What drums did Jason Bittner use on Threads of Life?",
        "answer": "On Threads of Life (2007), Jason Bittner played the same Mapex Saturn V kit — engineered for power and durability — that had defined his playing since The Art of Balance (2002): a double bass drum configuration with two 22\" x 18\" kicks, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). For full career gear context, see [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
