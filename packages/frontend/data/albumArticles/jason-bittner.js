...
export const articles = {
  "jason-bittner-drum-setup": {
    ...
    "description": "Jason Bittner's complete drum setup for Shadows Fall and Overkill — Mapex Saturn V kit, Zildjian cymbals, Mapex Falcon double pedal, and the hybrid NWOAHM thrash technique behind The Art of Balance and The Electric Age.",
    "seoKeywords": [
      "jason bittner drum setup",
    ...
    "quickFacts": {
      ...
      "doublePedals": "Mapex Falcon Double Bass Pedal",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Mapex Saturn V — all-maple shells for durability and attack in dense metal contexts",
        "Zildjian K and A Custom cymbals — cutting brightness for projection through NWOAHM and thrash guitar density",
        "Mapex Falcon double bass pedal — precision-engineered for the sustained double-kick patterns across both bands",
    ...
    "drumKit": {
      ...
      "description": "Jason Bittner's Mapex Saturn V kit is the physical foundation of his dual NWOAHM/thrash approach. The Saturn V uses Mapex's all-maple shell construction with the SONIClear Bearing Edge: a consistent, precision-cut bearing edge across every shell that maximizes head-to-shell contact for focused attack with controlled sustain, while the all-maple build introduces warmth and even fundamental resonance that prevents the kit from sounding brittle in the mid-range frequencies where metal guitars live.\n\nFor Bittner's context — alternating between the groove-forward arrangements of Shadows Fall and the straightforward thrash velocity of Overkill — shell character matters enormously. Shadows Fall's arrangements demand toms that respond with articulate attack on fills and transitions while sustaining enough to support the melodic character of the music; Overkill's thrash context requires a sharper, more percussive decay that keeps the rhythm section's articulation distinct at high tempos. The all-maple Saturn V navigates both demands: the SONIClear Bearing Edge's focused attack and the maple body's tonal warmth together create a drum sound with more character than a single-ply shell while maintaining the front-end definition that metalcore and thrash drumming require.\n\nHis double bass drum configuration — two 22\" kick drums — drives the sustained double-kick patterns that both bands demand. At Shadows Fall's NWOAHM tempos, these kicks lay down the rhythmic foundation beneath polyrhythmic cymbal patterns and snare placement. At Overkill's thrash velocities, the same two kicks fire at machine-gun rates that require consistent beater response from both pedal sides. The 22\" diameter supplies the sub-bass body that carries the kick through both bands' dense guitar arrangements.\n\nTom configuration follows a practical logic: two rack toms (10\" and 12\") and two floor toms (14\" and 16\") give Bittner the full range needed for descending fills and tom-driven transitions without excess hardware. In NWOAHM arrangements, toms serve a structural role — marking section changes and amplifying breakdown moments — while in Overkill's thrash context, they supply the rapid fill vocabulary between riff cycles.",
      "notes": [
        "Mapex Saturn V — all-maple shells with the SONIClear Bearing Edge for attack and warmth across NWOAHM and thrash contexts",
        ...
        "Shell character suited to both bands: maple attack for clarity, all-maple body for tonal warmth"
      ],
    ...
    "cymbals": {
      "title": "Zildjian K & A Custom: Brightness and Definition for Dense Metal",
      "brand": "Zildjian",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Bright, cutting response for driving 16th-note patterns at thrash and NWOAHM tempos"
        },
        {
          "type": "Crash",
          "model": "Zildjian A Custom 16\" Crash",
          "position": "Left crash",
          "notes": "Fast attack, quick decay for rapid accent work in NWOAHM and thrash passages"
        },
        {
          "type": "Crash",
        ...
        },
        {
          ...
          "position": "Right",
          "notes": "Defined bell for thrash ride patterns; wash for NWOAHM's more open cymbal work"
        },
        {
          "type": "China",
      ...
      "items": [
        {
          ...
          "description": "The Mapex Falcon double bass pedal is Jason Bittner's core hardware choice and the mechanical foundation of the double-kick work that defines his playing in both Shadows Fall and Overkill. The Falcon's dual-chain drive mechanism provides a smooth, consistent power stroke that translates foot technique into beater velocity without mechanical slop or timing variation between the primary and slave pedal.\n\nFor Bittner's dual-band workload, the Falcon's consistency across both pedal sides is a practical requirement. In Overkill's thrash context — sustained double-kick passages at velocities approaching 200 BPM — any variation between primary and secondary pedal action becomes audible as timing unevenness that disrupts the mechanical precision thrash double-bass requires. Mapex's Falcon engineering prioritizes matched action between both pedal sides, supporting the metronomic consistency that both NWOAHM groove and thrash velocity demand.\n\nThe Falcon's adjustable beater weight and spring tension allow Bittner to configure the pedal for the different demands of each band's material. Shadows Fall's NWOAHM arrangements call for responsive action capable of navigating syncopated kick patterns beneath polyrhythmic cymbal textures; Overkill's thrash passages require sustained, high-velocity even-stroke output. The Falcon's adjustability — within a single reliable mechanical platform — suits this dual context. For double bass technique applicable to both contexts: [double-bass technique at MetalForge](/technique/double-bass/drummers)."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
          ...
          "description": "ProMark Jason Bittner Signature 5BX (TX5BXN) sticks provide the balance of weight and durability that Bittner's high-velocity playing across two active bands demands. The 5BX's larger diameter offers additional mass for driving the Zildjian K and A Custom cymbals and Mapex Saturn V shells at full metal volume; the signature taper maintains the wrist balance needed for the rapid ghost note patterns and cross-stick work that appear in Shadows Fall's more textural NWOAHM passages."
        },
        {
    ...
    "playingStyle": {
      ...
      "keyTechniques": [
        ...
        "All-maple Mapex Saturn V delivering matched attack across both NWOAHM and thrash drumming contexts",
        "Mapex Falcon dual-chain consistency — metronomic double-kick precision at both NWOAHM and thrash tempos"
      ]
    },
    "gearTimeline": [
      {
        ...
        "gear": {
          ...
          "pedals": "Double bass pedal configuration (pre-Mapex Falcon formalization)"
        },
      ...
      },
      {
        ...
        "gear": {
          "drums": "Mapex Saturn V — the kit that defines the Shadows Fall era",
          "cymbals": "Zildjian K / A Custom series",
      ...
      },
      {
        ...
        "gear": {
          "drums": "Mapex Saturn V (maintained)",
          "cymbals": "Zildjian K / A Custom series",
          "pedals": "Mapex Falcon Double Bass Pedal",
          "sticks": "ProMark Jason Bittner Signature 5BX (TX5BXN)"
        },
      ...
      },
      {
        ...
        "gear": {
          "drums": "Mapex Saturn V (consistent across both bands)",
          "cymbals": "Zildjian K / A Custom series",
          "pedals": "Mapex Falcon Double Bass Pedal",
          "sticks": "ProMark Jason Bittner Signature 5BX (TX5BXN)"
        },
    ...
    "faq": [
      {
        ...
        "answer": "Jason Bittner plays a Mapex Saturn V kit — an all-maple shell pack built with Mapex's SONIClear Bearing Edge. His setup runs a double bass drum configuration with two 22\" kick drums, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). The all-maple shells provide focused attack for high-tempo metalcore and thrash drumming combined with tonal warmth and body — a combination that suits both Shadows Fall's NWOAHM arrangements and Overkill's thrash material. Bittner has been a long-time Mapex Drums endorser throughout his career, using Saturn V and Black Panther series kits as the foundation of his setup across both bands. Full profile: [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
        "question": "What cymbals does Jason Bittner play?",
        "answer": "Jason Bittner plays Zildjian K and A Custom series cymbals. His setup includes 14\" K hi-hats, 16\" and 18\" A Custom crash cymbals, a 21\" K Custom ride, and an 18\" K china cymbal. The A Custom series — hand-hammered B20 bronze with brilliant finish — emphasizes upper-frequency harmonics that project above the mid-range density of both Shadows Fall's layered NWOAHM guitar arrangements and Overkill's thrash wall, while the K series contributes darker, more complex overtones. The K Custom ride's defined bell is particularly suited to Overkill's thrash context, where ride bell accents cut through the guitar mass to mark rhythmic divisions in the arrangement. Zildjian is Bittner's primary cymbal endorsement across his career with both bands."
      },
      {
        "question": "What double bass pedal does Jason Bittner use?",
        "answer": "Jason Bittner uses the Mapex Falcon double bass pedal. The Falcon's dual-chain drive system provides consistent action across both the primary and slave pedal sides — a critical feature for the sustained double-bass passages that define Bittner's drumming in both Shadows Fall and Overkill. At Overkill's thrash tempos, where double-kick patterns sustain at high velocities for extended passages, any mechanical variation between the two pedal sides becomes audible as rhythmic unevenness; Mapex's Falcon engineering prioritizes matched action to support the metronomic precision both bands require. The pedal's adjustable spring tension and beater weight allow configuration for NWOAHM's syncopated kick patterns as well as thrash's sustained velocity demands. See [double-bass technique at MetalForge](/technique/double-bass/drummers) for related context."
      },
      {
  ...
  "the-war-within-drum-setup": {
    ...
    "cymbals": {
      "title": "Zildjian K & A Custom: Brightness and Definition Above the NWOAHM Wall",
      "brand": "Zildjian",
      "series": "Zildjian K and A Custom Series",
      "setup": [
        {
    ...
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          ...
          "description": "ProMark Jason Bittner Signature 5BX (TX5BXN) sticks provided the mass and durability Bittner's playing demanded across *The War Within*'s dense arrangements. The 5BX's larger diameter offers more mass for driving the Zildjian K and A Custom cymbals at full NWOAHM volume while retaining the wrist balance needed for the ghost note patterns and cross-stick work that appear in the album's more dynamic passages."
        },
        {
          "type": "Drumheads (Bass, Batter)",
          "brand": "Remo",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "Zildjian A Custom cymbal overheads preserving the upper-frequency projection that distinguishes cymbal work in the mix",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "highlights": [
          ...
          "Crash cymbal placement marks the chorus arrivals with the 18\" A Custom's full response — maximum structural impact",
        ...
        "gearNotes": "The 18\" A Custom crash provides the full-response accent for the chorus arrivals. The Mapex Saturn V's all-maple shell warmth is audible in the verse's half-time groove — less attack-forward than the kit's heaviest moments."
      },
      {
        ...
        "highlights": [
          ...
          "The 16\" A Custom crash's fast decay is essential here — rapid accents between riff changes without cymbal wash buildup",
    ...
    "faq": [
      {
        ...
        "answer": "On *The War Within* (2004), Jason Bittner played a Mapex Saturn V kit — an all-maple shell pack with Mapex's SONIClear Bearing Edge. His setup included a double bass drum configuration with two 22\" x 18\" kick drums, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). The all-maple shells provided the attack definition needed to cut through Shadows Fall's dense guitar arrangements combined with tonal warmth for the album's more dynamic passages. The Mapex Saturn V was Bittner's kit throughout the peak Shadows Fall era, from *The Art of Balance* (2002) through *The War Within* (2004) and beyond. For full career gear context, see [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
        "question": "What cymbals did Jason Bittner use on The War Within?",
        "answer": "Jason Bittner played Zildjian K and A Custom series cymbals on *The War Within*. His setup included 14\" K hi-hats, 16\" and 18\" A Custom crash cymbals, a 21\" K Custom ride, and an 18\" K china cymbal. The A Custom series — hand-hammered B20 bronze with brilliant finish — emphasizes upper harmonics that project above the mid-range density of Shadows Fall's dual-guitar arrangements. This upper-frequency positioning is what allows the hi-hat patterns and crash accents to register clearly in *The War Within*'s dense NWOAHM production. Zildjian has been Bittner's primary cymbal endorsement throughout his career."
      },
      {
        "question": "What double bass pedal did Jason Bittner use on The War Within?",
        "answer": "Jason Bittner used the Mapex Falcon double bass pedal on *The War Within*. The Falcon's dual-chain drive system provides matched action across both the primary and slave pedal sides — critical for the sustained double-bass patterns that define the album's most demanding tracks, including the Grammy-nominated \"What Drives the Weak.\" At the tempos *The War Within* demands, any mechanical variation between pedal sides would become audible as rhythmic unevenness; the Falcon's engineering prevents this. The Mapex Falcon remained Bittner's pedal of choice across his career with both Shadows Fall and Overkill. See [double-bass technique at MetalForge](/technique/double-bass/drummers)."
      },
      {
  ...
  "art-of-balance-drum-setup": {
    ...
    "cymbals": {
      ...
      "description": "Jason Bittner's Zildjian cymbal setup on The Art of Balance was built to register clearly inside Zeuss's dry, forward production -- a mix with little natural reverb to soften or blend the cymbal wash into the rest of the kit. Zildjian's hand-hammered B20 bronze construction gives both the K and A Custom series a bright, articulate character that translates directly into a dry mix without losing definition.\n\nThe hi-hats are the rhythmic backbone of \"Idle Hands\": tight, controlled 16th-note patterns that lock with the double-kick foundation and give the song's opening its mechanical precision. The 16\" and 18\" A Custom crashes split structural duty across the album -- the 16\" answers quick riff-change accents on uptempo tracks, the 18\" delivers the fuller response Shadows Fall's chorus arrivals and bridge climaxes need. The K Custom 21\" ride's defined stick articulation carries the verse sections on the album's more melodic tracks, where Bittner pulls back from constant crash density and lets the ride pattern do the rhythmic work. The china cymbal supplies the harshest textural accent for the album's most aggressive breakdown passages, most notably on \"Destroyer of Senses.\"",
      "estimatedValue": "$1,000-1,800 (full Zildjian K / A Custom setup, 2002 era)"
    },
    "hardware": {
      "title": "Mapex Falcon Double Pedal: The Engine Behind Idle Hands",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Mapex",
          ...
          "description": "The Mapex Falcon double bass pedal is the mechanical foundation of \"Idle Hands\" -- the double-kick pattern that opens The Art of Balance and remains the single most-cited piece of drumming in the Shadows Fall catalog. The pattern alternates rapid single strokes between feet at a tempo that exposes any inconsistency between primary and slave pedal response; the Falcon's dual-chain drive system delivers matched beater action across both sides, which is what makes the pattern sound mechanically even rather than lopsided toward the stronger foot.\n\nFor Bittner, the pedal's reliability under sustained use mattered as much as its raw speed capability. The Art of Balance asks for double-bass not as an occasional accent but as a structural element across most of the record -- the kind of workload that punishes pedals with inconsistent spring tension or beater wear. The Falcon platform's adjustability let Bittner dial in the beater angle and spring response for the specific demands of NWOAHM's syncopated kick vocabulary, distinct from straight thrash velocity. See [double-bass technique at MetalForge](/technique/double-bass/drummers) for a breakdown of the pattern style."
        },
        {
          "type": "Sticks",
          "brand": "ProMark",
          ...
          "description": "ProMark Jason Bittner Signature 5BX (TX5BXN) sticks gave Bittner the weight needed to drive the Zildjian setup at full volume while retaining the control required for the album's more dynamic, ghost-note-driven passages. The 5BX's larger diameter provides extra mass for cymbal projection without sacrificing the wrist feel Bittner's technique depends on."
        },
        {
          "type": "Drumheads (Bass, Batter)",
          "brand": "Remo",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "Cymbal overheads preserving Zildjian's upper-frequency brightness without added ambience",
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "The Mapex Falcon double pedal's matched dual-chain action is most audible here — both feet deliver even velocity across the opening pattern. The Mapex Saturn V's maple attack cuts cleanly through Zeuss's dry, forward mix."
      },
      {
        ...
        "gearNotes": "The 16\" A Custom crash's fast decay keeps pace with rapid riff changes without cymbal wash buildup. Remo Powerstroke 3 kick heads deliver controlled low-end through the sustained double-bass passage."
      },
      {
    ...
    "faq": [
      {
        ...
        "answer": "On The Art of Balance (2002), Jason Bittner played a Mapex Saturn V kit — all-maple shells with the SONIClear Bearing Edge — in a double bass drum configuration with two 22\" x 18\" kicks, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). This was the setup that became Bittner's signature for the rest of his Shadows Fall tenure and into his later work with Overkill. For full career gear context, see [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
        "question": "What cymbals did Jason Bittner use on The Art of Balance?",
        "answer": "Jason Bittner played Zildjian K and A Custom series cymbals on The Art of Balance — 14\" K hi-hats, 16\" and 18\" A Custom crashes, a 21\" K Custom ride, and a K china. The hand-hammered B20 bronze construction gives both series a bright, articulate character built to register clearly inside Zeuss's dry, forward production, where there was little natural reverb to soften the cymbal wash."
      },
      {
  ...
  "threads-of-life-drum-setup": {
    ...
    "cymbals": {
      ...
      "description": "Jason Bittner's Zildjian setup on Threads of Life carried forward the same K and A Custom combination that had defined his playing since The Art of Balance, now working inside Nick Raskulinecz's bigger, more layered major-label production. The hand-hammered B20 bronze construction's upper-frequency emphasis remained essential -- Raskulinecz's fuller guitar and bass presence on Threads of Life demanded cymbal work that could still project clearly above a denser overall mix than Bittner's earlier, leaner-sounding Shadows Fall records.\n\nThe hi-hats drive the rhythmic foundation on \"Redemption\" and \"Burning the Lives,\" locking tight with the double-bass patterns beneath them. The 16\" and 18\" A Custom crashes split structural duty as they had on prior albums -- quick accents from the 16\", fuller response from the 18\" for the bigger, more arena-scaled chorus arrivals that characterize Raskulinecz's production approach. The K Custom ride's defined character carries the album's more melodic sections, and the china cymbal supplies the harshest accent for the record's heaviest moments, including the breakdown passages on \"Venomous\" and \"Dread Uprising.\"",
      "estimatedValue": "$1,100-1,900 (full Zildjian K / A Custom setup, 2007 era)"
    },
    "hardware": {
      "title": "Mapex Falcon Double Pedal: Five Years of Refined Double-Bass Precision",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Mapex",
        ...
        },
        {
          ...
          "description": "ProMark Jason Bittner Signature 5BX (TX5BXN) sticks remained Bittner's choice on Threads of Life, providing the mass needed to drive the Zildjian cymbal setup at full volume inside Raskulinecz's bigger production while retaining the control needed for the album's more dynamic, melodic passages."
        },
        {
          "type": "Drumheads (Bass, Batter)",
          "brand": "Remo",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "Cymbal overheads preserving Zildjian's projection without losing presence in the fuller mix",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "Sustained double-bass through verse and chorus demonstrates the same metronomic precision the Mapex Falcon pedal delivered on Idle Hands",
        ...
        "gearNotes": "The Mapex Falcon double pedal's matched dual-chain action is essential to the verse's sustained double-bass pattern. The A Custom 18\" crash delivers the fuller response needed for the chorus arrivals' arena-scaled impact."
      },
      {
        ...
        "gearNotes": "The Mapex Saturn V's maple attack cuts through Raskulinecz's fuller mix on this track's heaviest passages. Remo Powerstroke 3 kick heads sustain controlled low-end through the extended double-bass sections."
      },
      {
        "track": "Storm Winds",
        "bpm": "155",
    ...
    "faq": [
      {
        ...
        "answer": "On Threads of Life (2007), Jason Bittner played the same Mapex Saturn V kit — all-maple shells with the SONIClear Bearing Edge — that had defined his playing since The Art of Balance (2002): a double bass drum configuration with two 22\" x 18\" kicks, two rack toms (10\" and 12\"), and two floor toms (14\" and 16\"). For full career gear context, see [Jason Bittner at MetalForge](/drummer/jason-bittner)."
      },
      {
