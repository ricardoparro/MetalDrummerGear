...
export const articles = {
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          "drums": "SJC Custom Drums kit (endorsement held since 2009, pre-dating Slipknot)",
          "snare": "SJC Custom Drums 14\" snare (debut configuration)",
          "cymbals": "Zildjian A series (debut setup)",
          "hardware": "DW 9000 double bass pedal, Vater sticks, Evans heads"
        },
        "notes": "Weinberg's identity as the new Slipknot drummer was kept secret for months. He had to learn the full Slipknot catalog and honor Jordison's parts while beginning to develop his own voice within the band. His SJC Custom Drums endorsement predated Slipknot by five years; he added a Tama SLP snare for We Are Not Your Kind (2019)."
      },
      {
  ...
  "the-gray-chapter-drum-setup": {
    ...
    "drumKit": {
      ...
      "brand": "SJC Custom Drums",
      "model": "SJC Custom Series",
      "finish": "Two rigs: an all-mirrored maple \"A-rig\" and a stained bubinga \"B-rig\"",
      "config": {
        "bassdrums": [
      ...
      "estimatedValue": "$4,000–8,000 (SJC Custom shell pack, 2014)"
    },
    "snare": {
      "title": "The Gray Chapter Crack: Jay's 14\" Snare",
      "brand": "SJC Custom Drums",
      "model": "SJC Custom Drums 14\" Snare",
      "size": "14\" x 6.5\"",
      "shell": "Maple or bubinga, matched to the A-rig/B-rig kit in use",
      ...
      "estimatedValue": "$400–550 (SJC Custom snare, 2014)"
    },
    "cymbals": {
    ...
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          ...
          "brand": "Vater",
          "model": "Vater 5B",
          "notes": "Standard 5B model, endorsed since 2009",
          "description": "Weinberg's Vater 5B sticks reflect an endorsement that predates his Slipknot tenure by five years. Vater manufactures premium American hickory sticks; hickory's natural shock absorption and durability made it well-suited to protecting Weinberg's hands across full-length Slipknot sets and recording sessions. The 5B profile balances the power required for Slipknot's heaviest passages with the control needed for dynamic variation in tracks like 'Killpop.'"
        },
        {
          "type": "Drumheads",
          "brand": "Evans",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "SJC Custom Drums' dynamic range is evident — the kit sounds dramatically different in the quiet verse vs the explosive chorus. EC2 heads contribute to the controlled warmth."
      },
      {
  ...
  "we-are-not-your-kind-drum-setup": {
    ...
    "drumKit": {
      "title": "SJC Custom Drums: The WANYK Reconfiguration",
      "brand": "SJC Custom Drums",
      "model": "SJC Custom Series",
      "finish": "Custom Slipknot-themed finishes (black, custom wraps)",
      "config": {
      ...
      "description": "By the time Slipknot entered the studio for *We Are Not Your Kind* in 2018–2019, Jay Weinberg had been an SJC Custom Drums artist for a decade — the endorsement predated Slipknot itself, going back to 2009 — and he continued playing SJC's hand-built kits, reconfigured and refinished to match Slipknot's stage aesthetic for the WANYK era. SJC (Scott Johnson Customs), based in Marlborough, Massachusetts, builds drums to individual artist specifications — giving Weinberg a kit tailored exactly to his touch, tuning preferences, and the band's visual identity.\n\nSJC's maple shells continued to deliver the warm, full-bodied attack suited to the denser, more atmospheric production Greg Fidelman built for WANYK. Custom hardware finishes matched the band's iconic visual aesthetic — the same SJC platform from the Gray Chapter, now refinished with a setup that was unmistakably Slipknot on stage.\n\nThe double 22\" x 18\" bass drums remained the foundation, with Weinberg's double-kick technique fully matured by the WANYK sessions. Tracks like \"Nero Forte\" and \"Birth of the Cruel\" feature double-bass patterns of exceptional density and precision.\n\nThe tom configuration — four rack toms (8\", 10\", 12\", 13\") plus two floor toms (16\", 18\") — gave Weinberg the full melodic range of fills that the album's more compositionally complex arrangements required, with the floor toms seeing increased compositional use on WANYK compared to the Gray Chapter's more standard layout.",
      "notes": [
        "Continued the same SJC Custom Drums platform played since 2009 — no brand switch, reconfigured and refinished for WANYK",
        "Darker visual finish aligned with WANYK album aesthetic",
        "SJC maple shells for warm, full-bodied attack — unchanged from the Gray Chapter era",
    ...
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          ...
          "brand": "Vater",
          "model": "Vater 5B",
          "notes": "Standard 5B model, endorsed since 2009, carried through WANYK sessions",
          "description": "By the WANYK sessions, Weinberg's Vater 5B sticks were a fully established part of his setup — a hickory model that balanced power and speed across the full dynamic range WANYK demanded. Slipknot's live show is among the most physically demanding in metal; sticks that could handle the touring circuit and the recording studio needed the durability and consistency that Vater's production processes provide."
        },
        {
          "type": "Drumheads",
          "brand": "Evans",
    ...
    "faq": [
      {
        ...
        "answer": "Jay Weinberg continued playing his SJC Custom Drums shell pack on We Are Not Your Kind (2019) — the same endorsement he'd held since 2009, reconfigured and refinished for the album, not a switch from a different brand. The SJC configuration features four rack toms (8\", 10\", 12\", 13\") plus two floor toms (16\", 18\"), and double 22\" x 18\" bass drums, with maple shells finished in custom Slipknot-themed wraps. Evans EMAD2 kick heads and EC2 batter heads were used throughout, with Pearl Demon Drive triggers integrated on the bass drums for the album's dense, hybrid production approach."
      },
      {
      ...
      },
      {
        ...
        "answer": "The most significant changes between Jay Weinberg's Gray Chapter (2014) and WANYK (2019) setups were the snare and cymbal configuration — his SJC Custom Drums kit itself, an endorsement he'd held since 2009, did not change brands, though it was reconfigured and refinished between albums. Weinberg switched from an SJC snare to a new Tama SLP snare. On the cymbal side, the Gray Chapter used a pure Zildjian A series setup; on WANYK he adopted a hybrid A and K Custom approach — retaining A series hi-hats and China for attack and clarity, while adding K Custom Dark crashes and a K Custom ride for darker, more complex crash and ride character suited to the album's atmospheric production. Evans EMAD2 heads replaced EMAD for heavier batter construction, and Pearl Demon Drive triggers were more prominent in the WANYK mix."
      },
      {
    ...
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          ...
          "brand": "Vater",
          "model": "Vater 5B",
          "notes": "Standard 5B model, endorsed since 2009, carried into TESF sessions",
          "description": "Weinberg's Vater 5B sticks — the established hickory model that balanced power and speed across Slipknot's demanding dynamic range — continued as his stick of choice for the TESF sessions. By his third studio album, the model was as much a part of his identity as any other piece of his setup."
        },
        {
          "type": "Drumheads",
          "brand": "Evans",
