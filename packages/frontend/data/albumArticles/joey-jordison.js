...
export const articles = {
  ...
  "all-hope-is-gone-drum-setup": {
    ...
    "cymbals": {
      "title": "Paiste RUDE and 2002: The Expanded All Hope Is Gone Setup",
      "brand": "Paiste",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Raw, unlathed hi-hats for fast patterns and song-focused groove work"
        },
        {
          "type": "Crash",
          "model": "Paiste RUDE 16\" Wild Crash",
      ...
      "description": "For *All Hope Is Gone*, Joey Jordison continued and expanded the Paiste RUDE setup that had defined his Iowa and Vol. 3 cymbal sound, supplementing it with select Paiste 2002 pieces for his late-Slipknot work. RUDE — Paiste's fully unlathed, raw bronze line built specifically for hard rock and metal drumming — kept the dark, trashy, extremely loud character that had cut through Slipknot's live and recorded mixes since 2001, while the wider Reference-era setup gave Joey more tonal options to work with.\n\nThe RUDE hi-hats deliver the rapid articulation Joey's playing demanded with a raw, cutting chick sound that sits clearly in Dave Fortman's mix. On \"Psychosocial\" — the album's defining track — the hi-hat pattern drives the verse with the kind of precision that survives the dense rhythm guitar layering without disappearing.\n\nThe crash array (16\", 18\", 19\") provides a hierarchy of dynamic weights for *All Hope Is Gone*'s wide range of song-section intensities. The RUDE Wild Crashes deliver the same unlathed aggression that had defined Jordison's sound since Iowa, now applied to Fortman's tighter, more controlled production approach.\n\nThe 22\" RUDE Power Ride is a notable feature of Joey's late-Slipknot setup. The pronounced bell gives the ride a powerful, cutting attack particularly suited to the slower, riff-driven sections of \"Dead Memories\" and \"Snuff,\" where the ride functions as a melodic voice rather than a pure timekeeping device. This represents a maturation of Joey's cymbal vocabulary beyond the pure-aggression vocabulary of the Iowa era, even as the Paiste RUDE foundation stayed constant.\n\nThe 20\" RUDE China continued the Slipknot tradition of aggressive China accents as compositional punctuation. On \"Gematria (The Killing Name)\" — the album opener — the China fires on the downbeats of the most intense sections with the same raw authority as the RUDE Chinas of earlier Slipknot albums.",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        {
          "category": "Cymbals",
          "then": "Paiste RUDE, expanded with 2002 series pieces",
          "now": "Paiste RUDE remains in production; same models Joey used"
        },
        {
          "category": "Pedals",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Joey Jordison used an expanded Paiste RUDE setup on All Hope Is Gone (2008), the same raw, unlathed series that had defined his Iowa and Vol. 3 cymbal sound, supplemented with Paiste 2002 pieces. The setup included Paiste RUDE 14 inch Wild Hi-Hats, RUDE Wild Crashes in 16, 18, and 19 inch sizes, a RUDE 22 inch Power Ride, a RUDE 20 inch Wild China, and a Paiste 2002 10 inch Splash. The fully unlathed RUDE series — designed for hard rock and metal — delivers a dark, trashy, extremely loud tone that continued to cut through Dave Fortman's tighter, more controlled production at Sound Farm Studios."
      },
      {
  ...
  "joey-jordison-drum-setup": {
    ...
    "cymbals": {
      ...
      "setup": [
        {
          ...
          "model": "Paiste RUDE 14\" Wild Hi-Hats",
          "position": "Left side",
          "notes": "Raw, unlathed hi-hat voice for rapid patterns"
        },
        {
          "type": "Crash",
          "model": "Paiste RUDE 16\" Wild Crash",
        ...
        },
        {
          ...
          "model": "Paiste RUDE 22\" Power Ride",
          "position": "Far right",
          "notes": "Versatile — pronounced bell cuts through even at high volumes"
        },
        {
          "type": "China",
          "model": "Paiste RUDE 20\" Wild China",
      ...
      "description": "Joey Jordison became a Paiste artist in May 2001 and his cymbal choices remained one of the most consistent elements of his setup throughout the Slipknot years. The combination of Paiste's RUDE and 2002 series gave him a setup built around RUDE's fully unlathed, raw bronze character, supplemented by the brighter, more traditional 2002 line.\n\nThe RUDE Wild Hi-Hats were central to Jordison's approach. RUDE cymbals feature a dark, trashy, unlathed voice — ideal for the rapid single-stroke hi-hat patterns that drove Slipknot's groove-based nu-metal. The 14\" diameter provided quick response without excessive wash, allowing each stroke to speak individually even at extreme tempos.\n\nHis crash setup — 16\" and 18\" RUDE Wild Crashes — covered the full spectrum of nu-metal accents. The 16\" spoke fast and sharp for punctuating fills; the 18\" provided the fuller, more resonant crash for section-ending explosions. Both cymbals' raw, unlathed character was essential in venues that ran from clubs to arenas with Slipknot's rapidly expanding audience.\n\nThe Paiste RUDE 22\" Power Ride brought a heavy, cutting voice to the right side of the kit. The pronounced bell gave Jordison a versatile ride that could serve either as a clean riding surface or as a large crash when driven hard.\n\nThe RUDE 20\" Wild China was the exclamation mark of Jordison's setup: raw, aggressive, with the distinctive unlathed surface that produces the trashiest possible china voice. Used selectively in his most extreme passages, it added a sonic violence that matched the intensity of Slipknot's heaviest moments.",
      "estimatedValue": "$1,500–2,500 (full Paiste RUDE/2002 setup)"
    },
    "hardware": {
      "title": "Pearl Demon Drive to Eliminator Demon Drive: The Pedal Evolution",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Pedal (Iowa/Vol. 3 era) / Pearl Eliminator Demon Drive (later career)",
          "notes": "Direct-drive cam mechanism throughout, refined for speed across eras",
          "description": "Jordison's pedal journey tracked his career evolution, staying within the Pearl family throughout. In the Iowa and Vol. 3 era he ran Pearl Demon Drive double bass pedals — a direct-drive cam mechanism delivering immediate response with zero chain slack, essential for the precision double-bass passages that defined his sound. The Demon Drive gave him the power and consistency to sustain his extreme double-bass tempos through full Slipknot performances. In later years, Jordison shifted to the Pearl Eliminator Demon Drive — a refined direct-drive evolution with interchangeable cam profiles that let him dial in the exact acceleration curve his technique required, extending the explosive speed his signature style demanded."
        },
        {
          "type": "Sticks",
          "brand": "Promark",
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          ...
          "cymbals": "Paiste RUDE setup",
          "hardware": "Pearl Demon Drive double bass pedal, Promark 5B / early Jordison signature sticks"
        },
      ...
      },
      {
        ...
        "gear": {
          ...
          "cymbals": "Paiste 2002 pieces added to RUDE setup",
          "hardware": "Pearl Demon Drive continued, Promark Jordison Signature sticks"
        },
      ...
      },
      {
        ...
        "gear": {
          ...
          "hardware": "Pearl Eliminator Demon Drive double pedal transition, Jordison Signature sticks"
        },
    ...
    "buyingGuide": {
      ...
      "budgetTiers": [
        ...
        },
        {
          "tier": "Mid-Range",
          "range": "$2,000–4,000",
          "notes": "Session Studio + Paiste 2002 crashes + Pearl Demon Drive double pedal"
        },
        {
          "tier": "Professional",
          "range": "$5,000+",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Joey Jordison became a Paiste artist in May 2001 and built his setup around the Paiste RUDE and 2002 series. His primary setup included Paiste RUDE 14\" Wild Hi-Hats, 16\" and 18\" RUDE Wild Crashes, a Paiste RUDE 22\" Power Ride, and a Paiste RUDE 20\" Wild China. The RUDE series' fully unlathed, raw, dark and trashy character was essential for cutting through Slipknot's dense multi-guitar and percussion mix — both on albums like Iowa and Vol. 3, and in the massive live arenas Slipknot headlined."
      },
      {
        "question": "What double bass pedals did Joey Jordison use?",
        "answer": "During the Iowa and Vol. 3 era, Joey Jordison played Pearl Demon Drive double bass drum pedals — a direct-drive cam mechanism delivering immediate response with zero chain slack. The Demon Drive's adjustable cam profiles and precision construction supported Jordison's extreme double-kick tempos. In later years he transitioned to the Pearl Eliminator Demon Drive, a refined evolution of the same direct-drive system with interchangeable cam shapes for customizing the acceleration curve to match his technique."
      },
      {
        "question": "What drumsticks did Joey Jordison use?",
        "answer": "Joey Jordison played Promark Joey Jordison Signature TX515W drumsticks, a model developed with Promark to match his specific extreme-metal playing demands. The sticks featured a custom taper optimized for blast beats and rapid single-stroke patterns, with a tip shape providing clear cymbal articulation at high velocities. Before his signature model was released, Jordison used Promark 5B American Hickory sticks."
      },
      {
