...
export const articles = {
  "slipknot-self-titled-drum-setup": {
    ...
    "description": "Complete breakdown of Joey Jordison's drum setup on Slipknot's 1999 self-titled debut. ddrum kit, Zildjian A Custom cymbals, Tama Iron Cobra pedals — the pre-endorsement rig that launched one of metal's greatest drum careers.",
    "seoKeywords": [
    ...
    "drumKit": {
      "title": "The Pre-Endorsement Rig: ddrum",
      "brand": "ddrum",
      "model": "ddrum kit (specific model not publicly documented)",
      ...
      "estimatedValue": "Not publicly documented"
    },
    "snare": {
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "Full kit deployment with tom fills across the ddrum kit's tom spread. A Custom crashes at each major section transition."
      },
      {
        "track": "Scissors",
        "bpm": "Variable",
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Joey Jordison recorded Slipknot's 1999 self-titled debut on a ddrum kit (the specific model is not publicly documented), in the pre-Pearl endorsement era. The configuration included double 22-inch bass drums and a standard tom spread with rack toms at 10, 12, and 14 inches plus a 16-inch floor tom. This was a mid-range ddrum setup rather than a custom artist kit — the performances that launched Slipknot's career came from a drummer playing the best gear he had access to, not a corporate-backed custom specification. Joey would transition to Pearl Masterworks for the Iowa sessions in 2001."
              }
            },
            {
              "@type": "Question",
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Joey Jordison's first major endorsements came through the commercial success of Slipknot's 1999 self-titled debut. The debut was recorded with pre-endorsement gear — a ddrum kit, Zildjian A Custom cymbals, and a Tama Iron Cobra double pedal. After the album went Platinum and Slipknot became a mainstream phenomenon, Joey secured endorsement relationships with Pearl drums, Paiste cymbals, and Promark sticks. By the time the band recorded Iowa in 2001, Joey was fully endorsed by Pearl and Paiste."
              }
            },
            {
              "@type": "Question",
