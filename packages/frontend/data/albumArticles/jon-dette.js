...
export const articles = {
  "jon-dette-drum-setup": {
    ...
    "gearTimeline": [
      ...
      {
        "era": "Testament — Touring Drummer, First Stint",
        "years": "1997–1999",
        "albums": [
          "Touring only — The Gathering (1999) was recorded in the studio by Dave Lombardo"
        ],
        "description": "Testament's touring drummer during The Gathering era — cult thrash following, progressive songwriting, live-only role.",
        "gear": {
          "drums": "Professional maple kit — setup optimized for Testament's touring environment",
          "snare": "Bright, focused tuning for live shows",
          "cymbals": "Sabian or Zildjian professional setup",
          "pedals": "Double bass pedal for Testament's thrash material"
        },
        "notes": "The Gathering (1999) is the album most associated with this era of Testament's history, but its drums were recorded by Dave Lombardo, not Dette. Dette toured behind the album, applying his own gear and technique to a heavier, more aggressive live show built on material he didn't record."
      },
      {
        "era": "Testament — Touring Drummer, Second Stint",
        "years": "2001–2012",
        "albums": [
          "Live at the Fillmore (2005) — Dette's only recorded credit with the band",
          "Touring only — The Formation of Damnation (2008) recorded by Paul Bostaph; Dark Roots of Earth (2012) recorded by Gene Hoglan"
        ],
        "description": "Testament's commercial and critical resurgence — Dette's longest touring relationship with the band, captured on Live at the Fillmore.",
        "gear": {
        ...
        "notes": "The Formation of Damnation (2008) marked Testament's Nuclear Blast era comeback — a commercially and critically successful return that positioned the band among thrash's active elite alongside Slayer, Megadeth, and Anthrax — and Dark Roots of Earth (2012) continued this trajectory, but both were studio records made by Paul Bostaph and Gene Hoglan respectively. Dette's contribution to this period was as touring drummer, documented on the live album Live at the Fillmore (2005)."
      }
    ],
    "faq": [
      {
