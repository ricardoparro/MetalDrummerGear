// Album drum-setup articles — Jon Dette. Auto-split from the former monolith.
export const articles = {
  "jon-dette-drum-setup": {
    ...
    "seoKeywords": [
      "jon dette drum setup",
      "jon dette drum kit",
      "jon dette slayer drums",
      "jon dette testament",
      "jon dette ludwig kit",
      "slayer drummer gear",
      "thrash metal drummer setup"
    ],
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Testament touring drummer across two periods (1997–1999, 2001–2012) — documented on the live album Live at the Fillmore, not on any studio album",
    ...
    "drumKit": {
      ...
      "config": {
        "bassdrums": [
          "22\" x 16\" Bass Drum (x2 — double bass configuration for Slayer material)"
        ],
        "toms": [
          "10\" x 8\" Rack Tom",
          "12\" x 9\" Rack Tom"
      ...
      "setup": [
        {
          ...
          "model": "14\" Hi-Hats",
          "position": "Left side",
          "notes": "Fast, articulate response for thrash metal sixteenth-note pulse at 180–220 BPM"
        },
        {
          "type": "Crash",
          "model": "16\" Crash",
          "position": "Left crash",
          "notes": "Quick attack and decay for accent work in thrash passages"
        },
        {
          "type": "Crash",
          "model": "18\" Crash",
          "position": "Right crash",
          "notes": "Fuller crash for structural accent points and section boundaries"
        },
        {
          "type": "Ride",
          "model": "20\" Ride",
          "position": "Right",
          "notes": "Defined bell for ride patterns; usable as a heavy wash"
        },
        {
          "type": "China",
          "model": "18\" China",
          "position": "Over rack toms",
          "notes": "Aggressive trash accent for Slayer's most intense passages"
        }
      ],
    ...
    "gearTimeline": [
      {
        ...
        "years": "1996–1997",
        "albums": [
          "Slayer live touring — full Reign in Blood / South of Heaven / Seasons in the Abyss catalogue"
        ],
      ...
      {
        "era": "Testament — The Gathering Touring Cycle",
        "years": "1997–1999",
        "albums": [
          "The Gathering (1999) — studio album recorded by Dave Lombardo; Dette was Testament's touring drummer for this era"
        ],
        "description": "Touring cycle for Testament's The Gathering — cult thrash following, progressive songwriting; Dette held the touring drummer's chair while Dave Lombardo recorded the studio album.",
        "gear": {
          "drums": "Professional maple kit — setup optimized for Testament's live shows",
          "snare": "Bright, focused tuning for Testament's live mix",
          "cymbals": "Sabian or Zildjian professional setup",
          "pedals": "Double bass pedal for Testament's thrash material"
        },
        "notes": "The Gathering (1999) is the album most associated with this era of Testament, but it was recorded by Dave Lombardo, not Dette — Dette joined as the band's touring drummer for the supporting tour. Produced with a heavier, more aggressive sound than previous Testament records and featuring guitar work from both Alex Skolnick and James Murphy, the album's touring cycle gave Dette the opportunity to bring his thrash metal power and precision to Testament's live show."
      },
      {
        "era": "Testament — Formation of Damnation and Dark Roots of Earth Touring Cycles",
        "years": "2001–2012",
        "albums": [
          "The Formation of Damnation (2008) — recorded by Paul Bostaph",
          "Dark Roots of Earth (2012) — recorded by Gene Hoglan"
        ],
        "description": "Testament's commercial and critical resurgence — Dette returned as the band's touring drummer for these album cycles, while the studio records were made by Paul Bostaph and Gene Hoglan.",
        "gear": {
        ...
        "notes": "The Formation of Damnation (2008) marked Testament's Nuclear Blast era comeback — a commercially and critically successful return that positioned the band among thrash's active elite alongside Slayer, Megadeth, and Anthrax; the studio album was recorded by Paul Bostaph. Dark Roots of Earth (2012) continued this trajectory and was recorded by Gene Hoglan. Dette's role across both album cycles was as Testament's touring drummer, not as a studio contributor."
      }
    ],
    "faq": [
      {
      ...
      {
        "question": "Did Jon Dette record any Testament studio albums?",
        "answer": "No. Despite being Testament's touring drummer across two stints (1997–1999, 2001–2012), Jon Dette did not perform on any of the band's studio albums. The Gathering (1999) — widely considered one of Testament's finest albums — was recorded by Dave Lombardo. The Formation of Damnation (2008) was recorded by Paul Bostaph, and Dark Roots of Earth (2012) was recorded by Gene Hoglan. Dette's Testament tenure is documented on the live album Live at the Fillmore (2000), and he toured behind all three of those studio records without appearing on them."
      },
      {
