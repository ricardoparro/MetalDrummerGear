...
export const articles = {
  ...
  "load-drum-setup": {
    ...
    "hardware": {
      "title": "Tama Hardware Through the Load Sessions",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "Tama",
          "model": "Tama Iron Cobra Double Pedal",
          "notes": "The cam-driven Iron Cobra remained Lars's double pedal of choice through the Load sessions",
          "description": "The Tama Iron Cobra double pedal — the cam-driven mechanism that had served Lars well since the Black Album sessions — remained his primary pedal reference for Load, consistent with his long-running Tama hardware relationship."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Tama",
          "model": "Tama Titan Hi-Hat Stand",
          "notes": "Standard Tama Titan hardware, consistent with Lars's established rig"
        },
        {
          "type": "Cymbal Stands",
          "brand": "Tama",
  ...
  "reload-drum-setup": {
    ...
    "hardware": {
      "title": "Consolidated Tama Hardware Into the Reload Sessions",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "Tama",
          "model": "Tama Iron Cobra Double Pedal",
          "notes": "Iron Cobra remained Lars's primary double pedal into the Reload sessions",
          "description": "Reload's hardware setup continued directly from the Load sessions. The Tama Iron Cobra double pedal — the cam-driven mechanism that had served Lars since the Black Album — remained the primary double pedal for the Reload recording, consistent with his long-running Tama hardware relationship."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Tama",
          "model": "Tama Titan Hi-Hat Stand",
          "notes": "Same Tama Titan hardware carried over from the Load sessions"
        },
        {
          "type": "Cymbal Stands",
          "brand": "Tama",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "The Reload snare uses a Tama LU1465 Lars Ulrich Signature — a 14\" x 6.5\" steel shell drum — tuned to moderate tension. The LU1465's steel construction provides brightness and cut while resisting muddiness at lower tunings. Bob Rock's production philosophy for Load and Reload deliberately reduced the heavy gated reverb that characterised the Black Album snare, resulting in a more naturalistic, present snare sound. The Reload snare sits in a different universe from the St. Anger snare (2003) — a raw, deliberately unpolished sound that divided listeners — making Reload the last Metallica album to feature Lars's naturalistic studio snare approach before that radical departure."
      },
      {
  ...
  "st-anger-drum-setup": {
    ...
    "description": "Complete breakdown of Lars Ulrich's drum setup on Metallica's St. Anger (2003) — including the most controversial snare in metal history: a raw, ultra-tight Ludwig snare borrowed from producer Bob Rock, producing the polarising metallic 'clang' that defined the album.",
    "seoKeywords": [
      "st anger drum setup",
    ...
    "drumKit": {
      ...
      "config": {
        ...
        "shells": "Tama Starclassic Maple shell construction"
      },
      "description": "For the St. Anger sessions, Lars Ulrich continued playing Tama — the Starclassic Maple kit he'd carried from the Load/Reload era, finished in a distinctive Green Sparkle wrap, assembled at HQ, the Metallica-owned facility located inside the Presidio in San Francisco. Despite the album's radical break from the band's prior production philosophy, Lars's drum brand did not change; the departure was in the snare and the recording approach, not the kit.\n\nThe configuration was a true double bass setup — two 22\" x 18\" kick drums rather than a single kick with double pedal. This was a deliberate choice for St. Anger's relentless, often surf-tempo-meets-thrash kick patterns: two independent drums project two independent attacks, with the physical mass of dual shells producing a heavier low-end footprint in the room than a single kick with double pedal can replicate. Tracks like \"Frantic,\" \"St. Anger,\" and \"Some Kind of Monster\" depend on this kind of sustained dual-kick weight.\n\nThe tom configuration was deliberately spartan compared to Lars's Black Album and Load-era spreads. A single 12\" rack tom over the hi-hat side, with two floor toms (14\" and 16\") on the right, reduced the kit to its functional core for a record whose drum sound philosophy was about raw impact rather than melodic tom orchestration. The Starclassic Maple's shell construction provided the attack and projection necessary for the dry, close-miked production approach the album required.",
      "notes": [
        "Tama Starclassic Maple, Green Sparkle finish — continuity with Lars's Load/Reload-era kit, not a brand change",
        "True double bass configuration: two independent 22\"x18\" kick drums, not a single kick with double pedal",
        "Reduced tom configuration vs. Black Album / Load era — spartan, function-forward setup",
        "Assembled at HQ (the Presidio facility) for the St. Anger sessions",
        "Green Sparkle finish (per uberproaudio's gear breakdown)"
      ],
    ...
    "snare": {
      ...
      "brand": "Ludwig",
      "model": "Ludwig Plexi/Vistalite Snare (borrowed from producer Bob Rock)",
      "size": "14\" (exact depth unconfirmed)",
      "shell": "Acrylic — Ludwig Vistalite/Plexi construction",
      "description": "The snare drum on St. Anger is the single most discussed piece of metal percussion of the 2000s, and the conversation has not stopped in twenty-plus years. Per producer Bob Rock's account (Consequence.net, 2020), the drum itself wasn't one of Lars's own signature Tama snares at all: Bob Rock had bought a Ludwig Plexi/Vistalite snare, Lars borrowed it during pre-production demos, and its raw, unglamorous rehearsal-room character stuck for the finished album.\n\nBob Rock's account attributes the record's dry, metallic \"clang\" — frequently and not unfairly compared by listeners to a trashcan lid — to that borrowed drum's raw character and the tight tuning applied to it, rather than to any wire-disengagement trick. This article omits an unverified claim that circulated for years about the snare wires being intentionally switched off; that specific mechanism has not been independently confirmed and is not repeated here.\n\nWhatever the precise mechanism, the sound was a deliberate aesthetic choice. The St. Anger production brief, as documented in Some Kind of Monster and in Bob Rock and Lars Ulrich's later interviews, was for a raw, industrial, almost garage-band drum sound — a hard rejection of the polished, room-mic-driven Black Album and Load tones. It is also the choice that polarised the metal audience more than any other single production decision in the band's history. Some fans hear it as a bold, brave commitment to a raw sonic identity. Others consider it the band's worst single creative decision. Both reactions are valid responses to a sound that was, by design, supposed to provoke.\n\nThe snare appears in this configuration on every track of the record. There was no \"corrected\" version mixed for radio singles. What was committed to tape was what shipped.",
      "tuningSetting": "Ultra-high batter head tension on the borrowed Ludwig snare",
      "heads": "Evans Heavyweight (batter)",
      "estimatedValue": "Not commercially reproducible — a one-off snare borrowed from producer Bob Rock, not a Lars Ulrich signature model"
    },
    "cymbals": {
      ...
      "items": [
        {
          ...
          "notes": "Lars continued using Tama pedals for St. Anger, consistent with his long-running Tama endorsement",
    ...
    "faq": [
      {
        ...
        "answer": "The St. Anger snare sounds different because Lars Ulrich didn't record it on one of his usual Tama signature snares. Producer Bob Rock has said in interviews that a Ludwig Plexi/Vistalite snare he had bought for himself was borrowed by Lars during pre-production demos and ended up sticking for the finished album, tuned extremely tight. The result is a dry, metallic \"clang\" that listeners frequently compare to a trashcan lid. This was a deliberate aesthetic decision aligned with the album's raw, industrial production brief, not a recording mistake or a hardware problem. The sound has been one of the most polarising production choices in modern metal since the album's 2003 release."
      },
      {
        "question": "What snare did Lars Ulrich use on St. Anger?",
        "answer": "Per producer Bob Rock's account (Consequence.net, 2020), the St. Anger snare was a Ludwig Plexi/Vistalite drum that Bob Rock had bought and Lars borrowed during pre-production — not one of Lars's usual Tama signature snares. Tuned to extremely high tension, it produced the metallic \"clang\" sound heard across every track on the album. This was confirmed by Bob Rock in interviews and the sessions were documented visually in the Some Kind of Monster film. It was not a recording mistake — it was an explicit aesthetic choice the band has consistently defended for more than twenty years."
      },
      {
        "question": "What drum kit did Lars Ulrich use on St. Anger?",
        "answer": "Lars Ulrich played a Tama Starclassic Maple kit in a Green Sparkle finish on St. Anger, continuing his Tama endorsement from the Load and Reload eras — the album's radical sound came from the snare and production choices, not a change in drum brand. The kit was configured with two 22\"x18\" bass drums (a true double bass setup, not a single kick with double pedal), a 12\" rack tom, and 14\" and 16\" floor toms. Cymbals were a Zildjian Z Custom and A Custom hybrid, pedals were Tama Speed Cobra HP910, sticks were Ahead aluminium-core signatures, and heads were Evans throughout (EMAD on kicks, EC2 on toms, Heavyweight on the snare batter). The kit was assembled at HQ — Metallica's San Francisco facility inside the Presidio — for the album sessions."
      },
      {
        "question": "Was the St. Anger snare sound intentional?",
        "answer": "Yes. The St. Anger snare sound was an entirely intentional production decision made by Lars Ulrich and producer Bob Rock. The brief for the album was a raw, industrial, garage-band drum sound that rejected the polished, room-mic-heavy approach of the Black Album, Load, and ReLoad. Recording on a raw, borrowed Ludwig snare tuned ultra-tight was the way that aesthetic came together. The decision is documented extensively in the Some Kind of Monster film, has been defended in numerous interviews by both Lars and Bob Rock, and was committed to across the entire record — there is no \"corrected\" version of any track. Listener reception has been deeply polarised since release, but the band has never described the sound as a mistake; it was the sound they meant to make."
      }
    ],
    "relatedAlbums": [
      "reload-drum-setup",
  ...
  "hardwired-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Tama Starclassic Maple kit (Deeper Purple finish) with dual 22\" × 18\" bass drums — continuing Lars's Tama-exclusive history",
        "Tama Speed Cobra HP910 pedals, consistent with the Death Magnetic era",
        "Debuted at #1 in 57 countries — global commercial dominance",
        "Double album: 12 tracks across 2 discs"
      ]
    },
    "drumKit": {
      "title": "Lars's Hardwired Kit: Tama Starclassic Maple, \"Deeper Purple\"",
      "brand": "Tama",
      "model": "Tama Starclassic Maple",
      ...
      "description": "For Hardwired...to Self-Destruct, Lars Ulrich anchored his setup on a Tama Starclassic Maple kit finished in Deeper Purple — the touring replica of this kit was later released by Tama as the limited-edition \"Worldwired\" kit. Where the earlier Tama Starclassic Birch of Death Magnetic had emphasized attack and punch, the Starclassic Maple shells offered a wider tonal palette: warmer fundamentals, longer sustain, and the kind of fullness that suited Hardwired's heavier, riff-dense arrangements. The brand didn't change — Lars has remained a Tama-exclusive endorser since the mid-1980s — but the shell material did.\n\nThe defining choice for Hardwired was the move to dual 22\" × 18\" bass drums. Lars had spent decades running a single 22\" kick with an Iron Cobra double pedal, but the dual-kick configuration on Hardwired delivered tonal consistency and visual presence that matched the album's renewed thrash ambitions. Each bass drum could be tuned independently, allowing subtle character differences between the two, and the dual-kick rig eliminated the slight mechanical compromises inherent to slave-beater double pedals.\n\nLars kept his tom configuration economical for Hardwired: a single 12\" rack tom up top with 14\" and 16\" floor toms below. This is the same minimal tom setup he has favored since the Justice era — Lars's playing has always emphasized kick-snare interaction over tom flurries, and the limited tom array reflects that priority. When the toms do appear, as in the fills throughout \"Atlas, Rise!\" and the explosive moments in \"Spit Out the Bone,\" they punctuate rather than decorate.\n\nCombined with Evans heads tuned for attack and the room treatment Metallica had developed at their own facility, the kit sound on Hardwired stands among the most refined Lars has ever committed to record.",
      "notes": [
        "Tama Starclassic Maple, Deeper Purple finish — later released by Tama as the limited-edition \"Worldwired\" replica kit",
        "Dual 22\" × 18\" bass drums replaced the single-kick + double-pedal of earlier sessions",
        "Shell material shifted from Death Magnetic's Starclassic Birch to Starclassic Maple — brand remained Tama throughout",
        "Minimal tom configuration matches Lars's kick-snare-focused playing"
      ],
      "estimatedValue": "$5,000-7,000 (2016 Tama Starclassic Maple configuration)"
    },
    "snare": {
      "title": "The Tama Steel Snare: Hardwired's Cracking Voice",
      "brand": "Tama",
      "model": "Tama signature steel-shell snare (LU1465 family; exact Hardwired-era model unconfirmed)",
      "size": "14\" x 6.5\"",
      "shell": "Steel",
      "description": "For Hardwired, Lars Ulrich's snare drum was a Tama steel-shell signature snare — DRUM! Magazine's Hardwired-era feature described it as Lars's \"signature steel plate snare by Tama.\" This continues directly from the steel-shell Tama LU1465 he used on Death Magnetic rather than representing any change of brand.\n\nThe 6.5\" depth gave the snare enough body to register through the densely layered guitar parts that characterize tracks like \"Moth Into Flame\" and \"Halo on Fire,\" while die-cast hoops kept rimshots tight and consistent throughout the album's most punishing passages. The steel shell's bright cut balanced the Zildjian cymbal array, producing a snare voice that cut without being harsh — exactly the tonal balance Hardwired's mix demanded.\n\nFidelman's snare capture at HQ combined a Shure SM57 close mic on top with a secondary mic underneath to track snare wire response. The HQ studio's controlled acoustic environment, which the band had refined across years of pre-production work in the facility, gave the snare a natural room character without bleed problems.\n\nLars's tuning approach for Hardwired stayed in the medium-high range that has defined his playing for decades: enough tension for sharp attack and clarity in fast passages, with the resonant head tuned slightly looser to give the snare body. Evans Heavyweight batter head delivered the durability needed for the album's heaviest backbeats without sacrificing tonal response.",
      ...
      "estimatedValue": "$450-650 (2016 Tama steel signature snare)"
    },
    "cymbals": {
      ...
      "items": [
        {
          ...
          "notes": "Lars continued using Tama Speed Cobra pedals through the Hardwired era, consistent with the Death Magnetic touring cycle",
          "description": "For Hardwired, Lars Ulrich continued using Tama Speed Cobra HP910 pedals, the same pedal line he had used during the Death Magnetic touring cycle. The Speed Cobra's long footboard and Cobra Coil spring system delivered fast rebound and effortless response, well suited to the sustained double-bass passages on \"Spit Out the Bone\" and \"Atlas, Rise!.\" Used as two single pedals on the dual-kick rig, the Speed Cobras gave Lars the consistent feel across both feet that demanding uptempo arrangements require."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Tama",
    ...
    "evolution": {
      ...
      "content": "Hardwired...to Self-Destruct represents the culmination of Lars Ulrich's gear evolution through the modern Metallica era. The album sits at a pivotal point: the Tama Starclassic Maple kit had replaced the Starclassic Birch shells of Death Magnetic (Lars's Tama endorsement itself never changed), the Zildjian A Custom range had become his established cymbal core (with Z Custom additions), and Tama Speed Cobra pedals continued from the previous touring cycle.\n\n**Before Hardwired:**\nThe Black Album (1991) used Tama Artist Maple shells and traditional Zildjian A Series cymbals with Bob Rock's warm production. Death Magnetic (2008) saw Tama Starclassic Birch with Rick Rubin's punchy production approach. Both albums sit in a clear lineage with Hardwired — same drummer, same Tama endorsement, similar philosophical commitment to thrash sound, but each with distinct shell/finish choices that reflected the production era.\n\n**The Hardwired Configuration:**\nFor Hardwired, Lars settled on:\n- Tama Starclassic Maple kit, Deeper Purple finish (shell material change from Death Magnetic's Starclassic Birch)\n- Dual 22\" × 18\" bass drums (replacing single kick + double pedal)\n- Tama steel-shell signature snare (continuing the Tama LU1465-family snare of Death Magnetic)\n- Zildjian A Custom + Z Custom cymbals (expanded from pure A Custom)\n- Tama Speed Cobra HP910 pedals (continued from Death Magnetic)\n- Evans heads across all drums (replacing Remo)\n- Ahead Lars Ulrich Signature sticks (consistent since late 1990s)\n\n**The Modern Standard:**\nThe Hardwired gear configuration became Lars's standard touring setup through the WorldWired Tour (2016–2019) and beyond. The combination of Tama shells and hardware, Zildjian cymbals, Evans heads, and Ahead sticks represents the modern Lars Ulrich rig — built on his Tama-exclusive endorsement since the mid-1980s.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Starclassic Maple (Hardwired)",
        ...
        {
          "category": "Snare",
          "then": "Tama steel-shell signature snare, 14\" × 6.5\"",
          "now": "Tama steel-shell signature snare, 14\" × 6.5\""
        },
        {
          "category": "Cymbals",
    ...
    "faq": [
      {
        ...
        "answer": "Lars Ulrich recorded Hardwired...to Self-Destruct in 2016 using a Tama Starclassic Maple drum kit finished in Deeper Purple — a shell-material change from the Starclassic Birch he used on Death Magnetic, but no change in brand; Lars has been a Tama-exclusive endorser since the mid-1980s. The configuration included dual 22x18 inch bass drums, a 12 inch rack tom, and 14 and 16 inch floor toms. The Starclassic Maple shells delivered a warmer, fuller tone than the Starclassic Birch, a fit for Greg Fidelman's punchier production at Metallica's HQ studio in San Rafael, California."
      },
      {
        "question": "What snare did Lars Ulrich use on Hardwired?",
        "answer": "Lars Ulrich used a Tama steel-shell signature snare (14x6.5 inch) on Hardwired — a continuation of the Tama LU1465-family steel-shell signature snare he used on Death Magnetic, not a change of brand. DRUM! Magazine's Hardwired-era feature described it as Lars's \"signature steel plate snare by Tama.\" Die-cast hoops kept rimshots tight and consistent, and the snare was tuned medium-high for attack and clarity, paired with an Evans Heavyweight batter head for durability under the album's aggressive backbeats."
      },
      {
      ...
      },
      {
        ...
        "answer": "Lars Ulrich used Tama Speed Cobra HP910 pedals on Hardwired, continuing directly from the Death Magnetic touring cycle. The Speed Cobra's long footboard and Cobra Coil spring system deliver fast rebound and effortless response — well suited to the sustained double-bass passages on tracks like \"Spit Out the Bone\" and \"Atlas, Rise!.\" Used as two single pedals on a dual-kick rig, the Speed Cobras gave Lars consistent feel across both feet at the demanding uptempo arrangements Hardwired required."
      },
      {
      ...
      },
      {
        ...
        "answer": "Hardwired sits in a clear lineage with Death Magnetic but represents an evolution rather than a repeat. Where Death Magnetic used a Tama Starclassic Birch kit with a single bass drum + double pedal and a steel Tama LU1465-family snare under Rick Rubin's production, Hardwired moved to a Tama Starclassic Maple kit with dual 22 inch bass drums under Greg Fidelman's co-production, while keeping the same Tama steel-shell signature snare family. The Hardwired drum tone has more low-end weight and slightly fuller body than Death Magnetic, but maintains the same attack-forward, thrash-aligned character. Both albums avoid the over-compressed mastering issues that plagued Death Magnetic's release."
      }
    ],
    "conclusion": {
      "title": "Hardwired: The Modern Lars Ulrich Configuration",
      "content": "Hardwired...to Self-Destruct captures Lars Ulrich at a confident moment in his modern career — playing the most sustained uptempo material Metallica had recorded since the Black Album era, on a refined Tama-anchored kit that combined Tama shells and pedals, Zildjian cymbals, Evans heads, and Ahead sticks into a single coherent setup. The album sits cleanly within the Black Album → Death Magnetic → Hardwired arc: each record represents Lars at a particular gear and production juncture, with Hardwired delivering the most polished synthesis of the three.\n\nThe Tama Starclassic Maple kit, dual 22\" × 18\" bass drums, and Tama Speed Cobra pedals became Lars's established touring rig from 2016 onward — through the WorldWired Tour and into Metallica's subsequent activity. The combination of self-production at HQ studio and Greg Fidelman's punchy modern engineering produced a drum tone that avoided the Loudness War controversy of Death Magnetic while delivering the kind of weight and attack that the material demanded.\n\nFor drummers studying Lars Ulrich's modern setup, the Hardwired configuration is the reference. The gear is achievable: Tama Starclassic Maple remains in production, Zildjian A Custom and Z Custom cymbals are widely available, Tama Speed Cobra HP910 pedals remain a standard choice for working drummers, and Evans heads are everywhere. What's less replicable is the context — three decades of Metallica drumming refined into the configuration that worked, and a self-owned studio environment with unlimited time for sound refinement.\n\nFor the full Lars Ulrich gear story across the modern era, see the [Lars Ulrich drummer profile](/drummer/lars-ulrich), the [Black Album drum setup](/articles/black-album-drum-setup), and the [Death Magnetic drum setup](/articles/death-magnetic-drum-setup). For broader context on the band, see the [Metallica band page](/band/metallica). For comparison with the modern thrash drumming landscape, the [thrash metal drummers guide](/articles/thrash-metal-drummers) and the [Big Four drummers analysis](/articles/big-four-drummers) cover Lars's peers and contemporaries."
    },
    "schema": {
      "@context": "https://schema.org",
      "@graph": [
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Lars Ulrich used a Tama Starclassic Maple drum kit on Hardwired...to Self-Destruct, with dual 22x18 inch bass drums, a 12 inch rack tom, and 14 and 16 inch floor toms. The maple shells delivered a warmer, fuller tone than the Tama Starclassic Birch he used on Death Magnetic."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Lars Ulrich used a Tama steel-shell signature snare (14x6.5 inch, LU1465 family) with die-cast hoops on Hardwired, tuned medium-high with an Evans Heavyweight batter head — a continuation of the same snare family used on Death Magnetic."
              }
            },
            {
              "@type": "Question",
            ...
            {
              "@type": "Question",
              "name": "Why did Lars Ulrich switch to Tama Speed Cobra pedals for Hardwired?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Lars Ulrich switched to Tama Speed Cobra HP910 pedals during the Hardwired era for their fast rebound and effortless response — well suited to the sustained double-bass passages on tracks like Spit Out the Bone and Atlas, Rise!."
              }
            },
            {
              "@type": "Question",
