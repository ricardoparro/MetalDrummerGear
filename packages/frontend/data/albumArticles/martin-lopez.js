...
export const articles = {
  ...
  "martin-lopez-drum-setup": {
    ...
    "description": "Discover the exact drum kit, cymbals, and gear Martin Lopez uses with Soen and used with Opeth. Complete setup breakdown covering his Noble & Cooley Walnut shell pack, Zildjian K Dark Series cymbals, and the jazz-influenced technique behind Blackwater Park and Soen's progressive sound.",
    "seoKeywords": [
      "martin lopez drum setup",
      "opeth drummer gear",
      "soen drummer kit",
      "martin lopez blackwater park drums",
      "martin lopez noble and cooley",
    ...
    "intro": {
      ...
      "keyPoints": [
        "Noble & Cooley Walnut shell pack — boutique American shells built for warmth",
        "Zildjian K Dark Series cymbals for dark, complex overtones",
    ...
    "drumKit": {
      "title": "Martin's Noble & Cooley Walnut Shell Pack",
      "brand": "Noble & Cooley",
      "model": "Noble & Cooley Walnut",
      "finish": "Walnut shell pack",
      "config": {
        "bassdrums": [
          "22\" × 18\" Bass Drum"
        ],
      ...
      "description": "Noble & Cooley is a boutique American drum maker, and Lopez's switch to their walnut shell pack for Soen reflects his priorities as a musician: warmth, articulation, and dynamic responsiveness over pure volume.\n\nWalnut shells sit tonally between maple and mahogany — a warmer, more focused fundamental than maple with faster attack than mahogany. This tonal character suits Soen's material, which frequently shifts between delicate instrumental passages and dense, heavy sections within a single track.\n\nThe configuration — 22\" bass drum, 10\" and 12\" rack toms, 14\" and 16\" floor toms — gives Lopez a compact, well-balanced palette. He prioritizes feel over spectacle: no giant double-kicks, no wall of rack toms. The setup is built to be played musically, not to impress from across an arena floor. Every tom has a specific voice in his arrangements.\n\nLopez tunes his drums to sing rather than thud — medium-high tension on toms for articulation, medium-low on the kick for depth without boom. This tuning philosophy traces directly to his jazz background, where drums are treated as melodic instruments rather than pure timekeepers.",
      "notes": [
        "Switched to boutique American maker Noble & Cooley for the Soen era",
        "Walnut construction for a warmer, more focused tone than his earlier maple kits",
    ...
    "cymbals": {
      ...
      "setup": [
        {
          "type": "Hi-Hats",
          "model": "Zildjian K Dark Thin 14\" Hi-Hats",
          "position": "Left side",
          "notes": "Dark, trashy, and versatile — excellent definition for groove-based patterns"
        },
        {
          "type": "Crash",
          "model": "Zildjian K Dark Medium Thin 18\" Crash",
          "position": "Left crash",
          "notes": "Fast, dark, musical — quick decay ideal for dynamic passages"
        },
        {
          "type": "Crash",
          "model": "Zildjian K Dark Medium Thin 20\" Crash",
          "position": "Right crash",
          "notes": "Fuller voice for heavier accents and section endings"
        },
        {
          "type": "Ride",
          "model": "Zildjian K Dark Light 22\" Ride",
          "position": "Far right",
        ...
        },
        {
          ...
          "position": "Above ride",
          "notes": "Trashy, dark accent for jazz-influenced ornaments"
        }
      ],
      "description": "Lopez's cymbal palette favors warmth and musical complexity over raw cut. The Zildjian K Dark Series gives him a darker, drier overtone structure than his earlier A/K mix — an upgrade suited to Soen's atmospheric, mature progressive sound.\n\nThe 14\" K Dark Thin hi-hats are a dark, complex choice that gives Lopez outstanding definition for intricate hi-hat patterns and the control to blend from fully open to razor-tight in a single phrase. His groove playing relies heavily on hi-hat dynamics, and the K Dark Thins respond to subtle foot pressure changes in ways cheaper cymbals cannot.\n\nThe crash selection bridges light and heavy: the 18\" K Dark Medium Thin crashes quickly for dynamic accents without sustaining into the next phrase, while the 20\" K Dark Medium Thin provides the body needed for full-band climaxes. This combination means Lopez is never over-crashing or under-crashing for the musical moment.\n\nOn Blackwater Park (where he played Sabian HH and AAX cymbals), Lopez established the cymbal philosophy he continues today: prioritize complexity and dynamic range over pure volume. The shift to Zildjian's K Dark line has maintained that philosophy with an even more complex, mature overtone structure suited to modern production.",
      "estimatedValue": "$1,800–2,400 total"
    },
    "hardware": {
      ...
      "items": [
        {
          ...
          "notes": "Precision response preferred for controlled, refined footwork",
          "description": "The Axis Percussion double pedal provides the balance of speed and control Lopez needs for Soen's demanding, technical rhythmic patterns. Its precision engineering delivers refined response night after night on tour."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "DW",
    ...
    "gearTimeline": [
      ...
      },
      {
        ...
        "notes": "The switch from Sonor to Noble & Cooley — a boutique American maker — reflects Lopez's mature, song-first aesthetic, with walnut shells delivering a warmer, more focused tone. The move to Zildjian's K Dark Series brought an even more complex, darker overtone structure that suits Soen's atmospheric production."
      }
    ],
    "faq": [
      {
        "question": "What drum kit does Martin Lopez use?",
        "answer": "Martin Lopez currently plays a Noble & Cooley Walnut shell pack. His configuration includes a 22\" bass drum, 10\" and 12\" rack toms, and 14\" and 16\" floor toms. During his Opeth years (1997–2006) he used a Sonor Designer Series kit in a similar configuration. Noble & Cooley is a boutique American maker, and the walnut shells deliver a warmer, more focused tone reflecting Lopez's mature, song-first approach."
      },
      {
        "question": "What cymbals does Martin Lopez play?",
        "answer": "Martin Lopez plays Zildjian's K Dark Series. His setup includes 14\" K Dark Thin hi-hats, 18\" and 20\" K Dark Medium Thin crashes, a 22\" K Dark Light ride, and an 18\" K China. During his Opeth era he used Sabian HH and AAX cymbals — the switch to Zildjian's K Dark line for Soen brought a darker, more complex overtone structure while maintaining his preference for warmth and dynamic complexity over pure volume."
      },
      {
