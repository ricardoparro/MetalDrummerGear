// Album drum-setup articles — Matt Garstka. Auto-split from the former monolith.
export const articles = {
  "whats-in-matt-garstkas-kit": {
    ...
    "description": "Discover Matt Garstka's complete drum setup — his DW Collector's Series custom shop kit, Meinl Byzance cymbals, and signature gear that power Animals as Leaders. Complete breakdown of the modern prog pioneer's equipment.",
    "seoKeywords": [
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "DW and Meinl Cymbals endorsee with signature products",
    ...
    "drumKit": {
      ...
      "description": "Matt Garstka switched drum brands in September 2021, moving from the Pearl Masterworks Maple kit he'd played since joining Animals as Leaders to a DW custom shop build. DW's official signing announcement described the kit as mixing Collector's Series wood species and shell configurations, continuing Garstka's preference for a compact, articulation-focused setup rather than a larger, louder rig.\n\nExact shell sizes for the current DW build have not been independently verified. What's confirmed is the brand switch itself and its timing: Garstka's kit today, and on his most recent studio album \"Parrhesia\" (2022), is DW rather than the Pearl Masterworks Maple setup he used on \"The Joy of Motion\" (2014) and \"The Madness of Many\" (2016).\n\nThe underlying philosophy carried over from the Pearl era: smaller, more responsive drums that prioritize articulation over raw power, rather than a massive kit. Rather than adding drums, Matt adds complexity through technique — ghost notes, dynamic variations, polyrhythmic layering. The kit is a vehicle for musical ideas, not a display of excess.",
      "notes": [
        ...
        "Exact shell sizes for the current DW build are not yet independently verified",
    ...
    "snare": {
      "title": "The DW Collector's Series Snare",
      "brand": "DW",
      "model": "DW Collector's Series Purpleheart",
      "size": "Not verified",
      "shell": "Purpleheart, per DW's Matt Garstka signature drum line",
      "description": "Garstka's Pearl Matt Garstka Signature Snare, used from \"The Joy of Motion\" through the \"The Madness of Many\" era, was retired along with the rest of his Pearl kit when he switched to DW in September 2021. His current primary snare, per DW's Collector's Series signature line, is a Purpleheart-shell model — though DW's custom shop also built him several boutique signature snares (Craviotto, Highwood, Noble & Cooley) that may see use on specific tracks or tours.\n\nExact snare specs and tuning for the current DW setup have not been independently verified beyond the brand and model switch; this article will be updated as more detailed sourcing becomes available.",
      "tuningSetting": "Not verified for the current DW setup",
    ...
    "hardware": {
      "title": "Hardware & Vic Firth Sticks",
      "items": [
        {
    ...
    "gearTimeline": [
      ...
      },
      {
        ...
        "description": "Switched from Pearl to a DW custom shop kit in September 2021, ahead of \"Parrhesia.\"",
        "gear": {
          "drums": "DW Collector's Series (custom shop)",
          "snare": "DW Collector's Series Purpleheart",
          "cymbals": "Meinl Byzance (various configurations per tour)",
          "hardware": "Pearl Demon Drive (last-verified; unconfirmed after the switch), Vic Firth Signature Sticks"
        },
        "notes": "First drum brand change of Garstka's Animals as Leaders tenure. Matt continues to refine his approach while maintaining the core philosophy of dynamics and musicality."
      }
    ],
    "videos": [
      {
    ...
    "gearStillAvailable": {
      ...
      "items": [
        ...
        },
        {
          ...
          "available": true,
          "priceRange": "$400-500",
          "notes": "Matt's former signature snare, used through The Madness of Many era; still sold by Pearl, though Matt switched to a DW Collector's Series Purpleheart snare in September 2021"
        },
        {
          "item": "Pearl Demon Drive Pedals",
          "available": true,
          "priceRange": "$400-700",
          "notes": "Matt's last-verified pedal brand; unconfirmed whether it carried over after his September 2021 switch to DW drums"
        },
        {
          "item": "DW Collector's Series (custom shop)",
          "available": true,
          "priceRange": "Not verified (custom shop pricing varies by configuration)",
          "notes": "Matt's current kit since September 2021; built to order through DW's custom shop rather than a standard retail configuration"
        }
      ]
    },
    "buyingGuide": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "notes": "This replicates the Pearl setup Matt played through 2021, before switching to a DW custom shop kit. Remember: the gear is just the start — his sound comes from years of disciplined practice."
        }
      ]
    },
    "education": {
    ...
    "faq": [
      {
        ...
        "answer": "Matt Garstka currently plays a DW Collector's Series custom shop kit, switching from Pearl in September 2021. DW's signing announcement describes a mix of Collector's Series wood species and shell configurations; exact shell sizes for the current build have not been independently verified. He played a Pearl Masterworks Maple kit — a 20x16 inch bass drum, 10x7 and 12x8 inch rack toms, and a 14x14 inch floor tom with MasterCast hoops — from joining Animals as Leaders in 2012 through the \"The Madness of Many\" (2016) era."
      },
      {
