...
export const articles = {
    ...
    "faq": [
      {
        ...
        "answer": "On *Inferno* (2004), Mikkey Dee played a Tama Starclassic kit — an evolution of the Artstar II/Swingstar setup he used on [*Bastards*](/articles/bastards-drum-setup) over a decade earlier. The configuration centered on a 22\" bass drum, three rack toms (10\", 12\", 13\"), and dual floor toms (16\", 18\"), built with maple/birch hybrid shells for a punchier, more modern attack suited to producer Cameron Webb's production style. *Inferno* was one of Dee's final Motörhead albums on Tama before he transitioned to a Sonor SQ2 kit around the [*Kiss of Death*](/articles/kiss-of-death-drum-setup) sessions in 2006. See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for his complete gear evolution."
      },
      {
  ...
  "kiss-of-death-drum-setup": {
    ...
    "snare": {
      ...
      "size": "14\" x 6.5\"",
      "shell": "Steel",
      "description": "Dee's snare choice on *Kiss of Death* carried forward the steel-shell preference he'd maintained since his King Diamond years, now voiced through his Sonor SQ2 hardware rather than Tama's. At 14\" x 6.5\", the dimensions matched almost exactly what he'd used on every Motörhead record since *Bastards* — proof that his core sonic priorities remained constant even as the brand changed. This plain steel SQ2 snare would serve him until 2012, when Sonor released his own signature birch snare model.\n\nThe Sonor SQ2 steel snare delivered a slightly warmer, more controlled crack than the brighter Tama Starclassic snare heard on *Inferno*, giving Dee's backbeat a touch more body without sacrificing the cut needed to sit above Phil Campbell's guitar and Lemmy's aggressive bass tone. On tracks like \"Sucker\" and \"Devil I Know,\" the snare sits assertively in the mix, driving the tempo with the same crisp authority that had defined his sound for over a decade.\n\nCameron Webb's returning production kept the snare tuned tight and forward in the mix, consistent with the more modern, defined drum sound he'd established on *Inferno* two years prior.",
      ...
      "items": [
        {
          ...
          "brand": "DW",
          "model": "DW 5000 Series Double Pedal",
          "notes": "Precise, responsive double pedal that replaced the Tama Iron Cobra chain-drive Dee used through Inferno",
          "description": "Alongside the switch to a Sonor kit, Dee moved to a DW 5000 Series double pedal. Its precise, responsive feel gave Dee a more immediate kick response than the Iron Cobra's chain-drive action — a change he'd carry forward unchanged for the rest of his Motörhead tenure and into his Scorpions years."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
          "model": "Sonor Hardware",
          "notes": "Matched hardware to the new Sonor SQ2 kit"
        },
        {
          "type": "Throne",
          "brand": "Roc-N-Soc",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "The DW 5000 Series pedal's precise response gives the kick a noticeably quicker, more immediate feel than the Tama Iron Cobra's chain-drive action."
      }
    ],
    "faq": [
      {
        "question": "When did Mikkey Dee switch from Tama to Sonor drums?",
        "answer": "Mikkey Dee switched from Tama to a Sonor SQ2 kit for the *Kiss of Death* (2006) sessions, after more than a decade playing Tama kits that began with [*Bastards*](/articles/bastards-drum-setup) in 1993 and continued through [*Inferno*](/articles/inferno-drum-setup) in 2004. The Sonor SQ2 — an endorsement dating back to his pre-Motörhead King Diamond days — became his primary kit for nearly the next ten years, refined further across *Motörizer* (2008) and later albums before reaching its final form on [*Bad Magic*](/articles/bad-magic-drum-setup) in 2015. See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for the complete gear timeline."
      },
      {
      ...
      "@graph": [
        {
          ...
          "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Kiss of Death (2006) — the album where he switched from Tama to Sonor SQ2 drums.",
          "author": {
            "@type": "Organization",
            "name": "MetalForge Editorial"
          },
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Mikkey Dee switched from Tama to a Sonor SQ2 kit for the Kiss of Death (2006) sessions, after more than a decade on Tama kits."
              }
            },
            {
              "@type": "Question",
  ...
  "motorizer-drum-setup": {
      ...
      "items": [
        {
          ...
          "description": "By Motörizer, Dee's DW 5000 Series double pedal setup had been road-tested across two years of touring behind Kiss of Death, giving him complete familiarity with its precise, responsive feel. The precision is audible on faster tracks like \"When the Eagle Screams,\" where the kick sits perfectly locked with Lemmy's bass without any hesitation."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "internalLinks": [
      ...
      {
        "text": "Kiss of Death drum setup (the Sonor SQ2's debut)",
        "url": "/articles/kiss-of-death-drum-setup"
      },
      {
  ...
  "the-world-is-yours-drum-setup": {
    ...
    "hardware": {
      "title": "DW 5000 Series Pedal, Still the Standard",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "DW",
          ...
          "description": "Four years and two albums into using the DW 5000 Series double pedal, Dee's kick technique had fully absorbed its precise, responsive feel. The Wörld Is Yours required no adjustment period — the same immediate response that defined Motörizer carried forward without interruption."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
  ...
  "aftershock-drum-setup": {
    ...
    "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Aftershock (2013) — the band's highest US chart placement to date and the album where Dee introduced his new Sonor Mikkey Dee Signature birch snare, setting up the final Bad Magic configuration.",
    "seoKeywords": [
      "mikkey dee drum kit",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "The album where Dee introduced his 2012-released Sonor Mikkey Dee Signature birch snare, replacing the plain steel SQ2 snare used since Kiss of Death",
    ...
    "snare": {
      "title": "Sonor Signature Birch Arrives: A New Snare Voice",
      "brand": "Sonor",
      "model": "Sonor Mikkey Dee Signature",
      "size": "14\" x 7.25\"",
      "shell": "Birch",
      "description": "*Aftershock* introduces Dee's own Sonor Mikkey Dee Signature snare to his Motörhead setup — a 14\" x 7.25\" birch shell Sonor released in 2012, one year before these sessions, replacing the plain steel SQ2 snare he'd used since *Kiss of Death* in 2006. The deeper birch shell adds substantial low-mid body to his backbeat, a departure from the brighter, shallower steel snare he'd played for the previous seven years.\n\nThe extra-deep birch shell delivers extra sensitivity for ghost notes alongside a full, articulate backbeat — bright and cutting enough to slice through Lemmy's mid-heavy Rickenbacker bass tone despite the added low-end weight. Unlike the steel model it replaced, the birch shell trades some outright brightness for added warmth and sustain.\n\nOn \"Heartbreaker,\" the Grammy-nominated opening track, the new signature snare's extra body is audible in the verses, where ghost notes add texture beneath the main backbeat without ever losing the crack on the primary hits. This same snare — the one Dee would keep using for the rest of his life — carried forward, unchanged, all the way through *Bad Magic* in 2015.",
      "tuningSetting": "Medium-high tension for maximum crack and cut",
      "heads": "Evans G2 Coated (batter), Evans Snare Side 300 (resonant)",
      ...
      "items": [
        {
          ...
          "model": "DW 5000 Series Double Pedal",
          "notes": "Unchanged since its introduction on Kiss of Death (2006)",
          "description": "Even as the snare changed for these sessions, Dee's DW 5000 Series double pedal carried forward without alteration — its precise, responsive feel remained exactly what he wanted for Motörhead's later material. The consistency shows up clearly on faster tracks like \"Queen of the Damned,\" where the kick locks to Lemmy's bass with the same tight precision heard on The Wörld Is Yours."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "First recorded appearance of the Sonor Mikkey Dee Signature birch snare's fuller, warmer crack",
        ...
        "gearNotes": "The combined debut of the new signature birch snare and the expanded Paiste cymbal setup makes this the clearest single-track showcase of Aftershock's gear turnover."
      },
      {
        "track": "End of Time",
        "bpm": "132",
      ...
      },
      {
        ...
        "gearNotes": "The DW 5000 Series pedal's consistent precision is most audible here, where the kick maintains accuracy at a tempo that would expose any looseness in the pedal action."
      }
    ],
    "faq": [
      {
        "question": "What drums and cymbals did Mikkey Dee use on Aftershock?",
        "answer": "On *Aftershock* (2013), Mikkey Dee played a Sonor SQ2 kit with a 22\" x 18\" bass drum, a 10\"/12\"/14\" rack tom configuration, and a 16\" floor tom — unchanged from [*The Wörld Is Yours*](/articles/the-world-is-yours-drum-setup). What changed was his new Sonor Mikkey Dee Signature birch snare (14\" x 7.25\"), released the previous year and replacing the plain steel SQ2 snare he'd used since *Kiss of Death*, plus an expanded Paiste Signature Series cymbal configuration (adding a wider 21\" ride). See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for his complete gear evolution."
      },
      {
      ...
      },
      {
        ...
        "answer": "Dee's Paiste artist relationship — dating back to April 1987, more than 26 years before *Aftershock* — continued uninterrupted, but the cymbal configuration itself expanded on this record: a wider 21\" Signature Series ride joined the familiar Sound Edge hi-hats, Full Crashes, and China. The change arrived alongside Dee's new Sonor Mikkey Dee Signature birch snare, making *Aftershock* the site of the most concentrated hardware turnover in Dee's Motörhead career. The resulting expanded Paiste Signature Series setup carried forward unchanged through [*Bad Magic*](/articles/bad-magic-drum-setup) (2015)."
      }
    ],
    "evolution": {
      "title": "From The Wörld Is Yours to Aftershock: The Big Gear Turnover",
      "content": "*Aftershock* (2013) is the single most significant hardware shift in Mikkey Dee's Sonor SQ2 era — not because the drum shells changed, but because the snare and cymbal setup did, all within one recording cycle.\n\n**What Changed:**\nThe plain steel SQ2 snare gave way to Dee's own Sonor Mikkey Dee Signature birch snare, released the year before. Dee's longstanding Paiste Signature cymbal setup — a relationship dating to 1987 — expanded to a fuller configuration, adding a wider 21\" ride.\n\n**What Stayed the Same:**\nThe drum shells themselves carried forward completely unchanged from *The Wörld Is Yours* — the 22\" x 18\" bass drum, the 10\"/12\"/14\" rack tom configuration, and the 16\" floor tom. The DW 5000 Series double pedal, in use since *Kiss of Death* (2006), also carried forward unchanged. The Paiste artist relationship itself also continued unbroken, as it had since 1987. This exact combination became the final Dee/Motörhead configuration, expanded only once more, with a single 8\" tom, for *Bad Magic* in 2015.",
      "thenVsNow": [
        {
          "category": "Kit",
      ...
      "@graph": [
        {
          ...
          "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Aftershock (2013) — the album where his snare switched to his own Sonor Mikkey Dee Signature birch model.",
          "author": {
            "@type": "Organization",
            "name": "MetalForge Editorial"
          },
