...
export const articles = {
  ...
  "inferno-drum-setup": {
    ...
    "drumKit": {
      "title": "Tama Power, Late-Era: Dee's Kit Before the Move to Sonor",
      "brand": "Tama",
      "model": "Tama Starclassic",
      "finish": "Black",
      "config": {
      ...
      "notes": [
        ...
        "One of Dee's final Motörhead albums on Tama before he moved to his longtime Sonor SQ2 kit around Kiss of Death (2006)"
      ],
    ...
    "faq": [
      {
        ...
        "answer": "On *Inferno* (2004), Mikkey Dee played a Tama Starclassic kit — an evolution of the Artstar II/Swingstar setup he used on [*Bastards*](/articles/bastards-drum-setup) over a decade earlier. The configuration centered on a 22\" bass drum, three rack toms (10\", 12\", 13\"), and dual floor toms (16\", 18\"), built with maple/birch hybrid shells for a punchier, more modern attack suited to producer Cameron Webb's production style. *Inferno* was one of Dee's final Motörhead albums on Tama before he brought his longtime personal Sonor SQ2 kit into the Motörhead studio around the [*Kiss of Death*](/articles/kiss-of-death-drum-setup) sessions in 2006. See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for his complete gear evolution."
      },
      {
  ...
  "kiss-of-death-drum-setup": {
    ...
    "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Kiss of Death (2006) — the album where his longtime personal Sonor SQ2 kit made its Motörhead studio debut. Complete breakdown of the Sonor SQ2 kit, Paiste cymbals, and the band's highest German chart entry to date.",
    "seoKeywords": [
      "mikkey dee drum kit",
    ...
    "drumKit": {
      ...
      "config": {
        ...
        "shells": "Birch shells (Sonor SQ2 custom-build) for fuller resonance and increased low-end depth"
      },
      "description": "*Kiss of Death* marks the debut of Mikkey Dee's Sonor SQ2 kit on a Motörhead record — an endorsement dating back to his pre-Motörhead King Diamond days that would become the foundation of his Motörhead sound for nearly a decade, refined further across *Motörizer* (2008), *The Wörld Is Yours* (2010), and *Aftershock* (2013) before carrying through to *Bad Magic* (2015). Compared to the Tama Starclassic he'd used on *Inferno* just two years earlier, the Sonor SQ2's birch shells offered a fuller, more resonant low end suited to Motörhead's increasingly arena-scaled live shows.\n\nThe initial configuration heard here was leaner than the kit he'd later expand to on *Bad Magic* — a three rack tom setup (10\", 12\", 14\") and single 16\" floor tom, rather than the four-tom, dual-floor-tom arrangement he'd eventually settle into. The 22\" x 18\" bass drum, however, was consistent from the start: the same focused, punchy dimension Dee had favored since his earliest Motörhead years.\n\nSonor's birch shell construction gave Dee's drums noticeably more low-mid resonance than the Tama Starclassic's punchier, more clipped tone — a change audible immediately on album opener \"Sucker,\" where the toms carry more sustain and body during fills. Bringing his personal Sonor kit into the Motörhead studio reflected both a longstanding gear preference and the demands of a band whose stage productions had grown considerably since the mid-1990s club and theater circuit.\n\nThis was the beginning of what would become Dee's longest-serving drum kit relationship of his Motörhead career — nearly matching the entire length of his Tama period in years played, built on a personal endorsement that actually predated Motörhead itself.",
      "notes": [
        "Debut album for Dee's Sonor SQ2 kit on a Motörhead record — replaced the Tama Starclassic used on Inferno (2004); the Sonor endorsement itself dates back to his pre-Motörhead King Diamond days",
    ...
    "snare": {
      "title": "A Steel Snare to Match the New Kit",
      "brand": "Sonor",
      "model": "Sonor SQ2 Steel Snare",
      "size": "14\" x 6.5\"",
      "shell": "Steel",
      "description": "Dee's snare choice on *Kiss of Death* carried forward the steel-shell preference he'd maintained since his King Diamond years, now voiced through Sonor SQ2 hardware rather than Tama's. At 14\" x 6.5\", the dimensions matched almost exactly what he'd used on every Motörhead record since *Bastards* — proof that his core sonic priorities remained constant even as the kit's Motörhead-record debut brought a new brand into the picture.\n\nThe Sonor SQ2 snare delivered a slightly warmer, more controlled crack than the brighter Tama Starclassic snare heard on *Inferno*, giving Dee's backbeat a touch more body without sacrificing the cut needed to sit above Phil Campbell's guitar and Lemmy's aggressive bass tone. On tracks like \"Sucker\" and \"Devil I Know,\" the snare sits assertively in the mix, driving the tempo with the same crisp authority that had defined his sound for over a decade.\n\nCameron Webb's returning production kept the snare tuned tight and forward in the mix, consistent with the more modern, defined drum sound he'd established on *Inferno* two years prior.",
    ...
    "hardware": {
      "title": "Hardware to Match the New Kit",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "DW",
          "model": "DW 5000 Series Double Pedal",
          "notes": "Precise, responsive pedal paired with the new Sonor SQ2 kit",
          "description": "Dee's DW 5000 Series double pedal gave him a precise, responsive kick feel that paired well with the new Sonor SQ2 kit's fuller-resonance shells — the same pedal pairing that would carry through the rest of his Sonor-based Motörhead years and into his Scorpions tenure."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "Kick drum microphone and EQ approach recalibrated for the kit's Motörhead-record debut"
      ]
    },
    "trackAnalysis": [
      {
        ...
        "signature": "4/4",
        "highlights": [
          "Album opener — the first recorded showcase of Dee's Sonor SQ2 kit",
      ...
      },
      {
        ...
        "signature": "4/4",
        "highlights": [
          "High-tempo track that puts Dee's new Sonor-era setup through its paces",
        ...
        "gearNotes": "The DW 5000 Series pedal's precise response keeps Dee's kick tight and immediate on the new Sonor SQ2 kit."
      }
    ],
    "faq": [
      {
        "question": "When did Mikkey Dee's Sonor SQ2 kit first appear on a Motörhead album?",
        "answer": "Mikkey Dee's longtime personal Sonor SQ2 kit — an endorsement dating back to his pre-Motörhead King Diamond days — made its first appearance on a Motörhead record with *Kiss of Death* (2006), after more than a decade recording on Tama kits that began with [*Bastards*](/articles/bastards-drum-setup) in 1993 and continued through [*Inferno*](/articles/inferno-drum-setup) in 2004. The Sonor SQ2 became his primary Motörhead-era kit for the rest of the band's career, refined further across *Motörizer* (2008) and later albums before carrying through to [*Bad Magic*](/articles/bad-magic-drum-setup) in 2015. See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for the complete gear timeline."
      },
      {
    ...
    "evolution": {
      ...
      "content": "*Kiss of Death* (2006) documents the single biggest gear change of Mikkey Dee's Motörhead career — bringing his longtime personal Sonor SQ2 kit into the studio after more than a decade recording on Tama. Two years earlier, [*Inferno*](/articles/inferno-drum-setup) had already shown the Tama Starclassic evolving toward a more modern tone under producer Cameron Webb; *Kiss of Death* completed that evolution by introducing an entirely different kit — one Dee had actually played since before Motörhead even existed.\n\n**What Changed:**\nThe Tama Starclassic gave way to the Sonor SQ2, bringing noticeably more low-mid resonance and sustain. The Tama Iron Cobra chain-drive pedal was replaced by a DW 5000 Series double pedal, giving Dee's kick a more consistent response.\n\n**What Stayed the Same:**\nThe 22\" bass drum dimension, the 14\" x 6.5\" steel snare depth, and the Paiste cymbal family (now blending 2002 and Signature lines) all carried forward — proof that Dee's fundamental sonic priorities remained constant even through a full drum-brand change.",
      "thenVsNow": [
        {
          "category": "Kit",
    ...
    "internalLinks": [
      ...
      {
        "text": "Motörizer drum setup (the Sonor era continues)",
        "url": "/articles/motorizer-drum-setup"
      },
      {
        "text": "What's In Mikkey Dee's Kit",
      ...
      "@graph": [
        {
          ...
          "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Kiss of Death (2006) — the album where his Sonor SQ2 kit made its Motörhead-record debut.",
          "author": {
            "@type": "Organization",
            "name": "MetalForge Editorial"
          },
        ...
        },
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "When did Mikkey Dee's Sonor SQ2 kit first appear on a Motörhead album?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Mikkey Dee's longtime personal Sonor SQ2 kit made its first appearance on a Motörhead record with Kiss of Death (2006), after more than a decade recording on Tama."
              }
            },
            {
              "@type": "Question",
    ...
    "conclusion": {
      ...
      "content": "*Kiss of Death* (2006) stands as the single most consequential gear-change record in Mikkey Dee's Motörhead career. After more than a decade recording on Tama drums — dating back to his 1993 debut on *Bastards* — Dee brought his longtime personal Sonor SQ2 kit into the Motörhead studio here, and it would define his recorded sound for the rest of the band's career, all the way through the band's final album in 2015.\n\nWhat's remarkable is how little actually changed in Dee's fundamental approach. The 22\" bass drum, the steel snare, the Paiste cymbal family — all carried forward, proof that a drummer's core identity lives in technique and philosophy, not brand loyalty. Cameron Webb's returning production captured the transition faithfully, letting the Sonor kit's fuller resonance come through without losing the tight, modern edge established on *Inferno* two years earlier.\n\n**For Drummers Studying Kiss of Death:**\nListen to \"Sucker\" for the clearest first impression of the Sonor kit's voice on record, and \"Trigger\" for how quickly Dee adapted his technique to the new DW 5000 Series pedal without any loss of precision. The album is a case study in how professional drummers absorb equipment changes without disrupting their fundamental sound.\n\n**The Gear Legacy:**\nThe Sonor SQ2 introduced here on record would carry Dee through *Motörizer* (2008) and beyond. For the full arc of that kit's refinement, see the [Motörizer drum setup](/articles/motorizer-drum-setup), the [Mikkey Dee drummer profile](/drummer/mikkey-dee), and the [complete kit breakdown](/articles/whats-in-mikkey-dees-kit).\n\n🤘 *New kit on record, same thunder.* 🤘"
    }
  },
  "motorizer-drum-setup": {
    ...
    "hardware": {
      "title": "DW Double Pedal, Two Years In",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "DW",
          "model": "DW 5000 Series Double Pedal",
          "notes": "Same double pedal introduced on Kiss of Death, now fully dialed to Dee's preferred response",
          "description": "By Motörizer, Dee's DW 5000 Series double pedal had been road-tested across two years of touring behind Kiss of Death, giving him complete familiarity with its response. The precision is audible on faster tracks like \"When the Eagle Screams,\" where the kick sits perfectly locked with Lemmy's bass without any hesitation."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "gearNotes": "The Sonor SQ2 kit's fuller low-mid resonance gives the toms extra warmth during the track's more spacious, dynamic sections."
      }
    ],
    "faq": [
      {
        "question": "What drums did Mikkey Dee use on Motörizer?",
        "answer": "On *Motörizer* (2008), Mikkey Dee played the same Sonor SQ2 kit that had made its first Motörhead-record appearance on [*Kiss of Death*](/articles/kiss-of-death-drum-setup) two years earlier, now expanded to a four rack tom configuration (10\", 12\", 13\", 14\") alongside the same 22\" x 18\" bass drum and 16\" floor tom. The kit was recorded at Studio 606, Dave Grohl's Foo Fighters facility in Northridge, California, which gave the drums a more natural, spacious room sound than earlier Cameron Webb-produced Motörhead albums. See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for his complete gear history."
      },
      {
    ...
    "evolution": {
      ...
      "content": "*Motörizer* (2008) shows Mikkey Dee's Sonor SQ2 kit two years into its life on Motörhead records — no longer the just-arrived setup heard on [*Kiss of Death*](/articles/kiss-of-death-drum-setup), but a fully road-tested instrument Dee had complete command over. The core dimensions stayed constant, but the configuration expanded and the cymbal setup matured.\n\n**What Changed:**\nThe three-tom Kiss of Death configuration expanded to four rack toms (adding a 13\") for more fill options. The cymbal blend shifted decisively toward Paiste Signature, leaving only the China cymbal on the brighter 2002 series. Recording at Studio 606 gave the whole kit a more natural, spacious character than the tighter production of the two previous Cameron Webb albums.\n\n**What Stayed the Same:**\nThe 22\" x 18\" bass drum, the 14\" x 6.5\" steel snare, and the DW 5000 Series double pedal all carried forward unchanged from *Kiss of Death* — the settled foundation of a kit that would remain largely consistent through *The Wörld Is Yours* (2010) and *Aftershock* (2013) before its final expansion for *Bad Magic* (2015).",
      "thenVsNow": [
        {
          "category": "Kit",
        ...
        {
          "category": "Snare",
          "then": "Sonor SQ2 Steel 14\" x 6.5\"",
          "now": "Sonor SQ2 Steel 14\" x 6.5\" (unchanged)"
        },
        {
          "category": "Cymbals",
    ...
    "internalLinks": [
      ...
      {
        "text": "Kiss of Death drum setup (the Sonor SQ2's Motörhead debut)",
        "url": "/articles/kiss-of-death-drum-setup"
      },
      {
      ...
      "items": [
        {
          ...
          "description": "Four years and two albums into using the DW 5000 Series double pedal, Dee's kick technique had fully absorbed its response. The Wörld Is Yours required no adjustment period — the same precise, immediate feel that defined Motörizer carried forward without interruption."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "trackAnalysis": [
      ...
      },
      {
        ...
        "highlights": [
          ...
          "Kick and snare interplay reflects Dee's fully settled DW 5000 Series pedal technique"
        ],
      ...
      },
      {
        ...
        "gearNotes": "The Sonor SQ2 Steel snare's ghost-note sensitivity carries much of the track's dynamic shape at this slower tempo."
      }
    ],
    "faq": [
      {
        "question": "What drums did Mikkey Dee use on The Wörld Is Yours?",
        "answer": "On *The Wörld Is Yours* (2010), Mikkey Dee played a Sonor SQ2 kit with a 22\" x 18\" bass drum, a trimmed three rack tom configuration (10\", 12\", 14\"), and a single 16\" floor tom — a leaner setup than the four-tom configuration he'd used on [*Motörizer*](/articles/motorizer-drum-setup) two years earlier. He paired it with a Sonor SQ2 steel snare (14\" x 6.5\") and Paiste Signature cymbals. See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for his complete gear history."
      },
      {
  ...
  "aftershock-drum-setup": {
    ...
    "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Aftershock (2013) — the band's highest US chart placement to date and the album where Dee introduced his own new Sonor Mikkey Dee Signature snare, setting up the final Bad Magic configuration.",
    "seoKeywords": [
      "mikkey dee drum kit",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "The album where Dee introduced his own new Sonor Mikkey Dee Signature birch snare, released by Sonor in 2012",
    ...
    "drumKit": {
      ...
      "description": "The Sonor SQ2 drum shells themselves carried forward unchanged from *The Wörld Is Yours* — the same 22\" x 18\" bass drum, the same trimmed 10\"/12\"/14\" rack tom configuration, and the same single 16\" floor tom. By 2013, this was the settled, proven shape of Dee's kit, seven years into the Sonor SQ2's run on Motörhead records and three albums into this specific tom configuration.\n\nWhat changed around those shells was the snare. *Aftershock* is where Dee introduced his own new Sonor Mikkey Dee Signature birch snare, released by Sonor the year before — a more personal gear update than any other point in his Motörhead career, and one that would carry forward, unchanged, all the way through *Bad Magic*.\n\nRecording once again at NRG Studios gave Webb a familiar room to capture the Sonor kit's fuller low-mid resonance, consistent with every Motörhead album since *Kiss of Death*. The band's Grammy-nominated single \"Heartbreaker\" opens the album, and its drum sound — tight, present, and driving — reflects a kit and a room combination Webb had fully mastered by this point in the partnership.\n\nThis would be the second-to-last tom configuration of Dee's Motörhead career — *Bad Magic* would add a single 8\" rack tom on top of this exact setup in 2015, but the 10\"/12\"/14\"/16\" foundation established here remained untouched through the end.",
      "notes": [
        "Shell configuration unchanged from The Wörld Is Yours — 22\" x 18\" kick, 10\"/12\"/14\" rack toms, 16\" floor tom",
        "Dee introduced his own new Sonor Mikkey Dee Signature birch snare for this album — the most personal gear update of his Motörhead career",
    ...
    "snare": {
      "title": "His Own Signature Snare Arrives",
      "brand": "Sonor",
      "model": "Sonor Mikkey Dee Signature",
      "size": "14\" x 7.25\"",
      "shell": "Birch",
      "description": "*Aftershock* introduces the Sonor Mikkey Dee Signature birch snare to Dee's setup — a 14\" x 7.25\" model Sonor released in 2012, built on his longtime Sonor SQ2 endorsement dating back to his King Diamond days, replacing the standard steel snare he'd used since *Kiss of Death* in 2006. The deeper birch shell adds substantial low-mid body to his backbeat, a shift from the brighter steel snares he'd played on every Motörhead record before this one.\n\nThe move to his own signature model marked a rare moment of Dee's gear catching up with his stature — after two decades in the band, he finally had a snare bearing his own name. The birch shell offers extra sensitivity for ghost notes alongside a full, articulate backbeat, still built to slice through Lemmy's mid-heavy Rickenbacker bass tone.\n\nOn \"Heartbreaker,\" the Grammy-nominated opening track, the new snare's added body and ghost-note sensitivity is audible in the verses, giving the track's dynamics extra texture beneath the main backbeat. This same snare model would carry forward, unchanged, all the way through *Bad Magic* in 2015.",
      "tuningSetting": "Medium-high tension for maximum crack and cut",
      "heads": "Evans G2 Coated (batter), Evans Snare Side 300 (resonant)",
      ...
      "items": [
        {
          ...
          "model": "DW 5000 Series Double Pedal",
          "notes": "Unchanged since its introduction on Kiss of Death (2006)",
          "description": "Seven years and three albums into using the DW 5000 Series double pedal, Dee's kick technique had fully absorbed its response. The precision shows up most clearly on faster tracks like \"Queen of the Damned,\" where the kick locks to Lemmy's bass with the same tight consistency heard on The Wörld Is Yours."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "recordingTechniques": {
      "title": "Recording Aftershock: Introducing the Signature Snare at NRG",
      "content": "*Aftershock* required Cameron Webb to re-approach part of Dee's drum sound — not because the shells or pedal changed, but because the snare and cymbal configuration turned over for these sessions, the most personal gear update of Dee's Motörhead career.\n\n**A Fuller Cymbal Configuration:**\nThe expanded Paiste Signature Series setup — a wider 21\" ride alongside the familiar Sound Edge hats and Full Crashes — carries a fuller overtone profile than the leaner configuration Webb had recorded on the previous two albums. The wider ride in particular required new microphone placement and EQ decisions to capture its fuller, more complex wash without letting it muddy the mix.\n\n**A New Snare Voice:**\nDee's new Sonor Mikkey Dee Signature birch snare gave Webb a deeper, more full-bodied backbeat to work with than the brighter steel snare used on the previous three albums — audible immediately on \"Heartbreaker\" and carried through the rest of the album's tracklist.\n\n**Studio Rotation:**\nSessions moved between NRG Studios, Sound Factory, Sunset Sound, and Maple Studios — a broader rotation of Hollywood-area rooms than *The Wörld Is Yours* had used, giving Webb more flexibility to match specific songs to specific room characteristics.\n\n**A Career-Best Chart Result:**\nThe eventual commercial payoff — a #22 Billboard 200 debut, Motörhead's best US chart position ever — validated the gear refresh. Whatever prompted the new snare and the expanded Paiste cymbal configuration, the results translated directly into the band's most acclaimed and commercially successful late-career release.",
      "keyTechniques": [
        "Expanded Paiste Signature cymbal configuration required fresh microphone placement and EQ approach from Cameron Webb",
        "Dee's new Sonor Mikkey Dee Signature birch snare gave the backbeat extra body and ghost-note sensitivity",
        "Sessions rotated across four Hollywood-area studios: NRG, Sound Factory, Sunset Sound, and Maple Studios",
        "The most personal gear update of Dee's Motörhead career — his own name now on the snare"
      ]
    },
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "First recorded appearance of Dee's own Sonor Mikkey Dee Signature birch snare",
          "Driving, direct groove with the Paiste Signature crashes cutting cleanly through the mix",
          "Kick pattern shows Dee's fully settled DW 5000 Series pedal technique"
        ],
        "gearNotes": "The combined debut of Dee's signature snare and the expanded Paiste cymbal setup makes this the clearest single-track showcase of Aftershock's gear refresh."
      },
      {
        "track": "End of Time",
        "bpm": "132",
      ...
      },
      {
        ...
        "highlights": [
          ...
          "The DW 5000 Series pedal's precise response keeps the kick locked to Lemmy's bass even at speed",
          "Paiste Signature crashes cut through cleanly without harshness at full velocity"
        ],
        "gearNotes": "The DW 5000 Series pedal's consistent response is most audible here, where the kick maintains precision at a tempo that would expose any looseness in a lesser pedal."
      }
    ],
    "faq": [
      {
        "question": "What drums and cymbals did Mikkey Dee use on Aftershock?",
        "answer": "On *Aftershock* (2013), Mikkey Dee played a Sonor SQ2 kit with a 22\" x 18\" bass drum, a 10\"/12\"/14\" rack tom configuration, and a 16\" floor tom — unchanged from [*The Wörld Is Yours*](/articles/the-world-is-yours-drum-setup). What changed was a new Sonor Mikkey Dee Signature birch snare (14\" x 7.25\"), released the year before, and an expanded Paiste Signature Series cymbal configuration (adding a wider 21\" ride). See the [Mikkey Dee drummer profile](/drummer/mikkey-dee) for his complete gear evolution."
      },
      {
      ...
      },
      {
        ...
        "answer": "Dee's Paiste artist relationship — dating back to April 1987, more than 26 years before *Aftershock* — continued uninterrupted, but the cymbal configuration itself expanded on this record: a wider 21\" Signature Series ride joined the familiar Sound Edge hi-hats, Full Crashes, and China. The change arrived alongside Dee's new Sonor Mikkey Dee Signature birch snare, making *Aftershock* the site of the most personal gear update in Dee's Motörhead career. The resulting expanded Paiste Signature Series setup carried forward unchanged through [*Bad Magic*](/articles/bad-magic-drum-setup) (2015)."
      }
    ],
    "evolution": {
      "title": "From The Wörld Is Yours to Aftershock: The Signature Snare Arrives",
      "content": "*Aftershock* (2013) marks a personal milestone in Mikkey Dee's Motörhead gear story — not because the drum shells changed, but because Sonor gave him his own signature snare model, introduced on this record.\n\n**What Changed:**\nThe Sonor SQ2 steel snare gave way to Dee's own Sonor Mikkey Dee Signature birch model, released by Sonor in 2012. Dee's longstanding Paiste Signature cymbal setup — a relationship dating to 1987 — expanded to a fuller configuration, adding a wider 21\" ride.\n\n**What Stayed the Same:**\nThe drum shells themselves carried forward completely unchanged from *The Wörld Is Yours* — the 22\" x 18\" bass drum, the 10\"/12\"/14\" rack tom configuration, and the 16\" floor tom. The DW 5000 Series double pedal, in use since *Kiss of Death* (2006), also carried forward unchanged. The Paiste artist relationship itself continued unbroken, as it had since 1987. This exact combination became the final Dee/Motörhead configuration, expanded only once more, with a single 8\" tom, for *Bad Magic* in 2015.",
      "thenVsNow": [
        {
          "category": "Kit",
      ...
      "@graph": [
        {
          ...
          "description": "Discover the exact drum kit, cymbals, and gear Mikkey Dee used on Motörhead's Aftershock (2013) — the album where he introduced his own Sonor Mikkey Dee Signature snare.",
          "author": {
            "@type": "Organization",
            "name": "MetalForge Editorial"
          },
    ...
    "conclusion": {
      ...
      "content": "*Aftershock* (2013) stands as a personal milestone in Mikkey Dee's late-career gear story. The Sonor SQ2 shells stayed exactly where *The Wörld Is Yours* left them, but Dee's own new signature snare arrived and the longstanding Paiste Signature cymbal setup expanded within a single album cycle — the most personal gear update of his entire Sonor SQ2 era.\n\nThe results speak for themselves: a career-best Billboard 200 debut, a Grammy nomination for \"Heartbreaker,\" and reviews calling it the best Motörhead record in two decades. Whatever prompted the new signature snare and the expanded cymbal setup, it coincided with a genuine late-career creative and commercial peak.\n\n**For Drummers Studying Aftershock:**\nListen to \"Heartbreaker\" for the clearest single-track showcase of the new gear — Dee's own Sonor Mikkey Dee Signature snare and the expanded Paiste Signature cymbal setup both present from the first bar. Then compare \"Queen of the Damned\" to *The Wörld Is Yours*' uptempo tracks for the same tight, consistent kick response the DW 5000 Series pedal had delivered for years.\n\n**The Gear Legacy:**\nEvery gear choice introduced on *Aftershock* — the Sonor Mikkey Dee Signature snare, the expanded Paiste Signature Series cymbal configuration — carried forward unchanged into *Bad Magic* (2015), Motörhead's final album. For the closing chapter of this arc, see the [Bad Magic drum setup](/articles/bad-magic-drum-setup), the [Mikkey Dee drummer profile](/drummer/mikkey-dee), and the [full kit breakdown](/articles/whats-in-mikkey-dees-kit).\n\n🤘 *New gear, same thunder — and a Grammy nod to prove it still mattered.* 🤘"
    }
  }
};
