// Album drum-setup articles — Morgan Ågren. Auto-split from the former monolith.
export const articles = {
  "morgan-agren-drum-setup": {
    ...
    "seoKeywords": [
      ...
      "Morgan Agren drum setup",
      "Morgan Agren kit",
      "Devin Townsend Project drummer",
      "Zappa drummer",
      "Morgan Agren Sonor",
      "Morgan Agren Paiste",
      "avant-garde metal drummer"
    ],
    "keywords": [
      "Morgan Ågren",
      "Morgan Agren drum setup",
    ...
    "quickFacts": {
      "kit": "Sonor SQ2 Beech",
      "cymbals": "Paiste Signature and 2002 Series",
      "pedals": "Sonor Giant Step Double Pedal",
    ...
    "drumKit": {
      ...
      "config": {
        "bassdrums": [
          "22\" Bass Drum (single kick — avant-garde and jazz-metal configurations)"
        ],
        "toms": [
          "10\" Rack Tom",
          "12\" Rack Tom"
    ...
    "cymbals": {
      "title": "Paiste Signature and 2002 Series: Bright Precision for Avant-Garde Contexts",
      "brand": "Paiste",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Tight, controlled response — fast articulation at jazz and metal tempos without wash buildup"
        },
        {
          "type": "Crash",
          "model": "Paiste Signature Fast Crash 18\"",
          "position": "Left crash",
          "notes": "Quick, bright crash decay — musical rather than purely aggressive"
        },
        {
          "type": "Crash",
          "model": "Paiste Signature Fast Crash 20\"",
          "position": "Right crash",
          "notes": "Fuller body for section endings and structural accent points"
        },
        {
          "type": "Ride",
          "model": "Paiste Signature Dry Heavy Ride 22\"",
          "position": "Right",
          "notes": "Dry, defined ride with clear bell for ride playing across jazz-metal and progressive contexts"
        },
        {
          "type": "China",
          "model": "Paiste 2002 China 18\"",
          "position": "Right",
          "notes": "Cutting, explosive accent voice for structural accent points and section transitions"
        }
      ],
      ...
      "items": [
        {
          ...
          "description": "Ågren's Sonor Giant Step double pedal supports a playing approach where the feet function as independent rhythmic voices rather than a simple subdivision pulse. In 4-over-3 polyrhythm patterns — the technique Ågren is most studied for — the kick drum plays three evenly spaced pulses against four strokes in the hands: a rhythmic displacement that requires a pedal with consistent, predictable response across each stroke regardless of position in the pattern. The Giant Step's engineering delivers that consistency."
        },
        {
          "type": "Hardware",
          "brand": "Sonor",
    ...
    "gearTimeline": [
      {
        ...
        "albums": [
          ...
          "Mats/Morgan Band early recordings"
        ],
        ...
        "gear": {
          ...
          "cymbals": "Paiste (early Signature/2002 Series exploration)",
          "pedals": "Sonor (developing Giant Step double pedal configuration)"
        },
      ...
      },
      {
        ...
        "albums": [
          ...
          "Morgan Ågren's Conundrum (2005)",
          "Mats/Morgan Band — Heat Death (2009)"
        ],
      ...
      },
      {
        ...
        "gear": {
          ...
          "cymbals": "Full Paiste Signature and 2002 Series setup",
          "pedals": "Sonor Giant Step double pedal"
        },
