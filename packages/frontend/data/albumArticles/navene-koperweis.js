...
export const articles = {
  "whats-in-navene-koperweiss-kit": {
    ...
    "evolution": {
      ...
      "content": "Navene Koperweis's gear has evolved alongside his musical direction. Here's how the two primary eras of his career compare:\n\n**Animals as Leaders Era (2010–2012):**\nThe Animals as Leaders era was where Navene cemented his reputation as a djent drumming pioneer. His setup was more variable during this period — undocumented touring/session gear with no fixed drum or pedal brand — but the Meinl Byzance cymbals were already central. The djent sound with AaL was clean, precise, and technical; the drums served Tosin Abasi and Javier Reyes's complex guitar work without drawing attention away from the riff architecture.\n\n**Entheos Era (2012–present):**\nWhen Navene founded Entheos in 2012, the setup became fixed: a DW Performance Series kit and DW 9000 Series double pedal, first documented on the Primal EP (2015) sessions and carried unchanged into The Infinite Nothing and every release since. The Meinl Byzance Extra Dry series featured prominently alongside it.\n\nThe Entheos setup is heavier and more aggressive than the AaL era — drums tuned to cut through distorted walls of guitar, cymbals selected for quick decay to avoid cluttering fast riffing. The fundamental philosophical approach — riff-locked kick, polyrhythmic layering, Byzance cymbals — remained identical.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Various touring/session kits (Animals as Leaders era, no fixed brand documented)",
          "now": "DW Performance Series (since Entheos founding, 2012)"
        },
        {
          "category": "Snare",
        ...
        },
        {
          ...
          "now": "DW 9000 Series Double Pedal (since Entheos founding, 2012)"
        },
        {
          "category": "Sticks",
