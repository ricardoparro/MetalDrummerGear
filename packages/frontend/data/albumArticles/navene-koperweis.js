// Album drum-setup articles — Navene Koperweis. Auto-split from the former monolith.
export const articles = {
  "whats-in-navene-koperweiss-kit": {
    ...
    "drumKit": {
      "title": "The DW Performance Series: Current Setup",
      "brand": "DW",
      ...
      "notes": [
        ...
        "Same DW Performance Series rig since Entheos's founding (2015 Primal EP)",
        "Evans drumheads throughout",
    ...
    "snare": {
      "title": "The Steel Cannon",
      "brand": "DW",
      "model": "DW Performance 14\" x 6.5\" Steel Snare",
      "size": "14\" x 6.5\"",
      "shell": "Steel shell",
      "description": "Navene Koperweis's snare since founding Entheos has been the DW Performance 14\" x 6.5\" steel — a focused, cutting instrument that slices through Entheos's dense twin-guitar attack. Steel shells produce a brighter, more penetrating crack than wood, with tighter overtones that project without becoming harsh — essential when the drum has to be heard over heavily processed djent guitars.\n\nThe 6.5\" depth provides the body needed for medium-high tuning. Navene tunes with authority: snare wires kept tight for crisp articulation, tension high enough for cut but not so high the drum loses resonance on ghost notes and soft passages. This balance is critical because Entheos songs swing between explosive accents and delicate textural moments, and the snare has to be credible at both extremes.\n\nDuring the Animals as Leaders era, Navene used various snares matched to that period's setup. Since founding Entheos in 2015 (Primal EP), the DW Performance steel has been his consistent tool for both live performances and session work with Machine Head and Job for a Cowboy.",
    ...
    "cymbals": {
      "title": "Meinl Byzance: The Constant Through Every Era",
      "brand": "Meinl",
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Dark, complex response with defined stick articulation"
        },
        {
          "type": "Crash",
          "model": "Meinl Byzance 18\" Extra Dry Medium Crash",
          "position": "Left of rack toms",
          "notes": "Controlled sustain, raw wash for accents"
        },
        {
          "type": "Crash",
          "model": "Meinl Byzance 19\" Extra Dry Medium Crash",
          "position": "Right of rack toms",
          "notes": "Larger accent crash, slightly fuller tone"
        },
        {
          "type": "Ride",
          "model": "Meinl Byzance 21\" Transition Ride",
          "position": "Far right",
          "notes": "Versatile: clear bell for djent patterns, full wash when needed"
        },
        {
          "type": "China",
          "model": "Meinl Byzance 18\" Extra Dry China",
          "position": "Above floor tom",
          "notes": "Raw, trashy accent for explosive moments"
        },
        {
          "type": "Splash",
          "model": "Meinl Byzance 10\" Splash",
          "position": "Between hi-hat and crash",
          "notes": "Quick accent strokes and transitions"
        }
      ],
      "description": "While Navene Koperweis has played multiple drum kit brands across his career, his Meinl Byzance cymbals have remained constant — the one piece of his setup that appears in every era from early Entheos playthroughs to his most recent session and touring work. He is a verified Meinl Cymbals endorser.\n\nThe Byzance series is handcrafted in Turkey using traditional cymbal-making techniques: B20 bronze alloy, hand-hammered and lathed to create complex, multi-layered tonal profiles. These are darker, more nuanced cymbals than the bright, cutting modern lines — and that darkness is exactly what Navene's style requires. In djent and progressive death metal, the guitar tone is already dense and high-gain; cymbals that are too bright create treble congestion. Byzance cymbals cut without competing.\n\nThe 15\" Dual Hi-Hats are particularly characteristic: their two distinct hats (rather than top/bottom pair of identical weight) create a rich, slightly trashy stick response with excellent definition even at extreme tempos. For fast 16th-note hat patterns or intricate open-closed work, this definition is critical.\n\nThe Extra Dry crashes (18\" and 19\") suppress ring and sustain more aggressively than standard Byzance — producing a raw, almost raw bronze \"thud\" that speaks quickly and decays fast. In tight djent riffing, quick-decaying crashes prevent the cymbal from bleeding into subsequent notes. The 21\" Transition Ride bridges between a dark washy sound and a defined, bell-forward articulation, making it versatile enough for both riding patterns and crash-ride accents.",
      "estimatedValue": "$2,200–2,800 total (Byzance series)"
    },
    "hardware": {
      "title": "DW 9000 Double Pedal: The Foundation of the Kick",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "DW",
          "model": "DW 9000 Series Double Pedal",
          "notes": "Chain-drive, adjustable cam for heel-up technique",
          "description": "Navene's double pedal is the DW 9000 Series — DW's flagship chain-drive double, renowned for its smooth action, customizable feel, and durability under extreme use. The 9000's dual-chain drive and adjustable eccentric cam allow fine-tuning of the acceleration curve and rebound angle, critical for the heel-up technique Navene uses at high BPM. The DW 9000 has been the choice of countless technical metal drummers for good reason: it delivers consistent feel across hours of demanding live performance."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "DW",
          "model": "DW 9000 Series Hi-Hat Stand",
          "notes": "Matching DW hardware for consistent feel"
        },
        {
          "type": "Throne",
          "brand": "DW",
          "model": "DW Throne",
          "notes": "Height-adjustable for extreme precision"
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
          "model": "Vic Firth American Classic 5B",
          "notes": "Power and balance for extreme metal"
        }
      ],
      "heads": {
    ...
    "playingStyle": {
      "title": "Navene Koperweis: Technique Breakdown",
      "content": "Navene Koperweis built his style at the intersection of technical death metal and the emerging djent movement — and what sets him apart from his contemporaries is how completely his drumming is integrated with the guitar parts he plays against.\n\n**Riff-Locked Double Bass:**\nThe defining feature of Koperweis's djent drumming — developed during his Animals as Leaders tenure and refined through every Entheos album — is locking the double-bass pattern specifically to the guitar riff, not to a generic kick template. Where many djent drummers apply a fixed foot pattern under varying guitar parts, Navene rewrites the kick when the riff changes. This creates drums that feel compositionally bonded to the arrangement rather than layered on top of it.\n\n**Polyrhythmic Precision:**\nEntheos songs frequently layer multiple simultaneous rhythmic groupings: ghost notes implying one meter against hi-hat patterns in another, kick figures that subdivide differently from the snare placement, cymbal accents marking downbeats of phrases that don't align with the underlying time signature. Koperweis navigates all of this while maintaining a clear rhythmic centre — the most demanding requirement in progressive metal drumming.\n\n**Dynamic Range:**\nDespite the extreme technical demands of his music, Navene has developed a broad dynamic range. Time Will Take Us All (2023) revealed his ability to pull back — using silence, restraint, and sparse passages expressively. A drummer with a wide dynamic range can make the heavy moments land harder by building contrast; Entheos's most crushing sections hit harder because of what surrounds them.\n\n**Electronic Integration:**\nKoperweis's production background as \"Navene K\" (electronic music) directly informs his drum writing. He approaches drum parts compositionally — thinking about texture, layering, and arrangement as much as execution. This is visible in how Entheos records are constructed: the drums are mixed and placed to maximize rhythmic impact, not to showcase technical ability for its own sake.",
      "signatureSongs": [
        {
          "song": "Chemical Flashback",
          "album": "Primal EP (Entheos, 2015)",
          "note": "First clear statement of djent-locked double bass"
        },
        {
          "song": "The Interior Wilderness",
          "album": "Time Will Take Us All (Entheos, 2023)",
          "note": "Peak polyrhythmic complexity"
        },
        {
          "song": "An End to Everything",
          "album": "An End to Everything EP (Entheos, 2024)",
          "note": "Dynamic restraint in extreme metal context"
        },
        {
          "song": "Tooth and Claw",
          "album": "Weightless (Animals as Leaders, 2011)",
          "note": "Djent drumming landmark"
        },
        {
          "song": "The Woven Web",
          "album": "The Infinite Nothing (Entheos, 2016)",
          "note": "Technical death metal at full intensity"
        }
      ]
    },
    "evolution": {
      "title": "Animals as Leaders Era vs. Entheos Era: Gear Differences",
      "content": "Navene Koperweis's gear has evolved alongside his musical direction. Here's how the two primary eras of his career compare:\n\n**Animals as Leaders Era (2010–2012):**\nThe Animals as Leaders era was where Navene cemented his reputation as a djent drumming pioneer. His setup was more variable during this period — he used different drum kits depending on the studio or touring context, but the Meinl Byzance cymbals were already central. The djent sound with AaL was clean, precise, and technical; the drums served Tosin Abasi and Javier Reyes's complex guitar work without drawing attention away from the riff architecture.\n\n**Entheos Era (2015–present):**\nWhen Navene founded Entheos in 2015, he adopted the DW Performance Series maple/mahogany kit that has anchored his sound ever since — established from the Primal EP onward and carried through The Infinite Nothing (2016), Time Will Take Us All (2023), and his current session and touring work. The Meinl Byzance Extra Dry cymbal series featured prominently from the start, and the DW 9000 Series double pedal rounded out the rig.\n\nThe Entheos setup is heavier and more aggressive than the AaL era — drums tuned to cut through distorted walls of guitar, cymbals selected for quick decay to avoid cluttering fast riffing. The fundamental philosophical approach — riff-locked kick, polyrhythmic layering, Byzance cymbals — remained identical.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Various (AaL era, 2010–2012)",
          "now": "DW Performance Series (since Primal EP, 2015)"
        },
        {
          "category": "Snare",
          "then": "Various (recording/studio dependent)",
          "now": "DW Performance 14x6.5\" Steel"
        },
        {
          "category": "Cymbals",
          "then": "Meinl Byzance (same series)",
          "now": "Meinl Byzance Extra Dry (refined setup)"
        },
        {
          "category": "Pedal",
          "then": "Various (no fixed brand documented, AaL era)",
          "now": "DW 9000 Series Double Pedal (since Primal EP, 2015)"
        },
        {
          "category": "Sticks",
          "then": "5A standard",
    ...
    "currentGear": {
      "title": "Navene Koperweis's Current Setup at a Glance",
      "items": [
        {
          "item": "DW Performance Series Drums (double bass)",
          "available": true,
          "priceRange": "$3,000–5,000",
          "notes": "Current touring and session kit"
        },
        {
          "item": "DW Performance 14\" x 6.5\" Steel Snare",
          "available": true,
          "priceRange": "$350–500",
          "notes": "Steel shell for maximum cut"
        },
        {
          "item": "Meinl Byzance 15\" Dual Hi-Hats",
          "available": true,
          "priceRange": "$450–550",
          "notes": "Dark, complex, defined stick response"
        },
        {
          "item": "Meinl Byzance 18\" Extra Dry Medium Crash",
          "available": true,
          "priceRange": "$280–350",
          "notes": "Fast decay, raw attack"
        },
        {
          "item": "Meinl Byzance 19\" Extra Dry Medium Crash",
          "available": true,
          "priceRange": "$300–380",
          "notes": "Slightly fuller larger crash"
        },
        {
          "item": "Meinl Byzance 21\" Transition Ride",
          "available": true,
          "priceRange": "$400–500",
          "notes": "Versatile djent and crash-ride use"
        },
        {
          "item": "Meinl Byzance 18\" Extra Dry China",
          "available": true,
          "priceRange": "$280–350",
          "notes": "Trashy, aggressive accent"
        },
        {
          "item": "Meinl Byzance 10\" Splash",
          "available": true,
          "priceRange": "$120–160",
          "notes": "Quick accent and transition work"
        },
        {
          "item": "DW 9000 Series Double Pedal",
          "available": true,
          "priceRange": "$700–800",
          "notes": "Chain-drive, adjustable cam"
        },
        {
          "item": "Vic Firth American Classic 5B",
          "available": true,
          "priceRange": "$12–16",
          "notes": "Power and balance"
        },
        {
          "item": "Evans EMAD Clear (bass drum)",
          "available": true,
          "priceRange": "$35–45",
          "notes": "Controlled attack, controlled sustain"
        },
        {
          "item": "Evans EC2 Clear (toms)",
          "available": true,
          "priceRange": "$15–25 each",
          "notes": "Warm, clear tone"
        }
      ]
    },
    "faq": [
      {
        ...
        "answer": "Navene Koperweis uses DW Performance Series drums in a double bass configuration — the same rig he adopted when founding Entheos in 2015 and recorded the Primal EP on. The setup is optimized for the extreme technical demands of his djent and progressive death metal playing style."
      },
      {
        "question": "What cymbals does Navene Koperweis use?",
        "answer": "Navene Koperweis is a Meinl Cymbals endorser and uses the Meinl Byzance series throughout his career. His current setup includes Meinl Byzance 15\" Dual Hi-Hats, 18\" and 19\" Extra Dry Medium Crashes, a 21\" Transition Ride, 18\" Extra Dry China, and a 10\" Splash. The Byzance Extra Dry sub-series — with its fast decay and controlled sustain — is particularly well-suited to tight djent riffing where cymbal bleed between notes would muddy the rhythmic picture."
      },
      {
        "question": "What double bass pedal does Navene Koperweis use?",
        "answer": "Navene Koperweis uses the DW 9000 Series double bass pedal, which has driven his kick work since founding Entheos in 2015 — including the Primal EP sessions. The 9000 is DW's flagship chain-drive double, featuring an adjustable eccentric cam that lets him dial in the exact acceleration curve and rebound angle his heel-up extreme-tempo technique requires."
      },
      {
        "question": "What snare drum does Navene Koperweis use?",
        "answer": "Navene Koperweis uses a DW Performance 14\" x 6.5\" steel snare. The steel shell produces a bright, cutting crack that slices through Entheos's dense guitar arrangements, while the 6.5\" depth provides enough body for medium-high tuning without thinning out on ghost notes and softer passages."
      },
      {
        "question": "What bands has Navene Koperweis played with?",
        "answer": "Navene Koperweis has played with Animosity (2003–2008), Animals as Leaders (2010–2012), and Entheos (2015–present), where he is the founding drummer. He has also done session and touring work with Machine Head, Whitechapel, and Job for a Cowboy. He runs his own solo project Fleshwrought (all instruments) and releases electronic music as \"Navene K.\""
      },
      {
        "question": "What did Navene Koperweis play with Animals as Leaders?",
        "answer": "Navene Koperweis recorded Weightless (2011) with Animals as Leaders — the band's second album and considered a landmark of the djent genre. His riff-locked double bass approach, where the kick drum pattern mirrors the guitar riff's specific rhythmic subdivision rather than a generic template, helped define how djent drumming would be played. He also received a production credit on The Joy of Motion (2014) after leaving the band."
      }
    ],
    "videos": [
      {
      ...
      },
      {
        ...
        "title": "Navene Koperweis - ENTHEOS - The Interior Wilderness (Drum Playthrough)",
        "description": "Navene's math-metal polyrhythmic playthrough showing his full DW/Meinl Byzance setup"
      },
      {
        "youtubeId": "DCilxbTlu9c",
        "title": "Navene Koperweis - Entheos - An End to Everything (One-Take)",
        "description": "One-take drum performance revealing Navene's evolved dynamic range and atmospheric restraint"
      },
      {
        "youtubeId": "J8SNuR8Tb4g",
        "title": "Navene Koperweis - ENTHEOS - The Sinking Sun (Drum Playthrough)",
        "description": "Drum playthrough from Time Will Take Us All (2023) with full DW kit and Meinl Byzance setup visible"
      }
    ],
    "relatedAlbums": [
  ...
  "navene-koperweis-weightless-2011": {
      ...
      "items": [
        {
          ...
          "description": "No single documented pedal brand is tied to Koperweis's Weightless-era touring and session work — the Animals as Leaders period predates his DW endorsement. What is consistent is the demand the riff-locked kick technique placed on whatever double pedal he used: because his kick patterns change specifically with each riff rather than following a fixed template, pedal consistency between the primary and secondary beater mattered more than raw speed. He later moved to the DW 9000 Series double pedal after founding Entheos in 2015, which has anchored his rig ever since."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "No single pedal brand is documented for the Weightless era — it predates Koperweis's DW endorsement. The riff-locked kick technique he used required a consistent response between the primary and secondary beater, since any mechanical difference would undercut the tight coupling between kick pattern and guitar riff that defines his style. He later adopted the DW 9000 Series double pedal after founding Entheos in 2015."
      }
    ],
    "videos": [
      {
