  ...
  "whats-in-navene-koperweiss-kit": {
    ...
    "drumKit": {
      ...
      "notes": [
        ...
        "Entheos founding era (2015 Primal EP): DW Performance Series — the same rig, continuous since",
        "Evans drumheads throughout the entire DW Performance Series era",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        {
          "category": "Pedal",
          "then": "Standard touring double pedal (Animals as Leaders era, no fixed brand documented)",
          "now": "DW 9000 Series Double Pedal (established with Entheos founding, 2015–present)"
        },
        {
          "category": "Sticks",
          "then": "5A standard",
    ...
    "faq": [
      {
        ...
        "answer": "Navene Koperweis uses DW Performance Series drums in a double bass configuration — the same kit he adopted when founding Entheos for the Primal EP (2015) sessions and has used ever since. The setup is optimized for the extreme technical demands of his djent and progressive death metal playing style."
      },
      {
