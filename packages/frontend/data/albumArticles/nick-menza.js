...
export const articles = {
  "rust-in-peace-drum-setup": {
    ...
    "snare": {
      ...
      "size": "14\" x 5.5\"",
      "shell": "Steel, 8-lug",
      "description": "The snare sound on Rust in Peace is distinctive — bright, cutting, with a controlled crack that punctuates even the fastest passages. Nick Menza achieved this with a Tama Steel snare, tuned tight for a sharp, high-pitched rimshot crack.\n\nThe steel shell delivers a bright, focused voice with fast decay, giving the drum immediate definition. At 5.5\" depth, the snare offered a crisp, punchy character — essential for a drummer who played everything from blast beats to subtle ghost note patterns.\n\nProducer Mike Clink, coming from the Guns N' Roses sessions where he achieved Steven Adler's punchy snare sound, knew how to capture metal drums with clarity. The snare was close-miked with a Shure SM57, EQ'd to emphasize the attack frequencies, and compressed just enough to control peaks without squashing dynamics.\n\nMenza tuned the snare tight with moderate snare wire tension. This allowed for both the aggressive attack needed for thrash sections and the sensitivity required for his ghost note work. Listen to the verses of \"Tornado of Souls\" — the snare responds to the lightest touches while still cracking on backbeats.",
      "tuningSetting": "Tuned tight for a sharp, high-pitched rimshot crack, with moderate snare wire tension",
      "heads": "Remo Emperor Coated (batter), Remo Ambassador Snare Side (resonant)",
      "estimatedValue": "$150-250 (1990) / $250-400 (vintage today)"
    },
    "cymbals": {
    ...
    "evolution": {
      ...
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Swingstar, poplar",
          "now": "Legacy: mid-range Tama kits remain popular working-drummer choices"
        },
        {
          "category": "Snare",
          "then": "Tama Steel 14x5.5\", 8-lug",
          "now": "Steel snares remain a workhorse choice for metal"
        },
        {
          "category": "Cymbals",
    ...
    "faq": [
      {
        ...
        "answer": "Nick Menza played a Tama Swingstar kit on Rust in Peace, recorded in 1990 — a mid-range, working drummer's kit rather than a prestige endorsement. The setup featured twin 22x16 inch bass drums, rack toms in 10, 12, and 13 inch sizes, and 16 and 18 inch floor toms. All shells were poplar, giving the kit a tight, dry attack that cut through Megadeth's aggressive riff-driven arrangements on that album."
      },
      {
  ...
  "countdown-to-extinction-drum-setup": {
    ...
    "drumKit": {
      ...
      "notes": [
        ...
        "Maple shells for a warmer, more resonant tone than the Rust in Peace-era Tama poplar",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Swingstar, poplar (5-tom on Rust)",
  ...
  "nick-menza-drum-setup": {
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          "drums": "Tama Swingstar 5-piece — poplar shells for a tight, dry attack",
          "snare": "Tama Steel 14\"x5.5\", 8-lug — sharp, high-pitched crack",
          "cymbals": "Zildjian A Custom (launched 1989) — brilliant finish, fast response",
          "hardware": "Tama chain-drive double pedal"
        },
        "notes": "Poplar shells + Tama Steel snare + A Custom cymbals = the Rust in Peace sound — a mid-range, working drummer's kit rather than a prestige endorsement. Menza joined as drum tech and transitioned to drummer for this recording."
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "On Rust in Peace (1990), Nick Menza played a Tama Steel snare drum, in a 14\"x5.5\", 8-lug configuration. The steel shell delivered the sharp, high-pitched crack audible throughout the album — particularly on \"Holy Wars,\" \"Tornado of Souls,\" and \"Take No Prisoners.\" The steel shell provides bright tonal definition with fast, focused decay ideal for high-tempo thrash drumming."
      },
      {
