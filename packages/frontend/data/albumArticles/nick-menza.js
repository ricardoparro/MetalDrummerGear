...
export const articles = {
  "rust-in-peace-drum-setup": {
    ...
    "drumKit": {
      ...
      "brand": "Tama",
      "model": "Tama Artstar II 5-piece, Midnight Blue finish",
      "config": {
        "bassdrums": [
          "22\" x 16\" Bass Drum"
        ],
    ...
    "evolution": {
      ...
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Artstar II, birch shells",
          "now": "Tama's Starclassic line carries the pro-tier torch today"
        },
        {
          "category": "Snare",
  ...
  "countdown-to-extinction-drum-setup": {
    ...
    "evolution": {
      ...
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Artstar II, birch (3-tom on Rust)",
    ...
    "gearTimeline": [
      {
        ...
        "gear": {
          "drums": "Tama Artstar II 5-piece — birch shells for focused attack",
        ...
        "notes": "Birch shells + Tama Steel snare + A Custom cymbals = the Rust in Peace sound — Tama's pro-tier kit of the era. Menza joined as drum tech and transitioned to drummer for this recording."
      },
      {
