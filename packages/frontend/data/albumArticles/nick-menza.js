// Album drum-setup articles — Nick Menza. Auto-split from the former monolith.
export const articles = {
  ...
  "countdown-to-extinction-drum-setup": {
    ...
    "drumKit": {
      "title": "Menza's Pearl Masters — Refined for Commercial Thrash",
      "brand": "Pearl",
      "model": "Pearl Masters",
      "finish": "Black Wrap",
      "config": {
    ...
    "faq": [
      {
        ...
        "answer": "Nick Menza played a Pearl Masters kit on Countdown to Extinction, recorded at Enterprise Studios in Burbank in 1992 — an upgrade from the Tama Artstar II he used on Rust in Peace, seeking a more resonant, powerful sound. The setup featured twin 22 by 16 inch bass drums, 10 and 12 inch rack toms, and 14 and 16 inch floor toms — a streamlined four-tom configuration compared to the five-tom sprawl he used on Rust in Peace. All shells were maple with die-cast hoops, giving the kit the warmth and clarity needed to cut through the album's dense guitar arrangements while Max Norman's production delivered the bigger, more radio-ready drum sound the songs called for."
      },
      {
    ...
    "faq": [
      {
        ...
        "answer": "Nick Menza played a Pearl Reference Custom kit on Cryptic Writings — his flagship professional-tier kit and the final stop in a Pearl evolution that ran from Pearl Masters (Countdown to Extinction) through Pearl Masterworks (Youthanasia) — recorded at The Tracking Room in Nashville in 1996-97. The setup featured twin 22\" x 16\" bass drums, 10\" and 12\" rack toms, and 14\" and 16\" floor toms, all mounted on his signature Greg Voelker stainless-steel dual-rack system, which held the toms on a lower chrome rack and every cymbal on a higher rack with the bass drums floating on a built-in riser."
      },
      {
  ...
  "youthanasia-drum-setup": {
    ...
    "description": "Inside Nick Menza's drum kit on Megadeth's 1994 Youthanasia: the Pearl Masterworks configuration, Bell Brass snare, Paiste 2002 cymbal arsenal, and the Phase Four Studios sessions that produced the band's most refined recording.",
    "seoKeywords": [
      "youthanasia drum setup",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Primary kit: Pearl Masterworks — the most premium kit of his career — with Bell Brass 14\"x6.5\" signature snare",
    ...
    "drumKit": {
      ...
      "finish": "Cobalt Blue / Black (varies by performance footage)",
      "config": {
        "bassdrums": [
    ...
    "snare": {
      ...
      "heads": "Remo Ambassador Coated (batter), Remo Ambassador Snare Side (resonant)",
      "estimatedValue": "$600–1,200 (vintage Tama Artstar Bell Brass)"
    },
    "cymbals": {
    ...
    "faq": [
      {
        ...
        "answer": "Nick Menza played a Pearl Masterworks kit on the Youthanasia sessions — the most premium kit of his career, and an upgrade from the Pearl Masters he used on Countdown to Extinction. The kit featured double 22\" x 16\" bass drums (slightly shallower than the Rust in Peace era for tighter attack), 10\" and 12\" rack toms, and 14\" and 16\" floor toms. The maple shells provided focused attack with controlled sustain — well-suited to Youthanasia's mid-tempo, groove-oriented arrangements."
      },
      {
        "question": "What snare drum did Nick Menza use on Youthanasia?",
        "answer": "Menza used his Tama Artstar Bell Brass 14\"x6.5\" snare drum on Youthanasia — the same canonical late-80s/early-90s thrash brass snare he had used since Rust in Peace. The Bell Brass shell delivers a bright, focused crack with fast decay and excellent projection, captured at Phase Four Studios with more room ambience than the more compressed Countdown to Extinction snare sound."
      },
      {
