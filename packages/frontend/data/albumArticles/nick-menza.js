...
export const articles = {
  ...
  "countdown-to-extinction-drum-setup": {
    ...
    "description": "Complete breakdown of Nick Menza's drum gear on Megadeth's Countdown to Extinction. Inside the Tama Artstar II kit, Paiste cymbals, and mid-tempo restraint behind 'Symphony of Destruction,' 'Sweating Bullets,' and 'Foreclosure of a Dream.'",
    "seoKeywords": [
    ...
    "drumKit": {
      "title": "Menza's Tama Artstar II — Refined for Commercial Thrash",
      "brand": "Tama",
      "model": "Tama Artstar II",
      "finish": "Midnight Blue",
      "config": {
      ...
      "estimatedValue": "$3,000-4,500 (1992)"
    },
    "snare": {
  ...
  "youthanasia-drum-setup": {
    ...
    "description": "Inside Nick Menza's drum kit on Megadeth's 1994 Youthanasia: the Tama Artstar II configuration, Bell Brass snare, Paiste 2002 cymbal arsenal, and the Phase Four Studios sessions that produced the band's most refined recording.",
    "seoKeywords": [
      "youthanasia drum setup",
      "nick menza youthanasia drums",
      "nick menza drum kit 1994",
      "megadeth youthanasia drum gear",
      "tama artstar ii nick menza",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Primary kit: Tama Artstar II with Bell Brass 14\"x6.5\" signature snare",
        "Cymbal arsenal: Paiste 2002 and Signature series — bright, articulate top-end"
      ]
    },
    "drumKit": {
      "title": "Nick's Tama Artstar II — The Youthanasia Configuration",
      "brand": "Tama",
      "model": "Tama Artstar II",
      ...
      "notes": [
        ...
        "Birch construction: bright fundamentals, fast attack, controlled sustain",
        "Recorded at Phase Four Studios, the purpose-built Phoenix facility"
      ],
      "estimatedValue": "$1,800–3,200 (vintage Tama Artstar II shell pack)"
    },
    "snare": {
    ...
    "faq": [
      {
        ...
        "answer": "Nick Menza played his Tama Artstar II on the Youthanasia sessions. The kit featured double 22\" x 16\" bass drums (slightly shallower than the Rust in Peace era for tighter attack), 10\" and 12\" rack toms, and 14\" and 16\" floor toms. The birch shells provided focused attack with controlled sustain — well-suited to Youthanasia's mid-tempo, groove-oriented arrangements."
      },
      {
