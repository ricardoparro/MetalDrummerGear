// Album drum-setup articles — Nicko McBrain. Auto-split from the former monolith.
export const articles = {
  ...
  "no-prayer-for-the-dying-drum-setup": {
    ...
    "cymbals": {
      "title": "Paiste 2002: Same Cymbals, Rawer Room",
      "brand": "Paiste",
      "series": "Paiste 2002",
      "setup": [
        {
          ...
          "model": "Paiste 2002 14\" Medium Hi-Hats",
          "position": "Left side",
          "notes": "Crisp, controlled chick that cut through the barn's live acoustics"
        },
        {
          "type": "Crash",
          "model": "Paiste 2002 16\" Medium Crash",
          "position": "Left of hi-hats",
          "notes": "Quick decay suited to the barn's untreated room sound"
        },
        {
          "type": "Crash",
          "model": "Paiste 2002 18\" Medium Crash",
        ...
        },
        {
          ...
          "model": "Paiste 2002 20\" Medium Ride",
          "position": "Far right",
          "notes": "Defined bell and stick sound cutting through the raw mix"
        },
        {
          "type": "China",
          "model": "Paiste 2002 18\" China Type",
      ...
      "description": "Alongside his familiar Yamaha kit and snare, Nicko McBrain tracked No Prayer for the Dying on the same Paiste 2002 series cymbals that had defined his sound since the early 1980s. Their bright, articulate character held up even in the barn's rawer, more direct acoustics.\n\nThe 14\" Medium hi-hats delivered the tight, controlled chick that mattered in the live-room barn setting, where cymbal wash could easily bleed into other mics. \"Public Enema Number One\" and \"Tailgunner\" lean on fast, controlled hi-hat work that benefits from the 2002's clear articulation.\n\nThe crash pairing (16\" and 18\") and 20\" ride followed Nicko's usual structure, and the 2002's quick decay meant accents cut through the mix without lingering — a good match for the more direct, less reverberant Barnyard Studios sound.\n\nNicko's Yamaha kit, snare, and Paiste 2002 cymbals carried on unchanged through the barn sessions; the tighter tuning was the only real departure from his established setup. By the time Iron Maiden reconvened for Fear of the Dark, Nicko had moved up to the newer Paiste Signature series — but on No Prayer for the Dying, the same 2002s he'd used since 1982 were still doing the work.",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "Paiste 2002 cymbals carried over unchanged — the tighter tuning, not new gear, drove the raw barn sound"
      ]
    },
    "trackAnalysis": [
      {
        ...
        "gearNotes": "Paiste 2002 14\" Medium hi-hats deliver the tight chick needed for the fast verse pattern."
      },
      {
      ...
      },
      {
        ...
        "gearNotes": "Paiste 2002 ride and hi-hats provide the crisp, defined articulation the faster tempo demands."
      },
      {
        "track": "Tailgunner",
        "bpm": "158",
    ...
    "faq": [
      {
        ...
        "answer": "Nicko McBrain recorded No Prayer for the Dying (1990) on the same Yamaha Recording Custom kit he'd played since Somewhere in Time (1986), tuned tighter and drier for the session. His cymbals stayed the same Paiste 2002 series he'd used since the early 1980s. The tighter tuning suited the rawer, more live-sounding production the band pursued at Barnyard Studios. For his full gear history, see the [Nicko McBrain drummer profile](/drummer/nicko-mcbrain)."
      },
      {
  ...
  "fear-of-the-dark-drum-setup": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "On Fear of the Dark, Nicko McBrain played Paiste Signature series cymbals — 14\" Sound Edge hi-hats, 16\" and 18\" Full Crashes, a 20\" Power Ride, and an 18\" China — marking an upgrade from the Paiste 2002s he'd used since the early 1980s, including on No Prayer for the Dying. Across his career, Nicko has used Paiste 2002 (1980s into 1990) and Paiste Signature (1990s onward), reflecting one continuous Paiste endorsement stretching back over four decades."
      },
      {
      ...
      },
      {
        ...
        "answer": "The two albums sit close together chronologically but differ sharply in approach. No Prayer for the Dying (1990) was recorded with deliberate rawness in a barn using the Rolling Stones Mobile Studio, with Nicko McBrain tuning his Yamaha kit punchier and tighter for a leaner sound while keeping his usual Paiste 2002 cymbals. Fear of the Dark (1992) returned to a fuller, more produced sound at Barnyard Studios, with Nicko opening the tuning back up on the same Yamaha kit and moving up to the newer Paiste Signature cymbals that better suited the album's bigger, more melodic arrangements. Commercially, Fear of the Dark was the clear winner — a number-one, 2x-platinum album against No Prayer's number-two showing. See the [No Prayer for the Dying drum setup article](/articles/no-prayer-for-the-dying-drum-setup) for that preceding chapter."
      }
    ],
    "evolution": {
      "title": "Fear of the Dark in Nicko McBrain's Gear Progression",
      "content": "Fear of the Dark (1992) fills a crucial gap in Nicko McBrain's gear history, sitting between the tighter-tuned Barnyard chapter of No Prayer for the Dying (1990) and the reunion years that followed. Through all of it, the drum kit itself never changed: the same Yamaha Recording Custom he'd played since 1985 stayed with him through 2010.\n\n**The founding era (1982-1984):** Ludwig drums, Paiste 2002, Pro-Mark sticks.\n\n**The Barnyard adjustment (1990):** Same Yamaha Recording Custom kit, tuned tighter and drier, same Paiste 2002 cymbals.\n\n**The Fear of the Dark era (1992):** Same Yamaha Recording Custom kit, tuning opened back up, upgraded to Paiste Signature cymbals — a fuller, more resonant drum tone for Iron Maiden's biggest commercial peak of the decade.\n\n**What came next:** Nicko stayed on the same Yamaha Recording Custom kit all the way through Brave New World (2000), Dance of Death (2003), A Matter of Life and Death (2006), and The Final Frontier (2010), with the Paiste cymbal relationship begun here continuing through the reunion era and beyond.\n\n**The constant:** One bass drum, one pedal. The single-pedal gallop never changed, no matter what else did.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Yamaha Recording Custom",
