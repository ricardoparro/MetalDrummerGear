// Album drum-setup articles — Ryan Van Poederooyen. Auto-split from the former monolith.
export const articles = {
  "ryan-van-poederooyen-drum-setup": {
    ...
    "seoKeywords": [
      "ryan van poederooyen drum setup",
      "ryan van poederooyen kit",
      "devin townsend project drummer",
      "van poederooyen drum gear",
      "ryan van poederooyen cymbals",
      "devin townsend drummer setup",
      "pearl reference drums prog metal",
      "ryan van poederooyen double bass"
    ],
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Fast, versatile response — articulates across ambient ghost patterns and driving metal pulse"
        },
        {
          "type": "Crash",
          "model": "Sabian 16\" AAX Crash",
          "position": "Left crash",
          "notes": "Quick decay for accent work in DTP's densely arranged passages"
        },
        {
          "type": "Crash",
          "model": "Sabian 18\" HHX Crash",
          "position": "Right crash",
          "notes": "Fuller, darker tone for section transitions and climactic moments"
        },
        {
          "type": "Ride",
          "model": "Sabian 20\" HHX Ride",
          "position": "Right",
          "notes": "Complex wash and defined bell for extended ride patterns in progressive passages"
        },
        {
          "type": "China",
          "model": "Sabian 18\" AAX China",
          "position": "Over rack toms",
          "notes": "Aggressive trash accent for DTP's heaviest sections and dynamic peaks"
        }
      ],
      ...
      "items": [
        {
          ...
          "description": "Van Poederooyen's double bass setup has centered on the Pearl Demon Drive across his Devin Townsend Project years, reflecting his need for a reliable, high-performance pedal under the physically demanding conditions of Devin Townsend's touring schedule. The Demon Drive's direct-drive design delivers a consistent, driving stroke suited to the forward-momentum double kick patterns on DTP tracks like 'Kingdom' and 'Decimator,' with smooth, controlled acceleration and consistent beater velocity across extended double-kick passages. The pedal supports Van Poederooyen's approach to double bass: powerful and groove-focused rather than maximally fast. The goal is rhythmic drive and physical presence rather than speed records. See also [double-bass drumming at MetalForge](/technique/double-bass-drumming) for setup and practice methodology."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
