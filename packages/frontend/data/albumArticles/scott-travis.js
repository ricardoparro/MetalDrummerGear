...
export const articles = {
      ...
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Brilliant finish, heavy weight for aggressive playing"
        },
        {
          "type": "Crash",
        ...
        {
          "type": "Crash",
          "model": "Paiste Signature 17\" Power Crash",
          "position": "Above left toms",
          "notes": "Brilliant, cutting crash"
        },
        {
          "type": "Crash",
    ...
    "evolution": {
      ...
      "thenVsNow": [
        ...
        },
        {
          "category": "Sticks",
          "then": "Vic Firth 5B",
          "now": "Vic Firth Scott Travis Signature"
        },
        {
          "category": "Pedals",
  ...
  "firepower-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Gear arc from Painkiller-era Tama Artstar II / Paiste to 2018 Tama Starclassic Maple / Sabian HHX"
      ]
    },
    "drumKit": {
      "title": "The Modern Tama: Starclassic Maple",
      "brand": "Tama",
      ...
      "config": {
        ...
        "shells": "6-ply maple shells"
      },
      "description": "By 2018, Scott Travis's main kit for Priest sessions was the Tama Starclassic Maple — a long way from the Pearl-era setups he had used in his early Racer X period and the Tama Artstar II birch kit he used on *Painkiller*. Travis had transitioned to Tama as his primary endorsement during the 1990s and stayed with the brand through the modern era, settling on the Starclassic Maple as his go-to platform.\n\nThe shift from birch (Artstar II) to maple (Starclassic) is the most significant tonal change between *Painkiller* and *Firepower*. Birch delivers a hard, focused attack with pronounced high-mids — ideal for cutting through the dry, in-your-face guitar production Chris Tsangarides built in 1990. Maple delivers a warmer, fuller body with smoother low-mid resonance — better suited to the broader, layered guitar arrangements Andy Sneap and Tom Allom constructed on *Firepower*. The 6-ply maple shell preserves articulation while giving each drum more harmonic depth.\n\nThe bass drum dimensions also evolved. *Painkiller* used 22\"x16\" kicks tuned tight for maximum machine-gun articulation; *Firepower* uses 22\"x18\" — two inches deeper, which adds low-end body and sustain without sacrificing attack. For an album with more mid-tempo groove material alongside the speed showcases, the deeper kicks deliver the weight the songs demand. Travis still runs two independent bass drums rather than a double pedal, preserving the foot independence that has defined his playing since the 1980s.\n\nThe tom configuration is more compact than the *Painkiller* setup — two rack toms (10\", 12\") and two floor toms (14\", 16\") instead of the three-rack-tom arrangement of 1990. Modern Travis has consistently favored a tighter tom array, prioritizing fluency across fewer drums rather than a sprawling palette. The 10/12 rack and 14/16 floor combination matches what he had been touring with through the 2000s and 2010s.\n\nFinished in piano black with chrome hardware, the kit reads as a direct visual descendant of the *Painkiller* Artstar II — same aesthetic, same brand loyalty, three decades of refinement under the surface.",
      "notes": [
        "Maple shells replace the Painkiller-era birch — warmer body, smoother low-mids",
    ...
    "snare": {
      "title": "The Modern Crack: Starphonic Brass",
      "brand": "Tama",
      "model": "Tama Starphonic Brass",
      "size": "14\" x 6\"",
      "shell": "Brass with die-cast hoops",
      "description": "For *Firepower*, Travis paired the Starclassic Maple kit with a Tama Starphonic 14\"x6\" brass snare — a modern, focused snare that delivers the high-frequency cut he has favored throughout his career while adding the warm low-mid body that brass shells uniquely produce.\n\nThe Starphonic line is Tama's flagship single-ply premium snare series, engineered to maximize resonance from the shell rather than rely on heavy double-ply construction. The brass shell at 14\"x6\" is slightly shallower than the 14\"x6.5\" Artstar II steel snare he used on *Painkiller* — a half-inch difference that trades a small amount of body for additional response and articulation. For an album with as much sixteenth-note snare work as *Firepower*, that responsiveness matters.\n\nBrass sits between steel and aluminum in tonal character: brighter than aluminum, warmer than steel. The result is a snare that cuts through Andy Sneap's dense, layered guitar production while retaining enough body to feel substantial in the mix. Travis tunes it medium-high with tight snare wires — the same tuning philosophy he has used since *Painkiller*, refined for a more modern target sound.\n\nThe die-cast hoops continue from the *Painkiller* era as well, adding to the drum's overall projection and giving Travis the rim-shot clarity he uses for accents and cross-stick work across the album. On \"Lightning Strike,\" the Grammy-nominated single, every backbeat needs to lock against Sneap's tight kick-and-guitar production — the Starphonic Brass delivers that anchor with the authority Priest's heaviest material demands.",
    ...
    "cymbals": {
      "title": "Sabian HHX: The Modern Travis Arsenal",
      "brand": "Sabian",
      "series": "Sabian HHX",
      "setup": [
        {
        ...
        {
          "type": "Crash",
          "model": "Sabian HHX Evolution Crash 16\"",
          "position": "Left of hi-hats",
      ...
      "description": "*Firepower* documents Scott Travis's long-running Sabian endorsement — a partnership that replaced the Paiste setup he used on *Painkiller* and which has defined his cymbal voice through the modern era. The HHX (Hand-Hammered Xtreme) series is Sabian's premier modern dark-side line, hand-hammered for complex overtones while retaining the cut and projection a metal drummer requires.\n\nThe 14\" HHX Stage Hi-Hats are Travis's pulse layer. Where the *Painkiller* Paiste Signature 14\" Heavy Hi-Hats were bright and brilliant-finished for maximum cut at speed, the HHX Stage Hats sit slightly darker in the spectrum — better suited to modern dense productions where excessive high-frequency content can fight the cymbal mics on the guitar tracks. They still cut, but with more harmonic complexity underneath.\n\nThe HHX Evolution crash range (16/18/19) provides Travis the dynamic options he uses across the album. Evolution-series crashes are designed for fast response with controlled decay — they speak immediately, peak hard, and clear out of the way for the next phrase. For *Firepower*'s arrangement-dense songs, that quick-clear behavior is essential. The three sizes allow Travis to match accent intensity to song dynamics: 16\" for tight punctuation, 18\" as the primary, 19\" for the bigger structural moments.\n\nThe 21\" HHX Groove Ride is the album's ride workhorse. It is a relatively dry, defined ride with a strong bell — exactly what Priest's mid-tempo material requires. Where flowery, washy rides would muddy the mix, the Groove Ride delivers articulation that holds its position in the stereo field even when guitars stack to the limit.\n\nThe 18\" HHX Chinese provides the trashy accent role that the 20\" Paiste Novo China filled on *Painkiller*. Sabian's Chinese cymbals in the HHX series have a more controlled trash character than vintage 2002s — useful for tight modern productions that don't want extended cymbal wash.",
      "estimatedValue": "$1,800-2,400 total (2018)"
    },
    "hardware": {
      "title": "Speed Cobra Era: Modern Tama Hardware",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Tama",
          "model": "Tama Speed Cobra HP910LSW",
          "notes": "Long footboard, light spring tension — Travis's modern pedal of choice",
          "description": "The Tama Speed Cobra HP910 replaced the Iron Cobra HP900 prototypes Travis used on Painkiller. The Speed Cobra's longer footboard provides additional leverage for heel-toe technique, and the lightweight construction reduces moving mass for faster response. By 2018 the Speed Cobra had become the standard for high-speed double-bass drummers across metal — Travis was running two of them, one on each independent kick drum, preserving his long-standing rejection of connected double-pedal setups."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Tama",
          "model": "Tama Speed Cobra Hi-Hat Stand HH915D",
          "notes": "Direct-drive linkage matched to the Speed Cobra family"
        },
        {
          "type": "Throne",
          "brand": "Tama",
          "model": "Tama 1st Chair Round Rider HT530B",
        ...
        },
        {
          ...
          "notes": "Slightly heavier than standard 5B for power without sacrificing speed"
        }
      ],
      "heads": {
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "Speed Cobra pedals deliver clean articulation under the verse double-bass pattern. HHX Evolution crashes provide the tight punctuation Sneap's arrangement demands."
      },
      {
        ...
        "gearNotes": "HHX Stage Hi-Hats deliver the pulse layer with controlled chick. Starphonic Brass snare cuts through Sneap's layered guitars without losing body."
      },
      {
        ...
        "gearNotes": "Compact 4-tom array (10/12/14/16) provides fluent fill movement. 22\"x18\" bass drums deliver the deeper low-end weight the mid-tempo groove demands."
      },
      {
        "track": "Necromancer",
        "bpm": "175",
        ...
        "gearNotes": "Speed Cobra pedals showcase the modern hardware's response advantage over the prototype Iron Cobras of 1990. Starphonic Brass cuts through at higher tempo."
      },
      {
        "track": "Spectre",
        "bpm": "120",
        ...
        "gearNotes": "HHX Groove Ride delivers articulation in the quieter passages. Maple shells' warmer body suits the slower dynamic build."
      }
    ],
    "evolution": {
      "title": "Painkiller to Firepower: Twenty-Eight Years of Gear Evolution",
      "content": "The gear arc from *Painkiller* (1990) to *Firepower* (2018) spans twenty-eight years and a near-complete component-level transition. Every category — drums, snare, cymbals, pedals, sticks, heads — evolved across the period. What did not evolve was the underlying philosophy: tight bass-drum tuning for articulation, brass-or-steel snare for cut, dual independent bass drums rather than a connected double pedal, and a metal-vocabulary cymbal approach prioritizing projection and definition.\n\n**The Drum Kit Shift:**\n*Painkiller*'s Tama Artstar II birch kit gave way to the Tama Starclassic Maple by the 2000s, and Travis stayed with the Starclassic platform through *Firepower*. The shift from birch to maple traded a portion of the aggressive high-mid attack for a warmer, fuller body — better suited to modern multi-tracked guitar arrangements with extended harmonic content. Bass drum depth went from 22\"x16\" to 22\"x18\", adding low-end weight for the more mid-tempo *Firepower* material.\n\n**The Snare Transition:**\nThe *Painkiller*-era Tama Artstar II 14\"x6.5\" steel snare evolved into the Tama Starphonic 14\"x6\" brass for *Firepower*. Brass replaced steel — warmer low-mid body while preserving high-frequency cut. The half-inch shallower depth (6\" vs 6.5\") prioritizes response and articulation over body weight.\n\n**Cymbals — Paiste to Sabian:**\nTravis transitioned from his *Painkiller*-era Paiste Signature / 2002 setup to the Sabian HHX series during the 1990s and stayed with Sabian through *Firepower*. The HHX line provides darker, more complex overtones than the brilliant-finished Paiste Signatures — a tonal direction better suited to modern dense productions where excessive brightness can clash with guitar tracks.\n\n**Hardware — Prototype to Production:**\nThe prototype/early Tama Iron Cobra HP900 pedals Travis helped develop in 1989-1990 were replaced by the Tama Speed Cobra HP910 by the modern era. The Speed Cobra's longer footboard provides additional leverage for heel-toe technique; lightweight construction reduces moving mass for faster response. Travis still runs two independent pedals on two bass drums — no connected double pedal, then or now.\n\n**Sticks:**\nVic Firth 5B in 1990 evolved to Vater Power 5B by 2018 — slightly heavier than standard 5B for power without sacrificing speed.\n\n**Heads:**\nRemo Powerstroke 3 / Emperor Coated heads of 1990 evolved to an Evans head package by 2018: EMAD2 for bass-drum batters, EC2 for toms, Heavyweight for snare batter. The Evans heads suit the modern recording environment's transient-shaping requirements better than the more open Remo selections that fit Wisseloord's natural ambience.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Artstar II Birch (1990)",
          "now": "Tama Starclassic Maple (2018)"
        },
        {
          "category": "Bass Drums",
          "then": "22\"x16\" (x2)",
        ...
        },
        {
          ...
          "now": "Tama Starphonic Brass 14\"x6\""
        },
        {
          "category": "Cymbals",
          "then": "Paiste Signature / 2002",
          "now": "Sabian HHX series"
        },
        {
          "category": "Pedals",
    ...
    "faq": [
      {
        ...
        "answer": "On Judas Priest's Firepower (2018), Scott Travis played a Tama Starclassic Maple kit in Piano Black finish — two 22\"x18\" bass drums, 10\"x8\" and 12\"x9\" rack toms, 14\"x14\" and 16\"x16\" floor toms, all 6-ply maple shells. His snare was a Tama Starphonic Brass 14\"x6\" with die-cast hoops. The setup is a notable evolution from his Painkiller-era (1990) Tama Artstar II birch kit — maple shells deliver warmer, fuller body than birch, and the 22\"x18\" bass drums are two inches deeper than the 22\"x16\" kicks he used in 1990, adding low-end weight for Firepower's more mid-tempo material."
      },
      {
  ...
  "angel-of-retribution-drum-setup": {
    ...
    "seoKeywords": [
      ...
      "pearl reference scott travis",
      "lochness eulogy drum sound",
      "scott travis pearl masters mcx",
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Scott Travis transitioned from his Painkiller-era Tama rig to Pearl Reference Series drums by the mid-2000s",
    ...
    "drumKit": {
      ...
      "brand": "Pearl",
      "model": "Pearl Reference Series (transitional from Painkiller-era Tama; some sessions used Pearl Masters MCX)",
      "finish": "Piano Black",
      "config": {
        "bassdrums": [
          "22\" x 18\" Bass Drum (x2)"
        ...
        "shells": "Pearl Reference hybrid shells (maple/birch/mahogany) for projection with focused low end; Masters MCX all-maple as alternate"
      },
      "description": "By 2005, Scott Travis had moved away from the Tama Artstar II that defined his Painkiller-era sound and settled into Pearl's flagship Reference Series. Photos and rehearsal footage from the Angel of Retribution sessions and the supporting 2005 tour consistently show him behind a Pearl Reference kit, with a Pearl Masters MCX appearing on some tracking dates as a backup. This transition is important: it's the rig that bridges Travis's blistering speed-metal years and the later Tama-era Firepower setup, and it's tuned for a fundamentally different goal — songs over spectacle.\n\nThe Reference Series uses a hybrid shell construction — maple, birch, and mahogany plies arranged so each drum is tuned for its role in the kit. The toms get more maple for warmth and sustain, the bass drums get more mahogany for low-end weight, and the snare position emphasizes birch for cutting attack. For an album like Angel of Retribution, which oscillates between mid-tempo grooves on \"Worth Fighting For\" and double-kick blasts on \"Hellrider,\" this approach paid off: the kit could speak quietly during the verses and explode without changing tuning.\n\nTravis ran a streamlined four-tom configuration — 10\" and 12\" up top, 14\" and 16\" on the floor — a noticeable simplification from the three-rack-tom Painkiller setup. The reduced tom count let him commit to bigger, more architectural fills rather than the rapid-fire melodic runs of 1990. The dual 22\" x 18\" bass drums (deeper than the 22\" x 16\" Painkiller-era kicks) gave him more air and a fuller bottom end suited to the album's heavier mid-2000s production aesthetic.\n\nThe Pearl Masters MCX, used on alternate sessions, is the all-maple counterpart to the Reference Series and would have provided a slightly warmer, more rounded tom voice on any tracks that called for it. Both kits sit in the same family — pro-level professional Pearl gear that defined Travis's middle period.",
      "notes": [
        "Transitional kit between the 1990 Tama Artstar II and the later Tama/Firepower-era setup",
        "Pearl Reference hybrid shells tune each drum for its role in the kit",
        ...
        "Pearl Masters MCX served as an all-maple alternate on some tracking dates"
      ],
      "estimatedValue": "$4,500-6,500 (2005)"
    },
    "snare": {
      "title": "Brass Authority",
      "brand": "Pearl",
      "model": "Pearl Reference Brass",
      "size": "14\" x 6.5\"",
      "shell": "Beaded brass with die-cast hoops",
      "description": "For Angel of Retribution, Travis paired his Pearl Reference kit with a Pearl Reference brass snare — a 14\" x 6.5\" beaded brass drum that delivers a darker, more complex backbeat than the steel Artstar II he used on Painkiller. Brass shells sit between steel and bronze tonally: more body than steel, more crack than bronze, and a midrange focus that cuts through the modern mid-2000s mix without sounding thin.\n\nThe 6.5\" depth gives the snare enough body for the album's slower, heavier material — \"Worth Fighting For,\" \"Eulogy,\" and the closing stretch of \"Lochness\" all benefit from a snare that can sustain a backbeat without disappearing. At the same time, the die-cast hoops keep rim shots sharp and tight, which matters during the double-kick passages on \"Judas Rising\" and \"Hellrider\" where Travis still needs Painkiller-style snap on the 2 and 4.\n\nTravis tuned the drum medium-high — not as tight as the 1990 Artstar steel, but tighter than a typical rock tuning — to find a middle ground between projection and tone. The combination of brass shell, beaded reinforcement, and die-cast hoops produced one of the most consistent snare sounds in Travis's recorded catalogue and is a big part of what makes Angel of Retribution feel modern next to its 1990 predecessor.",
    ...
    "cymbals": {
      "title": "Sabian HH and AA: The Long-Running Endorsement",
      "brand": "Sabian",
      "series": "Sabian HH / AA",
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Hand-hammered tone for warmth with bite"
        },
        {
          "type": "Crash",
        ...
        },
        {
          ...
          "position": "Above right toms",
          "notes": "Darker hand-hammered crash for verses"
        },
        {
          "type": "Crash",
      ...
      "description": "Scott Travis has been a Sabian endorser for decades, and Angel of Retribution captures him deep into that relationship. The setup combines Sabian's hand-hammered HH series (darker, more complex, more vintage in character) with the machine-hammered AA line (brighter, more cutting, faster response) — a hybrid approach that gives Travis tonal options without sacrificing the projection he needs to sit on top of K.K. Downing and Glenn Tipton's dual-guitar wall.\n\nThe 14\" HH Regular Hats are a noticeably warmer choice than the Paiste Signature 14\" Heavy Hi-Hats of the Painkiller era. The hand-hammered finish produces a chick-and-wash character that suits Angel of Retribution's groove-leaning material — particularly the verse of \"Revolution\" and the long instrumental passages of \"Lochness,\" where hi-hat color matters as much as articulation.\n\nThe crash array spans 16\" to 20\", giving Travis a range from quick AA Medium accents to larger sustaining hits. The 22\" HH Raw Bell Dry Ride is the centerpiece of the right side — a dry, articulate ride with a pronounced bell that drives the ride patterns on the verses of \"Deal With the Devil\" and the slow build of \"Eulogy.\" The 20\" AA Chinese provides the trashy accent voice for the heavier moments on \"Hellrider\" and the climactic sections of \"Lochness.\"\n\nThis setup represents Travis's mature cymbal voicing: less brightness than Painkiller, more tonal variety, and a deliberate balance between cutting attack and musical sustain. It's the cymbal language of a drummer who has stopped chasing the loudest possible sound and started shaping a real ensemble role.",
      "estimatedValue": "$2,800-3,500 total (2005)"
    },
    "hardware": {
      "title": "Demon Drive Era Hardware",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Pearl",
          ...
          "description": "The Pearl Demon Drive is the era-correct double pedal for Travis's mid-2000s setup. Its direct-drive linkage — a rigid metal link rather than a chain or strap — provides near-zero lag between foot motion and beater impact, which is exactly what double-kick-heavy songs like 'Judas Rising' and 'Hellrider' demand. The pedal's customizable cam, beater angle, and spring tension let Travis dial in the same response on both sides of the kit."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
        ...
        },
        {
          ...
          "notes": "Travis-spec hickory model with extended length for reach"
        }
      ],
      "heads": {
    ...
    "technique": {
      ...
      "keyTechniques": [
        ...
        "Cymbal color (HH vs. AA) used as an arrangement tool rather than pure volume"
      ]
    },
    "relatedAlbums": [
      "painkiller-drum-setup"
    ...
    "faq": [
      {
        ...
        "answer": "For the 2005 Angel of Retribution sessions, Scott Travis played a Pearl Reference Series kit — Pearl's flagship hybrid-shell line that combines maple, birch, and mahogany plies tuned per drum. The configuration featured dual 22 inch by 18 inch bass drums, 10 and 12 inch rack toms, and 14 and 16 inch floor toms. A Pearl Masters MCX served as an all-maple alternate on some tracking dates. This rig represented a clear transition away from the Tama Artstar II setup he used on 1990's Painkiller and toward the modern Priest sound that would carry through Nostradamus and into the Firepower era."
      },
      {
        "question": "Why did Scott Travis switch from Tama to Pearl by 2005?",
        "answer": "Travis moved into the Pearl camp in the early-to-mid 2000s as part of an endorsement shift. The Pearl Reference Series, introduced in 2004, was Pearl's most ambitious shell design at the time — its hybrid construction tunes each drum for its role rather than using a single shell material throughout. For a drummer whose work spans the speed-metal extremes of Painkiller and the song-oriented material on Angel of Retribution, that flexibility was a meaningful upgrade. Travis would later transition back toward Tama by the Firepower era, but the mid-2000s through early 2010s are firmly his Pearl years."
      },
      {
        "question": "What cymbals did Scott Travis use on Angel of Retribution?",
        "answer": "Travis has been a long-running Sabian endorser, and his 2005 setup combined the hand-hammered HH series with the machine-hammered AA line. The rig included 14 inch HH Regular Hi-Hats, AA Medium Crashes from 16 to 20 inches, an HH 19 inch Thin Crash for darker accents, a 22 inch HH Raw Bell Dry Ride, and a 20 inch AA Chinese for trashy accents on tracks like Hellrider and the Lochness section of the closing epic. The HH/AA hybrid approach gave him both vintage warmth and modern cut."
      },
      {
        "question": "How does Angel of Retribution fit between Painkiller and Firepower in Scott Travis's career?",
        "answer": "Angel of Retribution closes a 15-year arc gap on the Judas Priest timeline: Painkiller in 1990, Angel of Retribution in 2005, Nostradamus in 2008, and Firepower in 2018. For Travis specifically, it's the album where he stops being purely the speed-metal phenom of Painkiller and becomes the long-arc Priest drummer. The Pearl Reference kit, the Sabian HH/AA hybrid setup, and the more restrained song-serving approach all point toward the mature drumming he'd bring to the band's later work. It's also Rob Halford's first studio album back with Judas Priest after a 13-year departure, making it as much a comeback record for the band as a transition record for Travis's gear."
      },
      {
  ...
  "invincible-shield-drum-setup": {
    ...
    "drumKit": {
      "title": "The DW Collector's Series Era",
      "brand": "DW",
      ...
      "config": {
        ...
        "shells": "Maple/mahogany hybrid shells (SSC construction) for a fuller low end with controlled attack"
      },
      "description": "By the *Invincible Shield* era, Scott Travis had moved from the Tama Starclassic Maple kit he used on *Firepower* (2018) into DW's flagship Collector's Series — the same brand he had briefly sampled on the second leg of the *Nostradamus* tour years earlier, now his primary recording and touring kit. DW's Collector's Series is built around the company's Specialty/Standard Shell Composite (SSC) approach, blending maple and mahogany plies to deliver a fuller, warmer low end than the Tama maple shells while keeping the attack controlled enough to cut through Andy Sneap's dense, modern guitar production.\n\nThe two independent 22\"x18\" bass drums carry over directly from the *Firepower* configuration — Travis has run two separate kick drums, rather than a single drum with a connected double pedal, since the *Painkiller* era. The DW shells' added low-mid warmth suits *Invincible Shield*'s more anthemic, riff-driven material; tracks like the title track and \"Panic Attack\" benefit from bass drums that carry weight without losing the machine-gun clarity Travis's speed passages require.\n\nThe compact four-tom layout (10\"/12\" rack, 14\"/16\" floor) is unchanged from every Travis Priest kit since *Angel of Retribution* (2005) — a deliberate, mature choice that favors fluency and architectural fills over a sprawling tom array. The Piano Black finish keeps the visual continuity with every prior Travis-era Priest kit dating back to the *Painkiller* Tama Artstar II.",
      "notes": [
        "First Travis Priest studio album on a DW Collector's Series kit — Tama was the Firepower-era brand",
        "SSC maple/mahogany hybrid shells add low-mid warmth versus the Firepower-era Tama maple shells",
    ...
    "snare": {
      "title": "DW Collector's Series Bell Brass",
      "brand": "DW",
      "model": "DW Collector's Series Bell Brass",
      "size": "14\" x 6\"",
      "shell": "Bell brass with die-cast hoops",
      "description": "Travis's snare for *Invincible Shield* is a DW Collector's Series Bell Brass, 14\"x6\" — matching the brass-shell preference he has favored since his mid-2000s Pearl Reference Brass era on *Angel of Retribution* and carrying through the Tama Starphonic Brass he used on *Firepower*. Bell brass shells produce a sharper, more focused crack than standard brass, with a pronounced high-frequency lift that helps the drum sit forward in Andy Sneap's tight, modern mix.\n\nThe 14\"x6\" depth mirrors the Starphonic Brass dimensions from *Firepower*, keeping Travis's snare response consistent across the gear transition. Die-cast hoops preserve the rim-shot clarity he relies on for the album's frequent backbeat accents, particularly on \"Panic Attack\" and \"Devil in Disguise,\" where the snare needs to read clearly against Faulkner and Tipton's layered guitar tracks.\n\nTravis continues tuning medium-high with tight snare wires — the same fundamental approach documented on every Priest album since *Painkiller* — prioritizing cut and articulation over sustained ring.",
      "tuningSetting": "Medium-high tension, tight snare wires for cut and immediate attack",
      "heads": "Evans Heavyweight (batter), Evans Hazy 300 Snare Side (resonant)",
      "estimatedValue": "$550-750 (2024)"
    },
    "cymbals": {
      "title": "Zildjian A Custom: A New Cymbal Voice for Priest",
      "brand": "Zildjian",
      ...
      "description": "*Invincible Shield* marks Scott Travis's move to Zildjian's A Custom line, replacing the Sabian HHX setup that carried him through *Firepower*. A Custom cymbals are Zildjian's brilliant-finished, brighter-voiced line within the A family — engineered for fast response and pronounced high-frequency cut, which suits Andy Sneap's dry, upfront modern production approach.\n\nThe 14\" A Custom Hi-Hats give Travis a tighter, more immediate chick than the darker Sabian HHX Stage Hats he used on *Firepower*, useful for the driving hi-hat patterns that carry the verses of \"Panic Attack\" and \"The Serpent and the King.\" The crash range — 16\" through 19\" — favors quick attack and fast decay, letting Travis punctuate Sneap's tightly arranged riffs without cymbal wash bleeding into the next phrase.\n\nThe 20\" A Custom Ride anchors the album's more mid-tempo, groove-driven tracks like \"Trial by Fire,\" delivering clear stick definition and a bell that cuts for accents without overwhelming Ian Hill's bass lines. The 18\" A Custom China supplies the trashy accent voice Travis has used across every Priest era, from the Paiste Novo China of *Painkiller* through the Sabian HHX Chinese of *Firepower* to this Zildjian equivalent.",
      "estimatedValue": "$2,000-2,800 total (2024)"
    },
    "hardware": {
      "title": "DW Hardware Era",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "DW",
          "model": "DW MDD (Machined Direct Drive) (x2 independent pedals)",
          "notes": "Direct-drive linkage, one pedal per bass drum",
          "description": "Travis paired the DW Collector's Series kit with two independent DW MDD Machined Direct Drive pedals — no connected double pedal, consistent with his practice since the Painkiller era. The MDD's rigid, machined direct-drive linkage minimizes lag between foot motion and beater impact, matching the response he had from the Tama Speed Cobra pedals he used through Firepower."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "DW",
          "model": "DW 9000 Series Hi-Hat Stand",
          "notes": "Direct-drive design matched to the MDD pedal family"
        },
        {
          "type": "Throne",
          "brand": "DW",
        ...
        },
        {
          ...
          "brand": "Vater",
          "model": "Vater Scott Travis Signature",
          "notes": "Travis's long-running signature hickory model, unchanged across the DW gear transition"
        }
      ],
      "heads": {
        "bassKick": "Evans EMAD2 Clear (batter), Evans EQ3 Resonant Black (front)",
    ...
    "recordingTechniques": {
      ...
      "keyTechniques": [
        ...
        "DW Collector's Series kit and Zildjian A Custom cymbals gave a bright, well-defined signal for remote assembly",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "A Custom crashes punctuate the hook"
        ],
        "gearNotes": "Zildjian A Custom 14\" Hi-Hats deliver the fast, bright chick that drives the verse groove. DW MDD pedals keep the kick pattern clean under Faulkner's riff."
      },
      {
        ...
        "gearNotes": "18\" and 19\" A Custom crashes stack for the chorus hits. DW Collector's Series bass drums provide the low-end weight the anthemic chorus needs."
      },
      {
        ...
        "gearNotes": "Bell brass snare cuts through cleanly at the slower tempo. 20\" A Custom Ride anchors the groove without washing out the arrangement."
      },
      {
        ...
        "gearNotes": "DW MDD pedals sustain the verse double-kick cleanly. A Custom China provides the trashy accent at the bridge."
      },
      {
        "track": "Trial by Fire",
        "bpm": "110",
        ...
        "gearNotes": "20\" A Custom Ride carries the verse groove with clear stick definition. Maple/mahogany DW shells add body to the tom fills."
      }
    ],
    "evolution": {
      "title": "Firepower to Invincible Shield: Six Years, A New Gear Voice",
      "content": "The gear arc from *Firepower* (2018) to *Invincible Shield* (2024) spans six years and Travis's most significant brand shift since he moved from Tama to Pearl in the mid-2000s. Where the *Firepower*-to-*Painkiller* comparison told a story of gradual, incremental refinement within the same broad approach, the *Invincible Shield* gear change is a more deliberate reset: new drum brand, new cymbal brand, largely new hardware, all arriving at once for Travis's first Priest studio album in six years.\n\n**Drums — Tama to DW:**\n*Firepower*'s Tama Starclassic Maple gave way to the DW Collector's Series for *Invincible Shield*. DW's SSC maple/mahogany hybrid shells add low-mid warmth that Tama's pure maple shells didn't emphasize as strongly — a useful characteristic for *Invincible Shield*'s more anthemic, riff-forward material. The bass drum dimensions (22\"x18\", x2 independent) carried over unchanged.\n\n**Snare — Starphonic to Collector's Series Bell Brass:**\nThe Tama Starphonic Brass 14\"x6\" became a DW Collector's Series Bell Brass in the same 14\"x6\" dimensions — a lateral move within the brass-snare family Travis has favored since *Angel of Retribution* (2005), rather than a tonal reset.\n\n**Cymbals — Sabian HHX to Zildjian A Custom:**\nThe most audible shift is in the cymbals. Sabian's HHX series, which anchored Travis's cymbal voice from the mid-2010s through *Firepower*, gave way to Zildjian's brighter, faster-responding A Custom line. Where HHX favors darker, more complex overtones, A Custom cymbals speak faster and cut higher in the frequency spectrum — a better match for Andy Sneap's increasingly bright, upfront modern production style.\n\n**Hardware — Speed Cobra to MDD:**\nTama's Speed Cobra HP910 pedals were replaced by DW's Machined Direct Drive (MDD) pedals, bundled with the new drum endorsement. Travis's fundamental approach — two independent pedals, no connected double pedal — has not changed since 1990.\n\n**What Didn't Change:**\nVater's Scott Travis Signature stick model carried through unchanged, as did the Evans head package and the tight, medium-high snare tuning philosophy documented on every Priest album since *Painkiller*. The brand names shifted; the fundamentals — precision, articulation, and a preference for gear that speaks immediately — did not.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Starclassic Maple (Firepower, 2018)",
          "now": "DW Collector's Series (Invincible Shield, 2024)"
        },
        {
          "category": "Snare",
          "then": "Tama Starphonic Brass 14\"x6\"",
          "now": "DW Collector's Series Bell Brass 14\"x6\""
        },
        {
          "category": "Cymbals",
        ...
        },
        {
          ...
          "now": "DW MDD (Machined Direct Drive)"
        },
        {
          "category": "Sticks",
          "then": "Vater Power 5B",
          "now": "Vater Scott Travis Signature"
        }
      ]
    },
    "faq": [
      {
        ...
        "answer": "On Judas Priest's Invincible Shield (2024), Scott Travis plays a DW Collector's Series kit in Piano Black finish — two 22\"x18\" bass drums, 10\"x8\" and 12\"x9\" rack toms, and 14\"x14\" and 16\"x16\" floor toms, built with DW's maple/mahogany SSC hybrid shells. His snare is a DW Collector's Series Bell Brass at 14\"x6\" with die-cast hoops. This is a shift from the Tama Starclassic Maple kit he used on Firepower (2018) — his most significant drum brand change since moving from Tama to Pearl in the mid-2000s."
      },
      {
      ...
      },
      {
        ...
        "answer": "For Invincible Shield, Scott Travis uses Zildjian's A Custom line — a shift from the Sabian HHX series that carried him through Firepower (2018). His setup includes 14\" A Custom Hi-Hats, A Custom Crashes from 16\" to 19\", a 20\" A Custom Ride, and an 18\" A Custom China. A Custom cymbals are brighter and faster-responding than the darker Sabian HHX line, matching producer Andy Sneap's upfront, modern mix approach on the album."
      },
      {
  ...
  "whats-in-scott-travis-kit": {
    ...
    "drumKit": {
      "title": "Scott's Current Arsenal: Pearl Reference Series",
      "brand": "Pearl",
      "model": "Pearl Reference Series",
      "finish": "Piano Black",
      "config": {
    ...
    "cymbals": {
      ...
      "setup": [
        ...
        {
          "type": "Crash",
          "model": "Sabian 20\" AAX X-Plosion Crash",
          "position": "Right of toms",
          "notes": "Larger crash for section endings"
        },
        {
          "type": "Ride",
          "model": "Sabian 22\" HHX Power Ride",
          "position": "Far right",
      ...
      "items": [
        {
          ...
          "brand": "Pearl",
          "model": "Pearl Demon Drive Double Pedal",
          "description": "The Demon Drive is Pearl's flagship double pedal, featuring direct drive for immediate response. Travis's legendary double bass speed depends on pedals that translate every muscle movement instantly. The Demon Drive's adjustable footboard angles and interchangeable cam systems let him fine-tune response for his exact technique.",
          "notes": "Direct drive for maximum responsiveness, used with medium spring tension"
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Pearl",
          "model": "Pearl H-2050 Eliminator Hi-Hat",
          ...
          "notes": "Swivel leg design for positioning flexibility"
        },
        {
          "type": "Throne",
          "brand": "Pearl",
          "model": "Pearl D-3500 Roadster",
          "description": "A hydraulic throne that provides stability during extended double bass sessions. Travis's performances are physically demanding — a reliable, comfortable throne is essential for maintaining technique over two-hour shows.",
          "notes": "Multi-core foam seat with hydraulic height adjustment"
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
          "model": "Vic Firth American Classic 5A or 5B",
          "description": "Travis prefers standard stick models that balance speed and power. The 5A provides more finesse, while the 5B offers additional weight for harder-hitting passages. Hickory construction for durability.",
    ...
    "gearEvolution": {
      "title": "From Racer X to Invincible Shield: 40 Years of Gear",
      "content": "Scott Travis's gear has evolved significantly from his Racer X days to the current Judas Priest era. Understanding that evolution illuminates his journey as a drummer.\n\n**Racer X Era (1985-1989):**\nWith Racer X, Travis used Tama drums — the brand of choice for many shred-era drummers. His setup was more compact than his current kit, reflecting the club and theater venues Racer X played. Speed was paramount; power came second.\n\n**Early Priest Era (1989-1995):**\nWhen Travis joined Judas Priest, he initially continued with Tama Artstar II drums — the kit heard on \"Painkiller.\" This birch-shell setup provided the attack needed for his speed metal approach. The snare was typically a Tama steel model.\n\n**Transitional Period (1996-2005):**\nThrough the Tim \"Ripper\" Owens era and Rob Halford's return, Travis experimented with different configurations. He explored ddrum for a period, even developing a signature snare drum that remained in his rotation for years.\n\n**Modern Era (2005-Present):**\nTravis settled on Pearl Reference Series drums, finding the maple/birch hybrid shells delivered the perfect balance of warmth and attack. His cymbal preferences stabilized around Sabian HHX and AAX models. The current setup represents decades of refinement — every element chosen through experience.\n\n**Consistency Philosophy:**\nUnlike some drummers who constantly chase new gear, Travis values reliability. His basic configuration has remained similar for nearly two decades. He knows what works for Judas Priest's sound and sees no reason to reinvent what already performs.",
      "thenVsNow": [
        {
          "category": "Kit",
          "then": "Tama Artstar II (Painkiller)",
          "now": "Pearl Reference Series"
        },
        {
          "category": "Snare",
          "then": "Tama Steel 14\"x6.5\"",
          "now": "Pearl Reference Brass 14\"x6.5\""
        },
        {
          "category": "Cymbals",
          "then": "Paiste 2002/Signature mix",
          "now": "Sabian HHX/AAX"
        },
        {
          "category": "Pedals",
          "then": "Early Tama Iron Cobra",
    ...
    "whereToBuy": {
      ...
      "items": [
        {
          "category": "Drums",
          "recommendation": "Pearl Reference or Reference Pure Series",
          "available": true,
          "priceRange": "$5,000-8,000 (new)",
          "notes": "Pearl's flagship line remains available with various finish options"
        },
        {
          "category": "Snare",
          "recommendation": "Pearl Reference Brass 14\"x6.5\" or Sensitone Brass",
          "available": true,
          "priceRange": "$500-900 (new)",
          "notes": "Brass shells provide the cut Travis's sound requires"
        },
        {
          "category": "Cymbals",
          "recommendation": "Sabian HHX + AAX combination",
          "available": true,
          "priceRange": "$2,500-4,000 (full setup)",
          "notes": "HHX Power series for hi-hats and ride, AAX X-Plosion for crashes"
        },
        {
          "category": "Double Pedal",
          "recommendation": "Pearl Demon Drive or Demon XR",
          "available": true,
