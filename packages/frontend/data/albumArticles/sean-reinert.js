// Album drum-setup articles — Sean Reinert. Auto-split from the former monolith.
  ...
  "focus-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "The first death metal album to fully incorporate jazz fusion as a structural element, not just an influence"
      ]
    },
    "drumKit": {
      "title": "Reinert's Focus Kit: Tama Artstar II with Electronic Integration",
      "brand": "Tama",
      "model": "Tama Artstar II",
      "finish": "Natural Wood",
      "config": {
        ...
        "shells": "Birch shells with electronic trigger augmentation"
      },
      "description": "Sean Reinert's kit for the \"Focus\" sessions was built on the same Tama Artstar II foundation he had used for \"Human\" in 1991 — birch shells, single bass drum with double pedal, three rack toms providing melodic fill options. But for \"Focus,\" Reinert added a layer that transformed the sonic landscape: electronic drum trigger pads, positioned alongside his acoustic drums, fed into synthesizer modules that layered electronic textures beneath the live performance.\n\nThis integration of acoustic and electronic drums was unprecedented in extreme metal. The triggers weren't replacing the acoustic drums — they were augmenting them, adding synthesizer pads, atmospheric tones, and programmatic elements that gave \"Focus\" its otherworldly production texture. Scott Burns, whose engineering work typically leaned toward bone-dry death metal clarity, found new territory capturing this hybrid setup.\n\nThe birch Artstar II shells continued to deliver the warmth and attack balance that defined Reinert's sound. Single bass drum with double pedal remained his signature — his double-kick vocabulary was musical, not merely fast, and the single-drum-plus-pedal setup kept his patterns grounded in compositional thinking rather than pure velocity display.\n\nThe three rack toms (10\", 12\", 13\") and single floor tom (16\") gave Reinert the same fill vocabulary he had explored on \"Human,\" now deployed across musical contexts ranging from death metal blasting to jazz-fusion comping to near-ambient textural passages. The compact, musical configuration proved as versatile in Cynic's fusion context as it had been in Death's progressive death metal framework.",
      "notes": [
        "Same Tama Artstar II birch shell foundation as Human (1991)",
        "Electronic trigger pads augmenting the acoustic kit — unique in metal for the era",
        "Single 22\" bass drum with double pedal — Reinert's signature compositional approach",
        "Three rack toms providing melodic fill vocabulary for jazz-fusion passages",
        "Trigger integration required extraordinary timing precision from the performer"
      ],
      "estimatedValue": "$2,500-3,500 (1993)"
    },
    "snare": {
      "title": "Precision in Two Voices",
      "brand": "Tama",
      "model": "Tama Artstar II Birch Snare",
      "size": "14\" x 5.5\"",
      "shell": "Birch with electronic trigger option",
      "description": "The snare sound on \"Focus\" occupies a unique sonic territory in Sean Reinert's discography. Where \"Human\" had a pure acoustic snare captured with Scott Burns' characteristic mid-range clarity, \"Focus\" adds the possibility of electronic snare layering on certain passages — triggered samples blended beneath the acoustic crack for additional body and attack.\n\nThe primary snare was a Tama Artstar II birch model, tuned to provide both the attack required for death metal passages and the sensitivity needed for Reinert's ghost note vocabulary. On \"Focus,\" the dynamic range of his snare playing is even more pronounced than on \"Human\": passages like the jazz-leaning sections of \"Veil of Maya\" require whisper-quiet ghost notes, while the death metal blasts of \"Hyperdrive\" need a sharp, cutting rimshot that registers above the guitar density.\n\nScott Burns captured this range with particular care on \"Focus,\" allowing the snare dynamics more space in the mix than typical death metal productions of the period. The result is a snare that breathes across the album's varied contexts — cutting through distortion when required, retreating into textural ghost work when the music opens up.",
      "tuningSetting": "Medium-high for dynamic range across jazz and death metal passages",
      "heads": "Remo Ambassador Coated (batter), Remo Ambassador Snare Side (resonant)",
      "estimatedValue": "$300-450 (1993)"
    },
    "cymbals": {
      "title": "Zildjian Arsenal for Jazz and Metal",
      "brand": "Zildjian",
      "series": "Zildjian A / K Series",
      "setup": [
        {
          ...
          "position": "Left side",
          "notes": "Versatile hi-hats bridging jazz openness and metal precision"
        },
        {
          "type": "Crash",
          "model": "Zildjian A 16\" Medium Thin Crash",
          "position": "Left of hi-hats",
          "notes": "Fast, musical crash for compositional accents"
        },
        {
          "type": "Crash",
          "model": "Zildjian A 18\" Medium Crash",
          "position": "Right of rack toms",
          "notes": "Fuller crash voice for heavier sections"
        },
        {
          "type": "Ride",
          "model": "Zildjian K 20\" Custom Dry Ride",
          "position": "Far right",
          "notes": "Central to Reinert's jazz-fusion ride vocabulary"
        },
        {
          "type": "China",
          "model": "Zildjian 16\" China",
        ...
        },
        {
          ...
          "model": "Zildjian A 10\" Splash",
          "position": "Effect position",
          "notes": "Jazz-vocabulary splash cymbal for quick accents"
        }
      ],
      "description": "Reinert's cymbal selection on \"Focus\" carried forward the jazz-rooted Zildjian palette from \"Human,\" deploying it now across an even wider musical range. The K Custom Dry Ride remained the cornerstone of his sound — its dry, articulate character allowed every stick stroke to register clearly whether Reinert was riding the bell, playing the bow in jazz patterns, or using it as an accent surface during blast passages.\n\nThe A Series New Beat hi-hats provided the tonal center his playing demanded. Reinert's hi-hat technique on \"Focus\" is among the most sophisticated in extreme metal: he uses the hats as a harmonic voice, opening and closing them for tonal inflection in ways that jazz drummers would recognize immediately. On tracks like \"Sentiment,\" the hi-hat becomes almost melodic — an approach that had no precedent in death metal.\n\nThe crash and China cymbals served the album's death metal sections with characteristic Zildjian clarity — musical crashes with enough body to punctuate section changes, a China with the raw aggression required for blasting passages. The 10\" splash appeared in jazz-vocabulary contexts, providing the quick accent responses that larger crashes couldn't deliver.",
      "estimatedValue": "$1,500-2,000 total (1993)"
    },
    "hardware": {
      "title": "Electronic Integration and Acoustic Foundation",
      "items": [
        {
          "type": "Bass Drum Pedal",
          "brand": "DW",
          "model": "DW 5000 Double Pedal",
          "notes": "Smooth, controllable double bass for musical rather than velocity-focused patterns",
          "description": "Reinert's double pedal approach on Focus maintained the compositional philosophy from Human — double bass as a musical voice rather than a speed display."
        },
        {
          "type": "Electronic Trigger Pads",
          "brand": "Various",
          "model": "Drum trigger pads with synthesizer modules",
          "notes": "Revolutionary integration of electronic and acoustic sounds"
        },
        {
          "type": "Throne",
          "brand": "Roc-N-Soc",
          "model": "Roc-N-Soc Standard",
          "notes": "Consistent throne for extended technical sessions"
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
          "model": "Vic Firth American Classic 5A",
          "notes": "Medium-weight sticks for dynamic range across jazz and metal contexts"
        }
      ],
      "heads": {
        "bassKick": "Remo Powerstroke 3 Clear",
    ...
    "recordingTechniques": {
      "title": "Scott Burns at the Frontier",
      "content": "Recording \"Focus\" at Morrisound with Scott Burns placed the sessions in familiar technical territory — Burns had captured the Florida death metal scene's defining records — but the musical content pushed both engineer and producer into new space. \"Focus\" wasn't another death metal album requiring Burns' signature punchy, aggressive drum sound. It was a jazz-fusion hybrid that needed the drum kit to breathe, respond dynamically, and carry both electronic and acoustic information simultaneously.\n\n**The Electronic Integration Challenge:**\nThe most technically demanding aspect of the \"Focus\" drum recording was capturing both acoustic and electronic elements in a coherent blend. Reinert's trigger pads fed synthesizer sounds that needed to sit beneath the acoustic drums without obscuring them, creating textural layers rather than competing signals. Burns' engineering balanced these elements across the mix with unusual sophistication for a metal record of the period.\n\n**Dynamic Capture:**\nUnlike typical death metal productions where compression maximizes punch and minimizes dynamic variation, \"Focus\" required a more nuanced approach. Reinert's ghost notes, jazz ride patterns, and brushwork needed to survive the mixing process without being flattened into the uniform surface of standard death metal production.\n\n**The Result:**\n\"Focus\" sounds unlike any other metal record in Burns' catalog — because it is unlike any other metal record. The drum sound serves the music's fusion ambitions while retaining the attack and definition of extreme metal production.",
      "keyTechniques": [
        "Blending acoustic and electronic drum signals — unprecedented in extreme metal",
        "Dynamic range preservation beyond standard death metal production compression",
        "Overhead and room mic placement capturing Reinert's jazz cymbal vocabulary",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          "Opens the album with the full scope of Reinert's jazz-death vocabulary",
          "Ride cymbal patterns shifting between death metal drive and jazz riding",
          "Electronic triggers audible beneath the acoustic performance",
          "Ghost notes anchoring the fusion passages"
        ],
        "gearNotes": "K Custom Dry Ride central to the opening track's dual jazz/metal character. Electronic trigger pads audible beneath the snare in transitional passages."
      },
      {
        "track": "Sentiment",
        "bpm": "130-160",
        "signature": "Shifting, jazz-fusion influenced",
        "highlights": [
          "Reinert's most overtly jazz-influenced drumming on the album",
          "Hi-hat as melodic voice — nearly unprecedented in metal",
          "Brush technique elements in the quieter passages",
          "Dynamic range from near-silence to death metal intensity within a single track"
        ],
        "gearNotes": "Zildjian A 14\" New Beat hi-hats used as a primary melodic voice. Brush technique on the Tama Artstar snare head."
      },
      {
        "track": "Textures",
        "bpm": "150-190",
        "signature": "Ambient fusion to death metal",
        "highlights": [
          "Electronic drum pads most audible here — synthesizer textures beneath acoustic kit",
          "Jazz ride vocabulary contrasting with death metal blast sections",
          "Tom fills that move like jazz comping rather than metal clichés",
          "Demonstrates the full scope of Reinert's dual-genre fluency"
        ],
        "gearNotes": "Electronic trigger pads create atmospheric layers. Single 22\" kick with double pedal delivering musical double-bass figures throughout."
      }
    ],
    "evolution": {
      "title": "The Arc: Human → Focus → Beyond",
      "content": "\"Focus\" represents the fullest realization of Sean Reinert's musical vision — the culmination of everything he had developed on \"Human\" and pushed further into fusion territory that the death metal context had constrained.\n\n**From Human to Focus:**\n\"Human\" was revolutionary within death metal; \"Focus\" dissolved the genre boundaries entirely. The same jazz vocabulary — ghost notes, ride cymbal work, dynamic shading, polyrhythmic complexity — now operated in an environment that encouraged it to expand rather than exist in creative tension with death metal convention. Reinert had complete creative freedom, and he used it to build the most sophisticated extreme metal drum performance of the early 1990s.\n\n**The Legacy:**\n\"Focus\" influenced everyone from the early progressive death metal bands who followed to the modern fusion-metal acts that emerged in the 2000s. Bands like Periphery, Animals as Leaders, and Scale the Summit all share DNA with what Reinert demonstrated in 1993 — that extreme metal could be genuinely musical, compositionally sophisticated, and technically virtuosic without sacrificing power.",
      "thenVsNow": [
        {
          "category": "Human (1991)",
          "then": "Jazz vocabulary within death metal framework",
          "now": "Framework that expanded the genre"
        },
        {
          "category": "Focus (1993)",
          "then": "Jazz fusion merged with death metal as equals",
          "now": "Template for progressive extreme metal"
        },
        {
          "category": "Electronic Integration",
          "then": "Revolutionary and unprecedented",
          "now": "Standard in progressive metal production"
        }
      ]
    },
    "videos": [],
    ...
    "faq": [
      {
        "question": "What drum kit did Sean Reinert use on Cynic's Focus in 1993?",
        "answer": "Sean Reinert recorded Cynic's Focus in 1993 using a Tama Artstar II kit with birch shells — the same series he had used on Death's Human two years earlier. His configuration included a single 22\" x 16\" bass drum with a double pedal, 10\", 12\", and 13\" rack toms, and a 16\" floor tom. What made the Focus setup unique was the addition of electronic trigger pads integrated with the acoustic kit, feeding synthesizer modules to create the layered electronic textures that define the album's sound. This blend of acoustic and electronic drums was unprecedented in extreme metal."
      },
      {
        "question": "What cymbals did Sean Reinert use on Cynic's Focus?",
        "answer": "Sean Reinert used a Zildjian A and K Series cymbal setup on Cynic's Focus, carrying forward the same palette from his Death Human sessions. His setup included Zildjian A 14\" New Beat Hi-Hats, A Series 16\" and 18\" crashes, a Zildjian K 20\" Custom Dry Ride (central to his jazz-fusion ride vocabulary), a 16\" China for aggressive accents, and a 10\" Splash for jazz-vocabulary quick accents. The K Custom Dry Ride was the cornerstone of his sound, its dry, articulate character allowing the jazz ride patterns on tracks like Veil of Maya and Sentiment to speak clearly above the mix."
      },
      {
        "question": "How did Sean Reinert's drumming on Focus differ from his work on Death's Human?",
        "answer": "On Death's Human (1991), Reinert introduced jazz vocabulary into death metal — ghost notes, ride cymbal work, dynamic shading — but always within the framework of death metal song structures and Chuck Schuldiner's compositional vision. On Cynic's Focus (1993), the jazz and death metal elements were fully equal partners, with no genre hierarchy constraining Reinert's approach. Additionally, Focus introduced electronic trigger pads blended with the acoustic kit — an element absent from Human — creating the synthesizer textures that give Focus its futuristic sonic identity. Reinert had complete creative freedom on Focus in a way that the Death sessions, however groundbreaking, did not allow."
      },
      {
        "question": "Who produced Cynic's Focus and where was it recorded?",
        "answer": "Cynic's Focus (1993) was recorded at Morrisound Recording in Tampa, Florida, with producer Scott Burns — the same studio and producer who had captured Death's Human in 1991. Scott Burns was the defining engineer of Florida death metal, having recorded Deicide, Obituary, Cannibal Corpse, and numerous other Morrisound classics. For Focus, Burns extended his approach to accommodate Reinert's electronic trigger integration and the album's jazz-fusion hybrid character, producing a drum sound unlike anything else in his catalog."
      }
    ],
    "conclusion": {
      "title": "Focus: Where Jazz Fusion Met Extreme Metal and Neither Survived Unchanged",
      "content": "Cynic's \"Focus\" is the album where Sean Reinert proved that his innovations on \"Human\" were not a ceiling — they were a foundation. Every technique he had introduced to death metal in 1991 he took further in 1993: more sophisticated jazz vocabulary, more compositional thinking, and the addition of electronic integration that pushed the sonic possibilities of extreme metal drumming into entirely new territory.\n\n**The Gear in Perspective:**\nReinert's equipment on \"Focus\" was an evolution of what he had used on \"Human\" — Tama Artstar II shells, Zildjian A and K cymbals, DW double pedal — augmented by the electronic trigger pads that gave the album its unique textural dimension. The lesson is the same as always: extraordinary playing elevates ordinary equipment. The Artstar II and Zildjian cymbals were professional but not exotic; what made them produce extraordinary sounds was Reinert's hands.\n\n**For Drummers Today:**\nStudy \"Focus\" as a masterclass in vocabulary expansion. Reinert demonstrates what happens when you commit fully to erasing genre boundaries rather than testing them. Every passage is considered, every fill is compositional, every cymbal choice serves the music rather than the drummer's ego.\n\n**The Sean Reinert Legacy:**\nFrom \"Human\" through \"Focus\" and beyond, Sean Reinert established that extreme metal drumming could be genuinely musical — not just technically demanding, but sophisticated, dynamic, and emotionally expressive. \"Focus\" is his most complete statement. Every progressive metal drummer since has been building on what he laid down.\n\n🥁 *Sean Reinert (1971-2020) — He showed death metal what was possible when jazz met metal and neither blinked.* 🥁"
    }
  }
};
