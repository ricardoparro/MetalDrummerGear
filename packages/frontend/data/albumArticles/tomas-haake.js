...
export const articles = {
  ...
  "violent-sleep-of-reason-drum-setup": {
    ...
    "description": "Complete breakdown of Tomas Haake's drum setup on Meshuggah's The Violent Sleep of Reason. Discover how the Sonor SQ2 Heavy Beech kit and Sabian HHX/AAX cymbals held steady while recording live-to-tape changed everything about this album's drum sound.",
    "seoKeywords": [
      "tomas haake drum kit",
    ...
    "drumKit": {
      ...
      "description": "For *The Violent Sleep of Reason*, Tomas Haake stayed with the Sonor SQ2 Heavy Beech platform he had transitioned to during the *Koloss* era — no gear switch accompanied the shift to live-in-studio recording. The Heavy Beech shells' thicker construction, built for attack and volume against downtuned guitars, turned out to be exactly what a live room demanded.\n\nThe SQ2's consistency under pressure mattered more than ever here. Recording live with five musicians simultaneously, with no isolation or punch-in editing to fall back on, meant every piece of gear needed to respond predictably at high volume and hold tuning through a full take. The Heavy Beech shells had already proven that reliability on stage for years.\n\nHaake maintained his signature configuration: a single 24\" x 18\" bass drum played with two separate single pedals rather than a double pedal, and the same compact tom arrangement he'd carried since the Koloss era. Nothing about the live-to-tape approach required — or produced — a change in shells.\n\nThe decision to record on a road-tested, unchanged rig rather than experimenting with a studio-only configuration was deliberate. With five musicians recording simultaneously in a live room, reliability matters more than exotic studio configurations. Every piece of gear needed to perform without fail, take after take, for days on end.",
      "notes": [
        "Same Sonor SQ2 Heavy Beech platform established during the Koloss era — no switch for this album",
        "Heavy Beech variant for increased attack and projection",
        "Single 24\" bass drum — uses two separate single pedals",
    ...
    "cymbals": {
      ...
      "description": "*The Violent Sleep of Reason* did not bring a cymbal change — Haake's Sabian HHX/AAX setup carried straight into the live-in-studio sessions unmodified. The signature 14\" HHX Compression Hi-Hats and the mix of HHX (darker, complex) and AAX (brighter, faster) crashes had already been road-tested through years of touring, which is exactly what a live-to-tape session demands.\n\nRecording live with five musicians in the same room raises the stakes on cymbal bleed and separation, but rather than reaching for a different cymbal voicing, Haake and producer Tue Madsen managed it through mic placement and mix decisions. The Sabian setup's existing balance of attack and control — dry response on the 21\" Raw Bell Dry Ride prevents wash buildup, and the HHX crashes' complex overtones sit naturally against dense, downtuned guitars — needed no rethinking for the live room.\n\nThe 14\" hi-hats provide the precise open/closed articulation central to Haake's hi-hat work. Much of Meshuggah's groove comes from the relationship between hi-hat patterns and the polyrhythmic kick/snare interplay — the hi-hats serve as a consistent reference pulse that makes the surrounding complexity perceivable rather than chaotic.",
      "estimatedValue": "$2,500-3,500 total (HHX/AAX combination setup)"
    },
    "hardware": {
      ...
      "items": [
        {
          ...
          "description": "The Tama Speed Cobra single pedals stayed in place for this album, unchanged from Haake's established setup. Using two completely separate single pedals rather than a double pedal keeps each foot mechanically independent, with the Speed Cobra's smooth, fast action supporting the sustained demands of a five-piece band recording live in the same room."
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
    ...
    "trackAnalysis": [
      {
        ...
        "gearNotes": "The Sonor SQ2 Heavy Beech kit and Sabian HHX/AAX cymbals — unchanged from prior albums — establish the album's sonic palette immediately."
      },
      {
        ...
        "gearNotes": "The Sabian HHX Compression hi-hats provide the controlled articulation essential for this track's groove-forward approach."
      },
      {
        "track": "MonstroCity",
        "bpm": "100",
    ...
    "vsObzen": {
      "title": "VSÖR vs obZen: Gear Evolution vs Recording Revolution",
      "content": "*The Violent Sleep of Reason* sits eight years after *obZen* in the Meshuggah timeline. The gear did evolve in that span — but the transition had already happened gradually during the *Koloss* era (2012), not as a dramatic brand-switch tied to VSÖR's live-to-tape approach.\n\n**Kit — Evolved via Koloss, Not VSÖR:**\nobZen used the Sonor Designer Series with maple/beech shells. By the time of *Koloss*, Haake had transitioned to the Sonor SQ2 platform, and that SQ2 Heavy Beech configuration is what he brought into the VSÖR sessions — no additional kit change accompanied the shift to live-in-studio recording.\n\n**Cymbals — Refined, Not Replaced:**\nobZen's Sabian AAX/AA setup gave way to the HHX/AAX combination (including Haake's signature HHX Compression Hi-Hats) that anchored VSÖR. This was a refinement within the Sabian family, not a switch to a different cymbal brand.\n\n**Pedals — Same Independence Philosophy:**\nobZen used two independent Sonor Perfect Balance single pedals; by VSÖR, Haake had moved to two independent Tama Speed Cobra single pedals. In both cases, the defining choice — complete, unlinked foot independence rather than a connected double pedal — never changed.\n\n**What Actually Changed for VSÖR — the Recording Process:**\nThe real story of this album is entirely in how it was captured. obZen was recorded with isolated, overdubbed tracking and a click track — standard studio practice that allowed painstaking precision. VSÖR was recorded live-to-tape, all five members playing simultaneously with no click track on rhythm tracks — a method that tested Haake's internal timing rather than his gear.\n\n**What Didn't Change:**\nThe fundamental approach remained identical across both albums: two single bass drum pedals, compact tom configuration, 22-inch kick drums, and a philosophy that technique serves music rather than the other way around.",
      "comparisonTable": [
        {
          "category": "Kit",
          "obzen": "Sonor Designer Series (maple/beech)",
          "vsor": "Sonor SQ2 Heavy Beech (established during Koloss era)"
        },
        {
          "category": "Snare",
        ...
        },
        {
          "category": "Cymbals",
          "obzen": "Sabian AAX / AA",
          "vsor": "Sabian HHX / AAX (signature Compression Hi-Hats)"
        },
        {
          "category": "Pedals",
    ...
    "faq": [
      {
        ...
        "answer": "Tomas Haake recorded The Violent Sleep of Reason in 2016 on his Sonor SQ2 Heavy Beech kit — the same platform he had transitioned to during the Koloss era (2012), not a new kit adopted for this album. The setup featured a single 24x18 inch bass drum played with two separate single pedals, Heavy Beech shells for increased attack and projection, and a compact tom configuration. The thicker Heavy Beech shells' focused attack, already road-tested through years of touring, translated directly into the live-in-studio recording approach without requiring any gear change."
      },
      {
      ...
      },
      {
        ...
        "answer": "The Violent Sleep of Reason setup differs from obZen in the areas that had already evolved by the Koloss era: the drum kit (Sonor Designer Series on obZen vs Sonor SQ2 Heavy Beech on VSÖR), the cymbals (Sabian AAX/AA on obZen vs Sabian HHX/AAX, including his signature Compression Hi-Hats, on VSÖR), and the pedals (Sonor Perfect Balance on obZen vs Tama Speed Cobra on VSÖR). None of these changes were made for VSÖR specifically — they were already in place from the Koloss album cycle. Haake also had his Vic Firth signature sticks by 2016 rather than the standard 5A sticks he used on obZen. What's genuinely unique to VSÖR is the recording process: live-to-tape with no click track, a first for a Meshuggah studio album."
      },
      {
        "question": "What cymbals did Tomas Haake use on The Violent Sleep of Reason?",
        "answer": "Tomas Haake used his established Sabian HHX/AAX setup on The Violent Sleep of Reason, the same combination he had refined from the Sabian AAX/AA series he used on obZen. His VSÖR setup included the signature 14 inch HHX Compression Hi-Hats, an 18 inch AAX X-Plosion crash, a 19 inch HHX Evolution crash, a 21 inch HHX Raw Bell Dry Ride, and an 18 inch HHX Chinese. No cymbal brand change accompanied the album's live-in-studio recording approach — the existing HHX/AAX blend of dry, defined tones needed no rethinking for a live room."
      },
      {
        "question": "What pedals did Tomas Haake use on The Violent Sleep of Reason?",
        "answer": "Tomas Haake used two independent Tama Speed Cobra single pedals on The Violent Sleep of Reason — never a connected double pedal, consistent with his entire career approach. This pedal setup carried over unchanged from the Koloss album cycle rather than being introduced for VSÖR specifically. The Speed Cobra's smooth, fast action lets Haake fine-tune the feel under each foot independently — essential for the complete foot independence his polyrhythmic patterns require."
      }
    ],
    "conclusion": {
      "title": "Live Energy, Polyrhythmic Precision",
      "content": "*The Violent Sleep of Reason* occupies a unique position in Meshuggah's catalog and in the history of extreme metal recording. It proved that music of extraordinary rhythmic complexity — patterns that had been painstakingly constructed in isolation on previous records — could be performed live in a room, without a click track, by five musicians listening to each other in real time.\n\nFor Tomas Haake, the album represented a philosophical shift, not a gear one. His Sonor SQ2 Heavy Beech kit, Sabian HHX/AAX cymbals, and two independent Tama Speed Cobra single pedals — already established during the Koloss era — carried straight into the VSÖR sessions unchanged. The transformation was entirely in the recording approach: choosing a stripped-back, road-tested rig for a live room rather than reaching for a different kind of tool.\n\nThe stripped-back touring rig philosophy — reliable, road-tested, optimized for feel rather than studio-specific tone-chasing — produced an album that sounds different from obZen not just in gear terms (the SQ2/Sabian/Speed Cobra platform reflects the evolution already underway by Koloss), but in energy. Where obZen is precisely engineered, VSÖR is raw. Where obZen is metronomic, VSÖR breathes.\n\nBoth approaches are legitimate. Both represent Meshuggah at the peak of their powers. And both reveal something essential about Tomas Haake: that his technical mastery is in service of musical expression, whether that expression demands machine-like precision or the organic energy of musicians locked in a room together, playing music of inhuman complexity as if their lives depended on it.\n\nFor drummers studying the Meshuggah catalog, *The Violent Sleep of Reason* is essential: proof that the patterns are not just programmable or studio-correctable, but genuinely, humanly performable — live, simultaneously, without a safety net."
    },
    "relatedAlbums": [
      "obzen-drum-setup",
      "catch-thirtythree-drum-setup",
  ...
  "immutable-drum-setup": {
    ...
    "drumKit": {
      "title": "The SQ2 Heavy Beech, Fully Settled In",
      "brand": "Sonor",
      "model": "Sonor SQ2 Heavy Beech",
      "finish": "Custom Matte Black",
      "config": {
      ...
      "description": "For *Immutable*, Tomas Haake used the same Sonor SQ2 Heavy Beech kit that had carried him through *The Violent Sleep of Reason* — no shell change accompanied this album. The Heavy Beech variant's thicker beech construction delivers more attack and volume than standard configurations, essential for cutting through Meshuggah's downtuned guitars.\n\nHaake achieves his double-bass speed with the single 24\" x 18\" bass drum driven by two completely separate single pedals rather than a double pedal — the independence lets each foot play different subdivisions, which is not optional for Meshuggah's polyrhythmic bass drum work where individual notes must remain perceptibly discrete.\n\nThe configuration mirrors the setup Haake used on *The Violent Sleep of Reason*, demonstrating continuity in his approach through this album cycle. The compact tom arrangement and Heavy Beech shells remained tuned for maximum punch with controlled sustain — each kick note needs to speak clearly in a dense wall of low-tuned guitar and bass frequencies.\n\nThe COVID pandemic delay worked in the kit's favor. Haake had additional time to road-test and settle further into this established configuration during the extended gap between albums, arriving in the studio with a fully dialed-in rig rather than one still being adjusted mid-cycle.",
      "notes": [
        "Same Sonor SQ2 Heavy Beech platform as the VSÖR era — refined, not replaced",
        "Single 24\" bass drum — uses two separate single pedals",
        "Heavy Beech variant for increased attack and projection",
        "Configuration tuned for articulation over sustain",
        "Extended COVID delay allowed further settling-in of the established configuration"
      ],
      "estimatedValue": "$8,000-15,000 (SQ2 Heavy Beech custom configuration)"
    },
    "snare": {
      "title": "The Signature Sound, Carried Forward",
      "brand": "Sonor",
      "model": "Sonor Tomas Haake Signature Snare",
      "size": "14\" x 6.5\"",
      "shell": "Maple with unique bearing edges",
      "description": "The Sonor Tomas Haake Signature snare on *Immutable* continues Haake's established preference for a focused, cutting sound that projects through Meshuggah's dense guitar frequencies. At 14x6.5 inches, it offers a balanced response — enough depth for body, without sacrificing the attack response Haake requires for precisely articulated snare hits.\n\nThe signature model's maple shell and specific bearing-edge design give the attack and projection needed for metal, engineered for resonance and sensitivity. Every snare hit occupies a precise rhythmic position within Meshuggah's complex polyrhythmic architecture, and immediacy of response is essential to keeping that placement clear.\n\nHaake tunes the snare in the medium range, prioritizing clarity and consistency over extreme tension — the same approach he's maintained across album cycles. In Meshuggah's music, the snare is often the most reliable rhythmic reference point — the \"clock\" that grounds the listener while everything else seems to dissolve time.",
      "tuningSetting": "Medium tension for clarity and consistency",
      "heads": "Remo Emperor Coated (batter), Remo Ambassador Snare Side (resonant)",
      "estimatedValue": "$500-700 (signature model)"
    },
    "cymbals": {
      "title": "Sabian Precision, Fully Dialed In",
      "brand": "Sabian",
      "series": "Sabian HHX / AAX Series",
      "setup": [
        {
      ...
      "description": "Tomas Haake's cymbal setup for *Immutable* is the same Sabian HHX/AAX blend that anchored *The Violent Sleep of Reason* — no cymbal change accompanied this album cycle. The AAX series provides the brightness and quick response Haake requires for accents; the HHX series contributes darker, more complex overtones that enrich the sonic texture.\n\nThe 14\" HHX Compression Hi-Hats — a Tomas Haake signature design — remain central to his pattern work. Meshuggah's groove frequently lives in the hi-hat layer — the consistent pulse against which guitars and kicks create polyrhythmic tension. The Compression Hi-Hats' quick, tight articulation ensures that pulse remains audible even in the most densely arranged passages.\n\nThe HHX Evolution 19\" crash's darker character offers a different kind of accent from the brighter AAX X-Plosion — one that blooms rather than snaps. This contrast between bright AAX crashes (immediate, sharp) and the HHX Evolution (slower, complex) gives Haake more expressive range within the same musical context.\n\nThe HHX 18\" Chinese continues Meshuggah's preference for trashy, definitive section markers. In music with extended rhythmic cycles, the China cut through precisely delineates structural moments — when Meshuggah's polyrhythm finally \"resolves,\" the China is often the signal.",
      "estimatedValue": "$2,500-3,500 total (HHX/AAX combination setup)"
    },
    "hardware": {
      "title": "Two Single Pedals, Still the Foundation",
      "items": [
        {
          "type": "Bass Drum Pedals",
          "brand": "Tama",
          "model": "Tama Speed Cobra Single Pedals (TWO separate pedals)",
          "notes": "The defining feature of Haake's setup — two independent pedals, NOT a double pedal",
          "description": "Haake continues using two separate Tama Speed Cobra single pedals rather than a double pedal, unchanged from the VSÖR era. This allows each foot to operate with complete independence — essential for polyrhythmic patterns where the feet might play different subdivisions or even different rhythms entirely. The Speed Cobra's smooth, fast action supports his demanding technique."
        },
        {
          "type": "Hi-Hat Stand",
          "brand": "Sonor",
    ...
    "trackAnalysis": [
      {
        ...
        "highlights": [
          ...
          "Two-single-pedal independence fully audible in kick articulation",
      ...
      },
      {
        ...
        "highlights": [
          ...
          "HHX Evolution crash adds bloom to structural accent points"
        ],
        "gearNotes": "The HHX Evolution 19\" crash's bloom contrasts with the brighter AAX X-Plosion. The Sonor signature snare provides the sharp pulse-marking the track requires."
      },
      {
        ...
        "highlights": [
          "High-tempo showcase for the two-single-pedal approach",
        ...
        "gearNotes": "The Sonor SQ2 Heavy Beech kit's punch is most evident here — the bass drum stays articulate at higher BPM. Heavy Beech shell attack ensures note separation."
      }
    ],
    "faq": [
      {
        "question": "What does Tomas Haake play on Immutable?",
        "answer": "On Meshuggah's Immutable (2022), Tomas Haake played his Sonor SQ2 Heavy Beech kit in his established configuration — a single 24x18 inch bass drum played with two separate single pedals, 10x8, 12x9, and 14x12 inch rack toms, and 16x16 and 18x18 inch floor toms. His snare was the Sonor Tomas Haake Signature at 14x6.5 inches. The Heavy Beech shells deliver the hard, articulate attack essential for Meshuggah's downtuned, polyrhythmic music. This is the same platform he used on The Violent Sleep of Reason (2016) — the COVID-enforced production delay gave him more time to settle into it, not a reason to change it."
      },
      {
        "question": "What cymbals did Meshuggah use on Immutable?",
        "answer": "Tomas Haake used his established Sabian HHX/AAX setup on Immutable: the signature 14 inch HHX Compression Hi-Hats, an 18 inch AAX X-Plosion crash, a 19 inch HHX Evolution crash, a 21 inch HHX Raw Bell Dry Ride, an 18 inch HHX Chinese, and a 10 inch AAX splash. The HHX series provides darker, more complex overtones while the AAX series contributes brightness and quick response — the same combination Haake has used since the Koloss/VSÖR era, with no cymbal brand change for this album."
      },
      {
        "question": "How does Immutable differ from obZen gear-wise?",
        "answer": "Immutable (2022) and obZen (2008) represent fourteen years of gear evolution for Tomas Haake, though most of that evolution had already happened by the Koloss era (2012). On obZen, Haake played Sonor Designer Series maple/beech shells with Sabian AAX/AA cymbals and two independent Sonor Perfect Balance single pedals. By Immutable, the kit was Sonor SQ2 Heavy Beech (thicker shells, more attack), cymbals had shifted to the Sabian HHX/AAX combination including his signature Compression Hi-Hats, and the pedals had moved to two independent Tama Speed Cobra single pedals — still never a double pedal. The Porter & Davies BC2 throne and Remo head selection remain consistent across both albums — anchors in an evolved but still Sonor/Sabian setup."
      },
      {
        "question": "Did Tomas Haake change his pedal setup for Immutable?",
        "answer": "No — Immutable did not bring a pedal change. Haake used two independent Tama Speed Cobra single pedals, the same setup he had used since the Koloss/VSÖR era. He has never used a double pedal at any point in his career, prioritizing absolute foot independence between two completely separate pedals. The COVID production delay gave him additional time to settle further into this established setup rather than adapt to something new."
      },
      {
        "question": "What album is Immutable on and when was it released?",
        "answer": "Immutable is Meshuggah's tenth studio album, released on April 1, 2022 on Atomic Fire Records — their first album on the label after decades with Nuclear Blast. The album was originally planned for release around 2020 but was delayed by the COVID-19 pandemic, which inadvertently gave Tomas Haake additional time to settle further into his existing drum setup. The album earned a Grammy nomination for Best Metal Performance for the track \"The Abysmal Eye\" at the 2023 Grammy Awards."
      }
    ],
    "conclusion": {
      "title": "The Present-Day Blueprint: Haake's Most Settled Modern Setup",
      "content": "*Immutable* closes the Meshuggah studio arc as the definitive reference point for Tomas Haake's current drum configuration. From the Sonor Designer Series that powered obZen's genre-defining polyrhythms, through the Sonor SQ2 platform he transitioned to during the Koloss era and carried through the live-in-studio *Violent Sleep of Reason*, to the same SQ2 Heavy Beech kit that anchors *Immutable* — the gear evolution had already settled well before this album, not because of it.\n\nThe COVID delay, frustrating as it was, produced an unexpected dividend: Haake arrived at Sweetspot Studios with the most thoroughly prepared and settled drum rig of any album in the band's catalog. The Sonor SQ2 / Sabian HHX-AAX / Tama Speed Cobra platform was fully dialed in. The signature snare tuning was established. Everything was ready.\n\nFor drummers studying the Meshuggah catalog, *Immutable* is the essential final chapter — the present-day answer to \"what does Tomas Haake actually play?\" It's also proof that after more than three decades with Meshuggah, stability itself can be a form of mastery: the same Sonor SQ2 Heavy Beech kit, Sabian HHX/AAX cymbals, and two independent Tama Speed Cobra single pedals, refined rather than replaced, all in service of the same foundational principle that has defined his playing since \"Bleed.\"\n\nGroove is everything. Complexity serves the song. The polyrhythms are not math exercises — they are music.\n\nTomas Haake on *Immutable*: the Atomic Clock, still running."
    },
    "relatedAlbums": [
      "obzen-drum-setup",
      "violent-sleep-of-reason-drum-setup"
