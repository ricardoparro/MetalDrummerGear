...
export const articles = {
  "periphery-drum-setup": {
    ...
    "drumKit": {
      ...
      "estimatedValue": "$4,000–7,500 (SJC Custom shell pack, 2010 configuration)"
    },
    "cymbals": {
  ...
  "periphery-ii-drum-setup": {
    ...
    "drumKit": {
      ...
      "estimatedValue": "$4,000–7,500 (SJC Custom shell pack, 2012 touring configuration)"
    },
    "cymbals": {
  ...
  "travis-orbin-drum-setup": {
    ...
    "intro": {
      ...
      "keyPoints": [
        ...
        "Cited influence on Matt Halpern and the entire djent drumming generation"
      ]
    },
    "drumKit": {
    ...
    "gearTimeline": [
      {
        "era": "Periphery Formation and Debut",
        "years": "2009–2011",
        "albums": [
          "Periphery (2010)",
          "Icarus EP (2011)"
        ...
        "gear": {
          "drums": "SJC Custom (early touring and recording configuration)",
        ...
        "notes": "Periphery's debut album established djent as a genre. Orbin's drumming on tracks like 'Icarus Lives!' set the technical benchmark for the entire scene. The Roland SPD-SX electronic integration gave the album its distinctive hybrid drum texture."
      },
      {
