...
export const articles = {
  ...
  "great-southern-trendkill-drum-setup": {
    ...
    "description": "Complete breakdown of Vinnie Paul's drum gear on Pantera's The Great Southern Trendkill — the Pearl Masters Custom kit, Sabian HH cymbals, and Vic Firth signature sticks behind the 1996 #4 Billboard 200 debut tracked amid the band tensions that sent Floods and Suicide Note Pt. II into the canon.",
    "seoKeywords": [
    ...
    "hardware": {
      ...
      "items": [
        ...
        },
        {
          "type": "Sticks",
          "brand": "Vic Firth",
          "model": "Vic Firth American Classic 5B (played backwards)",
          "notes": "Vic Firth was Vinnie's signature stick endorsement from the early 90s onward"
        }
      ],
      "heads": {
