...
export const bands = {
  ...
  megadeth: {
    ...
    metaDescription: "Explore Megadeth's drumming legacy from Nick Menza to Dirk Verbeuren.",
    summary: "Megadeth, formed in 1983 in Los Angeles by former Metallica guitarist Dave Mustaine, is one of thrash metal's 'Big Four' bands alongside Metallica, Slayer, and Anthrax. Nick Menza anchored the band's most celebrated era before Dirk Verbeuren took over on drums in 2016.",
    keywords: ["megadeth", "nick menza", "dirk verbeuren", "chris adler", "thrash metal", "drummer gear"],
    drummerHistory: [
      { drummer: "nick-menza", period: "1989-1998, 2004", notes: "Drummer" },
      { drummer: "chris-adler", period: "2015-2016", notes: "Session/touring drummer" },
      { drummer: "dirk-verbeuren", period: "2016-present", notes: "Current drummer" }
    ],
    relatedBands: ["metallica", "slayer", "testament"],
  ...
  testament: {
    ...
    metaDescription: "Explore Testament's drumming legacy from Jon Dette and Gene Hoglan to Paul Bostaph.",
    summary: "Testament formed in Berkeley, California in 1983 (originally as Legacy) and became one of the Bay Area thrash metal scene's most enduring acts. The drum chair has passed through several technical players including Jon Dette and Gene Hoglan, with Paul Bostaph rejoining the band in 2024.",
    keywords: ["testament", "paul bostaph", "gene hoglan", "jon dette", "thrash metal", "drummer gear"],
    drummerHistory: [
      { drummer: "jon-dette", period: "1997-1999, 2001-2012", notes: "Drummer" },
      { drummer: "gene-hoglan", period: "2007-present", notes: "Drummer" },
      { drummer: "paul-bostaph", period: "1999-2001, 2024-present", notes: "Drummer" }
    ],
    relatedBands: ["metallica", "slayer", "megadeth"],
  ...
  "lamb-of-god": {
    ...
    metaDescription: "Explore Lamb of God's drumming legacy from Chris Adler to Art Cruz.",
    summary: "Lamb of God formed in Richmond, Virginia in 1994 (originally as Burn the Priest) and became one of groove metal's defining acts of the 2000s. Co-founder Chris Adler anchored the band's rhythm section for 25 years before Art Cruz took over on drums in 2019.",
    keywords: ["lamb of god", "chris adler", "art cruz", "groove metal", "metalcore", "drummer gear"],
    drummerHistory: [
      { drummer: "chris-adler", period: "1994-2019", notes: "Drummer, co-founder" },
      { drummer: "art-cruz", period: "2019-present", notes: "Drummer" }
    ],
    relatedBands: ["pantera", "slipknot", "megadeth"],
  ...
  opeth: {
    ...
    metaDescription: "Explore Opeth's drumming legacy from Martin Lopez to Martin Axenrot.",
    summary: "Opeth formed in Stockholm, Sweden in 1990 and pioneered a blend of death metal and progressive rock across their genre-defying discography. Martin Lopez held the drum seat through the band's early landmark albums before Martin Axenrot took over in 2006.",
    keywords: ["opeth", "martin axenrot", "martin lopez", "progressive metal", "swedish metal", "drummer gear"],
    drummerHistory: [
      { drummer: "martin-lopez", period: "1997-2006", notes: "Drummer" },
      { drummer: "martin-axenrot", period: "2006-present", notes: "Drummer" }
    ],
    relatedBands: ["tool", "meshuggah"],
  ...
  periphery: {
    ...
    metaDescription: "Explore Periphery's drumming legacy from Travis Orbin to Matt Halpern.",
    summary: "Periphery formed in the Washington, D.C. area in 2005 and became a leading act in the progressive metalcore and djent scenes. Travis Orbin was among the band's founding drummers before Matt Halpern took over the kit, where he has remained since 2009.",
    keywords: ["periphery", "travis orbin", "matt halpern", "djent", "progressive metal", "drummer gear"],
    drummerHistory: [
      { drummer: "travis-orbin", period: "2009-2012", notes: "Founding drummer" },
      { drummer: "matt-halpern", period: "2009-present", notes: "Drummer" }
    ],
  ...
  "morbid-angel": {
    ...
    metaDescription: "Explore Morbid Angel's drumming legacy from Pete Sandoval to Tim Yeung.",
    summary: "Morbid Angel formed in Tampa, Florida in 1983 and became one of death metal's most influential and technically demanding bands. Pete Sandoval anchored the band's drumming for most of its history, with Tim Yeung filling in and later taking over the kit during the 2000s and 2010s.",
    keywords: ["morbid angel", "pete sandoval", "tim yeung", "death metal", "drummer gear"],
    drummerHistory: [
      { drummer: "pete-sandoval", period: "1988-2013", notes: "Drummer" },
      { drummer: "tim-yeung", period: "2004-2015", notes: "Drummer" }
    ],
    relatedBands: ["cannibal-corpse", "behemoth", "vader"],
  ...
  "animals-as-leaders": {
    ...
    metaDescription: "Explore Animals as Leaders' drumming legacy from Navene Koperweis to Matt Garstka.",
    summary: "Animals as Leaders formed in Washington, D.C. in 2007 as an instrumental progressive metal project built around intricate djent rhythms. Navene Koperweis was the band's original drummer before Matt Garstka took over in 2012.",
    keywords: ["animals as leaders", "matt garstka", "navene koperweis", "djent", "instrumental metal", "drummer gear"],
    drummerHistory: [
      { drummer: "navene-koperweis", period: "2010-2012", notes: "Drummer" },
      { drummer: "matt-garstka", period: "2012-present", notes: "Drummer" }
    ],
  ...
  mastodon: {
    ...
    status: "active",
    metaTitle: "Mastodon - Drummer History & Gear | MetalForge",
    metaDescription: "Explore Mastodon's drumming legacy with founding member Brann Dailor.",
    summary: "Mastodon formed in Atlanta, Georgia in 2000 and became one of progressive and sludge metal's most acclaimed bands. Founding drummer and co-vocalist Brann Dailor has anchored the band's complex, shifting rhythms since its inception.",
    keywords: ["mastodon", "brann dailor", "sludge metal", "progressive metal", "drummer gear"],
    drummerHistory: [
      { drummer: "brann-dailor", period: "2000-present", notes: "Drummer, vocalist, founding member" }
    ],
    relatedBands: ["tool", "gojira"],
  ...
  "cavalera-conspiracy": {
    ...
    metaDescription: "Explore Cavalera Conspiracy's drumming legacy with founding member Igor Cavalera.",
    summary: "Cavalera Conspiracy formed in 2007 as a reunion project between brothers Max and Igor Cavalera, who had co-founded Sepultura together decades earlier. Igor Cavalera has drummed for the band since its founding.",
    keywords: ["cavalera conspiracy", "igor cavalera", "max cavalera", "thrash metal", "drummer gear"],
    drummerHistory: [
      { drummer: "igor-cavalera", period: "2007-present", notes: "Drummer, co-founder" }
    ],
  ...
  cynic: {
    ...
    metaDescription: "Explore Cynic's drumming legacy with founding member Sean Reinert.",
    summary: "Cynic formed in Miami, Florida in 1987 and helped pioneer the fusion of technical death metal with progressive and jazz influences. Co-founder Sean Reinert drummed for the band across its original run and its mid-2000s reunion until 2017.",
    keywords: ["cynic", "sean reinert", "technical death metal", "jazz fusion metal", "drummer gear"],
    drummerHistory: [
      { drummer: "sean-reinert", period: "1987-1994, 2006-2017", notes: "Drummer, co-founder" }
    ],
    relatedBands: ["death", "opeth"],
  ...
  damageplan: {
    ...
    metaDescription: "Explore Damageplan's drumming legacy with founding member Vinnie Paul.",
    summary: "Damageplan formed in 2003 in Arlington, Texas, founded by brothers Vinnie Paul and 'Dimebag' Darrell Abbott following the breakup of Pantera. The band disbanded in 2004 after Dimebag Darrell was killed on stage during a performance.",
    keywords: ["damageplan", "vinnie paul", "groove metal", "dimebag darrell", "drummer gear"],
    drummerHistory: [
      { drummer: "vinnie-paul", period: "2003-2004", notes: "Drummer, co-founder" }
    ],
  ...
  hellyeah: {
    ...
    metaDescription: "Explore Hellyeah's drumming legacy with founding member Vinnie Paul.",
    summary: "Hellyeah formed in Arlington, Texas in 2006 as a groove metal supergroup featuring former Pantera and Damageplan drummer Vinnie Paul. Paul remained the band's drummer until his death in 2018, and the band has been on hiatus since 2021.",
    keywords: ["hellyeah", "vinnie paul", "groove metal", "drummer gear"],
    drummerHistory: [
      { drummer: "vinnie-paul", period: "2006-2018", notes: "Drummer, co-founder" }
    ],
  ...
  murderdolls: {
    ...
    metaDescription: "Explore Murderdolls' history with Slipknot drummer Joey Jordison on guitar.",
    summary: "Murderdolls formed in 2002 in Hollywood, California as a horror-punk side project fronted by Wednesday 13. Slipknot drummer Joey Jordison co-founded the band and played guitar rather than drums, contributing to the band until 2011; Wednesday 13 confirmed the split in 2013.",
    keywords: ["murderdolls", "joey jordison", "horror punk", "glam metal", "drummer gear"],
    drummerHistory: [
      { drummer: "joey-jordison", period: "2002-2011", notes: "Guitar, co-founder (his primary instrument here was guitar, not drums)" }
    ],
  ...
  "sons-of-apollo": {
    ...
    status: "hiatus",
    metaTitle: "Sons of Apollo - Drummer History & Gear | MetalForge",
    metaDescription: "Explore Sons of Apollo's drumming legacy with founding member Mike Portnoy.",
    summary: "Sons of Apollo formed in 2017 as a progressive metal supergroup featuring former Dream Theater drummer Mike Portnoy. The band released two studio albums before going on hiatus in the early 2020s.",
    keywords: ["sons of apollo", "mike portnoy", "progressive metal", "supergroup", "drummer gear"],
    drummerHistory: [
      { drummer: "mike-portnoy", period: "2017-present", notes: "Drummer, co-founder" }
    ],
  ...
  vader: {
    ...
    metaDescription: "Explore Vader's drumming legacy with Daray.",
    summary: "Vader formed in Olsztyn, Poland in 1983 and became one of the most influential death metal bands from outside North America. Daray drummed for the band from 2006 to 2016.",
    keywords: ["vader", "daray", "polish death metal", "death metal", "drummer gear"],
    drummerHistory: [
      { drummer: "daray", period: "2006-2016", notes: "Drummer" }
    ],
    relatedBands: ["morbid-angel", "behemoth"],
  ...
  volto: {
    ...
    status: "active",
    metaTitle: "Volto! - Drummer History & Gear | MetalForge",
    metaDescription: "Explore Volto!'s drumming legacy with Tool drummer Danny Carey.",
    summary: "Volto! is a Los Angeles progressive rock and jazz-fusion project first formed in the early 2000s by Tool drummer Danny Carey. Carey has remained the band's drummer throughout its history alongside a rotating cast of collaborators.",
    keywords: ["volto", "danny carey", "progressive rock", "instrumental", "drummer gear"],
    drummerHistory: [
      { drummer: "danny-carey", period: "2000-present", notes: "Drummer" }
    ],
    relatedBands: ["tool"],
