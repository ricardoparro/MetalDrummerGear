...
Vic Firth's signature roster includes some of metal's most recognizable drummers, and its American Classic line remains the most widely used stick across every metal subgenre — from George Kollias' blast-beat speed to Nicko McBrain's five-decade Iron Maiden career.`,
    history: {
      ...
      metalEra: "Vic Firth's American Classic 5A/5B is among the most widely used stick models across every metal subgenre — Vinnie Paul (Pantera) played the American Classic 5B, and George Kollias (Nile) is a longtime Vic Firth artist too. The brand's signature roster includes some of metal's biggest names as well, like Nicko McBrain (Iron Maiden) with the SNM. The American Classic Metal and Extreme (X5A/X5B) lines extend that lineup with purpose-built heavier, longer variants for hard-hitting players.",
    ...
    metaDescription:
      "Discover which metal drummers play Vic Firth drumsticks. From George Kollias to Nicko McBrain's SNM signature, explore Vic Firth setups used in metal.",
    ...
    faq: [
      {
        ...
        answer: "Metal drummers commonly use the American Classic 5A or 5B — Vinnie Paul played the 5B — or one of Vic Firth's signature models like Nicko McBrain's SNM."
      },
      {
