...
Vic Firth's signature roster includes some of metal's most recognizable drummers, and its American Classic line remains the most widely used stick across every metal subgenre — from George Kollias' blast-beat speed to Nicko McBrain's five-decade Iron Maiden career.`,
    history: {
      ...
      metalEra: "Vic Firth's American Classic 5A/5B is among the most widely used stick models across every metal subgenre, and the brand's signature roster includes some of metal's biggest names: Nicko McBrain (Iron Maiden) plays the SNM. The American Classic Metal and Extreme (X5A/X5B) lines extend that lineup with purpose-built heavier, longer variants for hard-hitting players.",
    ...
    metaDescription:
      "Discover which metal drummers play Vic Firth drumsticks. From Nicko McBrain's SNM signature model, explore Vic Firth setups used in metal.",
