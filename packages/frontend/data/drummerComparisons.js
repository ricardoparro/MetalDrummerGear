...
export const drummerComparisons = {
  ...
  // Issue #4162: SEO batch 2 — Jaska Raatikainen/Eloy Casagrande/Gavin Harrison cross-pairs
  'mario-duplantier-vs-gavin-harrison': {
    slug: 'mario-duplantier-vs-gavin-harrison',
    title: 'Mario Duplantier vs Gavin Harrison',
    metaTitle: 'Mario Duplantier vs Gavin Harrison — French Tribal Power vs British Polyrhythmic Precision | MetalForge',
    metaDescription: 'Gojira\'s Mario Duplantier vs Porcupine Tree/King Crimson\'s Gavin Harrison. Tribal progressive death metal power compared to restrained progressive rock polyrhythm mastery. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['mario-duplantier', 'gavin-harrison'],
    comparison: {
      style: 'Mario Duplantier co-founded Gojira with his brother Joe in Bayonne, France in 1996, building a tribal, ceremonial approach to progressive death metal that fuses dual-bass-drum power with atmospheric dynamics across landmark records including "From Mars to Sirius" (2005), "The Way of All Flesh" (2008), "Magma" (2016), and "Fortitude" (2021), and has since headlined Download Festival and performed at the 2024 Paris Olympics opening ceremony. Gavin Harrison joined progressive rock band Porcupine Tree in 2002 and added King Crimson\'s demanding three-drummer lineup in 2008, building a career on intricate polyrhythmic sophistication and restrained musicality across albums including "In Absentia" (2002), "Deadwing" (2005), and "Fear of a Blank Planet" (2007), while also drumming for The Pineapple Thief.',
      technique: 'Duplantier forgoes a double bass pedal entirely, playing dual 22" kick drums for a more organic, physically grounded feel that gives Gojira\'s tribal rhythms their ceremonial weight, layering explosive accents and stamina-driven endurance beneath the band\'s massive, slow-building compositions. Harrison weaves intricate polyrhythmic patterns through constantly shifting odd time signatures with economy and sophistication, prioritizing groove, ghost-note nuance, and musical feel over technical spectacle — an approach that has made him one of the most studied drummers in progressive rock.',
      gear: 'Mario Duplantier plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums, a Tama S.L.P. 14x6.5" G-Maple snare, and Zildjian cymbals including A Custom and K Sweet models, driven by his own Tama Mario Duplantier Signature sticks. Gavin Harrison plays a Sonor SQ2 Series kit with a matched Sonor snare and Zildjian K Custom Special Dry Series cymbals (14" Hi-Hats, 16" & 18" Crashes, 21" Special Dry Ride, 18" Trash China), paired with Vic Firth signature sticks.',
      influence: 'Duplantier is one of the most-searched metal drummers globally and has defined what modern progressive death metal drumming looks and sounds like, influencing a generation of tribal-leaning prog-death drummers who build compositions around dual-kick ceremony rather than double-pedal speed. Harrison is a multiple Modern Drummer Reader\'s Poll winner and is widely regarded as "the prog drummer\'s drummer," elevating Porcupine Tree, King Crimson, and The Pineapple Thief with a reputation for making impossible polyrhythms feel like conversation.',
    },
    verdict: 'Mario Duplantier and Gavin Harrison represent two entirely different schools of progressive drumming excellence. Duplantier channels physical, ceremonial power through Gojira\'s tribal death metal — his dual-kick setup and atmospheric dynamics turn environmental themes into percussive ritual. Harrison channels restrained, mathematical sophistication through Porcupine Tree and King Crimson\'s progressive rock — his polyrhythms reward the closest listening in the genre. Comparing them is comparing raw tribal force to refined polyrhythmic craftsmanship, two poles of what "progressive" can mean behind a drum kit.',
    faqs: [
      { q: 'What is the main stylistic difference between Mario Duplantier and Gavin Harrison?', a: 'Mario Duplantier brings tribal, ceremonial power to Gojira\'s progressive death metal, built around a dual-kick-drum setup rather than a double pedal. Gavin Harrison brings restrained, intricate polyrhythmic sophistication to Porcupine Tree and King Crimson\'s progressive rock, prioritizing groove and ghost-note nuance over raw power.' },
      { q: 'What gear do Mario Duplantier and Gavin Harrison use?', a: 'Mario Duplantier plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums and Zildjian A Custom & K Sweet cymbals, driven by his own Tama signature sticks. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals and Vic Firth signature sticks.' },
      { q: 'What bands are Mario Duplantier and Gavin Harrison known for?', a: 'Mario Duplantier co-founded and drums for French progressive death metal band Gojira, formed in 1996. Gavin Harrison is best known for Porcupine Tree (since 2002) and King Crimson (since 2008), and also drums for The Pineapple Thief.' },
      { q: 'Does Mario Duplantier use a double bass pedal?', a: 'No — Mario Duplantier plays two separate 22" bass drums rather than a double pedal, a deliberate choice that gives Gojira\'s tribal rhythms a more organic, physically grounded feel compared to drummers who rely on double-pedal speed.' },
    ],
  },
  ...
  'jaska-raatikainen-vs-gavin-harrison': {
    ...
    metaTitle: 'Jaska Raatikainen vs Gavin Harrison — Finnish Melodic Death Metal vs Progressive Rock Precision | MetalForge',
    metaDescription: 'Children of Bodom\'s Jaska Raatikainen vs Porcupine Tree/King Crimson\'s Gavin Harrison. Neoclassical melodic death metal drive compared to restrained progressive rock polyrhythm mastery. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['jaska-raatikainen', 'gavin-harrison'],
    comparison: {
      style: 'Jaska Raatikainen co-founded Children of Bodom in 1993 (performing as Inearthed until adopting the Children of Bodom name in 1997) alongside the late Alexi Laiho, and remained the band\'s sole drummer for its entire 26-year run — from the 1997 debut "Something Wild" through landmark records "Hatebreeder" (1999) and "Follow the Reaper" (2000) to the band\'s 2019 farewell album "Hexed" — anchoring neoclassical melodic death metal with speed that always served Laiho\'s guitar and Janne Wirman\'s keyboard interplay. Gavin Harrison joined progressive rock band Porcupine Tree in 2002 and added King Crimson\'s demanding three-drummer lineup in 2008, building a career on intricate polyrhythmic sophistication across albums including "In Absentia" (2002) and "Fear of a Blank Planet" (2007), while also drumming for The Pineapple Thief.',
      technique: 'Raatikainen balances death metal velocity with melodic awareness — rapid double bass volleys and blast beats locked tightly to Children of Bodom\'s neoclassical riffing, with fills composed to support rather than overwhelm the guitar and keyboard interplay around him. Harrison weaves intricate polyrhythmic patterns through constantly shifting odd time signatures with economy and restraint, prioritizing groove and musicality over the raw velocity that defines Raatikainen\'s extreme metal foundation.',
      gear: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom Series cymbals (14" A Custom Hi-Hats, 17" & 18" A Custom Crashes, 20" K Custom Ride), powered by a Pearl Eliminator double pedal and Vic Firth American Classic 5A sticks. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals (14" Hi-Hats, 16" & 18" Crashes, 21" Special Dry Ride, 18" Trash China), paired with Vic Firth signature sticks.',
      influence: 'Raatikainen helped build Finland\'s melodic death metal scene into a global commercial force — Children of Bodom sold over two million albums worldwide, and his playing on "Hatebreeder" and "Follow the Reaper" influenced a generation of melodic death and metalcore drummers. Harrison is a multiple Modern Drummer Reader\'s Poll winner regarded as "the prog drummer\'s drummer," elevating Porcupine Tree, King Crimson, and The Pineapple Thief with polyrhythmic sophistication that rewards the closest listening in progressive rock.',
    },
    verdict: 'Jaska Raatikainen and Gavin Harrison represent two entirely different corners of technical drumming excellence. Raatikainen built 26 years of neoclassical melodic death metal precision anchoring Children of Bodom\'s explosive, keyboard-driven assault. Harrison built decades of restrained polyrhythmic mastery across Porcupine Tree and King Crimson\'s progressive rock catalog. Comparing them is comparing extreme metal velocity to progressive rock\'s most refined technical vocabulary — both are considered the defining drummer of their respective genre\'s technical ceiling.',
    faqs: [
      { q: 'How do Jaska Raatikainen and Gavin Harrison differ stylistically?', a: 'Jaska Raatikainen anchored Children of Bodom\'s neoclassical melodic death metal with rapid blast beats and double bass volleys that supported Alexi Laiho\'s guitar and Janne Wirman\'s keyboard work. Gavin Harrison brings restrained polyrhythmic sophistication to Porcupine Tree and King Crimson\'s progressive rock, prioritizing groove and ghost-note nuance over extreme velocity.' },
      { q: 'What gear do Jaska Raatikainen and Gavin Harrison use?', a: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with Zildjian A Custom & K Custom cymbals, powered by a Pearl Eliminator double pedal. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals.' },
      { q: 'How long was Jaska Raatikainen in Children of Bodom?', a: 'Jaska Raatikainen co-founded Children of Bodom in 1993 (originally as Inearthed) and remained the band\'s sole drummer for its entire 26-year run, from the 1997 debut "Something Wild" through the band\'s 2019 farewell album "Hexed."' },
      { q: 'What bands are Jaska Raatikainen and Gavin Harrison known for?', a: 'Jaska Raatikainen was the co-founding drummer of Finnish melodic death metal band Children of Bodom from 1993 until its 2019 dissolution. Gavin Harrison is best known for Porcupine Tree (since 2002) and King Crimson (since 2008), and also drums for The Pineapple Thief.' },
    ],
  },
  ...
  'jaska-raatikainen-vs-john-otto': {
    ...
    metaTitle: 'Jaska Raatikainen vs John Otto — Finnish Melodic Death Metal vs Nu-Metal Groove | MetalForge',
    metaDescription: 'Children of Bodom\'s Jaska Raatikainen vs Limp Bizkit\'s John Otto. Neoclassical melodic death metal precision compared to hip-hop-infused nu-metal pocket. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['jaska-raatikainen', 'john-otto'],
    comparison: {
      style: 'Jaska Raatikainen co-founded Children of Bodom in 1993 (performing as Inearthed until 1997) alongside the late Alexi Laiho, and remained the band\'s sole drummer for its entire 26-year run, anchoring neoclassical melodic death metal across landmark records including "Hatebreeder" (1999) and "Follow the Reaper" (2000) through the band\'s 2019 farewell album "Hexed." John Otto co-founded Limp Bizkit in Jacksonville, Florida in 1994 and has remained the band\'s drummer ever since, building tight, hip-hop-influenced grooves and funk-inspired pocket playing that helped define the rap-metal sound of the late 1990s and early 2000s on albums including "Significant Other" (1999) and "Chocolate Starfish and the Hot Dog Flavored Water" (2000).',
      technique: 'Raatikainen balances death metal velocity with melodic awareness — rapid double bass volleys and blast beats that lock tightly with Children of Bodom\'s neoclassical riffing, with fills composed to support rather than overwhelm the guitar and keyboard interplay around him. Otto, who studied jazz at the Douglas Anderson School of the Arts, centers his playing on a deep sense of groove and pocket drawn from hip-hop and funk, favoring tight snare work and syncopated patterns over speed or blast-beat technicality, giving Limp Bizkit\'s rap-metal fusion its rhythmic backbone.',
      gear: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom Series cymbals (14" A Custom Hi-Hats, 17" & 18" A Custom Crashes, 20" K Custom Ride), powered by a Pearl Eliminator double pedal and Vic Firth American Classic 5A sticks. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual OCDP snares (a 14x6.5" 40-ply vented shell and a 10x6" 20-ply piccolo) and Zildjian A Custom cymbals (13" A Custom Mastersound Hi-Hats, 16" & 17" A Custom Projection Crashes, 20" A Custom EFX, 20" FX Oriental Crash of Doom), driven by Gibraltar G Class bass drum pedals.',
      influence: 'Raatikainen helped build Finland\'s melodic death metal scene into a global commercial force — Children of Bodom sold over two million albums worldwide, and his playing on "Hatebreeder" and "Follow the Reaper" influenced a generation of melodic death and metalcore drummers. Otto\'s hip-hop-infused groove playing showed nu-metal\'s deep rhythmic connection to funk and rap, and his work on Limp Bizkit\'s multi-platinum albums helped define the commercial peak of the nu-metal era.',
    },
    verdict: 'Jaska Raatikainen and John Otto represent opposite ends of what "essential drumming" can mean in heavy music. Raatikainen built 26 years of blast-beat-driven, neoclassical precision anchoring Children of Bodom\'s extremity. Otto built three decades of groove-first, hip-hop-informed pocket playing anchoring Limp Bizkit\'s commercial rap-metal breakthrough. Comparing them is comparing Finnish melodic death metal\'s technical extremity to nu-metal\'s funk-and-groove foundation — both are foundational voices of their respective 1990s metal movements.',
    faqs: [
      { q: 'How do Jaska Raatikainen and John Otto differ stylistically?', a: 'Jaska Raatikainen anchored Children of Bodom\'s neoclassical melodic death metal with rapid blast beats and double bass volleys. John Otto anchors Limp Bizkit with tight, hip-hop-influenced grooves and funk-inspired pocket playing rather than extreme speed or blast beats.' },
      { q: 'What gear do Jaska Raatikainen and John Otto use?', a: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with Zildjian A Custom & K Custom cymbals, powered by a Pearl Eliminator double pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with Zildjian A Custom cymbals, driven by Gibraltar G Class bass drum pedals.' },
      { q: 'What bands are Jaska Raatikainen and John Otto known for?', a: 'Jaska Raatikainen was the co-founding drummer of Finnish melodic death metal band Children of Bodom from 1993 until its 2019 dissolution. John Otto co-founded and has drummed for Limp Bizkit since the band formed in Jacksonville, Florida in 1994.' },
      { q: 'Did John Otto study music formally?', a: 'Yes — John Otto studied jazz at the Douglas Anderson School of the Arts in Jacksonville, Florida, a background that shaped the syncopated, hip-hop and funk-influenced pocket playing he brought to Limp Bizkit\'s rap-metal sound.' },
    ],
  },
  ...
  'eloy-casagrande-vs-ben-koller': {
    ...
    metaDescription: 'Slipknot/Sepultura\'s Eloy Casagrande vs Converge\'s Ben Koller. Explosive dual-bass technical precision compared to raw, unpredictable mathcore intensity. Gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['eloy-casagrande', 'ben-koller'],
    comparison: {
      style: 'Eloy Casagrande spent 13 years driving Sepultura\'s thrash-death fusion, joining in 2011 and appearing on albums including "Machine Messiah" (2017) and "Quadra" (2020), before joining Slipknot in 2024, where his explosive speed and dynamic control earned him Modern Drummer magazine\'s No. 1 metal drummer honor in their 2024 Readers\' Poll. Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "You Fail Me" (2004), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures, while also co-founding Mutoid Man and joining the supergroup Killer Be Killed.',
      technique: 'Casagrande combines dual-bass-drum power with controlled musicality, balancing explosive double bass runs with dynamic sensitivity across both Sepultura\'s and Slipknot\'s demanding live sets — his parts are technically dense but tightly composed. Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, which is exactly what gives Converge\'s mathcore its dangerous, live-wire energy.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x5.5" snare and an extensive Paiste cymbal array including Masters Dark and 2002 Series models, driven by a Tama Iron Cobra double pedal. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks — both drummers share a Tama Starclassic and Tama Iron Cobra foundation despite their opposite genres.',
      influence: 'Casagrande\'s technical prowess and dual stints in two of metal\'s biggest bands have made him one of the most decorated modern metal drummers, voted the genre\'s best by Modern Drummer readers in 2024. Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics.',
    },
    verdict: 'Eloy Casagrande and Ben Koller both build explosive intensity from a shared Tama foundation, yet arrive there through opposite philosophies. Casagrande channels composed, dual-bass power into Sepultura and Slipknot\'s heaviest material, technically dense but tightly controlled. Koller channels raw, unpredictable chaos into Converge\'s constantly shifting mathcore structures, thriving on the feeling of near-collapse. The debate is controlled explosive power versus deliberate, dangerous unpredictability — both are among modern extreme music\'s most respected technicians.',
    faqs: [
      { q: 'How do Eloy Casagrande and Ben Koller compare as drummers?', a: 'Eloy Casagrande brings composed, dual-bass-drum power to Sepultura and Slipknot\'s heaviest material, technically dense but tightly controlled. Ben Koller brings raw, unpredictable intensity to Converge\'s mathcore, favoring gut-level feel over rehearsed precision.' },
      { q: 'What gear do Eloy Casagrande and Ben Koller use?', a: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass snare and a Paiste cymbal array, driven by a Tama Iron Cobra double pedal. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal.' },
  ...
  'eloy-casagrande-vs-hellhammer': {
    ...
    metaDescription: 'Slipknot/Sepultura\'s Eloy Casagrande vs Mayhem\'s Hellhammer. Explosive dual-bass technical precision compared to cold, relentless second-wave black metal blast beats. Gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['eloy-casagrande', 'hellhammer'],
    comparison: {
      style: 'Eloy Casagrande spent 13 years driving Sepultura\'s thrash-death fusion, joining in 2011 and appearing on albums including "Machine Messiah" (2017) and "Quadra" (2020), before joining Slipknot in 2024, where his explosive speed and dynamic control earned him Modern Drummer magazine\'s No. 1 metal drummer honor in their 2024 Readers\' Poll. Hellhammer (born Jan Axel Blomberg, 1969) joined Mayhem in 1988 as a teenager, replacing founding drummer Manheim, and delivered the genre-defining blast beats on "De Mysteriis Dom Sathanas" (1994) — the recording against which every subsequent black metal drum performance is measured — while running a parallel career with Dimmu Borgir since 1999 and co-founding Arcturus.',
      technique: 'Casagrande combines dual-bass-drum power with controlled musicality, balancing explosive double bass runs with dynamic sensitivity across both Sepultura\'s and Slipknot\'s demanding live sets. Hellhammer\'s blast beats are built on cold, relentless one-foot precision, and he famously plays barefoot for the direct tactile feedback he says is essential to holding tempo accuracy at extreme speeds — a machine-like consistency that is the polar opposite of Casagrande\'s dynamically varied, dual-kick approach.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x5.5" snare and an extensive Paiste cymbal array including Masters Dark and 2002 Series models, driven by a Tama Iron Cobra double pedal. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals (14" A Custom Hi-Hats, 17" & 19" A Custom Crashes, 20" Z Custom Dark Ride, 18" A China Boy), driven by a Pearl Demon Drive double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Casagrande\'s technical prowess and dual stints in two of metal\'s biggest bands have made him one of the most decorated modern metal drummers, voted the genre\'s best by Modern Drummer readers in 2024. Hellhammer defined the sound and speed vocabulary of second-wave black metal, and his three-decade-plus dual career with Mayhem and Dimmu Borgir has made him the genre\'s most in-demand extreme drummer for both raw and symphonic contexts.',
    },
    verdict: 'Eloy Casagrande and Hellhammer both built reputations on explosive extreme-metal speed, but from opposite philosophies. Casagrande channels composed, dual-bass power into Sepultura and Slipknot\'s heaviest material, technically dense but dynamically varied. Hellhammer built his reputation on cold, icy blast-beat precision that turned speed itself into black metal\'s defining texture on "De Mysteriis Dom Sathanas." The debate is dynamic, modern technical power versus mechanical, atmosphere-first speed — both are foundational figures in extreme metal\'s most demanding corners.',
    faqs: [
      { q: 'How do Eloy Casagrande and Hellhammer compare as drummers?', a: 'Eloy Casagrande brings composed, dual-bass-drum power to Sepultura and Slipknot\'s heaviest material. Hellhammer built his reputation on cold, relentless one-foot blast beat precision that defined Mayhem\'s second-wave black metal sound.' },
      { q: 'What gear do Eloy Casagrande and Hellhammer use?', a: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass snare and a Paiste cymbal array, driven by a Tama Iron Cobra double pedal. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals, driven by a Pearl Demon Drive double pedal.' },
      { q: 'What bands are Eloy Casagrande and Hellhammer known for?', a: 'Eloy Casagrande drummed for Sepultura from 2011 to 2024 before joining Slipknot. Hellhammer has drummed for Mayhem since 1988 and has run a parallel career with Dimmu Borgir since 1999, along with co-founding Arcturus.' },
      { q: 'Does Hellhammer play barefoot?', a: 'Yes — Hellhammer famously plays barefoot, saying the direct tactile feedback is essential to holding his icy, relentless blast-beat tempo accuracy at extreme speeds with Mayhem and Dimmu Borgir.' },
    ],
  },
};
