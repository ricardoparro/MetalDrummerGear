...
export const drummerComparisons = {
  ...
  // Issue #3147: SEO batch 39 — NWOAHM dual-role drummers (metalcore/thrash crossover)
  'alex-bent-vs-jason-bittner': {
    slug: 'alex-bent-vs-jason-bittner',
    title: 'Alex Bent vs Jason Bittner',
    metaTitle: 'Alex Bent vs Jason Bittner — NWOAHM Dual-Role Drumming Compared | MetalForge',
    metaDescription: 'Trivium\'s Alex Bent vs Shadows Fall/Overkill\'s Jason Bittner: two drummers who bridge metalcore and thrash simultaneously. Technical double-kick stamina vs groove-precision translation compared.',
    category: 'other',
    drummers: ['alex-bent', 'jason-bittner'],
    comparison: {
      style: 'Jason Bittner has spent over two decades bridging thrash metal and the New Wave of American Heavy Metal, joining Shadows Fall in 1999 and driving the band\'s genre-defining metalcore output through "The Art of Balance" (2002) and the Grammy-nominated "The War Within" (2004), before joining thrash legends Overkill in 2017 and recording "The Wings of War" (2019) and "Scorched" (2023); he also co-founded supergroup Category 7 in 2024, maintaining dual-band duties across thrash and NWOAHM simultaneously. Alex Bent built his reputation in the technical death metal underground with Brain Drill, Arkaik, and Battlecross before joining Trivium in 2017, bringing that extreme-metal precision to the modern metalcore giants across "The Sin and the Sentence" (2017), "What the Dead Men Say" (2020), "In the Court of the Dragon" (2021), and "Struck Dead" (2025) until his October 2025 departure.',
      technique: 'Bittner\'s Berklee College of Music training shows in his technical precision and sustained double-kick stamina, honed across Shadows Fall\'s layered metalcore arrangements and sharpened further by Overkill\'s dense thrash riffing — a dual vocabulary few drummers maintain across two active, stylistically distinct bands at once. Bent\'s technical death metal roots gave him blast-beat velocity and an intricate fill vocabulary, but Trivium\'s modern metalcore songwriting required him to fold that extremity into groove-focused, song-serving precision rather than raw technical display.',
      gear: 'Jason Bittner plays a Mapex Saturn V kit with a Mapex Black Panther 14x6.5" Brass snare and Zildjian K & A Custom Series cymbals (14" K Hi-Hats, 18" & 19" A Custom Crashes, 21" K Custom Ride, 18" K China), driven by a Mapex Falcon double pedal and Mapex T865 throne, with Promark Jason Bittner Signature 5BX sticks and Evans heads. Alex Bent plays a Pearl Reference Pure Series kit with a Pearl Reference 14x5" Brass snare and Zildjian cymbals (14" K Custom Hybrid Hi-Hats, 18" & 19" K Custom Hybrid Crashes, 21" K Custom Hybrid Ride, 18" A Custom China), powered by an Axis A Longboard double pedal and Pearl D-3000 throne, with Vic Firth American Classic 5B sticks and Remo heads.',
      influence: 'Bittner earned multiple Modern Drummer "Best Metal Drummer" honors and has filled in live for Anthrax\'s Charlie Benante, cementing his reputation as one of thrash and NWOAHM\'s most versatile working drummers across two simultaneously active bands. Bent proved that technical death metal underground chops could translate directly into mainstream modern metalcore success, elevating Trivium\'s rhythmic complexity across four albums and eight years before moving on in 2025.',
    },
    verdict: 'Jason Bittner and Alex Bent represent two paths through the NWOAHM and modern metalcore landscape. Bittner built a 25-plus-year career maintaining technical double-kick versatility across metalcore and thrash simultaneously, first with Shadows Fall and Overkill and now alongside Category 7. Bent brought technical death metal underground precision to Trivium\'s more radio-accessible modern metalcore songwriting for eight years before his 2025 departure. Asking "who is the better NWOAHM drummer?" comes down to whether you value Bittner\'s sustained dual-genre stamina or Bent\'s extremity-to-accessibility translation.',
    faqs: [
      { q: 'Who is more technical: Jason Bittner or Alex Bent?', a: 'Both are considered highly technical NWOAHM-era drummers. Jason Bittner (Shadows Fall, Overkill) brings Berklee-trained precision and sustained double-kick stamina across two simultaneously active bands spanning metalcore and thrash. Alex Bent (Trivium) brings technical death metal underground velocity from Brain Drill and Arkaik, folded into Trivium\'s more song-focused modern metalcore. They are technical in different dimensions — dual-genre stamina versus extremity-to-accessibility translation.' },
      { q: 'What bands are Jason Bittner and Alex Bent known for?', a: 'Jason Bittner has drummed for Shadows Fall (1999-2015), Overkill (2017-present), and Category 7 (2024-present), maintaining dual-band duties across thrash and metalcore. Alex Bent drummed for Trivium from 2017 to 2025, having previously played technical death metal with Brain Drill, Arkaik, and Battlecross.' },
      { q: 'What gear do Jason Bittner and Alex Bent use?', a: 'Jason Bittner plays a Mapex Saturn V kit with a Mapex Black Panther 14x6.5" Brass snare and Zildjian K & A Custom Series cymbals, driven by a Mapex Falcon double pedal. Alex Bent plays a Pearl Reference Pure Series kit with a Pearl Reference 14x5" Brass snare and Zildjian cymbals, powered by an Axis A Longboard double pedal.' },
      { q: 'Is Jason Bittner still playing in two bands at once?', a: 'Yes — Jason Bittner has been Overkill\'s drummer since 2017 and co-founded supergroup Category 7 in 2024, maintaining active dual-band duties, continuing the multi-band pattern he set during his overlapping Shadows Fall and Flotsam and Jetsam years.' },
    ],
  },

  // Issue #3147: SEO batch 39 — atmospheric alt-metal vs arena extreme metal counterpoint
  'abe-cunningham-vs-jay-weinberg': {
    slug: 'abe-cunningham-vs-jay-weinberg',
    title: 'Abe Cunningham vs Jay Weinberg',
    metaTitle: 'Abe Cunningham vs Jay Weinberg — Deftones Atmosphere vs Slipknot Arena Power | MetalForge',
    metaDescription: 'Deftones\' Abe Cunningham vs former Slipknot drummer Jay Weinberg: atmospheric alt-metal restraint versus arena-scale extreme metal power. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['abe-cunningham', 'jay-weinberg'],
    comparison: {
      style: 'Abe Cunningham co-founded Deftones in Sacramento in 1988 as a teenager and has anchored the band\'s atmospheric alt-metal sound for over three decades, driving landmark records including the Grammy-winning "White Pony" (2000), "Diamond Eyes" (2010), and "Ohms" (2020) with a style built on dynamic restraint rather than raw aggression. Jay Weinberg joined Slipknot in 2014 at age 24, stepping into one of extreme metal\'s most scrutinized drum chairs following founding drummer Joey Jordison\'s departure, and delivered arena-scale power across ".5: The Gray Chapter" (2014), "We Are Not Your Kind" (2019), and "The End, So Far" (2022) before parting ways in November 2023 and later joining Suicidal Tendencies.',
      technique: 'Cunningham\'s playing favors unconventional patterns, creative use of space, and seamless transitions between crushing heaviness and ethereal delicacy — influenced by John Bonham\'s pocket, Stewart Copeland\'s unconventional patterns, and 311\'s Chad Sexton\'s syncopated funk-metal feel, he prioritizes serving Deftones\' emotional arc over technical showmanship. Weinberg blends the professional discipline he absorbed from his father, E Street Band drummer Max Weinberg, with hardcore-punk-honed intensity from his time in Against Me! and Madball, delivering sustained blast beats and powerful double bass patterns that had to authentically replicate Jordison\'s iconic parts while injecting his own explosive energy into Slipknot\'s chaotic live show.',
      gear: 'Abe Cunningham plays an SJC Custom drum kit with an SJC Custom 14x6.5" Brass snare and Zildjian K Custom & A Custom Series cymbals (14" K Custom Hi-Hats, 18" & 20" K Custom Crashes, 22" K Custom Ride, 19" A Custom China), driven by a DW 9000 Series double pedal and DW hardware, with Vic Firth American Classic 2B sticks and Remo heads. Jay Weinberg played an SJC Custom Drums kit (OBEY x ST Collaboration) with an SJC Jay Weinberg "The Crucible" 14x6.5" 48-ply Brass snare and Zildjian cymbals (14" A New Beat Hi-Hats, 18" & 19" A Custom Crashes, 21" K Custom Ride, 19" K China, 7" FX Break Bell), powered by a DW 9000 Series double pedal and DW 9100 throne, with Vater Jay Weinberg 908 Signature sticks and Evans Black Chrome heads.',
      influence: 'Cunningham helped define an entire alternative metal subgenre — his creative, non-traditional approach to drumming, drawing from post-punk and alt-rock rather than standard metal vocabulary, influenced countless nu-metal and alt-metal drummers who followed. Weinberg carried one of metal\'s most scrutinized drum chairs for nine years, earning respect from fans who initially doubted anyone could replace Jordison, and built a following that carried into his post-Slipknot work with Suicidal Tendencies.',
    },
    verdict: 'Abe Cunningham and Jay Weinberg represent opposite poles of heavy music\'s emotional range, and — coincidentally — both built their sound on SJC Custom Drums kits driven by DW 9000 Series double pedals. Cunningham spent 35-plus years proving that restraint, space, and atmosphere can be just as heavy as raw power, anchoring Deftones\' genre-defining blend of crushing riffs and shoegaze textures. Weinberg spent nine years bringing arena-scale extreme metal intensity to one of the most scrutinized drum chairs in metal, honoring Joey Jordison\'s legacy while injecting his own hardcore-punk energy. Asking "what makes Deftones vs Slipknot drumming different?" comes down to atmospheric heaviness versus aggressive arena power.',
    faqs: [
      { q: 'Who hits harder: Abe Cunningham or Jay Weinberg?', a: 'Jay Weinberg\'s Slipknot drumming is built for raw, arena-scale aggression — sustained blast beats and powerful double bass driving one of extreme metal\'s heaviest live shows. Abe Cunningham\'s Deftones drumming prioritizes dynamic restraint and atmosphere over sheer force, though his heavier passages on records like "White Pony" hit just as hard by contrast with the band\'s ambient sections.' },
      { q: 'What makes Deftones\' drumming different from Slipknot\'s?', a: 'Abe Cunningham\'s Deftones drumming emphasizes unconventional patterns, space, and dynamic shifts between crushing heaviness and ethereal delicacy, drawing on post-punk and alt-rock influences. Jay Weinberg\'s Slipknot drumming emphasizes sustained aggression, technical double bass, and replicating Joey Jordison\'s intricate, high-energy parts for the band\'s chaotic arena live show.' },
      { q: 'What gear do Abe Cunningham and Jay Weinberg use?', a: 'Abe Cunningham plays an SJC Custom drum kit with an SJC Custom 14x6.5" Brass snare and Zildjian K Custom & A Custom cymbals, driven by a DW 9000 Series double pedal. Jay Weinberg played an SJC Custom Drums kit with an SJC "The Crucible" 14x6.5" Brass snare and Zildjian cymbals, also powered by a DW 9000 Series double pedal — both drummers share the same drum and pedal brands.' },
      { q: 'What bands did Abe Cunningham and Jay Weinberg play for?', a: 'Abe Cunningham has been the founding drummer of Deftones since 1988. Jay Weinberg was Slipknot\'s drummer from 2014 to 2023, replacing founding drummer Joey Jordison, and later joined Suicidal Tendencies in 2024.' },
    ],
  },
};
