...
export const drummerComparisons = {
  ...
  'ben-koller-vs-brann-dailor': {
    ...
    metaTitle: 'Ben Koller vs Brann Dailor — Mathcore Chaos vs Progressive Melody | MetalForge',
    metaDescription: 'Converge\'s Ben Koller vs Mastodon\'s Brann Dailor. Raw hardcore-fueled mathcore intensity versus melodic, jazz-informed progressive sludge — gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['ben-koller', 'brann-dailor'],
    comparison: {
      style: 'Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "You Fail Me" (2004), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures. Beyond Converge, he co-founded heavy rock band Mutoid Man with Stephen Brodsky of Cave In and joined the supergroup Killer Be Killed. Brann Dailor co-founded Mastodon in 2000 with guitarist Bill Kelliher and has been the band\'s only drummer since, building progressive sludge metal\'s most melodic drumming voice across "Leviathan" (2004), "Blood Mountain" (2006), and the Grammy-nominated "Crack the Skye" (2009), while also serving as the band\'s co-vocalist on its later albums.',
      technique: 'Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, which gives Converge\'s mathcore its dangerous, live-wire energy. Dailor\'s technique treats the drums as a lead melodic instrument rather than a timekeeping tool — intricate, jazz-influenced fills weave around Mastodon\'s riffs in constant motion, requiring him to sustain complex compositional ideas across long-form progressive songs while also singing lead vocal parts, a demand almost no other extreme-adjacent drummer faces simultaneously.',
      gear: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks. Brann Dailor plays a Tama Starclassic Performer B/B kit with a Tama S.L.P. 14x6.5" G-Maple snare and Meinl Byzance Series cymbals (14" Dark Hi-Hats, 18" & 19" Brilliant Heavy Hammered Crashes, 21" Ghost Ride, 18" Extra Dry China), powered by a Tama Speed Cobra double pedal and Vater 5B sticks.',
      influence: 'Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics. Dailor\'s "lead drums" approach with Mastodon, combined with his increasingly prominent vocal role, has made him one of the most influential and widely imitated drummers in modern progressive metal, inspiring a generation of players to treat the kit as a melodic voice rather than pure rhythm section support.',
    },
    verdict: 'Ben Koller and Brann Dailor channel very different heavy-music lineages into equally distinctive drumming voices. Koller\'s Converge output is built on chaos and visceral unpredictability — mathcore that feels dangerous because it is engineered to feel uncontrolled. Dailor\'s Mastodon output is built on melodic composition — progressive sludge that treats every fill as a musical statement, delivered while he simultaneously handles co-lead vocals. Both are cornerstones of their respective subgenres and both are frequently cited by younger drummers as reasons to pick up sticks, but the comparison ultimately comes down to whether you value Koller\'s raw hardcore intensity or Dailor\'s melodic, compositional restraint.',
    faqs: [
      { q: 'Who is more technically demanding — Ben Koller or Brann Dailor?', a: 'Both are demanding in very different ways. Ben Koller (Converge) is demanding because of his loose, explosive, unpredictable attack — sudden tempo shifts and dynamic swings that make Converge\'s mathcore feel dangerous. Brann Dailor (Mastodon) is demanding because of his melodic, compositional complexity — intricate, jazz-influenced fills that he sustains while also singing lead and co-lead vocal parts on later Mastodon albums. Koller\'s difficulty is visceral; Dailor\'s is compositional and multitasking-heavy.' },
      { q: 'What gear do Ben Koller and Brann Dailor use?', a: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal. Brann Dailor plays a Tama Starclassic Performer B/B kit with a Tama S.L.P. 14x6.5" G-Maple snare and Meinl Byzance Series cymbals, powered by a Tama Speed Cobra double pedal.' },
      { q: 'What bands are Ben Koller and Brann Dailor known for?', a: 'Ben Koller has drummed for Converge since 1999, and also plays in Mutoid Man and Killer Be Killed. Brann Dailor co-founded Mastodon in 2000 and has been its drummer and co-vocalist ever since, also playing in the synth project Arcadea.' },
      { q: 'Does Brann Dailor sing while drumming for Mastodon?', a: 'Yes — Dailor has taken on an increasingly prominent lead and co-lead vocal role on later Mastodon albums such as "Crack the Skye" (2009) and beyond, singing full verses and choruses while simultaneously performing Mastodon\'s complex, fill-heavy drum parts. Ben Koller does not sing in Converge, which is fronted by Jacob Bannon.' },
    ],
  },
  ...
  'ben-koller-vs-gavin-harrison': {
    ...
    metaTitle: 'Ben Koller vs Gavin Harrison — Mathcore Fury vs Progressive Restraint | MetalForge',
    metaDescription: 'Converge\'s Ben Koller vs Porcupine Tree/King Crimson\'s Gavin Harrison. Chaotic hardcore-driven mathcore versus intricate, ghost-note-laden progressive precision — gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['ben-koller', 'gavin-harrison'],
    comparison: {
      style: 'Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "You Fail Me" (2004), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures. Beyond Converge, he co-founded heavy rock band Mutoid Man with Stephen Brodsky of Cave In and joined the supergroup Killer Be Killed. Gavin Harrison, born in 1963 in Harrow, England, built his reputation across Porcupine Tree (2002–2010, 2021–present), King Crimson (2007–2021), and The Pineapple Thief (2016–present), earning a reputation as one of the finest and most award-winning drummers in progressive rock and metal for his musicality inside extreme complexity.',
      technique: 'Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, exactly what gives Converge\'s mathcore its dangerous, live-wire energy. Harrison\'s technique is the opposite pole of complexity — intricate polyrhythmic patterns, masterful ghost notes, and an economical bass drum approach that let him navigate King Crimson\'s and Porcupine Tree\'s odd-time signatures with restraint and groove rather than raw power, a touch-first precision that has earned him multiple Modern Drummer awards.',
      gear: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks. Gavin Harrison plays a Sonor SQ2 Series kit with two signature Sonor snares in rotation (12x5" and 14x5.25") and Zildjian K Custom Special Dry cymbals (14" Hi-Hats, 16" & 18" Crashes, 21" Special Dry Ride, 18" Trash China), powered by a single Sonor Perfect Balance pedal and Vic Firth Gavin Harrison Signature sticks.',
      influence: 'Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics. Harrison is considered a major influence on progressive rock and metal drummers worldwide, celebrated for proving that extreme technical complexity and restrained musicality are not opposites — his work with King Crimson and Porcupine Tree is studied for how much groove he extracts from odd-time signatures.',
    },
    verdict: 'Ben Koller and Gavin Harrison sit at nearly opposite ends of the technical extreme music spectrum. Koller channels chaos and raw emotional intensity into Converge\'s unpredictable mathcore assault — his playing feels dangerous because it is built to feel uncontrolled even when it isn\'t. Harrison channels restraint and economy into some of progressive rock\'s most complex time signatures, proving that ghost notes and understatement can be just as technically demanding as speed and power. Both are titans of their respective scenes, and the comparison ultimately comes down to whether you value Koller\'s visceral chaos or Harrison\'s disciplined, musical precision.',
    faqs: [
      { q: 'Who is more technically demanding — Ben Koller or Gavin Harrison?', a: 'Both are demanding in different ways. Ben Koller (Converge) is demanding because of his loose, explosive, unpredictable attack — sudden tempo shifts and dynamic swings that make Converge\'s mathcore feel dangerous. Gavin Harrison (Porcupine Tree, King Crimson) is demanding because of intricate polyrhythmic patterns and ghost-note mastery executed with restraint inside complex odd-time signatures. Koller\'s difficulty is visceral and chaotic; Harrison\'s is architectural and economical.' },
      { q: 'What gear do Ben Koller and Gavin Harrison use?', a: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal. Gavin Harrison plays a Sonor SQ2 Series kit with signature Sonor snares and Zildjian K Custom Special Dry cymbals, powered by a single Sonor Perfect Balance pedal.' },
      { q: 'What bands are Ben Koller and Gavin Harrison known for?', a: 'Ben Koller has drummed for Converge since 1999, and also plays in Mutoid Man and Killer Be Killed. Gavin Harrison has drummed for Porcupine Tree (2002–2010, 2021–present), King Crimson (2007–2021), and The Pineapple Thief (2016–present).' },
      { q: 'Why does Gavin Harrison use two different signature snares?', a: 'Harrison rotates between a 12x5" and a 14x5.25" Sonor signature snare so he can switch between a tighter, higher-pitched crack for intricate ghost-note passages and a fuller backbeat for King Crimson\'s heavier sections — a level of tonal customization that reflects his restrained, musicality-first approach compared to Ben Koller\'s single-snare, maximum-impact Converge setup.' },
    ],
  },
  ...
  'ben-koller-vs-hellhammer': {
    ...
    metaDescription: 'Converge\'s Ben Koller vs Mayhem\'s Hellhammer. Improvisational hardcore-fueled mathcore versus disciplined, genre-defining black metal blast beats — gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['ben-koller', 'hellhammer'],
    comparison: {
      style: 'Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "You Fail Me" (2004), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures. Beyond Converge, he co-founded heavy rock band Mutoid Man with Stephen Brodsky of Cave In and joined the supergroup Killer Be Killed. Hellhammer (Jan Axel Blomberg), born in 1969 in Oslo, Norway, joined black metal pioneers Mayhem in 1988 and has remained the band\'s rhythmic foundation through its most turbulent history, appearing on every official release from "De Mysteriis Dom Sathanas" (1994) through "Daemon" (2019), while also contributing to Arcturus and Dimmu Borgir.',
      technique: 'Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, which gives Converge\'s mathcore its dangerous, live-wire energy. Hellhammer\'s technique is built on raw black metal aggression paired with surprising technical sophistication — his rapid, sustained blast beats at extreme tempos, combined with a fast-rebounding double pedal setup, are credited with helping define the black metal drumming vocabulary that countless extreme metal drummers still draw from today.',
      gear: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 14x5.5" Maple snare and Paiste RUDE Series cymbals (14" RUDE Hi-Hats, 18" & 19" RUDE Crashes, 20" RUDE Ride, 18" RUDE China), powered by an Axis double bass pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics. Hellhammer\'s influence on extreme metal drumming is immeasurable — he is credited with helping define black metal\'s blast-beat-driven style, has recorded with over 40 different bands and artists, and remains one of the most enduring and respected figures in black metal history.',
    },
    verdict: 'Ben Koller and Hellhammer approach extreme intensity from different hardcore-versus-black-metal roots that converge on raw physical demand. Koller channels chaos and improvisational unpredictability into Converge\'s mathcore assault — his playing feels dangerous because it is built to feel uncontrolled even when it isn\'t. Hellhammer channels disciplined, sustained aggression into Mayhem\'s black metal blast beats, helping define an entire genre\'s rhythmic vocabulary across more than three decades in one of the scene\'s most turbulent and storied bands. Both are foundational figures in their respective extreme subgenres, and the comparison comes down to Koller\'s visceral unpredictability versus Hellhammer\'s sustained, genre-defining blast-beat discipline.',
    faqs: [
      { q: 'Who is more technically demanding — Ben Koller or Hellhammer?', a: 'Both are considered elite extreme metal drummers by different measures. Ben Koller (Converge) is demanding because of his loose, explosive, unpredictable attack across constantly shifting mathcore time signatures. Hellhammer (Mayhem) is demanding because of his sustained, disciplined blast beats at extreme tempos, a style he helped originate and that has influenced generations of black and extreme metal drummers. Koller\'s difficulty is chaotic and improvisational; Hellhammer\'s is about sustained speed and genre-defining consistency.' },
      { q: 'What gear do Ben Koller and Hellhammer use?', a: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 14x5.5" Maple snare and Paiste RUDE Series cymbals, powered by an Axis double bass pedal.' },
      { q: 'What bands are Ben Koller and Hellhammer known for?', a: 'Ben Koller has drummed for Converge since 1999, and also plays in Mutoid Man and Killer Be Killed. Hellhammer has drummed for Mayhem since 1988, appearing on every official release from "De Mysteriis Dom Sathanas" (1994) onward, and has also played in Arcturus and Dimmu Borgir.' },
      { q: 'Did Hellhammer help invent the black metal blast beat?', a: 'Hellhammer is widely credited with helping define black metal\'s blast-beat-driven drumming style during his tenure with Mayhem, which began in 1988. His raw, aggressive playing on records like "De Mysteriis Dom Sathanas" (1994) is considered foundational to how extreme metal drummers approach sustained blast beats, in much the same way Ben Koller\'s work on "Jane Doe" (2001) is considered foundational to modern mathcore drumming.' },
    ],
  },
  ...
  'brann-dailor-vs-hellhammer': {
    ...
    metaTitle: 'Brann Dailor vs Hellhammer — Progressive Melody vs Black Metal Blast Beats | MetalForge',
    metaDescription: 'Mastodon\'s Brann Dailor vs Mayhem\'s Hellhammer. Melodic, jazz-informed progressive sludge versus raw, genre-defining black metal blast beats — gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['brann-dailor', 'hellhammer'],
    comparison: {
      style: 'Brann Dailor co-founded Mastodon in 2000 with guitarist Bill Kelliher and has been the band\'s only drummer since, building progressive sludge metal\'s most melodic drumming voice across "Leviathan" (2004), "Blood Mountain" (2006), and the Grammy-nominated "Crack the Skye" (2009), while also serving as the band\'s co-vocalist on its later albums. Hellhammer (Jan Axel Blomberg), born in 1969 in Oslo, Norway, joined black metal pioneers Mayhem in 1988 and has remained the band\'s rhythmic foundation through its most turbulent history, appearing on every official release from "De Mysteriis Dom Sathanas" (1994) through "Daemon" (2019), while also contributing to Arcturus and Dimmu Borgir.',
      technique: 'Dailor\'s technique treats the drums as a lead melodic instrument rather than a timekeeping tool — intricate, jazz-influenced fills weave constantly around Mastodon\'s riffs, requiring him to sustain complex compositional ideas across long-form progressive songs while frequently singing lead vocal parts simultaneously. Hellhammer\'s technique is built on raw black metal aggression paired with surprising technical sophistication — rapid, sustained blast beats at extreme tempos, driven by a fast-rebounding double pedal setup, that are credited with helping define the black metal drumming vocabulary countless extreme metal drummers still draw from today.',
      gear: 'Brann Dailor plays a Tama Starclassic Performer B/B kit with a Tama S.L.P. 14x6.5" G-Maple snare and Meinl Byzance Series cymbals (14" Dark Hi-Hats, 18" & 19" Brilliant Heavy Hammered Crashes, 21" Ghost Ride, 18" Extra Dry China), powered by a Tama Speed Cobra double pedal and Vater 5B sticks. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 14x5.5" Maple snare and Paiste RUDE Series cymbals (14" RUDE Hi-Hats, 18" & 19" RUDE Crashes, 20" RUDE Ride, 18" RUDE China), driven by an Axis double bass pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Dailor\'s "lead drums" approach with Mastodon, combined with his increasingly prominent vocal role, has made him one of the most influential and widely imitated drummers in modern progressive metal, inspiring a generation of players to treat the kit as a melodic voice rather than pure rhythm section support. Hellhammer\'s influence on extreme metal drumming is immeasurable — he is credited with helping define black metal\'s blast-beat-driven style, has recorded with over 40 different bands and artists, and remains one of the most enduring and respected figures in black metal history.',
    },
    verdict: 'Brann Dailor and Hellhammer represent two of extreme-adjacent metal\'s most opposite drumming philosophies. Dailor builds Mastodon\'s progressive sludge sound around melody and constant compositional motion, treating every fill as a musical statement while frequently singing lead vocals at the same time. Hellhammer builds Mayhem\'s black metal sound around raw, disciplined, sustained aggression, helping define an entire genre\'s blast-beat vocabulary across more than three decades in one of extreme metal\'s most storied and turbulent bands. Both are foundational, genre-defining figures whose recordings are considered essential listening — the comparison comes down to melodic complexity versus sustained sonic assault.',
    faqs: [
      { q: 'How do Brann Dailor\'s and Hellhammer\'s drumming styles differ?', a: 'Brann Dailor (Mastodon) plays a melodic, compositional style — intricate, jazz-influenced fills that treat the kit as a lead instrument, often performed while he sings lead or co-lead vocals. Hellhammer (Mayhem) plays a raw, aggressive style built around sustained extreme-tempo blast beats that helped define black metal\'s rhythmic vocabulary. Dailor represents melodic restraint and motion; Hellhammer represents disciplined, sustained sonic assault.' },
      { q: 'What gear do Brann Dailor and Hellhammer use?', a: 'Brann Dailor plays a Tama Starclassic Performer B/B kit with a Tama S.L.P. 14x6.5" G-Maple snare and Meinl Byzance Series cymbals, powered by a Tama Speed Cobra double pedal. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 14x5.5" Maple snare and Paiste RUDE Series cymbals, driven by an Axis double bass pedal.' },
      { q: 'What bands are Brann Dailor and Hellhammer known for?', a: 'Brann Dailor co-founded Mastodon in 2000 and has been its drummer and co-vocalist ever since, also playing in the synth project Arcadea. Hellhammer has drummed for Mayhem since 1988, appearing on every official release from "De Mysteriis Dom Sathanas" (1994) onward, and has also played in Arcturus and Dimmu Borgir.' },
      { q: 'Is Brann Dailor or Hellhammer considered more influential?', a: 'Both are considered genre-defining figures, but in different subgenres. Brann Dailor\'s melodic, "lead drums" approach with Mastodon reshaped how progressive and sludge metal drummers think about the kit as a compositional voice. Hellhammer is credited with helping define black metal\'s blast-beat drumming style during his decades with Mayhem, making him one of the most cited influences in extreme metal specifically. Their influence operates in largely non-overlapping corners of heavy music.' },
    ],
  },
};
