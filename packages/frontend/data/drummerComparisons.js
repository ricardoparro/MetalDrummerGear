...
export const drummerComparisons = {
  ...
  'mario-duplantier-vs-gavin-harrison': {
    ...
    metaTitle: 'Mario Duplantier vs Gavin Harrison — Gojira\'s Tribal Power vs Porcupine Tree\'s Polyrhythmic Precision | MetalForge',
    metaDescription: 'Gojira\'s Mario Duplantier vs Porcupine Tree/King Crimson\'s Gavin Harrison. Organic dual-bass-drum progressive death metal compared to restrained, sophisticated polyrhythmic prog rock. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['mario-duplantier', 'gavin-harrison'],
    comparison: {
      style: 'Mario Duplantier co-founded Gojira in 1996 alongside his brother, guitarist Joe Duplantier, and has driven the French band\'s tribal, progressive death metal — often dubbed "environmental metal" for its ecological themes — across landmark records including "From Mars to Sirius" (2005), "The Way of All Flesh" (2008), "L\'Enfant Sauvage" (2012), and "Fortitude" (2021), culminating in Gojira\'s 2024 Paris Olympics opening ceremony performance of "Mea Culpa" atop a giant mechanical guillotine before a global television audience. Gavin Harrison joined Porcupine Tree in 2002 and later added King Crimson (2007–present) and The Pineapple Thief (2016–present) to his résumé, building a reputation for constructing sophisticated polyrhythmic grooves and odd-time-signature architecture that rewards close, repeated listening rather than sheer power.',
      technique: 'Duplantier forgoes a double pedal in favor of dual bass drums for a more organic feel, layering tribal, almost ritualistic polyrhythms and explosive tom-driven accents beneath Gojira\'s massive, downtuned riffing rather than relying on mechanical precision. Harrison weaves intricate polyrhythmic patterns through constantly shifting odd time signatures with restrained, economical sophistication, prioritizing groove, ghost notes, and musicality over overt technical display — a philosophy he has described as making the complex sound simple.',
      gear: 'Mario Duplantier plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums (no double pedal) and a Tama S.L.P. 14x6.5" G-Maple snare, paired with a sprawling Zildjian cymbal array including a 21" Z Custom Mega Bell Ride. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals (14" Hi-Hats, 16" & 18" Crashes, 21" Special Dry Ride, 18" Trash China) and Vic Firth signature sticks, favoring a dry, controlled tone suited to his polyrhythmic precision.',
      influence: 'Duplantier pioneered the "environmental metal" drumming style that made Gojira one of the most critically acclaimed progressive death metal bands of the 21st century, and the band\'s 2024 Olympics appearance introduced his tribal power to a global audience that had never heard of Gojira before. Harrison has won multiple Modern Drummer awards and is widely regarded as "the drummer\'s drummer," influencing a generation of progressive rock and metal players who study his ghost-note vocabulary and odd-time phrasing.',
    },
    verdict: 'Mario Duplantier and Gavin Harrison represent two opposite poles of progressive metal drumming philosophy. Duplantier channels raw, tribal, organic power into Gojira\'s environmentally themed death metal, turning dual-bass-drum grooves into a force of nature that reached a mainstream global audience at the 2024 Paris Olympics. Harrison channels restrained, mathematically sophisticated polyrhythm into Porcupine Tree and King Crimson\'s cerebral progressive rock, making impossible time signatures feel conversational rather than showy. Comparing them is comparing elemental force to architectural precision — both represent the pinnacle of what progressive drumming can achieve, just from entirely different directions.',
    faqs: [
      { q: 'What bands are Mario Duplantier and Gavin Harrison known for?', a: 'Mario Duplantier has been the co-founding drummer of French progressive death metal band Gojira since 1996. Gavin Harrison is best known for Porcupine Tree (2002–present) and King Crimson (2007–present), and also plays with The Pineapple Thief.' },
      { q: 'What gear do Mario Duplantier and Gavin Harrison use?', a: 'Mario Duplantier plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums instead of a double pedal, a Tama S.L.P. G-Maple snare, and a Zildjian cymbal array including a 21" Z Custom Mega Bell Ride. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals.' },
      { q: 'Did Gojira perform at the Olympics?', a: 'Yes — Gojira performed their song "Mea Culpa" during the 2024 Paris Olympics opening ceremony, with Mario Duplantier\'s tribal drumming introduced to a massive global television audience atop a mechanical guillotine staging.' },
      { q: 'Why does Mario Duplantier use dual bass drums instead of a double pedal?', a: 'Mario Duplantier prefers dual 22"x18" bass drums over a double pedal because it gives Gojira\'s tribal, progressive death metal rhythms a more organic feel, letting him layer polyrhythms with a different physical touch than a single-kick double-pedal setup allows.' },
    ],
  },
  ...
  'jaska-raatikainen-vs-gavin-harrison': {
    ...
    metaTitle: 'Jaska Raatikainen vs Gavin Harrison — Finnish Melodic Death Metal vs Progressive Rock Polyrhythm | MetalForge',
    metaDescription: 'Children of Bodom\'s Jaska Raatikainen vs Porcupine Tree/King Crimson\'s Gavin Harrison. Neoclassical melodic death metal blast beats compared to restrained, sophisticated progressive rock polyrhythm. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['jaska-raatikainen', 'gavin-harrison'],
    comparison: {
      style: 'Jaska Raatikainen co-founded Children of Bodom in 1993 (originally performing as Inearthed until adopting the Children of Bodom name in 1997) alongside the late Alexi Laiho, remaining the band\'s sole drummer for its entire 26-year run — from the 1997 debut "Something Wild" through the band\'s 2019 farewell album "Hexed" — anchoring Finnish neoclassical melodic death metal with blast beats and double bass built around Laiho\'s guitar and Janne Wirman\'s keyboard interplay. Gavin Harrison joined Porcupine Tree in 2002 and later added King Crimson (2007–present) and The Pineapple Thief (2016–present), building a career on intricate polyrhythmic grooves and odd-time-signature mastery that made him one of progressive rock\'s most studied technicians.',
      technique: 'Raatikainen balances death metal velocity with melodic awareness — rapid double bass volleys and blast beats locked tightly to Children of Bodom\'s neoclassical riffing, with fills composed to support rather than overwhelm the melodic material. Harrison weaves polyrhythmic patterns through constantly shifting odd time signatures with restrained, economical sophistication, favoring groove and ghost-note nuance over technical flash — a philosophy of making complexity feel natural rather than showy.',
      gear: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare, Zildjian A Custom & K Custom Series cymbals (14" A Custom Hi-Hats, 17" & 18" A Custom Crashes, 20" K Custom Ride), a Pearl Eliminator double pedal, and Vic Firth American Classic 5A sticks. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals (14" Hi-Hats, 16" & 18" Crashes, 21" Special Dry Ride, 18" Trash China) and Vic Firth signature sticks.',
      influence: 'Raatikainen helped build Finland\'s melodic death metal scene into a global commercial force — Children of Bodom sold over two million albums worldwide, and his playing on "Hatebreeder" (1999) and "Follow the Reaper" (2000) influenced a generation of melodic death and metalcore drummers. Harrison has won multiple Modern Drummer awards and built a reputation as "the drummer\'s drummer," his ghost-note vocabulary and odd-time phrasing studied by progressive rock and metal drummers across generations.',
    },
    verdict: 'Jaska Raatikainen and Gavin Harrison represent two entirely different schools of European technical drumming. Raatikainen spent 26 years anchoring Children of Bodom\'s neoclassical melodic death metal assault with blast beat velocity and double bass precision. Harrison built a decades-long reputation across Porcupine Tree, King Crimson, and The Pineapple Thief on restrained, sophisticated polyrhythm rather than raw speed. Comparing them is comparing Finnish extreme metal aggression to British progressive rock\'s intellectual complexity — both are considered among the most complete drummers in their respective corners of heavy and progressive music.',
    faqs: [
      { q: 'What bands are Jaska Raatikainen and Gavin Harrison known for?', a: 'Jaska Raatikainen was the co-founding drummer of Finnish melodic death metal band Children of Bodom from 1993 until the band\'s dissolution in 2019. Gavin Harrison is best known for Porcupine Tree and King Crimson, and also plays with The Pineapple Thief.' },
      { q: 'What gear do Jaska Raatikainen and Gavin Harrison use?', a: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with Zildjian A Custom & K Custom cymbals and a Pearl Eliminator double pedal. Gavin Harrison plays a Sonor SQ2 Series kit with Zildjian K Custom Special Dry Series cymbals.' },
      { q: 'Who is more technical: Jaska Raatikainen or Gavin Harrison?', a: 'Both are technical in different dimensions. Jaska Raatikainen\'s technicality lies in blast beat velocity and double bass precision within neoclassical melodic death metal. Gavin Harrison\'s technicality lies in restrained polyrhythmic sophistication and odd-time-signature mastery within progressive rock. Raatikainen\'s difficulty is about speed; Harrison\'s is about complexity made to feel simple.' },
      { q: 'How long was Jaska Raatikainen in Children of Bodom, and how long has Gavin Harrison been in Porcupine Tree?', a: 'Jaska Raatikainen was Children of Bodom\'s sole drummer for the band\'s entire 26-year run, from 1993 to its 2019 dissolution. Gavin Harrison has been Porcupine Tree\'s drummer since 2002, and has also drummed for King Crimson since 2007 and The Pineapple Thief since 2016.' },
    ],
  },
  ...
  'jaska-raatikainen-vs-john-otto': {
    ...
    metaTitle: 'Jaska Raatikainen vs John Otto — Melodic Death Metal Blast Beats vs Nu-Metal Groove | MetalForge',
    metaDescription: 'Children of Bodom\'s Jaska Raatikainen vs Limp Bizkit\'s John Otto. Finnish neoclassical blast-beat precision compared to jazz-and-hip-hop-informed nu-metal pocket. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['jaska-raatikainen', 'john-otto'],
    comparison: {
      style: 'Jaska Raatikainen co-founded Children of Bodom in 1993 (originally performing as Inearthed until adopting the Children of Bodom name in 1997) alongside the late Alexi Laiho, remaining the band\'s sole drummer for its entire 26-year run — from the 1997 debut "Something Wild" through the band\'s 2019 farewell album "Hexed" — anchoring Finnish neoclassical melodic death metal with blast beats and double bass built around Laiho\'s guitar and Janne Wirman\'s keyboard interplay. John Otto has been Limp Bizkit\'s drummer and a founding member since the band formed in Jacksonville, Florida in 1994, building his reputation on tight, hip-hop-influenced grooves and funk-inspired pocket playing that helped define the rap-metal sound of the late 1990s and early 2000s across "Significant Other" (1999) and "Chocolate Starfish and the Hot Dog Flavored Water" (2000).',
      technique: 'Raatikainen balances death metal velocity with melodic awareness — rapid double bass volleys and blast beats locked tightly to Children of Bodom\'s neoclassical riffing, with fills composed to support rather than overwhelm the melodic material. Otto\'s technique centers on a deep sense of groove and pocket drawn from jazz training at the Douglas Anderson School of the Arts and hip-hop/funk influences, favoring tight snare work and syncopated patterns over speed or blast-beat technicality, giving Limp Bizkit\'s rap-metal fusion its rhythmic backbone.',
      ...
      influence: 'Raatikainen helped build Finland\'s melodic death metal scene into a global commercial force — Children of Bodom sold over two million albums worldwide, and his playing on "Hatebreeder" and "Follow the Reaper" influenced a generation of melodic death and metalcore drummers. Otto\'s hip-hop-infused groove playing showed nu-metal\'s deep rhythmic connection to funk and rap, and his work across Limp Bizkit\'s multi-platinum albums helped define the commercial peak of the nu-metal era.',
    },
    verdict: 'Jaska Raatikainen and John Otto sit at opposite ends of heavy music\'s rhythmic spectrum. Raatikainen spent 26 years pushing blast-beat velocity and neoclassical precision with Children of Bodom, one of extreme metal\'s most demanding disciplines. Otto built his entire career on pocket, groove, and jazz-informed restraint, helping define Limp Bizkit\'s rap-metal fusion during nu-metal\'s commercial peak. Comparing them is comparing Finnish melodic death metal extremity to American nu-metal groove — proof that great metal drumming can mean blistering speed or deep, funk-informed pocket, depending entirely on what the music demands.',
    faqs: [
      { q: 'What bands are Jaska Raatikainen and John Otto known for?', a: 'Jaska Raatikainen was the co-founding drummer of Finnish melodic death metal band Children of Bodom from 1993 until the band\'s dissolution in 2019. John Otto has been the drummer and a founding member of Limp Bizkit since the band formed in Jacksonville, Florida in 1994.' },
      { q: 'What gear do Jaska Raatikainen and John Otto use?', a: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with Zildjian A Custom & K Custom cymbals and a Pearl Eliminator double pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual snares, Zildjian A Custom cymbals, and Gibraltar G Class bass drum pedals.' },
      { q: 'Is John Otto jazz trained?', a: 'Yes — John Otto studied jazz at the Douglas Anderson School of the Arts in Jacksonville, Florida, and that jazz and funk background is central to the syncopated, hip-hop-influenced groove he brings to Limp Bizkit\'s rap-metal fusion.' },
      { q: 'Who is faster: Jaska Raatikainen or John Otto?', a: 'Jaska Raatikainen is by far the faster, more extreme drummer — his blast beats and double bass volleys with Children of Bodom operate at neoclassical melodic death metal tempos. John Otto prioritizes groove, pocket, and hip-hop-informed feel over speed, favoring tight syncopation over blast-beat technicality.' },
    ],
  },
  ...
  'eloy-casagrande-vs-ben-koller': {
    ...
    metaTitle: 'Eloy Casagrande vs Ben Koller — Thrash-Groove Precision vs Mathcore Chaos | MetalForge',
    metaDescription: 'Metallica/Sepultura\'s Eloy Casagrande vs Converge\'s Ben Koller. Locked-in thrash-groove versatility compared to raw, improvisational mathcore intensity. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['eloy-casagrande', 'ben-koller'],
    comparison: {
      style: 'Eloy Casagrande joined Sepultura in 2011, replacing Jean Dolabella, and spent 13 years as the Brazilian thrash pioneers\' drummer — recording "Kairos" (2011), "The Mediator Between Head and Hands Must Be the Heart" (2013), "Machine Messiah" (2017), and "Quadra" (2020) — before joining Metallica as touring drummer in 2024, instantly becoming one of the most-watched drummers in metal. Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "You Fail Me" (2004), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity, while also co-founding heavy rock band Mutoid Man and joining supergroup Killer Be Killed.',
      technique: 'Casagrande combines Brazilian rhythmic roots with thrash metal power — his double bass work is defined by locked-in groove rather than sheer speed, and his ability to adapt across Metallica\'s 40-year catalog demonstrates extraordinary musical versatility. Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, which gives Converge\'s mathcore its dangerous, live-wire energy.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Maple kit with Zildjian A Custom and K Series cymbals and Tama Iron Cobra double pedals — a powerhouse setup suited to both Sepultura\'s thrash attack and Metallica\'s arena-scale sound. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Casagrande became one of the most-watched drummers in metal overnight when his Metallica appointment was announced in 2024, following over a decade defining Sepultura\'s modern-era sound. Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics.',
    },
    verdict: 'Eloy Casagrande and Ben Koller represent two very different definitions of intensity in modern heavy music. Casagrande built his reputation on locked-in groove and versatility, carrying Sepultura\'s thrash legacy for 13 years before stepping into Metallica\'s biggest stage in metal. Koller built his reputation on barely controlled chaos, making Converge\'s unpredictable mathcore feel dangerous for over two decades. Comparing them is comparing disciplined, groove-driven power to raw, improvisational ferocity — both represent the outer edges of what heavy drumming can sound like.',
    faqs: [
      { q: 'What bands are Eloy Casagrande and Ben Koller known for?', a: 'Eloy Casagrande drummed for Sepultura from 2011 to 2024 before joining Metallica as touring drummer in 2024. Ben Koller has drummed for Converge since 1999, and also plays in Mutoid Man and Killer Be Killed.' },
      { q: 'What gear do Eloy Casagrande and Ben Koller use?', a: 'Eloy Casagrande plays a Tama Starclassic Maple kit with Zildjian A Custom and K Series cymbals and Tama Iron Cobra double pedals. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal.' },
      { q: 'Why did Eloy Casagrande join Metallica?', a: 'Eloy Casagrande joined Metallica as touring drummer in 2024 after departing Sepultura. His combination of technical precision, thrash metal roots, and ability to handle Metallica\'s vast catalog made him a natural fit for the biggest stage in metal.' },
      { q: 'What is Ben Koller\'s most acclaimed work?', a: 'Ben Koller\'s most acclaimed work is Converge\'s "Jane Doe" (2001), widely regarded as a genre-defining mathcore record, along with "Axe to Fall" (2009) and "The Dusk in Us" (2017).' },
    ],
  },
  ...
  'eloy-casagrande-vs-hellhammer': {
    ...
    metaTitle: 'Eloy Casagrande vs Hellhammer — Thrash-Groove Versatility vs Black Metal Blast Beat Foundations | MetalForge',
    metaDescription: 'Metallica/Sepultura\'s Eloy Casagrande vs Mayhem\'s Hellhammer. Modern thrash-groove precision compared to raw, foundational second-wave black metal blast beats. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['eloy-casagrande', 'hellhammer'],
    comparison: {
      style: 'Eloy Casagrande joined Sepultura in 2011, replacing Jean Dolabella, and spent 13 years as the Brazilian thrash pioneers\' drummer — recording "Kairos" (2011), "The Mediator Between Head and Hands Must Be the Heart" (2013), "Machine Messiah" (2017), and "Quadra" (2020) — before joining Metallica as touring drummer in 2024, instantly becoming one of the most-watched drummers in metal. Hellhammer (born Jan Axel Blomberg, 1969) joined Mayhem in 1988 as a teenager, replacing founding drummer Manheim, and delivered the genre-defining blast beats on "De Mysteriis Dom Sathanas" (1994) — the recording against which every subsequent black metal drum performance is measured — while running a parallel career with Dimmu Borgir since 1999 and contributing to hundreds of albums across Arcturus, Winds, Kovenant, and dozens of other projects.',
      technique: 'Casagrande combines Brazilian rhythmic roots with thrash metal power — his double bass work is defined by locked-in groove rather than sheer speed, and his ability to adapt across Metallica\'s 40-year catalog demonstrates extraordinary musical versatility. Hellhammer\'s blast beats are built on cold, relentless one-foot precision that became second-wave black metal\'s rhythmic foundation, and he famously plays barefoot for the direct tactile feedback he says is essential to holding tempo accuracy at extreme speeds.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Maple kit with Zildjian A Custom and K Series cymbals and Tama Iron Cobra double pedals — a powerhouse setup suited to both Sepultura\'s thrash attack and Metallica\'s arena-scale sound. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals (14" A Custom Hi-Hats, 17" & 19" A Custom Crashes, 20" Z Custom Dark Ride, 18" A China Boy), driven by a Pearl Demon Drive double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Casagrande became one of the most-watched drummers in metal overnight when his Metallica appointment was announced in 2024, following over a decade defining Sepultura\'s modern-era sound. Hellhammer defined the sound and speed vocabulary of second-wave black metal, and his three-decade-plus dual career with Mayhem and Dimmu Borgir has made him the genre\'s most in-demand extreme drummer for both raw and symphonic contexts.',
    },
    verdict: 'Eloy Casagrande and Hellhammer represent two entirely different corners of extreme heavy drumming. Casagrande built his career on groove-driven versatility, carrying Sepultura\'s thrash legacy for 13 years before stepping into Metallica\'s global spotlight in 2024. Hellhammer built his legacy on raw, primal power, helping invent black metal\'s foundational blast beat vocabulary with Mayhem across more than three decades and hundreds of guest recordings. Comparing them is comparing modern thrash-groove polish to black metal\'s rawest, most foundational fury.',
    faqs: [
      { q: 'What bands are Eloy Casagrande and Hellhammer known for?', a: 'Eloy Casagrande drummed for Sepultura from 2011 to 2024 before joining Metallica as touring drummer in 2024. Hellhammer (Jan Axel Blomberg) has drummed for Mayhem since 1988 and has also drummed for Dimmu Borgir since 1999, alongside hundreds of guest recordings.' },
      { q: 'What gear do Eloy Casagrande and Hellhammer use?', a: 'Eloy Casagrande plays a Tama Starclassic Maple kit with Zildjian A Custom and K Series cymbals and Tama Iron Cobra double pedals. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare, Zildjian A Custom cymbals, and a Pearl Demon Drive double pedal.' },
      { q: 'Does Hellhammer play barefoot?', a: 'Yes — Hellhammer famously plays barefoot, saying the direct tactile feedback is essential to holding his icy, relentless blast-beat tempo accuracy at extreme speeds with Mayhem and Dimmu Borgir.' },
      { q: 'What is Hellhammer\'s most influential recording?', a: 'Hellhammer\'s performance on Mayhem\'s "De Mysteriis Dom Sathanas" (1994) is widely considered the defining blast-beat recording of second-wave black metal, a benchmark against which subsequent extreme metal drummers, including Eloy Casagrande\'s peers in other genres, are still measured.' },
    ],
  },
};
