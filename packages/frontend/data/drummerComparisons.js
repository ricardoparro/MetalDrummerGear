...
export const drummerComparisons = {
  ...
  // Issue #3248: SEO batch 42 — Cannibal Corpse vs Nile death metal blast beat titans
  'paul-mazurkiewicz-vs-george-kollias': {
    ...
    metaDescription: 'Cannibal Corpse\'s Paul Mazurkiewicz vs Nile\'s George Kollias. Brutal old-school groove vs extreme technical speed — two death metal blast beat titans compared on gear, technique, and legacy.',
    category: 'extreme',
    drummers: ['paul-mazurkiewicz', 'george-kollias'],
    comparison: {
      style: 'Paul Mazurkiewicz co-founded Cannibal Corpse in Buffalo, New York in 1988 and has performed on every album since their 1990 debut "Eaten Back to Life" — his drumming combines relentless blast beats, complex double bass patterns, and groove-oriented bulldoze sections that helped define brutal death metal\'s rhythmic template across albums like "Tomb of the Mutilated" (1992) and "Kill" (2006). George Kollias joined Nile in 2004, replacing Tony Laureano, and built a reputation as one of extreme metal\'s fastest and most technically precise drummers, sustaining blast beats at 240+ BPM with surgical clarity on records like "Annihilation of the Wicked" (2005) and "Those Whom the Gods Detest" (2009).',
      technique: 'Mazurkiewicz favors unflinching brutality over technical showmanship — his alternating blast beats and relentless mid-tempo sections have become part of death metal\'s shared vocabulary, prioritizing groove and power that translate directly to Cannibal Corpse\'s pit-driving live shows. Kollias pushes the outer limits of sustained speed and endurance, co-designing the Pearl Demon XR double pedal specifically to handle rapid-fire bass drum sequences, and has built a parallel career as a drum educator teaching the mechanics behind his technique through instructional DVDs and worldwide clinics.',
      gear: 'Paul Mazurkiewicz plays a Pearl Masters Maple Complete kit with a Pearl Masters 14×6.5" Maple snare, Sabian AAX Series cymbals (14" Stage Hi-Hats, 18" & 19" X-Plosion Crashes, 21" Raw Bell Dry Ride, 18" AAXtreme China), a Pearl Demon Drive double pedal, and Vic Firth American Classic 5B sticks. George Kollias plays a Pearl Masterworks Stadium Exotic kit in Piano Black with Gold Hardware, a Pearl George Kollias Signature 14×6.5" snare, Zildjian cymbals (14" K Mastersound Hi-Hats, 17" & 18" K Custom Dark Crashes, 21" A Custom Mega Bell Ride, 18" China), the co-designed Pearl Demon XR double pedal, and Vic Firth George Kollias Signature sticks.',
      influence: 'Mazurkiewicz has been the rhythmic backbone of Cannibal Corpse, the best-selling death metal band of all time, for over 35 years — his consistency across fifteen-plus studio albums made the band\'s brutal sound recognizable worldwide. Kollias is widely cited as one of the fastest drummers in extreme metal, and his openly shared educational content — instructional DVDs, online courses, and clinics — has taught his speed and endurance techniques to thousands of drummers, extending his influence well beyond Nile\'s discography.',
    },
    verdict: 'Paul Mazurkiewicz and George Kollias represent two distinct pillars of death metal drumming excellence. Mazurkiewicz is the genre\'s old-school architect — three and a half decades of unflinching brutality that built Cannibal Corpse into death metal\'s best-selling act. Kollias is the modern speed scientist — a co-designed signature pedal and 240+ BPM blast beats that pushed Nile\'s technical death metal into uncharted territory. The debate is brutal groove vs sustained extreme velocity.',
    faqs: [
      { q: 'Who plays faster death metal drums, Paul Mazurkiewicz or George Kollias?', a: 'George Kollias is widely regarded as one of the fastest drummers in extreme metal, capable of sustaining blast beats at 240+ BPM with surgical clarity — a benchmark he reinforces through his Pearl Demon XR double pedal, which he co-designed for extreme speed. Paul Mazurkiewicz prioritizes brutal groove and relentless consistency over peak velocity, making his blast beats and double bass patterns part of death metal\'s foundational vocabulary rather than a speed showcase.' },
      { q: 'What drum kit does Paul Mazurkiewicz use compared to George Kollias?', a: 'Paul Mazurkiewicz plays a Pearl Masters Maple Complete kit with Sabian AAX cymbals and a Pearl Demon Drive double pedal. George Kollias plays a Pearl Masterworks Stadium Exotic kit with Zildjian cymbals and the co-designed Pearl Demon XR double pedal. Both endorse Pearl drums, but Kollias\'s setup is purpose-built for sustained extreme-speed blast beats.' },
      { q: 'How long has Paul Mazurkiewicz been in Cannibal Corpse?', a: 'Paul Mazurkiewicz co-founded Cannibal Corpse in Buffalo, New York in 1988 and has performed on every studio album since their 1990 debut "Eaten Back to Life" — over 35 years as the band\'s drummer, making him one of the longest-tenured members of any death metal band.' },
      { q: 'Who is the better drummer, Paul Mazurkiewicz or George Kollias?', a: 'Both are death metal icons in different ways. Mazurkiewicz built brutal death metal\'s rhythmic template through 35-plus years co-founding and driving Cannibal Corpse, the genre\'s best-selling band. Kollias represents the technical extreme — extraordinary speed, endurance, and educational influence as Nile\'s drummer since 2004. The choice depends on whether you value foundational brutality or technical extremity.' },
    ],
  },

  // Issue #3248: SEO batch 42 — Deftones vs Godsmack nu-metal/alt-metal contrast
  'abe-cunningham-vs-shannon-larkin': {
    ...
    metaDescription: 'Deftones\' Abe Cunningham vs Godsmack\'s Shannon Larkin. Atmospheric alt-metal dynamics vs hard-hitting groove rock power — two of nu-metal-era alternative metal\'s most recognizable drummers compared.',
    category: 'other',
    drummers: ['abe-cunningham', 'shannon-larkin'],
    comparison: {
      style: 'Abe Cunningham has been Deftones\' sole drummer since the band formed in Sacramento, California in 1988 — his playing prioritizes emotional arc, space, and dynamic texture over technical showmanship, shifting effortlessly between whisper-quiet shimmer and thundering heaviness across nine studio albums. Shannon Larkin joined Godsmack in 2002, replacing Tommy Stewart, after stints with Ugly Kid Joe and Wrathchild America, bringing a powerful, groove-oriented hard rock approach that helped drive Godsmack\'s run of platinum albums including "Faceless" (2003) and "IV" (2006).',
      technique: 'Cunningham\'s approach relies on unconventional snare placement, creative hi-hat and ride patterns, and pocket-focused playing that mirrors Deftones\' shoegaze-influenced atmosphere — his dynamic control transitioning between crushing downbeats and delicate textures is one of alternative metal\'s most distinctive signatures. Larkin favors a deep pocket and hard-hitting backbeat that serves Godsmack\'s riff-driven hard rock songwriting, combining showmanship and energetic live delivery with the musical sensitivity to anchor the band\'s heavier, more accessible sound.',
      gear: 'Abe Cunningham plays Tama Starclassic Maple/Bubinga drums with a Tama S.L.P. Big Black Steel 14×8" snare, Zildjian cymbals (14" A New Beat Hi-Hats, A Custom crashes, K Custom Ride), a Tama Iron Cobra double pedal, and Zildjian Abe Cunningham Artist Series sticks. Shannon Larkin plays a Pearl Reference Pure kit with a Pearl Reference 14×6.5" Brass snare, Sabian AAX Series cymbals (14" Stage Hi-Hats, 18" & 19" X-Plosion Crashes, 21" Raw Bell Dry Ride, 18" AAX Chinese), a Pearl Demon Drive double pedal, and Promark Shannon Larkin Signature sticks.',
      influence: 'Cunningham has been the defining rhythmic voice of Deftones across nine studio albums and 35+ years — his drumming on "White Pony" (2000, Grammy winner) and "Diamond Eyes" (2010) helped shape alternative metal\'s atmospheric direction for a generation of drummers. Larkin\'s 20-plus years driving Godsmack\'s multi-platinum catalog, alongside his earlier hit run with Ugly Kid Joe\'s "Everything About You," established him as one of hard rock\'s most recognizable and durable drummers.',
    },
    verdict: 'Abe Cunningham and Shannon Larkin represent two contrasting faces of nu-metal-adjacent alternative and hard rock drumming. Cunningham is the master of atmospheric restraint — his unconventional patterns and dynamic control are inseparable from Deftones\' shoegaze-tinged identity. Larkin is groove-driven power personified — his deep pocket and hard-hitting backbeat built Godsmack\'s commercial rock sound into a multi-platinum institution. The Deftones vs Godsmack matchup is one of metal\'s most compelling commercial cross-genre contrasts.',
    faqs: [
      { q: 'Who is the better drummer, Abe Cunningham or Shannon Larkin?', a: 'Both are exceptional in different lanes. Cunningham excels at atmospheric dynamics and unconventional groove that define Deftones\' emotional textures. Larkin excels at hard-hitting power and deep pocket that drove Godsmack\'s multi-platinum hard rock catalog. The choice depends on whether you value atmospheric subtlety or groove-driven power.' },
      { q: 'What drum kit does Abe Cunningham use compared to Shannon Larkin?', a: 'Abe Cunningham plays Tama Starclassic Maple/Bubinga drums with Zildjian cymbals and a Tama Iron Cobra double pedal. Shannon Larkin plays a Pearl Reference Pure kit with Sabian AAX cymbals and a Pearl Demon Drive double pedal.' },
      { q: 'How long has Abe Cunningham been with Deftones?', a: 'Abe Cunningham is a founding member of Deftones, having been with the band since it formed in Sacramento, California in 1988 — over 35 years as the band\'s sole drummer. His Grammy came with "Elite" (White Pony, 2000, Best Metal Performance).' },
      { q: 'What bands did Shannon Larkin play in before Godsmack?', a: 'Shannon Larkin played with thrash band Wrathchild America (1989–1991) and then Ugly Kid Joe (1991–1997), recording the hit "Everything About You," before joining Godsmack in 2002, replacing original drummer Tommy Stewart.' },
    ],
  },
};
