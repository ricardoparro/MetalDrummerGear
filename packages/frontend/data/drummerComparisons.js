...
export const drummerComparisons = {
  ...
  'martin-axenrot-vs-martin-lopez': {
    ...
    comparison: {
      ...
      technique: 'Lopez\'s technique emphasized feel and musicality over pure technicality — creative ghost notes, complex hi-hat patterns, and melodic tom work that let Opeth\'s acoustic passages breathe before its death metal sections detonated. His playing is widely considered one of progressive death metal\'s most tasteful performances. Axenrot brought a heavier, more aggressive attack to the drum chair, informed by his parallel work in death metal supergroup Bloodbath (since 2008) and black/thrash band Witchery (1997–2010). His twin-bass-drum custom DW setup gave Opeth\'s post-2006 material a more forceful low end while still honoring the progressive vocabulary Lopez had established, particularly as the band\'s songwriting shifted toward longer, more rock-oriented compositions.',
      gear: 'Martin Lopez plays Noble & Cooley Walnut drums with a Noble & Cooley Solid Shell 14"×6" Maple snare, Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 20" K Dark Medium Thin Crashes, 22" K Dark Light Ride, 18" K China), Axis Percussion double pedal, and Vic Firth American Classic 5A sticks. Martin Axenrot plays a custom hand-made DW Collector\'s Series kit with maple/gum shells built around twin bass drums and a matching custom DW snare, with SABIAN HHX/AAX cymbals (15" HHX Groove Hats, 10" AAX Splash, 18" HHX Evolution O-Zone Crash, 12" HHX Splash, 21" HHX Legacy Ride, 20" HHX Chinese), a pedal setup not independently verified, and Pro-Mark sticks.',
    ...
    faqs: [
      ...
      { q: 'What gear does Martin Axenrot use vs Martin Lopez?', a: 'Martin Axenrot plays a custom hand-made DW kit with twin bass drums, a matching custom DW snare, and SABIAN HHX/AAX cymbals. Martin Lopez plays Noble & Cooley Walnut drums with a Noble & Cooley 14"×6" Maple snare and Zildjian K Dark Series cymbals.' },
    ],
  },
  ...
  'dirk-verbeuren-vs-paul-bostaph': {
    ...
    comparison: {
      ...
      gear: 'Dirk Verbeuren plays Tama Starclassic Walnut/Birch drums with a Tama S.L.P. Big Black Steel 14"×6.5" snare, Meinl Byzance Brilliant & Classics Custom Dark cymbals (14" Byzance Brilliant Hi-Hats, 18"/19"/20"/21" Classics Custom Dark Crashes, 22" Byzance Brilliant Ride, 18" Byzance Brilliant China), Tama Speed Cobra 910 double pedal, and Promark Shira Kashi Oak 5B sticks. Paul Bostaph plays a ddrum Paladin Series kit with a ddrum Paladin 14"×6.5" Maple snare, Zildjian A Custom Series cymbals (14" Hi-Hats, 18" & 19" Crashes, 21" Ride, 18" China), ddrum Mercury double pedal, and Vic Firth American Classic 5B sticks.',
  ...
  'paul-bostaph-vs-dave-lombardo': {
    ...
    faqs: [
      ...
      { q: 'What gear do Paul Bostaph and Dave Lombardo use?', a: 'Dave Lombardo plays a Pearl Masters Maple Complete kit with a Pearl Dave Lombardo Signature snare and Paiste RUDE & 2002 Series cymbals. Paul Bostaph plays a ddrum Paladin Series kit with a ddrum Paladin snare and Zildjian A Custom Series cymbals. Both use Vic Firth American Classic 5B sticks.' },
    ],
  },
  ...
  'martin-axenrot-vs-lars-ulrich': {
    ...
    comparison: {
      ...
      technique: 'Axenrot brought a heavier, more aggressive attack to Opeth\'s drum chair than his predecessor, informed by his parallel extreme metal work in Bloodbath and Witchery — his twin-bass-drum custom DW setup gave the band\'s post-2006 material a more forceful low end while still honoring the progressive vocabulary Opeth had established, particularly as the songwriting shifted toward longer, more rock-oriented compositions. Ulrich is a feel-driven player whose drumming serves Metallica\'s songs above all else — powerful, punchy patterns, mid-tempo stomp on the genre-defining classics, and double bass intensity on the speed tracks, locking in with Hetfield\'s rhythm guitar to create one of metal\'s tightest rhythm section bonds rather than chasing technical complexity.',
    ...
    faqs: [
      ...
      { q: 'What gear do Martin Axenrot and Lars Ulrich use?', a: 'Martin Axenrot plays a custom hand-made DW kit with twin bass drums, a matching custom DW snare, and SABIAN HHX/AAX cymbals. Lars Ulrich plays a Tama Starclassic Maple kit with his signature Tama LU1465 snare and Zildjian A Custom cymbals, powered by a Tama Iron Cobra 900 Power Glide double pedal and Ahead signature aluminum sticks.' },
  ...
  'chris-adler-vs-travis-orbin': {
    ...
    metaTitle: 'Chris Adler vs Travis Orbin — Groove Metal Precision vs Djent-Defining Technicality | MetalForge',
    metaDescription: 'Lamb of God\'s Chris Adler vs Periphery founding drummer Travis Orbin. Groove metal\'s triplet precision compared to djent\'s polymetric technicality — gear, technique, and influence analyzed.',
    category: 'progressive',
    ...
    faqs: [
      ...
      { q: 'What band is Travis Orbin known for founding djent with?', a: 'Travis Orbin was the founding studio drummer on Periphery\'s self-titled 2010 debut album, a record widely credited with helping define the djent genre, before leaving the band in 2012.' },
  ...
  'travis-orbin-vs-mike-mangini': {
    ...
    faqs: [
      { q: 'What is the difference between Travis Orbin\'s and Mike Mangini\'s drumming styles?', a: 'Travis Orbin built djent\'s polymetric template with precise double bass work and electronic triggers on Periphery\'s 2010 debut. Mike Mangini brings a scientific, biomechanically optimized approach built on world-record drumming speed to Dream Theater\'s progressive metal material.' },
      ...
      { q: 'What is the connection between Travis Orbin, Mike Mangini, and djent?', a: 'Travis Orbin was the founding studio drummer on Periphery\'s self-titled 2010 debut, a record widely credited with helping define djent. Mike Mangini is not a djent drummer himself, but his scientific approach to progressive metal technique with Dream Theater is frequently discussed alongside djent\'s technical drummers as part of the same modern progressive metal conversation.' },
      { q: 'Who holds Guinness World Records for drumming speed, Travis Orbin or Mike Mangini?', a: 'Mike Mangini holds multiple Guinness World Records for drumming speed, a distinction built before he joined Dream Theater in 2010. Travis Orbin is not a record holder but is widely regarded for his polymetric precision and creative use of electronic triggers on Periphery\'s foundational djent recordings.' },
    ],
  },
