...
export const drummerComparisons = {
  ...
  'paul-mazurkiewicz-vs-tim-yeung': {
    ...
    comparison: {
      ...
      gear: 'Paul Mazurkiewicz plays Pearl Reference Series drums with Sabian cymbals, maintaining a robust, traditional death metal setup that has evolved alongside Cannibal Corpse\'s recording career from early extreme metal production to modern high-definition studio recordings. His Pearl reference setup prioritizes warm, powerful tone that sits in the low end of brutal death metal production. Tim Yeung plays Tama Starclassic Bubinga drums with Sabian cymbals across multiple projects — a similarly configured setup but tuned for maximum attack and definition at high blast tempos, with his Tama Speed Cobra 910 double pedal optimized for the single-stroke speed that his verified blast BPM records require.',
