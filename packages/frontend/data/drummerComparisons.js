...
export const drummerComparisons = {
  ...
  // Issue #2999: SEO batch 35 — Ben Koller vs Blake Richardson (mathcore chaos vs progressive precision)
  'ben-koller-vs-blake-richardson': {
    slug: 'ben-koller-vs-blake-richardson',
    title: 'Ben Koller vs Blake Richardson',
    metaTitle: 'Ben Koller vs Blake Richardson — Mathcore Chaos vs Progressive Precision | MetalForge',
    metaDescription: 'Converge\'s Ben Koller vs Between the Buried and Me\'s Blake Richardson. Two of extreme progressive metal\'s most technically demanding drummers compared — chaos-driven intensity vs composed metric modulation.',
    category: 'progressive',
    drummers: ['ben-koller', 'blake-richardson'],
    comparison: {
      style: 'Ben Koller has been Converge\'s drummer since late 1999, anchoring the mathcore and metalcore landmark "Jane Doe" (2001) and every studio album since — "You Fail Me" (2004), "Axe to Fall" (2009), "All We Love We Leave Behind" (2012), and "The Dusk in Us" (2017), the latter earning a Grammy nomination. His playing is chaos-driven and emotionally explosive, built for hardcore\'s unpredictable song structures and sudden tempo shifts. He also co-founded heavy rock band Mutoid Man with Stephen Brodsky and joined supergroup Killer Be Killed alongside members of Mastodon and The Dillinger Escape Plan. Blake Richardson has been Between the Buried and Me\'s drummer since early 2005, powering the band\'s genre-blending progressive death metal across "Colors" (2007), "The Great Misdirect" (2009), "The Parallax II: Future Sequence" (2012), "Automata I & II" (2018), and "Colors II" (2023). His playing is composed and architectural — precise metric modulation and jazz-informed complexity layered into songs that shift genre by the measure rather than the album.',
      technique: 'Koller\'s technique prioritizes raw power and organic dynamics over machine-like precision — his blast beats and hardcore-punk-rooted fills feel volatile and reactive, mirroring Converge\'s unpredictable song structures and Kurt Ballou\'s dense, chaotic guitar work. Richardson\'s technique is built around metric modulation, jazz-influenced ghost notes, and seamless transitions between death metal blast beats and delicate, almost fusion-like passages — a compositional approach that treats odd time signatures as a natural language rather than a technical showcase. Where Koller channels chaos into intensity, Richardson channels complexity into architecture.',
      gear: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14×6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), powered by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks — a streamlined, hard-hitting setup built for raw impact. Blake Richardson plays a Tama Starclassic Bubinga kit in a custom finish with a Tama STARPHONIC 14×6" Brass snare and Sabian cymbals (14" HHX Evolution Hi-Hats, 18" HHX Evolution Crash, 17" & 21" AAX Holy Chinas, 21" HH Raw Bell Dry Ride, plus a 10" HH Duo Splash and 9" Radia Cup Chime for textural detail), driven by twin Tama Iron Cobra Power Glide single pedals for independent double-kick patterns and Vic Firth American Classic 3A sticks.',
      influence: 'Koller is widely regarded as one of the most important drummers in modern heavy music, having helped define mathcore and metalcore\'s rhythmic vocabulary through Converge\'s quarter-century run — his intensity and genre-crossing versatility across Mutoid Man and Killer Be Killed have made him an icon of underground extreme music. Richardson has become a touchstone for the modern progressive metal generation, frequently cited alongside Terry Bozzio, Dennis Chambers, and Tomas Haake as an influence, with his Grammy-nominated work on "Colors" and "The Dusk in Us"-era BTBAM records helping define the genre-blending sound of 2010s and 2020s progressive metal.',
    },
    verdict: 'Ben Koller and Blake Richardson represent extreme progressive metal\'s two most technically demanding poles. Koller is mathcore\'s chaos-driven force — volatile, emotionally intense, and built for hardcore\'s sudden turns. Richardson is progressive metal\'s composed architect — precise metric modulation and jazz-informed complexity built into every measure. Both answer the question "who is more technically demanding?" from opposite directions: Koller through explosive unpredictability, Richardson through structured intricacy.',
    faqs: [
      { q: 'Who is more technically demanding — Ben Koller or Blake Richardson?', a: 'Both are considered among the most technically demanding drummers in heavy music, but in different ways. Ben Koller (Converge) is chaos-driven and emotionally explosive, built for mathcore\'s unpredictable song structures. Blake Richardson (Between the Buried and Me) is composed and architectural, built around metric modulation and jazz-informed complexity. Koller by raw intensity and unpredictability; Richardson by compositional precision.' },
      { q: 'What bands has Ben Koller played in?', a: 'Ben Koller has been Converge\'s drummer since 1999, and also plays in Mutoid Man (with Stephen Brodsky of Cave In), Killer Be Killed (with members of Mastodon and The Dillinger Escape Plan), and All Pigs Must Die.' },
      { q: 'What gear do Ben Koller and Blake Richardson use?', a: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals. Blake Richardson plays a Tama Starclassic Bubinga kit with a Tama STARPHONIC 14x6" Brass snare and Sabian cymbals, including 17" and 21" AAX Holy Chinas.' },
      { q: 'How long has Blake Richardson been in Between the Buried and Me?', a: 'Blake Richardson joined Between the Buried and Me in early 2005 and has been the band\'s drummer ever since, recording landmark albums including "Colors" (2007), "The Great Misdirect" (2009), "The Parallax II: Future Sequence" (2012), and "Colors II" (2023).' },
    ],
  },

  // Issue #2999: SEO batch 35 — Mikkey Dee vs Vinnie Paul (classic heavy metal legends tribute)
  'mikkey-dee-vs-vinnie-paul': {
    slug: 'mikkey-dee-vs-vinnie-paul',
    title: 'Mikkey Dee vs Vinnie Paul',
    metaTitle: 'Mikkey Dee vs Vinnie Paul — Two Heavy Metal Legends Compared | MetalForge',
    metaDescription: 'Motörhead\'s Mikkey Dee vs Pantera\'s Vinnie Paul. Two of heavy metal\'s most powerful drummers compared — 23 years driving Lemmy\'s rock \'n\' roll machine vs the groove metal architecture that defined the 1990s.',
    category: 'thrash',
    drummers: ['mikkey-dee', 'vinnie-paul'],
    comparison: {
      style: 'Mikkey Dee spent 23 years (1992–2015) as Motörhead\'s drummer, providing the powerful, hard-hitting engine behind Lemmy Kilmister\'s relentless rock \'n\' roll machine across albums like "Bastards" (1993) and "Inferno" (2004), before joining German rock legends Scorpions in 2016. Before Motörhead, he drummed for King Diamond (1985–1989). Vinnie Paul co-founded Pantera in 1981 alongside his brother "Dimebag" Darrell Abbott, building one of heavy metal\'s most influential rhythm sections and defining groove metal across "Cowboys from Hell" (1990), "Vulgar Display of Power" (1992), "Far Beyond Driven" (1994), and "The Great Southern Trendkill" (1996). After Pantera\'s 2003 breakup, he formed Damageplan with Darrell, and following his brother\'s murder in 2004, went on to found Hellyeah in 2006, leading the band until his own death on June 22, 2018.',
      technique: 'Dee\'s technique is built for stamina and raw power — thunderous, hard-hitting patterns and relentless double bass that gave Motörhead\'s already-loud sound an even more punishing low end, a style that translated seamlessly into Scorpions\' classic rock anthems. Paul pioneered the "power groove" — deep, wide snare hits (famously from his signature 14×8" snare), syncopated pocket, and fills that emphasize weight over flash, locking in tightly with Dimebag Darrell\'s riffs to create one of metal\'s most influential rhythm-section partnerships.',
      gear: 'Mikkey Dee plays a Yamaha Recording Custom kit with a Yamaha Mikkey Dee Signature 14×8" snare and Zildjian A Custom & K Series cymbals (14" A Custom Hi-Hats, 18" & 19" A Custom Crashes, 22" K Custom Ride, 20" Oriental China), powered by a Yamaha FP9 double pedal and Vic Firth Mikkey Dee Signature sticks. Vinnie Paul played a ddrum Vinnie Paul Signature Series kit with a ddrum Vinnie Paul Signature 14×8" snare and Sabian AA & AAX Series cymbals (14" Hi-Hats, 18" & 19" Crashes, 21" Ride, 18" China), powered by a ddrum double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Dee\'s 23-year Motörhead tenure made him one of the most respected drummers in hard rock and metal, and his 2016 move to Scorpions proved his power and professionalism translate across generations of rock. Paul\'s groove metal template influenced virtually all of American metal that followed Pantera — several outlets have ranked him among the greatest metal drummers of all time. His death in 2018 at age 54 was mourned across the metal world as the loss of one of the genre\'s defining rhythmic architects.',
    },
    verdict: 'Mikkey Dee and Vinnie Paul are two of heavy metal\'s most powerful and influential drummers, both gone from the touring world but neither forgotten — Dee still playing with Scorpions, Paul\'s legacy carried on through Pantera\'s catalog and Hellyeah. Dee brought thunderous stamina to Motörhead\'s relentless rock \'n\' roll for 23 years. Paul invented groove metal\'s power-groove template with Dimebag Darrell and defined 1990s heavy metal. Both answer the question "who was the better heavy metal drummer?" — Dee through raw endurance and versatility, Paul through genre-defining groove and legacy.',
    faqs: [
      { q: 'Who was the better heavy metal drummer — Mikkey Dee or Vinnie Paul?', a: 'Both are considered among heavy metal\'s greatest drummers. Mikkey Dee powered Motörhead for 23 years (1992–2015) with thunderous stamina before joining Scorpions in 2016. Vinnie Paul co-founded Pantera and invented groove metal\'s "power groove" template alongside his brother Dimebag Darrell. Dee by longevity and versatility across two legendary bands; Paul by genre-defining influence on American metal.' },
      { q: 'When did Vinnie Paul die?', a: 'Vinnie Paul (born Vincent Paul Abbott) died on June 22, 2018, at age 54. He was the co-founder and drummer of Pantera, and later Damageplan and Hellyeah, alongside his brother "Dimebag" Darrell Abbott until Darrell\'s murder in 2004.' },
      { q: 'How long was Mikkey Dee in Motörhead?', a: 'Mikkey Dee was Motörhead\'s drummer for 23 years, from 1992 until Lemmy Kilmister\'s death in 2015. He then joined German rock legends Scorpions in 2016, where he continues to perform.' },
  ...
  // Issue #2999: SEO batch 35 — Derek Roddy vs Tim Yeung (technical death metal speed specialists)
  'derek-roddy-vs-tim-yeung': {
    ...
    metaDescription: 'Hate Eternal\'s Derek Roddy vs Morbid Angel\'s Tim Yeung. Two of technical and brutal death metal\'s fastest blast-beat specialists compared — gravity blast pioneer vs machine-precision speed and versatility.',
    category: 'extreme',
    drummers: ['derek-roddy', 'tim-yeung'],
    comparison: {
      style: 'Derek Roddy built his reputation across Hate Eternal (2000–2002, 2004–2005), Nile (2000–2002), and Malevolent Creation (1996–1999) as one of extreme metal\'s pioneering speed-and-endurance specialists, renowned for blast beats and innovative one-footed bass drum technique delivered with relentless precision. Beyond performing, he became a respected educator, producing instructional DVDs like "The Evolution of Blast Beats" that shaped how a generation of drummers approach extreme tempos. Tim Yeung is death metal\'s most prolific extreme session and touring drummer, with credits spanning Hate Eternal (2004–2007, 2015–present), Morbid Angel (2013–2015), Vital Remains (2001–2007), Divine Heresy, and Nile — a resume built on machine-like consistency and versatility across the genre\'s most demanding subgenres.',
      technique: 'Roddy\'s technique centers on raw blast-beat velocity and stamina — his single-stroke and one-footed bass drum approaches were built for sustained brutality across entire albums, and his instructional materials have made his methods a reference point for extreme metal drummers worldwide. Yeung\'s technique emphasizes clarity and power at sustained high tempos, with the ability to navigate between brutal death metal, technical death metal, and industrial death metal without losing precision — a versatility that has made him one of the genre\'s most in-demand touring and session players.',
      gear: 'Derek Roddy plays a Tama Starclassic Bubinga kit with a Tama SLP Black Brass 14×6.5" snare and Meinl Byzance & Mb20 Series cymbals (14" Byzance Heavy Hi-Hats, 18" & 19" Mb20 Heavy Crashes, 21" Mb20 Heavy Ride, 18" Byzance China), powered by a Tama Speed Cobra 910 double pedal and Vic Firth Derek Roddy Signature sticks. Tim Yeung plays a Tama Starclassic Bubinga kit with a Tama S.L.P. Big Black Steel 14×6.5" snare and Sabian AAX & HHX Series cymbals (14" AAX Stage Hi-Hats, 18" & 19" AAX X-Plosion Crashes, 21" HHX Raw Bell Dry Ride), also powered by a Tama Speed Cobra 910 double pedal, with Vic Firth American Classic 5A sticks.',
      influence: 'Roddy is widely regarded as one of extreme metal\'s pioneering speed specialists, with his instructional content shaping how a generation of death metal drummers approach blast beats and bass drum technique. Yeung\'s career as death metal\'s most prolific working extreme drummer represents the upper limit of what a technical death metal specialist can achieve across multiple demanding bands, inspiring drummers pursuing maximum speed and cross-genre versatility.',
    },
    verdict: 'Derek Roddy and Tim Yeung represent technical and brutal death metal\'s speed specialists from two complementary angles. Roddy is the pioneering educator — his blast beat innovations and instructional legacy defined how extreme metal drummers train for speed and endurance. Yeung is the genre\'s most prolific working speed demon — machine-precise, versatile across subgenres, and one of the most in-demand touring drummers in death metal. Both answer the question "who is faster?" — Roddy through pioneering technique, Yeung through sustained, cross-genre velocity.',
    faqs: [
      { q: 'Who is faster — Derek Roddy or Tim Yeung?', a: 'Both are among technical death metal\'s fastest drummers. Derek Roddy (Hate Eternal, Nile) pioneered modern blast-beat and one-footed bass drum technique, becoming a benchmark for extreme metal speed and an influential educator. Tim Yeung (Morbid Angel, Vital Remains, Hate Eternal) is renowned for machine-like consistency and speed sustained across some of death metal\'s most demanding subgenres. Roddy by pioneering technique; Yeung by prolific, versatile velocity.' },
      { q: 'What is the difference between Derek Roddy and Tim Yeung?', a: 'Derek Roddy is best known as a pioneering blast-beat innovator and extreme metal educator, having developed one-footed bass drum techniques and produced widely used instructional DVDs. Tim Yeung is best known as death metal\'s most prolific touring and session drummer, having played in more major extreme metal bands — including Morbid Angel, Vital Remains, Hate Eternal, and Divine Heresy — than almost any of his peers.' },
      { q: 'What bands has Tim Yeung played in?', a: 'Tim Yeung has played with Hate Eternal (2004–2007, 2015–present), Morbid Angel (2013–2015), Vital Remains (2001–2007), Divine Heresy, and Nile, making him one of the most prolific and versatile touring drummers in death metal.' },
