...
export const drummerComparisons = {
  ...
  'bill-ward-vs-matt-greiner': {
    ...
    metaTitle: 'Bill Ward vs Matt Greiner — Heavy Metal\'s Origin vs Grammy-Nominated Metalcore | MetalForge',
    metaDescription: 'Black Sabbath\'s Bill Ward vs August Burns Red\'s Matt Greiner: the jazz-swing originator who invented heavy metal drumming vocabulary compared to metalcore\'s Grammy-nominated technical stylist. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['bill-ward', 'matt-greiner'],
    comparison: {
      style: 'Bill Ward co-founded Black Sabbath in Birmingham, England in 1968 alongside Tony Iommi, Geezer Butler, and Ozzy Osbourne, and, shaped by jazz heroes Gene Krupa and Buddy Rich, helped invent the vocabulary of heavy metal drumming itself on landmark records like "Black Sabbath" (1970), "Paranoid" (1970), and "Master of Reality" (1971). Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania in 2003 and has anchored the band\'s Grammy-nominated catalog for over two decades, bringing a jazz-informed sense of dynamics and odd-time sophistication to records including "Found in Far Away Places" (2015) and "Guardians" (2020).',
      technique: 'Ward\'s technique is rooted in open, swinging jazz feel rather than technical precision — his loose grip and behind-the-beat phrasing gave early Sabbath riffs like "Iron Man" and "War Pigs" a heavy, rolling groove that no other rock drummer of the era was playing, emphasizing feel and space over speed. Greiner incorporates similar jazz-influenced dynamics into a far more technical framework, weaving creative stacked-cymbal work, rapid-fire double bass, and odd time signatures seamlessly into August Burns Red\'s metalcore song structures rather than showcasing them as a display of pure aggression.',
      gear: 'Bill Ward played a Ludwig Super Classic (later Ludwig Classic Maple) kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals (15" Giant Beat Hi-Hats, 18" & 20" 2002 Crashes, a massive 24" 2002 Ride, 18" 2002 China), driven by a single Ludwig Speed King pedal — no double bass throughout his entire career. Matt Greiner plays a Pearl Reference Pure kit in Piano Black with his own Pearl Matt Greiner Signature 14x6" steel snare and Meinl Byzance cymbals (15" Dual Hi-Hats, 18" & 19" Extra Dry Medium Crashes, 21" Transition Ride, 18" Extra Dry China), driven by a Pearl Demon Drive double pedal and Vic Firth Matt Greiner Signature sticks.',
      influence: 'Ward is widely credited as one of the true originators of heavy metal drumming — his jazz-informed, swinging approach to Black Sabbath\'s riffs created the rhythmic template that every subsequent metal drummer, including Greiner, built upon, earning him a 2006 Rock and Roll Hall of Fame induction. Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through his signature Pearl snare and worldwide drum clinics.',
    },
    verdict: 'Bill Ward and Matt Greiner represent two foundational, cross-era pillars of metal drumming built on the same jazz-swing DNA. Ward invented heavy metal\'s drumming vocabulary from that jazz foundation, creating the genre\'s rhythmic template with Black Sabbath starting in 1968. Greiner built on that legacy 35 years later, channeling jazz-informed dynamics into Grammy-nominated metalcore precision with August Burns Red. Comparing them is comparing metal\'s birth to one of its most technically sophisticated modern descendants — the originator versus the jazz-schooled metalcore stylist.',
    faqs: [
      { q: 'Did Bill Ward influence Matt Greiner?', a: 'Bill Ward\'s pioneering work with Black Sabbath created the foundational, jazz-informed rhythmic vocabulary of heavy metal drumming that every metal drummer who followed — including modern metalcore players like Matt Greiner — built upon, even across five decades and multiple subgenre shifts.' },
      { q: 'What gear did Bill Ward and Matt Greiner use?', a: 'Bill Ward played a Ludwig Super Classic/Classic Maple kit with Paiste 2002 & Giant Beat Series cymbals and a single Ludwig Speed King pedal — no double bass. Matt Greiner plays a Pearl Reference Pure kit with his signature Pearl 14x6" steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal.' },
      { q: 'Has August Burns Red won a Grammy?', a: 'No — August Burns Red, featuring Matt Greiner, has received two Grammy nominations for Best Metal Performance, in 2016 and 2020, but has not won.' },
      { q: 'Did Bill Ward ever use a double bass pedal?', a: 'No. Bill Ward built Black Sabbath\'s foundational heaviness entirely with a single Ludwig Speed King pedal, relying on touch and jazz-informed technique rather than extra hardware — a contrast to Matt Greiner, who drives August Burns Red\'s metalcore with a Pearl Demon Drive double pedal.' },
    ],
  },
  ...
  'bill-ward-vs-gavin-harrison': {
    ...
    metaTitle: 'Bill Ward vs Gavin Harrison — Heavy Metal\'s Origin vs Progressive Rock\'s Polyrhythm Master | MetalForge',
    metaDescription: 'Black Sabbath\'s Bill Ward vs Porcupine Tree/King Crimson\'s Gavin Harrison: the jazz-swing originator who invented heavy metal drumming vocabulary compared to progressive rock\'s most studied polyrhythmic technician. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['bill-ward', 'gavin-harrison'],
    comparison: {
      style: 'Bill Ward co-founded Black Sabbath in Birmingham, England in 1968 alongside Tony Iommi, Geezer Butler, and Ozzy Osbourne, and, shaped by jazz heroes Gene Krupa and Buddy Rich, helped invent the vocabulary of heavy metal drumming itself on landmark records like "Black Sabbath" (1970), "Paranoid" (1970), and "Master of Reality" (1971). Gavin Harrison built his reputation as an in-demand session and touring drummer for artists including Iggy Pop and Kevin Ayers before joining progressive rock band Porcupine Tree in 2002, where his polyrhythmic sophistication shaped "In Absentia" (2002), "Deadwing" (2005), and "Fear of a Blank Planet" (2007); he joined progressive rock institution King Crimson\'s three-drummer lineup in 2008 and has also drummed for The Pineapple Thief since 2016.',
      technique: 'Ward\'s technique is rooted in open, swinging jazz feel rather than technical precision — his loose grip and behind-the-beat phrasing gave early Sabbath riffs like "Iron Man" and "War Pigs" a heavy, rolling groove that no other rock drummer of the era was playing, emphasizing feel and dynamics over calculated complexity. Harrison specializes in linear drumming and polyrhythmic layering, using deep musical instinct and meticulous ghost-note weaving through odd time signatures to make technically impossible grooves feel natural, treating space and cymbal decay as compositional tools rather than chasing raw volume.',
      gear: 'Bill Ward played a Ludwig Super Classic (later Ludwig Classic Maple) kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals (15" Giant Beat Hi-Hats, 18" & 20" 2002 Crashes, a massive 24" 2002 Ride, 18" 2002 China), driven by a single Ludwig Speed King pedal — no double bass throughout his entire career. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells (22"x17" bass drum, 10"/12" rack toms, 14"/16" floor toms), his own Sonor Gavin Harrison Signature snares (14x5.25" brass primary, 12x5" Protean), and Zildjian K Custom Special Dry cymbals developed in direct collaboration with him, paired with his Vic Firth Gavin Harrison Signature stick.',
      influence: 'Ward is widely credited as one of the true originators of heavy metal drumming — his jazz-informed, swinging approach to Black Sabbath\'s riffs created the rhythmic template that every subsequent metal drummer built upon, earning him a 2006 Rock and Roll Hall of Fame induction. Harrison\'s Zildjian K Custom Special Dry series changed how a generation of progressive drummers think about cymbal decay and controlled sound, and his multiple Modern Drummer awards cement him as one of progressive music\'s most studied players.',
    },
    verdict: 'Bill Ward and Gavin Harrison sit at opposite ends of metal and progressive rock\'s drumming lineage, separated by more than three decades and an entirely different musical philosophy. Ward invented heavy metal\'s jazz-swung, single-pedal foundation in 1968, prioritizing feel and dynamics over calculated complexity. Harrison spent decades refining polyrhythmic sophistication into a science with Porcupine Tree and King Crimson, making the impossibly complex feel effortless. Both drummers built their reputations on jazz-rooted foundations, but Ward channeled that foundation into metal\'s birth, while Harrison channeled it into progressive rock\'s most cerebral corners.',
    faqs: [
      { q: 'Did Bill Ward influence Gavin Harrison?', a: 'Bill Ward\'s pioneering, jazz-informed work with Black Sabbath helped create the foundational rhythmic vocabulary of heavy metal drumming. Gavin Harrison built his career primarily within progressive rock rather than metal, but both drummers draw on the same jazz lineage — Ward through swing feel, Harrison through polyrhythmic precision.' },
      { q: 'What gear did Bill Ward and Gavin Harrison use?', a: 'Bill Ward played a Ludwig Super Classic/Classic Maple kit with Paiste 2002 & Giant Beat Series cymbals and a single Ludwig Speed King pedal — no double bass. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells, his own Sonor Gavin Harrison Signature brass snare, and Zildjian K Custom Special Dry cymbals developed specifically with him.' },
      { q: 'What bands are Bill Ward and Gavin Harrison known for?', a: 'Bill Ward co-founded and drummed for Black Sabbath from 1968 to 1983, and again from 1997 to 2006. Gavin Harrison is best known for Porcupine Tree (since 2002) and King Crimson (since 2008), and also drums for The Pineapple Thief.' },
      { q: 'Did Bill Ward ever use a double bass pedal?', a: 'No. Bill Ward built Black Sabbath\'s foundational heaviness entirely with a single Ludwig Speed King pedal, relying on touch and jazz-informed swing rather than extra hardware — a contrast to Gavin Harrison, whose progressive rock work with Porcupine Tree and King Crimson relies on meticulous polyrhythmic layering rather than raw double-bass power.' },
    ],
  },
  ...
  'matt-greiner-vs-hellhammer': {
    ...
    metaDescription: 'August Burns Red\'s Matt Greiner vs Mayhem\'s Hellhammer: jazz-informed metalcore technicality compared to cold, relentless second-wave black metal blast beats. Gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['matt-greiner', 'hellhammer'],
    comparison: {
      style: 'Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania in 2003 and has anchored the band\'s Grammy-nominated catalog for over two decades, bringing a jazz-informed sense of dynamics rare in the genre to records including "Found in Far Away Places" (2015) and "Guardians" (2020). Hellhammer (born Jan Axel Blomberg, August 2, 1969, in Oslo, Norway) joined Mayhem in 1988 as a teenager, replacing founding drummer Manheim, and delivered the genre-defining blast beats on "De Mysteriis Dom Sathanas" (1994) — the recording against which every subsequent black metal drum performance is measured — while running a parallel career with Dimmu Borgir since 1999 and co-founding Arcturus.',
      technique: 'Greiner brings jazz-influenced dynamics, creative stacked-cymbal work, and rapid-fire double bass into metalcore\'s heavy foundation, weaving odd time signatures seamlessly into August Burns Red\'s song structures rather than showcasing them as a technical display. Hellhammer\'s blast beats are built on cold, relentless one-foot precision, and he famously plays barefoot for the direct tactile feedback he says is essential to holding tempo accuracy at extreme speeds — a machine-like consistency built for atmosphere and aggression rather than musical dynamics.',
      gear: 'Matt Greiner plays a Pearl Reference Pure kit in Piano Black with his own Pearl Matt Greiner Signature 14x6" steel snare and Meinl Byzance cymbals (15" Dual Hi-Hats, 18" & 19" Extra Dry Medium Crashes, 21" Transition Ride, 18" Extra Dry China), driven by a Pearl Demon Drive double pedal and Vic Firth Matt Greiner Signature sticks. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals (14" A Custom Hi-Hats, 17" & 19" A Custom Crashes, 20" Z Custom Dark Ride, 18" A China Boy), driven by a Pearl Demon Drive double pedal and Vic Firth American Classic 5B sticks — both drummers share a Pearl Reference kit and Pearl Demon Drive double pedal despite operating in opposite corners of heavy music.',
      influence: 'Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through his signature Pearl snare and worldwide drum clinics. Hellhammer defined the sound and speed vocabulary of second-wave black metal, and his three-decade-plus dual career with Mayhem and Dimmu Borgir has made him the genre\'s most in-demand extreme drummer for both raw and symphonic contexts.',
    },
    verdict: 'Matt Greiner and Hellhammer both drive their genres\' technical ceilings, but from very different rhythmic philosophies. Greiner channels jazz-informed musicality into Grammy-nominated metalcore, proving technical drumming doesn\'t require sacrificing dynamic range or groove. Hellhammer built his reputation on cold, icy blast-beat precision that turned raw speed itself into black metal\'s defining texture on "De Mysteriis Dom Sathanas." Sharing a Pearl Reference foundation and Demon Drive double pedal, the two drummers prove that identical gear can be pointed toward completely opposite musical goals — sophisticated dynamics versus atmosphere-first extremity.',
    faqs: [
      { q: 'How do Matt Greiner and Hellhammer compare as drummers?', a: 'Matt Greiner (August Burns Red) weaves jazz-informed dynamics and odd time signatures into Grammy-nominated metalcore. Hellhammer (Mayhem, Dimmu Borgir) delivers cold, relentless blast beats with icy one-foot precision that defined second-wave black metal\'s speed vocabulary. Greiner represents technical musicality; Hellhammer represents raw, atmosphere-first extremity.' },
      { q: 'What gear do Matt Greiner and Hellhammer use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his signature Pearl 14x6" steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals, also driven by a Pearl Demon Drive double pedal — both drummers share the same Pearl double-pedal system.' },
      { q: 'What bands are Matt Greiner and Hellhammer known for?', a: 'Matt Greiner co-founded and has drummed for metalcore band August Burns Red since 2003. Hellhammer has drummed for Mayhem since 1988 and Dimmu Borgir since 1999, alongside co-founding Arcturus.' },
      { q: 'Does Hellhammer play barefoot?', a: 'Yes — Hellhammer famously plays barefoot, saying the direct tactile feedback is essential to holding his icy, relentless blast-beat tempo accuracy at extreme speeds with Mayhem and Dimmu Borgir. Matt Greiner plays in standard footwear with August Burns Red.' },
    ],
  },
  ...
  'matt-greiner-vs-john-otto': {
    ...
    metaTitle: 'Matt Greiner vs John Otto — Grammy-Nominated Metalcore vs Nu-Metal Pocket | MetalForge',
    metaDescription: 'August Burns Red\'s Matt Greiner vs Limp Bizkit\'s John Otto: jazz-informed metalcore technicality compared to hip-hop-infused nu-metal groove. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['matt-greiner', 'john-otto'],
    comparison: {
      style: 'Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania in 2003 and has anchored the band\'s Grammy-nominated catalog for over two decades, bringing a jazz-informed sense of dynamics rare in the genre to records including "Found in Far Away Places" (2015) and "Guardians" (2020). John Otto has been Limp Bizkit\'s drummer and founding member since 1994, blending hip-hop-influenced grooves and funk-inspired beats that helped define the rap-metal sound on hits like "Rollin\'" and "Break Stuff" — a disciplined, pocket-first sensibility that stands in sharp contrast to Greiner\'s constantly shifting metalcore complexity.',
      technique: 'Greiner brings jazz-influenced dynamics, creative stacked-cymbal work, and rapid-fire double bass into metalcore\'s heavy foundation, weaving odd time signatures seamlessly into August Burns Red\'s song structures rather than showcasing them as a technical display. Otto studied jazz at the Douglas Anderson School of the Arts, using syncopated patterns and funky ghost notes over a single-pedal setup to give Limp Bizkit\'s grooves their distinctive pocket, prioritizing restraint and feel over the constant motion that defines Greiner\'s playing.',
      gear: 'Matt Greiner plays a Pearl Reference Pure kit in Piano Black with his own Pearl Matt Greiner Signature 14x6" steel snare and Meinl Byzance cymbals (15" Dual Hi-Hats, 18" & 19" Extra Dry Medium Crashes, 21" Transition Ride, 18" Extra Dry China), driven by a Pearl Demon Drive double pedal and Vic Firth Matt Greiner Signature sticks. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual signature OCDP snares and Zildjian A Custom cymbals, driven by Gibraltar G Class pedals — Otto has never needed a double pedal, relying instead on jazz-honed foot control for Limp Bizkit\'s groove-driven single-kick patterns.',
      influence: 'Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through his signature Pearl snare and worldwide drum clinics. Otto\'s jazz-meets-hip-hop grooves gave Limp Bizkit\'s sound instant recognizability, helping drive one of the best-selling records of the nu-metal era in "Chocolate Starfish and the Hot Dog Flavored Water."',
    },
    verdict: 'Matt Greiner and John Otto both draw on jazz training, yet arrive at opposite destinations within heavy music. Greiner channels his jazz-honed instincts into Grammy-nominated metalcore\'s constantly shifting odd-time complexity with August Burns Red. Otto channels the same jazz foundation into disciplined, hip-hop-informed restraint that made Limp Bizkit\'s rap-metal commercially unstoppable. The debate is technical density versus groove-first economy — both prove jazz training can serve radically different heavy music goals.',
    faqs: [
      { q: 'How do Matt Greiner and John Otto compare as drummers?', a: 'Matt Greiner (August Burns Red) weaves jazz-informed dynamics and odd time signatures into Grammy-nominated metalcore. John Otto (Limp Bizkit) is known for disciplined, jazz-and-funk-informed grooves built around a tight single-pedal pocket. Both trained in jazz, but Greiner channels it into technical density while Otto channels it into song-serving restraint.' },
      { q: 'What gear do Matt Greiner and John Otto use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his signature Pearl 14x6" steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual signature OCDP snares, Zildjian A Custom cymbals, and Gibraltar G Class pedals.' },
      { q: 'What bands are Matt Greiner and John Otto known for?', a: 'Matt Greiner co-founded and has drummed for metalcore band August Burns Red since 2003. John Otto has been Limp Bizkit\'s drummer and founding member since 1994.' },
      { q: 'Did Matt Greiner and John Otto both study jazz?', a: 'Yes — both drummers have jazz backgrounds. Matt Greiner brings jazz-informed dynamics to August Burns Red\'s Grammy-nominated metalcore. John Otto studied jazz at the Douglas Anderson School of the Arts before co-founding Limp Bizkit in 1994, channeling that training into syncopated, funk-informed grooves.' },
    ],
  },
  ...
  'mario-duplantier-vs-ben-koller': {
    ...
    metaTitle: 'Mario Duplantier vs Ben Koller — Progressive Death Metal Groove vs Mathcore Chaos | MetalForge',
    metaDescription: 'Gojira\'s Mario Duplantier vs Converge\'s Ben Koller: tribal, polyrhythmic progressive death metal versus raw, unpredictable mathcore intensity. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['mario-duplantier', 'ben-koller'],
    comparison: {
      style: 'Mario Duplantier co-founded progressive death metal band Gojira with his brother Joe Duplantier in Bayonne, France, in 1996, building crushing double bass patterns layered with tribal, ceremonial polyrhythmic structures across albums including "From Mars to Sirius" (2005) and "Magma" (2016). Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "You Fail Me" (2004), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures; beyond Converge, he co-founded heavy rock band Mutoid Man with Stephen Brodsky of Cave In and joined the supergroup Killer Be Killed.',
      technique: 'Duplantier blends raw power with polyrhythmic complexity and an unmistakable tribal, ceremonial quality, treating blast beats as compositional tools that build tension rather than a default setting for intensity, locking into Gojira\'s tuned, resonant guitar tones with explosive fills and odd-meter grooves. Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, which is exactly what gives Converge\'s mathcore its dangerous, live-wire energy.',
      gear: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. 14x6" G-Maple snare and Meinl Byzance Series cymbals (14" Dark Hi-Hats, 18" & 20" Brilliant Heavy Hammered Crashes, 21" Transition Ride, 18" Extra Dry China), powered by a Tama Iron Cobra 900 Power Glide double pedal and Vic Firth X5A sticks. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks — both drummers build on a Tama Starclassic foundation and Iron Cobra 900 double pedal despite Gojira\'s ceremonial groove and Converge\'s mathcore chaos pulling in opposite directions.',
      influence: 'Duplantier has become one of progressive death metal\'s most influential modern voices, his tribal, polyrhythmic approach on Gojira records shaping a generation of drummers who blend technical death metal with atmospheric groove, and earning the band a Grammy nomination for "Silvera" in 2016 — the first for a French metal act. Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics.',
    },
    verdict: 'Mario Duplantier and Ben Koller share a Tama Starclassic and Iron Cobra 900 foundation, yet channel it toward opposite ends of progressive-leaning extreme music. Duplantier builds Gojira\'s tribal, ceremonial groove around dynamic tension and tuned, resonant power, treating blast beats as compositional punctuation rather than constant aggression. Koller channels raw, unpredictable chaos into Converge\'s mathcore assault, thriving on sudden tempo shifts that make his playing feel dangerous even when it\'s meticulously honed. The comparison is disciplined, ceremonial dynamics versus visceral, live-wire unpredictability — two of modern heavy music\'s most respected technicians pointed in opposite directions.',
    faqs: [
      { q: 'How do Mario Duplantier and Ben Koller compare as drummers?', a: 'Mario Duplantier co-founded Gojira in 1996 and drives the band\'s tribal, polyrhythmic progressive death metal groove, treating blast beats as compositional tools. Ben Koller has drummed for Converge since 1999, bringing loose, explosive unpredictability to the band\'s mathcore assault. Duplantier represents disciplined, ceremonial dynamics; Koller represents raw, live-wire chaos.' },
      { q: 'What gear do Mario Duplantier and Ben Koller use?', a: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. G-Maple snare and Meinl Byzance Series cymbals, powered by a Tama Iron Cobra 900 Power Glide double pedal. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal — both drummers share the same Tama double-pedal system.' },
      ...
      { q: 'Has Gojira or Converge won a Grammy?', a: 'Neither band has won a Grammy. Gojira, featuring Mario Duplantier, received a Grammy nomination for "Silvera" in 2016, the first for a French metal act. Converge, featuring Ben Koller, has not received a Grammy nomination, though "Jane Doe" (2001) is widely cited as a genre-defining mathcore record.' },
    ],
  },
};
