...
export const drummerComparisons = {
  ...
  // Issue #3768: SEO batch 48 — technical death metal peers, prog-fusion crossover, industrial/metalcore dual-kick specialists
  'hannes-grossmann-vs-tim-yeung': {
    slug: 'hannes-grossmann-vs-tim-yeung',
    title: 'Hannes Grossmann vs Tim Yeung',
    metaTitle: 'Hannes Grossmann vs Tim Yeung — Technical Death Metal Compositional Precision Compared | MetalForge',
    metaDescription: 'Obscura/Necrophagist\'s Hannes Grossmann vs Hate Eternal/Morbid Angel\'s Tim Yeung — two technical death metal architects compared on compositional complexity, raw speed, gear, and legacy.',
    category: 'extreme',
    drummers: ['hannes-grossmann', 'tim-yeung'],
    comparison: {
      style: 'Hannes Grossmann (born 1982, Germany) built his reputation on classically trained, mathematically architected drumming, recording Necrophagist\'s genre-defining "Epitaph" (2004) before joining Obscura for "Cosmogenesis" (2009) and "Omnivium" (2011), two albums widely cited as benchmarks for technical death metal composition, and later co-founding Alkaloid. Tim Yeung (born 1978, USA) took a different route through extreme metal\'s most demanding drum chairs — Divine Heresy, Vital Remains, Hate Eternal, and a high-profile stint filling in for Morbid Angel and Nile — earning a reputation as one of death metal\'s fastest and most reliable hired guns, capable of executing brutally difficult parts written by others at full speed.',
      technique: 'Grossmann\'s technique is rooted in classical percussion training and open-handed playing — he frequently leads with his left hand on hi-hat or ride rather than crossing hands, unlocking limb-independence voicings that let him construct genuinely composed polyrhythms rather than just technical flash. Yeung\'s technique centers on blistering, machine-consistent execution — his blast beats and double bass endurance let him step into other drummers\' catalogs (Morbid Angel, Nile) and reproduce notoriously difficult parts note-for-note under touring pressure, a skill set built for stamina and precision rather than compositional invention.',
      gear: 'Hannes Grossmann plays a DW Collectors Series kit with a DW Collectors 14x5.5" Maple snare and Meinl Byzance Series cymbals (14" Byzance Traditional Hi-Hats, 18" & 19" Byzance Brilliant Crashes, 21" Byzance Traditional Ride), driven by a DW 9000 Series double pedal and Vic Firth American Classic 5B sticks. Tim Yeung plays a Tama Starclassic Bubinga kit with a Tama S.L.P. Big Black Steel 14x6.5" snare and Sabian AAX & HHX Series cymbals (14" AAX Stage Hi-Hats, 18" & 19" AAX X-Plosion Crashes, 21" HHX Raw Bell Dry Ride), driven by a Tama Speed Cobra 910 double pedal and Vic Firth American Classic 5A sticks.',
      influence: 'Grossmann\'s work on "Epitaph," "Cosmogenesis," and "Omnivium" pushed technical death metal\'s compositional ceiling for structural complexity, and he continues extending that legacy through Alkaloid and Blotted Science. Yeung has become one of extreme metal\'s most in-demand session and touring drummers precisely because of his reliability under pressure — bands facing a drummer departure or injury have repeatedly turned to him to hold a demanding live show together, a different but equally valuable form of influence within the death metal touring ecosystem.',
    },
    verdict: 'Hannes Grossmann and Tim Yeung represent two different kinds of technical death metal mastery. Grossmann is the composer-drummer, whose classically trained, open-handed approach on Necrophagist\'s "Epitaph" and Obscura\'s "Cosmogenesis"/"Omnivium" helped define the genre\'s modern structural ambitions. Yeung is the specialist executor, whose speed and reliability have made him extreme metal\'s go-to drummer for holding together some of the genre\'s most technically unforgiving live catalogs. Comparing them highlights two equally essential but distinct paths to technical death metal respect — writing the impossible parts versus flawlessly delivering them.',
    faqs: [
      { q: 'Who is technically more skilled, Hannes Grossmann or Tim Yeung?', a: 'They excel in different disciplines. Hannes Grossmann\'s skill set is rooted in classically trained, open-handed compositional drumming developed on Necrophagist\'s "Epitaph" and Obscura\'s "Cosmogenesis" and "Omnivium." Tim Yeung\'s skill set is rooted in raw speed, stamina, and the ability to precisely execute other drummers\' demanding parts across bands like Hate Eternal, Morbid Angel, and Nile.' },
      { q: 'What is each drummer\'s signature technique?', a: 'Hannes Grossmann\'s signature is open-handed playing — leading with his left hand on hi-hat or ride rather than crossing hands — combined with mathematically structured polyrhythms. Tim Yeung\'s signature is sustained, machine-consistent blast beats and double bass endurance that let him step into extreme metal\'s most technically demanding drum chairs on short notice.' },
      { q: 'What bands have Hannes Grossmann and Tim Yeung played in?', a: 'Hannes Grossmann recorded Necrophagist\'s "Epitaph" (2004) before joining Obscura for "Cosmogenesis" (2009) and "Omnivium" (2011), and later co-founded Alkaloid. Tim Yeung has drummed for Divine Heresy, Vital Remains, and Hate Eternal, and has filled in on tour for Morbid Angel and Nile.' },
      { q: 'What gear do Hannes Grossmann and Tim Yeung use?', a: 'Hannes Grossmann plays a DW Collectors Series kit with a DW Collectors 14x5.5" Maple snare and Meinl Byzance Series cymbals, driven by a DW 9000 Series double pedal. Tim Yeung plays a Tama Starclassic Bubinga kit with a Tama S.L.P. Big Black Steel snare and Sabian AAX & HHX Series cymbals, driven by a Tama Speed Cobra 910 double pedal.' },
    ],
  },
  ...
  'aquiles-priester-vs-morgan-agren': {
    ...
    metaDescription: 'Angra/W.A.S.P.\'s Aquiles Priester vs Mats/Morgan Band\'s Morgan Ågren — Brazilian power metal speed versus Swedish jazz-fusion experimentation. Style, technique, gear, and legacy compared.',
    category: 'progressive',
    drummers: ['aquiles-priester', 'morgan-agren'],
    comparison: {
      style: 'Aquiles Priester (born 1971, São Paulo, Brazil) built his career on blazing speed and showmanship, joining Brazilian power metal legends Angra in 2000 and recording "Rebirth" (2001), "Temple of Shadows" (2004), and "Aurora Consurgens" (2007) before adding a long tenure with American heavy metal band W.A.S.P. from 2006 onward. Morgan Ågren (born 1967, Umeå, Sweden) took the opposite career path, emerging from Swedish progressive rock and jazz fusion with the Mats/Morgan Band before crossing into metal territory through his work on Fredrik Thordendal\'s (Meshuggah) solo album "Sol Niger Within" and collaborations with Dweezil Zappa and Devin Townsend.',
      technique: 'Priester\'s technique is built for sustained extreme speed and stage presence — his double bass patterns hold at 220+ BPM while remaining clean and musical, and his playing incorporates power metal gallops alongside progressive complexity drawn from Neil Peart and Mike Portnoy. Ågren\'s technique draws directly from jazz fusion — odd-metered independence, dynamic control, and an improvisational sensibility that lets him move fluidly between delicate fusion passages and the crushing polyrhythmic weight of Meshuggah-adjacent material, prioritizing harmonic and rhythmic exploration over raw velocity.',
      gear: 'Aquiles Priester plays a Pearl Reference Series kit in custom finishes with a Pearl Reference/Signature 14x6.5" snare and Meinl Byzance Series cymbals (14" Byzance Traditional Hi-Hats, crashes, 21" Byzance Ride), driven by a Pearl Demon Chain Drive double pedal and Vic Firth Aquiles Priester Signature sticks. Morgan Ågren plays a Sonor SQ2 Beech kit with a Sonor Designer 14x5.5" Maple snare and Meinl Byzance Series cymbals (15" Sand Hi-Hats, 18" & 20" Extra Dry Crashes, 22" Foundry Reserve Ride), driven by a Sonor Giant Step double pedal and Vic Firth American Classic 5A sticks.',
      influence: 'Priester is widely regarded as one of the greatest Brazilian metal drummers, with "Temple of Shadows" considered a power metal landmark, and his return to Angra in 2023 was celebrated across the power metal community. Ågren has built a four-decade reputation as one of progressive rock and fusion\'s most technically accomplished drummers, gaining metal-world recognition through his contribution to Thordendal\'s "Sol Niger Within" and continued collaborations that keep bridging jazz fusion and extreme metal audiences.',
    },
    verdict: 'Aquiles Priester and Morgan Ågren approach the "prog-fusion crossover" from opposite directions. Priester came up through power metal and brought jazz-informed complexity (via influences like Neil Peart and Mike Portnoy) into blazing-speed, showmanship-driven performances with Angra and W.A.S.P. Ågren came up through actual jazz fusion with the Mats/Morgan Band and crossed into metal almost as a guest, lending his odd-metered, improvisational sensibility to Meshuggah-adjacent and Devin Townsend projects. Priester is the metal virtuoso who plays with fusion vocabulary; Ågren is the fusion virtuoso who plays with metal weight — both prove the two worlds are far more compatible than genre labels suggest.',
    faqs: [
      { q: 'Who is technically more skilled, Aquiles Priester or Morgan Ågren?', a: 'They come from different technical traditions. Aquiles Priester\'s skill set is rooted in sustained extreme-speed double bass and power metal showmanship built across Angra and W.A.S.P. Morgan Ågren\'s skill set is rooted in jazz-fusion independence and odd-metered improvisation developed over decades with the Mats/Morgan Band and collaborators like Dweezil Zappa.' },
      { q: 'What is each drummer\'s signature technique?', a: 'Aquiles Priester\'s signature is blazing double bass patterns sustained past 220 BPM combined with dynamic, showmanship-driven fills. Morgan Ågren\'s signature is jazz-fusion-rooted rhythmic independence and improvisational phrasing that translates fluidly into crushing polyrhythmic metal contexts.' },
      { q: 'What bands have Aquiles Priester and Morgan Ågren played in?', a: 'Aquiles Priester has drummed for Angra (2000-2012, 2023-present), W.A.S.P. (2006-present), and his own band Hangar. Morgan Ågren has drummed for the Mats/Morgan Band, Kaipa, and Fredrik Thordendal\'s Special Defects, and has collaborated with Dweezil Zappa, Devin Townsend, and Bill Laswell.' },
      { q: 'What gear do Aquiles Priester and Morgan Ågren use?', a: 'Aquiles Priester plays a Pearl Reference Series kit with a Pearl Reference/Signature snare and Meinl Byzance Series cymbals, driven by a Pearl Demon Chain Drive double pedal. Morgan Ågren plays a Sonor SQ2 Beech kit with a Sonor Designer Maple snare and Meinl Byzance Series cymbals, driven by a Sonor Giant Step double pedal.' },
    ],
  },
  ...
  'raymond-herrera-vs-chris-turner': {
    ...
    metaTitle: 'Raymond Herrera vs Chris Turner — Industrial Metal vs Progressive Metalcore Dual-Kick Drumming | MetalForge',
    metaDescription: 'Fear Factory\'s Raymond Herrera vs Oceans Ate Alaska\'s Chris Turner — the "stop-go" industrial double bass pioneer versus a viral progressive metalcore double-bass sensation. Style, technique, gear compared.',
    category: 'other',
    drummers: ['raymond-herrera', 'chris-turner'],
    comparison: {
      style: 'Raymond Herrera co-founded industrial metal pioneers Fear Factory and defined the band\'s mechanized sound through his innovative "stop-go" double bass technique on landmark albums like "Demanufacture" (1995) and "Obsolete" (1998), also composing music for video games including Ghost Recon Advanced Warfighter and Iron Man 2. Chris Turner co-founded progressive metalcore band Oceans Ate Alaska in Birmingham, UK in 2010, and became a viral social-media phenomenon through drumming playthrough videos that showcase lightning-fast footwork and complex polyrhythmic patterns across albums like "Lost Isles" (2015), "Hikari" (2017), and "Disparity" (2022).',
      technique: 'Herrera\'s technique is built around his signature "stop-go" double bass patterns — precisely timed bursts and silences that lock in with Fear Factory\'s stuttering, machine-like guitar riffs, giving industrial metal its mechanized, robotic groove. Turner\'s technique blends extreme-speed double bass footwork with complex polyrhythms layered over odd time signatures, seamlessly integrating blast beats, groove patterns, and jazz-influenced fills in a way engineered to look effortless on camera while remaining musically dense.',
      gear: 'Raymond Herrera plays a Tama Starclassic Performer kit with a Tama S.L.P. 14x5.5" Steel snare and Zildjian A Custom Series cymbals (14" Hi-Hats, 17" & 18" Crashes, 20" Ride, 18" China), driven by a DW 5000 Series double pedal and Promark 5A Oak Nylon Tip sticks. Chris Turner plays a Tama Starclassic Walnut/Birch kit in custom finish with a Tama S.L.P. 14x5.5" Vintage Hammered Steel snare and Meinl cymbals (Byzance and Pure Alloy series), driven by a Tama Speed Cobra 910 double pedal and Promark or Vic Firth 5B sticks.',
      influence: 'Herrera\'s "stop-go" double bass innovations helped define industrial metal\'s mechanized rhythmic identity and remain a reference point for any drummer locking tight, syncopated patterns to programmed-sounding riffs. Turner has become one of modern metal\'s most-followed drummers on social media, with playthrough videos accumulating tens of millions of views and inspiring a new generation of drummers to pursue extreme technical precision in the progressive metalcore and djent scenes.',
    },
    verdict: 'Raymond Herrera and Chris Turner represent double-bass innovation from two different eras of aggressive metal drumming. Herrera pioneered a mechanized, "stop-go" double bass vocabulary in the mid-1990s that gave Fear Factory\'s industrial metal its distinctly robotic groove. Turner, a generation later, brings that same dual-kick intensity into progressive metalcore, wrapping extreme footwork in polyrhythmic complexity built as much for viral video clarity as for the mix. Herrera is the genre-defining originator; Turner is the modern technical showman carrying double bass precision into the social-media era.',
    faqs: [
      { q: 'Who is technically more skilled, Raymond Herrera or Chris Turner?', a: 'They built their reputations in different eras and contexts. Raymond Herrera\'s skill set is rooted in precisely timed "stop-go" double bass patterns that defined Fear Factory\'s industrial metal sound in the 1990s. Chris Turner\'s skill set is rooted in extreme-speed double bass footwork and complex polyrhythms developed with Oceans Ate Alaska and showcased in viral playthrough videos.' },
      { q: 'What is each drummer\'s signature technique?', a: 'Raymond Herrera\'s signature is the "stop-go" double bass technique — tightly timed bursts and silences locked to Fear Factory\'s mechanized guitar riffs. Chris Turner\'s signature is extreme-speed double bass combined with complex polyrhythmic patterns over odd time signatures, blending blast beats, groove, and jazz-influenced fills.' },
      { q: 'What bands have Raymond Herrera and Chris Turner played in?', a: 'Raymond Herrera co-founded Fear Factory and has also played with Arkaea and Brujeria. Chris Turner co-founded progressive metalcore band Oceans Ate Alaska in Birmingham, UK in 2010 and has remained its drummer through albums including "Lost Isles," "Hikari," and "Disparity."' },
      { q: 'What gear do Raymond Herrera and Chris Turner use?', a: 'Raymond Herrera plays a Tama Starclassic Performer kit with a Tama S.L.P. 14x5.5" Steel snare and Zildjian A Custom Series cymbals, driven by a DW 5000 Series double pedal. Chris Turner plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. 14x5.5" Vintage Hammered Steel snare and Meinl cymbals, driven by a Tama Speed Cobra 910 double pedal.' },
    ],
  },
};
