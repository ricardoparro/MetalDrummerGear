...
export const drummerComparisons = {
  ...
  'matt-greiner-vs-matt-halpern': {
    ...
    comparison: {
      ...
      gear: 'Greiner plays Pearl Masters Maple Reserve with Sabian AAX/HHX cymbals and a Pearl Demon Drive double pedal. Halpern uses Pearl Reference Series with Meinl Byzance cymbals (Traditional Medium hi-hats, Traditional Extra Thin Hammered crashes, Sand Crash-Ride) plus his signature Artist Concept Double Down Stack and a Pearl Demon Drive double pedal — both Pearl endorsers with contrasting cymbal philosophies.',
  ...
  'mario-duplantier-vs-matt-halpern': {
    ...
    faqs: [
      ...
      { q: 'What drums does Matt Halpern play?', a: 'Matt Halpern plays Pearl Reference Series drums with Meinl Byzance cymbals (Traditional Medium hi-hats, Traditional Extra Thin Hammered crashes, Sand Crash-Ride) plus his signature Artist Concept Double Down Stack and a Pearl Demon Drive double pedal.' },
  ...
  'matt-greiner-vs-matt-garstka': {
    ...
    verdict: 'Matt Greiner and Matt Garstka are the two defining polyrhythm voices of their respective corners of technical heavy music, and both endorse Meinl Byzance cymbals despite Greiner\'s Pearl kit and Garstka\'s DW Collector\'s Series kit. Greiner built a 20-plus-year career turning Grammy-nominated metalcore into a showcase for jazz-informed dynamics and odd-time sophistication with August Burns Red. Garstka brought Berklee-trained jazz-fusion virtuosity to Animals as Leaders\' entirely instrumental, djent-rooted catalog, turning polyrhythmic complexity into fluid, conversational playing. Both share a devotion to making complex time signatures feel natural rather than showy.',
    faqs: [
  ...
  'matt-greiner-vs-eloy-casagrande': {
    ...
    faqs: [
      ...
      { q: 'What gear do Matt Greiner and Eloy Casagrande use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" Steel snare and Meinl Byzance Series cymbals, driven by a Pearl Demon Drive double pedal. Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x6.5" snare and Paiste cymbals, powered by a Tama Iron Cobra Power Glide double pedal.' },
      ...
      { q: 'Does Matt Greiner have a signature drum or stick line?', a: 'Yes — Matt Greiner has his own signature Pearl 14x6" Steel snare drum designed for metalcore applications, along with a Vic Firth Matt Greiner Signature stick model.' },
    ],
  },
  ...
  'matt-greiner-vs-george-kollias': {
    ...
    faqs: [
      ...
      { q: 'What gear do Matt Greiner and George Kollias use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" Steel snare and Meinl Byzance Series cymbals, driven by a Pearl Demon Drive double pedal. George Kollias plays a Pearl Masterworks Stadium Exotic kit with his own signature 14x6.5" Pearl snare and Zildjian cymbals, powered by the Pearl Demon XR double pedal he co-designed.' },
  ...
  'matt-greiner-vs-chris-adler': {
    ...
    faqs: [
      ...
      { q: 'What gear do Matt Greiner and Chris Adler use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" Steel snare and Meinl Byzance Series cymbals, driven by a Pearl Demon Drive double pedal. Chris Adler played a Mapex Black Panther Design Lab kit with a Mapex Chris Adler Signature 14x5.5" snare and Meinl Byzance cymbals, driven by a Mapex Falcon double pedal.' },
  ...
  'nick-augusto-vs-matt-greiner': {
    ...
    faqs: [
      ...
      { q: 'What gear do Nick Augusto and Matt Greiner use?', a: 'Nick Augusto played a Pearl Reference Pure kit with a Pearl Reference brass snare and Sabian AAX Series cymbals, powered by a Pearl Demon Drive double pedal. Matt Greiner also plays a Pearl Reference Pure kit, paired with his own Pearl Matt Greiner Signature steel snare, Meinl Byzance cymbals, and his own Vic Firth signature sticks.' },
  ...
  'matt-greiner-vs-hellhammer': {
    ...
    faqs: [
      ...
      { q: 'What gear do Matt Greiner and Hellhammer use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" Steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals, also driven by a Pearl Demon Drive double pedal.' },
  ...
  'matt-greiner-vs-john-otto': {
    ...
    comparison: {
      ...
      gear: 'Matt Greiner plays a Pearl Reference Pure kit in Piano Black with his own Pearl Matt Greiner Signature 14x6" Steel snare and Meinl Byzance cymbals (15" Dual Hi-Hats, 18" & 19" Extra Dry Medium Crashes, 21" Transition Ride, 18" Extra Dry China), driven by a Pearl Demon Drive double pedal and his own Vic Firth Matt Greiner Signature sticks. John Otto plays an Orange County Drum and Percussion (OCDP) custom kit with Zildjian A and A Custom cymbals — a groove-oriented setup that delivers the punchy, pocket-focused tones Limp Bizkit\'s hip-hop-metal crossover demands.',
    ...
    faqs: [
      ...
      { q: 'What gear do Matt Greiner and John Otto use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" Steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal. John Otto plays an Orange County Drum and Percussion (OCDP) custom kit with Zildjian A and A Custom cymbals.' },
      { q: 'Where did John Otto study drumming?', a: 'John Otto studied at the Douglas Anderson School of the Arts in Jacksonville, Florida — the same school that produced Limp Bizkit bandmates. His jazz education is evident in his sophisticated ghost-note patterns and syncopated groove work.' },
