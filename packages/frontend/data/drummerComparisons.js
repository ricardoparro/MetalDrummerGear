...
export const drummerComparisons = {
  ...
  'paul-bostaph-vs-jon-dette': {
    ...
    comparison: {
      ...
      gear: 'Paul Bostaph\'s final Slayer setup used Pearl Masters Maple Complete (MCX) drums with Sabian AAX Series cymbals, Pearl Eliminator double pedal, and Vater Power 5B sticks — a powerful, punchy configuration designed for arena-scale thrash. Jon Dette has played Ludwig Classic Maple drums since 1996, with Sabian or Zildjian cymbals and DW 9000 or Tama Iron Cobra double pedals — a stable core kit paired with the touring versatility multiple bands\' requirements demanded.',
