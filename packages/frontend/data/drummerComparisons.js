...
export const drummerComparisons = {
  ...
  'dirk-verbeuren-vs-chris-adler': {
    ...
    comparison: {
      ...
      gear: 'Dirk endorses Tama Starclassic Maple drums with Meinl Byzance Brilliant & Classics Custom Dark cymbals for versatile attack. Chris played Mapex Black Panther Design Lab drums with Meinl Byzance cymbals for a dark, aggressive tone.',
  ...
  'paul-mazurkiewicz-vs-pete-sandoval': {
    ...
    comparison: {
      ...
      gear: 'Paul Mazurkiewicz plays a Pearl Reference Series kit with a Pearl Free-Floating 14x6.5" steel snare and Meinl Classics Custom / Byzance Series cymbals, driven by a Pearl Eliminator Double Bass Pedal and his own Vic Firth Paul Mazurkiewicz Signature sticks. Pete Sandoval played a ddrum kit (exact model undocumented) with hardware to match; his cymbal brand was never publicly confirmed, though his gravity blast technique relied on the pedal\'s rebound action regardless of make.',
    ...
    faqs: [
      ...
      { q: 'What drums does Paul Mazurkiewicz play vs Pete Sandoval?', a: 'Paul Mazurkiewicz plays Pearl Reference Series drums with a Pearl Eliminator Double Bass Pedal. Pete Sandoval played a ddrum kit, but the exact model and his cymbal brand were never publicly documented.' },
  ...
  'nick-menza-vs-dirk-verbeuren': {
    ...
    faqs: [
      ...
      { q: 'What drums does Nick Menza play vs Dirk Verbeuren?', a: 'Nick Menza played Pearl Reference Custom drums with Sabian AA / Signature Series cymbals in his final Megadeth era. Dirk Verbeuren plays Tama Starclassic Maple drums with Meinl Byzance Brilliant and Classics Custom Dark cymbals — the endorsements differ across the two Megadeth eras.' },
  ...
  'danny-carey-vs-gavin-harrison': {
    ...
    comparison: {
      ...
      gear: 'Danny plays Sonor SQ2 Heavy Beech drums with Paiste Signature cymbals and custom Mandala pads. Gavin uses Sonor SQ2 Series drums with Zildjian K Custom Special Dry cymbals — sharing a Sonor drum foundation with Danny while taking a different cymbal approach.',
  ...
  'eloy-casagrande-vs-jay-weinberg': {
    ...
    comparison: {
      ...
      gear: 'Eloy plays Tama Starclassic Bubinga drums with Paiste cymbals, and Tama Iron Cobra double pedals — a powerhouse setup suited to Slipknot\'s aggressive, percussion-heavy sound. Jay played SJC Custom Drums with Zildjian cymbals and DW hardware during his Slipknot tenure, with a masked performer\'s setup built for visual impact and live endurance.',
    ...
    faqs: [
      ...
      { q: 'What gear does Eloy Casagrande use?', a: 'Eloy Casagrande plays Tama Starclassic Bubinga drums with Paiste cymbals and Tama Iron Cobra double pedals.' },
  ...
  'mike-mangini-vs-matt-garstka': {
    ...
    faqs: [
      ...
      { q: 'What drum kits do Mangini and Garstka use?', a: 'Mangini uses a Pearl Masterworks Maple kit with Sabian HHX / AAX cymbals; Garstka plays a DW Collector\'s Series kit with Meinl Byzance cymbals and electronic pads.' },
  ...
  'gene-hoglan-vs-eloy-casagrande': {
    ...
    comparison: {
      ...
      gear: 'Gene Hoglan plays Pearl Reference Pure drums with Sabian AAX Series cymbals and Pearl Demon Drive double pedals — a powerful, projection-focused setup built for extreme metal clarity. Eloy Casagrande plays Tama Starclassic Bubinga drums with Paiste cymbals and Tama Iron Cobra double pedals — a powerhouse setup suited to Slipknot\'s aggressive, percussion-heavy sound.',
    ...
    faqs: [
      ...
      { q: 'What gear does Gene Hoglan use vs Eloy Casagrande?', a: 'Gene Hoglan plays Pearl Reference Pure drums with Sabian AAX cymbals and Pearl Demon Drive double pedals. Eloy Casagrande plays Tama Starclassic Bubinga drums with Paiste cymbals and Tama Iron Cobra double pedals.' },
  ...
  'brann-dailor-vs-eloy-casagrande': {
    ...
    comparison: {
      ...
      gear: 'Brann Dailor plays Tama Starclassic Performer B/B drums with Meinl Byzance cymbals and Vater 5B sticks — a warm, musical setup suited to Mastodon\'s progressive sludge sound. Eloy Casagrande plays Tama Starclassic Bubinga drums with Paiste cymbals and Tama Iron Cobra double pedals — a powerhouse setup suited to Slipknot\'s aggressive, percussion-heavy sound.',
    ...
    faqs: [
      ...
      { q: 'What gear does Brann Dailor use vs Eloy Casagrande?', a: 'Brann Dailor plays Tama Starclassic Performer B/B drums with Meinl Byzance cymbals and Vater 5B sticks. Eloy Casagrande plays Tama Starclassic Bubinga drums with Paiste cymbals and Tama Iron Cobra double pedals.' },
  ...
  'tomas-haake-vs-blake-richardson': {
    ...
    faqs: [
      ...
      { q: 'What drums do Tomas Haake and Blake Richardson play?', a: 'Tomas Haake plays Sonor SQ2 Heavy Beech drums with Sabian HHX & AAX cymbals. Blake Richardson plays Tama Starclassic Bubinga drums with Sabian HHX Evolution / AAX cymbals.' },
  ...
  'shannon-larkin-vs-jay-weinberg': {
    ...
    faqs: [
      ...
      { q: 'What gear did Jay Weinberg use with Slipknot?', a: 'Jay Weinberg played SJC Custom Drums with Zildjian cymbals and DW hardware during his Slipknot tenure.' },
  ...
  'raymond-herrera-vs-matt-garstka': {
    ...
    faqs: [
      ...
      { q: 'What gear do Raymond Herrera and Matt Garstka use?', a: 'Raymond Herrera plays a Tama Starclassic kit with a Tama 14x6.5" Brass snare and Zildjian Z Custom cymbals. Matt Garstka plays a DW Collector\'s Series kit and Meinl Byzance Series cymbals.' },
  ...
  'abe-cunningham-vs-john-otto': {
    ...
    faqs: [
      ...
      { q: 'What gear do Abe Cunningham and John Otto use?', a: 'Abe Cunningham plays a Tama Starclassic Maple/Bubinga kit with Zildjian K Custom & A Custom Series cymbals and a Tama Iron Cobra 900 Rolling Glide. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with Zildjian A Custom cymbals and Gibraltar Professional Series bass drum pedals.' },
  ...
  'ray-luzier-vs-art-cruz': {
    ...
    faqs: [
      ...
      { q: 'What gear do Ray Luzier and Art Cruz use?', a: 'Ray Luzier plays a Pearl Reference Maple kit with a Pearl Reference Brass snare and Sabian AAX Series cymbals. Art Cruz plays Ludwig drums with a Ludwig snare and Zildjian cymbals, driven by a Trick Pro 1-V Bigfoot double pedal.' },
    ],
  },
  ...
  'nick-menza-vs-charlie-benante': {
    ...
    comparison: {
      ...
      kit: 'Nick Menza played a Pearl Reference Custom kit with Sabian AA / Signature Series cymbals and Vater Nick Menza Signature sticks in his final "Cryptic Writings" (1997) Megadeth era, driven by a Tama Iron Cobra Double Pedal. Charlie Benante plays a Tama Starclassic kit with a Tama Charlie Benante Signature 14x6.5" snare and Paiste RUDE & 2002 Series cymbals (14" Hi-Hats, 18" & 19" Crashes, 20" Power Ride, 18" China), driven by a Tama Speed Cobra double pedal with Roland electronics and Vic Firth Charlie Benante Signature sticks.',
  ...
  'richard-christy-vs-derek-roddy': {
    ...
    comparison: {
      ...
      gear: 'Richard plays a Pearl Masters Custom kit with a 14x6.5" Pearl Masters Maple snare, Sabian AAX & HHX cymbals, and an Axis A Longboard double pedal. Derek favors a heavier Tama Starclassic Bubinga kit with a punchier 14x6.5" Tama SLP Black Brass snare, Meinl Byzance & Mb20 cymbals, and a Tama Speed Cobra 910 double pedal tuned for his signature footwork.',
    ...
    faqs: [
      ...
      { q: 'What gear do Richard Christy and Derek Roddy use?', a: 'Richard Christy plays a Pearl Masters Custom kit with a 14x6.5" Pearl Masters Maple snare and Sabian AAX & HHX cymbals. Derek Roddy plays a Tama Starclassic Bubinga kit with a 14x6.5" Tama SLP Black Brass snare and Meinl Byzance & Mb20 cymbals, driven by a Tama Speed Cobra 910 double pedal.' },
    ],
  },
  ...
  'frost-vs-inferno': {
    ...
    faqs: [
      ...
      { q: 'What gear does Frost use vs Inferno?', a: 'Frost plays a Tama Starclassic Bubinga Series kit with Zildjian A Custom & K Series cymbals and a Tama Iron Cobra Power Glide pedal. Inferno plays a Pearl Masterworks kit with Paiste RUDE Series cymbals and a Czarcie Kopyto (Devil\'s Hoof) double pedal.' },
  ...
  'frost-vs-jaska-raatikainen': {
    ...
    faqs: [
      ...
      { q: 'What gear does Frost use vs Jaska Raatikainen?', a: 'Frost plays a Tama Starclassic Bubinga Series kit with Zildjian A Custom & K Series cymbals and a Tama Iron Cobra Power Glide pedal. Jaska Raatikainen plays a Pearl Masters Premium Maple kit with Zildjian A Custom & K Custom Series cymbals and a Pearl Eliminator double pedal.' },
  ...
  'frost-vs-daray': {
    ...
    faqs: [
      ...
      { q: 'What gear does Frost use vs Daray?', a: 'Frost plays a Tama Starclassic Bubinga Series kit with Zildjian A Custom & K Series cymbals and a Tama Iron Cobra Power Glide pedal. Daray plays a Pearl Masterworks Stadium Exotic kit with Paiste RUDE & 2002 Series cymbals and a Pearl Demon XR double pedal.' },
  ...
  'bill-ward-vs-eloy-casagrande': {
    ...
    faqs: [
      ...
      { q: 'What gear did Bill Ward and Eloy Casagrande use?', a: 'Bill Ward played a Ludwig Classic Maple kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Zildjian Avedis Series cymbals. Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x5.5" snare and Paiste cymbals, powered by a Tama Iron Cobra double pedal.' },
  ...
  'morgan-agren-vs-mike-mangini': {
    ...
    comparison: {
      ...
      gear: 'Morgan Ågren plays a Sonor SQ2 Designer Series kit with a Sonor Designer 14x5.5" maple snare and Paiste Signature & 2002 Series cymbals (14" Signature Heavy Hi-Hats, 18" & 20" Signature Fast Crashes, 22" Signature Dry Heavy Ride, 18" 2002 China), powered by a Sonor Giant Step double pedal and Vic Firth American Classic 5A sticks. Mike Mangini plays a Pearl Reference Series kit with 14x5" and 14x6.5" Pearl Reference brass snares and Sabian HHX & AAX Series cymbals (14" HHX Evolution Hi-Hats, 17", 18", and 19" HHX Evolution Crashes, 21" HHX Raw Bell Dry Ride), integrating a Roland SPD-SX sampling pad and Pearl Demon Drive double pedals, with his own Vater Mike Mangini Wicked Piston (VHMMWP) sticks.',
  ...
  'isaac-lamb-vs-john-otto': {
    ...
    comparison: {
      ...
      gear: 'Lamb endorses SJC Custom Drums and Meinl Cymbals; his specific kit and cymbal models are not publicly documented. Otto plays an OCDP Custom Type 5 Acrylic kit with Zildjian A Custom cymbals and Gibraltar Professional Series bass drum pedals.',
  ...
  'isaac-lamb-vs-ryan-van-poederooyen': {
    ...
    faqs: [
      ...
      { q: 'What gear do Isaac Lamb and Ryan Van Poederooyen use?', a: 'Isaac Lamb endorses SJC Custom Drums and Meinl Cymbals, but his specific kit and cymbal models are not publicly documented. Ryan Van Poederooyen plays a Pearl Reference Series kit with a 14x6.5" brass Pearl Reference snare and Sabian HHX & AAX cymbals, driven by a Pearl Demon Drive double pedal.' },
    ],
  },
  ...
  'hellhammer-vs-gene-hoglan': {
    ...
    faqs: [
      ...
      { q: 'What drums do Hellhammer and Gene Hoglan play?', a: 'Hellhammer played a Sonor 5-piece shell pack with a Sonor 14"x5.5" steel snare on "De Mysteriis Dom Sathanas," later moving to the Sonor SQ2 Heavy Beech kit in 1999. Gene Hoglan plays a Pearl Reference Pure kit with a Pearl Reference 14"x6.5" Brass snare and Sabian AAX cymbals.' },
  ...
  'hellhammer-vs-george-kollias': {
    ...
    faqs: [
      ...
      { q: 'What gear do Hellhammer and George Kollias use?', a: 'Hellhammer\'s classic rig was a Sonor 5-piece shell pack with a Sonor 14"x5.5" steel snare, later moving to the Sonor SQ2 Heavy Beech kit in 1999. George Kollias plays a Pearl Masterworks Stadium Exotic kit with a 14"x6.5" Pearl George Kollias Signature snare, Zildjian cymbals, and his co-designed Pearl Demon XR double pedal.' },
  ...
  'hannes-grossmann-vs-tim-yeung': {
    ...
    faqs: [
      ...
      { q: 'What gear do Hannes Grossmann and Tim Yeung use?', a: 'Hannes Grossmann plays a DW Collectors Series kit with a DW Collectors maple snare and Meinl Byzance Series cymbals, driven by a DW 9000 Series double pedal. Tim Yeung plays a Tama Starclassic Bubinga kit with a metal snare and Sabian AAX/HHX cymbals, driven by a Tama Speed Cobra 910 double pedal.' },
    ],
  },
  ...
  'raymond-herrera-vs-chris-turner': {
    ...
    comparison: {
      ...
      gear: 'Raymond Herrera played a Tama Starclassic kit (with triggering) with a trigger-equipped snare and Zildjian Z Custom cymbals, driven by a DW 5000 Series Double Pedal with ddrum/Roland triggers throughout the kit and Pro-Mark 5A Oak Nylon Tip sticks. Chris Turner endorses Tama Drums and Meinl Cymbals, playing a Tama Starclassic Maple/Birch kit with a Tama S.L.P. 14"x5.5" G-Maple snare and Meinl Byzance Series (Extra Dry / Dual) cymbals, driven by a Tama Speed Cobra 910 double pedal and Promark or Vic Firth 5B sticks.',
  ...
  'chris-turner-vs-isaac-lamb': {
    ...
    faqs: [
      ...
      { q: 'What gear do Chris Turner and Isaac Lamb use?', a: 'Chris Turner plays a Tama Starclassic Maple/Birch kit with Meinl Byzance cymbals and Vic Firth American Classic 5A sticks. Isaac Lamb endorses SJC Custom Drums and Meinl Cymbals, but his specific kit and cymbal models are not publicly documented.' },
  ...
  'john-otto-vs-arin-ilejay': {
    ...
    comparison: {
      ...
      gear: 'John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual OCDP snares — a 14x6.5" 40-ply vented shell and a 10x6" 20-ply piccolo — and Zildjian cymbals (13" A Custom Mastersound Hi-Hats, 16" & 17" A Custom Projection Crashes, 20" A Custom EFX, 20" FX Oriental Crash of Doom), driven by Gibraltar Professional Series bass drum pedals. Arin Ilejay played a Mapex Saturn Series kit with a Mapex Black Panther 14x6.5" snare and Zildjian A Custom cymbals (14" A Custom Mastersound Hi-Hats, 18" & 19" A Custom Crashes, 21" A Sweet Ride, 18" A Custom China), powered by a Mapex Falcon double pedal — the documented setup from his 2011-2015 A7X tenure.',
    ...
    faqs: [
      ...
      { q: 'What gear do John Otto and Arin Ilejay use?', a: 'John Otto plays an OCDP Custom Type 5 Acrylic kit with dual OCDP snares and Zildjian A Custom cymbals, driven by Gibraltar Professional Series bass drum pedals. Arin Ilejay played a Mapex Saturn Series kit with a Mapex Black Panther snare and Zildjian A Custom cymbals, powered by a Mapex Falcon double pedal, during his 2011-2015 Avenged Sevenfold tenure.' },
  ...
  'daniel-erlandsson-vs-jaska-raatikainen': {
    ...
    faqs: [
      ...
      { q: 'What gear do Daniel Erlandsson and Jaska Raatikainen use?', a: 'Daniel Erlandsson plays Pearl Reference Series or Masters Maple kits with Sabian cymbals. Jaska Raatikainen played a Pearl Masters Premium Maple kit with a Pearl Masters maple snare, Zildjian A Custom & K Custom cymbals, and a Pearl Eliminator double pedal — a shared Pearl foundation with Erlandsson, though each drummer\'s cymbal endorsement differs.' },
  ...
  'daniel-erlandsson-vs-dirk-verbeuren': {
    ...
    faqs: [
      ...
      { q: 'What gear do Daniel Erlandsson and Dirk Verbeuren use?', a: 'Daniel Erlandsson plays Pearl Reference Series or Masters Maple kits with Sabian cymbals. Dirk Verbeuren plays a Tama Starclassic Maple kit with a Tama S.L.P. Dynamic Bronze snare and Meinl Byzance Brilliant & Classics Custom Dark cymbals, powered by a Tama Speed Cobra 910 double pedal.' },
  ...
  'ben-koller-vs-dirk-verbeuren': {
    ...
    comparison: {
      ...
      gear: 'Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal. Verbeuren plays a Tama Starclassic Maple kit with a Tama S.L.P. Dynamic Bronze 14x5.5" snare and Meinl Byzance Brilliant & Classics Custom Dark cymbals, powered by Tama Speed Cobra 910 double pedals.',
  ...
  'bill-ward-vs-john-otto': {
    ...
    faqs: [
      ...
      { q: 'What gear does Bill Ward use vs John Otto?', a: 'Bill Ward played a Ludwig Classic Maple kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Zildjian Avedis Series cymbals. John Otto plays an OCDP Custom Type 5 Acrylic kit with dual signature OCDP snares and Zildjian A Custom cymbals, driven by Gibraltar Professional Series pedals.' },
  ...
  'hellhammer-vs-jaska-raatikainen': {
    ...
    faqs: [
      ...
      { q: 'What gear do Hellhammer and Jaska Raatikainen use?', a: 'Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare and Paiste RUDE Series cymbals, driven by an Axis Double Pedal. Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom cymbals, powered by a Pearl Eliminator double pedal.' },
    ],
  },
  ...
  'hellhammer-vs-mikkey-dee': {
    ...
    faqs: [
      ...
      { q: 'What gear do Hellhammer and Mikkey Dee use?', a: 'Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare and Paiste RUDE Series cymbals, driven by an Axis Double Pedal. Mikkey Dee plays Sonor drums built around a single 18"x22" bass drum, with a Sonor Mikkey Dee Signature snare and Paiste Signature Series cymbals.' },
  ...
  'jon-dette-vs-gene-hoglan': {
    ...
    faqs: [
      ...
      { q: 'What gear do Jon Dette and Gene Hoglan use?', a: 'Jon Dette has played Ludwig Classic Maple drums since 1996 with Sabian or Zildjian cymbals. Gene Hoglan plays a Pearl Reference Pure kit with a Pearl Reference Brass snare and Sabian AAX cymbals, driven by a Pearl Demon Drive double pedal. Both use Promark 5B sticks.' },
  ...
  'nick-menza-vs-vinnie-paul': {
    ...
    comparison: {
      ...
      gear: 'In a striking parallel, both drummers started 1990 on the exact same kit: a Tama Artstar II with birch shells and die-cast hoops — Menza in Midnight Blue for "Rust in Peace," Paul in Piano Black for "Cowboys from Hell." From there their gear diverged completely. Menza\'s drums kept moving too — from that Tama Artstar II he switched to Pearl Masters for "Countdown to Extinction" (1992), Pearl Masterworks for "Youthanasia" (1994), and Pearl Reference Custom for his final Megadeth album, "Cryptic Writings" (1997) — while his cymbals went Zildjian A/A Custom on "Rust in Peace" to Paiste 2002 and Signature series on "Countdown to Extinction" to Sabian AA/Signature on "Cryptic Writings," and he used Vater Nick Menza Signature sticks. Paul moved from Tama to a custom ddrum kit for "Vulgar Display of Power" — oversized 24"x18" double bass drums and an 8"-deep steel snare, both triggered — and stayed with Sabian AA/AAX cymbals for nearly his entire career, eventually landing on a ddrum Vinnie Paul Signature Series kit for Hellyeah. Paul was also an early advocate of blending acoustic drums with electronic triggers to guarantee consistency at massive volume.',
    ...
    faqs: [
      { q: 'Did Nick Menza and Vinnie Paul use the same drum kit?', a: 'Yes, at least at the start of the decade — both drummers played a Tama Artstar II with birch shells and die-cast hoops in 1990: Nick Menza in Midnight Blue finish on Megadeth\'s "Rust in Peace," and Vinnie Paul in Piano Black finish on Pantera\'s "Cowboys from Hell." Their gear diverged sharply afterward, with Menza moving through Pearl Masters, Pearl Masterworks, and finally Pearl Reference Custom drums while his cymbals went from Zildjian to Paiste to Sabian, while Paul switched to a custom ddrum kit and stayed on Sabian cymbals for most of his career.' },
      ...
      { q: 'What snare drums did Nick Menza and Vinnie Paul use?', a: 'Nick Menza\'s snare moved along with his kit changes across his Megadeth tenure, settling into his Pearl Reference Custom setup by "Cryptic Writings" (1997). Vinnie Paul used a custom ddrum steel snare at 14"x8" — notably deeper than standard metal snares — which produced the massive, cracking low-end tone that became a hallmark of Pantera\'s groove metal sound.' },
  ...
  'jocke-wallgren-vs-daniel-erlandsson': {
    ...
    faqs: [
      ...
      { q: 'What is the difference between Jocke Wallgren\'s and Daniel Erlandsson\'s drum kits?', a: 'Jocke Wallgren plays a Pearl Reference Pure kit with a Pearl Reference 14"x6.5" brass snare, Zildjian A Custom & K Custom cymbals, and a Pearl Demon Drive double pedal. Daniel Erlandsson plays a Pearl Reference Pure kit (all-maple) with a Pearl Eliminator double pedal and Sabian AAX/HHX cymbals. Erlandsson\'s signature snare is a shallower 14"x5.5" for faster response, versus Wallgren\'s deeper 14"x6.5".' },
  ...
  'richard-christy-vs-george-kollias': {
    ...
    faqs: [
      ...
      { q: 'What pedals do Richard Christy and George Kollias use?', a: 'Richard Christy used the Axis A Longboard double pedal during his Death and Control Denied years. George Kollias uses the Pearl Demon XR, a double pedal he co-designed with Pearl\'s engineers specifically for sustained extreme-speed blast-beat playing, featuring a NiNjA Bearing Universal Joint and Direct Link drive system.' },
  ...
  'mario-duplantier-vs-hellhammer': {
    ...
    faqs: [
      ...
      { q: 'What gear do Mario Duplantier and Hellhammer use?', a: 'Mario Duplantier plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums, a Tama S.L.P. 14x6.5" G-Maple snare, and a Zildjian cymbal array including a 21" Z Custom Mega Bell Ride. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare, Paiste RUDE Series cymbals, and an Axis Double Pedal.' },
  ...
  'ben-koller-vs-hellhammer': {
    ...
    faqs: [
      ...
      { q: 'What gear do Ben Koller and Hellhammer use?', a: 'Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare and Paiste RUDE Series cymbals, driven by an Axis Double Pedal. Both use Vic Firth American Classic 5B sticks.' },
  ...
  'brann-dailor-vs-hellhammer': {
    ...
    faqs: [
      ...
      { q: 'What gear do Brann Dailor and Hellhammer use?', a: 'Brann Dailor plays a Tama Starclassic Performer B/B kit with a Tama S.L.P. G-Maple snare, Meinl Byzance cymbals, and a Tama Speed Cobra double pedal. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare, Paiste RUDE Series cymbals, and an Axis Double Pedal.' },
  ...
  'gavin-harrison-vs-hellhammer': {
    ...
    faqs: [
      ...
      { q: 'What gear do Gavin Harrison and Hellhammer use?', a: 'Gavin Harrison plays a Sonor SQ2 kit with his signature Sonor 14x5.25" brass snare and Zildjian K Custom Special Dry cymbals. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare and Paiste RUDE Series cymbals, driven by an Axis Double Pedal.' },
  ...
  'hellhammer-vs-john-otto': {
    ...
    faqs: [
      ...
      { q: 'What gear do Hellhammer and John Otto use?', a: 'Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 Heavy Beech snare and Paiste RUDE Series cymbals, driven by an Axis Double Pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual signature OCDP snares, Zildjian A Custom cymbals, and Gibraltar Professional Series pedals.' },
