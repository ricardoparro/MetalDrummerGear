...
export const drummerComparisons = {
  ...
  // Issue #3248: SEO batch 42 — Paul Mazurkiewicz vs George Kollias
  'paul-mazurkiewicz-vs-george-kollias': {
    ...
    metaDescription: 'Cannibal Corpse\'s Paul Mazurkiewicz vs Nile\'s George Kollias. Brutal death metal consistency vs technical death metal speed — gear, blast beat technique, and legacy compared.',
    category: 'extreme',
    drummers: ['paul-mazurkiewicz', 'george-kollias'],
    comparison: {
      style: 'Paul Mazurkiewicz has been Cannibal Corpse\'s drummer since the band formed in Buffalo, New York in 1988, appearing on every studio album from "Eaten Back to Life" (1990) through "Chaos Horrific" (2023) — a 35-plus-year run that makes him one of the most consistent drummers in death metal history. His playing is brutality-first: powerful double bass, authoritative blast beats, and mid-tempo bulldoze passages built to serve Cannibal Corpse\'s riff-driven songwriting rather than display technique for its own sake. George Kollias has been Nile\'s drummer since 2004, bringing Greek technical death metal precision to the band\'s Egyptology-themed, polyrhythmically dense catalog across albums including "Annihilation of the Wicked" (2005), "Ithyphallic" (2007), and "Those Whom the Gods Detest" (2009). Kollias is consistently ranked among the fastest drummers in extreme metal, sustaining blast beats above 240 BPM with surgical clarity rather than blur.',
      technique: 'Mazurkiewicz\'s technical signature is relentless consistency — his blast beats lock tightly with Alex Webster\'s bass and Cannibal Corpse\'s down-tuned riffs, prioritizing groove and impact over raw speed. His stamina across decades of physically demanding live shows and seventeen studio albums is itself a technical achievement few extreme metal drummers can match. Kollias represents technical death metal\'s speed ceiling — his co-designed Pearl Demon XR double pedal enables the linear, direct bass drum action behind Nile\'s most punishing passages, and as a prolific instructor he has codified his blast beat and double bass methods into widely used educational material, openly sharing techniques most extreme drummers treat as trade secrets.',
      gear: 'Paul Mazurkiewicz plays a Pearl Masters Maple Complete kit with a Pearl Masters 14×6.5" Maple snare, Sabian AAX Series cymbals (14" Stage Hi-Hats, 18" & 19" X-Plosion Crashes, 21" Raw Bell Dry Ride, 18" AAXtreme China), a Pearl Demon Drive double pedal, and Vic Firth American Classic 5B sticks — a warm, powerful setup tuned for brutal death metal\'s low end. George Kollias plays a Pearl Masterworks Stadium Exotic kit (Piano Black with Gold Hardware) with his signature Pearl George Kollias 14×6.5" snare, Zildjian A Custom Series cymbals (14" Hi-Hats, 17" & 18" Crashes, 21" Ride, 18" China), a Pearl Demon Drive double pedal he co-designed, and Vic Firth George Kollias Signature sticks — a setup engineered specifically for sustained extreme-speed clarity.',
      influence: 'Paul Mazurkiewicz\'s unbroken 35-plus-year tenure with Cannibal Corpse — the best-selling death metal band of all time — makes his rhythmic template one of the genre\'s most widely emulated, and his drumming on "Tomb of the Mutilated" (1992) and "The Bleeding" (1994) helped define brutal death metal\'s rhythmic vocabulary. George Kollias has become one of extreme metal\'s premier educators alongside his Nile career, with instructional DVDs, online courses, and worldwide clinics that have taught thousands of drummers the mechanics behind sustained extreme speed — and his 2020 solo album "Invictus" proved his range extends well beyond pure velocity.',
    },
    verdict: 'Paul Mazurkiewicz and George Kollias represent death metal drumming\'s two defining poles. Mazurkiewicz is the genre\'s great consistent force — seventeen Cannibal Corpse albums and 35-plus years of brutal, song-serving drumming that never wavered. Kollias is technical death metal\'s speed authority — a co-designed pedal, a signature snare, and blast beats sustained above 240 BPM with surgical precision. Mazurkiewicz wins on legacy and longevity; Kollias wins on verified technical extremity. Both are essential studies for any drummer serious about extreme metal.',
    faqs: [
      { q: 'Who is the better death metal drummer, Paul Mazurkiewicz or George Kollias?', a: 'Both are death metal essentials in different ways. Paul Mazurkiewicz (Cannibal Corpse) has delivered brutal, consistent drumming across seventeen studio albums and 35-plus years — the longest unbroken tenure in the genre. George Kollias (Nile) is one of the fastest technically proficient drummers in extreme metal, sustaining blast beats above 240 BPM with co-designed Pearl Demon XR pedals built for that exact purpose. Mazurkiewicz by legacy and consistency; Kollias by raw technical speed.' },
      { q: 'What drum kit does Paul Mazurkiewicz use compared to George Kollias?', a: 'Paul Mazurkiewicz plays a Pearl Masters Maple Complete kit with Sabian AAX Series cymbals and a Pearl Demon Drive double pedal. George Kollias plays a Pearl Masterworks Stadium Exotic kit with Zildjian A Custom Series cymbals and a Pearl Demon Drive double pedal he co-designed with Pearl specifically for extreme-speed blast beats.' },
      { q: 'How fast can George Kollias play blast beats?', a: 'George Kollias is regarded as one of the fastest drummers in extreme metal, sustaining blast beats above 240 BPM with controlled clarity rather than losing definition at high tempo. He has built instructional material around the specific technique that allows him to maintain that speed without sacrificing precision.' },
      { q: 'How long has Paul Mazurkiewicz played in Cannibal Corpse?', a: 'Paul Mazurkiewicz has been Cannibal Corpse\'s only drummer since the band formed in Buffalo, New York in 1988, appearing on all seventeen studio albums from "Eaten Back to Life" (1990) through "Chaos Horrific" (2023) — over 35 years with the same band, one of the longest tenures of any drummer in death metal.' },
    ],
  },

  // Issue #3248: SEO batch 42 — Abe Cunningham vs Shannon Larkin
  'abe-cunningham-vs-shannon-larkin': {
    slug: 'abe-cunningham-vs-shannon-larkin',
    title: 'Abe Cunningham vs Shannon Larkin',
    metaTitle: 'Abe Cunningham vs Shannon Larkin — Deftones vs Godsmack Drummer Comparison | MetalForge',
    metaDescription: 'Deftones\' Abe Cunningham vs Godsmack\'s Shannon Larkin. Atmospheric alt-metal texture vs arena-ready hard rock groove — gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['abe-cunningham', 'shannon-larkin'],
    comparison: {
      style: 'Abe Cunningham co-founded Deftones in Sacramento in 1988 and has been the band\'s sole drummer ever since, shaping a style built on space, dynamic restraint, and emotional arc rather than technical showmanship — his playing across "White Pony" (2000), "Diamond Eyes" (2010), and "Ohms" (2020) helped define alternative metal\'s atmospheric, shoegaze-tinged direction. Shannon Larkin joined Godsmack in 2002, bringing veteran hard rock groove authority to the band\'s arena-scale sound across albums including "Faceless," "IV," and "The Oracle." Before Godsmack, Larkin played in Ugly Kid Joe, Wrathchild America, and Amen, giving him a broader hard rock and alternative metal pedigree than most of his nu-metal-era peers.',
      technique: 'Cunningham\'s technique centers on unconventional snare placement, creative hi-hat and ride patterns, and dynamic control that shifts between whisper-quiet shimmer and crushing heaviness within a single song — a style that prioritizes mood over conventional metal drumming vocabulary. Larkin\'s approach is muscular, groove-first hard rock drumming: powerful, hook-driven rhythms that lock tightly with Tony Rombola\'s guitar riffs and give Godsmack\'s songs the pocket and weight that made them commercially dominant through the 2000s. Where Cunningham serves Deftones\' atmosphere, Larkin serves Godsmack\'s groove.',
      gear: 'Abe Cunningham plays a Tama Starclassic Maple/Bubinga kit with a Tama S.L.P. Big Black Steel 14×8" snare, Zildjian cymbals (14" A New Beat Hi-Hats, A Custom Crashes, K Custom Ride), a Tama Iron Cobra double pedal, and signature Zildjian Abe Cunningham Artist Series sticks — a compact, feel-focused setup built for Deftones\' dynamic range. Shannon Larkin plays a Pearl Reference Pure kit with a Pearl Reference 14×6.5" Brass snare, Sabian AAX Series cymbals (14" Stage Hi-Hats, 18" & 19" X-Plosion Crashes, 21" Raw Bell Dry Ride, 18" AAX Chinese), a Pearl Demon Drive double pedal, and Promark Shannon Larkin Signature sticks — a powerful, cutting setup tuned for Godsmack\'s arena-rock weight.',
      influence: 'Cunningham has been Deftones\' sole drummer across nine studio albums and 35-plus years — his drumming on "White Pony" (Grammy winner, Best Metal Performance for "Elite") and "Diamond Eyes" helped shape an entire generation of alternative metal drummers toward atmospheric, dynamics-first playing. Larkin\'s two-decade tenure with Godsmack helped sustain the band\'s commercial dominance through multiple platinum records, and his pre-Godsmack résumé across Ugly Kid Joe and Wrathchild America made him one of the most well-traveled drummers to find mainstream success in 2000s hard rock.',
    },
    verdict: 'Abe Cunningham and Shannon Larkin represent two contrasting approaches to commercially successful modern metal drumming. Cunningham is the master of atmospheric restraint — unconventional patterns and dynamic control that make Deftones\' textures feel alive. Larkin is the master of arena-ready groove — muscular, hook-driven rhythms that gave Godsmack its rhythmic foundation. The Deftones vs Godsmack matchup pits alt-metal mood against hard rock power, two of the most recognizable drum chairs of the nu-metal and post-grunge era.',
    faqs: [
      { q: 'Who is the better drummer, Abe Cunningham or Shannon Larkin?', a: 'Both are accomplished in different lanes. Abe Cunningham (Deftones) excels at atmospheric dynamics and unconventional groove patterns that serve Deftones\' emotional, shoegaze-influenced sound. Shannon Larkin (Godsmack) excels at muscular, hook-driven hard rock groove that powered Godsmack\'s commercial dominance. The choice depends on whether you value alt-metal texture or arena-rock power.' },
      { q: 'What drum kit does Abe Cunningham use compared to Shannon Larkin?', a: 'Abe Cunningham plays a Tama Starclassic Maple/Bubinga kit with Zildjian cymbals and a Tama Iron Cobra double pedal. Shannon Larkin plays a Pearl Reference Pure kit with Sabian AAX Series cymbals and a Pearl Demon Drive double pedal — two different drum brands built for very different sonic goals.' },
      { q: 'How long has Abe Cunningham been the drummer for Deftones?', a: 'Abe Cunningham co-founded Deftones in Sacramento, California in 1988 and has been the band\'s only drummer ever since — over 35 years across nine studio albums, including the Grammy-winning "White Pony" (2000).' },
      { q: 'What bands did Shannon Larkin play in before Godsmack?', a: 'Shannon Larkin played with Wrathchild America (1989–1991), Ugly Kid Joe (1991–1997, including the hit "Everything About You"), and Amen before joining Godsmack in 2002, where he remained the band\'s drummer for over two decades.' },
    ],
  },
};
