...
export const drummerComparisons = {
  ...
  'frost-vs-hellhammer': {
    ...
    comparison: {
      ...
      gear: 'Frost plays a Sonor SQ2 Series kit with a Sonor SQ2 14x6" Maple snare and Zildjian A Custom & K Series cymbals (14" A Custom Hi-Hats, 16"-18" A Custom Crashes, 22" K Custom Dark Ride, 18" K China) — a controlled, articulate setup built for Satyricon\'s precise compositions. Hellhammer plays a Sonor SQ2 Heavy Beech kit with a Sonor SQ2 14x5.5" Maple snare and Paiste RUDE Series cymbals (14" RUDE Hi-Hats, 18" & 19" RUDE Crashes, 20" RUDE Ride, 18" RUDE China) — both drummers share a Sonor shell loyalty while diverging on cymbal brand, Zildjian\'s controlled articulation for Frost versus Paiste RUDE\'s raw, aggressive character for Hellhammer.',
    ...
    faqs: [
      ...
      { q: 'What gear does Frost use vs Hellhammer?', a: 'Frost plays a Sonor SQ2 Series kit with Zildjian A Custom & K Series cymbals. Hellhammer plays a Sonor SQ2 Heavy Beech kit with Paiste RUDE Series cymbals — both share Sonor drum shells while using different cymbal brands.' },
  ...
  // Issue #3186: SEO batch 40 — Art Cruz vs Jay Weinberg (dual legacy-band replacement narrative)
  'art-cruz-vs-jay-weinberg': {
    slug: 'art-cruz-vs-jay-weinberg',
    title: 'Art Cruz vs Jay Weinberg',
    metaTitle: 'Art Cruz vs Jay Weinberg — Modern American Metal Drumming Compared | MetalForge',
    metaDescription: 'Lamb of God\'s Art Cruz vs Slipknot successor Jay Weinberg. Two drummers who stepped into massive legacy seats — groove-first replacement vs powerhouse precision. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['art-cruz', 'jay-weinberg'],
    comparison: {
      style: 'Art Cruz joined [Lamb of God](/articles/whats-in-art-cruzs-kit) in 2019, replacing founding drummer Chris Adler after first filling in on the band\'s 2018 tour supporting Slayer\'s farewell run. Cruz brought a groove-first, service-the-song philosophy to one of groove metal\'s most demanding drum chairs, learning Adler\'s intricate vocabulary with respect while adding his own power on "Lamb of God" (2020) and "Omens" (2022). Jay Weinberg, son of E Street Band drummer Max Weinberg, joined [Slipknot](/articles/jay-weinberg-complete-drum-setup) in 2014 following Joey Jordison\'s departure, delivering nine years of powerhouse precision across ".5: The Gray Chapter," "We Are Not Your Kind," and "The End, So Far" before parting ways with the band in 2023 and joining Suicidal Tendencies.',
      technique: 'Cruz\'s technique centers on disciplined double bass work and dynamic control — he prioritizes pocket and groove over flash, a philosophy suited to Lamb of God\'s syncopated riff-driven songwriting. His fills are functional, built to serve Mark Morton and Willie Adler\'s guitar work rather than showcase technicality for its own sake. Weinberg\'s technique is defined by explosive power and machine-like consistency — his blast-capable speed and theatrical intensity honored Joey Jordison\'s legacy while adding his own aggressive stamp, delivering note-perfect performances across Slipknot\'s masked, high-production arena shows night after night.',
      gear: 'Art Cruz plays Ludwig Classic Maple drums with a Ludwig 14x6.5" Black Beauty snare and Zildjian A Custom cymbals (14" Hi-Hats, 17"-19" Crashes, 21" A Custom 20th Anniversary Ride, 18" A Custom China), driven by a Trick Pro 1-V Bigfoot double pedal for Lamb of God\'s demanding kick patterns. Jay Weinberg plays an SJC Custom Drums kit with his signature SJC "The Crucible" 14x6.5" 48-ply brass snare and Zildjian cymbals (14" A New Beat Hi-Hats, 18"-19" A Custom Crashes, 21" K Custom Ride, 19" K China), powered by a DW 9000 Series double pedal built for Slipknot\'s explosive, arena-scale production.',
      career: 'Cruz\'s path ran through Winds of Plague\'s deathcore intensity and Prong\'s industrial groove before a career-defining audition-by-fire: learning Chris Adler\'s entire catalog in weeks to fill in on tour, which became a permanent seat in 2019. Weinberg\'s path started young — touring with Against Me! and Madball as a teenager before, at just 23, replacing Joey Jordison in one of metal\'s most scrutinized drum chairs. Both drummers faced the same core challenge at different life stages: proving themselves worthy successors to bands with rabid, legacy-obsessed fanbases.',
      legacy: 'Cruz reenergized Lamb of God\'s modern era without erasing Chris Adler\'s fingerprints, proving groove metal\'s most demanding drum seat could survive generational transition. Weinberg\'s nine-year Slipknot tenure — longer than some founding members\' stints — cemented him as far more than a placeholder, before his own departure in 2023 opened the seat for Eloy Casagrande and continued Slipknot\'s cycle of drummer succession.',
    },
    verdict: 'Art Cruz and Jay Weinberg both inherited enormous legacy-band drum seats and answered the challenge with distinct philosophies. Cruz brings groove-first restraint to Lamb of God, serving the song over spectacle. Weinberg brought powerhouse precision and theatrical intensity to Slipknot, honoring Joey Jordison\'s legacy while making the seat his own for nearly a decade. Both are the modern blueprint for how to replace an irreplaceable drummer in American metal.',
    faqs: [
      { q: 'Who replaced Chris Adler in Lamb of God?', a: 'Art Cruz replaced Chris Adler in Lamb of God in 2019. Cruz first filled in for Adler on the band\'s 2018 North American tour supporting Slayer\'s farewell run, and the fill-in role became permanent, with Cruz recording "Lamb of God" (2020) and "Omens" (2022) as the band\'s full-time drummer.' },
      { q: 'Who replaced Jay Weinberg in Slipknot?', a: 'Eloy Casagrande, formerly of Sepultura, replaced Jay Weinberg in Slipknot after Weinberg parted ways with the band in 2023. Weinberg himself had joined Slipknot in 2014, replacing founding drummer Joey Jordison.' },
      { q: 'How do Art Cruz and Jay Weinberg compare as drummers?', a: 'Both are modern American metal drummers who inherited massive legacy-band drum seats. Art Cruz (Lamb of God) favors groove-first, pocket-forward drumming that serves the song. Jay Weinberg (Slipknot, 2014-2023) is known for powerhouse precision, blast-capable speed, and theatrical intensity. Both proved worthy successors to their predecessors.' },
      { q: 'What gear do Art Cruz and Jay Weinberg use?', a: 'Art Cruz plays Ludwig Classic Maple drums with Zildjian A Custom cymbals and a Trick Pro 1-V Bigfoot double pedal. Jay Weinberg plays SJC Custom Drums with his signature SJC "The Crucible" snare, Zildjian cymbals, and a DW 9000 Series double pedal.' },
    ],
  },

  // Issue #3186: SEO batch 40 — Ray Luzier vs Scott Travis (metal drumming longevity, replacement drummers)
  'ray-luzier-vs-scott-travis': {
    slug: 'ray-luzier-vs-scott-travis',
    title: 'Ray Luzier vs Scott Travis',
    metaTitle: 'Ray Luzier vs Scott Travis — Nu-Metal vs Heavy Metal Drumming Longevity | MetalForge',
    metaDescription: 'Korn\'s Ray Luzier vs Judas Priest\'s Scott Travis. Two technically accomplished replacement drummers who outlasted the legacy era — nu-metal groove vs classic heavy metal power. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['ray-luzier', 'scott-travis'],
    comparison: {
      style: 'Ray Luzier joined [Korn](/articles/korn-iii-drum-setup) in 2007, replacing founding drummer David Silveria and bringing rock-solid grooves with technical flair to the band\'s nu-metal foundation across "Korn III: Remember Who You Are" (2010), "The Path of Totality" (2011), and "The Paradigm Shift" (2013). Scott Travis joined [Judas Priest](/articles/painkiller-drum-setup) in 1989, replacing Dave Holland for the landmark "Painkiller" album — bringing an American double-bass-driven, thrash-influenced style that revitalized British heavy metal\'s biggest institution and has kept him in the band for over three decades.',
      technique: 'Luzier combines a sought-after session musician\'s versatility (built from years working with David Lee Roth and Army of Anyone) with the syncopated pocket-playing Korn\'s dense, detuned riffs demand — locking tightly with bassist Fieldy to hold down the band\'s signature groove. Travis is defined by relentless double bass precision and speed — his performance on "Painkiller"\'s title track remains one of heavy metal\'s most celebrated drumming feats, a machine-like display that established the modern American power-drumming template within a classic British metal band.',
      gear: 'Ray Luzier plays a Pearl Reference Series kit with a Pearl Reference 14x6.5" Brass snare and Sabian AAX Series cymbals (14" Stage Hi-Hats, 18"-19" X-Plosion Crashes, 21" Stage Ride, 18" AAXtreme China), powered by a DW 9002 double pedal. Scott Travis plays a ddrum Dominion Series kit with his signature ddrum Scott Travis 14x6.5" snare and Paiste RUDE & 2002 Series cymbals (14" RUDE Hi-Hats, 18"-19" RUDE Crashes, 22" RUDE Power Ride, 18" RUDE China), driven by a DW 9000 Series double pedal mounted in a Gibraltar Rack System.',
      career: 'Luzier built his reputation as an in-demand session and touring drummer before Korn — including stints with David Lee Roth and Army of Anyone — before landing the permanent Korn seat in 2007 and becoming the band\'s longest-serving drummer after Silveria. Travis came from Racer X, playing alongside guitarist Paul Gilbert, before Judas Priest recruited him in 1989 specifically to deliver the extreme double-bass demands of "Painkiller" — a hire that has now spanned over 35 years and eight studio albums.',
      legacy: 'Luzier has now held Korn\'s drum seat longer than founding member David Silveria did, cementing himself as an essential part of the band\'s modern identity through "The Paradigm Shift" and beyond. Travis transformed Judas Priest\'s rhythmic identity entirely — "Painkiller" would not exist in its iconic form without his technique, and his multi-decade tenure across "Angel of Retribution," "Redeemer of Souls," and "Firepower" makes him one of heavy metal\'s most enduring replacement-drummer success stories.',
    },
    verdict: 'Ray Luzier and Scott Travis are both technically accomplished replacement drummers who didn\'t just fill a seat — they outlasted the era they were hired to bridge. Luzier brought session-musician versatility and syncopated groove to Korn\'s nu-metal foundation, becoming the band\'s longest-tenured drummer. Travis brought thrash-influenced double bass power to Judas Priest\'s classic heavy metal, delivering one of the genre\'s most celebrated performances on "Painkiller" and remaining behind the kit for over three decades. Both prove that a replacement drummer can become the definitive one.',
    faqs: [
      { q: 'Who is the current drummer for Korn?', a: 'Ray Luzier has been Korn\'s drummer since 2007, when he replaced founding member David Silveria. He has now served longer than Silveria did, recording "Korn III: Remember Who You Are" (2010), "The Path of Totality" (2011), and "The Paradigm Shift" (2013) with the band.' },
      { q: 'Who has been in both Korn and Judas Priest?', a: 'No single drummer has played in both bands — Ray Luzier (Korn, 2007-present) and Scott Travis (Judas Priest, 1989-present) are separate drummers, but they share a similar career arc: both replaced a founding member and became the definitive long-term drummer for a legacy metal band.' },
      { q: 'How do Ray Luzier and Scott Travis compare as drummers?', a: 'Both are technically accomplished replacement drummers who outlasted the legacy era they were hired into. Ray Luzier (Korn) brings session-musician versatility and syncopated nu-metal groove. Scott Travis (Judas Priest) brings thrash-influenced double bass power and delivered one of heavy metal\'s most celebrated performances on "Painkiller."' },
      { q: 'What gear do Ray Luzier and Scott Travis use?', a: 'Ray Luzier plays a Pearl Reference Series kit with Sabian AAX Series cymbals and a DW 9002 double pedal. Scott Travis plays a ddrum Dominion Series kit with his signature ddrum snare, Paiste RUDE & 2002 Series cymbals, and a DW 9000 Series double pedal.' },
    ],
  },
};
