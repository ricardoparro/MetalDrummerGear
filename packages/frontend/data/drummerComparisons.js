...
export const drummerComparisons = {
  ...
  'john-otto-vs-shannon-larkin': {
    ...
    faqs: [
      ...
      { q: 'What gear does John Otto use vs Shannon Larkin?', a: 'John Otto plays an Orange County Drum and Percussion (OCDP) custom kit with Zildjian A and A Custom cymbals. Shannon Larkin plays a ddrum Dios Series kit with a ddrum Dios 14x6.5" Maple snare and Sabian AAX Series cymbals, powered by a DW 9000 Series double pedal and Vic Firth American Classic 5B sticks.' },
  ...
  'shannon-larkin-vs-mario-duplantier': {
    ...
    faqs: [
      ...
      { q: 'What sticks does Shannon Larkin use?', a: 'Shannon Larkin plays Vic Firth American Classic 5B sticks — a standard (non-signature) model he has used since joining Godsmack in 2002.' },
    ],
  },
