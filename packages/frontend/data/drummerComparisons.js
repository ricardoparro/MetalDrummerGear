...
export const drummerComparisons = {
  ...
  'bill-ward-vs-matt-greiner': {
    ...
    metaTitle: 'Bill Ward vs Matt Greiner — Heavy Metal\'s Jazz-Swing Origin vs Metalcore\'s Polyrhythm King | MetalForge',
    metaDescription: 'Black Sabbath\'s Bill Ward vs August Burns Red\'s Matt Greiner — the jazz-swing originator who invented heavy metal drumming compared to Grammy-nominated metalcore\'s technical standard-bearer. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['bill-ward', 'matt-greiner'],
    comparison: {
      style: 'Bill Ward co-founded Black Sabbath in Birmingham, England, in 1968 alongside Tony Iommi, Geezer Butler, and Ozzy Osbourne, and his open, jazz-informed swing on "Black Sabbath" (1970), "Paranoid" (1970), and "Master of Reality" (1971) effectively invented heavy metal\'s rhythmic vocabulary from scratch. Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania, in 2003 and has anchored the band\'s Grammy-nominated catalog for over two decades, weaving jazz-influenced dynamics into breakneck metalcore tempos on records like "Found in Far Away Places" (2015) and "Guardians" (2020).',
      technique: 'Ward\'s technique is rooted in open, swinging jazz feel inherited from Gene Krupa and Buddy Rich rather than technical precision — his loose grip and behind-the-beat phrasing gave early Sabbath riffs like "Iron Man" and "War Pigs" a heavy, rolling groove, and he never reached for a double pedal across his entire career. Greiner incorporates jazz-influenced dynamics, creative stacked-cymbal work, and rapid-fire double bass into metalcore\'s heavy foundation, weaving odd time signatures seamlessly into August Burns Red\'s song structures rather than showcasing them as a technical display.',
      gear: 'Bill Ward played a Ludwig Super Classic (later Ludwig Classic Maple) kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals (15" Giant Beat Hi-Hats, 18" & 20" 2002 Crashes, a massive 24" 2002 Ride, 18" 2002 China), driven by a single Ludwig Speed King pedal — no double bass, relying entirely on foot technique. Matt Greiner plays a Pearl Reference Pure kit in Piano Black with his own Pearl Matt Greiner Signature 14x6" steel snare and Meinl Byzance cymbals (15" Dual Hi-Hats, 18" & 19" Extra Dry Medium Crashes, 21" Transition Ride, 18" Extra Dry China), driven by a Pearl Demon Drive double pedal and Vic Firth Matt Greiner Signature sticks.',
    ...
    verdict: 'Bill Ward and Matt Greiner sit at opposite ends of heavy metal\'s five-decade evolution while sharing a common thread — both bring jazz sensibility to genres that usually reward brute force. Ward invented metal\'s jazz-swung, single-pedal foundation in 1968, prioritizing feel and dynamics over speed. Greiner built a Grammy-nominated career turning metalcore into a showcase for jazz-informed dynamics and odd-time sophistication with August Burns Red. Comparing them is comparing metal\'s birth to one of its most musically literate modern descendants.',
    faqs: [
      { q: 'How do Bill Ward and Matt Greiner compare as drummers?', a: 'Bill Ward co-founded Black Sabbath in 1968 and is credited as one of the true originators of heavy metal drumming, inventing its jazz-swing-rooted vocabulary. Matt Greiner has driven August Burns Red\'s Grammy-nominated metalcore since 2003, weaving jazz-informed dynamics into odd time signatures. Ward represents metal\'s founding groove; Greiner represents modern metalcore\'s technical, musically literate evolution.' },
      { q: 'What gear do Bill Ward and Matt Greiner use?', a: 'Bill Ward played a Ludwig Super Classic/Classic Maple kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals, using only a single Ludwig Speed King pedal — no double bass. Matt Greiner plays a Pearl Reference Pure kit with his signature Pearl 14x6" steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal.' },
      { q: 'Did Bill Ward influence modern metalcore drummers like Matt Greiner?', a: 'Bill Ward\'s jazz-informed, swinging approach to Black Sabbath\'s riffs created the foundational rhythmic vocabulary that every metal drummer since has built upon, including modern metalcore players like Matt Greiner who bring similar jazz-influenced dynamics into a much heavier, faster genre.' },
      { q: 'Has August Burns Red won a Grammy?', a: 'No — August Burns Red, featuring drummer Matt Greiner, has received two Grammy nominations for Best Metal Performance (2016 and 2020) but has not won. Bill Ward\'s Black Sabbath won a Grammy for Best Metal Performance in 2014 for "God Is Dead?"' },
    ],
  },
  ...
  'bill-ward-vs-gavin-harrison': {
    ...
    metaTitle: 'Bill Ward vs Gavin Harrison — Heavy Metal\'s Founding Swing vs Progressive Rock\'s Polyrhythm Master | MetalForge',
    metaDescription: 'Black Sabbath\'s Bill Ward vs Porcupine Tree/King Crimson\'s Gavin Harrison — the jazz-swing originator who invented heavy metal drumming compared to progressive rock\'s most studied polyrhythmic technician. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['bill-ward', 'gavin-harrison'],
    comparison: {
      style: 'Bill Ward co-founded Black Sabbath in Birmingham, England, in 1968 alongside Tony Iommi, Geezer Butler, and Ozzy Osbourne, and his open, jazz-informed swing on "Black Sabbath" (1970), "Paranoid" (1970), and "Master of Reality" (1971) effectively invented heavy metal\'s rhythmic vocabulary from scratch. Gavin Harrison joined Porcupine Tree in 2002 and King Crimson\'s revolutionary three-drummer lineup in 2008, building a reputation on polyrhythmic sophistication across albums like "In Absentia" (2002), "Deadwing" (2005), and "Fear of a Blank Planet" (2007).',
      technique: 'Ward\'s technique came from jazz — a loose, open-handed feel inherited from Gene Krupa and Buddy Rich that prioritized dynamics and space over raw velocity, and he never reached for a double pedal in his career, generating Sabbath\'s early heaviness entirely through single-pedal technique and touch. Harrison\'s technique centers on ghost notes, ambidextrous independence, and odd-time polyrhythms delivered with controlled, almost scientific precision — he can make a groove in 7/8 feel more natural than straight 4/4.',
      gear: 'Bill Ward played a Ludwig Super Classic (later Ludwig Classic Maple) kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals, including a massive 24" 2002 Ride, driven by a single Ludwig Speed King pedal — no double bass throughout his entire career. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells (22"x17" bass drum, 10"/12" rack toms, 14"/16" floor toms), Sonor Gavin Harrison Signature snares (14"x5.25" brass primary, 12"x5" Protean), and Zildjian K Custom Special Dry cymbals developed in direct collaboration with him, anchored by a 21" Special Dry Ride.',
      influence: 'Ward is widely credited as one of the true originators of heavy metal drumming — every rock and metal drummer who followed, including Harrison, built on the rhythmic vocabulary he created with Sabbath, earning him a 2006 Rock and Roll Hall of Fame induction. Harrison\'s Zildjian K Custom Special Dry series changed how a generation of progressive drummers think about cymbal decay and controlled sound, and his multiple Modern Drummer awards cement him as one of prog\'s most studied players.',
    },
    verdict: 'Bill Ward and Gavin Harrison represent two entirely different eras and philosophies of rock-and-metal-adjacent drumming, separated by more than three decades. Ward invented heavy metal\'s jazz-swung, single-pedal foundation in 1968, prioritizing feel and dynamics over calculated complexity. Harrison built his reputation on meticulous, almost scientific polyrhythmic precision with Porcupine Tree and King Crimson, making impossibly complex odd-time signatures feel like natural, breathing grooves. Both prove that heavy music\'s most influential drummers can come from a foundation of restraint and musicality rather than raw power.',
    faqs: [
      { q: 'How do Bill Ward and Gavin Harrison compare as drummers?', a: 'Bill Ward co-founded Black Sabbath in 1968 and is credited as one of the true originators of heavy metal drumming, inventing its jazz-swing-rooted vocabulary. Gavin Harrison built his reputation on meticulous polyrhythmic precision with Porcupine Tree and King Crimson, earning multiple Modern Drummer awards. Ward founded metal\'s rhythmic language; Harrison represents progressive rock\'s technical, restraint-driven pinnacle.' },
      { q: 'What gear do Bill Ward and Gavin Harrison use?', a: 'Bill Ward played a Ludwig Super Classic/Classic Maple kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals, using only a single Ludwig Speed King pedal — no double bass. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells, his own Sonor signature snares, and Zildjian K Custom Special Dry cymbals developed specifically with him.' },
      { q: 'What bands are Bill Ward and Gavin Harrison known for?', a: 'Bill Ward co-founded and drummed for Black Sabbath from 1968 to 1983, and again from 1997 to 2006. Gavin Harrison has drummed for Porcupine Tree since 2002 and joined King Crimson\'s three-drummer lineup in 2008, also recording with The Pineapple Thief.' },
      { q: 'Did Bill Ward ever use a double bass pedal?', a: 'No. Bill Ward built Black Sabbath\'s foundational heaviness entirely with a single Ludwig Speed King pedal, relying on touch, tuning, and jazz-informed technique rather than extra hardware — a contrast to Gavin Harrison, whose polyrhythmic technique relies on independence and ghost notes rather than double bass speed as well.' },
    ],
  },
  ...
  'matt-greiner-vs-hellhammer': {
    ...
    metaTitle: 'Matt Greiner vs Hellhammer — Metalcore Polyrhythm vs Black Metal Blast Beats | MetalForge',
    metaDescription: 'August Burns Red\'s Matt Greiner vs Mayhem\'s Hellhammer — Grammy-nominated metalcore musicality compared to cold, relentless second-wave black metal blast-beat precision. Gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['matt-greiner', 'hellhammer'],
    comparison: {
      style: 'Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania, in 2003 and has anchored the band\'s Grammy-nominated catalog for over two decades, weaving jazz-influenced dynamics into breakneck metalcore tempos on records like "Found in Far Away Places" (2015) and "Guardians" (2020). Hellhammer (born Jan Axel Blomberg, 1969, in Oslo, Norway) joined Mayhem in 1988 as a teenager, replacing founding drummer Manheim, and delivered the genre-defining blast beats on "De Mysteriis Dom Sathanas" (1994) — the recording against which every subsequent black metal drum performance is measured — while running a parallel career with Dimmu Borgir since 1999.',
      technique: 'Greiner incorporates jazz-influenced dynamics, creative stacked-cymbal work, and rapid-fire double bass into metalcore\'s heavy foundation, weaving odd time signatures seamlessly into August Burns Red\'s song structures rather than showcasing them as a technical display. Hellhammer\'s blast beats are built on cold, relentless one-foot precision, and he famously plays barefoot for the direct tactile feedback he says is essential to holding tempo accuracy at extreme speeds, prioritizing icy atmosphere and machine-like consistency over dynamic range.',
    ...
    verdict: 'Matt Greiner and Hellhammer both push technical extremes, but from opposite philosophical directions — and both build their sound on a Pearl Reference kit with a Pearl Demon Drive double pedal. Greiner turns metalcore into a showcase for jazz-informed dynamics and odd-time musicality with August Burns Red\'s Grammy-nominated catalog. Hellhammer turned blast beat speed itself into black metal\'s defining texture on "De Mysteriis Dom Sathanas," prioritizing cold consistency over melodic variation. One brings warmth and groove to extreme tempos; the other brings icy, machine-like relentlessness.',
    faqs: [
      { q: 'How do Matt Greiner and Hellhammer compare as drummers?', a: 'Matt Greiner has driven August Burns Red\'s Grammy-nominated metalcore since 2003, weaving jazz-informed dynamics into odd time signatures. Hellhammer has driven Mayhem\'s black metal since 1988, delivering the genre-defining blast beats on "De Mysteriis Dom Sathanas" (1994). Greiner represents metalcore\'s musical sophistication; Hellhammer represents black metal\'s speed ceiling.' },
      { q: 'What gear do Matt Greiner and Hellhammer use?', a: 'Both drummers play a Pearl kit with a Pearl Demon Drive double pedal. Matt Greiner plays a Pearl Reference Pure kit with his signature Pearl 14x6" steel snare and Meinl Byzance cymbals. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals.' },
      ...
      { q: 'Has August Burns Red or Mayhem won a Grammy?', a: 'Neither band has won a Grammy. August Burns Red, featuring Matt Greiner, received Grammy nominations for Best Metal Performance in 2016 and 2020. Mayhem, featuring Hellhammer since 1988, has not received a Grammy nomination.' },
    ],
  },
  ...
  'matt-greiner-vs-john-otto': {
    ...
    metaTitle: 'Matt Greiner vs John Otto — Metalcore Polyrhythm vs Nu-Metal Groove | MetalForge',
    metaDescription: 'August Burns Red\'s Matt Greiner vs Limp Bizkit\'s John Otto — Grammy-nominated metalcore technicality compared to hip-hop-infused nu-metal pocket and groove. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['matt-greiner', 'john-otto'],
    comparison: {
      style: 'Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania, in 2003 and has anchored the band\'s Grammy-nominated catalog for over two decades, weaving jazz-influenced dynamics into breakneck metalcore tempos on records like "Found in Far Away Places" (2015) and "Guardians" (2020). John Otto co-founded Limp Bizkit in Jacksonville, Florida, in 1994, and his hip-hop-influenced, groove-first drumming was essential to defining the rap-metal sound that dominated mainstream rock at the turn of the millennium on albums like "Significant Other" (1999) and "Chocolate Starfish and the Hot Dog Flavored Water" (2000).',
      technique: 'Greiner incorporates jazz-influenced dynamics, creative stacked-cymbal work, and rapid-fire double bass into metalcore\'s heavy foundation, weaving odd time signatures seamlessly into August Burns Red\'s song structures rather than showcasing them as a technical display. Otto studied jazz at the Douglas Anderson School of the Arts, using syncopated patterns and funky ghost notes over a single-pedal setup to give Limp Bizkit\'s grooves their distinctive, hip-hop-informed pocket rather than chasing speed or odd-time complexity.',
    ...
    verdict: 'Matt Greiner and John Otto represent two very different definitions of technical excellence in heavy music, both rooted in jazz training applied to opposite ends of the genre spectrum. Greiner turns metalcore\'s breakneck tempos into a showcase for jazz-informed dynamics and odd-time sophistication with August Burns Red\'s Grammy-nominated catalog. Otto carried that same jazz-schooled sensibility into 1990s rap-metal, giving Limp Bizkit\'s riffs a syncopated, hip-hop-informed pocket instead of blast-beat aggression. One prioritizes complexity, the other prioritizes groove — both prove jazz training translates into wildly different corners of metal.',
    faqs: [
      { q: 'How do Matt Greiner and John Otto compare as drummers?', a: 'Matt Greiner has driven August Burns Red\'s Grammy-nominated metalcore since 2003, weaving jazz-informed dynamics into odd time signatures. John Otto has been Limp Bizkit\'s founding drummer since 1994, blending hip-hop-influenced grooves and funk-inspired beats into nu-metal. Greiner represents metalcore\'s technical sophistication; Otto represents nu-metal\'s groove-first pocket.' },
      ...
      { q: 'Does John Otto use a double bass pedal?', a: 'No — John Otto plays with a single-pedal setup, relying on jazz-schooled syncopation and funky ghost notes rather than double bass speed to give Limp Bizkit\'s grooves their distinctive hip-hop-infused pocket, unlike Matt Greiner, who drives August Burns Red\'s metalcore with a Pearl Demon Drive double pedal.' },
      { q: 'Has August Burns Red or Limp Bizkit won a Grammy?', a: 'Neither band has won a Grammy. August Burns Red, featuring Matt Greiner, received Grammy nominations for Best Metal Performance in 2016 and 2020. Limp Bizkit, featuring founding drummer John Otto since 1994, has not received a Grammy nomination.' },
    ],
  },
  ...
  'mario-duplantier-vs-ben-koller': {
    ...
    metaTitle: 'Mario Duplantier vs Ben Koller — Tribal Progressive Death Metal vs Mathcore Chaos | MetalForge',
    metaDescription: 'Gojira\'s Mario Duplantier vs Converge\'s Ben Koller — organic, tribal polyrhythmic power compared to hardcore-fueled mathcore unpredictability. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['mario-duplantier', 'ben-koller'],
    comparison: {
      style: 'Mario Duplantier co-founded progressive death metal band Gojira with his brother Joe Duplantier in Bayonne, France, in 1996, and built his reputation on crushing double bass patterns layered with tribal, almost ceremonial rhythmic structures across albums like "From Mars to Sirius" (2005), "L\'Enfant Sauvage" (2012), and "Magma" (2016). Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures, alongside side projects Mutoid Man and Killer Be Killed.',
      technique: 'Duplantier\'s technique blends raw power with polyrhythmic complexity and an unmistakable tribal sensibility, often locking into Gojira\'s tuned, resonant guitar tones with explosive fills and odd-meter grooves that feel organic rather than mechanical, forgoing a double pedal in favor of dual bass drums for a more natural feel. Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision.',
      gear: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with dual 22"x18" bass drums, a Tama S.L.P. 14x6" G-Maple snare, and Meinl Byzance Series cymbals (14" Dark Hi-Hats, 18" & 20" Brilliant Heavy Hammered Crashes, 21" Transition Ride, 18" Extra Dry China), powered by Tama Iron Cobra 900 Power Glide pedals and his own Tama signature sticks. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" K China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Duplantier has become one of progressive death metal\'s most influential modern voices, his tribal, polyrhythmic approach on Gojira records shaping a generation of drummers who blend technical death metal with atmospheric, almost meditative groove, and earning multiple Grammy nominations for "L\'Enfant Sauvage," "Amazonia," and "Fortitude." Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics.',
    },
    verdict: 'Mario Duplantier and Ben Koller both build modern extreme drumming on Tama Starclassic kits, yet arrive at completely different results. Duplantier channels Gojira\'s environmentally-themed death metal into organic, tribal polyrhythms that feel ceremonial even at crushing volume, spending nearly three decades refining that dynamics-first sound. Koller channels Converge\'s mathcore into raw, unpredictable chaos, favoring gut-level instinct over rehearsed precision so the music feels like it could fly apart at any second. Both are foundational voices in their respective corners of extreme, technical metal — one disciplined and tribal, the other loose and dangerous.',
    faqs: [
      { q: 'How do Mario Duplantier and Ben Koller compare as drummers?', a: 'Mario Duplantier co-founded Gojira in 1996 and built a career on tribal, polyrhythmic progressive death metal drumming across albums like "From Mars to Sirius" and "Magma." Ben Koller has driven Converge\'s mathcore evolution since 1999, becoming one of the most respected drummers in extreme and hardcore music. Duplantier represents disciplined, organic complexity; Koller represents controlled chaos.' },
      { q: 'What gear do Mario Duplantier and Ben Koller use?', a: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with dual 22"x18" bass drums, a Tama S.L.P. 14x6" G-Maple snare, and Meinl Byzance cymbals, powered by Tama Iron Cobra 900 Power Glide pedals. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a Tama Iron Cobra 900 double pedal.' },
      { q: 'What bands are Mario Duplantier and Ben Koller known for?', a: 'Mario Duplantier co-founded Gojira with his brother Joe Duplantier in 1996 and remains the band\'s drummer. Ben Koller has drummed for Converge since late 1999, and also plays in Mutoid Man alongside Stephen Brodsky and in the supergroup Killer Be Killed.' },
      { q: 'Does Mario Duplantier use a double bass pedal?', a: 'No — Mario Duplantier forgoes a double pedal in favor of dual physical bass drums for a more organic feel, a setup distinct from Ben Koller, who drives Converge\'s mathcore assault with a Tama Iron Cobra 900 double pedal.' },
    ],
  },
};
