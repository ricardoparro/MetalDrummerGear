...
export const drummerComparisons = {
  ...
  'nicko-mcbrain-vs-lars-ulrich': {
    ...
    comparison: {
      ...
      gear: 'Nicko plays British Drum Co. drums with Paiste cymbals for bright, cutting tone. Lars uses Tama Starclassic with Zildjian cymbals.',
  ...
  'nicko-mcbrain-vs-mikkey-dee': {
    ...
    comparison: {
      ...
      gear: 'Nicko plays British Drum Co. drums with Paiste 2002 cymbals for a bright, cutting tone. Mikkey endorses Sonor drums with Zildjian A Custom and K Series cymbals for aggressive projection.',
