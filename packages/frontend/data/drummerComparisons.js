...
export const drummerComparisons = {
  ...
  'dirk-verbeuren-vs-chris-adler': {
    ...
    comparison: {
      ...
      influence: 'Dirk brought a new level of technical sophistication to Megadeth after joining as touring drummer in 2016 — the same year Chris recorded the band\'s Grammy-winning "Dystopia" as a session drummer, before Dirk took over the live shows and eventually recorded his own Megadeth debut, "The Sick, the Dying... and the Dead!" (2022). Chris defined the NWOAHM drumming template with Lamb of God\'s Grammy-nominated work across the 2000s and 2010s.',
    },
  ...
  'dirk-verbeuren-vs-paul-bostaph': {
    ...
    comparison: {
      style: 'Dirk Verbeuren is a Belgian drummer who spent 18 years (1998–2016) as the backbone of Swedish melodic death metal band Soilwork before joining Megadeth as touring drummer in 2016, the same year Chris Adler recorded "Dystopia" (2016) as a session drummer without ever touring it. His precise, powerful playing combines European melodic death metal sensibilities with American thrash aggression, and he has since recorded his own Megadeth studio debut, "The Sick, the Dying... and the Dead!" (2022). Paul Bostaph is Slayer\'s longest-serving drummer outside of Dave Lombardo — joining in 1992 and recording four studio albums across two tenures (1992–2001, 2013–2019), including "Divine Intervention" (1994), "Undisputed Attitude" (1996), "Diabolus in Musica" (1998), and "Repentless" (2015), before returning once more for Slayer\'s 2024 reunion shows.',
    ...
    faqs: [
      { q: 'Who is Megadeth\'s drummer?', a: 'Dirk Verbeuren has been Megadeth\'s drummer since 2016, joining as touring drummer after Chris Adler recorded "Dystopia" (2016) as a session drummer. Before Megadeth, Verbeuren spent 18 years as Soilwork\'s drummer (1998–2016). He recorded his own Megadeth studio debut, "The Sick, the Dying... and the Dead!" (2022).' },
  ...
  'eloy-casagrande-vs-dirk-verbeuren': {
    ...
    verdict: 'Eloy Casagrande and Dirk Verbeuren both carried thrash metal\'s founding-era bands into a more technical present. Casagrande spent 13 years modernizing Sepultura\'s Brazilian thrash lineage before his explosive speed carried him to Slipknot and Modern Drummer\'s top ranking in 2024. Verbeuren imported nearly two decades of Soilwork\'s melodic death metal precision into Megadeth\'s classic thrash framework, recording his own Megadeth debut on "The Sick, the Dying... and the Dead!" after years as the band\'s touring drummer. Casagrande is groove-driven thrash\'s rising powerhouse; Verbeuren is technical death metal\'s import into thrash\'s old guard — both prove founding-era thrash bands still demand drummers who can outrun the genre\'s own history.',
    faqs: [
      ...
      { q: 'Has Dirk Verbeuren won any awards with Megadeth?', a: 'Megadeth\'s "Dystopia" (2016) won the Grammy for Best Metal Performance in 2017, the band\'s first Grammy win after several prior nominations — but that album was recorded by session drummer Chris Adler, not Verbeuren, who joined as touring drummer that same year. Verbeuren\'s own Megadeth studio debut, "The Sick, the Dying... and the Dead!" (2022), earned a Grammy nomination in the same category in 2023.' },
    ],
  },
