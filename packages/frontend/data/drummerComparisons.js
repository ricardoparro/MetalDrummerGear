...
export const drummerComparisons = {
  ...
  // Issue #3186: SEO batch 40 — dual replacement narrative (Lamb of God vs Slipknot successors)
  'art-cruz-vs-jay-weinberg': {
    slug: 'art-cruz-vs-jay-weinberg',
    title: 'Art Cruz vs Jay Weinberg',
    metaTitle: 'Art Cruz vs Jay Weinberg — Lamb of God & Slipknot Successors Compared | MetalForge',
    metaDescription: 'Lamb of God\'s Art Cruz vs ex-Slipknot\'s Jay Weinberg. Two drummers who inherited legendary metal drum chairs compared — groove-first power vs powerhouse precision. Gear, technique, and legacy analyzed.',
    category: 'other',
    drummers: ['art-cruz', 'jay-weinberg'],
    comparison: {
      style: 'Art Cruz joined Lamb of God in 2019, stepping into one of modern metal\'s most demanding drum chairs after founding member Chris Adler\'s departure, and brought a deathcore-honed physicality (via Winds of Plague) to the band\'s groove metal vocabulary. Jay Weinberg joined Slipknot in 2014 after Joey Jordison\'s exit, delivering four studio albums of precision-meets-chaos drumming before departing in 2023 to join Suicidal Tendencies — both drummers inherited scrutinized legacy seats in bands whose entire identity had been built around a single predecessor.',
      technique: 'Cruz favors overt front-of-the-beat attack and raw power, a blast-beat foundation from his deathcore background layered onto Lamb of God\'s syncopated riff-locking — a more physical, less mechanically precise approach than his predecessor\'s ride-bell-driven groove. Weinberg\'s technique is built on relentless independence and endurance, navigating Slipknot\'s chaotic multi-percussionist live arrangement night after night while channeling the aggression Jordison established, without ever losing the surgical timing the role demands.',
      gear: 'Art Cruz plays Ludwig drums with a Ludwig 14x6.5" Black Beauty snare, Zildjian A Custom & K Series cymbals, and a Trick Pro 1-V Bigfoot Double Pedal. Jay Weinberg plays a Pearl Masterworks Custom kit with a Pearl Reference 14x6.5" Steel snare, Zildjian A Custom & K Custom Series cymbals, and a Pearl Demon Drive Double Pedal — both share a Zildjian A Custom/K cymbal foundation despite different drum shell brands.',
      succession: 'Cruz had to learn Lamb of God\'s entire technically demanding two-decade catalog under Chris Adler in a short window, debuting on the band\'s 2020 self-titled album before further defining his own stamp on "Omens" (2022) and "Illegals in Heaven" (2024). Weinberg spent nearly a decade as the public, unmasked face of Slipknot\'s live show, recording ".5: The Gray Chapter" (2014), "We Are Not Your Kind" (2019), and "The End, So Far" (2022) before Slipknot moved on to a new drummer in late 2023.',
      influence: 'Cruz proved that Lamb of God\'s groove metal identity could survive a lineup change without losing its technical ceiling, inheriting one of the genre\'s most studied drum chairs and keeping the band a top-tier live act. Weinberg carried one of metal\'s most scrutinized seats for nearly a decade, becoming a reference point for an entire generation of drummers asking what it takes to replace a founding member in a globally touring extreme metal band.',
    },
    verdict: 'Art Cruz and Jay Weinberg answer the same question from opposite sides of American metal: what happens when a founding drummer leaves a band built around their identity? Cruz brought deathcore-forged physicality to Lamb of God\'s groove metal template and made it his own across three studio albums. Weinberg brought explosive precision to Slipknot\'s chaos for four albums before moving on entirely. Both prove that a legacy seat can be honored and reinvented at the same time — the comparison is raw power vs relentless precision, two different answers to the same succession problem.',
    faqs: [
      { q: 'Who replaced Chris Adler in Lamb of God?', a: 'Art Cruz replaced Chris Adler in Lamb of God. Cruz had been filling in for Adler live as far back as 2018 before being named the band\'s permanent drummer in 2019, following Adler\'s departure. Cruz made his studio debut on the band\'s self-titled 2020 album.' },
      { q: 'Who replaced Jay Weinberg in Slipknot?', a: 'Jay Weinberg left Slipknot in November 2023, and the band continued with a new drummer. Weinberg himself had joined Slipknot in 2014 as the replacement for founding member Joey Jordison, and after departing Slipknot he joined Suicidal Tendencies.' },
      { q: 'What gear do Art Cruz and Jay Weinberg use?', a: 'Art Cruz plays Ludwig drums with a Ludwig 14x6.5" Black Beauty snare and Zildjian A Custom & K Series cymbals, driven by a Trick Pro 1-V Bigfoot Double Pedal. Jay Weinberg plays a Pearl Masterworks Custom kit with a Pearl Reference 14x6.5" Steel snare and Zildjian A Custom & K Custom Series cymbals, driven by a Pearl Demon Drive Double Pedal.' },
      { q: 'What bands are Art Cruz and Jay Weinberg known for?', a: 'Art Cruz is the drummer for Lamb of God, having joined in 2019 after coming up through deathcore band Winds of Plague. Jay Weinberg was the drummer for Slipknot from 2014 to 2023 and is now the drummer for Suicidal Tendencies; he is also the son of E Street Band drummer Max Weinberg.' },
    ],
  },

  // Issue #3186: SEO batch 40 — replacement drummer longevity (Korn vs Judas Priest)
  'ray-luzier-vs-scott-travis': {
    slug: 'ray-luzier-vs-scott-travis',
    title: 'Ray Luzier vs Scott Travis',
    metaTitle: 'Ray Luzier vs Scott Travis — Korn & Judas Priest Drumming Longevity | MetalForge',
    metaDescription: 'Korn\'s Ray Luzier vs Judas Priest\'s Scott Travis. Two replacement drummers who outlasted their predecessors\' eras compared. Gear, technique, and career longevity analyzed.',
    category: 'other',
    drummers: ['ray-luzier', 'scott-travis'],
    comparison: {
      style: 'Ray Luzier joined Korn in 2007 as a seasoned session player — having worked with David Lee Roth and Army of Anyone — bringing rock-solid grooves and technical flair to Korn\'s nu-metal foundation while respecting the sound original drummer David Silveria established. Scott Travis joined Judas Priest in 1989, debuting on the speed-metal landmark "Painkiller," becoming the band\'s first non-British member and bringing a new level of technical proficiency to classic British heavy metal.',
      technique: 'Luzier blends deep groove instincts with technical precision, giving Korn\'s detuned, atmospheric arrangements a live-band muscularity that studio-era Korn sometimes lacked. Travis brought double-bass speed and technical sophistication that Judas Priest had never featured before "Painkiller" — his playing reinvigorated the band with an aggressive, virtuosic approach that redefined what a Judas Priest rhythm section could do.',
      gear: 'Ray Luzier plays Pearl Masters Maple Complete drums with a Pearl Reference 14x6.5" Brass snare and Sabian AAX Series cymbals, driven by a Pearl Demon Drive Double Pedal and Promark Ray Luzier Signature TX420X sticks. Scott Travis plays a DW Collector\'s Series Maple kit with a DW Collector\'s 14x6.5" Bronze snare and Paiste RUDE & 2002 Series cymbals, driven by a DW 9000 Series Double Pedal and Vic Firth American Classic 5B sticks.',
      longevity: 'Luzier has now held Korn\'s drum chair since 2007 — nearly two decades — recording "Korn III: Remember Who You Are" (2010), "The Path of Totality" (2011), "The Paradigm Shift" (2013), "The Serenity of Suffering" (2016), and "Requiem" (2022), longer than Silveria\'s own most productive stretch with the band. Travis has held Judas Priest\'s drum chair since 1989 — over three decades — recording every studio album from "Painkiller" through "Invincible Shield" (2024), making him the longest-tenured drummer in Judas Priest\'s history and a full Rock and Roll Hall of Fame inductee alongside the band in 2022.',
      influence: 'Luzier\'s session pedigree and adaptability helped Korn maintain relevance and touring strength across the 2010s and 2020s, proving a replacement drummer could match the energy of Korn\'s original lineup. Travis is widely regarded as reinvigorating Judas Priest at a critical moment — "Painkiller" is frequently cited as one of the most important speed/power metal albums ever recorded, and his three-decades-plus tenure has made him inseparable from the band\'s modern identity.',
    },
    verdict: 'Ray Luzier and Scott Travis are metal\'s two great examples of a replacement drummer becoming a defining, tenure-outlasting presence. Luzier stepped into Korn\'s nu-metal chair in 2007 and has anchored the band for nearly 20 years across five studio albums. Travis stepped into Judas Priest\'s classic heavy metal chair in 1989 and has anchored the band for over 30 years across every album since "Painkiller," culminating in a 2022 Rock and Roll Hall of Fame induction. Different genres, different eras, same result: both drummers turned a "replacement" role into one of metal\'s great longevity stories.',
    faqs: [
      { q: 'Who is the current drummer for Korn?', a: 'Ray Luzier is Korn\'s current drummer, having joined the band in 2007. He replaced founding drummer David Silveria and has since recorded five studio albums with Korn, including "Korn III: Remember Who You Are," "The Path of Totality," and "Requiem" (2022).' },
      { q: 'Who has been in both Korn and Judas Priest?', a: 'No single drummer has played in both bands — Ray Luzier (Korn) and Scott Travis (Judas Priest) are two separate musicians. However, both are frequently compared as the definitive examples of a "replacement drummer" who became inseparable from their band\'s modern identity across nu-metal and classic heavy metal respectively.' },
      { q: 'What gear do Ray Luzier and Scott Travis use?', a: 'Ray Luzier plays Pearl Masters Maple Complete drums with a Pearl Reference 14x6.5" Brass snare and Sabian AAX Series cymbals. Scott Travis plays a DW Collector\'s Series Maple kit with a DW Collector\'s 14x6.5" Bronze snare and Paiste RUDE & 2002 Series cymbals.' },
      { q: 'How long has Scott Travis been Judas Priest\'s drummer?', a: 'Scott Travis has been Judas Priest\'s drummer since 1989, debuting on "Painkiller." He is the band\'s longest-tenured drummer and its first non-British member, and was inducted into the Rock and Roll Hall of Fame as a member of Judas Priest in 2022.' },
    ],
  },
};
