...
export const drummerComparisons = {
  ...
  // Issue #4162: SEO batch 2 — this week's top-signal drummer cross-pairs
  'mario-duplantier-vs-gavin-harrison': {
    slug: 'mario-duplantier-vs-gavin-harrison',
    title: 'Mario Duplantier vs Gavin Harrison',
    metaTitle: 'Mario Duplantier vs Gavin Harrison — Tribal Power vs Polyrhythmic Restraint | MetalForge',
    metaDescription: 'Gojira\'s Mario Duplantier vs Porcupine Tree/King Crimson\'s Gavin Harrison — crushing tribal progressive death metal compared to dry, ghost-note-driven progressive rock precision. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['mario-duplantier', 'gavin-harrison'],
    comparison: {
      style: 'Mario Duplantier co-founded progressive death metal band Gojira with his brother Joe Duplantier in Bayonne, France, in 1996, building a style defined by crushing double bass patterns layered with tribal, ceremonial polyrhythms across albums including "From Mars to Sirius" (2005), "L\'Enfant Sauvage" (2012), and "Magma" (2016). Gavin Harrison joined Porcupine Tree in 2002 and King Crimson\'s revolutionary three-drummer lineup in 2008, building a reputation on polyrhythmic sophistication and restraint across albums like "In Absentia" (2002), "Deadwing" (2005), and "Fear of a Blank Planet" (2007) — a career built on precision and dynamic control rather than raw force.',
      technique: 'Duplantier\'s technique blends raw physical power with polyrhythmic complexity and an unmistakable tribal, ceremonial quality, treating toms as a melodic instrument and locking into Gojira\'s tuned, resonant guitar tones with explosive fills and odd-meter grooves that build dynamic contrast rather than relying on constant aggression. Harrison\'s technique centers on ghost notes, ambidextrous independence, and odd-time polyrhythms delivered with controlled, almost scientific precision — he can make a bar of 7/8 groove harder than straight 4/4, treating space and cymbal decay as compositional tools rather than chasing volume or speed.',
      gear: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. 14x6" G-Maple snare and Meinl Byzance Series cymbals (14" Dark Hi-Hats, 18" & 20" Brilliant Heavy Hammered Crashes, 21" Transition Ride, 18" Extra Dry China), powered by a Tama Iron Cobra 900 Power Glide double pedal and Vic Firth X5A sticks. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells (22"x17" bass drum, 10"/12" rack toms, 14"/16" floor toms) for articulation over raw power, his own Sonor Gavin Harrison Signature brass snares (14"x5.25" primary, 12"x5" Protean), and Zildjian K Custom Special Dry cymbals developed in direct collaboration with him, anchored by a 21" Special Dry Ride, plus Vic Firth signature sticks.',
      influence: 'Duplantier has become one of progressive death metal\'s most influential modern voices, earning multiple Grammy nominations for "L\'Enfant Sauvage," "Amazonia," and "Fortitude," and his tribal, polyrhythmic approach has shaped a generation of drummers who blend technical death metal with atmospheric groove. Harrison\'s Zildjian K Custom Special Dry series changed how a generation of progressive drummers think about cymbal decay and controlled sound, and his multiple Modern Drummer awards cement him as one of prog\'s most studied and imitated players.',
    },
    verdict: 'Mario Duplantier and Gavin Harrison represent progressive metal\'s two extremes of intensity. Duplantier channels raw, ceremonial power into Gojira\'s tribal, tuned-percussion attack, building dynamic weight through crushing double bass and odd-meter grooves. Harrison channels restraint and scientific precision into Porcupine Tree and King Crimson\'s more understated progressive rock, proving that ghost notes and controlled cymbal decay can be just as compelling as brute force. Both are considered among the most technically gifted drummers of their generation — Duplantier through visceral tribal power, Harrison through dry, polyrhythmic sophistication.',
    faqs: [
      { q: 'How do Mario Duplantier and Gavin Harrison compare as drummers?', a: 'Mario Duplantier co-founded Gojira in 1996 and built a tribal, polyrhythmic style around crushing double bass and tuned-percussion grooves. Gavin Harrison joined Porcupine Tree in 2002 and King Crimson\'s three-drummer lineup in 2008, building a reputation on ghost notes, ambidextrous independence, and restrained, controlled polyrhythms. Duplantier represents raw tribal power; Harrison represents dry, scientific precision.' },
      { q: 'What gear do Mario Duplantier and Gavin Harrison use?', a: 'Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. 14x6" G-Maple snare and Meinl Byzance Series cymbals, powered by a Tama Iron Cobra 900 Power Glide double pedal. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells and his own Sonor Gavin Harrison Signature brass snares, paired with Zildjian K Custom Special Dry cymbals developed specifically with him.' },
      { q: 'What bands are Mario Duplantier and Gavin Harrison known for?', a: 'Mario Duplantier co-founded Gojira with his brother Joe Duplantier in 1996 and remains the band\'s drummer. Gavin Harrison has drummed for Porcupine Tree since 2002 and was part of King Crimson\'s three-drummer lineup starting in 2008.' },
      { q: 'Has Mario Duplantier or Gavin Harrison won any major awards?', a: 'Mario Duplantier has earned multiple Grammy nominations with Gojira for "L\'Enfant Sauvage," "Amazonia," and "Fortitude." Gavin Harrison has won multiple Modern Drummer awards and readers\' poll honors, and his Zildjian K Custom Special Dry cymbal line, developed in collaboration with him, is used by progressive drummers worldwide.' },
    ],
  },
  ...
  'jaska-raatikainen-vs-gavin-harrison': {
    ...
    metaTitle: 'Jaska Raatikainen vs Gavin Harrison — Melodic Death Precision vs Progressive Restraint | MetalForge',
    metaDescription: 'Children of Bodom\'s Jaska Raatikainen vs Porcupine Tree/King Crimson\'s Gavin Harrison — Finnish melodic death metal blast-beat precision compared to dry, polyrhythmic progressive rock control. Gear, technique, and legacy compared.',
    category: 'progressive',
    drummers: ['jaska-raatikainen', 'gavin-harrison'],
    comparison: {
      style: 'Jaska Raatikainen co-founded Finnish melodic death metal band Children of Bodom in 1993 alongside the late Alexi Laiho and remained its sole drummer for the band\'s entire 26-year run, anchoring the neoclassical melodic death metal sound across albums including "Hatebreeder" (1999) and "Follow the Reaper" (2000) through the band\'s 2019 farewell "Hexed." Gavin Harrison joined Porcupine Tree in 2002 and King Crimson\'s revolutionary three-drummer lineup in 2008, building a career on polyrhythmic sophistication across "In Absentia" (2002), "Deadwing" (2005), and "Fear of a Blank Planet" (2007) — a career defined by restraint and precision rather than extreme metal\'s velocity.',
      technique: 'Raatikainen balances death metal velocity with melodic awareness — rapid double bass volleys and blast beats that lock tightly with Children of Bodom\'s neoclassical riffing, with fills composed to support rather than overwhelm the guitar and keyboard interplay around him. Harrison\'s playing is defined by ghost notes, ambidextrous independence, and odd-time polyrhythms delivered with almost scientific control — he treats space and cymbal decay as compositional tools, favoring a dry, controlled attack that rewards close listening over one built for raw speed or aggression.',
      gear: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom Series cymbals (14" A Custom Hi-Hats, 17" & 18" A Custom Crashes, 20" K Custom Ride, 18" China), powered by a Pearl Eliminator double pedal and Vic Firth American Classic 5A sticks. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells and a smaller 22"x17" bass drum for articulation over raw power, his own Sonor Gavin Harrison Signature brass snares, and Zildjian K Custom Special Dry cymbals developed specifically with him — dry, controlled, and fast-decaying, the sonic opposite of a blast-beat-built kit.',
      influence: 'Raatikainen helped build Finland\'s melodic death metal scene into a global commercial force — Children of Bodom sold over two million albums worldwide, and his playing on "Hatebreeder" and "Follow the Reaper" influenced a generation of melodic death and metalcore drummers. Harrison\'s multiple Modern Drummer awards and his Zildjian K Custom Special Dry collaboration have made him one of the most studied drummers in progressive music, influencing players who prioritize control and dynamics over volume.',
    },
    verdict: 'Jaska Raatikainen and Gavin Harrison occupy opposite ends of technical metal drumming\'s volume dial. Raatikainen spent 26 unbroken years anchoring Children of Bodom\'s neoclassical melodic death metal with surgical, blast-beat-driven precision built for speed and aggression. Harrison built his reputation on the opposite instinct — dry, restrained polyrhythms and ghost notes that redefine progressive rock through subtlety rather than force. Both are internationally recognized as technical masters of their instrument, proving that "precision" in metal-adjacent drumming can mean either relentless velocity or scientific restraint.',
    faqs: [
      { q: 'How do Jaska Raatikainen and Gavin Harrison compare as drummers?', a: 'Jaska Raatikainen anchored Children of Bodom\'s melodic death metal with blast-beat-driven precision for 26 years, from 1993 to 2019. Gavin Harrison has drummed for Porcupine Tree since 2002 and King Crimson\'s three-drummer lineup since 2008, building a career on ghost notes and dry, controlled polyrhythms. Raatikainen represents extreme metal velocity; Harrison represents progressive rock restraint.' },
      { q: 'What gear do Jaska Raatikainen and Gavin Harrison use?', a: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom Series cymbals, driven by a Pearl Eliminator double pedal. Gavin Harrison plays a Sonor SQ2 kit with thin maple shells and Sonor Gavin Harrison Signature brass snares, paired with Zildjian K Custom Special Dry cymbals developed specifically with him.' },
      { q: 'What bands are Jaska Raatikainen and Gavin Harrison known for?', a: 'Jaska Raatikainen was the sole drummer of Finnish melodic death metal band Children of Bodom from 1993 until the band\'s dissolution in 2019. Gavin Harrison has drummed for Porcupine Tree since 2002 and was part of King Crimson\'s three-drummer lineup starting in 2008.' },
      { q: 'Why does Gavin Harrison\'s cymbal setup sound so different from Jaska Raatikainen\'s?', a: 'Gavin Harrison co-developed the Zildjian K Custom Special Dry line specifically for fast decay and controlled, articulate tone suited to progressive rock\'s dynamic subtlety. Jaska Raatikainen\'s Zildjian A Custom & K Custom setup is voiced for cutting through Children of Bodom\'s dense, distorted guitar-and-keyboard mix at extreme tempos — a brighter, more sustained sound built for extreme metal rather than restraint.' },
    ],
  },
  ...
  'jaska-raatikainen-vs-john-otto': {
    ...
    metaTitle: 'Jaska Raatikainen vs John Otto — Melodic Death Blast Beats vs Nu-Metal Groove | MetalForge',
    metaDescription: 'Children of Bodom\'s Jaska Raatikainen vs Limp Bizkit\'s John Otto — Finnish melodic death metal precision compared to jazz-trained, hip-hop-infused nu-metal pocket. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['jaska-raatikainen', 'john-otto'],
    comparison: {
      style: 'Jaska Raatikainen co-founded Finnish melodic death metal band Children of Bodom in 1993 alongside the late Alexi Laiho and remained its sole drummer for the band\'s entire 26-year run, anchoring the neoclassical melodic death metal sound across albums including "Hatebreeder" (1999) and "Follow the Reaper" (2000) through the band\'s 2019 farewell "Hexed." John Otto co-founded Limp Bizkit in Jacksonville, Florida, in 1994, and his hip-hop-influenced, groove-first drumming was essential to defining the rap-metal sound that dominated mainstream rock at the turn of the millennium on albums like "Significant Other" (1999) and "Chocolate Starfish and the Hot Dog Flavored Water" (2000).',
      technique: 'Raatikainen balances death metal velocity with melodic awareness — rapid double bass volleys and blast beats that lock tightly with Children of Bodom\'s neoclassical riffing, with fills composed to support rather than overwhelm the guitar and keyboard interplay around him. Otto\'s technique centers on pocket and feel rather than speed — trained in jazz at Douglas Anderson School of the Arts, he uses tight, syncopated grooves and funk-inspired ghost notes that fuse hip-hop\'s rhythmic sensibility with hard rock power, giving Limp Bizkit\'s biggest singles their head-nodding, danceable heaviness rather than extreme metal\'s velocity.',
      gear: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom Series cymbals (14" A Custom Hi-Hats, 17" & 18" A Custom Crashes, 20" K Custom Ride, 18" China), powered by a Pearl Eliminator double pedal and Vic Firth American Classic 5A sticks. John Otto plays an Orange County Drum & Percussion (OCDP) Custom kit with an OCDP 14x7" Maple/Ash snare and Zildjian K Custom Series cymbals (14" Hi-Hats, 17" & 18" Dark Crashes, 20" Ride, 18" China), powered by a DW 9000 Series double pedal and Promark 747 Rock Wood Tip sticks.',
      influence: 'Raatikainen helped build Finland\'s melodic death metal scene into a global commercial force — Children of Bodom sold over two million albums worldwide, and his playing on "Hatebreeder" and "Follow the Reaper" influenced a generation of melodic death and metalcore drummers. Otto proved nu-metal\'s rhythmic debt to hip-hop and funk, and his groove-centric approach with Limp Bizkit helped define an entire commercial era of metal, showing that pocket and feel could sell as many records as speed and aggression.',
    },
    verdict: 'Jaska Raatikainen and John Otto represent two completely different definitions of technical drumming excellence. Raatikainen spent 26 unbroken years anchoring Children of Bodom\'s neoclassical melodic death metal with blast-beat-driven, surgical precision. Otto built his reputation on groove and pocket, fusing jazz training and hip-hop feel with hard rock power to help define nu-metal\'s biggest commercial wave with Limp Bizkit. One drummer\'s ceiling is extreme-metal velocity; the other\'s is rhythmic feel — together they show just how wide the range of "great metal drumming" can be.',
    faqs: [
      { q: 'How do Jaska Raatikainen and John Otto compare as drummers?', a: 'Jaska Raatikainen anchored Children of Bodom\'s melodic death metal with blast-beat-driven precision for 26 years, from 1993 to 2019. John Otto co-founded Limp Bizkit in 1994 and built his reputation on jazz-trained, hip-hop-influenced groove and pocket rather than extreme metal speed.' },
      { q: 'What gear do Jaska Raatikainen and John Otto use?', a: 'Jaska Raatikainen plays a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare and Zildjian A Custom & K Custom Series cymbals, driven by a Pearl Eliminator double pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom kit with an OCDP 14x7" Maple/Ash snare and Zildjian K Custom Series cymbals, powered by a DW 9000 Series double pedal.' },
      { q: 'What bands are Jaska Raatikainen and John Otto known for?', a: 'Jaska Raatikainen was the sole drummer of Finnish melodic death metal band Children of Bodom from 1993 until the band\'s dissolution in 2019. John Otto co-founded Limp Bizkit in Jacksonville, Florida, in 1994 and remains the band\'s drummer.' },
      { q: 'Did John Otto study jazz drumming?', a: 'Yes — John Otto studied jazz at the Douglas Anderson School of the Arts in Jacksonville, Florida, before co-founding Limp Bizkit in 1994. That jazz background is why his nu-metal grooves lean on syncopation, pocket, and ghost notes rather than the blast-beat velocity drummers like Jaska Raatikainen bring to extreme metal.' },
    ],
  },
  ...
  'eloy-casagrande-vs-ben-koller': {
    ...
    metaTitle: 'Eloy Casagrande vs Ben Koller — Modern Groove-Metal Speed vs Mathcore Chaos | MetalForge',
    metaDescription: 'Slipknot/Sepultura\'s Eloy Casagrande vs Converge\'s Ben Koller — explosive, technically precise groove-metal drumming compared to mathcore\'s raw, unpredictable intensity. Gear, technique, and legacy compared.',
    category: 'other',
    drummers: ['eloy-casagrande', 'ben-koller'],
    comparison: {
      style: 'Eloy Casagrande became Sepultura\'s drummer in 2011 at just 19 years old, spending 13 years driving the Brazilian thrash institution\'s modern era before joining Slipknot in 2024, where his explosive speed and technical prowess earned him Modern Drummer magazine\'s No. 1 metal drummer honor in their 2024 Readers\' Poll. Ben Koller joined Converge in late 1999 and became central to the band\'s mathcore evolution, driving landmark records including "Jane Doe" (2001), "Axe to Fall" (2009), and "The Dusk in Us" (2017) with a chaotic, improvisational intensity that mirrors the band\'s unpredictable song structures.',
      technique: 'Casagrande\'s São Paulo upbringing brought samba and bossa nova influences into his playing — even at blast-beat velocity his double kick breathes with a natural swing rather than mechanically alternating, and his technical fills and stamina let him move between Sepultura\'s thrash-groove foundation and Slipknot\'s maximalist live show without losing precision. Koller\'s technique is built for maximum unpredictability — a loose, explosive attack that thrives on Converge\'s constantly shifting time signatures and sudden dynamic swings, favoring gut-level feel over rehearsed precision, which is exactly what gives Converge\'s mathcore its dangerous, live-wire energy.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums, a Tama S.L.P. Sonic Steel 14"x6" snare, and Paiste RUDE/2002/PST X cymbals, driven by twin Tama Speed Cobra 910 pedals and his own Promark signature sticks. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals (14" K Dark Thin Hi-Hats, 18" & 19" K Dark Medium Thin Crashes, 21" K Custom Ride, 18" China), driven by a Tama Iron Cobra 900 double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Casagrande\'s 2024 Modern Drummer #1 ranking validated over a decade of thrash pedigree with Sepultura before he stepped onto one of metal\'s biggest stages with Slipknot, representing metal drumming\'s modern, technically demanding standard. Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, and Converge\'s "Jane Doe" is routinely cited as a genre-defining mathcore record that reshaped how hardcore and metal drummers approach unpredictability and dynamics.',
    },
    verdict: 'Eloy Casagrande and Ben Koller both share a Tama-built foundation, but arrive at their sound through opposite instincts. Casagrande channels explosive, groove-laced technical precision — Brazilian swing at extreme velocity — that carried him from Sepultura\'s thrash trenches to Slipknot\'s biggest stages and a Modern Drummer #1 ranking. Koller channels raw, unpredictable chaos into Converge\'s mathcore assault, where the sense that a song could fly apart at any second is the entire point. One drummer\'s mastery is measured in precision under pressure, the other\'s in controlled danger.',
    faqs: [
      { q: 'How do Eloy Casagrande and Ben Koller compare as drummers?', a: 'Eloy Casagrande built his reputation on explosive technical speed across 13 years with Sepultura and, since 2024, Slipknot, earning Modern Drummer\'s No. 1 metal drummer honor in 2024. Ben Koller has driven Converge\'s unpredictable mathcore evolution since late 1999, favoring a loose, explosive attack over rehearsed precision.' },
      { q: 'What gear do Eloy Casagrande and Ben Koller use?', a: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums, a Tama S.L.P. Sonic Steel snare, and Paiste RUDE/2002/PST X cymbals, driven by twin Tama Speed Cobra 910 pedals. Ben Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, driven by a single Tama Iron Cobra 900 double pedal.' },
      { q: 'What bands are Eloy Casagrande and Ben Koller known for?', a: 'Eloy Casagrande drummed for Sepultura from 2011 to 2024 before joining Slipknot in 2024. Ben Koller has drummed for Converge since late 1999, and also plays in Mutoid Man and the supergroup Killer Be Killed.' },
      { q: 'Why does Eloy Casagrande use twin bass drum pedals instead of a single pedal?', a: 'Eloy Casagrande uses two independent Tama Speed Cobra 910 pedals rather than a single pedal with a slave, giving him complete foot independence for the technical, syncopated double-kick patterns his Brazilian percussion background demands — a setup distinct from Ben Koller\'s single Tama Iron Cobra 900 double pedal, which suits Converge\'s more improvisational mathcore attack.' },
    ],
  },
  ...
  'eloy-casagrande-vs-hellhammer': {
    ...
    metaTitle: 'Eloy Casagrande vs Hellhammer — Brazilian Groove-Metal Speed vs Norwegian Black Metal Cold Precision | MetalForge',
    metaDescription: 'Slipknot/Sepultura\'s Eloy Casagrande vs Mayhem\'s Hellhammer — modern groove-metal technical speed compared to the icy blast-beat precision that defined second-wave black metal. Gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['eloy-casagrande', 'hellhammer'],
    comparison: {
      style: 'Eloy Casagrande became Sepultura\'s drummer in 2011 at just 19 years old, spending 13 years driving the Brazilian thrash institution\'s modern era before joining Slipknot in 2024, where his explosive speed and technical prowess earned him Modern Drummer magazine\'s No. 1 metal drummer honor in their 2024 Readers\' Poll. Hellhammer (born Jan Axel Blomberg on August 2, 1969, in Oslo, Norway) joined Mayhem in 1988 as a teenager, replacing founding drummer Manheim, and delivered the genre-defining blast beats on "De Mysteriis Dom Sathanas" (1994) — the recording against which every subsequent black metal drum performance is measured. He has run a parallel career with Dimmu Borgir since 1999.',
      technique: 'Casagrande\'s São Paulo upbringing brought samba and bossa nova influences into his playing — even at blast-beat velocity his double kick breathes with a natural swing rather than mechanically alternating, using two independent bass drum pedals for complete foot independence across thrash and nu-metal contexts. Hellhammer\'s blast beats are built on cold, relentless one-foot precision, and he famously plays barefoot for the direct tactile feedback he says is essential to holding tempo accuracy at extreme speeds — a technique built for atmosphere and raw aggression rather than groove or dynamic contrast.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums, a Tama S.L.P. Sonic Steel 14"x6" snare, and Paiste RUDE/2002/PST X cymbals, driven by twin Tama Speed Cobra 910 pedals and his own Promark signature sticks. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals (14" A Custom Hi-Hats, 17" & 19" A Custom Crashes, 20" Z Custom Dark Ride, 18" A China Boy), driven by a Pearl Demon Drive double pedal and Vic Firth American Classic 5B sticks.',
      influence: 'Casagrande\'s 2024 Modern Drummer #1 ranking validated over a decade of thrash pedigree with Sepultura before he stepped onto one of metal\'s biggest stages with Slipknot, representing modern extreme metal\'s technically demanding new standard. Hellhammer defined the sound and speed vocabulary of second-wave black metal, and his three-decade-plus dual career with Mayhem and Dimmu Borgir has made him the genre\'s most in-demand extreme drummer for both raw and symphonic contexts.',
    },
    verdict: 'Eloy Casagrande and Hellhammer represent two very different extremes of technical metal drumming. Casagrande brings Brazilian rhythmic swing to explosive thrash and nu-metal speed, a technical completeness that carried him from Sepultura to Slipknot and a Modern Drummer #1 ranking. Hellhammer brings cold, atmosphere-first blast-beat precision that literally defined second-wave black metal\'s sound on "De Mysteriis Dom Sathanas," a standard the entire genre still measures itself against. Both are considered among the most technically complete drummers in extreme metal, separated by hemisphere, genre, and philosophy but united by relentless double-kick discipline.',
    faqs: [
      { q: 'How do Eloy Casagrande and Hellhammer compare as drummers?', a: 'Eloy Casagrande built his reputation on explosive technical speed and Brazilian rhythmic swing across 13 years with Sepultura and, since 2024, Slipknot, earning Modern Drummer\'s No. 1 metal drummer honor in 2024. Hellhammer has anchored Mayhem\'s black metal since 1988, delivering the genre-defining cold, blast-beat precision on "De Mysteriis Dom Sathanas" (1994).' },
      { q: 'What gear do Eloy Casagrande and Hellhammer use?', a: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with dual 22"x18" bass drums, a Tama S.L.P. Sonic Steel snare, and Paiste RUDE/2002/PST X cymbals, driven by twin Tama Speed Cobra 910 pedals. Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals, driven by a Pearl Demon Drive double pedal.' },
      { q: 'What bands are Eloy Casagrande and Hellhammer known for?', a: 'Eloy Casagrande drummed for Sepultura from 2011 to 2024 before joining Slipknot in 2024. Hellhammer has drummed for Mayhem since 1988 and Dimmu Borgir since 1999, alongside stints in Arcturus and Shining.' },
      { q: 'Why does Hellhammer play barefoot?', a: 'Hellhammer plays barefoot for the direct tactile feedback he says is essential to holding precise tempo accuracy on his kick pedal at the extreme speeds second-wave black metal demands — a contrast to Eloy Casagrande, who relies on twin independent Tama Speed Cobra 910 pedals and conventional footwear for his technical, groove-inflected double-kick approach.' },
    ],
  },
};
