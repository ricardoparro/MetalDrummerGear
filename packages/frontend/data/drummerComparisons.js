...
export const drummerComparisons = {
  ...
  'matt-greiner-vs-matt-halpern': {
    ...
    verdict: 'Matt Greiner and Matt Halpern represent two defining faces of modern heavy music drumming — Greiner\'s jazz-infused metalcore and Halpern\'s polyrhythmic djent. Halpern remains a Pearl endorser while Greiner switched to Mapex in 2016, and both transcend their genres to inspire a generation of technically ambitious heavy drummers.',
  },
  ...
  'matt-greiner-vs-matt-garstka': {
    ...
    verdict: 'Matt Greiner and Matt Garstka are two defining polyrhythm voices of their respective corners of technical heavy music, with Greiner\'s Mapex Black Panther Design Lab kit contrasting Garstka\'s Meinl Byzance-equipped DW Collector\'s Series kit. Greiner built a 20-plus-year career turning Grammy-nominated metalcore into a showcase for jazz-informed dynamics and odd-time sophistication with August Burns Red. Garstka brought Berklee-trained jazz-fusion virtuosity to Animals as Leaders\' entirely instrumental, djent-rooted catalog, turning polyrhythmic complexity into fluid, conversational playing. Both share a devotion to making complex time signatures feel natural rather than showy.',
    faqs: [
  ...
  'matt-greiner-vs-ben-koller': {
    ...
    comparison: {
      ...
      influence: 'Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through his signature gear and worldwide clinics. Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, with Converge\'s "Jane Doe" routinely cited as a genre-defining mathcore record.',
    },
  ...
  'matt-greiner-vs-mario-duplantier': {
    ...
    comparison: {
      ...
      influence: 'Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through his signature gear and worldwide clinics. Duplantier pioneered the "environmental metal" style that made Gojira one of the most critically acclaimed progressive death metal bands of the 21st century, earning multiple Grammy nominations.',
    },
  ...
  'jaska-raatikainen-vs-matt-greiner': {
    ...
    faqs: [
      ...
      { q: 'Has Matt Greiner won any awards with August Burns Red?', a: 'Matt Greiner has earned two Grammy nominations for Best Metal Performance with August Burns Red.' },
  ...
  'flo-mounier-vs-matt-greiner': {
    ...
    comparison: {
      ...
      gear: 'Flo Mounier plays a Tama Starclassic Maple kit in Dark Mocha Fade with a Tama S.L.P. Classic Dry Aluminum 14x5.5" snare and Sabian AAX & HHX Series cymbals (14" AAX X-Celerator Hi-Hats, 16" & 18" AAX X-Plosion Crashes, 19" HHX X-Plosion Crash, 20" AAX Metal Ride, 18" AAX X-Treme Chinese), driven by a Tama Speed Cobra 910 Twin Pedal. Matt Greiner plays a Mapex Black Panther Design Lab kit with dual 22"x18" bass drums, a Pearl Matt Greiner Signature 14"x6" steel snare, and Paiste Formula 602 cymbals, driven by a DW 9000 Series double pedal and Vic Firth Matt Greiner signature sticks.',
