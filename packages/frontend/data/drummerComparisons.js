...
export const drummerComparisons = {
  ...
  'joey-jordison-vs-jay-weinberg': {
    ...
    comparison: {
      ...
      gear: 'Joey Jordison played Pearl Masters Premium Maple drums with his signature Pearl Joey Jordison 13"×6.5" snare — a compact shell chosen for faster response at tempos exceeding 280 BPM — paired with Paiste RUDE Series cymbals, Pearl Demon Drive double pedals, and Promark Joey Jordison Signature TX515W sticks. Jay Weinberg endorsed SJC Custom Drums, Zildjian cymbals, DW pedal hardware, and Vater 5B sticks — a setup built for the aggressive attack Slipknot\'s live shows demand.',
    ...
    faqs: [
      ...
      { q: 'What gear does Joey Jordison use vs Jay Weinberg?', a: 'Joey Jordison played Pearl Masters Premium Maple drums with a signature 13"×6.5" Pearl snare, Paiste RUDE Series cymbals, and Pearl Demon Drive double pedals. Jay Weinberg played SJC Custom Drums with Zildjian cymbals, DW pedal hardware, and Vater 5B sticks.' },
    ],
  },
