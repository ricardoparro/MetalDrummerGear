...
export const drummerComparisons = {
  ...
  'abe-cunningham-vs-john-otto': {
    ...
    comparison: {
      ...
      gear: 'Abe Cunningham plays a Tama Starclassic Maple/Bubinga drum kit with Zildjian K Custom & A Custom Series cymbals (14" K Custom Hi-Hats, 18" & 20" K Custom Crashes, 22" K Custom Ride, 19" A Custom China), powered by a Tama Iron Cobra 900 Rolling Glide pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with dual OCDP snares (a 14x6.5" 40-ply vented shell and a 10x6" 20-ply piccolo) and Zildjian A Custom cymbals (13" A Custom Mastersound Hi-Hats, 16" & 17" A Custom Projection Crashes, 20" A Custom EFX, 20" FX Oriental Crash of Doom), driven by Gibraltar G Class bass drum pedals.',
    ...
    faqs: [
      ...
      { q: 'What gear do Abe Cunningham and John Otto use?', a: 'Abe Cunningham plays a Tama Starclassic Maple/Bubinga drum kit with Zildjian K Custom & A Custom Series cymbals and a Tama Iron Cobra 900 Rolling Glide pedal. John Otto plays an Orange County Drum & Percussion (OCDP) Custom Type 5 Acrylic kit with Zildjian A Custom cymbals and Gibraltar G Class bass drum pedals.' },
