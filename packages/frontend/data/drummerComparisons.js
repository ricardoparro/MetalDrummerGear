...
export const drummerComparisons = {
  ...
  'eloy-casagrande-vs-mario-duplantier': {
    ...
    metaTitle: 'Eloy Casagrande vs Mario Duplantier — Brazilian Thrash Power vs Gojira\'s Tribal Groove | MetalForge',
    metaDescription: 'Slipknot/Sepultura\'s Eloy Casagrande vs Gojira\'s Mario Duplantier — modern groove-metal technical speed versus tribal, polyrhythmic French death metal precision. Style, gear, and influence compared.',
    category: 'other',
    drummers: ['eloy-casagrande', 'mario-duplantier'],
    comparison: {
      style: 'Eloy Casagrande became Sepultura\'s drummer in 2011 at just 20 years old, spending 13 years driving the Brazilian thrash institution\'s modern era before joining Slipknot in 2024, where his explosive speed and technical prowess earned him Modern Drummer magazine\'s No. 1 metal drummer honor in their 2024 Readers\' Poll. Mario Duplantier co-founded progressive death metal band Gojira with his brother Joe Duplantier in Bayonne, France, in 1996, and built his reputation on crushing double bass patterns layered with tribal, almost ceremonial rhythmic structures across albums like "From Mars to Sirius" (2005), "L\'Enfant Sauvage" (2012), and "Magma" (2016).',
      technique: 'Casagrande\'s technique is built for modern extreme dynamics — explosive double bass speed, technical fill construction, and the stamina to move between Sepultura\'s thrash-groove foundation and Slipknot\'s maximalist nine-member live show without losing precision. Duplantier blends raw power with polyrhythmic complexity and an unmistakable tribal sensibility, often locking into Gojira\'s tuned, resonant guitar tones with explosive fills and odd-meter grooves that feel organic rather than mechanical.',
      gear: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x6.5" snare and Paiste cymbals (15" Masters Dark Hi-Hats, 20" Formula 602 Modern Essentials Crash, 20" 2002 Wild Crash, 20" Masters Dark Crash, 20" 2002 Novo China, 20" 2002 Power Ride), driven by a Tama Iron Cobra Power Glide double pedal. Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. 14x6" G-Maple snare and Meinl Byzance Series cymbals (14" Dark Hi-Hats, 18" & 20" Brilliant Heavy Hammered Crashes, 21" Transition Ride, 18" Extra Dry China), powered by a Tama Iron Cobra 900 Power Glide double pedal and Vic Firth X5A sticks. Both drummers build around Tama Starclassic shells and Iron Cobra pedals, but reach for different cymbal brands and tuning philosophies to match their bands\' sounds.',
      influence: 'Casagrande represents metal drumming\'s modern generation — Modern Drummer\'s 2024 Readers\' Poll No. 1 metal drummer, whose transition from Sepultura to Slipknot at the top of both bands\' drum chairs demonstrates the technical standard contemporary metal now demands. Duplantier has become one of progressive death metal\'s most influential modern voices, his tribal, polyrhythmic approach on Gojira records shaping a generation of drummers who blend technical death metal with atmospheric, almost meditative groove.',
    },
    verdict: 'Eloy Casagrande and Mario Duplantier are two of the most-searched technical drummers in modern metal, each defining a different national school of extreme precision. Casagrande built a reputation on explosive speed and stamina across 13 years with Sepultura before stepping into Slipknot\'s drum chair in 2024, earning Modern Drummer\'s top metal drummer honor along the way. Duplantier has spent nearly three decades turning Gojira\'s tribal, tuned-percussion attack into one of progressive death metal\'s most influential templates. Brazilian power meets French tribal precision — both share Tama Starclassic kits and Iron Cobra pedals as the technical foundation for two very different sonic identities.',
    faqs: [
      { q: 'How do Eloy Casagrande and Mario Duplantier compare as drummers?', a: 'Eloy Casagrande built his reputation on explosive technical speed across 13 years with Sepultura and, since 2024, Slipknot, earning Modern Drummer\'s No. 1 metal drummer honor in 2024. Mario Duplantier co-founded Gojira in 1996 and built his reputation on crushing double bass patterns layered with tribal, polyrhythmic grooves across albums like "From Mars to Sirius" and "Magma."' },
      { q: 'What gear do Eloy Casagrande and Mario Duplantier use?', a: 'Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x6.5" snare and Paiste cymbals, driven by a Tama Iron Cobra Power Glide double pedal. Mario Duplantier plays a Tama Starclassic Walnut/Birch kit with a Tama S.L.P. 14x6" G-Maple snare and Meinl Byzance Series cymbals, powered by a Tama Iron Cobra 900 Power Glide double pedal.' },
      { q: 'What bands are Eloy Casagrande and Mario Duplantier known for?', a: 'Eloy Casagrande drummed for Sepultura from 2011 to 2024 and has drummed for Slipknot since 2024. Mario Duplantier co-founded Gojira with his brother Joe Duplantier in 1996 and remains the band\'s drummer.' },
      { q: 'Do Eloy Casagrande and Mario Duplantier play the same drum brand?', a: 'Yes — both are Tama Starclassic endorsers who use Tama Iron Cobra double pedals, though Casagrande plays a Bubinga shell kit with Paiste cymbals while Duplantier plays a Walnut/Birch shell kit with Meinl Byzance cymbals.' },
    ],
  },
  ...
  'gavin-harrison-vs-matt-greiner': {
    ...
    metaTitle: 'Gavin Harrison vs Matt Greiner — Progressive Rock Polyrhythm vs Grammy-Nominated Metalcore | MetalForge',
    metaDescription: 'Porcupine Tree/King Crimson\'s Gavin Harrison vs August Burns Red\'s Matt Greiner — restrained polyrhythmic sophistication versus jazz-informed technical metalcore. Style, gear, and influence compared.',
    category: 'progressive',
    drummers: ['gavin-harrison', 'matt-greiner'],
    comparison: {
      style: 'Gavin Harrison, born in Harrow, London, in 1963, spent his early career as an in-demand session drummer before joining Porcupine Tree in 2002, a move that redefined progressive rock drumming on albums like "In Absentia" (2002), "Deadwing" (2005), and "Fear of a Blank Planet" (2007); he joined King Crimson\'s revolutionary three-drummer lineup in 2008 and also plays with The Pineapple Thief. Matt Greiner co-founded metalcore band August Burns Red in Lancaster, Pennsylvania, in 2003, and has driven the band\'s Grammy-nominated catalog for over two decades with jazz-influenced dynamics and technical precision that helped define modern metalcore\'s compositional ambition on records like "Found in Far Away Places" (2015) and "Guardians" (2020).',
      technique: 'Harrison plays with restrained sophistication, layering polyrhythms and ghost notes through odd time signatures while combining jazz vocabulary with metal intensity — an almost scientific approach to rhythm that lets 7/8 groove harder than straight 4/4. Greiner brings jazz-informed dynamics and odd-meter phrasing to metalcore songwriting, weaving technical complexity into riff-driven arrangements without sacrificing the genre\'s breakdown-heavy impact.',
      gear: 'Gavin Harrison plays a custom Sonor SQ2 kit (22" bass drum, 10" & 12" rack toms, 14" & 16" floor toms) with his own signature 14x5.25" brass snare and Zildjian K Custom Special Dry cymbals (14" Special Dry Hi-Hats, 16" & 18" Special Dry Crashes, 21" Special Dry Ride, 18" Trash China), driven by a Sonor Perfect Balance Pedal. Matt Greiner plays a Pearl Reference Pure kit in Piano Black with his own Pearl Matt Greiner Signature 14x6" steel snare and Meinl Byzance cymbals (15" Dual Hi-Hats, 18" & 19" Extra Dry Medium Crashes, 21" Transition Ride, 18" Extra Dry China), driven by a Pearl Demon Drive double pedal and his own Vic Firth Matt Greiner Signature sticks.',
      influence: 'Harrison has been recognized multiple times by Modern Drummer magazine as progressive rock\'s best drummer, and his instructional material on polyrhythms and odd-time playing is required study for serious drummers worldwide. Greiner\'s two-decade run with August Burns Red helped establish technical metalcore as Grammy-nominated, mainstream-viable music, and his jazz-informed approach to a genre built on breakdowns has influenced a generation of technically ambitious heavy drummers.',
    },
    verdict: 'Gavin Harrison and Matt Greiner occupy the progressive end of two very different genres, each prized for bringing jazz sophistication to heavy music rather than raw speed. Harrison\'s restrained, polyrhythmic mastery redefined what progressive rock drumming could sound like across Porcupine Tree, King Crimson, and The Pineapple Thief. Greiner\'s jazz-informed technicality turned August Burns Red into a Grammy-nominated force within modern metalcore. Both prove that odd time signatures and ghost-note nuance can serve the song rather than just showcase chops — international technical-precision drumming from two entirely different corners of heavy music.',
    faqs: [
      { q: 'How do Gavin Harrison and Matt Greiner compare as drummers?', a: 'Gavin Harrison is known for restrained, polyrhythmic sophistication across Porcupine Tree, King Crimson, and The Pineapple Thief, blending jazz vocabulary with progressive rock precision. Matt Greiner is known for jazz-informed dynamics and technical precision within Grammy-nominated metalcore, having co-founded and driven August Burns Red since 2003.' },
      { q: 'What gear do Gavin Harrison and Matt Greiner use?', a: 'Gavin Harrison plays a custom Sonor SQ2 kit with his own signature 14x5.25" brass snare and Zildjian K Custom Special Dry cymbals, driven by a Sonor Perfect Balance Pedal. Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal.' },
      { q: 'What bands are Gavin Harrison and Matt Greiner known for?', a: 'Gavin Harrison has drummed for Porcupine Tree since 2002 and King Crimson since 2008, and also plays with The Pineapple Thief. Matt Greiner co-founded and has drummed for metalcore band August Burns Red since 2003.' },
      { q: 'Has August Burns Red or Porcupine Tree won a Grammy?', a: 'Neither band has won a Grammy. August Burns Red, featuring Matt Greiner, received Grammy nominations for Best Metal Performance in 2016 and 2020. Porcupine Tree has not received a Grammy nomination.' },
    ],
  },
  ...
  'bill-ward-vs-brann-dailor': {
    ...
    metaTitle: 'Bill Ward vs Brann Dailor — Heavy Metal\'s Founding Swing vs Mastodon\'s Melodic Chaos | MetalForge',
    metaDescription: 'Black Sabbath\'s Bill Ward vs Mastodon\'s Brann Dailor — the jazz-swing originator who invented heavy metal drumming compared to the singing, melodic drummer who redefined progressive sludge. Style, gear, and generational influence compared.',
    category: 'other',
    drummers: ['bill-ward', 'brann-dailor'],
    comparison: {
      style: 'Bill Ward co-founded Black Sabbath in 1968 and, alongside Ozzy Osbourne, Tony Iommi, and Geezer Butler, helped invent heavy metal\'s rhythmic vocabulary across the band\'s classic Ozzy-era albums, including "Black Sabbath" (1970), "Paranoid" (1970), and "Master of Reality" (1971). Brann Dailor, born March 19, 1975, in Rochester, New York, has driven Atlanta progressive sludge band Mastodon since 2000, developing a melodic, almost lead-instrument approach to drumming — flowing tom patterns and constant motion that weave through the music as countermelodies on albums like "Crack the Skye" (2009) and "Emperor of Sand" (2017), while also handling substantial lead vocal duties.',
      technique: 'Ward\'s technique is rooted in jazz — a swinging, open-handed feel inherited from Gene Krupa and Buddy Rich, played entirely on a single Ludwig Speed King pedal with no double bass, that prioritized groove and dynamics over speed and gave early Black Sabbath riffs their loose, hard-swinging heaviness. Dailor treats the kit as a singing instrument rather than a timekeeper — his toms are tuned in musical intervals to create actual melodies on songs like "Oblivion," and his modest single 22"x18" bass drum relies on creative placement and groove rather than raw speed, all while he sings complex vocal harmonies over some of metal\'s most technically demanding drum parts.',
      gear: 'Bill Ward played a Ludwig Classic Maple kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals (15" Giant Beat Hi-Hats, 18" & 20" 2002 Crashes, a massive 24" 2002 Ride, 18" 2002 China), driven by a single Ludwig Speed King pedal and Vic Firth American Classic 2B sticks. Brann Dailor plays a DW Collector\'s Series kit with a four-tom configuration and a DW Collector\'s aluminum 6.5"-deep snare, paired with Meinl Byzance cymbals (14" Byzance Traditional Hi-Hats, 18"-20" Traditional/Brilliant Crashes, 22" Traditional Medium Ride, Byzance Brilliant China) chosen for their warm, complex overtones rather than the bright, cutting sound many metal drummers prefer.',
      influence: 'Ward is widely credited as one of the true originators of heavy metal drumming, and his playing on Black Sabbath\'s first six albums remains the foundational reference point the entire genre was built on. Dailor helped transform Mastodon from Atlanta sludge upstarts into one of progressive metal\'s most critically acclaimed and commercially successful acts, and his rare combination of technically demanding drumming with lead vocal duties — recognized with multiple Grammy nominations — has made him one of the genre\'s most distinctive modern voices.',
    },
    verdict: 'Bill Ward and Brann Dailor sit at opposite ends of a direct generational lineage from Black Sabbath\'s doom-laden birth of heavy metal to Mastodon\'s progressive sludge evolution. Ward invented the genre\'s foundational jazz-swing vocabulary with Black Sabbath starting in 1968, prioritizing feel and groove over speed on a single-pedal kit. Dailor, drumming for Mastodon since 2000, pushed that same instinct for musicality further than almost anyone, turning his kit into a melodic, singing instrument while handling lead vocals simultaneously. Both prove that heavy metal\'s power has always come from feel and musicality first — Ward founded that idea, and Dailor carried it into prog-sludge\'s most ambitious modern form.',
    faqs: [
      { q: 'How do Bill Ward and Brann Dailor compare as drummers?', a: 'Bill Ward co-founded Black Sabbath in 1968 and helped invent heavy metal drumming\'s jazz-influenced, swinging groove on foundational records like "Paranoid" (1970). Brann Dailor has drummed for Mastodon since 2000, developing a melodic, countermelody-driven style where his toms are tuned to create actual musical patterns, while also singing lead vocals on tracks like those from "Crack the Skye" (2009).' },
      { q: 'What gear do Bill Ward and Brann Dailor use?', a: 'Bill Ward played a Ludwig Classic Maple kit with a Ludwig Supraphonic 14x6.5" LM402 snare and Paiste 2002 & Giant Beat Series cymbals, driven by a single Ludwig Speed King pedal with no double bass. Brann Dailor plays a DW Collector\'s Series kit with a DW Collector\'s aluminum snare and Meinl Byzance cymbals chosen for warm, complex tones.' },
      { q: 'What bands are Bill Ward and Brann Dailor known for?', a: 'Bill Ward co-founded and drummed for Black Sabbath from 1968 to 1983, and again from 1997 to 2006. Brann Dailor has been the drummer and a vocalist for Mastodon since 2000.' },
      { q: 'Does Brann Dailor sing while drumming like Bill Ward did?', a: 'Brann Dailor handles substantial lead and harmony vocal duties for Mastodon while playing technically demanding drum parts, a combination that sets him apart even from most modern metal drummers. Bill Ward did not sing lead vocals in Black Sabbath, which were handled by Ozzy Osbourne, but Ward\'s jazz-informed drumming style directly shaped the rhythmic foundation that later progressive metal drummers, including Dailor, built upon.' },
    ],
  },
  ...
  'gavin-harrison-vs-eloy-casagrande': {
    ...
    metaTitle: 'Gavin Harrison vs Eloy Casagrande — Progressive Rock Finesse vs Modern Metal Speed | MetalForge',
    metaDescription: 'Porcupine Tree/King Crimson\'s Gavin Harrison vs Slipknot/Sepultura\'s Eloy Casagrande — restrained polyrhythmic mastery versus explosive modern technical speed. Style, gear, and international influence compared.',
    category: 'other',
    drummers: ['gavin-harrison', 'eloy-casagrande'],
    comparison: {
      style: 'Gavin Harrison, born in Harrow, London, in 1963, spent his early career as an in-demand session drummer before joining Porcupine Tree in 2002, redefining progressive rock drumming on albums like "In Absentia" (2002) and "Fear of a Blank Planet" (2007), and joining King Crimson\'s revolutionary three-drummer lineup in 2008. Eloy Casagrande became Sepultura\'s drummer in 2011 at just 20 years old, spending 13 years driving the Brazilian thrash institution\'s modern era before joining Slipknot in 2024, where his explosive speed and technical prowess earned him Modern Drummer magazine\'s No. 1 metal drummer honor in their 2024 Readers\' Poll.',
      technique: 'Harrison plays with restrained sophistication, layering polyrhythms and ghost notes through odd time signatures with an almost scientific understanding of rhythm, making complexity feel effortless and musical rather than showy. Casagrande\'s technique is built for modern extreme dynamics — explosive double bass speed, technical fill construction, and the stamina to move between Sepultura\'s thrash-groove foundation and Slipknot\'s maximalist nine-member live show without losing precision.',
      gear: 'Gavin Harrison plays a custom Sonor SQ2 kit (22" bass drum, 10" & 12" rack toms, 14" & 16" floor toms) with his own signature 14x5.25" brass snare and Zildjian K Custom Special Dry cymbals (14" Special Dry Hi-Hats, 16" & 18" Special Dry Crashes, 21" Special Dry Ride, 18" Trash China), driven by a Sonor Perfect Balance Pedal built for dynamic control over raw speed. Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass 14x6.5" snare and Paiste cymbals (15" Masters Dark Hi-Hats, 20" Formula 602 Modern Essentials Crash, 20" 2002 Wild Crash, 20" Masters Dark Crash, 20" 2002 Novo China, 20" 2002 Power Ride), powered by a Tama Iron Cobra Power Glide double pedal built for speed.',
      influence: 'Harrison has been recognized multiple times by Modern Drummer magazine as progressive rock\'s best drummer, and his instructional material on polyrhythms is required study for serious drummers worldwide. Casagrande represents metal drumming\'s modern generation — Modern Drummer\'s own 2024 Readers\' Poll No. 1 metal drummer — whose transition from Sepultura to Slipknot at the top of both bands\' drum chairs demonstrates the technical standard contemporary metal now demands.',
    },
    verdict: 'Gavin Harrison and Eloy Casagrande represent an international clash of technical philosophies — British progressive-rock finesse versus Brazilian modern-metal speed. Harrison built a reputation on restrained, polyrhythmic sophistication across Porcupine Tree and King Crimson, prioritizing dynamic control and musicality over raw power. Casagrande built his reputation on explosive technical speed and stamina across 13 years with Sepultura and, since 2024, Slipknot, earning Modern Drummer\'s top metal drummer honor along the way. Both are widely considered among the most technically gifted drummers from their respective corners of heavy music, proving that "technical mastery" can mean either controlled sophistication or explosive velocity.',
    faqs: [
      { q: 'How do Gavin Harrison and Eloy Casagrande compare as drummers?', a: 'Gavin Harrison is known for restrained, polyrhythmic sophistication across Porcupine Tree and King Crimson, prioritizing dynamic control and musicality. Eloy Casagrande is known for explosive technical speed and stamina, having driven Sepultura for 13 years before joining Slipknot in 2024 and earning Modern Drummer\'s No. 1 metal drummer honor.' },
      { q: 'What gear do Gavin Harrison and Eloy Casagrande use?', a: 'Gavin Harrison plays a custom Sonor SQ2 kit with his own signature brass snare and Zildjian K Custom Special Dry cymbals, driven by a Sonor Perfect Balance Pedal. Eloy Casagrande plays a Tama Starclassic Bubinga kit with a Tama Bell Brass snare and Paiste cymbals, driven by a Tama Iron Cobra Power Glide double pedal.' },
      { q: 'What bands are Gavin Harrison and Eloy Casagrande known for?', a: 'Gavin Harrison has drummed for Porcupine Tree since 2002 and King Crimson since 2008, and also plays with The Pineapple Thief. Eloy Casagrande drummed for Sepultura from 2011 to 2024 and has drummed for Slipknot since 2024.' },
      { q: 'Who is more technical, Gavin Harrison or Eloy Casagrande?', a: 'Both are considered elite technical drummers, but in different ways. Gavin Harrison\'s technicality is defined by polyrhythmic sophistication and restrained ghost-note control in progressive rock. Eloy Casagrande\'s technicality is defined by explosive double bass speed and stamina in modern thrash and groove metal.' },
    ],
  },
};
