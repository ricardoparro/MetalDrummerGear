...
export const drummerComparisons = {
  ...
  'eloy-casagrande-vs-jay-weinberg': {
    ...
    metaDescription: 'Eloy Casagrande (Slipknot) vs Jay Weinberg (ex-Slipknot). Both carried Slipknot\'s drum chair — Eloy stepping in for 2024, Jay departing after 9 years. Gear, technique, and legacy compared.',
    category: 'extreme',
    drummers: ['eloy-casagrande', 'jay-weinberg'],
    comparison: {
      style: 'Eloy Casagrande rose through Sepultura before joining Slipknot in 2024, bringing razor-sharp groove, thunderous double bass, and a thrash-meets-modern-metal authority to one of extreme metal\'s biggest and most theatrical stages. Jay Weinberg redefined Slipknot\'s percussive identity across four albums, channeling predecessor Joey Jordison\'s ferocity while stamping his own precision-based identity on the band\'s live and studio work.',
      technique: 'Eloy combines Brazilian rhythmic roots with thrash metal power — his double bass work is defined by locked-in groove rather than sheer speed, and adapting to Slipknot\'s percussion-heavy, nine-member live show is his defining challenge. Jay brings a technically rigorous, precise approach to Slipknot\'s chaos — his live playing with the percussive assault of Slipknot\'s multi-drummer setup demanded exceptional timing, independence, and endurance night after night.',
    ...
    verdict: 'Eloy Casagrande and Jay Weinberg share the rare experience of carrying Slipknot\'s drum chair. Eloy stepped into one of metal\'s most demanding, masked live shows; Jay carried that same percussive identity for nearly a decade before him. Both are technically elite, both carry the weight of expectation, and both delivered. The debate is power-and-groove vs precision-and-chaos.',
    faqs: [
      { q: 'Why did Eloy Casagrande join Slipknot?', a: 'Eloy Casagrande was announced as Slipknot\'s drummer in 2024 after leaving Sepultura. His combination of technical precision, thrash metal roots, and ability to handle Slipknot\'s demanding live show made him the natural choice.' },
      ...
      { q: 'Who is the better drummer: Eloy Casagrande or Jay Weinberg?', a: 'Both are exceptional. Eloy\'s groove-driven thrash power suits Slipknot\'s percussive assault; Jay\'s precision-based chaos suited that same demanding chair. Style preference determines the winner.' },
    ],
  },
  ...
  'gene-hoglan-vs-eloy-casagrande': {
    ...
    faqs: [
      ...
      { q: 'Why did Eloy Casagrande join Slipknot?', a: 'Eloy Casagrande joined Slipknot in 2024 after departing Sepultura. His combination of technical precision, thrash metal roots, and ability to handle Slipknot\'s demanding live show made him the ideal choice for one of metal\'s most scrutinized drum chairs.' },
    ],
  },
  ...
  'brann-dailor-vs-eloy-casagrande': {
    ...
    faqs: [
      ...
      { q: 'Why did Eloy Casagrande join Slipknot?', a: 'Eloy Casagrande joined Slipknot in 2024 after departing Sepultura. His thrash metal roots, technical precision, and ability to handle a demanding live show made him the natural choice for one of the most scrutinized drum chairs in metal history.' },
    ],
  },
  ...
  'eloy-casagrande-vs-igor-cavalera': {
    ...
    comparison: {
      ...
      technique: 'Eloy combines death metal speed and double bass fluency with locked-in groove — his ability to adapt across Sepultura\'s catalog and later Slipknot\'s percussion-heavy, aggressive live show demonstrates extraordinary musical versatility. Igor invented the tribal-metal fusion that defines Sepultura\'s classic era, incorporating Brazilian folk percussion, marching rhythms, and thrash aggression into a single unmistakable style.',
    ...
    faqs: [
      ...
      { q: 'Why did Eloy Casagrande join Slipknot?', a: 'Eloy Casagrande joined Slipknot in 2024 after departing Sepultura. His thrash metal roots, technical precision, and ability to handle a demanding live show made him the ideal candidate for one of metal\'s most scrutinized drum chairs.' },
  ...
  'aquiles-priester-vs-morgan-agren': {
    ...
    faqs: [
      ...
      { q: 'What bands have Aquiles Priester and Morgan Ågren played in?', a: 'Aquiles Priester has drummed for Angra (2001-2008, 2023-present), W.A.S.P., and Hangar. Morgan Ågren co-founded the Mats/Morgan Band in 1981, toured with Frank Zappa in 1988, played with Kaipa (2002-2005), and drummed for Devin Townsend Project from 2012 to 2016.' },
      { q: 'What gear do Aquiles Priester and Morgan Ågren use?', a: 'Aquiles Priester plays a Pearl Reference Series kit with a Pearl Reference signature snare and Meinl Byzance Series cymbals, driven by a Pearl Demon Chain double pedal and his own Vic Firth signature sticks. Morgan Ågren plays a Sonor SQ2 Beech kit with a Sonor Designer snare and Meinl Byzance Series cymbals, using Sonor hardware and DW pedals.' },
    ],
  },
  ...
  'mikkey-dee-vs-lars-ulrich': {
    ...
    faqs: [
      ...
      { q: 'What gear do Mikkey Dee and Lars Ulrich use?', a: 'Mikkey Dee plays a Yamaha Recording Custom kit with a Yamaha Mikkey Dee Signature 14x8" snare and Zildjian A Custom & K Series cymbals, driven by twin Yamaha FP9 pedals. Lars Ulrich plays a Tama Starclassic Maple kit with his signature Tama LU1465 snare and Zildjian A Custom cymbals, powered by a Tama Iron Cobra 900 Power Glide double pedal — both drummers rely on Zildjian A Custom cymbals despite otherwise different rigs.' },
  ...
  'mikkey-dee-vs-scott-travis': {
    ...
    faqs: [
      ...
      { q: 'What gear do Mikkey Dee and Scott Travis use?', a: 'Mikkey Dee plays a Yamaha Recording Custom kit with a Yamaha Mikkey Dee Signature 14x8" snare and Zildjian A Custom & K Series cymbals, driven by twin Yamaha FP9 pedals. Scott Travis plays a ddrum Dominion Series kit with a ddrum Scott Travis Signature snare, Paiste RUDE & 2002 cymbals, and a DW 9000 double pedal.' },
  ...
  'mikkey-dee-vs-shannon-larkin': {
    ...
    faqs: [
      ...
      { q: 'What gear do Mikkey Dee and Shannon Larkin use?', a: 'Mikkey Dee plays a Yamaha Recording Custom kit with a Yamaha Mikkey Dee Signature 14x8" snare and Zildjian A Custom & K Series cymbals, driven by twin Yamaha FP9 pedals. Shannon Larkin plays a ddrum Dios Series kit with a ddrum Dios 14x6.5" Maple snare and Sabian AAX & HHX Series cymbals, driven by a DW 9000 Series double pedal.' },
  ...
  'hellhammer-vs-mikkey-dee': {
    ...
    faqs: [
      ...
      { q: 'What gear do Hellhammer and Mikkey Dee use?', a: 'Hellhammer plays a Pearl Reference Series kit with a Pearl Reference snare and Zildjian A Custom cymbals, driven by a Pearl Demon Drive double pedal. Mikkey Dee plays a Yamaha Recording Custom / Oak Custom kit built around a single 24" bass drum, with a Yamaha Recording Custom Aluminum or Brass snare and Zildjian A Custom cymbals.' },
  ...
  'aquiles-priester-vs-navene-koperweis': {
    ...
    faqs: [
      ...
      { q: 'What gear do Aquiles Priester and Navene Koperweis use?', a: 'Aquiles Priester plays a Pearl Reference Series kit with Sabian HHX & AAX Series cymbals and a Pearl Demon Drive double pedal. Navene Koperweis plays a DW Performance Series kit with a DW Performance steel snare and Meinl Byzance Extra Dry cymbals.' },
  ...
  'raymond-herrera-vs-john-otto': {
    ...
    faqs: [
      ...
      { q: 'What gear did John Otto use on Significant Other versus his later Limp Bizkit albums?', a: 'On "Significant Other" (1999), John Otto played a Sonor Force 3007 kit with Paiste 2002 cymbals. He later transitioned to a custom Orange County Drum and Percussion (OCDP) kit with Zildjian A and A Custom cymbals and Gibraltar hardware, the setup he has used for the bulk of Limp Bizkit\'s catalog since.' },
    ],
  },
  ...
  'matt-greiner-vs-john-otto': {
    ...
    faqs: [
      ...
      { q: 'What gear do Matt Greiner and John Otto use?', a: 'Matt Greiner plays a Pearl Reference Pure kit with his own signature Pearl 14x6" Steel snare and Meinl Byzance cymbals, driven by a Pearl Demon Drive double pedal. John Otto plays Pearl Masters drums with Paiste Signature Series cymbals.' },
      { q: 'Where did John Otto study drumming?', a: 'John Otto studied at the Douglas Anderson School of the Arts in Jacksonville, Florida — the same school that produced Limp Bizkit bandmates. His jazz education is evident in his sophisticated ghost-note patterns and syncopated groove work.' },
