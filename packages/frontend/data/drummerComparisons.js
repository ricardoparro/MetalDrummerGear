...
export const drummerComparisons = {
  ...
  'isaac-lamb-vs-john-otto': {
    ...
    comparison: {
      ...
      gear: 'Lamb endorses SJC Custom Drums and Meinl Cymbals. Otto plays an OCDP Custom Type 5 Acrylic kit with Zildjian A Custom cymbals and Gibraltar G Class bass drum pedals.',
  ...
  'isaac-lamb-vs-ryan-van-poederooyen': {
    ...
    comparison: {
      ...
      technique: 'Lamb prioritizes devastating breakdown timing over flash, built around consistent, direct-drive kick response that lands patterns consistently at every tempo the band throws at him. Van Poederooyen\'s creative tom patterns and tasteful cymbal work give Devin Townsend\'s shifting dynamics room to breathe, backed by thunderous double bass through a Pearl Demon Drive pedal when the material demands it.',
      gear: 'Isaac endorses SJC Custom Drums and Meinl Cymbals; his specific kit configuration is not publicly documented. Ryan plays a Pearl Reference Series kit with a 14x6.5" brass Pearl Reference snare, Sabian HHX & AAX cymbals (14" HHX Evolution Hi-Hats, 18" & 20" HHX Evolution Crashes, 21" HHX Raw Bell Dry Ride, 19" AAXtreme China), and a Pearl Demon Drive double pedal.',
    ...
    faqs: [
      ...
      { q: 'What gear do Isaac Lamb and Ryan Van Poederooyen use?', a: 'Isaac Lamb endorses SJC Custom Drums and Meinl Cymbals; his specific kit configuration is not publicly documented. Ryan Van Poederooyen plays a Pearl Reference Series kit with a 14x6.5" brass Pearl Reference snare and Sabian HHX & AAX cymbals, driven by a Pearl Demon Drive double pedal.' },
    ],
  },
  ...
  'chris-turner-vs-isaac-lamb': {
    ...
    comparison: {
      ...
      gear: 'Chris Turner plays a Tama Starclassic Maple/Birch kit with Meinl Byzance cymbals and Vic Firth American Classic 5A sticks. Isaac Lamb endorses SJC Custom Drums and Meinl Cymbals; his specific kit configuration is not publicly documented.',
    ...
    faqs: [
      ...
      { q: 'What gear do Chris Turner and Isaac Lamb use?', a: 'Chris Turner plays a Tama Starclassic Maple/Birch kit with Meinl Byzance cymbals and Vic Firth American Classic 5A sticks. Isaac Lamb endorses SJC Custom Drums and Meinl Cymbals; his specific kit configuration is not publicly documented.' },
