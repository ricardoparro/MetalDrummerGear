...
export const drummerComparisons = {
  ...
  'matt-greiner-vs-matt-halpern': {
    ...
    verdict: 'Matt Greiner and Matt Halpern represent two defining faces of modern heavy music drumming — Greiner\'s jazz-infused metalcore and Halpern\'s polyrhythmic djent. Both transcend their genres and inspire a generation of technically ambitious heavy drummers.',
  },
  ...
  'matt-greiner-vs-matt-garstka': {
    ...
    verdict: 'Matt Greiner and Matt Garstka are the two defining polyrhythm voices of their respective corners of technical heavy music, playing very different kits — Greiner\'s Mapex Black Panther Design Lab and Paiste Formula 602 cymbals versus Garstka\'s DW Collector\'s Series kit and Meinl Byzance cymbals. Greiner built a 20-plus-year career turning Grammy-nominated metalcore into a showcase for jazz-informed dynamics and odd-time sophistication with August Burns Red. Garstka brought Berklee-trained jazz-fusion virtuosity to Animals as Leaders\' entirely instrumental, djent-rooted catalog, turning polyrhythmic complexity into fluid, conversational playing. Both share a devotion to making complex time signatures feel natural rather than showy.',
    faqs: [
  ...
  'matt-greiner-vs-ben-koller': {
    ...
    comparison: {
      ...
      gear: 'Greiner plays a Mapex Black Panther Design Lab kit with a 14x6.5" Maple snare and Paiste Formula 602 cymbals, driven by a DW 9000 Series double pedal. Koller plays a Tama Starclassic Maple kit with a Tama S.L.P. 14x6" Brass snare and Zildjian K Dark Series cymbals, powered by a Tama Iron Cobra 900 double pedal.',
      influence: 'Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through worldwide drum clinics. Koller is widely regarded as one of the most respected drummers in extreme and hardcore music, with Converge\'s "Jane Doe" routinely cited as a genre-defining mathcore record.',
    },
  ...
  'matt-greiner-vs-mario-duplantier': {
    ...
    comparison: {
      ...
      influence: 'Greiner earned two Grammy nominations for Best Metal Performance with August Burns Red and has influenced a generation of metalcore drummers through worldwide drum clinics. Duplantier pioneered the "environmental metal" style that made Gojira one of the most critically acclaimed progressive death metal bands of the 21st century, earning multiple Grammy nominations.',
    },
  ...
  'jaska-raatikainen-vs-matt-greiner': {
    ...
    faqs: [
      ...
      { q: 'What gear does Jaska Raatikainen use vs Matt Greiner?', a: 'Jaska Raatikainen played a Pearl Masters Premium Maple kit with a Pearl Masters 14x5.5" Maple snare, Zildjian A Custom & K Custom cymbals, and a Pearl Eliminator double pedal. Matt Greiner plays a Mapex Black Panther Design Lab kit with a 14x6.5" Maple snare, Paiste Formula 602 cymbals, and a DW 9000 Series double pedal.' },
      { q: 'Has Matt Greiner won any awards with August Burns Red?', a: 'Matt Greiner has earned two Grammy nominations for Best Metal Performance with August Burns Red, and Vic Firth released a Matt Greiner Signature stick model in 2017.' },
