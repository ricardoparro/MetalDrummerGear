...
export const drummerComparisons = {
  ...
  'daniel-erlandsson-vs-jaska-raatikainen': {
    ...
    verdict: 'Daniel Erlandsson and Jaska Raatikainen represent two of European melodic death metal\'s defining rhythmic voices from parallel scenes. Erlandsson has spent nearly two decades refining Arch Enemy\'s anthemic, production-forward Gothenburg sound with clean, controlled precision. Raatikainen spent 26 years — the entirety of Children of Bodom\'s existence — locking his neoclassical intensity to Alexi Laiho\'s guitar virtuosity before the band\'s 2019 dissolution. Both share a Pearl drum foundation — though Erlandsson\'s Sabian cymbals contrast with Raatikainen\'s Zildjian setup — while representing Sweden\'s and Finland\'s distinct takes on melodic death metal\'s golden era.',
    faqs: [
