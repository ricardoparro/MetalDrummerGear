...
export const DRUMSTICKS = [
  ...
  {
    id: 'vic-firth-american-classic-5b-vinnie-paul',
    brand: 'Vic Firth',
    ...
    retailerUrls: {},
    source: 'vicfirth.com',
    notes: 'Endorsed stock model played since the 1990s — no custom signature model. The "Vic Firth SVP Signature Vinnie Paul" stick is a separate, posthumous 2020 tribute product (he died in 2018) and is not gear he played.',
  },
  {
    id: 'tama-hmd',
    brand: 'Tama',
  ...
  {
    id: 'vic-firth-american-classic-extreme-5b-inferno',
    brand: 'Vic Firth',
