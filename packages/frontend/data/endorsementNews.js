...
export const ENDORSEMENT_TIMELINE = {
  ...
  'derek-roddy': {
    ...
    currentEndorsements: {
      ...
      hardware: { brand: 'Axis', model: 'A Longboard Double Pedal', since: '2001' },
    },
    timeline: [
      {
        year: 1994,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Adopted Sabian cymbals during his formative Aurora Borealis years, developing the extreme-tempo technique that would define his career',
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: "Built his DW Collector's Series Maple kit heading into Hate Eternal's King of All Kings sessions (2002)",
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sabian',
        to: 'Sabian HHX/AAX',
        notes: 'Refined to the HHX/AAX hybrid setup for the fast attack and controlled decay his gravity blast technique demands',
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Axis',
        notes: 'Adopted the Axis A Longboard double pedal, whose direct-drive action and longboard footboard suit his heel-toe technique at extreme tempos',
      },
    ],
  },
  'hannes-grossmann': {
    ...
    currentEndorsements: {
      drums: { brand: 'DW', model: "Collector's Series", since: '2014' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Tama',
        notes: "Built a Tama Starclassic Maple kit with a Tama S.L.P. G-Maple snare during his Necrophagist years (Epitaph, 2004)",
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Established his Meinl Byzance cymbal setup, a relationship carried forward unchanged through Obscura and into Alkaloid',
      },
      {
        year: 2007,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Tama',
        notes: 'Paired his Starclassic kit with a Tama Iron Cobra double pedal through the Obscura breakthrough era (Cosmogenesis, 2009; Omnivium, 2011)',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        notes: "Moved to a DW Collector's Series kit and 9000 Series double pedal upon founding Alkaloid, a setup carried through The Malkuth Grimoire (2015) and Liquid Anatomy (2018)",
      },
    ],
  },
  'isaac-lamb': {
    ...
    band: 'Battlecross',
    currentEndorsements: {
      drums: { brand: 'SJC Custom Drums', model: 'Custom Maple', since: '2009' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'SJC Custom Drums',
        notes: "Built his hand-built SJC Custom maple kit while founding the band in Sherman, Texas, a setup carried unchanged through the band's self-titled 2012 debut",
      },
      {
        year: 2009,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Adopted the Meinl Classics Custom Dark series for its trashy, low-pitched voicing across Balancing Survival and Happiness (2014) and Nomad (2017)',
      },
      {
        year: 2009,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: 'Paired his SJC kit with a DW 9000 Series double pedal, a combination maintained through Absolute (2019)',
      },
      {
        year: 2022,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'SJC Custom Drums',
        to: 'SJC Custom Drums',
        notes: 'Maintained his SJC Custom setup into Lowest Form of Animal (2022), the same rig documented across the entire Battlecross catalog',
      },
    ],
  },
  'jason-bittner': {
    ...
    currentEndorsements: {
      drums: { brand: 'Tama', model: 'Starclassic Performer B/B', since: '2002' },
      cymbals: { brand: 'Sabian', model: 'HHX / HH Series', since: '1997' },
      sticks: { brand: 'Vic Firth', model: '5B', since: '2002', signature: false },
      heads: { brand: 'Remo', model: 'Powerstroke 3 / Ambassador Coated', since: '2002' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Sabian',
        notes: 'Began his Sabian relationship during early Shadows Fall records (Somber Eyes to the Sky, 1997; Of One Blood, 2000)',
      },
      {
        year: 2002,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Tama',
        notes: 'Established the Tama Starclassic Performer B/B kit that would define the Shadows Fall era, debuting on The Art of Balance (2002)',
      },
      {
        year: 2002,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: 'Adopted the DW 9002 dual-chain double bass pedal alongside his Starclassic kit for The Art of Balance (2002)',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'Tama Starclassic Performer B/B',
        to: 'Tama Starclassic Performer B/B',
        notes: 'Carried the identical Tama/Sabian/DW rig into his Overkill tenure starting with The Electric Age (2012), running both bands on the same setup',
      },
    ],
  },
  'jocke-wallgren': {
    ...
    currentEndorsements: {
      ...
      cymbals: { brand: 'Meinl', model: 'Byzance Traditional', since: '2013' },
      sticks: { brand: 'Vic Firth', model: '5B', since: '2013', signature: false },
      heads: { brand: 'Remo', model: 'Powerstroke 3 / Emperor Coated', since: '2013' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Tama',
        notes: 'Developed his Tama kit and early Meinl Byzance cymbal setup during his years with Evergrey and Rage, ahead of joining Amon Amarth',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: 'Tama',
        to: 'Tama Starclassic Performer B/B',
        notes: 'Fully configured his Starclassic Performer B/B kit and DW 9002 pedal upon replacing Fredrik Andersson for Deceiver of the Gods (2013)',
      },
      {
        year: 2019,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        from: 'Meinl Byzance Traditional',
        to: 'Meinl Byzance Vintage',
        notes: 'Switched to the drier, trashier Byzance Vintage sub-line for Berserker (2019) to suit its blast-beat sections',
      },
      {
        year: 2022,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        from: 'Meinl Byzance Vintage',
        to: 'Meinl Byzance Traditional',
        notes: 'Reverted to the standard Byzance Traditional series for The Great Heathen Army (2022)',
      },
    ],
  },
};
