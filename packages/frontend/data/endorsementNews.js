...
export const ENDORSEMENT_TIMELINE = {
  ...
  'daray': {
    ...
    currentEndorsements: {
      ...
      cymbals: { brand: 'Paiste', model: '2002 / RUDE Series', since: '2008' },
      sticks: { brand: 'Promark', model: '5B', since: '2006' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Built his Pearl Reference Pure foundation while drumming for Polish death metal band Vader, recording Welcome to the Morbid Reich (2011) and Tibi et Igni (2014) on the same platform',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Paiste',
        notes: 'Adopted Paiste 2002 and RUDE series cymbals after replacing Hellhammer in Dimmu Borgir in 2008, carried through Abrahadabra (2010) and Eonian (2018)',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Runs the Pearl Demon Drive chain-drive double pedal for the sustained extreme-tempo double-kick patterns Dimmu Borgir\'s symphonic black metal and his Vader/Vesania work both require',
      },
    ],
  },
  'kevin-talley': {
    ...
    band: 'Dying Fetus',
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Masters Custom / Reference Series', since: '1996' },
      cymbals: { brand: 'Zildjian', model: 'A Custom Series', since: '1996' },
      sticks: { brand: 'Vic Firth', model: '5B', since: '1996' },
      heads: { brand: 'Remo', model: 'Powerstroke 3 / Emperor Coated', since: '1996' },
      hardware: { brand: 'DW', model: 'Double Bass Pedal', since: '1996' },
    },
    timeline: [
      {
        year: 1996,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Joined Dying Fetus at 17 and built his Pearl Masters Custom/Reference double-kick setup, first documented on Destroy the Opposition (2000) and carried through War of Attrition (2007)',
      },
      {
        year: 1996,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Settled on Zildjian A Custom cymbals for their fast attack and short decay, essential for articulating blast beat hi-hat patterns at 200-240 BPM',
      },
      {
        year: 2000,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        brand: 'DW',
        notes: 'Continued relying on DW double bass pedals for the consistent cam action needed to sustain his signature polyrhythmic kick patterns without rhythmic drift, a setup he kept consistent across Dying Fetus, Misery Index, and Jungle Rot',
      },
    ],
  },
  'martin-axenrot': {
    ...
    band: 'Opeth',
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Reference Series', since: '2011' },
      cymbals: { brand: 'Meinl', model: 'Byzance Traditional Series', since: '2008' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 5A', since: '2011' },
      heads: { brand: 'Remo', model: 'Powerstroke 3 / Emperor / Ambassador', since: '2008' },
      hardware: { brand: 'Pearl', model: 'Demon Drive (twin pedals)', since: '2011' },
    },
    timeline: [
      {
        year: 2008,
        ...
        from: null,
        to: 'Sonor',
        notes: 'Recorded his Opeth studio debut Watershed (2008) on a Sonor Designer/SQ2 kit, playing Sonor Giant Step twin pedals and Vic Firth American Classic 5B sticks after replacing Martin Lopez in 2006',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Established his Meinl Byzance Traditional cymbal setup on Watershed, a lineup he kept unchanged through Heritage (2011), Pale Communion (2014), Sorceress (2016), and In Cauda Venenum (2019)',
      },
      {
        year: 2011,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sonor',
        to: 'Pearl',
        notes: 'Switched to a Pearl Reference Series kit with Pearl Demon Drive twin pedals for Heritage (2011), Opeth\'s prog-rock turn, and stayed on Pearl through Pale Communion, Sorceress, and In Cauda Venenum',
      },
      {
        year: 2011,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.STICKS,
        from: 'Vic Firth American Classic 5B',
        to: 'Vic Firth American Classic 5A',
        notes: 'Moved to the lighter 5A model alongside the Heritage-era gear switch, matching the more dynamic, less blast-beat-driven playing Opeth\'s prog-rock records demanded',
      },
    ],
  },
  'martin-lopez': {
    ...
    band: 'Soen',
    currentEndorsements: {
      drums: { brand: 'Sonor', model: 'SQ2', since: '2010' },
      cymbals: { brand: 'Zildjian', model: 'A & K Series', since: '2010' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 5A (Nylon Tip)', since: '1998' },
      heads: { brand: 'Remo', model: 'Ambassador Coated / Diplomat', since: '1998' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Joined Opeth in 1997 and played a Pearl/Sonor mixed touring kit with Sabian B8 Pro cymbals on My Arms, Your Hearse (1998), moving to a full Pearl Export kit on Still Life (1999)',
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Pearl',
        to: 'Sonor',
        notes: 'Switched to a Sonor Designer Series maple kit for the Steven Wilson-produced Blackwater Park (2001), the album that unlocked the dynamic, jazz-informed playing he became known for',
      },
      {
        year: 2002,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sonor',
        to: 'Pearl',
        notes: 'Returned to Pearl — Masters Premium on Deliverance (2002) and Damnation (2003), then Pearl Reference with Paiste Signature cymbals on Ghost Reveries (2005), his final Opeth studio album before departing in 2006',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Pearl',
        to: 'Sonor',
        notes: 'After co-founding Soen in 2010, settled into a bespoke Sonor SQ2 kit with Zildjian A & K series cymbals — a brighter, fully custom setup replacing his Opeth-era Pearl/Sabian gear',
      },
    ],
  },
  'matt-garstka': {
    ...
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Masterworks Maple', since: '2014' },
      cymbals: { brand: 'Meinl', model: 'Byzance Dual / Sand Series', since: '2014' },
      sticks: { brand: 'Vic Firth', model: 'Matt Garstka Signature', since: '2016' },
      heads: { brand: 'Remo / Evans', model: 'Ambassador Coated / G1 Coated', since: '2014' },
      hardware: { brand: 'Pearl', model: 'Demon Drive Double Pedal', since: '2014' },
    },
    timeline: [
      {
        year: 2014,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Debuted his Pearl Masterworks Maple kit with a Pearl Reference snare and Meinl Byzance cymbals on The Joy of Motion (2014), his first album with Animals as Leaders',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Vic Firth',
        notes: 'Signed with Vic Firth playing American Classic 5A sticks on The Joy of Motion, ahead of his own signature model two years later',
      },
      {
        year: 2016,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Pearl',
        product: 'Matt Garstka Signature Snare 14"x5"',
        notes: 'Released a signature 14"x5" maple Pearl snare — shallower shell for faster response and wider dynamic range — debuting on The Madness of Many (2016) and used through Parrhesia (2022)',
      },
      {
        year: 2016,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        category: ENDORSEMENT_CATEGORIES.STICKS,
        brand: 'Vic Firth',
        product: 'Vic Firth Matt Garstka Signature',
        notes: 'Replaced his American Classic 5A with a Vic Firth Matt Garstka Signature stick starting on The Madness of Many, carried through Parrhesia',
      },
    ],
  },
};
