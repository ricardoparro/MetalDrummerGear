    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Mapex',
        notes: "Signed with Mapex in Shadows Fall's formative years, settling on the Saturn V shell pack that remains his platform today",
      },
      {
        year: 1997,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        from: null,
        to: 'Mapex',
        notes: 'Adopted the Mapex Falcon double pedal for The Art of Balance sessions, the record that broke Shadows Fall into NWOAHM\'s front rank',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Mapex',
        notes: 'Carried the same Saturn V kit into his new chair with Overkill on The Electric Age, confirming his thrash credentials without changing gear',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Zildjian',
        notes: 'Kept his Zildjian K and A Custom Series setup across both Shadows Fall and Overkill duties after joining Overkill full-time in 2012',
      },
    ],
  },
  'jocke-wallgren': {
