    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Sonor',
        notes: 'Signed with Sonor during his King Diamond years, playing their custom-build SQ2 series',
      },
      {
        year: 1987,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Paiste',
        notes: 'Became a Paiste artist in April 1987, a partnership that has continued through Motörhead and Scorpions',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Sonor',
        product: 'Mikkey Dee Signature Snare (14"x7.25" Birch)',
        notes: 'Sonor released his signature snare drum, a deep 14"x7.25" birch shell built for powerful backbeat',
      },
      {
        year: 2016,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Sonor',
        notes: 'Carried his longtime Sonor/Paiste setup into Scorpions after joining the band in 2016 following Lemmy Kilmister\'s death',
      },
    ],
  },
  'gavin-harrison': {
