...
export const ENDORSEMENT_TIMELINE = {
  ...
  'pete-sandoval': {
    ...
    band: 'Morbid Angel',
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Pearl Reference Series', since: '1993' },
      cymbals: { brand: 'Sabian', model: 'Sabian AA / Signature Series', since: '1993' },
      sticks: { brand: 'Pro-Mark', model: 'Pro-Mark 5B Wood Tip', since: '1989' },
      heads: { brand: 'Remo', model: 'Powerstroke 3 Clear / Emperor Clear / Ambassador Coated', since: '1993' },
      hardware: { brand: 'Pearl', model: 'Pearl PowerShift / Eliminator Double Bass Pedals', since: '1993' },
    },
    timeline: [
      {
        year: 1989,
        ...
        from: null,
        to: 'Tama',
        notes: 'Debuted a Tama Superstar kit on "Altars of Madness," the album that established death metal drumming and Sandoval\'s gravity-blast technique',
      },
      {
        year: 1989,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Paiste',
        notes: 'Paired the Tama kit with Paiste 2002 hi-hats, crashes, and ride for "Altars of Madness," carried through "Blessed Are the Sick"',
      },
      {
        year: 1993,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Tama',
        to: 'Pearl',
        notes: 'Moved to Pearl Reference Series maple/poplar hybrid shells for "Covenant," adding shell mass and low-end weight over the Tama Superstar birch kit',
      },
      {
        year: 1993,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Paiste',
        to: 'Sabian',
        notes: '"Covenant" marked a complete departure from Paiste 2002 to Sabian AA and Signature Series cymbals for faster response at 230+ BPM blast tempos',
      },
    ],
  },
  'ray-luzier': {
    ...
    band: 'Korn',
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Pearl Reference Maple', since: '2013' },
      cymbals: { brand: 'Sabian', model: 'Sabian AAX Series', since: '2013' },
      sticks: { brand: 'Promark', model: 'Promark Ray Luzier Signature TX420X', since: '2013', signature: true },
      heads: { brand: 'Evans', model: 'Evans EC2 Coated / EMAD2', since: '2010' },
      hardware: { brand: 'Pearl', model: 'Pearl Demon Drive Double Bass Pedal', since: '2013' },
    },
    timeline: [
      {
        year: 2010,
        ...
        from: null,
        to: 'DW',
        notes: 'Played a DW Collector\'s Series kit with Paiste/Meinl cymbals on "Korn III: Remember Who You Are," his first full studio album with Korn',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'DW',
        to: 'Pearl',
        notes: 'Switched to a Pearl Reference Maple kit for "The Paradigm Shift," Korn\'s reunion album with guitarist Brian "Head" Welch',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Paiste / Meinl',
        to: 'Sabian',
        notes: 'Adopted Sabian AAX Series (Stage Hi-Hats, X-Plosion Crashes, Stage Ride) alongside the Pearl switch for "The Paradigm Shift"',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        ...
        notes: 'Debuted his Promark signature stick model, used through "The Paradigm Shift," "The Serenity of Suffering," "The Nothing," and "Requiem"',
      },
    ],
  },
  'raymond-herrera': {
    ...
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Pearl Reference Series', since: '1992' },
      cymbals: { brand: 'Zildjian', model: 'Zildjian Z Custom', since: '1992' },
      sticks: { brand: 'Vater', model: 'Vater Power 5B', since: '1995' },
      heads: { brand: 'Remo', model: 'Remo Pinstripe / Ambassador', since: '1995' },
      hardware: { brand: 'Pearl', model: 'Pearl Eliminator Double Pedal', since: '1995' },
    },
    timeline: [
      {
        year: 1992,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Ran an early Pearl Custom kit with a trigger-fitted snare on Fear Factory\'s debut "Soul of a New Machine" (1992), the template for the hybrid acoustic/electronic setup',
      },
      {
        year: 1992,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Early Z Custom-predecessor Zildjian cymbals on "Soul of a New Machine," refined into the full Z Custom setup by "Demanufacture"',
      },
      {
        year: 1995,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Locked in the Pearl Reference Series / Eliminator double pedal combination, fully triggered with ddrum and Roland sensors, for "Demanufacture" (1995) — the industrial-metal drum template',
      },
    ],
  },
  'richard-christy': {
    ...
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Pearl Masters Custom', since: '1996' },
      cymbals: { brand: 'Sabian', model: 'Sabian AA / AAX Series', since: '1996' },
      sticks: { brand: 'Vic Firth', model: 'Vic Firth American Classic 5A / 5B', since: '1996' },
      heads: { brand: 'Remo', model: 'Remo Emperor / Pinstripe', since: '1996' },
      hardware: { brand: 'Pearl', model: 'Pearl P-2002C PowerShifter Eliminator', since: '1996' },
    },
    timeline: [
      {
        year: 1996,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Joined Death on a Pearl Masters Custom kit after Chuck Schuldiner handpicked him in 1996, the setup carried through "The Sound of Perseverance" (1998)',
      },
      {
        year: 1996,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Ran a Sabian AA/AAX setup (14" hi-hats, AAX Studio crashes, AA medium ride) documented on Death\'s "The Sound of Perseverance"',
      },
    ],
  },
  'ryan-van-poederooyen': {
    ...
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Pearl Reference Series', since: '1999' },
      cymbals: { brand: 'Sabian', model: 'Sabian AAX / HHX', since: '1999' },
      sticks: { brand: 'Vic Firth', model: 'Vic Firth American Classic 5B', since: '1999' },
      heads: { brand: 'Remo', model: 'Remo Powerstroke 3', since: '1999' },
      hardware: { brand: 'Tama', model: 'Tama Iron Cobra Double Bass Pedal', since: '2011' },
    },
    timeline: [
      {
        year: 1999,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Began his Pearl Reference Series relationship at the start of his 25-plus-year partnership with Devin Townsend in 1999',
      },
      {
        year: 2011,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Tama',
        notes: 'Used dual Tama Iron Cobra double bass pedals for "Deconstruction" (2011), paired with Sabian AAX/HHX cymbals and Vic Firth American Classic 5B sticks',
      },
    ],
  },
  'tim-yeung': {
    ...
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Pearl Reference Masters', since: '2007' },
      cymbals: { brand: 'Sabian', model: 'Sabian AAX / HHX', since: '2007' },
      sticks: { brand: 'Vic Firth', model: 'Vic Firth 5B', since: '2007' },
      heads: { brand: 'Remo', model: 'Remo Powerstroke 3 / Emperor Coated', since: '2007' },
      hardware: { brand: 'DW', model: 'DW 9002 Double Bass Pedal', since: '2007' },
    },
    timeline: [
      {
        year: 2007,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Ran a Pearl Reference Masters kit with DW 9002 double bass pedals on Hate Eternal\'s "Bleed the Fifth" (2007)',
      },
      {
        year: 2007,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Paired the Pearl kit with Sabian AAX hi-hats and HHX ride/china on "Bleed the Fifth," the setup that carried into his Morbid Angel tenure from 2011 onward',
      },
    ],
  },
};
