...
export const ENDORSEMENT_NEWS = [
  {
    ...
    description: 'Former Sepultura drummer Eloy Casagrande replaces Jay Weinberg as Slipknot\'s new drummer. He maintains his existing endorsements with Tama drums, Paiste cymbals, and Evans heads.',
    brands: {
      kept: ['Tama', 'Paiste', 'Evans'],
    },
  ...
  },
  {
    ...
    description: 'After several drummer changes, Trivium finds stability with Alex Bent. He brings his Tama Starclassic Maple setup and Zildjian cymbals to the band.',
    brands: {
      new: ['Tama', 'Zildjian', 'Vic Firth', 'Evans'],
    },
...
export const ENDORSEMENT_TIMELINE = {
  ...
  'mikkey-dee': {
    ...
    currentEndorsements: {
      drums: { brand: 'Sonor', model: 'SQ2', signature: 'Mikkey Dee Signature Snare' },
      cymbals: { brand: 'Paiste', model: 'Signature Series', since: '1987' },
      sticks: { brand: 'Wincent', model: 'Mikkey Dee Signature', signature: true },
      heads: { brand: 'Evans' },
      hardware: { brand: 'DW', model: '5000 Series Double Pedal' },
    },
    timeline: [
      {
        year: 1992,
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Sonor',
        notes: 'Carried his longtime Sonor SQ2 and Paiste Signature setup into Scorpions after joining the band in 2016 following Lemmy Kilmister\'s death',
      },
    ],
  },
  'gavin-harrison': {
  ...
  'hellhammer': {
    ...
    currentEndorsements: {
      drums: { brand: 'Sonor', model: 'SQ2 Heavy Beech', since: '1999' },
      cymbals: { brand: 'Paiste', model: 'RUDE Series', since: '1988' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 5B', since: '1999' },
      heads: { brand: 'Remo', model: 'Coated Ambassador', since: '1988' },
      hardware: { brand: 'Axis', model: 'Double Pedal', since: '1999' },
    },
    timeline: [
      {
        year: 1988,
        ...
        from: null,
        to: 'Sonor',
        notes: 'Developing Sonor endorsement during his early Mayhem years, in use on "De Mysteriis Dom Sathanas" (1994)',
      },
      {
        year: 1999,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Sonor',
        notes: 'Moved to the Sonor SQ2 Heavy Beech kit while drumming simultaneously for Dimmu Borgir and Mayhem',
      },
      {
        year: 1999,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Paiste',
        notes: 'Cymbal setup expanded to a full Paiste RUDE series configuration used consistently across both bands',
      },
    ],
  },
  'flo-mounier': {
  ...
  'gene-hoglan': {
    ...
    timeline: [
      ...
      },
      {
        ...
        from: null,
        to: 'ProMark',
        notes: 'Settled on ProMark Classic Forward 2B sticks for his Pearl Reference Pure setup of that era, favoring their balance across marathon touring and clinic schedules',
      },
    ],
  },
  'shannon-larkin': {
    ...
    band: 'Godsmack',
    currentEndorsements: {
      drums: { brand: 'ddrum', model: 'Dios Series', since: '2002' },
      cymbals: { brand: 'Sabian', model: 'AAX Series', since: '2002' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 5B', since: '2002', signature: false },
      heads: { brand: 'Evans', since: '2002' },
      hardware: { brand: 'DW', model: '9000 Series Double Pedal', since: '2002' },
    },
    timeline: [
      {
        year: 2002,
        ...
        from: null,
        to: 'ddrum',
        notes: 'Joined Godsmack in 2002, replacing Tommy Stewart, and brought his ddrum Dios Series kit into the band\'s platinum-selling run',
      },
      {
        year: 2002,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
  ...
  'travis-orbin': {
    ...
    currentEndorsements: {
      drums: { brand: 'SJC', model: 'Custom Drums', since: '2009' },
  ...
  'aquiles-priester': {
    ...
    band: 'Angra / W.A.S.P.',
    currentEndorsements: {
      drums: { brand: 'Mapex', model: 'Saturn Evolution All Maple (signature kit)', since: '2023' },
      cymbals: { brand: 'Paiste', model: 'Custom red-coated set incl. 18" Psychoctopus Giga Bell Ride', since: '2023' },
      sticks: { brand: 'ProMark', model: 'Aquiles Priester Signature', since: '2023', signature: true },
    ...
    timeline: [
      ...
      },
      {
        ...
        to: 'Mapex',
        notes: 'Adopted the Mapex Saturn Evolution All Maple signature kit upon returning to Angra for their 2023 album cycle',
      },
      {
        year: 2023,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
  ...
  'blake-richardson': {
    ...
    currentEndorsements: {
      drums: { brand: 'Tama', model: 'Starclassic Bubinga', since: '2018' },
      cymbals: { brand: 'Sabian', model: 'HHX Evolution / AAX / HH', since: '2018' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 3A', since: '2006', signature: false },
      heads: { brand: 'Evans', model: 'G2 Coated / Hazy 300', since: '2018' },
      hardware: { brand: 'Tama', model: 'Twin Iron Cobra Power Glide single pedals (not linked double)', since: '2018' },
    },
    timeline: [
      {
        year: 2006,
      ...
      },
      {
        ...
        from: null,
        to: 'Meinl',
        notes: 'Paired his DW kit with Meinl Byzance Extra Dry cymbals on Alaska, establishing the dark, hand-hammered voice through the Colors and Parallax eras',
      },
      {
        year: 2006,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Vic Firth',
        notes: 'Settled on Vic Firth American Classic 3A sticks for the mass and control needed across BTBAM\'s blast-beat-to-ghost-note dynamic range',
      },
      {
        year: 2006,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: 'Adopted the DW 9002 chain-drive double bass pedal on Alaska, his kick foundation through the Colors and Parallax eras',
      },
      {
        year: 2018,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'DW',
        to: 'Tama',
        notes: "Moved to a Tama Starclassic Bubinga kit in a custom finish for Automata I & II, favoring its resonance for BTBAM's Sumerian Records-era production",
      },
      {
        year: 2018,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Meinl',
        to: 'Sabian',
        notes: "Switched to Sabian — HHX Evolution hi-hats and crash, AAX Holy Chinas, and HH Raw Bell Dry Ride — for the Automata era",
      },
      {
        year: 2018,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
      ...
      },
      {
        ...
        from: 'DW',
        to: 'Tama',
        notes: 'Switched to twin Tama Iron Cobra Power Glide single pedals rather than a linked double, for independent control across BTBAM\'s shifting time signatures',
      },
    ],
  },
  'chris-turner': {
  ...
  'derek-roddy': {
    ...
    currentEndorsements: {
      drums: { brand: 'Tama', model: 'Starclassic Bubinga', since: '2001' },
      cymbals: { brand: 'Meinl', model: 'Byzance / Mb20 Heavy Series', since: '1994' },
      sticks: { brand: 'Vater', model: '5B', since: '2001', signature: false },
      heads: { brand: 'Evans', model: 'Genera HD Dry / EMAD', since: '2001' },
      hardware: { brand: 'Tama', model: 'Speed Cobra 910 Double Pedal', since: '2000' },
    },
    timeline: [
      {
        year: 1994,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Started with Meinl cymbals during his formative underground death metal years with Aurora Borealis',
      },
      {
        year: 2000,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Tama',
        notes: "Adopted Tama Speed Cobra double pedals while touring as Nile's live drummer, drawn to the speed and stability the extreme tempos demanded",
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        to: 'Tama Starclassic Bubinga',
        notes: "Moved to a Tama Starclassic Bubinga kit at the start of the Hate Eternal peak era, prizing the dense, bass-heavy shells for blast-beat-heavy sets",
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        brand: 'Tama',
        notes: 'Continued with Tama Speed Cobra pedals into his clinic and educational career, including The Evolution of Blast Beats DVD',
      },
    ],
  },
  'hannes-grossmann': {
  ...
  'jason-bittner': {
    ...
    currentEndorsements: {
      drums: { brand: 'Mapex', model: 'Saturn V', since: '1997' },
      cymbals: { brand: 'Zildjian', model: 'K and A Custom Series', since: '1997' },
      sticks: { brand: 'ProMark', model: 'Jason Bittner Signature 5BX', since: '1997', signature: true },
      heads: { brand: 'Evans', model: 'G2 Coated / EMAD', since: '1997' },
      hardware: { brand: 'Mapex', model: 'Falcon Double Pedal', since: '2002' },
    },
    timeline: [
      {
        year: 1997,
        ...
        from: null,
        to: 'Mapex',
        notes: "Signed with Mapex in Shadows Fall's formative years, settling on the Saturn V shell pack",
      },
      {
        year: 1997,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        from: null,
        to: 'Mapex',
        notes: 'Adopted the Mapex Falcon double bass pedal for The Art of Balance sessions, the record that broke Shadows Fall into NWOAHM\'s front rank',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Mapex',
        notes: 'Carried the same Mapex Saturn V kit into his new chair with Overkill on The Electric Age, confirming his thrash credentials without changing gear',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Zildjian',
        notes: 'Kept his Zildjian K and A Custom setup across both Shadows Fall and Overkill duties after joining Overkill full-time in 2012',
      },
    ],
  },
  'jocke-wallgren': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Began playing Zildjian A Custom & K Custom cymbals during his time with Rage and Evergrey in the European power/prog metal scene',
      },
      {
        year: 2005,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Zildjian',
        notes: "Carried his Zildjian A Custom & K Custom cymbals into the Amon Amarth chair, valuing their bright yet warm voicing for the band's melodic death metal identity",
      },
      {
        year: 2019,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        brand: 'Pearl',
        notes: "Continued with the Pearl Demon Drive double pedal through Berserker (2019), which demanded both extended blast-beat passages and the band's signature gallop",
      },
    ],
  },
  'mike-mangini': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Paiste',
        notes: 'Developing Paiste relationship in place around the time Frank Zappa personally selected the then-20-year-old Ågren for his touring band',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Paiste',
        notes: 'Carried the Paiste Signature and 2002 series cymbals into "Z²" (2014), where the odd-time metric modulations demanded the line\'s layered overtone complexity',
      },
    ],
  },
  'navene-koperweis': {
  ...
  'nick-augusto': {
    ...
    band: 'ex-Trivium',
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Reference Pure' },
  ...
  'pete-sandoval': {
    ...
    band: 'Morbid Angel',
    currentEndorsements: {
      drums: { brand: 'ddrum', model: 'unconfirmed', since: '1989' },
      cymbals: { brand: null, model: 'not publicly documented', since: null },
      sticks: { brand: 'Promark or Vic Firth', model: '5B/2B', since: '1989' },
      heads: { brand: 'Remo', model: 'Pinstripe or Emperor', since: '1989' },
      hardware: { brand: 'ddrum', model: 'unconfirmed', since: '1989' },
    },
    timeline: [
      {
        year: 1989,
  ...
  'daray': {
    ...
    band: 'Dimmu Borgir',
    currentEndorsements: {
      drums: { brand: 'Tama', model: 'Starclassic Performer B/B, Piano Black (snare: S.L.P. Black Brass LBR1465)', since: '2014' },
    ...
    timeline: [
      ...
      },
      {
        ...
        from: 'Pearl',
        to: 'Tama',
        notes: 'Switched to a Tama Starclassic Performer B/B kit in Piano Black, with a 14"x6.5" S.L.P. Black Brass snare (LBR1465); date is best-available, anchored to his appearance at the TAMA 40th Anniversary Drum Festival on July 5, 2014',
      },
    ],
  },
  'kevin-talley': {
  ...
  'martin-axenrot': {
    ...
    band: 'Opeth',
    currentEndorsements: {
      drums: { brand: 'DW', model: 'Custom (maple/gum shells)', since: '2006' },
      cymbals: { brand: 'Sabian', model: 'HHX / AAX Series', since: '2006' },
      sticks: { brand: 'Pro-Mark', since: '2006' },
      heads: { brand: 'Evans', since: '2006' },
      hardware: { brand: 'DW', since: '2006' },
    },
    timeline: [
      {
        year: 2006,
        ...
        from: null,
        to: 'DW',
        notes: 'Joined Opeth mid-tour on the Ghost Reveries cycle in 2006, playing a custom hand-made DW kit with maple/gum shells — the same setup he described in a 2016 MusicRadar interview around the Sorceress cycle',
      },
      {
        year: 2006,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'SABIAN artist endorsing HHX / AAX Series cymbals since joining Opeth in 2006, per SABIAN\'s own artist page',
      },
      {
        year: 2006,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
  ...
  'alex-bent': {
    ...
    timeline: [
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Tama',
        notes: 'Carried the Tama Starclassic Maple setup, centered on the 14x5" snare, through "What the Dead Men Say" (2020)',
      },
      {
        year: 2021,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
  ...
  'adrian-erlandsson': {
    ...
    currentEndorsements: {
      ...
      cymbals: { brand: 'Sabian', model: 'AAX/HHX Series', since: '2014' },
      sticks: { brand: 'Vic Firth', model: 'Rock Nylon Tip (At the Gates Signature)', since: '2014', signature: true },
    ...
    timeline: [
      {
        ...
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: null,
        to: 'Pearl Export / Studio House Kit',
        notes: 'Recorded At the Gates\' "Slaughter of the Soul" (1995) at Studio Fredman on an undocumented budget kit consistent with a Pearl Export or studio house kit of the era — the underground Gothenburg death metal scene\'s typical constraint',
      },
      {
        year: 1995,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian A-Series',
        notes: 'Ran a Zildjian A-Series setup (14" hi-hats, 16"/18" crashes, 20" ride, 18" China) on "Slaughter of the Soul" (1995) — widely available in Swedish professional music shops and studios of the period',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'Pearl Export / Studio House Kit',
        to: 'Tama Starclassic Bubinga',
        notes: 'Returned to Studio Fredman for At the Gates\' reunion album "At War with Reality" (2014) on a Tama Starclassic Bubinga kit in transparent black finish — the mature rig he had developed across his years with The Haunted, Cradle of Filth, and Paradise Lost (2009–2016)',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Zildjian A-Series',
        to: 'Sabian AAX/HHX',
        notes: 'Moved to Sabian\'s professional AAX and HHX lines (15" HHX Xcelerator hi-hats, 20" AAX Iso crash, 19" AAX Paragon China) for "At War with Reality" (2014), a setup carried over from his Paradise Lost years',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        notes: 'Adopted the Monolit Czarcie Kopyto — a boutique Polish double pedal prized for fast, direct response — for "At War with Reality" (2014), replacing the standard double bass pedal setups of his 1995 sessions',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
  ...
  'jon-dette': {
    ...
    currentEndorsements: {
      ...
      cymbals: { brand: 'Sabian / Zildjian', model: 'AAX / A Series (14" Hi-Hats, 16"/18" Crash, 20" Ride, 18" China)', since: '1996' },
    ...
    timeline: [
      {
        ...
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: null,
        to: 'Ludwig Classic Maple',
        notes: 'Brought a Ludwig Classic Maple kit — six-ply maple shells, double 22" bass drums — to his 1996–1997 Slayer touring stint filling in for Paul Bostaph, a distinct gear choice from Dave Lombardo\'s Tama and Bostaph\'s DW setups',
      },
      {
        year: 1996,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        from: null,
        to: 'Sabian AAX / Zildjian A or K Series',
        notes: 'Ran a Sabian AAX / Zildjian A or K Series setup (14" hi-hats, 16"/18" crashes, 20" ride, 18" China) for the fast, projecting cymbal work Slayer\'s 180–220 BPM catalogue demands',
      },
      {
        year: 1996,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        from: null,
        to: 'DW 9000 / Tama Iron Cobra Double Pedal',
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Ludwig',
        notes: 'Carried the same Ludwig Classic Maple setup into his first stint with Testament (1997–1999), recording "The Gathering" (1999) alongside guitarist Alex Skolnick\'s progressive arrangements',
      },
    ],
  },
  'jimmy-degrasso': {
    ...
    band: 'Megadeth',
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'JD1455 Signature Snare (14x5.5" Hammered Brass)', since: '2008' },
      cymbals: { brand: 'Sabian', since: '1998' },
      sticks: { brand: 'Promark', since: '1998' },
      heads: { brand: 'Evans', since: '1998' },
    },
    timeline: [
      {
        year: 1998,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Played a Pearl kit through his 1998–2002 Megadeth tenure, recording "Risk" (1999) and "The World Needs a Hero" (2001)',
      },
      {
        year: 1998,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Ran Sabian cymbals through his Megadeth tenure and into subsequent touring work with Alice Cooper and other hard rock acts',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Sonor',
        notes: 'Sonor\'s own artist page credits his Sonor endorsement back through his 1993–1999 tenure in Cradle of Filth, recording "The Principle of Evil Made Flesh" (1994) and "Cruelty and the Beast" (1998)',
      },
      {
        year: 1999,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Sonor',
        notes: 'Continued on Sonor through his 1999–2004 run in Dimmu Borgir, recording "Puritanical Euphoric Misanthropia" (2001) and "Death Cult Armageddon" (2003)',
      },
    ],
  },
  'alex-rudinger': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Tama',
        notes: 'Became a Tama Drums artist around his tenure in The Faceless and the launch of Conquering Dystopia, playing the Starclassic Performer B/B kit listed on Tama\'s own artist page',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Evans',
        notes: 'Evans\' own artist page credits his head setup — a UV EQ4 Coated bass batter, G2 Clear tom batters, and an HD Dry snare batter',
      },
      {
        year: 2015,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Signed with Meinl Cymbals, running the Byzance and MB20 lines through touring work including Good Tiger and studio credits such as Whitechapel\'s "Kin" (2021)',
      },
    ],
  },
  'john-longstreth': {
    ...
    currentEndorsements: {
      ...
      cymbals: { brand: 'Meinl', model: 'Classics Custom Dark Series', since: '2000s' },
      sticks: { brand: 'Scorpion Percussion', model: '"Wee Heavy" Signature', since: '2010s' },
      hardware: { brand: 'ACD Unlimited', model: 'Bass Drum Pedals + FootBlaster Triggers', since: '2010s' },
    },
    timeline: [
      {
        year: 1995,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Played Pearl drums from Angelcorpse\'s 1995 formation through his ongoing tenure in Origin, recording "Informis Infinitas Inhumanitas" (2002) and "Chaosmos" (2022)',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Signed with Meinl Cymbals, per the brand\'s own artist page — Classics Custom Dark series (8" Splash, 14" Hi-Hats, 18" China) plus a Generation X 12"/14" Trash Hat',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
  ...
  'waltteri-vayrynen': {
    ...
    band: 'Opeth',
    currentEndorsements: {
      drums: { brand: 'Pearl', since: '2010s' },
      cymbals: { brand: 'Sabian', model: '22" HH Power Bell Ride (favourite piece)', since: '2010s' },
      sticks: { brand: 'Wincent', model: 'W-5BXL Signature', since: '2022' },
    },
    timeline: [
      {
        year: 2015,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Played Pearl drums from his 2015 session work with Paradise Lost, corroborated by Antelope Audio\'s writeup of his 2020 studio session at Orgone Studios',
      },
      {
        year: 2017,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Sabian\'s own artist page credits him as an endorsed artist, naming a 22" HH Power Bell Ride as his favourite piece in the setup',
      },
      {
        year: 2022,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        category: ENDORSEMENT_CATEGORIES.STICKS,
        brand: 'Wincent',
        product: 'W-5BXL Signature Model',
        notes: 'Wincent announced his W-5BXL signature stick model through the brand\'s artist roster in December 2022',
      },
    ],
  },
};
