...
export const ENDORSEMENT_TIMELINE = {
  ...
  'derek-roddy': {
    ...
    currentEndorsements: {
      ...
      heads: { brand: 'Evans', model: 'Genera HD Dry / EMAD', since: '2001' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Sabian',
        notes: 'Started with Sabian cymbals during his formative underground death metal years with Aurora Borealis',
      },
      {
        year: 2000,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Axis',
        notes: "Adopted Axis double pedals while touring as Nile's live drummer, drawn to the direct-drive speed extreme tempos demanded",
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'Various early-career kits',
        to: "DW Collector's Series Maple",
        notes: "Moved to a DW Collector's Series Maple kit at the start of the Hate Eternal peak era, prizing DW's True Pitch tuning stability for blast-beat-heavy sets",
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        brand: 'Axis',
        notes: 'Continued with Axis Longboard pedals into his clinic and educational career, including The Evolution of Blast Beats DVD',
      },
    ],
  },
  'hannes-grossmann': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Tama',
        notes: 'Built a Tama Starclassic Maple kit during the Necrophagist era, recording the landmark Epitaph (2004)',
      },
      {
        year: 2001,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Paired his early Tama kit with Meinl Byzance cymbals, a relationship that has continued unchanged through every subsequent kit switch',
      },
      {
        year: 2007,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Vic Firth',
        notes: 'Settled on Vic Firth 5A/5B sticks while co-founding Obscura and recording Cosmogenesis (2009) and Omnivium (2011)',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'Tama Starclassic Maple',
        to: 'DW Collectors Series',
        notes: 'Moved to a DW Collectors Series maple kit while co-founding Alkaloid, seeking the custom bearing-edge precision his compositional prog-death arrangements demanded',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
  ...
  'jason-bittner': {
    ...
    currentEndorsements: {
      ...
      sticks: { brand: 'Vic Firth', model: '5B', since: '1997', signature: false },
      heads: { brand: 'Remo', model: 'Ambassador Coated / Powerstroke 3', since: '1997' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Tama',
        notes: "Signed with Tama in Shadows Fall's formative years, settling on the Starclassic Performer B/B birch/bubinga hybrid",
      },
      {
        year: 1997,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Began his Sabian relationship alongside the Tama deal, building the HHX/HH setup that still defines his sound',
      },
      {
        year: 2002,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: 'Adopted the DW 9002 double bass pedal for The Art of Balance sessions, the record that broke Shadows Fall into NWOAHM\'s front rank',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Tama',
        notes: 'Carried the same Starclassic Performer B/B kit into his new chair with Overkill on The Electric Age, confirming his thrash credentials without changing gear',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Sabian',
        notes: 'Kept his Sabian HHX/HH setup across both Shadows Fall and Overkill duties after joining Overkill full-time in 2012',
      },
    ],
  },
  'jocke-wallgren': {
    ...
    currentEndorsements: {
      ...
      heads: { brand: 'Remo', model: 'Coated Ambassador / Powerstroke 3', since: '2013' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Meinl',
        notes: 'Began playing Meinl Byzance cymbals during his time with Rage and Evergrey in the European power/prog metal scene',
      },
      {
        year: 2005,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: 'Adopted a DW double bass pedal configuration during his Rage and Evergrey years, ahead of the 9002 model becoming his standard',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Tama',
        notes: 'Signed with Tama on joining Amon Amarth for Deceiver of the Gods (2013), settling on the Starclassic Performer B/B birch/bubinga kit',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Meinl',
        notes: "Carried his Meinl Byzance cymbals into the Amon Amarth chair, valuing their dark, warm voicing for the band's melodic death metal identity",
      },
      {
        year: 2019,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        brand: 'DW',
        notes: "Continued with the DW 9002 double bass pedal through Berserker (2019), which demanded both extended blast-beat passages and the band's signature gallop",
      },
    ],
  },
  'mike-mangini': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Replaced Hellhammer in Dimmu Borgir and brought his Pearl Reference Pure kit (custom black finish, double 22" kick) into the band, first tracked on studio debut "Abrahadabra" (2010)',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Paiste',
        notes: 'Built his setup around Paiste RUDE and 2002 series cymbals (15" Sound Edge Hi-Hats, 22" RUDE Power Ride) for durability and projection across Dimmu Borgir\'s festival-scale live shows',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Used the Pearl Demon Drive chain-drive double pedal on his Dimmu Borgir studio debut "Abrahadabra" (2010), recorded alongside the Kringkastingsorkestret orchestra and Schola Cantorum choir',
      },
      {
        year: 2018,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Pearl',
        notes: 'Carried the same Pearl Reference Pure / Paiste RUDE-2002 rig into "Eonian" (2018), Dimmu Borgir\'s first studio album in nearly eight years',
      },
    ],
  },
  'kevin-talley': {
  ...
  'martin-axenrot': {
    ...
    band: 'Opeth',
    currentEndorsements: {
      drums: { brand: 'Sonor', model: 'Designer / SQ2 Series', since: '2008' },
      cymbals: { brand: 'Meinl', model: 'Byzance Series', since: '2008' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 5B', since: '2008' },
      heads: { brand: 'Remo', model: 'Ambassador Coated', since: '2008' },
      hardware: { brand: 'Sonor', model: 'Giant Step Double Pedal', since: '2008' },
    },
    timeline: [
      {
        year: 2008,
        ...
        from: null,
        to: 'Sonor',
        notes: 'Introduced twin 22"x18" Sonor Designer/SQ2 bass drums on studio debut "Watershed" (2008), replacing predecessor Martin Lopez\'s single-kick rig with a heavier setup informed by his Bloodbath and Witchery background',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Brought his own longtime Meinl Byzance cymbal setup (hand-hammered Traditional/Dark series) into Opeth on "Watershed", continuing Lopez\'s dark/complex cymbal vocabulary under a different brand than Lopez\'s Sabian HH',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sonor',
        notes: 'Used Sonor Giant Step direct-drive twin pedals on "Watershed", tracked at Fascination Street Studios with Jens Bogren producing',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Sonor',
        notes: 'Carried the same twin-kick Sonor / Meinl Byzance rig through Opeth\'s prog-rock turn on "Pale Communion" (2014), following "Heritage" (2011) dropping death metal vocals entirely',
      },
    ],
  },
  'martin-lopez': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Sonor',
        notes: 'Joined Opeth and played a Sonor Designer Series maple kit through "Blackwater Park" (2001), "Deliverance" (2002), and "Ghost Reveries" (2005) — a setup that became a reference standard for progressive metal drum sound',
      },
      {
        year: 1997,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Used Sabian HH and AAX cymbals throughout his Opeth tenure, prioritizing warmth and dynamic complexity over volume',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sabian',
        to: 'Zildjian',
        notes: 'Switched to Zildjian A and K series cymbals after co-founding Soen in 2010 — a brighter tonal palette suited to the band\'s modern production, documented across "Cognitive" (2012) through "Memorial" (2023)',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Joined Animals as Leaders in 2012 (replacing Navene Koperweis) playing a compact Pearl Masterworks Maple kit — a 20" bass drum and MasterCast hoops chosen for articulation over raw power',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Built his cymbal setup around Meinl Byzance (15" Dual Hi-Hats, 22" Sand Ride, 18" Extra Dry Thin Crash) for the dark, musical character heard on his debut "The Joy of Motion" (2014)',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Pearl',
        product: 'Matt Garstka Signature Snare',
        notes: 'Released his Pearl signature snare (14"x5" maple with a unique bearing edge for ghost-note sensitivity), recorded on "The Joy of Motion" (2014) with producer Misha Mansoor',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
  ...
  'sean-reinert': {
    ...
    timeline: [
      ...
      },
      {
        ...
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.STICKS,
        from: 'Vic Firth SD9 Short Handle',
        to: 'Vic Firth American Classic 5A',
        notes: 'Switched to Vic Firth\'s American Classic 5A for "Human" (1991), a medium-weight model atypical for metal drummers of the era that gave Reinert the rebound and dynamic control his ghost-note vocabulary required',
      },
      {
        year: 1991,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        from: 'Pearl P-100P Twin Pedal',
        to: 'DW 5000 Double Pedal',
        notes: 'Upgraded to the DW 5000 double pedal for "Human" (1991), a mechanical precision upgrade over the Pearl P-100P\'s chain-drive action; carried the same pedal into Cynic\'s "Focus" (1993)',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'Tama Artstar II',
        to: "DW Collector's Series",
        notes: 'Upgraded to a DW Collector\'s Series maple shell kit for Cynic\'s reunion album "Traced in Air" (2008), his first recording in 15 years since "Focus" — maple\'s warmer resonance suited the self-produced, atmospheric sound',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        from: 'Zildjian A/K Series',
        to: 'Zildjian K Custom',
        notes: 'Narrowed to Zildjian K Custom cymbals throughout "Traced in Air" (2008) — darker and more complex than the A/K Series blend used on "Human" and "Focus," suited to the album\'s introspective character',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        from: 'DW 5000 Double Pedal',
        to: 'DW 9000 Double Pedal',
        notes: 'Moved to the DW 9000 double pedal for "Traced in Air" (2008), retained for the same smooth, compositional double-bass feel through the remainder of the Cynic reunion era, including "Kindly Bent to Free Us" (2014)',
      },
    ],
  },
  'nick-menza': {
    ...
    currentEndorsements: {
      ...
      heads: { brand: 'Remo', model: 'Ambassador Coated', since: '1990' },
      hardware: { brand: 'Tama', model: 'Iron Cobra Double Pedal', since: '1997' },
    },
    timeline: [
      {
        year: 1990,
        ...
        from: null,
        to: 'Tama',
        notes: 'Debuted on Megadeth\'s "Rust in Peace" (1990) with a Tama Artstar II kit in Midnight Blue finish — birch shells chosen for the focused attack needed to cut through Dave Mustaine and Marty Friedman\'s dense guitar arrangements',
      },
      {
        year: 1990,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        from: 'Zildjian A / A Custom',
        to: 'Paiste 2002 / Signature',
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.STICKS,
        brand: 'Vater',
        product: 'Vater Nick Menza Signature',
      ...
      },
      {
        ...
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        from: 'Tama Camco',
        to: 'Tama Iron Cobra Double Pedal',
        notes: 'The Tama Iron Cobra had fully replaced his older Camco-style pedals by "Cryptic Writings" (1997), after a transitional Camco/early-Iron-Cobra period on "Youthanasia" (1994)',
      },
    ],
  },
  'adrian-erlandsson': {
    ...
    band: 'At the Gates',
    currentEndorsements: {
      drums: { brand: 'Tama', model: 'Starclassic Bubinga', since: '2014' },
      cymbals: { brand: 'Sabian', model: 'AAX / HHX Series', since: '2014' },
      sticks: { brand: 'Vic Firth', model: 'Rock Nylon Tip (At the Gates Signature)', since: '1995', signature: true },
      heads: { brand: 'Evans', model: 'EMAD Onyx / EC Reverse Dot', since: '2014' },
      hardware: { brand: 'Monolit', model: 'Czarcie Kopyto Double Pedal', since: '2014' },
    },
    timeline: [
      {
        year: 1995,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Debuted on At the Gates\' "Slaughter of the Soul" (1995) with a budget Pearl Export/Forum-series studio kit at Studio Fredman, Gothenburg — gear reflecting the underground scene\'s limited touring and recording budgets',
      },
      {
        year: 1995,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Ran a Zildjian A-Series setup (14" hi-hats, China cymbal) on "Slaughter of the Soul" (1995) — among the cymbals most widely available in Swedish professional music shops of the era',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        from: 'Pearl Export/Forum-series studio kit',
        to: 'Tama Starclassic Bubinga',
        notes: 'Upgraded to a Tama Starclassic Bubinga kit (twin 22" bass drums, matching 14x6.5" snare) for At the Gates\' reunion album "At War with Reality" (2014) — a rig developed during his Paradise Lost years and carried into the reunion',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        from: 'Zildjian A-Series',
        to: 'Sabian AAX / HHX Series',
        notes: 'Moved into Sabian\'s professional AAX/HHX lines (15" HHX Xcelerator hi-hats, 20" AAX Iso crash, 19" AAX Paragon China) for "At War with Reality" (2014), a setup carried over from his Paradise Lost tenure and kept largely unchanged since, including on 2018\'s "To Drink from the Night Itself"',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        from: 'standard double bass pedal',
        to: 'Monolit Czarcie Kopyto Double Pedal',
        notes: 'Adopted the boutique Polish-made Monolit Czarcie Kopyto double pedal by "At War with Reality" (2014), replacing the standard double-pedal setups used on "Slaughter of the Soul" (1995), for extreme-tempo double-kick precision',
      },
    ],
  },
  'jon-dette': {
    ...
    band: 'Slayer',
    currentEndorsements: {
      drums: { brand: 'Ludwig', model: 'Classic Maple', since: '1996' },
      cymbals: { brand: 'Sabian / Zildjian', model: 'AAX / A Series', since: '1996' },
      sticks: { brand: 'Promark / Vater', model: '5B', since: '1996' },
      heads: { brand: 'Remo', model: 'Powerstroke 3 (Kick) / Emperor Coated (Toms) / Coated Ambassador (Snare)', since: '1996' },
      hardware: { brand: 'DW / Tama', model: '9000 / Iron Cobra Double Pedal', since: '1996' },
    },
    timeline: [
      {
        year: 1996,
        ...
        from: null,
        to: 'Ludwig',
        notes: 'Brought a Ludwig Classic Maple kit (twin 22" bass drums) to Slayer as touring drummer in 1996, filling in for Paul Bostaph on short notice — a gear choice distinct from Dave Lombardo\'s Tama and Bostaph\'s DW setups',
      },
      {
        year: 1996,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian / Zildjian',
        notes: 'Ran a Sabian/Zildjian cymbal setup (14" hi-hats, 16"/18" crashes, 20" ride, 18" China) during his 1996-1997 Slayer tenure, chosen for the fast attack and controlled decay thrash metal\'s sixteenth-note pulse demands',
      },
      {
        year: 1999,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Ludwig',
        notes: 'Maintained his Ludwig Classic Maple kit and Sabian/Zildjian cymbal setup into Testament\'s "The Gathering" (1999), adapting the same fundamental configuration to producer Billy Sherwood\'s more progressive arrangements',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        brand: 'DW / Tama',
        notes: 'Continued using DW 9000 or Tama Iron Cobra double bass pedals through his 2010 fill-in stint for Charlie Benante on an Anthrax tour, the same mechanism relied on since his 1996 Slayer tenure',
      },
    ],
  },
};
