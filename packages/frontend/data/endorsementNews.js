...
export const ENDORSEMENT_TIMELINE = {
  ...
  'art-cruz': {
    ...
    band: 'Lamb of God',
    currentEndorsements: {
      drums: { brand: 'Ludwig', model: 'Black Beauty (14x6.5")', since: '2019' },
      cymbals: { brand: 'Zildjian', model: 'A Custom / K China', since: '2019' },
      sticks: { brand: 'Vic Firth', model: 'American Classic 5B', since: '2019' },
      heads: { brand: 'Evans', since: '2019' },
      hardware: { brand: 'Trick', model: 'Pro 1-V Double Pedal', since: '2019' },
    },
    timeline: [
      {
        year: 2019,
        ...
        from: null,
        to: 'Ludwig',
        notes: 'Adopted a Ludwig kit anchored by the 14x6.5" Black Beauty snare after joining Lamb of God in 2019 to replace Chris Adler, following his 2010-2012 run with Winds of Plague and 2012-2019 run with Prong',
      },
      {
        year: 2019,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Signed with Zildjian (A Custom Mastersound hi-hats, A Custom crashes, K China with EFX holes) alongside the Ludwig kit for his Lamb of God debut',
      },
      {
        year: 2020,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Ludwig',
        notes: 'Carried the Black Beauty-anchored Ludwig setup through Lamb of God\'s self-titled 2020 album, his first studio record with the band',
      },
      {
        year: 2022,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Zildjian',
        notes: 'Continued the Zildjian A Custom/K China cymbal mix, plus Vic Firth American Classic 5B sticks and Evans heads, through Lamb of God\'s "Omens" (2022)',
      },
    ],
  },
  'alex-bent': {
    ...
    currentEndorsements: {
      drums: { brand: 'Pearl', model: 'Reference Pure Series (14x5" Brass)', since: '2016' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Signed with Pearl drums upon joining Trivium in 2016 (recording debut 2017), replacing Paul Wandtke, after his 2008-2017 run in technical death metal outfit Arkaik',
      },
      {
        year: 2017,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Paired Zildjian K Custom Hybrid cymbals with the Pearl kit for his Trivium studio debut, "The Sin and the Sentence" (2017)',
      },
      {
        year: 2020,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Pearl',
        notes: 'Carried the Pearl Reference Pure Series setup, centered on the 14x5" Brass snare, through "What the Dead Men Say" (2020)',
      },
      {
        year: 2021,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Axis',
        notes: 'Added Axis A Longboard double pedals to drive the rapid double-bass patterns on "In the Court of the Dragon" (2021)',
      },
    ],
  },
};
