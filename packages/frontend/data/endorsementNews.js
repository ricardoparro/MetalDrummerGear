...
export const ENDORSEMENT_TIMELINE = {
  ...
  'daray': {
    ...
    currentEndorsements: {
      ...
      heads: { brand: 'Remo', model: 'Emperor Coated / Ambassador', since: '2008' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Played a Pearl kit through his decade with Polish death metal band Vader (2006-2016), recording "Welcome to the Morbid Reich" (2011) and "Tibi et Igni" (2014)',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.DRUMS,
        brand: 'Pearl',
        notes: 'Carried the Pearl Reference Pure kit into Dimmu Borgir after replacing Hellhammer in 2008, recording "Abrahadabra" (2010) and "Eonian" (2018)',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Paiste',
        notes: 'Adopted Paiste RUDE and 2002 series cymbals for Dimmu Borgir\'s festival-scale live production, spanning extreme-volume passages and quieter orchestral-integration sections',
      },
      {
        year: 2010,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Pearl Demon Drive double bass pedal became his standard for sustained extreme-tempo double-kick patterns on "Abrahadabra" and subsequent Dimmu Borgir material',
      },
    ],
  },
  'kevin-talley': {
    ...
    currentEndorsements: {
      ...
      sticks: { brand: 'Vic Firth', model: '5B', since: '2000' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Joined Dying Fetus at 17 in 1996, building the Pearl Masters maple/mahogany kit heard on "Destroy the Opposition" (2000)',
      },
      {
        year: 2000,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Zildjian',
        notes: 'Zildjian A and A Custom cymbals documented on "Destroy the Opposition" (2000), carried through "War of Attrition" (2007) and his Misery Index work',
      },
      {
        year: 2000,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'DW',
        notes: 'DW double bass pedal became the mechanical foundation for his polyrhythmic double-kick technique, from "Destroy the Opposition" through his later Misery Index and Jungle Rot work',
      },
      {
        year: 2007,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.STICKS,
        brand: 'Vic Firth',
        notes: 'Continued with Vic Firth American Classic 5B sticks through "War of Attrition" (2007), for the added mass his brutal death metal power demands across extended tours',
      },
    ],
  },
  'martin-axenrot': {
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Sonor',
        notes: 'Played a Sonor Designer/SQ2 kit on his Opeth debut "Watershed" (2008), his first album after replacing Martin Lopez',
      },
      {
        year: 2008,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Meinl Byzance Traditional setup established on "Watershed" (2008), unchanged through "Heritage," "Pale Communion," "Sorceress," and "In Cauda Venenum"',
      },
      {
        year: 2011,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sonor',
        to: 'Pearl',
        notes: 'Switched to a Pearl Reference Series kit for "Heritage" (2011), Opeth\'s pivot toward a progressive-rock-influenced sound, and kept it through "Pale Communion," "Sorceress," and "In Cauda Venenum"',
      },
      {
        year: 2011,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        category: ENDORSEMENT_CATEGORIES.HARDWARE,
        from: 'Sonor Giant Step',
        to: 'Pearl Demon Drive',
        notes: 'Moved from the Sonor Giant Step twin pedals used on "Watershed" to Pearl Demon Drive twin pedals alongside the "Heritage"-era kit switch',
      },
    ],
  },
  'martin-lopez': {
    ...
    band: 'Soen',
    currentEndorsements: {
      drums: { brand: 'Sonor', model: 'SQ2 Custom', since: '2012' },
      cymbals: { brand: 'Zildjian', model: 'A / K Series', since: '2012' },
      sticks: { brand: 'Vic Firth', model: '5A Nylon', since: '2012' },
      heads: { brand: 'Remo', model: 'Ambassador Coated', since: '1998' },
      hardware: { brand: 'DW', model: '9002 Double Pedal', since: '2012' },
    },
    timeline: [
      {
        year: 1998,
        ...
        from: null,
        to: 'Pearl',
        notes: 'Used a mixed Pearl/Sonor budget touring kit with Sabian B8 Pro cymbals on Opeth\'s "My Arms, Your Hearse" (1998), moving to a full Pearl Export Series kit for "Still Life" (1999) and "Blackwater Park" (2001)',
      },
      {
        year: 2002,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Pearl',
        to: 'Sonor',
        notes: 'Switched to a Sonor Designer Series kit for "Deliverance" (2002)',
      },
      {
        year: 2003,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sonor',
        to: 'Pearl',
        notes: 'Returned to Pearl on a Masters Premium kit for "Damnation" (2003), carried through "Ghost Reveries" (2005)',
      },
      {
        year: 2003,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Sabian',
        to: 'Paiste',
        notes: 'Moved from Sabian HH cymbals to a Paiste 2002 series setup for "Damnation" (2003), unchanged through "Ghost Reveries" (2005)',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Pearl',
        to: 'Sonor',
        notes: 'After exiting Opeth in 2006 and co-founding Soen in 2010, moved to a bespoke Sonor SQ2 custom kit for Soen\'s debut "Cognitive" (2012)',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Paiste',
        to: 'Zildjian',
        notes: 'Switched to a Zildjian A/K series setup for the Soen era, favoring warmer, more complex tones for the band\'s progressive material',
      },
    ],
  },
  'matt-garstka': {
    ...
    currentEndorsements: {
      ...
      heads: { brand: 'Remo', model: 'Coated Ambassador / Emperor', since: '2012' },
    ...
    timeline: [
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Joined Animals as Leaders in 2012 replacing Navene Koperweis, building the Pearl Masterworks Maple kit heard on "The Joy of Motion" (2014)',
      },
      {
        year: 2012,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Meinl',
        notes: 'Meinl Byzance cymbal setup established alongside the Pearl kit for "The Joy of Motion" (2014), later expanded for "The Madness of Many" (2016)',
      },
      {
        year: 2014,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Vic Firth',
        notes: 'Played Vic Firth American Classic 5A sticks on "The Joy of Motion" (2014), before Vic Firth developed his signature model',
      },
      {
        year: 2016,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        category: ENDORSEMENT_CATEGORIES.STICKS,
        brand: 'Vic Firth',
        product: 'Matt Garstka Signature',
        notes: 'Debuted the Vic Firth Matt Garstka Signature stick — an elongated taper built for traditional-grip players — on "The Madness of Many" (2016)',
      },
      {
        year: 2016,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNATURE,
        ...
        notes: 'Pearl released the Matt Garstka Signature Snare on "The Madness of Many" (2016), replacing the pre-signature Pearl Reference snare used on "The Joy of Motion"',
      },
    ],
  },
};
