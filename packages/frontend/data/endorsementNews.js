  ...
  'blake-richardson': {
    ...
    timeline: [
      ...
      },
      {
        ...
        from: null,
        to: 'Meinl',
        notes: 'Paired his DW kit with Meinl Byzance Extra Dry cymbals on Alaska, establishing the dark, hand-hammered voice that carried through the Colors and Parallax eras',
      },
      {
        year: 2006,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
      ...
      },
      {
        ...
        from: 'DW',
        to: 'Tama',
        notes: "Moved to a Tama Starclassic Bubinga kit for Automata I & II, favoring its tight low end and explosive attack for BTBAM's Sumerian Records-era production",
      },
      {
        year: 2018,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
        ...
        from: 'Meinl',
        to: 'Sabian',
        notes: 'Switched to a Sabian HHX Evolution / AAX / HH cymbal spread for Automata I & II, built for BTBAM\'s complex, shifting textures',
      },
      {
        year: 2018,
        changeType: ENDORSEMENT_CHANGE_TYPES.SWITCHED,
      ...
      },
      {
        ...
        from: 'DW',
        to: 'Tama',
        notes: 'Moved to twin Tama Iron Cobra Power Glide single pedals (not a linked double pedal) for independent double-kick control across Automata\'s shifting time signatures',
      },
    ],
  },
  'chris-turner': {
