    ...
    timeline: [
      {
        ...
        from: null,
        to: 'DW',
        notes: 'Joined Opeth mid-tour on the "Ghost Reveries" cycle in 2006, playing a custom hand-made DW kit with maple/gum shells — the same setup he described in a 2016 MusicRadar interview around the "Sorceress" cycle as unchanged since joining',
      },
      {
        year: 2006,
        changeType: ENDORSEMENT_CHANGE_TYPES.SIGNED,
        ...
        from: null,
        to: 'Sabian',
        notes: 'Sabian artist (HHX / AAX Series) since joining Opeth in 2006, per SABIAN\'s own artist page',
      },
    ],
  },
  'martin-lopez': {
