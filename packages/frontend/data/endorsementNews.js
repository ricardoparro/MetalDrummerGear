  ...
  'jocke-wallgren': {
    ...
    timeline: [
      ...
      },
      {
        ...
        from: null,
        to: 'Pearl',
        notes: 'Signed with Pearl on joining Amon Amarth for Deceiver of the Gods (2013), settling on the Reference Pure hybrid-shell kit',
      },
      {
        year: 2013,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
        category: ENDORSEMENT_CATEGORIES.CYMBALS,
        brand: 'Zildjian',
        notes: "Carried his Zildjian A Custom & K Custom cymbals into the Amon Amarth chair, valuing their bright, cutting voicing for the band's melodic death metal identity",
      },
      {
        year: 2019,
        changeType: ENDORSEMENT_CHANGE_TYPES.RENEWED,
