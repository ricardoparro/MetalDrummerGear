...
- Has signature educational content and drum books`
      ...
      sources: {
        title: 'Sources',
        items: [
          { name: 'Pearl Drums Artist Profile', url: 'https://pearldrum.com/en/artist/flo-mounier' },
...
- Emphasis on consistent sound night after night`
      ...
      sources: {
        ...
        items: [
          { name: 'Mapex Drums', url: 'https://www.mapexdrums.com' },
          { name: 'Zildjian Artist Profile', url: 'https://zildjian.com/blogs/artist/jason-bittner' },
