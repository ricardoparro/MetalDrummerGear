...
- **Sticks**: Promark or Vater 5B`
  ...
  'martin-axenrot': {
    ...
    summary: 'Martin Axenrot, Opeth\'s drummer since 2006 (succeeding Martin Lopez), also drums for death metal supergroup Bloodbath, known for his twin-bass-drum custom DW setup.',
...
- Dynamic control across Opeth's shifting acoustic and heavy sections`
      ...
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Martin Axenrot plays a custom hand-made DW drum kit with maple/gum shells, the platform he has used since joining Opeth in 2006. His setup is defined by twin bass drums — a departure from Martin Lopez's single-kick rig that adds low-end density and firepower for extended double-bass passages. In a 2016 MusicRadar interview, Axenrot described the kit as "a custom hand made DW drum kit with maple/gum shells that I think sounds fantastic," and had DW build an identical second kit for touring.

**Current Setup:**
- **Drums**: DW Collector's Series (custom, maple/gum shells) with twin bass drums
- **Snare**: DW Collector's Series (custom)
- **Cymbals**: SABIAN HHX/AAX Series (15" HHX Groove Hats, 10" AAX Splash, 18" HHX Evolution O-Zone Crash, 12" HHX Splash, 21" HHX Legacy Ride, 20" HHX Chinese)
- **Hardware**: Not independently verified
- **Sticks**: Pro-Mark
- **Heads**: Evans

**Notable Gear Choices:**
- Twin-bass-drum configuration for heavier, more aggressive attack than his predecessor
- SABIAN HHX/AAX cymbals for dark, complex tonal range across Opeth's dynamic material
- Setup has remained rooted in DW and SABIAN gear throughout his Opeth tenure`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
          ...
          'His twin-bass-drum custom DW setup marked a departure from Martin Lopez\'s single-kick configuration',
      ...
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does Martin Axenrot play?', a: 'Martin Axenrot plays a custom hand-made DW drum kit with maple/gum shells and twin bass drums, the configuration he has used throughout his tenure as Opeth\'s drummer since 2006.' },
          ...
          { q: 'What cymbals does Martin Axenrot use?', a: 'Martin Axenrot uses SABIAN HHX/AAX Series cymbals, including HHX Groove Hats, an AAX Splash, an HHX Evolution O-Zone Crash, an HHX Legacy Ride, and an HHX Chinese.' },
          ...
          { q: 'What drum set does Martin Axenrot use?', a: 'Martin Axenrot\'s drum set is a custom hand-made DW build with twin bass drums — a departure from Martin Lopez\'s single-kick rig — anchored by a matching DW custom snare and SABIAN HHX/AAX Series cymbals.' },
          { q: 'What snare drum does Martin Axenrot use?', a: 'Martin Axenrot plays a custom DW Collector\'s Series snare drum, matched to his kit.' },
          { q: 'What pedals does Martin Axenrot use?', a: 'Martin Axenrot\'s bass drum pedal brand is not independently verified for his twin-bass-drum DW kit.' },
          { q: 'What sticks does Martin Axenrot use?', a: 'Martin Axenrot plays Pro-Mark drumsticks.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'SABIAN: Martin Axenrot Artist Page', url: 'https://sabian.com/artist/martin-axenrot/' },
          { name: 'MusicRadar: Opeth\'s Martin "Axe" Axenrot talks new album Sorceress', url: 'https://www.musicradar.com/news/drums/opeths-martin-axe-axenrot-talks-new-album-sorceress-644191' }
        ]
      }
    }
  },
