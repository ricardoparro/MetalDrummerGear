...
- Clean, articulate playing even at extreme speeds`
      ...
      gearHighlights: {
        title: 'Gear Highlights',
        content: `George Kollias has a signature snare drum with Pearl Drums and plays Vic Firth sticks. He was instrumental in co-designing the Pearl Demon XR double pedal, specifically engineered for extreme speed applications.
...
- Signature snare: designed for cut and articulation in dense metal mixes`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drum set does George Kollias use?', a: 'George Kollias\'s drum set is a Pearl Masterworks Stadium Exotic configuration in Piano Black with Gold Hardware, centered on his Pearl George Kollias Signature 14"x6.5" snare. He drives the drum set with the Pearl Demon XR double pedal he co-designed, plays Vic Firth drumsticks, and heads it with Evans drumheads.' },
