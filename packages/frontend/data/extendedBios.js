// Extended Drummer Biographies
// LLM-optimized, SEO-friendly, entity-rich content
// Structure follows the template: Overview, Career Highlights, Style & Influences,
// Notable Recordings/Tours, Gear Highlights, Trivia/Notes, Sources

export const extendedBios = {
  ...
  'lars-ulrich': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Lars Ulrich (born December 26, 1963, in Gentofte, Denmark) is a Danish-American musician who co-founded Metallica in 1981 alongside vocalist/guitarist James Hetfield. As the band's drummer, primary spokesman, and a key creative force, Ulrich has been instrumental in shaping Metallica into one of the most commercially successful and influential heavy metal bands in history.
...
Ulrich was the first Danish-born musician inducted into the Rock and Roll Hall of Fame when Metallica received the honor in 2009. He is widely recognized for his aggressive drumming style, distinctive fills, and his role in pioneering the thrash metal genre alongside bands like Slayer, Megadeth, and Anthrax—collectively known as the "Big Four" of thrash metal.`
      ...
      careerHighlights: {
        ...
        items: [
          { year: '1981', event: 'Co-founded Metallica in Los Angeles with James Hetfield after placing a newspaper ad seeking musicians' },
          { year: '1983', event: 'Released "Kill \'Em All," Metallica\'s debut album, establishing the thrash metal template' },
          { year: '1986', event: 'Recorded "Master of Puppets," widely considered one of the greatest metal albums ever made' },
          { year: '1991', event: 'Released "The Black Album" (Metallica), which sold over 16 million copies in the US alone' },
          { year: '1996', event: 'Headlined Lollapalooza festival, breaking metal\'s alternative boundaries' },
          { year: '2000', event: 'Testified before the US Senate Judiciary Committee regarding Napster and digital piracy' },
          { year: '2004', event: 'Subject of the documentary "Some Kind of Monster," revealing band dynamics and personal struggles' },
          { year: '2009', event: 'Inducted into the Rock and Roll Hall of Fame with Metallica' },
          { year: '2016', event: 'Released "Hardwired...to Self-Destruct," Metallica\'s first album in 8 years, debuting at #1' },
          { year: '2023', event: 'Released "72 Seasons," Metallica\'s eleventh studio album' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Lars Ulrich's drumming style is characterized by aggressive, driving rhythms and distinctive snare fills that have become synonymous with Metallica's sound. His approach prioritizes serving the song over technical showmanship, creating memorable patterns that complement the guitar riffs.
...
- Minimalist, groove-focused approach on later albums`
      ...
      notableRecordings: {
        ...
        albums: [
          { name: 'Kill \'Em All', year: 1983, label: 'Megaforce Records', note: 'Thrash metal blueprint' },
          { name: 'Ride the Lightning', year: 1984, label: 'Megaforce/Elektra', note: 'Expanded musical complexity' },
          { name: 'Master of Puppets', year: 1986, label: 'Elektra', note: 'Widely considered a masterpiece' },
          { name: '...And Justice for All', year: 1988, label: 'Elektra', note: 'Most technically demanding' },
          { name: 'Metallica (The Black Album)', year: 1991, label: 'Elektra', note: '16x Platinum in US' },
          { name: 'Load', year: 1996, label: 'Elektra', note: 'Musical experimentation era' },
          { name: 'St. Anger', year: 2003, label: 'Elektra', note: 'Raw, controversial production' },
          { name: 'Death Magnetic', year: 2008, label: 'Warner Bros.', note: 'Return to thrash roots' },
          { name: 'Hardwired...to Self-Destruct', year: 2016, label: 'Blackened', note: '#1 in 57 countries' },
          { name: '72 Seasons', year: 2023, label: 'Blackened', note: 'Most recent studio album' }
        ],
        tours: [
          { name: 'Damage, Inc. Tour', year: '1986-1987', note: 'Supporting Master of Puppets' },
          { name: 'Nowhere Else to Roam Tour', year: '1991-1993', note: '300+ shows for Black Album' },
          { name: 'WorldWired Tour', year: '2016-2019', note: 'Grossed over $600 million' },
          { name: 'M72 World Tour', year: '2023-2025', note: 'Two unique setlists per city' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Lars Ulrich has been a Tama endorser since the mid-1980s, using their drums exclusively for over three decades. His signature snare drum, the Tama LU1465, features a 14"x6.5" steel shell designed to cut through Metallica's wall of guitar sound.

**Current Setup (2023-Present):**
- **Drums**: Tama Starclassic Maple in custom black finish
- **Snare**: Tama LU1465 Lars Ulrich Signature (14"x6.5" steel)
- **Cymbals**: Zildjian A Custom series including 14" Dyno Beat Hi-Hats, various crashes, and a 22" ride
- **Hardware**: Tama Iron Cobra 900 Power Glide double pedal
- **Sticks**: Ahead Lars Ulrich Signature (aluminum alloy)
- **Heads**: Remo (Emperor/Ambassador)

**Notable Gear Evolution:**
- Started with Camco drums in early Metallica years
- Transitioned to Tama in the mid-1980s
- Pioneer of Ahead aluminum drumsticks for durability
- Known for relatively small kit compared to many metal drummers`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drum kit did Lars Ulrich use?', a: "Lars Ulrich's drum kit is a Tama Starclassic Maple kit in a custom black finish, built around his signature Tama LU1465 snare — a 14\"x6.5\" steel shell designed to cut through Metallica's wall of guitar sound. The kit also carries Zildjian A Custom cymbals, including 14\" Dyno Beat hi-hats, several crashes, and a 22\" ride, powered by a Tama Iron Cobra 900 Power Glide double pedal. Ulrich started on Camco drums in Metallica's earliest years before switching to Tama in the mid-1980s." },
          { q: 'What drum set did Lars Ulrich use?', a: "Lars Ulrich's drum set is built on Tama Starclassic Maple shells finished in custom black, anchored by his signature Tama LU1465 14\"x6.5\" steel snare drum. Zildjian A Custom cymbals — 14\" Dyno Beat hi-hats, multiple crashes, and a 22\" ride — round out the set, along with a Tama Iron Cobra 900 Power Glide double pedal and Ahead aluminum alloy signature drumsticks. Ulrich has used Tama exclusively since moving on from Camco drums in the mid-1980s." },
          { q: 'What cymbals does Lars Ulrich use?', a: 'Lars Ulrich uses Zildjian A Custom series cymbals, including 14" Dyno Beat hi-hats, several A Custom crash cymbals, and a 22" A Custom ride. The bright, cutting tone of the A Custom line helps his cymbals project through Metallica\'s heavily distorted guitar mix.' },
          { q: 'What snare drum does Lars Ulrich use?', a: 'Lars Ulrich\'s primary snare is the Tama LU1465, his signature 14"x6.5" steel-shell snare drum built for maximum cut and volume on stage. It has been his main snare since he moved from Camco drums to Tama in the mid-1980s.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          { name: 'Rock and Roll Hall of Fame', url: 'https://www.rockhall.com/inductees/metallica' },
          { name: 'Tama Drums Artist Profile', url: 'https://www.tama.com/usa/artists/detail/98.html' },
          { name: 'Modern Drummer Magazine', url: 'https://www.moderndrummer.com' },
          { name: 'Wikipedia: Lars Ulrich', url: 'https://en.wikipedia.org/wiki/Lars_Ulrich' }
        ]
      }
    }
  },
  ...
  'joey-jordison': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Joey Jordison (born Nathan Jonas Jordison; April 26, 1975 – July 26, 2021) was an American musician, songwriter, and record producer. Best known as the original drummer of Slipknot from 1995 to 2013, Jordison was widely regarded as one of the greatest and most influential metal drummers of all time.
...
His blistering speed, technical precision, and theatrical stage presence—including performing on a rotating, inverted drum platform—made him an icon in the metal community. Beyond Slipknot, Jordison founded the horror punk band Murderdolls, played guitar for Rob Zombie's touring band, and drummed for numerous projects including Sinsaenum, Vimic, and a brief stint with Metallica in 2004.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1995', event: 'Joined Slipknot (then known as The Pale Ones), becoming member #1' },
          { year: '1999', event: 'Released Slipknot\'s self-titled debut album, achieving platinum status' },
          { year: '2001', event: 'Released "Iowa," considered one of the heaviest albums ever recorded' },
          { year: '2001', event: 'Formed Murderdolls with Wednesday 13, playing guitar' },
          { year: '2002', event: 'Performed legendary drum solo on "Disasterpieces" live DVD' },
          { year: '2004', event: 'Briefly filled in for Lars Ulrich on Metallica tour dates' },
          { year: '2006', event: 'Voted #1 in Revolver Magazine\'s "Greatest Metal Drummers of All Time"' },
          { year: '2008', event: 'Released "All Hope Is Gone," Slipknot\'s first #1 Billboard album' },
          { year: '2010', event: 'Won Revolver Golden Gods Award for Best Drummer' },
          { year: '2013', event: 'Parted ways with Slipknot; later revealed he had been battling transverse myelitis' },
          { year: '2016', event: 'Formed Sinsaenum and Vimic; continued performing despite health challenges' },
          { year: '2021', event: 'Passed away on July 26, 2021, leaving an immeasurable legacy' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Joey Jordison's drumming style combined extreme speed with surgical precision. He was capable of sustained blast beats at over 200 BPM while maintaining clarity and groove. His approach blended death metal technicality with nu-metal groove and punk energy.
...
- Seamless integration of electronic triggers with acoustic drums`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Slipknot', year: 1999, label: 'Roadrunner', note: '2x Platinum, explosive debut' },
          { name: 'Iowa', year: 2001, label: 'Roadrunner', note: 'Recorded drums in 10 days; extreme intensity' },
          { name: 'Vol. 3: (The Subliminal Verses)', year: 2004, label: 'Roadrunner', note: 'Grammy for "Before I Forget"' },
          { name: 'All Hope Is Gone', year: 2008, label: 'Roadrunner', note: 'First #1 album on Billboard' },
          { name: 'Murderdolls - Beyond the Valley of the Murderdolls', year: 2002, label: 'Roadrunner', note: 'Joey on guitar' },
          { name: 'Sinsaenum - Echoes of the Tortured', year: 2016, label: 'earMUSIC', note: 'Death metal supergroup' }
        ],
        tours: [
          { name: 'Ozzfest', year: '1999, 2001, 2004, 2005', note: 'Multiple legendary performances' },
          { name: 'Download Festival', year: '2009', note: 'Headlined with Slipknot' },
          { name: 'Mayhem Festival', year: '2008, 2012', note: 'US summer touring' }
        ]
      },
      gearHighlights: {
...
For a complete era-by-era component breakdown, see the [Joey Jordison drum setup guide](/articles/joey-jordison-drum-setup).`
      ...
      sources: {
        title: 'Sources',
        items: [
          { name: 'Pearl Drums Legacy', url: 'https://pearldrum.com' },
          { name: 'Revolver Magazine', url: 'https://www.revolvermag.com' },
          { name: 'Modern Drummer Magazine', url: 'https://www.moderndrummer.com' },
          { name: 'Wikipedia: Joey Jordison', url: 'https://en.wikipedia.org/wiki/Joey_Jordison' }
        ]
      }
    }
  },
...
**August 31, 2026** marks Gene Hoglan's 59th birthday. Fans continue to mark the anniversary by revisiting his work across Dark Angel, Death, Testament, and Dethklok — a body of work that remains a benchmark for technical death metal drumming.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1983', event: 'Started career as a roadie/drum tech for Slayer' },
          { year: '1984', event: 'Joined Dark Angel, earning the "Human Drum Machine" nickname' },
          { year: '1986', event: 'Released "Darkness Descends" with Dark Angel, a thrash metal landmark' },
          { year: '1991', event: 'Joined Chuck Schuldiner\'s Death for "Individual Thought Patterns" sessions' },
          { year: '1995', event: 'Recorded "Symbolic" with Death, widely considered his masterwork' },
          { year: '1997', event: 'Joined Strapping Young Lad, collaborating with Devin Townsend' },
          { year: '2005', event: 'Performed on "Alien" with Strapping Young Lad, one of the heaviest albums ever' },
          { year: '2007', event: 'Became Testament\'s drummer; recorded for Dethklok' },
          { year: '2008', event: 'Drummed on "The Formation of Damnation," Testament\'s acclaimed comeback' },
          { year: '2012', event: 'Joined Fear Factory; released "The Industrialist"' },
          { year: '2020', event: 'Released "Titans of Creation" with Testament during COVID-19 pandemic' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Gene Hoglan's drumming philosophy centers on serving the music while pushing technical boundaries. His playing combines jazz-influenced precision with extreme metal power. Despite his ability to play at extreme speeds, he prioritizes groove, dynamics, and tasteful musicality.
...
- Ability to play complex patterns while making them feel natural`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Dark Angel - Darkness Descends', year: 1986, label: 'Combat', note: 'Thrash metal essential' },
          { name: 'Dark Angel - Time Does Not Heal', year: 1991, label: 'Combat', note: '246 riffs in one album' },
          { name: 'Death - Individual Thought Patterns', year: 1993, label: 'Relativity', note: 'Technical death metal peak' },
          { name: 'Death - Symbolic', year: 1995, label: 'Roadrunner', note: 'Considered his masterpiece' },
          { name: 'Strapping Young Lad - City', year: 1997, label: 'Century Media', note: 'One of the heaviest albums ever' },
          { name: 'Strapping Young Lad - Alien', year: 2005, label: 'Century Media', note: 'Extreme metal tour de force' },
          { name: 'Testament - The Formation of Damnation', year: 2008, label: 'Nuclear Blast', note: 'Triumphant comeback' },
          { name: 'Dethklok - The Dethalbum', year: 2007, label: 'Williams Street', note: 'Animated band, real metal' },
          { name: 'Testament - Titans of Creation', year: 2020, label: 'Nuclear Blast', note: 'Pandemic-era masterwork' }
        ],
        tours: [
          { name: 'Testament World Tours', year: '2007-Present', note: 'Primary touring drummer' },
          { name: 'Dethklok Tours', year: '2008-2014', note: 'Adult Swim animated band live shows' },
          { name: 'Death To All', year: '2012-2013', note: 'Tribute to Chuck Schuldiner\'s Death' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Gene Hoglan has been a Pearl Drums endorser for many years, favoring their Reference Pure series for its versatility across his many musical projects. His setup emphasizes clarity and projection to cut through dense, extreme metal arrangements.
...
- Known for consistent setup across different bands`
      ...
      sources: {
        title: 'Sources',
        items: [
          { name: 'Pearl Drums Artist Profile', url: 'https://pearldrum.com/en/artist/gene-hoglan' },
          { name: 'Drumeo', url: 'https://www.drumeo.com/beat/gene-hoglans-drum-kit/' },
          { name: 'Modern Drummer Magazine', url: 'https://www.moderndrummer.com' },
          { name: 'Wikipedia: Gene Hoglan', url: 'https://en.wikipedia.org/wiki/Gene_Hoglan' }
        ]
      }
    }
  },
  ...
  'dave-lombardo': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Dave Lombardo (born February 16, 1965, in Havana, Cuba) is a Cuban-American drummer widely regarded as one of the greatest and most influential drummers in heavy metal history. As the original and primary drummer of Slayer, Lombardo pioneered the double bass drumming style that defined thrash metal in the 1980s.
...
His work on landmark albums such as "Reign in Blood," "South of Heaven," and "Seasons in the Abyss" established the template for extreme metal drumming. Beyond Slayer, Lombardo has explored diverse musical territories with Fantômas, Suicidal Tendencies, Dead Cross, Mr. Bungle, and the 2022 reunited Pantera as a touring member.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1981', event: 'Joined Slayer as founding drummer alongside Kerry King, Jeff Hanneman, and Tom Araya' },
          { year: '1983', event: 'Released "Show No Mercy," Slayer\'s debut album' },
          { year: '1986', event: 'Recorded "Reign in Blood," revolutionizing extreme metal drumming' },
          { year: '1988', event: 'Released "South of Heaven," showcasing dynamic range beyond speed' },
          { year: '1992', event: 'First departure from Slayer due to financial disputes' },
          { year: '1998', event: 'Joined Mike Patton\'s Fantômas, exploring avant-garde metal' },
          { year: '2001', event: 'Rejoined Slayer for "God Hates Us All" album' },
          { year: '2006', event: 'Released "Christ Illusion" with Slayer, winning Grammy for Best Metal Performance' },
          { year: '2013', event: 'Second departure from Slayer' },
          { year: '2017', event: 'Formed Dead Cross with Mike Patton; joined Mr. Bungle reunion' },
          { year: '2019', event: 'Recorded "The Raging Wrath of the Easter Bunny Demo" with Mr. Bungle' },
          { year: '2022', event: 'Joined reunited Pantera as touring drummer, honoring Vinnie Paul\'s legacy' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Dave Lombardo's drumming style is characterized by incredible speed, precise double bass technique, and a unique Latin-influenced groove that sets him apart from other thrash drummers. His ability to play complex, rapid patterns while maintaining groove and musicality revolutionized metal drumming.
...
- Creative use of china cymbals and unusual accents`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Slayer - Show No Mercy', year: 1983, label: 'Metal Blade', note: 'Slayer\'s debut' },
          { name: 'Slayer - Hell Awaits', year: 1985, label: 'Metal Blade', note: 'Thrash complexity evolves' },
          { name: 'Slayer - Reign in Blood', year: 1986, label: 'Def Jam', note: 'Defining thrash metal album' },
          { name: 'Slayer - South of Heaven', year: 1988, label: 'Def American', note: 'Showed dynamic range' },
          { name: 'Slayer - Seasons in the Abyss', year: 1990, label: 'Def American', note: 'Commercial breakthrough' },
          { name: 'Fantômas - Fantômas', year: 1999, label: 'Ipecac', note: 'Avant-garde exploration' },
          { name: 'Slayer - Christ Illusion', year: 2006, label: 'American', note: 'Grammy winner' },
          { name: 'Dead Cross - Dead Cross', year: 2017, label: 'Ipecac', note: 'Hardcore punk project' },
          { name: 'Mr. Bungle - The Raging Wrath...', year: 2020, label: 'Ipecac', note: 'Thrash metal reunion' }
        ],
        tours: [
          { name: 'Clash of the Titans', year: 1990, note: 'With Megadeth, Anthrax, Alice in Chains' },
          { name: 'Slayer Farewell Tour', year: '2018-2019', note: 'Final Slayer world tour (Lombardo not participating)' },
          { name: 'Pantera Reunion Tour', year: '2022-2023', note: 'Filling in for late Vinnie Paul' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Dave Lombardo has been a Tama endorser for most of his career, though he's used various brands throughout different projects. His signature 2Bx sticks from Promark are designed for power and speed.

**Current Setup (Pantera Era):**
- **Drums**: Tama Starclassic Walnut/Birch
- **Snare**: Tama S.L.P. 14"x6.5" G-Maple
- **Cymbals**: Paiste RUDE and 2002 series (15" Sound Edge Hi-Hats, crashes, Reign Power Ride)
- **Hardware**: Tama Iron Cobra 900 double pedal
- **Sticks**: Promark Dave Lombardo Signature 2Bx
- **Heads**: Evans (or Remo depending on project)

**Gear Evolution:**
- Started with Tama Imperialstar, evolved to Artstar and Starclassic
- Known for preferring larger bass drums (22"-24")
- Pioneered use of Paiste RUDE cymbals in thrash metal
- Has collaborated with Paiste on the "Reign" series ride cymbal`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What cymbals does Dave Lombardo use?', a: 'Dave Lombardo uses Paiste RUDE and 2002 series cymbals, including 15" Sound Edge hi-hats, RUDE crashes, and the Paiste Reign Power Ride — a signature ride cymbal he co-designed with Paiste and named after Slayer\'s "Reign in Blood" album.' },
          { q: 'What snare drum does Dave Lombardo use?', a: 'Dave Lombardo plays a Tama S.L.P. 14"x6.5" G-Maple snare drum, paired with Promark Dave Lombardo Signature 2Bx sticks designed for the power and speed his double bass style demands.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          { name: 'Tama Drums Artist Profile', url: 'https://www.tama.com/usa/artists/detail/1044.html' },
          { name: 'Paiste Artist Profile', url: 'https://www.paiste.com/en/musicians/dave-lombardo' },
          { name: 'Revolver Magazine', url: 'https://www.revolvermag.com' },
          { name: 'Wikipedia: Dave Lombardo', url: 'https://en.wikipedia.org/wiki/Dave_Lombardo' }
        ]
      }
    }
  },
...
Haake's approach to drumming involves complex polyrhythmic patterns that create the illusion of multiple time signatures occurring simultaneously. His metronomic precision and ability to navigate bewildering rhythmic landscapes while maintaining groove has influenced countless drummers and bands in the progressive and extreme metal communities.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1990', event: 'Joined Meshuggah as drummer, replacing Niclas Lundgren' },
          { year: '1995', event: 'Released "Destroy Erase Improve," introducing polyrhythmic concepts to metal' },
          { year: '1998', event: 'Released "Chaosphere," further developing the Meshuggah sound' },
          { year: '2002', event: 'Released "Nothing," influencing the nascent djent movement' },
          { year: '2005', event: 'Released "Catch Thirtythree," an experimental single-track album' },
          { year: '2008', event: 'Released "obZen" featuring "Bleed," one of the most challenging drum tracks ever recorded' },
          { year: '2012', event: 'Released "Koloss," topping metal charts worldwide' },
          { year: '2016', event: 'Released "The Violent Sleep of Reason," recorded live in studio' },
          { year: '2022', event: 'Released "Immutable," continuing Meshuggah\'s evolution' },
          { year: '2023', event: 'Received Grammy nomination for "Immutable"' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Tomas Haake's drumming style is defined by complex polyrhythmic patterns layered over steady 4/4 time signatures. While his hands often follow unconventional subdivisions and time signatures, his feet typically maintain a consistent pulse, creating the distinctive Meshuggah groove.
...
- Use of ghost notes and dynamics within extreme metal context`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Destroy Erase Improve', year: 1995, label: 'Nuclear Blast', note: 'Breakthrough polyrhythmic album' },
          { name: 'Chaosphere', year: 1998, label: 'Nuclear Blast', note: 'Refined the formula' },
          { name: 'Nothing', year: 2002, label: 'Nuclear Blast', note: 'Spawned djent movement' },
          { name: 'Catch Thirtythree', year: 2005, label: 'Nuclear Blast', note: 'Experimental single track' },
          { name: 'obZen', year: 2008, label: 'Nuclear Blast', note: 'Contains legendary "Bleed"' },
          { name: 'Koloss', year: 2012, label: 'Nuclear Blast', note: 'Groove-focused evolution' },
          { name: 'The Violent Sleep of Reason', year: 2016, label: 'Nuclear Blast', note: 'Live-recorded intensity' },
          { name: 'Immutable', year: 2022, label: 'Atomic Fire', note: 'Grammy-nominated' }
        ],
        tours: [
          { name: 'obZen World Tour', year: '2008-2009', note: 'Supporting the acclaimed album' },
          { name: 'Download Festival Headline', year: '2012', note: 'Major festival recognition' },
          { name: 'Immutable World Tour', year: '2022-2023', note: 'Most extensive touring cycle' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Tomas Haake has been a Sonor Drums endorser for over two decades, using their SQ2 series drums. Notably, he uses two separate single bass drum pedals rather than a traditional double pedal, allowing for greater independence between feet.

**Current Setup:**
- **Drums**: Sonor SQ2 Heavy Beech (24"x18" Bass, multiple toms up to 18")
- **Snare**: Sonor Tomas Haake Signature 14"x6.5" and Artist Series Bronze
- **Cymbals**: Sabian HHX and AAX series (including signature Compression Hi-Hats)
- **Hardware**: Two Tama Speed Cobra single pedals (NOT a double pedal)
- **Throne**: Porter & Davies BC2 with tactile monitoring
- **Sticks**: Wincent Tomas Haake Signature
- **Heads**: Remo

**Unique Setup Choices:**
- Two single pedals for foot independence (can play different rhythms with each foot)
- Porter & Davies throne provides tactile feedback for monitoring
- Sonor Heavy Beech shells for powerful, focused tone
- Sabian Compression Hi-Hats for quick, tight response`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      sources: {
        title: 'Sources',
        items: [
          { name: 'Sonor Drums Artist Profile', url: 'https://www.sonor.com/drums/artists/artists-detail/tomas-haake' },
          { name: 'Sabian Artist Profile', url: 'https://sabian.com/artist/tomas-haake/' },
          { name: 'Drumeo Interview', url: 'https://www.drumeo.com' },
          { name: 'Wikipedia: Tomas Haake', url: 'https://en.wikipedia.org/wiki/Tomas_Haake' }
        ]
      }
    }
  },
...
**August 30, 2026** marks George Kollias's 49th birthday. Fans continue to mark the anniversary by revisiting his blast-beat clinics and his run of albums with Nile — a body of work that remains a benchmark for technical death metal drumming.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1990s', event: 'Began drumming career in Greek metal bands Nightfall and Sickening Horror' },
          { year: '2004', event: 'Joined Nile, replacing Tony Laureano' },
          { year: '2005', event: 'Recorded first album with Nile: "Annihilation of the Wicked"' },
          { year: '2007', event: 'Released "Ithyphallic" with Nile; began educational clinic tours' },
          { year: '2009', event: 'Released "Those Whom the Gods Detest" to critical acclaim' },
          { year: '2010', event: 'Released first instructional DVD: "Intense Metal Drumming"' },
          { year: '2012', event: 'Received Vic Firth signature drumstick' },
          { year: '2015', event: 'Co-designed Pearl Demon XR double pedal' },
          { year: '2017', event: 'Released second instructional DVD: "Intense Metal Drumming II"' },
          { year: '2019', event: 'Released "Vile Nilotic Rites" with Nile' },
          { year: '2022', event: 'Received Pearl George Kollias signature snare drum' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `George Kollias's drumming style combines extreme speed with remarkable endurance and clarity. His blast beats, gravity blasts, and double bass patterns maintain precision even at the most demanding tempos. He emphasizes technical excellence while serving the musical compositions.
...
- Clean, articulate playing even at extreme speeds`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Nile - Annihilation of the Wicked', year: 2005, label: 'Relapse', note: 'First album with Nile' },
          { name: 'Nile - Ithyphallic', year: 2007, label: 'Nuclear Blast', note: 'Egyptian-themed brutality' },
          { name: 'Nile - Those Whom the Gods Detest', year: 2009, label: 'Nuclear Blast', note: 'Critical acclaim' },
          { name: 'Nile - At the Gate of Sethu', year: 2012, label: 'Nuclear Blast', note: 'Technical evolution' },
          { name: 'Nile - What Should Not Be Unearthed', year: 2015, label: 'Nuclear Blast', note: 'Return to brutality' },
          { name: 'Nile - Vile Nilotic Rites', year: 2019, label: 'Nuclear Blast', note: 'Most recent album' },
          { name: 'Solo - Invictus', year: 2020, label: 'Season of Mist', note: 'Solo instrumental album' }
        ],
        tours: [
          { name: 'Summer Slaughter', year: 'Multiple years', note: 'Premier US extreme metal festival tour' },
          { name: 'Educational Clinics', year: 'Ongoing', note: 'Worldwide drumming education' },
          { name: 'Nile World Tours', year: '2004-Present', note: 'Continuous touring with Nile' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- **Snare**: Pearl George Kollias Signature 14"x6.5"
...
- Signature snare: designed for cut and articulation in dense metal mixes`
  ...
  // Eloy Casagrande - Slipknot (formerly Sepultura)
  'eloy-casagrande': {
...
Starting drums at age 7 and joining Sepultura at just 19, Casagrande represented the new generation of metal drumming. His combination of traditional thrash metal power with modern technical elements has made him one of the most exciting and influential drummers in contemporary metal.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1998', event: 'Began playing drums at age 7 in São Paulo, Brazil' },
          { year: '2011', event: 'Joined Sepultura at age 19, replacing Jean Dolabella' },
          { year: '2013', event: 'Recorded first Sepultura album: "The Mediator Between Head and Hands Must Be the Heart"' },
          { year: '2017', event: 'Released "Machine Messiah" with Sepultura to critical acclaim' },
          { year: '2020', event: 'Released "Quadra" with Sepultura; gained international recognition' },
          { year: '2022', event: 'Performed at Rock in Rio with Sepultura' },
          { year: '2023', event: 'Sepultura announced farewell tour; Casagrande\'s future uncertain' },
          { year: '2024', event: 'Named #1 metal drummer in Modern Drummer Reader\'s Poll' },
          { year: '2024', event: 'Joined Slipknot as their new drummer, replacing Jay Weinberg' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Eloy Casagrande's drumming style blends traditional thrash metal power with modern technical precision. His playing combines the aggressive, groove-heavy style Sepultura is known for with his own technical flourishes and explosive energy.
...
- High-energy live performances with showmanship`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Sepultura - The Mediator...', year: 2013, label: 'Nuclear Blast', note: 'First studio album with band' },
          { name: 'Sepultura - Machine Messiah', year: 2017, label: 'Nuclear Blast', note: 'Critical acclaim' },
          { name: 'Sepultura - Quadra', year: 2020, label: 'Nuclear Blast', note: 'Concept album success' },
          { name: 'Slipknot - (TBA)', year: '2024+', label: 'Roadrunner', note: 'New chapter begins' }
        ],
        tours: [
          { name: 'Rock in Rio', year: '2022', note: 'Massive Brazilian festival performance' },
          { name: 'Sepultura Farewell Tour', year: '2023-2024', note: 'Final Sepultura touring cycle' },
          { name: 'Slipknot World Tours', year: '2024+', note: 'New era with Slipknot' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Eloy Casagrande is a Tama Drums and Paiste Cymbals endorser. His setup is designed for both the aggressive needs of thrash metal and the versatility required for Slipknot's diverse catalog.

**Current Setup:**
- **Drums**: Tama Starclassic Bubinga (dual bass drums: 22"x16" and 24"x14")
- **Snare**: Tama Bell Brass 14"x5.5" (BB146)
- **Cymbals**: Paiste (15" Masters Dark Hi-Hats, 602 and 2002 series crashes, Masters Dark Ride)
...
- Known for massive, visually impressive kit configurations`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What pedals does Eloy Casagrande use?', a: "Eloy Casagrande drives his dual-bass-drum setup with a Tama Iron Cobra double pedal." }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'Paiste', url: 'https://www.paiste.com/en/musicians' },
          { name: 'Modern Drummer Magazine', url: 'https://www.moderndrummer.com' },
          { name: 'Wikipedia: Eloy Casagrande', url: 'https://en.wikipedia.org/wiki/Eloy_Casagrande' }
        ]
      }
    }
  },
  ...
  'mike-portnoy': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Mike Portnoy (born April 20, 1967, in Long Beach, New York) is an American drummer, songwriter, and producer who co-founded progressive metal pioneers Dream Theater in 1985. He is one of the most decorated drummers in rock and metal history, having won over 30 awards from Modern Drummer magazine alone.
...
Portnoy's technical proficiency, creative compositions, and theatrical live performances helped define the progressive metal genre. After leaving Dream Theater in 2010, he continued with numerous projects including Avenged Sevenfold (briefly), The Winery Dogs, Flying Colors, Sons of Apollo, and Liquid Tension Experiment. In 2023, he rejoined Dream Theater for their reunion tour and new album.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1985', event: 'Co-founded Dream Theater (originally Majesty) at Berklee College of Music' },
          { year: '1989', event: 'Released Dream Theater debut "When Dream and Day Unite"' },
          { year: '1992', event: 'Released "Images and Words," breakthrough album with "Pull Me Under"' },
          { year: '1999', event: 'Released "Metropolis Pt. 2: Scenes from a Memory," a concept masterpiece' },
          { year: '2005', event: 'Performed the entire "Score" concert, a 3+ hour progressive metal epic' },
          { year: '2007', event: 'Inducted into Modern Drummer Hall of Fame' },
          { year: '2010', event: 'Left Dream Theater; briefly joined Avenged Sevenfold' },
          { year: '2012', event: 'Formed The Winery Dogs with Billy Sheehan and Richie Kotzen' },
          { year: '2017', event: 'Formed Sons of Apollo with Derek Sherinian' },
          { year: '2020', event: 'Reunited Liquid Tension Experiment for new album' },
          { year: '2023', event: 'Rejoined Dream Theater for reunion tour and new material' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
...
- Seamless integration of electronic elements`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Dream Theater - Images and Words', year: 1992, label: 'Atco', note: 'Breakthrough album' },
          { name: 'Dream Theater - Awake', year: 1994, label: 'East West', note: 'Darker, heavier evolution' },
          { name: 'Dream Theater - Metropolis Pt. 2', year: 1999, label: 'Elektra', note: 'Concept album masterpiece' },
          { name: 'Dream Theater - Six Degrees...', year: 2002, label: 'Elektra', note: 'Contains 42-minute epic' },
          { name: 'Dream Theater - Octavarium', year: 2005, label: 'Atlantic', note: '24-minute title track' },
          { name: 'Liquid Tension Experiment', year: 1998, label: 'Magna Carta', note: 'Instrumental supergroup' },
          { name: 'The Winery Dogs', year: 2013, label: 'Loud & Proud', note: 'Hard rock trio' },
          { name: 'Sons of Apollo - Psychotic Symphony', year: 2017, label: 'InsideOut', note: 'Progressive metal supergroup' }
        ],
        tours: [
          { name: 'Score 20th Anniversary Tour', year: 2006, note: '3+ hour performances nightly' },
          { name: 'Progressive Nation', year: '2008-2009', note: 'Curated progressive metal festival' },
          { name: 'Dream Theater Reunion Tour', year: '2023-2024', note: 'Triumphant return' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- Electronic pads integrated for samples`
      ...
      sources: {
        title: 'Sources',
        items: [
          { name: 'Modern Drummer Hall of Fame', url: 'https://www.moderndrummer.com' },
          { name: 'Tama Drums Artist Profile', url: 'https://www.tama.com' },
          { name: 'Sabian Artist Profile', url: 'https://www.sabian.com' },
          { name: 'Wikipedia: Mike Portnoy', url: 'https://en.wikipedia.org/wiki/Mike_Portnoy' }
        ]
      }
    }
  },
  ...
  'danny-carey': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Danny Carey (born May 10, 1961, in Lawrence, Kansas) is an American musician best known as the drummer for progressive metal band Tool since their formation in 1990. Widely regarded as one of the greatest rock drummers of all time, Carey is known for incorporating complex polyrhythms, unusual time signatures, and a jazz-influenced approach into heavy music.
...
Standing at 6'5" (196 cm), Carey is an imposing presence behind his massive Sonor drum kit. His drumming draws from diverse influences including jazz, world music, and his interest in sacred geometry and metaphysical concepts. Beyond Tool, he has collaborated with Pigface, Volto!, Zaum, and various other projects.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1990', event: 'Formed Tool in Los Angeles with Maynard James Keenan, Adam Jones, and Paul D\'Amour' },
          { year: '1993', event: 'Released debut album "Undertow," establishing Tool\'s unique sound' },
          { year: '1996', event: 'Released "Ænima," winning Grammy for "Ænima" (Best Metal Performance)' },
          { year: '2001', event: 'Released "Lateralus," considered a progressive metal masterpiece' },
          { year: '2002', event: 'Won Grammy for "Schism" (Best Metal Performance)' },
          { year: '2006', event: 'Released "10,000 Days," debuting at #1 on Billboard' },
          { year: '2007', event: 'Won Grammy for "Vicarious" (Best Recording Package)' },
          { year: '2016', event: 'Inducted into Modern Drummer Hall of Fame' },
          { year: '2019', event: 'Released "Fear Inoculum" after 13-year wait, debuting at #1' },
          { year: '2020', event: 'Won Grammy for "Fear Inoculum" (Best Metal Performance)' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Danny Carey's drumming is distinguished by complex polyrhythmic patterns, unusual time signatures, and a remarkably musical approach. He treats the drum kit as a melodic instrument, incorporating concepts from sacred geometry and metaphysics into his compositions.
...
- Mathematical concepts (Fibonacci sequence) in compositions`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Tool - Undertow', year: 1993, label: 'Zoo', note: 'Debut full-length' },
          { name: 'Tool - Ænima', year: 1996, label: 'Zoo', note: 'Grammy-winning breakthrough' },
          { name: 'Tool - Lateralus', year: 2001, label: 'Volcano', note: 'Progressive metal landmark' },
          { name: 'Tool - 10,000 Days', year: 2006, label: 'Volcano', note: '#1 debut' },
          { name: 'Tool - Fear Inoculum', year: 2019, label: 'RCA', note: '13 years in the making' },
          { name: 'Volto! - Incitare', year: 2013, label: 'Independent', note: 'Jazz fusion side project' }
        ],
        tours: [
          { name: 'Lateralus Tour', year: '2001-2002', note: 'Extended world touring' },
          { name: 'Fear Inoculum Tour', year: '2019-2022', note: 'Post-pandemic return' },
          { name: 'Tool 2023-2024 Tour', year: '2023-2024', note: 'Continued world touring' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Danny Carey has been a Sonor endorser for decades, using their SQ2 series drums in custom configurations. His setup includes Mandala electronic pads, which he uses for melodic and textural elements unique to Tool's sound.

**Current Setup:**
- **Drums**: Sonor SQ2 Heavy Beech (massive configuration with multiple toms)
- **Snare**: Sonor Danny Carey Signature 14"x8" Bronze
- **Cymbals**: Paiste Signature series (Sound Edge Hi-Hats, Power crashes, Dry Heavy Ride, chinas)
- **Hardware**: Sonor Giant Step Twin Effect Double Pedal
- **Electronics**: Mandala Drum electronic pads
- **Sticks**: Vic Firth Danny Carey Signature
- **Heads**: Remo (various)

**Unique Setup Elements:**
- Custom Sonor Danny Carey signature bronze snare
- Integration of Mandala pads for electronic textures
- Giant Step double pedal (non-traditional design)
- Massive kit size requiring extensive support hardware`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drum kit did Danny Carey use?', a: 'Danny Carey\'s drum kit is a massive Sonor SQ2 Heavy Beech configuration with multiple toms, built around his signature Sonor Danny Carey 14"x8" bronze snare drum. The kit is fitted with Paiste Signature cymbals — Sound Edge hi-hats, Power crashes, a Dry Heavy Ride, and chinas — plus Mandala electronic pads and a Sonor Giant Step Twin Effect double pedal.' },
          { q: 'What drum set did Danny Carey use?', a: 'Danny Carey\'s drum set is a massive Sonor SQ2 Heavy Beech configuration with multiple toms, built around his signature Sonor Danny Carey 14"x8" bronze snare drum. The drum set is fitted with Paiste Signature cymbals — Sound Edge hi-hats, Power crashes, a Dry Heavy Ride, and chinas — plus Mandala electronic pads and a Sonor Giant Step Twin Effect double pedal.' },
          { q: 'What drum set does Danny Carey use?', a: 'Danny Carey\'s drum set is Sonor SQ2 Heavy Beech, anchored by his signature Sonor Danny Carey 14"x8" bronze snare drum. Paiste Signature series cymbals — Sound Edge hi-hats, Power crashes, a Dry Heavy Ride, and chinas — complete the drum set, along with Mandala Drum electronic pads for melodic textures and a Sonor Giant Step Twin Effect double pedal.' },
          { q: 'What cymbals does Danny Carey use?', a: 'Danny Carey uses Paiste Signature series cymbals, including Sound Edge hi-hats, Power crash cymbals, a Dry Heavy Ride, and several china cymbals, chosen for their range of tones across Tool\'s complex polyrhythmic arrangements.' },
          { q: 'What snare drum does Danny Carey use?', a: 'Danny Carey plays his signature Sonor Danny Carey snare drum, a 14"x8" bronze shell built to project through Tool\'s dense, polyrhythmic mix, and hits it with Vic Firth Danny Carey Signature sticks.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          { name: 'Sonor Drums Artist Profile', url: 'https://www.sonor.com' },
          { name: 'Paiste Artist Profile', url: 'https://www.paiste.com' },
          { name: 'Modern Drummer Hall of Fame', url: 'https://www.moderndrummer.com' },
...
Mario's drumming combines crushing power with technical precision, featuring complex double bass patterns and an almost tribal quality that defines Gojira's unique sound. Beyond his drumming, he is a talented visual artist who creates artwork for Gojira's albums, merchandise, and stage productions.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1996', event: 'Formed Godzilla (later Gojira) with brother Joe in Bayonne, France' },
          { year: '2001', event: 'Released debut album "Terra Incognita" (as Gojira)' },
          { year: '2005', event: 'Released "From Mars to Sirius," international breakthrough' },
          { year: '2008', event: 'Released "The Way of All Flesh," critical acclaim worldwide' },
          { year: '2012', event: 'Released "L\'Enfant Sauvage," Gojira\'s first Grammy nomination' },
          { year: '2016', event: 'Released "Magma," reaching #1 on Billboard Hard Rock chart' },
          { year: '2021', event: 'Released "Fortitude," achieving mainstream success' },
          { year: '2022', event: 'Won "Best Metal Performance" Grammy nomination for "Amazonia"' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Mario Duplantier's drumming style is characterized by incredible power, tribal rhythmic elements, and seamless integration with Gojira's intricate guitar work. His playing emphasizes dynamics and groove within an extreme metal framework.
...
- "Wall of sound" approach with precise articulation`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Gojira - Terra Incognita', year: 2001, label: 'Boycott', note: 'Debut album' },
          { name: 'Gojira - The Link', year: 2003, label: 'Listenable', note: 'Sound evolution' },
          { name: 'Gojira - From Mars to Sirius', year: 2005, label: 'Listenable', note: 'International breakthrough' },
          { name: 'Gojira - The Way of All Flesh', year: 2008, label: 'Prosthetic', note: 'Critical acclaim' },
          { name: 'Gojira - L\'Enfant Sauvage', year: 2012, label: 'Roadrunner', note: 'First Grammy nod' },
          { name: 'Gojira - Magma', year: 2016, label: 'Roadrunner', note: 'Mainstream breakthrough' },
          { name: 'Gojira - Fortitude', year: 2021, label: 'Roadrunner', note: 'Environmental themes' }
        ],
        tours: [
          { name: 'Metallica Support Tours', year: '2017, 2023', note: 'Opening for Metallica worldwide' },
          { name: 'Download Festival Headline', year: '2022', note: 'Main stage headliner' },
          { name: 'Fortitude World Tour', year: '2021-2022', note: 'Post-pandemic touring' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- **Snare**: Tama S.L.P. 14"x6.5" G-Maple
- **Cymbals**: Zildjian (14" K Sweet Hi-Hats, various K Custom and A Custom crashes, 21" Z Custom Mega Bell Ride)
- **Hardware**: Tama Iron Cobra 900 Power Glide Double Pedal
- **Throne**: Tama 1st Chair Ergo-Rider
...
**Visual Artist Work:**
- Creates all Gojira album artwork and merchandise designs
- Designs stage visuals and projections
- His art features organic, spiritual, and environmental themes`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
...
Beyond Opeth, Axenrot has been a core member of death metal supergroup Bloodbath since 2008, performing alongside members of Opeth, Katatonia, and Paradise Lost. His dual role in a technically demanding progressive band and an unapologetically brutal death metal outfit reflects the versatility that has made him one of the most respected extreme metal drummers of his generation. Axenrot made his Opeth studio debut on Watershed (2008) and has recorded every studio album since, anchoring the band's evolution from progressive death metal into the more retro-progressive-rock-influenced territory of Heritage (2011) and beyond.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1997', event: 'Joined Swedish death metal band Witchery, beginning his professional drumming career' },
          { year: '2006', event: 'Replaced Martin Lopez as Opeth\'s drummer mid-tour on the Ghost Reveries cycle' },
          { year: '2008', event: 'Joined death metal supergroup Bloodbath and made his Opeth studio debut on Watershed' },
          { year: '2010', event: 'Left Witchery after 13 years to focus fully on Opeth and Bloodbath' },
          { year: '2011', event: 'Released Heritage with Opeth, a dramatic stylistic pivot toward 1970s progressive rock' },
          { year: '2014', event: 'Released Pale Communion with Opeth' },
          { year: '2016', event: 'Released Sorceress with Opeth' },
          { year: '2019', event: 'Released In Cauda Venenum, recorded in both Swedish and English versions' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
...
- Dynamic control across Opeth's shifting acoustic and heavy sections`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Opeth - Watershed', year: 2008, label: 'Roadrunner', note: 'Axenrot\'s Opeth studio debut' },
          { name: 'Opeth - Heritage', year: 2011, label: 'Roadrunner', note: 'Progressive rock pivot' },
          { name: 'Opeth - Pale Communion', year: 2014, label: 'Nuclear Blast', note: 'Continued progressive direction' },
          { name: 'Opeth - Sorceress', year: 2016, label: 'Nuclear Blast', note: 'Blends heavy and progressive elements' },
          { name: 'Opeth - In Cauda Venenum', year: 2019, label: 'Nuclear Blast', note: 'Swedish and English versions' },
          { name: 'Bloodbath - The Fathomless Mastery', year: 2008, label: 'Peaceville', note: 'Axenrot\'s debut with Bloodbath' }
        ],
        tours: [
          { name: 'Opeth World Tours', year: '2006-Present', note: 'Extensive global touring since joining' },
          { name: 'Bloodbath Festival Circuit', year: '2008-Present', note: 'Death metal festival appearances' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- Focus on sound quality over visual complexity`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What hi-hats does Shannon Larkin use?', a: 'Shannon Larkin plays 14" Sabian AAX Stage Hi-Hats, chosen for a bright, cutting chick sound that drives Godsmack\'s groove-oriented hard rock arrangements.' },
...
- Open-handed playing despite right-handed kit setup`
  ...
  // Paul Mazurkiewicz - Cannibal Corpse (Batch 10)
  'paul-mazurkiewicz': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Paul Mazurkiewicz (born September 8, 1968, in Buffalo, New York) is an American drummer and co-founder of legendary death metal band Cannibal Corpse, formed in 1988. As one of the most consistent and dedicated drummers in extreme metal, Mazurkiewicz has performed on every Cannibal Corpse album since their 1990 debut "Eaten Back to Life."
...
His drumming style combines relentless blast beats, complex double bass patterns, and groove-oriented sections that have helped define the death metal sound. With Cannibal Corpse being the best-selling death metal band of all time (over 2 million albums sold worldwide), Mazurkiewicz's contribution to the genre is immeasurable. His 35+ years of consistent touring and recording make him one of the most enduring figures in extreme metal history.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1988', event: 'Co-founded Cannibal Corpse in Buffalo, New York with Chris Barnes, Bob Rusay, Jack Owen, and Alex Webster' },
          { year: '1990', event: 'Released debut album "Eaten Back to Life," establishing Cannibal Corpse\'s brutal sound' },
          { year: '1992', event: 'Released "Tomb of the Mutilated," featuring the iconic "Hammer Smashed Face"' },
          { year: '1994', event: 'Appeared in the film "Ace Ventura: Pet Detective," performing "Hammer Smashed Face"' },
          { year: '1995', event: 'George "Corpsegrinder" Fisher joined as vocalist; new era began' },
          { year: '1996', event: 'Released "Vile," first album with Corpsegrinder and Rob Barrett' },
          { year: '2006', event: 'Released "Kill," considered one of their most technically proficient albums' },
          { year: '2012', event: 'Released "Torture," showcasing evolved drumming complexity' },
          { year: '2017', event: 'Released "Red Before Black," their 14th studio album' },
          { year: '2021', event: 'Released "Violence Unimagined," demonstrating continued relevance after 30+ years' },
          { year: '2023', event: 'Continues touring extensively; Cannibal Corpse remains death metal\'s best-selling act' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Paul Mazurkiewicz's drumming style is the foundation of Cannibal Corpse's brutal sound. His approach combines old-school death metal intensity with evolving technical proficiency, maintaining consistency across three decades of extreme metal.

**Key Influences:**
- **Dave Lombardo (Slayer)**: Thrash metal intensity and double bass foundation
- **Pete Sandoval (Morbid Angel)**: Death metal blast beat technique
- **Gene Hoglan (Dark Angel/Death)**: Technical precision in extreme metal
- **Neil Peart (Rush)**: Progressive elements and composition

**Signature Techniques:**
- **Relentless blast beats**: Sustained high-speed patterns that define Cannibal Corpse's intensity
- **Groove-oriented sections**: Contrast brutal blasts with headbang-worthy mid-tempo grooves
- **Complex double bass patterns**: Intricate kick drum work underlying the wall of sound
- **Endurance drumming**: Maintaining intensity through 90-minute performances nightly
- **Song service**: Patterns designed to enhance rather than overshadow the riffs`
      },
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Eaten Back to Life', year: 1990, label: 'Metal Blade', note: 'Debut album establishing brutal death metal template' },
          { name: 'Butchered at Birth', year: 1991, label: 'Metal Blade', note: 'Controversial artwork; refined sound' },
          { name: 'Tomb of the Mutilated', year: 1992, label: 'Metal Blade', note: 'Contains "Hammer Smashed Face"' },
          { name: 'The Bleeding', year: 1994, label: 'Metal Blade', note: 'Last album with Chris Barnes' },
          { name: 'Vile', year: 1996, label: 'Metal Blade', note: 'First album with Corpsegrinder' },
          { name: 'Gallery of Suicide', year: 1998, label: 'Metal Blade', note: 'Expanded musical complexity' },
          { name: 'Bloodthirst', year: 1999, label: 'Metal Blade', note: 'Erik Rutan production debut' },
          { name: 'Gore Obsessed', year: 2002, label: 'Metal Blade', note: 'Continued evolution' },
          { name: 'The Wretched Spawn', year: 2004, label: 'Metal Blade', note: 'Technical peak of classic era' },
          { name: 'Kill', year: 2006, label: 'Metal Blade', note: 'Modern Cannibal Corpse defined' },
          { name: 'Torture', year: 2012, label: 'Metal Blade', note: 'Grammy-nominated' },
          { name: 'Violence Unimagined', year: 2021, label: 'Metal Blade', note: 'Erik Rutan joins as guitarist' }
        ],
        tours: [
          { name: 'Global Evisceration Tour', year: '2012', note: 'Worldwide touring for Torture' },
          { name: 'Summer Slaughter', year: 'Multiple years', note: 'Premier North American extreme metal festival' },
          { name: '30th Anniversary Tour', year: '2018', note: 'Celebrating three decades of brutality' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- Consistent setup across all venues for muscle memory
- Relatively standard kit size for death metal efficiency
- Emphasis on reliability over complexity`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
          'Has appeared on every Cannibal Corpse album since 1990—the only member besides Alex Webster with this distinction',
          'The "Ace Ventura: Pet Detective" appearance (1994) introduced millions to death metal',
          'Cannibal Corpse\'s music was banned in several countries including Germany and Australia',
          'Despite the band\'s controversial imagery, Mazurkiewicz is known for his friendly, down-to-earth personality',
          'The band has performed over 3,000 shows across 40+ countries',
          'Original lyricist for some of Cannibal Corpse\'s most controversial songs',
  ...
  // Mike Mangini - Dream Theater (Batch 10)
  'mike-mangini': {
    slug: 'mike-mangini',
    drummerId: 52,
    name: 'Mike Mangini',
    bands: [
      ...
      { slug: 'extreme', period: '1999-2008, 2014-present', role: 'Drummer' },
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Mike Mangini (born April 18, 1963, in Newton, Massachusetts) is an American drummer who joined progressive metal legends Dream Theater in 2010, succeeding founding member Mike Portnoy. A former professor at Berklee College of Music, Mangini holds multiple world records for drumming speed and is widely regarded as one of the most technically proficient drummers alive.
...
Before Dream Theater, Mangini built an impressive resume with Steve Vai, Extreme, Annihilator, and James LaBrie's solo projects. His academic approach to drumming—combining mathematics, physics, and biomechanics—has revolutionized how drummers approach technique and education. Mangini's ability to navigate Dream Theater's complex compositions while adding his own innovations has cemented his place among progressive metal's elite.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1963', event: 'Born April 18 in Newton, Massachusetts' },
          { year: '1986', event: 'Set first world record for single-stroke roll speed' },
          { year: '1996', event: 'Joined Steve Vai\'s band for the "Fire Garden" tour' },
          { year: '1999', event: 'Recorded with Annihilator on "Criteria for a Black Widow"' },
          { year: '2002', event: 'Joined Extreme for reunion; began teaching at Berklee College of Music' },
          { year: '2005', event: 'Set Guinness World Record: 1,203 single strokes in 60 seconds' },
          { year: '2010', event: 'Won Dream Theater drummer audition; announced as new drummer October 2010' },
          ...
          { year: '2016', event: 'Released "The Astonishing," ambitious rock opera double album' },
          { year: '2019', event: 'Released "Distance Over Time," critically acclaimed return to roots' },
          { year: '2021', event: 'Released "A View from the Top of the World"' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Mike Mangini's drumming represents the intersection of academic study and practical application. His scientific approach to technique—analyzing angles, physics, and biomechanics—has produced a style that is both mechanically efficient and musically expressive.
...
- **"Rhythm Knowledge" system**: His educational framework for understanding time`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Steve Vai - Fire Garden', year: 1996, label: 'Epic', note: 'First major touring gig' },
          { name: 'Annihilator - Criteria for a Black Widow', year: 1999, label: 'CMC', note: 'Thrash metal precision' },
          { name: 'Extreme - Saudades de Rock', year: 2008, label: 'Open E', note: 'Reunion album' },
          { name: 'Dream Theater - A Dramatic Turn of Events', year: 2011, label: 'Roadrunner', note: 'DT debut; Grammy nominated' },
          { name: 'Dream Theater - Dream Theater', year: 2013, label: 'Roadrunner', note: 'Self-titled statement' },
          { name: 'Dream Theater - The Astonishing', year: 2016, label: 'Roadrunner', note: 'Ambitious rock opera' },
          { name: 'Dream Theater - Distance Over Time', year: 2019, label: 'InsideOut', note: 'Return to progressive roots' },
          { name: 'Dream Theater - A View from the Top of the World', year: 2021, label: 'InsideOut', note: 'Pandemic-era creation' }
        ],
        tours: [
          { name: 'A Dramatic Turn of Events World Tour', year: '2011-2012', note: 'First Dream Theater touring cycle' },
          { name: 'Along for the Ride Tour', year: '2014', note: 'Self-titled album support' },
          { name: 'Distance Over Time Tour', year: '2019-2020', note: 'Before pandemic shutdown' },
          { name: 'Top of the World Tour', year: '2022', note: 'Post-pandemic return' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- Custom positioning based on scientific analysis of motion`
  ...
  // Matt Garstka - Animals as Leaders (Batch 10)
  'matt-garstka': {
    slug: 'matt-garstka',
    drummerId: 53,
    name: 'Matt Garstka',
...
Garstka joined Animals as Leaders after the departure of original drummer Navene Koperweis, bringing a jazz-educated sensibility to the band's technical instrumental music. His approach—combining traditional grip, linear independence, and a deep understanding of metric modulation—has made him one of the most influential drummers of his generation. Beyond Animals as Leaders, Garstka is an in-demand educator and session musician.`
      ...
      careerHighlights: {
        ...
        items: [
          ...
          { year: '2017', event: 'Featured on Modern Drummer magazine cover' },
          { year: '2018', event: 'Began extensive educational content creation and clinic touring' },
          { year: '2019', event: 'Named one of the most influential drummers of the decade by multiple publications' },
          { year: '2022', event: 'Released "Parrhesia" with Animals as Leaders' },
          { year: '2023', event: 'Continues international touring and education' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Matt Garstka's drumming represents a new paradigm in progressive metal—combining jazz sophistication with heavy music intensity. His approach emphasizes feel and groove within complex frameworks, making intricate patterns accessible and musical.
...
- **Dynamic contrast**: Extreme range from whisper-quiet to powerful accents`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Animals as Leaders - The Joy of Motion', year: 2014, label: 'Sumerian', note: 'First album with band; breakthrough' },
          { name: 'Animals as Leaders - The Madness of Many', year: 2016, label: 'Sumerian', note: 'Showcased evolved technical approach' },
          { name: 'Animals as Leaders - Parrhesia', year: 2022, label: 'Sumerian', note: 'Most recent, continued evolution' }
        ],
        tours: [
          { name: 'The Joy of Motion World Tour', year: '2014-2015', note: 'First touring cycle with AAL' },
          { name: 'The Madness of Many Tour', year: '2016-2017', note: 'Extensive global touring' },
          { name: 'Clinic Tours', year: 'Ongoing', note: 'Educational presentations worldwide' },
          { name: 'Parrhesia World Tour', year: '2022-2023', note: 'Post-pandemic return' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- Meinl Byzance cymbals for dark, complex overtones
- Traditional grip influences positioning and angles
- Minimal setup compared to many progressive drummers
- Focus on quality of sound over quantity of drums`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
  ...
  // Daniel Erlandsson - Arch Enemy (Batch 10)
  'daniel-erlandsson': {
    ...
    bands: [
      ...
      { slug: 'eucharist', period: '1989-1997', role: 'Drummer' },
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Daniel Erlandsson (born May 22, 1976, in Malmö, Sweden) is a Swedish drummer and founding member of melodic death metal band Arch Enemy, formed in 1995 by his brother Michael Erlandsson (later replaced by Christopher Amott) and guitarist Michael Amott. His drumming combines Scandinavian death metal intensity with technical precision and musicality, helping define the melodic death metal genre.
...
Before Arch Enemy, Erlandsson played with Eucharist, one of the pioneers of the Gothenburg melodic death metal sound. His career spans over three decades, during which he has performed on every Arch Enemy album and established himself as one of the most consistent drummers in extreme metal. His ability to blend blast beats with groove and dynamics has made Arch Enemy accessible while maintaining their metal credibility.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1989', event: 'Joined Eucharist, pioneering Gothenburg melodic death metal' },
          { year: '1995', event: 'Helped found Arch Enemy with brother Michael and guitarist Michael Amott' },
          { year: '1996', event: 'Released Arch Enemy debut "Black Earth"' },
          { year: '1998', event: 'Released "Stigmata," establishing Arch Enemy\'s signature sound' },
          { year: '2001', event: 'Angela Gossow joined as vocalist; band gained international attention' },
          { year: '2003', event: 'Released "Anthems of Rebellion," commercial breakthrough' },
          { year: '2005', event: 'Released "Doomsday Machine," continued success' },
          { year: '2007', event: 'Toured with Carcass as live drummer' },
          { year: '2014', event: 'Alissa White-Gluz joined as vocalist; new era began' },
          { year: '2017', event: 'Released "Will to Power," commercial peak' },
          { year: '2022', event: 'Released "Deceivers," continuing Arch Enemy\'s evolution' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Daniel Erlandsson's drumming embodies the Swedish melodic death metal approach—combining extreme metal intensity with musical sensibility and technical precision. His style has evolved from raw aggression to refined power over three decades.
...
- **Compositional drumming**: Parts that enhance the song structure`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Eucharist - A Velvet Creation', year: 1993, label: 'Wrong Again', note: 'Early melodic death metal' },
          { name: 'Arch Enemy - Black Earth', year: 1996, label: 'Wrong Again', note: 'Debut album' },
          { name: 'Arch Enemy - Stigmata', year: 1998, label: 'Century Media', note: 'Sound established' },
          { name: 'Arch Enemy - Wages of Sin', year: 2001, label: 'Century Media', note: 'First with Angela Gossow' },
          { name: 'Arch Enemy - Anthems of Rebellion', year: 2003, label: 'Century Media', note: 'Commercial breakthrough' },
          { name: 'Arch Enemy - Doomsday Machine', year: 2005, label: 'Century Media', note: 'Continued success' },
          { name: 'Arch Enemy - Rise of the Tyrant', year: 2007, label: 'Century Media', note: 'Critical acclaim' },
          { name: 'Arch Enemy - War Eternal', year: 2014, label: 'Century Media', note: 'First with Alissa White-Gluz' },
          { name: 'Arch Enemy - Will to Power', year: 2017, label: 'Century Media', note: 'Commercial peak' },
          { name: 'Arch Enemy - Deceivers', year: 2022, label: 'Century Media', note: 'Most recent' }
        ],
        tours: [
          { name: 'Ozzfest', year: '2005', note: 'Major US festival exposure' },
          { name: 'War Eternal World Tour', year: '2014-2015', note: 'New vocalist introduction' },
          { name: 'Will to Power World Tour', year: '2017-2018', note: 'Extensive global touring' },
          { name: 'Deceivers World Tour', year: '2022-2023', note: 'Post-pandemic return' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Daniel Erlandsson is a Pearl Drums artist, using their high-end series for both studio and live work. His setup is designed for the combination of power and precision required by Arch Enemy's music.
...
- Consistent setup across all performances
- Reliability for extensive touring
- Signature snare drum developed with Pearl
- Classic rock-solid metal configuration`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What hi-hats does Daniel Erlandsson use?', a: 'Daniel Erlandsson plays 14" Paiste RUDE Hi-Hats, delivering the aggressive, cutting chick sound that drives Arch Enemy\'s melodic death metal rhythms.' },
      ...
      sources: {
        ...
        items: [
          ...
          { name: 'Century Media Records', url: 'https://www.centurymedia.com' },
  ...
  // Jaska Raatikainen - Children of Bodom (Batch 10)
  'jaska-raatikainen': {
    slug: 'jaska-raatikainen',
    drummerId: 55,
    name: 'Jaska Raatikainen',
    bands: [
      { slug: 'children-of-bodom', period: '1993-2019', role: 'Drummer, co-founder' },
...
Children of Bodom became one of Finland's most successful metal exports, selling over 2 million albums worldwide. Raatikainen's drumming combined blast beats, complex double bass patterns, and progressive elements that complemented Laiho's virtuosic guitar work. The band announced their dissolution in 2019 after 26 years together. Following Alexi Laiho's tragic death in December 2020, Children of Bodom's legacy became permanently sealed in metal history.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1993', event: 'Co-founded Inearthed (later Children of Bodom) with Alexi Laiho in Espoo, Finland' },
          { year: '1997', event: 'Band renamed to Children of Bodom; released debut "Something Wild"' },
          { year: '1999', event: 'Released "Hatebreeder," establishing international recognition' },
          { year: '2000', event: 'Released "Follow the Reaper," breakthrough album' },
          { year: '2003', event: 'Released "Hate Crew Deathroll," commercial peak' },
          { year: '2005', event: 'Released "Are You Dead Yet?," mainstream success' },
          { year: '2008', event: 'Released "Blooddrunk," continued evolution' },
          { year: '2013', event: 'Released "Halo of Blood," return to melodic roots' },
          { year: '2015', event: 'Released "I Worship Chaos," continued evolution' },
          { year: '2019', event: 'Released "Hexed," final Children of Bodom album; band dissolution announced' },
          { year: '2020', event: 'December 29: Alexi Laiho passes away; Children of Bodom legacy sealed' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Jaska Raatikainen's drumming style perfectly complemented Children of Bodom's unique blend of neoclassical melodic death metal. His playing featured intricate double bass patterns, precise blast beats, and a musical sensibility that supported Alexi Laiho's guitar virtuosity.
...
- **Consistent live performance**: Reliability across extensive touring`
      ...
      notableRecordings: {
        ...
        albums: [
          ...
          { name: 'Hatebreeder', year: 1999, label: 'Spinefarm', note: 'International breakthrough' },
          { name: 'Follow the Reaper', year: 2000, label: 'Spinefarm', note: 'Defining album' },
          { name: 'Hate Crew Deathroll', year: 2003, label: 'Spinefarm', note: 'Commercial peak' },
          { name: 'Are You Dead Yet?', year: 2005, label: 'Spinefarm', note: 'Mainstream success' },
          { name: 'Blooddrunk', year: 2008, label: 'Spinefarm', note: 'Continued evolution' },
          { name: 'Relentless Reckless Forever', year: 2011, label: 'Spinefarm', note: 'Heavy direction' },
          { name: 'Halo of Blood', year: 2013, label: 'Nuclear Blast', note: 'Return to melodic roots' },
          { name: 'I Worship Chaos', year: 2015, label: 'Nuclear Blast', note: 'Modern era' },
          { name: 'Hexed', year: 2019, label: 'Nuclear Blast', note: 'Final album' }
        ],
        tours: [
          { name: 'Ozzfest', year: '2006', note: 'Major US exposure' },
          { name: 'Mayhem Festival', year: '2009', note: 'US summer touring' },
          { name: 'A Chapter Called Children of Bodom Tour', year: '2019', note: 'Final tour; Finland only' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Jaska Raatikainen was a Pearl Drums endorser for much of Children of Bodom's career. His setup was built for the demanding requirements of the band's complex, high-energy material.

**Setup (Final Children of Bodom Era):**
- **Drums**: Pearl Masters Premium Maple (custom finish)
- **Snare**: Pearl Masters 14"x6.5"
- **Cymbals**: Meinl Mb20 series (14" Hi-Hats, crashes, 22" Heavy Bell Ride)
- **Hardware**: Pearl Eliminator double pedal
- **Sticks**: Vic Firth 5B
- **Heads**: Remo Emperor/Ambassador

**Setup Philosophy:**
- Built for endurance during long, technically demanding sets
- Maple shells for warmth and projection
- Consistent configuration for muscle memory
- Reliable hardware for extensive touring`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What hi-hats did Jaska Raatikainen use?', a: 'Jaska Raatikainen played 14" Zildjian A Custom Hi-Hats, delivering the bright, cutting chick sound that anchored Children of Bodom\'s neoclassical melodic death metal rhythms.' },
...
- Demon Drive pedals for speed and control`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What hi-hats does Scott Travis use?', a: 'Scott Travis plays 14" Paiste RUDE hi-hats, delivering the aggressive, cutting chick sound needed to punch through Judas Priest\'s dual-guitar attack.' },
...
- Known for vintage pedal preference until Tama discontinued them`
  ...
  'brann-dailor': {
    ...
    bands: [
      ...
      { slug: 'lethargy', period: '1992-1999', role: 'Drummer' }
    ],
...
Dailor's drumming is characterized by constant motion—intricate fills that weave around the riffs rather than simply keeping time. His "lead drums" approach treats the drums as a melodic instrument, and his increasingly prominent vocal contributions have added another dimension to Mastodon's sound. He co-founded Mastodon in 2000 with guitarist Bill Kelliher, his longtime collaborator from their days in Lethargy and Today Is the Day.`
      ...
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1992', event: 'Founded avant-garde metal band Lethargy in Rochester, NY; Bill Kelliher joined on guitar in 1994' },
...
- Angled toms for fluid motion between drums`
  ...
  'chris-adler': {
    ...
    bands: [
      ...
      { slug: 'firstborne', period: '2020-present', role: 'Drummer' }
    ],
...
Adler's drumming is characterized by powerful groove-based patterns, creative use of dynamics, and signature techniques like his "pivot" hi-hat foot work. In 2015, he briefly joined Megadeth to record "Dystopia," which won a Grammy for Best Metal Performance. He departed Lamb of God in 2019, and has since focused on new projects and drum education.`
      ...
      careerHighlights: {
        ...
        items: [
          ...
          { year: '2017', event: 'Won Grammy for Best Metal Performance for "Dystopia"' },
          { year: '2019', event: 'Departed Lamb of God after 25 years' },
          { year: '2020', event: 'Launched new band Firstborne with Girish Pradhan' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
...
- Emphasis on quick, responsive gear for groove playing`
  ...
  'matt-halpern': {
    ...
    sections: {
      overview: {
        title: 'Overview',
        content: `Matt Halpern (born June 21, 1983, in Baltimore, Maryland) is an American drummer best known as the drummer for progressive metal band Periphery. As one of the architects of the "djent" movement, Halpern has become one of the most influential drummers in modern metal, known for his precise, groove-focused playing and dynamic approach.
...
- Extensive use of triggering for modern production`
  ...
  'inferno': {
    ...
    bands: [
      ...
      { slug: 'azarath', period: '1998-present', role: 'Drummer' }
    ],
...
- Minimalist, efficient kit layout for rapid movement`
  ...
  'hellhammer': {
    ...
    bands: [
      ...
      { slug: 'dimmu-borgir', period: '2005-2010', role: 'Session/studio drummer' },
...
Hellhammer joined Mayhem in 1988, becoming their most enduring member and the rhythmic foundation of the band through its most turbulent years. His drumming combines raw black metal aggression with surprising technical sophistication, and his influence on the genre cannot be overstated. He has recorded with over 40 different bands and artists.`
      ...
      careerHighlights: {
        ...
        items: [
          ...
          { year: '2005', event: 'Began session/studio work with Dimmu Borgir' },
...
- Ability to navigate between raw and technical playing`
      ...
      notableRecordings: {
        ...
        albums: [
          ...
          { name: 'Dimmu Borgir - Stormblåst MMV', year: 2005, label: 'Nuclear Blast', note: 'Session drums' },
...
- Setup designed for both studio precision and live durability`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What hi-hats does Hellhammer use?', a: 'Hellhammer plays 14" Paiste RUDE Hi-Hats, chosen for the harsh, cutting articulation that powers Mayhem\'s extreme-tempo black metal rhythms.' },
...
- Emphasis on live performance reliability and consistency`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drum set does Isaac Lamb use?', a: 'Isaac Lamb\'s drum set is a boutique SJC Custom Drums kit in American maple — a 22" bass drum, 10"/12" rack toms, and 14"/16" floor toms — paired with an SJC Custom 14"x6.5" maple snare. The tight bearing edges give his kick-snare relationship the focused attack that cuts through Kublai Khan TX\'s heavily downtuned 7-string guitars.' },
          { q: 'What drum kit does Isaac Lamb use?', a: 'Isaac Lamb\'s drum kit centers on SJC Custom Drums American maple shells, an SJC Custom 14"x6.5" maple snare, and a complete Meinl Classics Custom Dark cymbal setup, driven by a DW 9000 Series double pedal — the setup he established for Nomad (2017) and carried through Absolute (2019) and Lowest Form of Animal (2022).' },
          { q: 'What cymbals does Isaac Lamb use?', a: 'Isaac Lamb uses a complete Meinl Classics Custom Dark Series setup: 14" Dark hi-hats, 18"/20" Dark crashes, a 21" Dark ride, and an 18" Dark China, chosen for their controlled decay so cymbal wash doesn\'t ring into Kublai Khan TX\'s breakdowns.' },
          { q: 'What snare drum does Isaac Lamb use?', a: 'Isaac Lamb plays an SJC Custom 14"x6.5" American maple snare drum, its 6.5" depth chosen for the body and backbeat authority that locks with the kick in his groove-first approach.' },
          { q: 'What pedals does Isaac Lamb use?', a: 'Isaac Lamb drives his kick patterns with a DW 9000 Series double pedal, whose floating rotor and adjustable cam give him the versatility to move between mid-tempo grooves, blast beats, and weighted breakdown strokes.' }
        ]
      },
      sources: {
        title: 'Sources',
...
- His Vic Firth stick relationship matured into an official At the Gates-branded signature model`
  ...
  'jimmy-degrasso': {
    ...
    metaDescription: 'Complete biography of Jimmy DeGrasso, Megadeth\'s 1998-2002 drummer on Risk and The World Needs a Hero. Explore his Pearl JD1455 signature snare, Sabian cymbals, and career across Y&T, Suicidal Tendencies, and Alice Cooper.',
    ogImage: '/images/drummers/jimmy-degrasso.webp',
    keywords: ['thrash metal', 'megadeth', 'pearl drums', 'sabian cymbals', 'jimmy degrasso drum kit', 'y&t', 'suicidal tendencies', 'alice cooper'],
    relatedDrummers: ['nick-menza', 'shawn-drover', 'dirk-verbeuren'],
    summary: 'Jimmy DeGrasso drummed for Megadeth from 1998-2002 (Risk, The World Needs a Hero, Rude Awakening) and built a four-decade career across Y&T, Suicidal Tendencies, and Alice Cooper.',
    lastUpdated: '2026-07-24',
    imageAlt: 'Jimmy DeGrasso performing live behind his Pearl drum kit',
    schemaType: 'Person',
    sections: {
      overview: {
        title: 'Overview',
        content: `Jimmy DeGrasso (born March 16, 1963, in Bethlehem, Pennsylvania) is an American drummer best known for his 1998-2002 tenure behind the drum kit for Megadeth, where he recorded Risk (1999), The World Needs a Hero (2001), and the band's first live release, Rude Awakening (2002). He relocated to Los Angeles in the 1980s and worked his way into the city's hard rock and metal touring circuit, including pre-production demos for Ozzy Osbourne's The Ultimate Sin — though Randy Castillo took over the drum stool before recording began.

DeGrasso's career has been defined by versatility: he drummed for Y&T (1987-1991, 1995-1997), Suicidal Tendencies (1992-1995), and Alice Cooper across two separate stints (1994-1998, 2008-2010), building a reputation as a reliable, road-tested hired gun capable of anchoring bands across hard rock, thrash, and crossover metal. His steady, groove-driven drum set work arrived at a pivotal, often-debated moment in Megadeth's catalog, and he went on to drum for Dokken, Black Star Riders, and Ratt, extending a touring career spanning four decades of hard rock and metal.`
      },
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1987', event: 'Joined Y&T for a first stint through 1991' },
          { year: '1992', event: 'Joined Suicidal Tendencies (1992-1995)' },
          { year: '1994', event: 'Joined Alice Cooper\'s band for the first of two stints' },
          { year: '1995', event: 'Rejoined Y&T for a second stint through 1997' },
          { year: '1998', event: 'Joined Megadeth' },
          { year: '1999', event: 'Recorded Risk with Megadeth' },
          { year: '2001', event: 'Recorded The World Needs a Hero with Megadeth' },
          { year: '2002', event: 'Recorded Rude Awakening, Megadeth\'s first live album, before departing the band' },
          { year: '2008', event: 'Rejoined Alice Cooper\'s band for a second stint through 2010; Pearl unveiled his JD1455 signature snare drum' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Jimmy DeGrasso's drumming favors pocket, feel, and adaptability over pure technical display — the toolkit of a hired-gun touring and session drummer who has anchored acts across hard rock, thrash, and crossover metal since the late 1980s. His Megadeth tenure required adapting quickly to Dave Mustaine's riff-driven, technically demanding songwriting on short notice, while his work in Alice Cooper's band called for a more theatrical, arena hard-rock pocket built around a decades-deep back catalog.

**Signature Traits:**
- Versatility across hard rock, thrash, and crossover metal without a single signature genre
- Steady, groove-anchored playing that prioritizes serving the song over technical flash
- Fast adaptation to a new band's existing catalog, evidenced by short-notice stints across Megadeth and later Dokken and Ratt`
      },
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Megadeth - Risk', year: 1999, label: 'Capitol Records', note: 'DeGrasso\'s Megadeth studio debut; the band\'s final album on Capitol' },
          { name: 'Megadeth - The World Needs a Hero', year: 2001, label: 'Sanctuary Records', note: 'A heavier-direction follow-up to Risk' },
          { name: 'Megadeth - Rude Awakening', year: 2002, label: 'Sanctuary Records', note: 'Megadeth\'s first live album; DeGrasso\'s final Megadeth recording' }
        ],
        tours: [
          { name: 'Megadeth World Tour', year: '1998-2002', note: 'Risk and The World Needs a Hero touring cycles' },
          { name: 'Alice Cooper Tours', year: '1994-1998, 2008-2010', note: 'Two separate touring stints' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Jimmy DeGrasso built a longtime relationship with Pearl, culminating in the Pearl JD1455 signature snare — a 14"x5.5" hammered brass shell with gold-plated hardware that Pearl unveiled at the 2008 NAMM Show, engineered for the cut and authority loud, amplified thrash and hard rock demand. He has maintained a parallel Sabian cymbal endorsement across his touring career with Megadeth, Alice Cooper, and other hard rock acts.

**Confirmed Setup:**
- **Drums**: Pearl
- **Snare**: Pearl JD1455 Jimmy DeGrasso Signature 14"x5.5" Hammered Brass
- **Cymbals**: Sabian
- **Sticks**: Promark
- **Heads**: Evans

Hardware and pedal brand are not independently confirmed and are omitted rather than guessed.`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
          'Relocated to Los Angeles in the 1980s to break into the city\'s hard rock touring scene',
          'Recorded pre-production demos for Ozzy Osbourne\'s The Ultimate Sin, but was replaced by Randy Castillo before the album was tracked',
          'Joined Megadeth in 1998 and had to learn the band\'s catalog on short notice',
          'Rude Awakening (2002) was Megadeth\'s first-ever live album release',
          'Pearl unveiled his JD1455 signature snare — a 14"x5.5" hammered brass shell — at the 2008 NAMM Show',
          'Went on to drum for Dokken, Black Star Riders, and Ratt after leaving Megadeth'
        ]
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does Jimmy DeGrasso use?', a: 'Jimmy DeGrasso plays a Pearl drum kit, paired with his own Pearl JD1455 signature snare — a 14"x5.5" hammered brass shell with gold-plated hardware that Pearl unveiled at the 2008 NAMM Show.' },
          { q: 'What drum set does Jimmy DeGrasso use?', a: 'Jimmy DeGrasso\'s drum set is built around Pearl shells and his JD1455 signature snare, driven with Sabian cymbals, Promark sticks, and Evans drumheads across his touring career with Megadeth and Alice Cooper.' },
          { q: 'What snare does Jimmy DeGrasso use?', a: 'Jimmy DeGrasso\'s signature snare is the Pearl JD1455 — a 14"x5.5" hammered brass shell with gold-plated hardware, unveiled by Pearl at the 2008 NAMM Show.' },
          { q: 'What cymbals does Jimmy DeGrasso play?', a: 'Jimmy DeGrasso plays Sabian cymbals, an endorsement he has maintained across his touring career with Megadeth, Alice Cooper, and other hard rock acts.' },
          ...
          { q: 'What band is Jimmy DeGrasso in?', a: 'Jimmy DeGrasso drummed for Megadeth from 1998 to 2002, recording Risk (1999), The World Needs a Hero (2001), and the live album Rude Awakening (2002). He also drummed for Y&T, Suicidal Tendencies, and Alice Cooper across two separate stints.' },
          { q: 'Did Jimmy DeGrasso play on Megadeth\'s Risk?', a: 'Yes — Jimmy DeGrasso recorded drums on Risk (1999), Megadeth\'s eighth studio album and his first with the band.' },
          { q: 'How long was Jimmy DeGrasso in Megadeth?', a: 'Jimmy DeGrasso was Megadeth\'s drummer from 1998 to 2002, recording two studio albums (Risk, The World Needs a Hero) and the band\'s first live album (Rude Awakening) before departing.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'Sabian: Jimmy DeGrasso Artist Page', url: 'https://sabian.com/artist/jimmy-degrasso/' },
          { name: 'MusicRadar — NAMM 2008: Megadeth Drummer Reveals Pearl Signature Snare', url: 'https://www.musicradar.com/news/drums/namm-2008-megadeth-drummer-reveals-pearl-signature-snare-126963' }
        ]
      }
    }
  },

  // Nick Barker - Dimmu Borgir / Cradle of Filth / Lock Up
  'nick-barker': {
    slug: 'nick-barker',
    drummerId: 69,
    name: 'Nick Barker',
    ...
    metaTitle: 'Nick Barker Drum Kit & Gear Setup — Dimmu Borgir & Cradle of Filth Drummer | MetalForge',
    metaDescription: 'Complete biography of Nick Barker, drummer for Cradle of Filth (1993-1999), Dimmu Borgir (1999-2004), and grindcore supergroup Lock Up. Explore his Sonor endorsement, career, and extreme metal session work.',
    ogImage: '/images/drummers/nick-barker.webp',
    keywords: ['black metal', 'death metal', 'grindcore', 'sonor drums', 'nick barker drum kit', 'dimmu borgir', 'cradle of filth', 'lock up'],
    relatedDrummers: ['martin-axenrot', 'gene-hoglan', 'danny-herrera'],
    summary: 'Nick Barker drummed for Cradle of Filth (1993-1999) and Dimmu Borgir (1999-2004), and co-founded grindcore supergroup Lock Up in 1998 with Napalm Death\'s Shane Embury.',
    lastUpdated: '2026-07-24',
    imageAlt: 'Nick Barker performing live drums with Lock Up',
    schemaType: 'Person',
    sections: {
      overview: {
        title: 'Overview',
        content: `Nicholas Howard Barker (born April 25, 1973, in Chesterfield, Derbyshire, England) is a British extreme metal drummer who became one of the genre's most in-demand session and touring players across three decades. He joined Cradle of Filth in 1993, recording The Principle of Evil Made Flesh (1994), Vempire or Dark Faerytales in Phallustein (1996), Dusk... and Her Embrace (1996), Cruelty and the Beast (1998), and the From the Cradle to Enslave EP (1999) before departing the band in 1999.

Barker then joined Norwegian symphonic black metal band Dimmu Borgir, recording Puritanical Euphoric Misanthropia (2001) and Death Cult Armageddon (2003) during his 1999-2004 tenure behind the drum kit. In 1998, while still in Cradle of Filth, he co-founded the grindcore supergroup Lock Up with Napalm Death's Shane Embury, recording Pleasures Pave Sewers (1999), Hate Breeds Suffering (2002), and Demonization (2017) across a drum set career with the band that ran until 2020. Barker has also done extensive session and touring work for Testament, Old Man's Child, Exodus, Brujeria, Gorgoroth/God Seed, Anaal Nathrakh, and Benediction.`
      },
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1993', event: 'Joined Cradle of Filth' },
          { year: '1994', event: 'Recorded The Principle of Evil Made Flesh with Cradle of Filth' },
          { year: '1998', event: 'Recorded Cruelty and the Beast with Cradle of Filth; co-founded Lock Up with Napalm Death\'s Shane Embury' },
          { year: '1999', event: 'Left Cradle of Filth; joined Dimmu Borgir; released Pleasures Pave Sewers with Lock Up' },
          ...
          { year: '2004', event: 'Left Dimmu Borgir' },
          { year: '2017', event: 'Recorded Demonization with Lock Up' },
          { year: '2020', event: 'Departed Lock Up after more than two decades with the band' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Nick Barker's drumming spans symphonic black metal's dense, orchestrated arrangements and grindcore's raw, high-speed extremity — a range built across three decades of session and touring work in extreme metal's upper tier. His Dimmu Borgir tenure required driving blast beats and precise double-bass patterns underneath elaborate keyboard and orchestral arrangements, while his long-running role in Lock Up called for the stripped-down, blunt-force intensity of old-school grindcore.

**Signature Traits:**
- Sustained blast-beat and double-bass endurance across symphonic black metal's dense arrangements
- Raw, high-speed grindcore drumming with Lock Up, largely unornamented
- Session versatility across black metal, death metal, thrash, and grindcore for bands including Testament, Exodus, and Anaal Nathrakh`
      },
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Cradle of Filth - Cruelty and the Beast', year: 1998, label: 'Music for Nations', note: 'Concept album based on the Erzsébet Báthory legend' },
          { name: 'Dimmu Borgir - Puritanical Euphoric Misanthropia', year: 2001, label: 'Nuclear Blast', note: 'Barker\'s Dimmu Borgir studio debut, recorded at Studio Fredman' },
          { name: 'Dimmu Borgir - Death Cult Armageddon', year: 2003, label: 'Nuclear Blast', note: 'Barker\'s final Dimmu Borgir studio album' },
          { name: 'Lock Up - Pleasures Pave Sewers', year: 1999, label: 'Nuclear Blast', note: 'Lock Up\'s debut album, with Peter Tägtgren on vocals' }
        ],
        tours: [
          { name: 'Dimmu Borgir World Touring', year: '1999-2004', note: 'Supporting Puritanical Euphoric Misanthropia and Death Cult Armageddon' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Nick Barker is an official Sonor artist, endorsed by the German drum manufacturer across his touring and session career in extreme metal. Sonor's own artist page credits him for his work with Cradle of Filth (1993-1999) and Dimmu Borgir (1999-2004), alongside his long-running role in Lock Up and session credits for Testament, Old Man's Child, and Exodus, among others.

**Confirmed Setup:**
- **Drums**: Sonor

Sonor's artist materials do not publish a specific kit model, snare spec, cymbal brand, or drumhead endorsement for Barker, so this profile omits those fields rather than guessing — a Nick Barker gear breakdown at the same component-level detail as many of his peers isn't independently documented as of this writing.`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
          'Co-founded the grindcore supergroup Lock Up in 1998 with Napalm Death bassist Shane Embury, while still a member of Cradle of Filth',
          'His 1999-2004 Dimmu Borgir tenure includes Puritanical Euphoric Misanthropia (2001) and Death Cult Armageddon (2003), two of the band\'s most commercially successful albums',
          'Has done session and touring work for Testament, Old Man\'s Child, Exodus, Brujeria, Gorgoroth/God Seed, Anaal Nathrakh, and Benediction',
          'An official Sonor endorsed artist',
          'Departed Lock Up in 2020 after more than two decades with the band'
        ]
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does Nick Barker play?', a: 'Nick Barker is an official Sonor artist, confirmed via Sonor\'s own artist page — the specific kit model and shell configuration are not publicly documented, so this profile omits those details rather than guessing.' },
          { q: 'What drum set does Nick Barker use?', a: 'Nick Barker\'s drum set is built on Sonor drums, per his confirmed Sonor artist endorsement; snare, cymbal, stick, and drumhead specifics are not independently documented.' },
          { q: 'What cymbals does Nick Barker use?', a: 'Nick Barker\'s cymbal brand is not publicly documented on Sonor\'s artist materials or elsewhere, so this profile omits it rather than guessing.' },
          { q: 'Is Nick Barker a Sonor endorsed artist?', a: 'Yes — Nick Barker is an official Sonor artist, credited on Sonor\'s own artist page for his work with Cradle of Filth and Dimmu Borgir.' },
          { q: 'What band is Nick Barker in?', a: 'Nick Barker drummed for Cradle of Filth (1993-1999) and Dimmu Borgir (1999-2004), and co-founded grindcore supergroup Lock Up in 1998, remaining with the band until 2020.' },
          { q: 'Did Nick Barker play in Cradle of Filth?', a: 'Yes — Nick Barker was Cradle of Filth\'s drummer from 1993 to 1999, recording The Principle of Evil Made Flesh (1994), Vempire (1996), Dusk... and Her Embrace (1996), Cruelty and the Beast (1998), and From the Cradle to Enslave (1999).' },
          { q: 'Did Nick Barker play in Dimmu Borgir?', a: 'Yes — Nick Barker drummed for Dimmu Borgir from 1999 to 2004, recording Puritanical Euphoric Misanthropia (2001) and Death Cult Armageddon (2003).' },
          { q: 'What is Lock Up?', a: 'Lock Up is a grindcore supergroup Nick Barker co-founded in 1998 with Napalm Death bassist Shane Embury, releasing Pleasures Pave Sewers (1999), Hate Breeds Suffering (2002), and Demonization (2017) before Barker departed in 2020.' },
          { q: 'What other bands has Nick Barker recorded or toured with?', a: 'Beyond Cradle of Filth, Dimmu Borgir, and Lock Up, Nick Barker has done session and touring work for Testament, Old Man\'s Child, Exodus, Brujeria, Gorgoroth/God Seed, Anaal Nathrakh, and Benediction.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'Sonor: Nick Barker Artist Page', url: 'https://www.sonor.com/drums/artists/artists-detail/nick-barker' }
        ]
      }
    }
  },

  // Alex Rüdinger - The Faceless / Trivium
  'alex-rudinger': {
    slug: 'alex-rudinger',
    drummerId: 70,
    name: 'Alex Rüdinger',
    bands: [
      ...
      { slug: 'trivium', period: '2025-present', role: 'Drummer' }
    ],
    metaTitle: 'Alex Rüdinger Drum Kit & Gear Setup — Trivium & The Faceless Drummer | MetalForge',
    metaDescription: 'Complete biography of Alex Rüdinger, Trivium\'s touring/studio drummer since 2025 and veteran of The Faceless, Conquering Dystopia, and 7 Horns 7 Eyes. Explore his Tama Starclassic kit, Evans heads, and Meinl cymbals.',
    ogImage: '/images/drummers/alex-rudinger.webp',
    keywords: ['technical death metal', 'progressive metal', 'tama starclassic', 'alex rudinger drum kit', 'the faceless', 'trivium', 'conquering dystopia'],
    relatedDrummers: ['alex-bent', 'navene-koperweis', 'art-cruz'],
    summary: 'Alex Rüdinger is Trivium\'s touring and studio drummer since 2025, known for technical precision built across The Faceless, Conquering Dystopia, and extensive session work.',
    lastUpdated: '2026-07-24',
    imageAlt: 'Alex Rüdinger performing live behind his Tama Starclassic drum kit',
    schemaType: 'Person',
    sections: {
      overview: {
        title: 'Overview',
        content: `Alex Rüdinger (born November 18, 1991, in Frederick, Maryland) is an American drummer known for technical, high-precision playing across progressive and technical death metal. He received his first drum kit at age 12 and began his professional career at 18, filling in for Threat Signal and appearing on the band's self-titled album (2011) before departing in late 2011. He went on to join The HAARP Machine (2012-2013) and technical death metal band The Faceless (2013-2014), and has been a member of the instrumental project Conquering Dystopia since 2013 and progressive band 7 Horns 7 Eyes since 2018. He also drummed in progressive metalcore band Good Tiger from 2015 to 2018.

Beyond his studio bands, Rüdinger has built an extensive session and touring career, with studio credits including Whitechapel (Kin, 2021), Nonvector (Ashen Time, 2024), Cognizance, Monuments, Revocation, and Intronaut, and live touring behind Whitechapel (2019-2021) and Light the Torch (2021). In 2025 he became the touring and studio drum set player for Trivium, extending a career built on rapid adaptation to some of technical metal's most demanding drum charts.`
      },
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '2010', event: 'Began filling in for Threat Signal at age 18' },
          { year: '2011', event: 'Appeared on Threat Signal\'s self-titled album before departing the band later that year' },
          { year: '2012', event: 'Joined The HAARP Machine' },
          { year: '2013', event: 'Joined The Faceless; became a member of instrumental project Conquering Dystopia' },
          { year: '2015', event: 'Joined progressive metalcore band Good Tiger' },
          { year: '2018', event: 'Joined progressive band 7 Horns 7 Eyes' },
          { year: '2019', event: 'Began touring with Whitechapel (through 2021)' },
          ...
          { year: '2025', event: 'Became touring and studio drummer for Trivium' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Alex Rüdinger's drumming is defined by technical precision married to unusually fast internalization of complex material — a skill built across a career of session and fill-in work for some of technical death and progressive metal's most demanding bands. His playing balances extreme independence (odd-meter figures, rapid single-stroke fills, and precise blast-beat control) with a musicality that has made him a first-call session drummer well beyond his main bands.

**Signature Traits:**
- High-speed technical precision across odd meters and polyrhythms
- Rapid learning and internalization of complex drum parts for session and fill-in work
- Musical restraint — prioritizing the song's structure even within highly technical death metal and progressive contexts`
      },
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Threat Signal - Threat Signal', year: 2011, label: 'Nuclear Blast', note: 'Rüdinger\'s recording debut' },
          { name: 'Whitechapel - Kin', year: 2021, label: 'Metal Blade Records', note: 'Session drum credit' },
          { name: 'Nonvector - Ashen Time', year: 2024, note: 'Session drum credit' }
        ],
        tours: [
          { name: 'Whitechapel Touring', year: '2019-2021', note: 'Live touring drummer' },
          { name: 'Light the Torch Tour', year: '2021', note: 'Touring drummer' },
          { name: 'Trivium World Tour', year: '2025-present', note: 'Touring and studio drummer' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
- **Cymbals**: Meinl Cymbals (Byzance and MB20 series)`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
          'Received his first drum kit at age 12 and began his professional career at 18',
          'Filled in for Threat Signal before appearing on the band\'s self-titled 2011 album',
          'A member of instrumental project Conquering Dystopia since 2013',
          'Recorded session drums for Whitechapel\'s Kin (2021) and Nonvector\'s Ashen Time (2024)',
          'Became Trivium\'s touring and studio drummer in 2025',
          'An official artist for Tama Drums, Evans Drumheads, and Meinl Cymbals'
        ]
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does Alex Rüdinger use?', a: 'Alex Rüdinger plays a Tama Starclassic Performer B/B kit — per Tama\'s own artist page, a 20"x16" bass drum, 8"x7" and 10"x7" rack toms, and 14"x12" and 16"x14" floor toms.' },
          { q: 'What drum set does Alex Rüdinger play?', a: 'Alex Rüdinger\'s drum set is a Tama Starclassic Performer B/B configuration, driven by Tama Speed Cobra bass drum pedals and hi-hat stands, Tama Roadpro stands, and a 1st Chair Ergo-Rider throne.' },
          { q: 'What snare does Alex Rüdinger use?', a: 'Alex Rüdinger\'s snare is a Tama STARPHONIC Brass 14"x6", with an SLP Black Brass model as a documented alternate.' },
          { q: 'What cymbals does Alex Rüdinger play?', a: 'Alex Rüdinger is a Meinl Cymbals artist, endorsing the Byzance and MB20 cymbal lines; Meinl does not publish a component-level breakdown, so specific models are omitted rather than guessed.' },
          { q: 'What drumheads does Alex Rüdinger use?', a: 'Alex Rüdinger is an Evans artist using a UV EQ4 Coated bass batter, G2 Clear tom batters, an HD Dry snare batter with a Snare Side 300 reso and PureSound Super 30 snare wires, and a G1 Clear/EQ3-NP Black bass reso combination.' },
          { q: 'What pedals does Alex Rüdinger use?', a: 'Alex Rüdinger drives his kit with Tama Speed Cobra bass drum pedals and a matching Tama Speed Cobra hi-hat stand.' },
          { q: 'What band is Alex Rüdinger in?', a: 'Alex Rüdinger has been Trivium\'s touring and studio drummer since 2025. He also drums for Conquering Dystopia and 7 Horns 7 Eyes, and previously played in Threat Signal, The HAARP Machine, The Faceless, and Good Tiger.' },
          { q: 'Did Alex Rüdinger play in The Faceless?', a: 'Yes — Alex Rüdinger was The Faceless\' drummer from 2013 to 2014.' },
          { q: 'When did Alex Rüdinger join Trivium?', a: 'Alex Rüdinger became Trivium\'s touring and studio drummer in 2025.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'Tama: Alex Rüdinger Artist Page', url: 'https://www.tama.com/usa/artists/detail/975.html' },
          { name: 'D\'Addario/Evans: Alex Rüdinger Artist Page', url: 'https://www.daddario.com/artists/evans-drumheads/alex_rudinger/' }
        ]
      }
    }
  },
  ...
  'john-longstreth': {
    ...
    bands: [
      ...
      { slug: 'hate-eternal', period: '2018', role: 'Touring fill-in drummer' }
    ],
    metaTitle: 'John Longstreth Drum Kit & Gear Setup — Origin Drummer | MetalForge',
    metaDescription: 'Complete biography of John Longstreth, Origin\'s drummer since 1999 and co-founder of Angelcorpse. Explore his jazz-rooted technique, Pearl/Meinl gear setup, and pioneering double-stroke bass drum style.',
    ogImage: '/images/drummers/john-longstreth.webp',
    keywords: ['technical death metal', 'brutal death metal', 'origin drummer', 'john longstreth drum kit', 'angelcorpse', 'meinl cymbals', 'double stroke bass drum'],
    relatedDrummers: ['pete-sandoval', 'derek-roddy', 'flo-mounier'],
    summary: 'John Longstreth has driven technical death metal band Origin since 1999, co-founded Angelcorpse in 1995, and is credited with pioneering the double-stroke bass drum technique in extreme metal.',
    lastUpdated: '2026-07-24',
...
Longstreth co-founded Angelcorpse in 1995, recording Hammer of Gods (1996) and Exterminate (1998) before departing; he rejoined for the band's 2006-2007 reunion. Since 1999 he has been the driving force behind technical death metal band Origin (with a 2003-2006 hiatus), recording Informis Infinitas Inhumanitas (2002), Antithesis (2008), Entity (2011), Omnipresent (2014), Unparalleled Universe (2017), and Chaosmos (2022) — a drum kit lineage that runs through the band's entire technical death metal catalog. He also drummed for Skinless in 2003 and has done extensive session and touring work for Dying Fetus, Dim Mak, Gorguts, Unmerciful, Codex Ritual, Exhumed, and The Red Chord, including filling in for regular drummer Hannes Grossmann on Hate Eternal's November 2018 US tour behind the drum set.`
      },
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '1995', event: 'Co-founded Angelcorpse' },
          { year: '1996', event: 'Recorded Hammer of Gods with Angelcorpse' },
          { year: '1998', event: 'Recorded Exterminate with Angelcorpse before the band\'s initial breakup' },
          { year: '1999', event: 'Joined Origin' },
          { year: '2002', event: 'Recorded Informis Infinitas Inhumanitas with Origin' },
          { year: '2003', event: 'Drummed for Skinless; Origin entered a hiatus through 2006' },
          { year: '2006', event: 'Rejoined Angelcorpse for its 2006-2007 reunion; resumed with Origin' },
          { year: '2008', event: 'Recorded Antithesis with Origin' },
          { year: '2017', event: 'Recorded Unparalleled Universe with Origin' },
          { year: '2018', event: 'Filled in for Hannes Grossmann on Hate Eternal\'s November US tour' },
          { year: '2022', event: 'Recorded Chaosmos with Origin' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `John Longstreth's playing is built on a rare foundation for extreme metal: jazz. His father was a working Kansas City jazz musician for fifty years, and John's early exposure to Buddy Rich, Miles Davis, and John Coltrane shaped a sense of dynamics and control that he later applied to death metal's most extreme tempos. He is credited with pioneering the double-stroke bass drum technique and the one-handed drum roll within extreme metal — techniques that let him sustain blast beats and rolls at tempos few drummers can match.

**Key Influences:**
- **Buddy Rich**: Foundational technique and control, introduced by his jazz-musician father
- **Miles Davis and John Coltrane**: Jazz phrasing and dynamics
- **Slayer and early thrash metal**: The gateway that pulled him toward extreme metal

**Signature Techniques:**
- Pioneered double-stroke bass drum technique in extreme metal
- Pioneered the one-handed drum roll
- Sustained high-speed blast beats with jazz-derived control and endurance`
      },
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Angelcorpse - Exterminate', year: 1998, label: 'Osmose Productions', note: 'Longstreth\'s final album before Angelcorpse\'s initial breakup' },
          { name: 'Origin - Informis Infinitas Inhumanitas', year: 2002, label: 'Relapse Records', note: 'Origin\'s second studio album' },
          { name: 'Origin - Unparalleled Universe', year: 2017, label: 'Nuclear Blast', note: 'Origin\'s seventh studio album' },
          { name: 'Origin - Chaosmos', year: 2022, label: 'Nuclear Blast', note: 'Origin\'s return to Nuclear Blast' }
        ],
        tours: [
...
**Confirmed Setup:**
- **Drums**: Pearl (specific model not independently documented)
...
- **Sticks**: Scorpion Percussion "Wee Heavy" Signature Drumsticks`
      ...
      trivia: {
        title: 'Trivia & Notes',
        items: [
          'His father was a working Kansas City jazz musician for fifty years',
          'Credited with pioneering the double-stroke bass drum technique and the one-handed drum roll within extreme metal',
          ...
          'Co-founded Angelcorpse in 1995 and rejoined for its 2006-2007 reunion'
        ]
      },
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does John Longstreth use?', a: 'John Longstreth is an endorsed Pearl Drums artist; specific shell sizes and finish are not independently documented, so this profile omits those details rather than guessing.' },
          { q: 'What drum set does John Longstreth play?', a: 'John Longstreth\'s drum set is built around Pearl shells, Meinl Classics Custom Dark cymbals, ACD Unlimited bass drum pedals with FootBlaster triggers, and Scorpion Percussion "Wee Heavy" signature sticks.' },
          { q: 'What cymbals does John Longstreth use?', a: 'John Longstreth uses Meinl Classics Custom Dark Series cymbals — an 8" Dark Splash, 14" Dark Hihats, and 18" Dark China — plus a Meinl Generation X 12"/14" Trash Hat.' },
          { q: 'What sticks does John Longstreth use?', a: 'John Longstreth plays Scorpion Percussion\'s "Wee Heavy" signature drumstick model.' },
          { q: 'What pedals does John Longstreth use?', a: 'John Longstreth drives his bass drums with ACD Unlimited pedals paired with FootBlaster triggers.' },
          { q: 'What band is John Longstreth in?', a: 'John Longstreth has been the drummer for technical death metal band Origin since 1999 (with a 2003-2006 hiatus), and co-founded Angelcorpse in 1995.' },
          { q: 'Did John Longstreth play in Angelcorpse?', a: 'Yes — John Longstreth co-founded Angelcorpse in 1995, recording Hammer of Gods (1996) and Exterminate (1998), and rejoined for the band\'s 2006-2007 reunion.' },
          { q: 'What technique is John Longstreth known for?', a: 'John Longstreth is credited with pioneering the double-stroke bass drum technique and the one-handed drum roll within extreme metal, enabling sustained high-speed blast beats.' },
      ...
      sources: {
        ...
        items: [
          ...
          { name: 'Scorpion Percussion: John Longstreth Signature Artist Page', url: 'https://scorpionpercussion.com/pages/john-longstreth-signature-artist' },
          { name: 'Meinl Cymbals: John Longstreth Artist Page', url: 'https://meinlcymbals.com/en/artists/john-longstreth-a12223.html' },
          { name: 'Modern Drummer — Origin\'s John Longstreth', url: 'https://www.moderndrummer.com/2011/06/origins-john-longstreth/' }
        ]
      }
    }
  },
  ...
  'waltteri-vayrynen': {
    ...
    bands: [
      { slug: 'paradise-lost', period: '2015-2022', role: 'Drummer (session 2015-2016, official 2016-2022)' },
    ...
    metaDescription: 'Complete biography of Waltteri Väyrynen, Opeth\'s drummer since 2022 and former Paradise Lost member. Explore his Pearl/Sabian gear, Bodom After Midnight tenure, and The Last Will and Testament recording.',
    ogImage: '/images/drummers/waltteri-vayrynen.webp',
    keywords: ['progressive metal', 'gothic doom metal', 'opeth drummer', 'waltteri vayrynen drum kit', 'paradise lost', 'pearl drums', 'sabian cymbals'],
    relatedDrummers: ['martin-axenrot', 'daniel-erlandsson', 'dirk-verbeuren'],
    summary: 'Waltteri Väyrynen joined Opeth in September 2022, succeeding Martin Axenrot, after a 2015-2022 tenure in Paradise Lost recording Medusa and Obsidian.',
    lastUpdated: '2026-07-24',
    imageAlt: 'Waltteri Väyrynen performing live drums with Opeth',
    schemaType: 'Person',
    sections: {
      overview: {
        title: 'Overview',
        content: `Waltteri Väyrynen is a Finnish drummer born July 5, 1994, in Puolanka, Finland, now based in Helsinki. He first appeared as a session drummer for British gothic doom metal band Paradise Lost in 2015, became an official member in 2016, and recorded the albums Medusa (2017) and Obsidian (2020) behind the drum kit before departing in September 2022. In 2020, while still in Paradise Lost, he joined Bodom After Midnight — the project former Children of Bodom frontman Alexi Laiho formed after that band's 2019 split — tracking material later released posthumously as the Paint the Sky with Blood EP (2021) following Laiho's death in December 2020.

Väyrynen has also drummed for Finnish death metal band Abhorrence since 2016 and performed live with Bloodbath. In September 2022 he joined Swedish progressive metal band Opeth, replacing longtime drummer Martin Axenrot, and recorded his first album with the band, The Last Will and Testament (2024) — a drum set performance on the band's first album to feature death growls since Watershed (2008). His stated influences include Dirk Verbeuren, Kai Hahto, and Daniel Erlandsson.`
      },
      careerHighlights: {
        title: 'Career Highlights',
        items: [
          { year: '2015', event: 'Became session drummer for Paradise Lost' },
          { year: '2016', event: 'Became an official member of Paradise Lost; joined Finnish death metal band Abhorrence' },
          { year: '2017', event: 'Recorded Medusa with Paradise Lost' },
          { year: '2020', event: 'Recorded Obsidian with Paradise Lost; joined Bodom After Midnight' },
          { year: '2021', event: 'Paint the Sky with Blood EP released posthumously by Bodom After Midnight' },
          { year: '2022', event: 'Left Paradise Lost; joined Opeth, replacing Martin Axenrot' },
          { year: '2024', event: 'Recorded The Last Will and Testament, his first album with Opeth' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
        content: `Waltteri Väyrynen's drumming bridges gothic doom metal's weighty, atmospheric restraint and progressive/death metal's technical demands — a range built across parallel tenures in Paradise Lost's melancholic doom and the more extreme Abhorrence and Bodom After Midnight. His move to Opeth in 2022 required stepping into one of progressive metal's most demanding drum chairs, succeeding Martin Axenrot and adapting to a catalog spanning progressive rock, death metal, and everything between.

**Key Influences:**
- **Dirk Verbeuren (Megadeth, ex-Soilwork)**: Technical precision and metronomic control
- **Kai Hahto (Wintersun, Nightwish)**: Power and dynamic range
- **Daniel Erlandsson (Arch Enemy)**: Melodic death metal's rhythmic vocabulary

**Signature Techniques:**
- Weighty, atmospheric restraint suited to gothic doom metal's slower tempos
- Technical adaptability across death metal, doom, and progressive metal styles
- Precise blast-beat and double-bass control drawn from his death metal background in Abhorrence`
      },
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Paradise Lost - Medusa', year: 2017, label: 'Nuclear Blast', note: 'Väyrynen\'s first full album as an official Paradise Lost member' },
          { name: 'Paradise Lost - Obsidian', year: 2020, label: 'Nuclear Blast', note: 'Väyrynen\'s final Paradise Lost studio album' },
          { name: 'Bodom After Midnight - Paint the Sky with Blood', year: 2021, note: 'Posthumous EP following Alexi Laiho\'s death' },
        ...
        tours: [
          { name: 'Paradise Lost Touring', year: '2015-2022', note: 'Session then full-time touring drummer' },
          { name: 'Opeth World Tour', year: '2022-present', note: 'Touring drummer' }
        ]
      },
      gearHighlights: {
        title: 'Gear Highlights',
...
**Confirmed Setup:**
- **Drums**: Pearl (specific model not independently documented)
- **Cymbals**: Sabian (confirmed favourite piece: 22" HH Power Bell Ride; full setup not itemized)
- **Sticks**: Wincent W-5BXL`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
          'Replaced Martin Axenrot in Opeth in September 2022',
          'Recorded posthumous material with Bodom After Midnight following Alexi Laiho\'s December 2020 death',
          'Cites Dirk Verbeuren, Kai Hahto, and Daniel Erlandsson as influences',
          'The Last Will and Testament (2024) was Opeth\'s first album to feature death growls since Watershed (2008)',
      ...
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does Waltteri Väyrynen use?', a: 'Waltteri Väyrynen is an endorsed Pearl Drums artist; specific shell sizes and finish are not independently documented, so this profile omits those details rather than guessing.' },
          { q: 'What drum set does Waltteri Väyrynen play?', a: 'Waltteri Väyrynen\'s drum set is built on Pearl drums with Sabian cymbals — his confirmed favourite piece is a 22" HH Power Bell Ride — and Wincent W-5BXL signature sticks.' },
          { q: 'What cymbals does Waltteri Väyrynen use?', a: 'Waltteri Väyrynen is a Sabian artist; Sabian\'s own artist page names a 22" HH Power Bell Ride as his favourite piece, though his full cymbal lineup isn\'t itemized there.' },
          { q: 'What sticks does Waltteri Väyrynen use?', a: 'Waltteri Väyrynen plays the Wincent W-5BXL, his signature stick model announced through Wincent\'s artist roster in December 2022.' },
          { q: 'What band is Waltteri Väyrynen in?', a: 'Waltteri Väyrynen has been Opeth\'s drummer since September 2022. He also drums for Finnish death metal band Abhorrence.' },
          { q: 'Did Waltteri Väyrynen play in Paradise Lost?', a: 'Yes — Waltteri Väyrynen was Paradise Lost\'s drummer from 2015 to 2022 (session member 2015-2016, official member 2016-2022), recording Medusa (2017) and Obsidian (2020).' },
          { q: 'Why did Waltteri Väyrynen join Opeth?', a: 'Waltteri Väyrynen joined Opeth in September 2022, replacing longtime drummer Martin Axenrot, and recorded his first album with the band, The Last Will and Testament (2024).' },
          { q: 'What is Bodom After Midnight?', a: 'Bodom After Midnight was a project formed by former Children of Bodom frontman Alexi Laiho after that band\'s 2019 split. Waltteri Väyrynen joined in 2020 and tracked material later released posthumously as the Paint the Sky with Blood EP (2021) following Laiho\'s death in December 2020.' },
          { q: 'Who are Waltteri Väyrynen\'s drumming influences?', a: 'Waltteri Väyrynen has cited Dirk Verbeuren (Megadeth), Kai Hahto (Wintersun, Nightwish), and Daniel Erlandsson (Arch Enemy) as influences.' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'Sabian: Waltteri Väyrynen Artist Page', url: 'https://sabian.com/artist/waltteri-vayrynen/' },
...
// Helper function to get extended bio by drummer slug
export function getExtendedBio(slug) {
  return extendedBios[slug] || null;
}

// Helper function to get all drummers with extended bios
export function getAllExtendedBioSlugs() {
  return Object.keys(extendedBios);
}

// Helper function to check if a drummer has an extended bio
export function hasExtendedBio(slug) {
  return slug in extendedBios;
}

// Export default
export default extendedBios;
