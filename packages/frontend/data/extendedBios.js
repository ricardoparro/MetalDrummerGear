...
- Ability to adapt to different metal styles`
      ...
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Dirk Verbeuren is endorsed by Tama Drums, Zildjian Cymbals, and Tama Drumsticks. His setup is designed for both the technical demands of modern metal and the power required for arena-level thrash performances.
...
- Zildjian A Custom & K Custom for bright attack and dark complexity
...
- Relatively compact setup for mobility`
      ...
      sources: {
        ...
        items: [
          ...
          { name: 'Zildjian Artist Profile', url: 'https://zildjian.com/blogs/artist' },
