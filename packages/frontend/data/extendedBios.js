...
For a complete era-by-era component breakdown, see the [Joey Jordison drum setup guide](/articles/joey-jordison-drum-setup).`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What cymbals did Joey Jordison use?', a: 'Joey Jordison used Paiste RUDE and 2002 series cymbals — 14" hi-hats, 18" & 19" crashes, 20" & 22" Chinas, and a 22" Power Ride — prized for their aggressive cut and extreme durability during Slipknot\'s most demanding live shows.' },
          { q: 'What bass drum pedals did Joey Jordison use?', a: 'Joey Jordison used a Pearl Demon Drive double bass drum pedal, giving him the speed and durability required for his extreme double kick patterns and the blast beats he performed live on Slipknot\'s rotating drum riser.' }
        ]
      },
      sources: {
        title: 'Sources',
...
- Has collaborated with Paiste on the "Reign" series ride cymbal`
      ...
      faq: {
        ...
        items: [
          ...
          { q: "What is Dave Lombardo's drum setup?", a: 'Dave Lombardo\'s drum setup is built on Tama Starclassic Walnut/Birch shells, anchored by a Tama S.L.P. 14"x6.5" G-Maple snare drum, with Paiste RUDE and 2002 series cymbals — including 15" Sound Edge hi-hats and the signature Paiste Reign Power Ride — powered by a Tama Iron Cobra 900 double pedal.' }
        ]
      },
      sources: {
        title: 'Sources',
...
- Known for massive, visually impressive kit configurations`
  ...
  'mike-portnoy': {
    ...
    metaDescription: 'Mike Portnoy drum set and drum kit breakdown: Tama Starclassic Maple + Bubinga "Dream Monster" shells, cymbals, and hardware behind the Dream Theater co-founder\'s 30+ year progressive metal career. Complete gear guide and biography.',
...
- Electronic pads integrated for samples`
  ...
  'danny-carey': {
    ...
    metaDescription: 'See what drum kit Danny Carey (Tool) plays — Sonor SQ2 Heavy Beech kit, Sonor Danny Carey Signature bronze snare, Paiste Signature cymbals, and Mandala electronic pads. Complete gear guide.',
...
- Massive kit size requiring extensive support hardware`
      ...
      faq: {
        ...
        items: [
          ...
          { q: "What is Danny Carey's drum setup?", a: 'Danny Carey\'s drum setup is a Sonor SQ2 Heavy Beech configuration built around his signature Sonor Danny Carey 14"x8" bronze snare drum, fitted with Paiste Signature cymbals (Sound Edge hi-hats, Power crashes, Dry Heavy Ride, chinas), Mandala electronic pads, and a Sonor Giant Step Twin Effect double pedal.' },
          { q: "What drumkit does Danny Carey use?", a: 'Danny Carey\'s drumkit is a Sonor SQ2 Heavy Beech configuration built around his signature Sonor Danny Carey 14"x8" bronze snare drum, fitted with Paiste Signature cymbals (Sound Edge hi-hats, Power crashes, Dry Heavy Ride, chinas), Mandala electronic pads, and a Sonor Giant Step Twin Effect double pedal.' }
        ]
      },
      sources: {
        title: 'Sources',
...
- **Heads**: Remo Powerstroke 3, Emperor Coated, Ambassador`
  ...
  'jon-dette': {
    ...
    bands: [
      ...
      { slug: 'testament', period: '1997-1999, 2001-2012', role: 'Touring drummer' },
...
Dette served as Slayer's touring drummer during 1996-1997, filling in when Paul Bostaph was temporarily unavailable. He later became Testament's touring drummer across two stints (1997-1999, 2001-2012), a tenure captured on the live album Live at the Fillmore. His versatility and professionalism have earned him respect throughout the metal community.`
      ...
      careerHighlights: {
        ...
        items: [
          ...
          { year: '1999', event: 'Touring drummer for Testament\'s "The Gathering" era (studio album recorded by Dave Lombardo)' },
          { year: '2008', event: 'Testament\'s touring drummer during "The Formation of Damnation" era (studio album recorded by Paul Bostaph)' },
          { year: '2010', event: 'Filled in for Charlie Benante on Anthrax tour dates' },
          { year: '2012', event: 'Testament\'s touring drummer during "Dark Roots of Earth" era (studio album recorded by Gene Hoglan)' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
...
- Professional approach to maintaining original song integrity`
      ...
      notableRecordings: {
        title: 'Notable Recordings & Tours',
        albums: [
          { name: 'Testament - Live at the Fillmore', year: 2005, label: 'Nuclear Blast', note: 'Live album capturing Dette\'s touring tenure' }
        ],
        tours: [
...
- Dynamic range from blast beats to sparse tribal sections`
      ...
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Igor Cavalera's gear has changed across distinct eras with Sepultura and Cavalera Conspiracy, including a documented mid-career switch away from Tama during the "Chaos A.D."/"Roots" years. His setup often includes traditional Brazilian percussion instruments alongside standard metal drums.

**Early Sepultura Era (pre-1993):**
...
- **Drums**: Yamaha Absolute Hybrid Maple (announced August 2018, moving on from Tama)
- **Cymbals**: Zildjian, moving on from his prior Paiste setup
- **Hardware**: Yamaha hardware (pedals, stands, hi-hat stand, boom arms)
- **Additional Percussion**: Atabaques, surdo, timbales, tribal percussion
- **Sticks**: Vic Firth American Classic 5B
- **Heads**: Remo
...
- Focus on both metal power and world music textures`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drums does Igor Cavalera play?', a: 'Igor Cavalera currently plays a Yamaha Absolute Hybrid Maple drum kit, having announced the endorsement in August 2018 after years on Tama Starclassic Maple (2007-2018).' },
          { q: 'What drum kit does Igor Cavalera play?', a: 'Igor Cavalera\'s current drum kit is a Yamaha Absolute Hybrid Maple shell pack with Yamaha hardware, replacing the Tama Starclassic Maple/Tama S.L.P. G-Maple snare setup he played from 2007 to 2018.' },
          { q: 'What drum set does Igor Cavalera play?', a: 'Igor Cavalera\'s current drum set is a Yamaha Absolute Hybrid Maple shell pack paired with Zildjian cymbals; from 2007 to 2018 he played Tama Starclassic Maple shells with Paiste RUDE and 2002 Series cymbals.' },
          { q: 'What cymbals does Igor Cavalera use?', a: 'Igor Cavalera is a current Zildjian artist, having moved on from the Paiste RUDE and 2002 Series cymbals he played from 2007 to 2018.' },
          { q: 'What hi-hats does Igor Cavalera use?', a: 'Igor Cavalera currently plays 14" Zildjian hi-hats, having moved on from the Paiste RUDE Hi-Hats he used from 2007 to 2018.' },
          { q: 'What snare drum does Igor Cavalera use?', a: 'Igor Cavalera\'s current snare is part of his Yamaha Absolute Hybrid Maple kit, replacing the Tama S.L.P. 14"x6.5" G-Maple he played from 2007 to 2018.' },
          { q: 'What pedals does Igor Cavalera use?', a: 'Igor Cavalera drives his tribal-influenced double bass patterns with Yamaha hardware, having moved on from the Tama Iron Cobra double pedal he used from 2007 to 2018.' },
          { q: 'What drumsticks does Igor Cavalera use?', a: 'Igor Cavalera plays Vic Firth American Classic 5B drumsticks.' },
          { q: 'What percussion does Igor Cavalera use?', a: 'Beyond his Yamaha Absolute Hybrid Maple drum kit and drum set, Igor Cavalera incorporates traditional Brazilian percussion — atabaques, surdo, and timbales — for the tribal rhythms he pioneered on Sepultura\'s Roots (1996).' }
        ]
      },
      sources: {
        title: 'Sources',
        items: [
          ...
          { name: 'Yamaha Artists: Iggor Cavalera', url: 'https://europe.yamaha.com/en/musical-instruments/drums/artists/i/iggor-cavalera.html' },
          { name: 'Zildjian Artists: Igor Cavalera', url: 'https://zildjian.com/blogs/artist/igor-cavalera' },
          { name: 'Blabbermouth: Igor Cavalera Announces Yamaha Endorsement', url: 'https://blabbermouth.net/news/former-sepultura-drummer-igor-cavalera-announces-new-drum-endorsement-with-yamaha' },
          { name: 'Modern Drummer Magazine', url: 'https://www.moderndrummer.com' },
...
- Open-handed playing despite right-handed kit setup`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drum set does Bill Ward use?', a: 'Bill Ward\'s drum set typically centered on a 24" bass drum and 13" and 16" toms in Ludwig Classic Maple shells, driven by a Ludwig Atlas Pro double pedal and Ludwig throne, with a 20" Zildjian Ride anchoring the kit from Master of Reality onward.' },
          ...
          { q: 'What hi-hats did Bill Ward play?', a: 'Bill Ward played 14" Avedis Zildjian hi-hats from Master of Reality (1971) onward, mounted alongside his Ludwig Supraphonic snare in his classic Black Sabbath drum kit.' }
        ]
      },
      sources: {
        title: 'Sources',
...
- Emphasis on reliability over complexity`
  ...
  'mike-mangini': {
    ...
    name: 'Mike Mangini',
    bands: [
      { slug: 'dream-theater', period: '2010-2023', role: 'Drummer' },
      { slug: 'godsmack', period: '2026-present', role: 'Drummer' },
    ...
    metaTitle: 'Mike Mangini Drum Kit & Gear Setup — Godsmack & Dream Theater Drummer | MetalForge',
    metaDescription: 'Complete biography of Mike Mangini, Godsmack\'s touring drummer since 2026 and Dream Theater\'s drummer from 2010-2023. Berklee professor and world record holder, explore his technical mastery and progressive metal legacy.',
...
Mangini departed Dream Theater in 2023 when founding drummer Mike Portnoy rejoined the band, and in June 2026 he emerged as Godsmack's touring drummer, bringing his technical approach to Sully Erna's alternative metal outfit.`
      ...
      careerHighlights: {
        ...
        items: [
          ...
          { year: '2023', event: 'Departed Dream Theater following Mike Portnoy\'s return to the band' },
          { year: '2026', event: 'Joined Godsmack as touring drummer' }
        ]
      },
      styleAndInfluences: {
        title: 'Style & Influences',
...
- Custom positioning based on scientific analysis of motion`
      ...
      sources: {
        ...
        items: [
          ...
          { name: 'Blabbermouth: Godsmack Recruits Ex-Dream Theater Drummer Mike Mangini', url: 'https://blabbermouth.net/news/godsmack-recruits-ex-dream-theater-drummer-mike-mangini-following-departure-of-wade-murff' },
          { name: 'Consequence: Mike Mangini Joins Godsmack', url: 'https://consequence.net/2026/06/mike-mangini-ex-dream-theater-joins-godsmack/' },
          { name: 'Metal Injection: Mike Mangini Joins Godsmack', url: 'https://metalinjection.net/news/mike-mangini-joins-godsmack-as-new-drummer' }
        ]
      }
    }
  },
...
- Focus on quality of sound over quantity of drums`
      ...
      sources: {
        ...
        items: [
          ...
          { name: 'MusicRadar: Animals as Leaders Drummer Matt Garstka Switches to DW Drums', url: 'https://www.musicradar.com/news/animals-as-leaders-matt-garstka-switches-to-playing-dw-drums' },
...
- Classic rock-solid metal configuration`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What band is Daniel Erlandsson in?', a: 'Daniel Erlandsson is a founding member and drummer of melodic death metal band Arch Enemy, formed in 1995. He previously played with Gothenburg pioneers Eucharist, briefly with In Flames in 1997, and as a live drummer for Carcass in 2007-2008.' },
...
- **Snare**: Sonor Nicko McBrain Signature 14"x6.5"
- **Cymbals**: Paiste 2002 & Signature Series (14" Sound Edge Hi-Hats, 16" & 18" Power Crashes, 22" Power Ride, 20" China)
- **Hardware**: Single bass drum pedal (brand unconfirmed; NOT double bass)
...
- Dynamic control that mirrors the song's emotional content`
      ...
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Abe Cunningham is a longtime Tama endorser, playing a Starclassic Bubinga kit for its punchy attack and durability. His setup is relatively straightforward, reflecting his focus on groove and feel over technical complexity.

**Current Setup:**
- **Drums**: Tama Starclassic Bubinga (Egyptian Night Mist)
- **Snare**: Matching Tama Starclassic snare (no separate model documented)
...
- Zildjian cymbal mix designed for his playing style
- Emphasizes feel and tone over extensive kit size`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What snare does Abe Cunningham use?', a: 'Abe Cunningham\'s snare matches his Tama Starclassic Bubinga shell pack; no separate snare model is publicly documented.' },
          { q: 'What sticks does Abe Cunningham use?', a: 'Abe Cunningham uses Pro-Mark drumsticks.' },
          { q: 'What bass drum pedal does Abe Cunningham use?', a: 'Abe Cunningham uses a Tama Iron Cobra Power Glide Twin Pedal (HP900PTW) mounted with a Tama Iron Cobra Lever Glide Hi-Hat (HH905).' },
      ...
      sources: {
        title: 'Sources',
        items: [
          { name: 'Tama Artist Profile', url: 'https://www.tama.com/usa/artists/detail/21.html' },
...
- Clean execution of technically demanding passages`
      ...
      gearHighlights: {
        title: 'Gear Highlights',
        content: `Aquiles Priester plays a Mapex Saturn Evolution signature kit paired with his own ProMark signature sticks. His setup is designed for both extreme speed and powerful stage presence during high-energy performances.

**Current Setup:**
- **Drums**: Mapex Saturn Evolution All Maple (Aquiles Priester signature kit)
...
- Mapex Saturn Evolution kit — the first Brazilian-drummer signature kit from a global drum brand
- DW 9000 double pedal for rapid-fire double bass`
      },
      trivia: {
        title: 'Trivia & Notes',
        items: [
      ...
      faq: {
        title: 'Frequently Asked Questions',
        items: [
          { q: 'What drum kit does Aquiles Priester use?', a: 'Aquiles Priester\'s drum kit is the Mapex Saturn Evolution All Maple — his own signature kit, and the first Brazilian-drummer signature kit released by a global drum brand. It is topped with Paiste cymbals (a custom red-coated set) and driven by a DW 9000 Series double pedal.' },
          { q: 'What drum set does Aquiles Priester use?', a: 'Aquiles Priester\'s drum set is his Mapex Saturn Evolution All Maple signature kit. The drum set carries a custom red-coated Paiste cymbal setup, a DW 9000 Series double pedal, and his signature ProMark sticks.' },
          { q: 'What cymbals does Aquiles Priester use?', a: 'Aquiles Priester uses Paiste cymbals, playing a custom red-coated set that includes his 18" Psychoctopus Giga Bell Ride.' },
          { q: 'What hi-hats does Aquiles Priester use?', a: 'Aquiles Priester plays Paiste hi-hats from his custom red-coated set, delivering the bright, articulate chick sound that keeps pace with his rapid single- and double-stroke fills.' },
          { q: 'What snare drum does Aquiles Priester play?', a: 'Aquiles Priester plays the snare from his Mapex Saturn Evolution All Maple signature kit, prized for a bright, cutting crack that keeps his rapid single- and double-stroke fills audible through dense progressive power metal arrangements.' },
...
- Custom finishes matching Slipknot's visual aesthetic`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What band is Jay Weinberg in?', a: 'Jay Weinberg has drummed for Suicidal Tendencies since 2024, and previously played drums for Slipknot from 2014 to 2023 after replacing Joey Jordison.' },
...
**Signature Products:**
- Mapex Black Panther 14"x5.5" Maple snare, anchoring August Burns Red's arrangements
- Vic Firth Matt Greiner Signature sticks designed for power and control
...
- Stories tell of bandmates finding him passed out on the floor from practice sessions`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drums does Pete Sandoval play?', a: 'Pete Sandoval has been a ddrum artist for much of his career, but the specific drum series he plays is not named on ddrum\'s own artist page.' },
          { q: 'What drum kit does Pete Sandoval play?', a: 'Pete Sandoval\'s drum kit is built on ddrum shells, though the specific series and snare model are not publicly documented.' },
          { q: 'What drum set does Pete Sandoval play?', a: 'Pete Sandoval\'s drum set is built on ddrum shells with a ddrum-brand double pedal; the specific series, snare model, and cymbal brand are not publicly documented.' },
          ...
          { q: 'What snare drum does Pete Sandoval use?', a: 'Pete Sandoval\'s snare is a ddrum shell, though the specific model is not publicly documented.' },
          { q: 'What pedals does Pete Sandoval use?', a: 'Pete Sandoval drives his pioneering blast beat technique with a ddrum-brand double pedal, though the specific model is unconfirmed.' },
...
- Emphasis on live performance reliability and consistency`
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'What drum set does Isaac Lamb use?', a: 'Isaac Lamb\'s specific drum kit brand and model are not publicly documented. No official artist page or gear-focused interview naming his equipment has been found.' },
          { q: 'What drum kit does Isaac Lamb use?', a: 'Isaac Lamb\'s drum kit brand and model are not publicly documented. What\'s known is that he has played the same role as Kublai Khan TX\'s sole drummer since the band\'s 2009 formation, but no source confirms specifics of his equipment.' },
          { q: 'What cymbals does Isaac Lamb use?', a: 'Isaac Lamb\'s cymbal brand and sizes are not publicly documented. No gear feature or interview naming his cymbal setup has been found.' },
          { q: 'What snare drum does Isaac Lamb use?', a: 'Isaac Lamb\'s snare drum brand and model are not publicly documented. No verified source naming his snare has been found.' },
          { q: 'What pedals does Isaac Lamb use?', a: 'Isaac Lamb\'s pedal brand and model are not publicly documented. No verified source naming his hardware has been found.' }
        ]
      },
      sources: {
        title: 'Sources',
