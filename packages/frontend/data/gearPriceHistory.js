...
export const GEAR_PRICE_HISTORY = {
  ...
  'vinnie-paul': {
    ...
    priceEvolution: [
      ...
      { year: 1994, price: 3200, label: 'Far Beyond Driven', event: 'Pantera reaches #1; Paul still on Tama' },
      { year: 1996, price: 3800, label: 'Great Southern Trendkill era', event: 'Paul switches to Pearl Custom' },
