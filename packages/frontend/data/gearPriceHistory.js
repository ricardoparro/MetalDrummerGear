...
export const GEAR_PRICE_HISTORY = {
  ...
  // Corrected per issue #3809 — Dirk did not record Dystopia (2016);
  // that album was recorded by Chris Adler. Dirk's actual studio debut
  // with Megadeth is "The Sick, the Dying... and the Dead!" (2022).
  // ==========================================
  'dirk-verbeuren': {
    slug: 'dirk-verbeuren',
    name: 'Dirk Verbeuren',
    ...
    summary: "Dirk Verbeuren's 2022 setup recorded his actual studio debut with Megadeth, \"The Sick, the Dying... and the Dead!\" — the band's first album built from the ground up around Verbeuren after he joined as touring drummer in 2016. (Megadeth's prior album, the Grammy-winning \"Dystopia\" (2016), was recorded entirely by Chris Adler of Lamb of God, who never toured with the band.) For his own studio debut, Verbeuren expanded to a twin-kick Tama Starclassic Maple Custom setup, paired his own Tama Signature snare with a dual-line Meinl Byzance Brilliant Heavy Hammered / Classics Custom Dark cymbal setup, and ran independent Tama Speed Cobra 910 single pedals on each kick. The rig cost roughly $10,385 in 2022 — a serious professional investment reflecting his fully established status within Tama and Meinl's artist rosters. Adjusted for 2026 inflation, that's equivalent to approximately $11,800 today. The contrast with Nick Menza's classic-era Pearl setup, already documented in this gear price index, captures how dramatically the cost of a top-tier Megadeth drum rig has shifted across the band's history.",

    setup: {
      drums: {
        item: 'Tama Starclassic Maple Custom',
        model: 'All-maple shell pack, twin bass drums, custom finish',
        specs: '22"x18" bass drum (×2), 10"x8"/12"x9"/13"x10" rack toms, 16"x16"/18"x18" floor toms',
        originalPrice: 5500,
        year: 2022,
        source: 'Tama Starclassic Maple Custom catalog MSRP 2022, double-kick configuration',
        notes: "All-maple shells with Tama's Star-Cast mounting system delivered the warm fundamental and open resonance needed for Verbeuren's expanded, arrangement-driven fills on the album.",
      ...
      snare: {
        ...
        notes: "Verbeuren's own signature model, voiced for fast, focused attack that stays articulate on tracks like \"We'll Be Back.\"",
      ...
      cymbals: {
        ...
        model: 'Dual-line cymbal setup',
        specs: '2x Hi-Hats, 2x Crashes, Ride, 2x China (split across both Byzance and Classics Custom Dark lines)',
        originalPrice: 3400,
        year: 2022,
        source: 'Meinl Byzance / Classics Custom Dark retail pricing 2022',
        notes: 'Pairing a bright Byzance line with a darker Classics Custom Dark line gave Verbeuren a wider tonal range within a single kit than his earlier all-Byzance touring setup.',
        vintageValue2026: 3300,
        modernEquivalent: {
          item: 'Meinl Byzance Brilliant Heavy Hammered / Classics Custom Dark',
          price: 3600,
          link: 'meinl-byzance-classics-custom-dark',
        },
      },
      hardware: {
        item: 'Tama Speed Cobra 910 (x2) + Iron Cobra Hi-Hat Stands',
        model: 'Dual single pedals + hardware pack',
        specs: 'Two independent single bass drum pedals, dual hi-hat stands, cymbal stands, 1st Chair Ergo-Rider throne',
        originalPrice: 900,
        year: 2022,
        source: 'Tama Speed Cobra / Iron Cobra hardware catalog 2022',
        notes: 'Running one Speed Cobra 910 per kick gave Verbeuren independent tonal control across the album\'s twin-kick passages.',
        vintageValue2026: 880,
        modernEquivalent: {
          item: 'Tama Speed Cobra 910 (x2)',
          price: 950,
      ...
      sticks: {
        ...
        notes: 'Balance of speed and power carried over from his touring setup.',
        vintageValue2026: null,
        modernEquivalent: {
          item: 'Vater Power 5B',
          price: 13,
      ...
      heads: {
        item: 'Evans EMAD2 / G2 / Hazy 300',
        model: 'EMAD2 (kick), G2 Clear (toms), Hazy 300 (snare resonant)',
        specs: 'Evans EMAD2 batter with EQ3 Black resonant (kick), Evans G2 Clear/G1 Clear (toms), Evans G2 Coated/Hazy 300 (snare)',
        originalPrice: 100,
        year: 2022,
        source: 'Evans retail pricing 2022',
        notes: 'Consistent head package carried over from his touring rig, built for studio reliability.',
        vintageValue2026: null,
        modernEquivalent: {
    ...
    totals: {
      originalTotal: 10385,
      inflationAdjusted2026: null, // Calculated dynamically
      vintageTotal2026: 9840,
      modernEquivalentTotal: 11083,
    },

    priceEvolution: [
      { year: 2016, price: 8200, label: 'Joins Megadeth', event: "Joins as touring drummer after Chris Adler recorded Dystopia" },
      { year: 2019, price: 8900, label: 'Full-time drummer', event: 'Confirmed as Megadeth\'s permanent drummer' },
      { year: 2022, price: 10385, label: 'Original Purchase', event: 'Records studio debut, The Sick, the Dying... and the Dead!' },
      { year: 2023, price: 10900, label: 'Grammy nomination', event: "\"We'll Be Back\" nominated for Best Metal Performance, 65th Grammy Awards" },
      { year: 2026, price: 11800, label: 'Current adjusted', event: 'Inflation-adjusted value' },
    ],

    sources: [
      { title: 'Tama Starclassic Maple Custom Catalog', year: 2022, type: 'catalog' },
      { title: 'Meinl Byzance / Classics Custom Dark Retail Pricing Archive', year: 2022, type: 'catalog' },
    ...
    meta: {
      ...
      description: "How much was Dirk Verbeuren's Megadeth studio debut drum kit worth? Original Tama Starclassic Maple Custom + Meinl Byzance setup ~$10,385 in 2022, inflation-adjusted to ~$11,800 today. Complete gear breakdown from The Sick, the Dying... and the Dead! era.",
