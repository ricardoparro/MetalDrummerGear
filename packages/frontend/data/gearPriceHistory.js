...
export const GEAR_PRICE_HISTORY = {
  ...
  'chris-adler': {
    ...
    summary: "Chris Adler's 2004 Mapex Deep Forest setup from Lamb of God's Ashes of the Wake — the album that cemented LoG as leaders of the New Wave of American Heavy Metal, and the record on which Adler debuted his new Mapex endorsement. Adler paired an all-walnut Mapex Deep Forest shell pack with Meinl Byzance cymbals and a Mapex double pedal to produce the precise, powerful groove that defined modern American groove metal drumming. The Deep Forest's all-walnut shells delivered a focused mid-range punch with fast attack, ideal for the tight polyrhythmic patterns and explosive double-kick runs throughout the album. This setup's blend of premium woodworking and pro-grade consistency helped Adler earn a reputation as one of the most technically precise groove metal drummers of his generation, and launched the Mapex relationship that carried through Wrath and Resolution before evolving into his signature Mapex Black Panther Design Lab kit.",

    setup: {
      drums: {
        item: 'Mapex Deep Forest',
        model: '6-piece all-walnut shell pack with double kick',
        specs: '22"x18" kick (×2), 10"x8" rack, 12"x9" rack, 14"x12" floor, 16"x14" floor — natural walnut finish',
        originalPrice: 4000,
        year: 2004,
        source: 'Mapex Deep Forest Series catalog pricing 2004, adjusted for custom configuration',
        notes: "Mapex Deep Forest's all-walnut shells gave Adler a focused, punchy attack ideal for groove metal's precision riffing. The dual 22\" kicks were essential for the alternating kick patterns throughout Ashes of the Wake.",
        vintageValue2026: 3500,
        modernEquivalent: {
          item: 'Mapex Black Panther Design Lab',
          price: 5200,
          link: 'mapex-black-panther-design-lab',
        },
      },
      snare: {
        item: 'Mapex Steel 14"x6.5"',
        model: 'Mapex steel shell snare',
        specs: '14"x6.5" steel shell',
        originalPrice: 450,
        year: 2004,
        source: 'Mapex snare catalog pricing 2004',
        notes: "The steel shell delivered a sharp, bright crack that cut through the dense guitar layers on Ashes of the Wake. Adler's rimshots on tracks like 'Laid to Rest' became a defining sound of mid-2000s metal production.",
        vintageValue2026: 600,
        modernEquivalent: {
          item: 'Mapex Chris Adler Signature 14"x5.5" Walnut/Maple',
          price: 700,
          link: 'mapex-chris-adler-signature-snare',
        },
      },
      cymbals: {
        item: 'Meinl Byzance Series',
        model: 'Mixed Byzance setup',
        specs: '14" Byzance Hi-Hats, 16" Byzance Crash, 18" Byzance Crash, 20" Byzance Ride',
        originalPrice: 1100,
        year: 2004,
        source: 'Meinl Byzance MSRP 2004 catalog pricing',
        notes: "Meinl Byzance cymbals balanced brightness and complexity — their dark, complex B20 bronze character suited Adler's fast hi-hat work and explosive crash accents throughout Ashes of the Wake's dynamic range.",
        vintageValue2026: 750,
        modernEquivalent: {
          item: 'Meinl Byzance Dark Series (Chris Adler current spec)',
          price: 1600,
          link: 'meinl-byzance-dark-chris-adler',
        },
      },
      hardware: {
        item: 'Mapex Hardware + Double Pedal',
        model: 'Mapex hardware and double pedal',
        specs: 'Mapex double pedal, Mapex hi-hat stand, 3× Mapex boom stands, Mapex snare stand',
        originalPrice: 1100,
        year: 2004,
        source: 'Mapex hardware catalog pricing 2004',
        notes: "The Mapex double pedal's cam system gave Adler the fast rebound and consistent stroke needed for the intricate double-kick patterns across Ashes of the Wake.",
        vintageValue2026: 1400,
        modernEquivalent: {
          item: 'Mapex Falcon Double Pedal + Hardware Pack',
          price: 1800,
          link: 'mapex-falcon-double-pedal',
        },
      },
      sticks: {
    ...
    priceEvolution: [
      { year: 2004, price: 6798, label: 'Original Purchase', event: 'Ashes of the Wake recording — Mapex Deep Forest debut' },
      ...
      { year: 2012, price: 8400, label: 'Black Panther Design Lab era', event: 'Adler transitions to Mapex Black Panther Design Lab signature series' },
    ...
    sources: [
      { title: 'Mapex Drums — Chris Adler Artist Page', year: 2026, type: 'manufacturer' },
      ...
      { title: "Uberproaudio — Lamb of God's Chris Adler Drum Gear and Drum Kit", year: 2025, type: 'interview' },
    ],
  ...
  'eloy-casagrande': {
    ...
    summary: "Eloy Casagrande's 2017 Sepultura setup from Machine Messiah — the album that cemented his reputation as one of the most complete heavy metal drummers of his generation. His Mapex Meridian Maple configuration delivered the power, precision, and versatility needed to handle Sepultura's hybrid of thrash, groove metal, and progressive complexity. Casagrande later joined Slipknot in 2023–24, carrying his Tama Starclassic Bubinga and Paiste setup into the band's arena-scale production, expanding to a dual 22\"x16\" / 24\"x14\" bass drum configuration for Slipknot's stadium shows.",
    ...
    priceEvolution: [
      ...
      { year: 2024, price: 5600, label: 'Slipknot touring rig era', event: 'Casagrande expands to dual Tama Starclassic Bubinga bass drums for Slipknot\'s stadium shows' },
    ...
    meta: {
      ...
      description: "How much did Eloy Casagrande's 2017 Sepultura drum kit cost? Original ~$4,124, inflation-adjusted to ~$5,510 today. Complete Mapex Meridian Maple breakdown from the Machine Messiah era, plus his Slipknot-era Tama Starclassic Bubinga touring rig.",
  ...
  'matt-halpern': {
    ...
    setup: {
      drums: {
        ...
        modernEquivalent: {
          item: 'Pearl Reference Series (current spec)',
          price: 7000,
          link: 'pearl-reference-series-matt-halpern',
        },
      },
      snare: {
        item: 'Mapex Black Panther Design Lab',
        ...
        modernEquivalent: {
          ...
          price: 750,
          link: 'pearl-reference-brass-snare-matt-halpern',
        },
      },
      cymbals: {
        item: 'Meinl Byzance Series',
      ...
      hardware: {
        ...
        vintageValue2026: 800,
        modernEquivalent: {
          item: 'Pearl Demon Drive Double Pedal + Pearl D-2000 Throne',
          price: 1100,
          link: 'pearl-demon-drive-matt-halpern',
        },
      },
      sticks: {
    ...
    priceEvolution: [
      ...
      { year: 2019, price: 11800, label: 'Hail Stan era', event: 'Halpern leaves Mapex for Pearl, debuting a Pearl Reference Series kit' },
      { year: 2023, price: 13200, label: 'Periphery V era', event: 'Pearl Reference Series configuration matures on Periphery V' },
  ...
  'george-kollias': {
    ...
    setup: {
      ...
      cymbals: {
        ...
        vintageValue2026: 2400,
        modernEquivalent: {
          item: 'Zildjian K Mastersound / K Custom Dark / A Custom (Current Configuration)',
          price: 3400,
          link: 'zildjian-current-config-kollias',
        },
      },
      hardware: {
        item: 'Tama Iron Cobra HP900 Double Pedal',
    ...
    priceEvolution: [
      ...
      { year: 2023, price: 18000, label: 'Zildjian era', event: 'Kollias leaves Paiste after ~18 years, joins Zildjian cymbals' },
    ...
    sources: [
      ...
      { title: 'Zildjian — George Kollias Artist Page', year: 2023, type: 'manufacturer' },
  ...
  'isaac-lamb': {
    ...
    iconicYear: 2017,
    era: 'Nomad Era',
    albumReference: 'Nomad (2017)',
    profileImage: '/images/drummers/isaac-lamb.webp',

    summary: "Isaac Lamb's 2017 setup behind Kublai Khan TX's Nomad — the Rise Records debut that carried the Sherman, Texas beatdown hardcore band to its largest audience yet — documents the gear behind a drummer who has held the band's only drum chair since its 2009 founding. Built on power-through-restraint groove philosophy rather than technical showmanship, Lamb's Nomad-era rig centered on a boutique SJC Custom Drums kit in American maple, an SJC Custom 14\"x6.5\" maple snare, and a complete Meinl Classics Custom Dark cymbal setup, driven by the DW 9000 Series double pedal. The complete rig cost approximately $6,334 in 2017 dollars, equivalent to roughly $8,466 today after inflation.\n\nEvery component reinforced the specific sonic demands of beatdown hardcore. The SJC shells' tight bearing edges gave Lamb's kick-snare relationship the focused attack and fast decay that let each hit punch through Kublai Khan TX's heavily downtuned 7-string guitars without disappearing into sustain, while the Meinl Classics Custom Dark cymbals' controlled decay prevented cymbal wash from still ringing when the album's crushing breakdowns arrived. The DW 9000's floating rotor and adjustable cam gave his foot technique the versatility to move between mid-tempo groove patterns, blast beats on tracks like \"True Fear,\" and the deliberate, weighted strokes that make Kublai Khan TX's breakdowns register as physical events.\n\nThat SJC / Meinl / DW core proved foundational: it carried Lamb through Absolute (2019) — widely cited as the band's defining statement and his most refined performance — and into Lowest Form of Animal (2022), a testament to a setup built to serve groove-first composition rather than display. Valued at approximately $9,385 at current retail, it remains the rhythmic engine behind one of modern hardcore's most respected and consistent drum chairs.",

    setup: {
      drums: {
        item: 'SJC Custom Drums',
        model: 'American maple shell pack, custom configuration',
        specs: '22" bass drum (DW 9000 double pedal), 10"/12" rack toms, 14"/16" floor toms',
        originalPrice: 3800,
        year: 2017,
        source: 'SJC Custom Drums catalog pricing 2017',
        notes: "Boutique handcrafted maple shells with tight bearing edges chosen for the focused attack and fast decay that beatdown hardcore's dense guitar context demands.",
        vintageValue2026: 3200,
        modernEquivalent: {
          item: 'SJC Custom Drums (Current, configured to spec)',
          price: 5800,
          link: 'sjc-custom-drums-isaac-lamb',
        },
      },
      snare: {
        item: 'SJC Custom Snare',
        model: '14"x6.5" American maple',
        specs: '14" x 6.5" maple shell',
        originalPrice: 450,
        year: 2017,
        source: 'SJC Custom Drums snare catalog pricing 2017',
        notes: "6.5\" depth chosen for the body and backbeat authority that lock absolutely with the kick in Lamb's groove-first approach.",
        vintageValue2026: 380,
        modernEquivalent: {
          item: 'SJC Custom Snare 14"x6.5" (Current)',
          price: 650,
          link: 'sjc-custom-snare-isaac-lamb',
        },
      },
      cymbals: {
        item: 'Meinl Classics Custom Dark Series',
        model: 'Complete Dark series setup',
        specs: '14" Dark hi-hats, 18"/20" Dark crashes, 21" Dark ride, 18" Dark China',
        originalPrice: 1500,
        year: 2017,
        source: 'Meinl Classics Custom Dark Series catalog pricing 2017',
        notes: "Dark series' controlled decay chosen to prevent cymbal wash from ringing into the crushing breakdowns that follow closely in beatdown hardcore arrangements.",
        vintageValue2026: 1300,
        modernEquivalent: {
          item: 'Meinl Classics Custom Dark Series (Current Configuration)',
          price: 2100,
          link: 'meinl-classics-custom-dark-isaac-lamb',
        },
      },
      hardware: {
        item: 'DW 9000 Series Double Pedal',
        model: 'Chain-drive double pedal with floating rotor',
        specs: 'DW 9000 double pedal, hi-hat stand, boom stands, snare stand',
        originalPrice: 480,
        year: 2017,
        source: 'DW hardware catalog pricing 2017',
        notes: "Floating rotor and adjustable cam chosen for versatility across Lamb's mid-tempo groove, blast beat, and weighted breakdown-stroke techniques.",
        vintageValue2026: 380,
        modernEquivalent: {
          item: 'DW 9000 Series Double Pedal (Current)',
          price: 680,
          link: 'dw-9000-double-pedal-isaac-lamb',
        },
      },
      sticks: {
        item: 'Vic Firth American Classic 2B',
        model: 'Hickory, heavy taper',
        specs: 'Hickory, thick 2B profile',
        originalPrice: 9,
        year: 2017,
        source: 'Vic Firth retail pricing 2017',
        notes: "Thicker, heavier profile than standard 5A chosen for the physical weight that makes breakdown strokes register as events.",
        vintageValue2026: null,
        modernEquivalent: {
          item: 'Vic Firth American Classic 2B (Current)',
          price: 15,
          link: 'vic-firth-2b-isaac-lamb',
        },
      },
      heads: {
        item: 'Evans Hydraulic',
        model: 'Oil-filled two-ply batters',
        specs: 'Evans Hydraulic batters across kick, toms, and snare',
        originalPrice: 95,
        year: 2017,
        source: 'Evans retail pricing 2017',
        notes: "Oil-filled construction chosen for the dead, focused attack that beatdown hardcore production aesthetics prioritize over natural resonance.",
        vintageValue2026: null,
        modernEquivalent: {
          item: 'Evans Hydraulic Pro Pack',
          price: 140,
          link: 'evans-hydraulic-isaac-lamb',
        },
      },
    },
    ...
    totals: {
      originalTotal: 6334,
      inflationAdjusted2026: null, // Calculated dynamically
      vintageTotal2026: 5260,
      modernEquivalentTotal: 9385,
    },

    priceEvolution: [
      { year: 2009, price: 1500, label: 'Kublai Khan TX Founding', event: 'Co-founded Kublai Khan in Sherman, Texas on entry-level gear' },
      { year: 2014, price: 4500, label: 'Balancing Survival and Happiness Era', event: 'Signed to Artery Recordings; SJC Custom Drums endorsement relationship developing' },
      { year: 2017, price: 6334, label: 'Original Purchase', event: 'Nomad recorded — Rise Records debut, definitive SJC Custom / Meinl Classics Custom Dark setup established' },
      { year: 2019, price: 6800, label: 'Absolute Era', event: "Same SJC / Meinl / DW core carried into the band's defining statement and Lamb's most refined performance" },
      { year: 2026, price: 8466, label: 'Current adjusted', event: 'Inflation-adjusted value of the 2017 Nomad-era SJC Custom Drums setup' },
    ],

    sources: [
      { title: 'SJC Custom Drums Catalog', year: 2017, type: 'catalog' },
      { title: 'Meinl Classics Custom Dark Series Catalog', year: 2017, type: 'catalog' },
      { title: 'Lambgoat — Isaac Lamb Interview', year: 2019, type: 'interview' },
      { title: 'Reverb Marketplace Analysis — SJC Custom Drums', year: 2025, type: 'market' },
    ],

    meta: {
      title: "Isaac Lamb Drum Setup Cost | Kublai Khan TX Gear Price History",
      description: "How much was Isaac Lamb's Nomad-era SJC Custom drum kit worth? Original ~$6,334 in 2017, inflation-adjusted to ~$8,466 today. Complete gear breakdown from Kublai Khan TX's founding beatdown hardcore drummer.",
      keywords: ['isaac lamb drum setup cost', 'kublai khan tx drum kit price', 'sjc custom drums price', 'isaac lamb gear cost today', 'nomad drum kit price', 'isaac lamb drummer gear cost'],
    },
  },
