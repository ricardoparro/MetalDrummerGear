...
export const GEAR_DATABASE = {
  drums: [
    ...
    { id: 'ocdp-custom-kit', name: 'OCDP Custom Kit', brand: 'ocdp', category: 'drums', tier: 'pro', price: 3000, keywords: ['ocdp', 'orange county', 'custom'] },
  ],
  snare: [
  ...
  hardware: [
    ...
    { id: 'gibraltar-professional', name: 'Gibraltar Professional Series', brand: 'gibraltar', category: 'hardware', tier: 'mid', price: 350, keywords: ['gibraltar', 'professional', 'hardware'] },
  ],
  sticks: [
