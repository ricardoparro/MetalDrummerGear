// Signature licks — Alex Bent (slug: alex-bent)
...
export const licks = {
  "alex-bent-sin-and-sentence-groove": {
    "slug": "alex-bent-sin-and-sentence-groove",
    "name": "The Sin and the Sentence Blast+Groove Hybrid",
    "shortName": "The Sin and the Sentence",
    "drummerId": 25,
    ...
    "tutorial": {
      ...
      "startTime": 0,
      "title": "Trivium — The Sin and the Sentence (Alex Bent Drum Cut)",
      "description": "Official Trivium drum cut isolating Alex Bent's full performance on The Sin and the Sentence, showing blast beats, half-time chorus groove, and blast-to-groove transitions"
    },
    "gearUsed": [
      {
    ...
    "seo": {
      "title": "Alex Bent The Sin and the Sentence - Trivium Drum Tutorial | MetalForge",
      "description": "Learn Alex Bent's blast beat and half-time groove hybrid from Trivium's The Sin and the Sentence. Drum cut breakdown, technique guide, and practice tips.",
      "keywords": [
        "alex bent",
        "the sin and the sentence drums",
        "trivium drumming",
        "blast beat groove hybrid",
        "modern thrash drumming",
        "alex bent technique",
        "trivium drum tutorial"
      ]
    }
  },
  "alex-bent-betrayer-groove": {
    "slug": "alex-bent-betrayer-groove",
    "name": "Betrayer Modern Thrash Fill Sequence",
    "shortName": "Betrayer",
    "drummerId": 25,
    "drummerName": "Alex Bent",
    "drummerSlug": "alex-bent",
    ...
    "tutorial": {
      ...
      "description": "Official Alex Bent drum playthrough for Betrayer, showing double-bass gallop technique, snare accent placement, and linear fill sequences in full detail"
    },
    "gearUsed": [
      {
        "name": "Tama Starclassic Maple Kit",
    ...
    "seo": {
      "title": "Alex Bent Betrayer - Trivium Drum Tutorial | MetalForge",
      "description": "Learn Alex Bent's double-bass gallop and linear fill sequences from Trivium's Betrayer. Official playthrough breakdown, technique guide, and practice tips.",
      "keywords": [
        "alex bent",
        "trivium betrayer drums",
        "modern thrash drumming",
        "double bass gallop",
        "linear drum fills",
        "alex bent playthrough",
        "trivium drum tutorial"
      ]
    }
  },
  "alex-bent-beyond-oblivion-groove": {
    "slug": "alex-bent-beyond-oblivion-groove",
    "name": "Beyond Oblivion Melodic Metal Groove",
    ...
    "tutorial": {
      ...
      "description": "Alex Bent's drum playthrough for Beyond Oblivion, demonstrating dynamic restraint in melodic sections, groove feel at moderate tempo, and controlled double-bass technique"
    },
    "gearUsed": [
      {
        "name": "Zildjian K Custom Hybrid Cymbals",
    ...
    "seo": {
      "title": "Alex Bent Beyond Oblivion - Trivium Drum Tutorial | MetalForge",
      "description": "Learn Alex Bent's dynamic melodic metal groove from Trivium's Beyond Oblivion. Playthrough breakdown, technique guide, and practice tips.",
      "keywords": [
        "alex bent",
        "trivium beyond oblivion drums",
        "melodic metal drumming",
        "dynamic drum control",
        "alex bent playthrough",
  ...
  "alex-bent-beyond-oblivion-drum-setup": {
    ...
    "bpmDisplay": "~132 BPM",
    "timeSignature": "4/4",
    "description": "\"Beyond Oblivion\" from Trivium's 2015 album Silence in the Snow demonstrates a dimension of Alex Bent's drumming that his work with technical death metal outfits like Brain Drill rarely puts on display: the ability to build a melodic metal drum setup that serves the song's emotional landscape without imposing the drummer's technical range on arrangements that call for restraint. Bent's kit for this era is one of the most versatile tools in his arsenal, capable of producing both the explosive attack needed for blast beats and the warm, controlled tone required for melodic passages — and \"Beyond Oblivion\" leans heavily into the latter. The snare tuning for this song sits at a medium pitch that projects clearly in the mix without overwhelming the clean guitar lines, and Bent's stick choice — Vic Firth 5B — provides enough weight for authority on the heavier hits without becoming unwieldy in the delicate verse passages. The double pedal configuration for this era is optimised for control at moderate tempo: the spring tension and beater angle are set for a lighter, more responsive touch than the heavy, planted approach used in blast beat contexts, allowing Bent to produce even, measured kick strokes that add weight beneath the melody without cluttering the low-end space. His Zildjian K Custom Hybrid cymbals bring a warm, slightly dark tone to the arrangement that complements the song's melodic character — the ride has enough wash to smooth out the pulse, and the crash cymbals decay quickly enough that they mark phrase ends without ringing into the next section. The setup and approach together reveal how a technically elite drummer configures their equipment and adjusts their physical approach to serve a song's emotional requirements — a skill as important as any technical capability in a drummer's development.",
    "techniques": [
      "groove-drumming",
      "fill-techniques",
      "double-bass"
