...
export const licks = {
  ...
  "alex-bent-beyond-oblivion-drum-setup": {
    ...
    "bpmDisplay": "~132 BPM",
    "timeSignature": "4/4",
    "description": "\"Beyond Oblivion\" from Trivium's 2015 album Silence in the Snow demonstrates a dimension of Alex Bent's drumming that his work with technical death metal outfits like Brain Drill rarely puts on display: the ability to build a melodic metal drum setup that serves the song's emotional landscape without imposing the drummer's technical range on arrangements that call for restraint. Bent's kit for this era is one of the most versatile tools in his arsenal, capable of producing both the explosive attack needed for blast beats and the warm, controlled tone required for melodic passages — and \"Beyond Oblivion\" leans heavily into the latter. The snare tuning for this song sits at a medium pitch that projects clearly in the mix without overwhelming the clean guitar lines, and Bent's stick choice — Vic Firth 5B — provides enough weight for authority on the heavier hits without becoming unwieldy in the delicate verse passages. The double pedal configuration is optimised for control at moderate tempo: the spring tension and beater angle are set for a lighter, more responsive touch than the heavy, planted approach used in blast beat contexts, allowing Bent to produce even, measured kick strokes that add weight beneath the melody without cluttering the low-end space. His Zildjian K Custom Hybrid cymbals bring a warm, slightly dark tone to the arrangement that complements the song's melodic character — the ride has enough wash to smooth out the pulse, and the crash cymbals decay quickly enough that they mark phrase ends without ringing into the next section. The setup and approach together reveal how a technically elite drummer configures their equipment and adjusts their physical approach to serve a song's emotional requirements — a skill as important as any technical capability in a drummer's development.",
    "techniques": [
      "groove-drumming",
      "fill-techniques",
      "double-bass"
