// Signature licks — Arin Ilejay (slug: arin-ilejay)
...
export const licks = {
  "arin-ilejay-hail-to-the-king-halftime": {
    "slug": "arin-ilejay-hail-to-the-king-halftime",
    "name": "Hail to the King Half-Time Groove",
    "shortName": "Hail to the King",
    "drummerId": 20,
    ...
    "seo": {
      "title": "Arin Ilejay Hail to the King Drums - Avenged Sevenfold Drum Tutorial | MetalForge",
      "description": "Learn Arin Ilejay's half-time groove from Avenged Sevenfold's Hail to the King. Technique breakdown, practice tips, and gear details for this essential A7X drum part.",
      "keywords": [
        "arin ilejay",
        ...
        "avenged sevenfold drum lesson",
        "arin ilejay technique"
      ]
    }
  },
  "arin-ilejay-shepherd-of-fire-double-bass": {
    "slug": "arin-ilejay-shepherd-of-fire-double-bass",
    "name": "Shepherd of Fire Double Bass Drive",
    "shortName": "Shepherd of Fire",
    "drummerId": 20,
    "drummerName": "Arin Ilejay",
    "drummerSlug": "arin-ilejay",
    "band": "Avenged Sevenfold",
    ...
    "seo": {
      "title": "Arin Ilejay Shepherd of Fire Double Bass - Avenged Sevenfold Drum Tutorial | MetalForge",
      "description": "Learn Arin Ilejay's double bass drive from Avenged Sevenfold's Shepherd of Fire. Technique breakdown, practice tips, and gear details for this A7X drum part.",
      "keywords": [
        "arin ilejay",
        "shepherd of fire drums",
        "avenged sevenfold double bass",
        "a7x drum tutorial",
        "heavy metal double bass",
        "avenged sevenfold drum lesson",
        "double bass technique"
      ]
    }
  },
  "arin-ilejay-god-forsaken-fill-cascade": {
    "slug": "arin-ilejay-god-forsaken-fill-cascade",
    "name": "God Forsaken Fill Cascade",
    "shortName": "God Forsaken",
    "drummerId": 20,
    "drummerName": "Arin Ilejay",
    "drummerSlug": "arin-ilejay",
    "band": "Avenged Sevenfold",
    ...
    "seo": {
      "title": "Arin Ilejay God Forsaken Fill Cascade - Avenged Sevenfold Drum Tutorial | MetalForge",
      "description": "Learn Arin Ilejay's high-speed fill cascades from Avenged Sevenfold's God Forsaken. Technique breakdown, practice tips, and gear details.",
      "keywords": [
        "arin ilejay",
        "god forsaken drums",
        "avenged sevenfold fills",
        "a7x drum tutorial",
        "heavy metal fill technique",
        "avenged sevenfold drum lesson",
        "drum fill cascade"
      ]
    }
