// Signature licks — Bill Ward (slug: bill-ward)
// Per-drummer module. Issue #1183. New-file op — no shared-file conflict (#1056).

export const licks = {
  "bill-ward-war-pigs-groove": {
    "slug": "bill-ward-war-pigs-groove",
    "name": "War Pigs Swinging Half-Time Groove",
    "shortName": "War Pigs",
    "drummerId": 30,
    ...
    "seo": {
      "title": "Bill Ward War Pigs Drums - Black Sabbath Drum Tutorial | MetalForge",
      "description": "Learn Bill Ward's swinging half-time groove from Black Sabbath's War Pigs. Video, technique breakdown, and practice tips.",
      "keywords": [
        "bill ward",
        "war pigs drums",
        "black sabbath",
        "classic metal drumming",
        "half-time groove",
        "paranoid"
      ]
    }
  },
  "bill-ward-iron-man-groove": {
    "slug": "bill-ward-iron-man-groove",
    "name": "Iron Man Intro & Verse Groove",
    "shortName": "Iron Man",
    "drummerId": 30,
    "drummerName": "Bill Ward",
    "drummerSlug": "bill-ward",
    ...
    "seo": {
      "title": "Bill Ward Iron Man Drums - Black Sabbath Drum Tutorial | MetalForge",
      "description": "Learn Bill Ward's authoritative groove from Black Sabbath's Iron Man. Video, technique breakdown, and practice tips.",
      "keywords": [
        "bill ward",
        "iron man drums",
        "black sabbath",
        "classic metal drumming",
        "beginner metal drums",
        "paranoid"
      ]
    }
  },
  "bill-ward-nib-shuffle": {
    "slug": "bill-ward-nib-shuffle",
    "name": "N.I.B. Blues-Shuffle Feel",
    "shortName": "N.I.B. Shuffle",
    "drummerId": 30,
    "drummerName": "Bill Ward",
    "drummerSlug": "bill-ward",
    "band": "Black Sabbath",
    ...
    "seo": {
      "title": "Bill Ward N.I.B. Shuffle Drums - Black Sabbath Drum Tutorial | MetalForge",
      "description": "Learn Bill Ward's blues-shuffle groove from Black Sabbath's N.I.B. Video, technique breakdown, and practice tips.",
      "keywords": [
        "bill ward",
        "nib drums",
        "black sabbath",
