// Signature licks — Dave Lombardo (slug: dave-lombardo)
...
export const licks = {
  "dave-lombardo-slayer-reign-in-blood-double-bass": {
    "slug": "dave-lombardo-slayer-reign-in-blood-double-bass",
    "name": "Reign in Blood Double-Bass Pump",
    "shortName": "RiB Double-Bass",
    "drummerId": 4,
    ...
    "techniqueDetails": [
      "Build the sixteenth-note pump pattern on a practice pad with equal weight between both feet",
      "Add the snare backbeat only after the feet are fully solid and even",
      "Lock the kick pattern tightly to the guitar riff's accent contour, not just a generic grid",
      "Maintain a forward-leaning, slightly forceful quality — push the riff rather than underline it",
      "Build tempo gradually, checking evenness at each increment before pushing higher"
    ],
    "video": null,
    "gearUsed": [
      {
    ...
    "seo": {
      "title": "Dave Lombardo Reign in Blood Double Bass - Slayer Drum Tutorial | MetalForge",
      "description": "Learn Dave Lombardo's foundational thrash double-bass pump from Slayer's Reign in Blood. The pattern every metal drummer studies — technique breakdown and practice guide.",
      "keywords": [
        "dave lombardo",
        "reign in blood double bass",
        "slayer double bass",
        "thrash metal double bass",
        "postmortem slayer",
        "foundational thrash drumming"
      ]
    }
  },
  "dave-lombardo-show-no-mercy-tom-run": {
    "slug": "dave-lombardo-show-no-mercy-tom-run",
    "name": "Show No Mercy Speed Tom Cascade",
    "shortName": "Show No Mercy Toms",
    "drummerId": 4,
    "drummerName": "Dave Lombardo",
    "drummerSlug": "dave-lombardo",
    "band": "Slayer",
    ...
    "techniqueDetails": [
      ...
      "Build from slow individual fills to full-song context only once each cascade is clean at tempo"
    ],
    "video": null,
    "gearUsed": [
      {
    ...
    "seo": {
      "title": "Dave Lombardo Show No Mercy Tom Cascade - Slayer Drum Tutorial | MetalForge",
      "description": "Learn Dave Lombardo's raw 1983-era speed tom cascade from Slayer's Show No Mercy. Early thrash fill technique breakdown and practice guide.",
      "keywords": [
        "dave lombardo",
        "show no mercy drums",
        "slayer 1983 drumming",
        "speed tom fill",
        "the antichrist slayer",
        "early thrash metal drums"
      ]
    }
  },
  ...
  "dave-lombardo-seasons-thrash": {
    ...
    "seo": {
      ...
      "keywords": [
        ...
        "dave lombardo groove",
        "slayer mid-tempo",
        "thrash metal groove"
      ]
    }
  },
  "dave-lombardo-raining-blood-lick": {
    "slug": "dave-lombardo-raining-blood-lick",
    "name": "Raining Blood Intro Blast",
    "shortName": "Raining Blood Blast",
    "drummerId": 4,
    "drummerName": "Dave Lombardo",
    "drummerSlug": "dave-lombardo",
    "band": "Slayer",
    ...
    "seo": {
      "title": "Dave Lombardo Raining Blood Blast Intro - Slayer Drum Tutorial | MetalForge",
      "description": "Learn Dave Lombardo's iconic 212 BPM straight sixteenths blast from Slayer's Raining Blood. Reign in Blood technique breakdown, stroke mechanics, and practice guide.",
      "keywords": [
        "dave lombardo",
        "raining blood blast beat",
        "slayer 212 bpm",
        "reign in blood drums",
        "straight sixteenths blast",
        "dave lombardo blast technique"
      ]
    }
  },
  "dave-lombardo-angel-of-death-lick": {
    "slug": "dave-lombardo-angel-of-death-lick",
    "name": "Angel of Death Double-Bass Tornado",
    "shortName": "Angel of Death DB Tornado",
    "drummerId": 4,
    "drummerName": "Dave Lombardo",
    "drummerSlug": "dave-lombardo",
    "band": "Slayer",
    ...
    "seo": {
      "title": "Dave Lombardo Angel of Death Double Bass Tornado - Slayer Tutorial | MetalForge",
      "description": "Learn Dave Lombardo's opening double-bass tornado from Slayer's Angel of Death. Reign in Blood entry technique, four-limb synchronisation, and the founding moment of thrash double-bass.",
      "keywords": [
        "dave lombardo",
        "angel of death double bass",
        "slayer opening drums",
        "reign in blood blast",
        "thrash metal double bass",
        "dave lombardo tornado technique"
      ]
    }
  },
  "dave-lombardo-south-of-heaven-lick": {
    "slug": "dave-lombardo-south-of-heaven-lick",
    "name": "South of Heaven Half-Time Groove",
    "shortName": "South of Heaven",
    "drummerId": 4,
    "drummerName": "Dave Lombardo",
    "drummerSlug": "dave-lombardo",
    "band": "Slayer",
    ...
    "seo": {
      "title": "Dave Lombardo South of Heaven Half-Time Groove - Slayer Tutorial | MetalForge",
      "description": "Learn Dave Lombardo's mid-tempo half-time groove from Slayer's South of Heaven. Dynamic contrast with Reign in Blood, riff-lock kick, and restraint technique breakdown.",
      "keywords": [
        "dave lombardo",
        "south of heaven drums",
        "slayer half time groove",
        "mid tempo thrash",
        "south of heaven 1988",
        "dave lombardo groove technique"
      ]
    }
  }
};
