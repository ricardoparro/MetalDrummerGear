// Signature licks — Gavin Harrison (slug: gavin-harrison)
// Per-drummer module. Issue #1049 (split 3/4 of #1044). New-file op — no shared-file conflict (#1056).

export const licks = {
  "gavin-harrison-anesthetize": {
    "slug": "gavin-harrison-anesthetize",
    "name": "Anesthetize Odd-Time Epic",
    ...
    "tutorial": {
      "youtubeId": "EupOTWOVZck",
      "startTime": 0,
      "title": "Porcupine Tree | Anesthetize (Isolated Drums Track)",
      "description": "Isolated drum track of Gavin Harrison's odd-time, polyrhythmic playing on Anesthetize"
    },
    "gearUsed": [
    ...
    "seo": {
      "title": "Gavin Harrison Anesthetize Drums - Porcupine Tree Drum Lesson | MetalForge",
      "description": "Learn Gavin Harrison's odd-time and polyrhythmic playing from Porcupine Tree's Anesthetize. Isolated drum video, technique steps, and practice tips.",
      "keywords": [
        "gavin harrison",
        "anesthetize drums",
        "porcupine tree",
  ...
  "gavin-harrison-the-sound-of-muzak": {
    "slug": "gavin-harrison-the-sound-of-muzak",
    ...
    "tutorial": {
      ...
      "startTime": 0,
      "title": "Gavin Harrison: The Sound Of Muzak Groove - Drum Lesson | Drumeo",
      "description": "Gavin Harrison breaks down his iconic 7/8 groove from The Sound of Muzak"
    },
    "gearUsed": [
      { "name": "Sonor SQ2 Series Kit", "type": "drums", "link": null },
      { "name": "Sonor Perfect Balance Pedal", "type": "hardware", "link": null }
    ...
    "seo": {
      "title": "Gavin Harrison Sound of Muzak 7/8 Groove - Drum Lesson | MetalForge",
      "description": "Learn Gavin Harrison's iconic 7/8 groove from Porcupine Tree's The Sound of Muzak. Lesson video, limb-pattern steps, and practice tips for odd time.",
      "keywords": [
        "gavin harrison",
        "sound of muzak drums",
        "porcupine tree",
        "7/8 groove",
        "odd time signatures",
  ...
  "gavin-harrison-harridan": {
    "slug": "gavin-harrison-harridan",
    "name": "Harridan Displaced-Fill Study",
    "shortName": "Harridan",
    "drummerId": 47,
    "drummerName": "Gavin Harrison",
    "drummerSlug": "gavin-harrison",
    ...
    "tutorial": {
      "youtubeId": "2LykrTahUyQ",
      "startTime": 0,
      "title": "Porcupine Tree - Harridan: drum fill explained",
      "description": "A breakdown of Gavin Harrison's displaced signature fill from Harridan"
    },
    "gearUsed": [
      { "name": "Sonor SQ2 Series Kit", "type": "drums", "link": null },
      { "name": "Zildjian K Custom Special Dry Cymbals", "type": "cymbals", "link": null },
    ...
    "seo": {
      "title": "Gavin Harrison Harridan Drums - Porcupine Tree Drum Lesson | MetalForge",
      "description": "Learn Gavin Harrison's metric displacement and signature fill from Porcupine Tree's Harridan. Breakdown video, technique steps, and practice tips.",
      "keywords": [
        "gavin harrison",
        "harridan drums",
        "porcupine tree",
