// Signature licks — Hannes Grossmann (slug: hannes-grossmann)
// Per-drummer module. Issue #1129 (split 2/2 of #1123). New-file op — no shared-file conflict (#1056).

export const licks = {
  "hannes-grossmann-alter-magnitudes": {
    "slug": "hannes-grossmann-alter-magnitudes",
    "name": "Alter Magnitudes Tech-Death Workout",
    "shortName": "Alter Magnitudes",
    "drummerId": 56,
    "drummerName": "Hannes Grossmann",
    "drummerSlug": "hannes-grossmann",
    "band": "Hannes Grossmann",
    "song": "Alter Magnitudes",
    "album": "Hannes Grossmann (solo)",
    ...
    "tutorial": {
      "youtubeId": "Fz6kzxOP5WU",
      "startTime": 0,
      "title": "Hannes Grossmann - Alter Magnitudes (drum playthrough)",
      "description": "Hannes Grossmann's drum playthrough showcasing his precise tech-death double bass and odd-time phrasing"
    },
    "gearUsed": [
    ...
    "seo": {
      "title": "Hannes Grossmann Alter Magnitudes - Tech-Death Drum Lesson | MetalForge",
      "description": "Learn Hannes Grossmann's precise tech-death double bass and odd-time phrasing from Alter Magnitudes. Drum playthrough video, technique steps, and tips.",
      "keywords": [
        "hannes grossmann",
        "alter magnitudes drums",
  ...
  "hannes-grossmann-in-turmoils-swirling-reaches": {
    "slug": "hannes-grossmann-in-turmoils-swirling-reaches",
    "name": "In Turmoil's Swirling Reaches Polyrhythm Study",
    "shortName": "In Turmoil's Swirling Reaches",
    "drummerId": 56,
    "drummerName": "Hannes Grossmann",
    "drummerSlug": "hannes-grossmann",
    "band": "Alkaloid",
    "song": "In Turmoil's Swirling Reaches",
    "album": "Alkaloid",
    "category": "signature-pattern",
    ...
    "tutorial": {
      "youtubeId": "bnv9AJzV2Ig",
      "startTime": 0,
      "title": "Hannes Grossmann | Alkaloid - In Turmoil's Swirling Reaches (drum playthrough)",
      "description": "Hannes Grossmann's Alkaloid playthrough demonstrating polyrhythmic layering and mixed meter"
    },
    "gearUsed": [
      { "name": "DW Collectors Series Kit", "type": "drums", "link": null },
      { "name": "Meinl Byzance Cymbals", "type": "cymbals", "link": null },
    ...
    "seo": {
      "title": "Hannes Grossmann Alkaloid Polyrhythm - Prog Drum Lesson | MetalForge",
      "description": "Learn Hannes Grossmann's polyrhythmic layering and mixed meter from Alkaloid's In Turmoil's Swirling Reaches. Playthrough video, steps, and practice tips.",
      "keywords": [
        "hannes grossmann",
        "alkaloid drums",
        "polyrhythms drumming",
  ...
  "hannes-grossmann-septuagint-odd-time": {
    "slug": "hannes-grossmann-septuagint-odd-time",
    "name": "Septuagint Odd-Time Mastery",
    ...
    "tutorial": {
      "youtubeId": "ZsPU41SlbDI",
      "startTime": 0,
      "title": "Hannes Grossmann (Obscura) - Odd Time Signatures Lesson",
    ...
    "seo": {
      "title": "Hannes Grossmann Septuagint Odd Time - Obscura Drum Lesson | MetalForge",
      "description": "Learn Hannes Grossmann's odd-time signature approach from Obscura's Septuagint. Lesson video, subdivision steps, and practice tips for 7/8 and 5/8 grooves.",
      "keywords": [
        "hannes grossmann",
        "septuagint drums",
        "obscura",
