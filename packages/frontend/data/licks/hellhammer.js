// Signature licks — Hellhammer (slug: hellhammer)
// Per-drummer module. Issue #1187 (SEO batch: extreme/black metal tier).

export const licks = {
  "hellhammer-freezing-moon-blast": {
    "slug": "hellhammer-freezing-moon-blast",
    "name": "Freezing Moon — Atmospheric Black Metal Blast",
    "shortName": "Freezing Moon",
    "drummerId": 22,
    ...
    "tutorial": {
      "youtubeId": "NcK8-AUqj5g",
      "startTime": 0,
      "title": "Mayhem - Freezing Moon - Wacken Open Air 2024 (LIVE)(OFFICIAL VIDEO)",
    ...
    "seo": {
      "title": "Hellhammer Freezing Moon Drums - Mayhem Black Metal Blast Tutorial | MetalForge",
      "description": "Learn Hellhammer's atmospheric blast beat technique from Mayhem's iconic Freezing Moon. Official Wacken 2024 live video, technique steps, and practice tips.",
      "keywords": [
        "hellhammer mayhem drums",
        "freezing moon blast beat",
        "mayhem drum technique",
        "hellhammer drum technique",
        "black metal drumming",
        "de mysteriis dom sathanas drums"
      ]
    }
  },
  "hellhammer-deathcrush-battery": {
    "slug": "hellhammer-deathcrush-battery",
    "name": "Deathcrush — Speed Metal Battery",
    "shortName": "Deathcrush",
    "drummerId": 22,
    "drummerName": "Hellhammer",
    "drummerSlug": "hellhammer",
    "band": "Mayhem",
    ...
    "seo": {
      "title": "Hellhammer Deathcrush Drums - Mayhem Speed Metal Battery Tutorial | MetalForge",
      "description": "Learn Hellhammer's foundational black metal battery from Mayhem's Deathcrush EP. Official live video, technique breakdown, and practice tips.",
      "keywords": [
        "hellhammer deathcrush drums",
        "mayhem deathcrush",
        "hellhammer drum technique",
  ...
  "hellhammer-de-mysteriis-blast": {
    "slug": "hellhammer-de-mysteriis-blast",
    "name": "De Mysteriis Dom Sathanas — Long-Form Black Metal Mastery",
    "shortName": "De Mysteriis Dom Sathanas",
    "drummerId": 22,
    "drummerName": "Hellhammer",
    "drummerSlug": "hellhammer",
    "band": "Mayhem",
    "song": "De Mysteriis Dom Sathanas",
    "album": "De Mysteriis Dom Sathanas (1994)",
    ...
    "seo": {
      "title": "Hellhammer De Mysteriis Dom Sathanas Drums - Mayhem Black Metal Lesson | MetalForge",
      "description": "Learn Hellhammer's long-form black metal technique from Mayhem's De Mysteriis Dom Sathanas title track. Video, technique breakdown, and practice tips.",
      "keywords": [
        "hellhammer mayhem",
        "de mysteriis dom sathanas drums",
        "mayhem drum technique",
