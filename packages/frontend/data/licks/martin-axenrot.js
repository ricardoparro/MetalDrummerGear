// Signature licks — Martin Axenrot (slug: martin-axenrot)
// Per-drummer module following the pattern from Issue #1056.
// Added as part of Issue #3700: closes lick coverage to 62/62 roster drummers.

export const licks = {
  "martin-axenrot-devils-orchard-meter-shifts": {
    "slug": "martin-axenrot-devils-orchard-meter-shifts",
    "name": "The Devil's Orchard — Odd-Meter Groove Command",
    "shortName": "The Devil's Orchard",
    "drummerId": 62,
    "drummerName": "Martin Axenrot",
    ...
    "tutorial": {
      "youtubeId": "FxvN_GxgpF8",
      "startTime": 0,
      "title": "Opeth - The Devil's Orchard [OFFICIAL VIDEO]",
    ...
    "seo": {
      "title": "Martin Axenrot The Devil's Orchard Drum Tutorial - Opeth Heritage | MetalForge",
      "description": "Learn Martin Axenrot's odd-meter groove command from Opeth's Heritage track The Devil's Orchard. Official video, technique breakdown, and practice tips for progressive metal drumming.",
      "keywords": [
        "martin axenrot opeth drums",
        "the devil's orchard drum lesson",
        "opeth heritage drumming",
        "martin axenrot odd meter technique",
        "progressive death metal drums",
        "opeth drummer technique"
      ]
    }
  },
  "martin-axenrot-sorceress-riff-lock": {
    "slug": "martin-axenrot-sorceress-riff-lock",
    "name": "Sorceress — Heavy Riff-Lock and Live Dynamics",
    "shortName": "Sorceress",
    "drummerId": 62,
    "drummerName": "Martin Axenrot",
    "drummerSlug": "martin-axenrot",
    ...
    "tutorial": {
      "youtubeId": "cHt4KNTgujQ",
      "startTime": 0,
      "title": "OPETH - Sorceress (Official Live Video)",
    ...
    "seo": {
      "title": "Martin Axenrot Sorceress Drum Tutorial - Opeth Riff-Lock Groove | MetalForge",
      "description": "Learn Martin Axenrot's heavy riff-lock groove from Opeth's title track Sorceress. Official live video, technique breakdown, and practice tips for progressive death metal drumming.",
      "keywords": [
        "martin axenrot opeth drums",
        "sorceress opeth drum lesson",
        "opeth sorceress drumming",
        "martin axenrot groove technique",
        "progressive death metal drums",
        "opeth drummer tutorial"
      ]
    }
  }
};
