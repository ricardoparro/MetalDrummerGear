// Signature licks — Nicko McBrain (slug: nicko-mcbrain)
// Per-drummer module. Issue #1154 (split 1/2 of #1124). New-file op — no shared-file conflict (#1056).

export const licks = {
  "nicko-mcbrain-the-trooper": {
    "slug": "nicko-mcbrain-the-trooper",
    "name": "The Trooper Galloping Groove",
    "shortName": "The Trooper",
    "drummerId": 41,
    ...
    "tutorial": {
      "youtubeId": "HiPUlLKEI7U",
      "startTime": 0,
      "title": "Nicko McBrain - The Trooper",
    ...
    "seo": {
      "title": "Nicko McBrain The Trooper Drums - Iron Maiden Drum Lesson | MetalForge",
      "description": "Learn Nicko McBrain's galloping groove and fills from Iron Maiden's The Trooper. Performance video, technique steps, and practice tips.",
      "keywords": [
        "nicko mcbrain",
        "the trooper drums",
        "iron maiden",
  ...
  "nicko-mcbrain-aces-high": {
    "slug": "nicko-mcbrain-aces-high",
    "name": "Aces High Full-Throttle Drive",
    "shortName": "Aces High",
    "drummerId": 41,
    "drummerName": "Nicko McBrain",
    "drummerSlug": "nicko-mcbrain",
    ...
    "tutorial": {
      "youtubeId": "98ioFmT8PO0",
      "startTime": 0,
      "title": "Iron Maiden - Nicko McBrain drum-cam compilation (Legacy of the Beast Tour)",
    ...
    "seo": {
      "title": "Nicko McBrain Aces High Drums - Iron Maiden Drum Lesson | MetalForge",
      "description": "Learn Nicko McBrain's driving groove and stamina from Iron Maiden's Aces High. Drum-cam video, technique steps, and practice tips.",
      "keywords": [
        "nicko mcbrain",
        "aces high drums",
        "iron maiden",
  ...
  "nicko-mcbrain-the-number-of-the-beast": {
    "slug": "nicko-mcbrain-the-number-of-the-beast",
    "name": "The Number of the Beast Live Groove",
    "shortName": "Number of the Beast",
    "drummerId": 41,
    "drummerName": "Nicko McBrain",
    "drummerSlug": "nicko-mcbrain",
    "band": "Iron Maiden",
    ...
    "tutorial": {
      "youtubeId": "nTdxEIDMKVk",
      "startTime": 0,
      "title": "Nicko McBrain - The Number of the Beast (Live)",
      "description": "Nicko McBrain's live interpretation of the Iron Maiden classic, showing his driving groove and fills"
    },
    "gearUsed": [
    ...
    "seo": {
      "title": "Nicko McBrain Number of the Beast Drums - Iron Maiden Lesson | MetalForge",
      "description": "Learn Nicko McBrain's live groove and fills on Iron Maiden's The Number of the Beast. Live video, technique steps, and practice tips.",
      "keywords": [
        "nicko mcbrain",
