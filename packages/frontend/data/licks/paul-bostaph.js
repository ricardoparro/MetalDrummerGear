// Signature licks — Paul Bostaph (slug: paul-bostaph)
// Per-drummer module extracted following the pattern from Issue #1056.
// Added as part of Issue #1217: thrash-metal revival + metalcore gap batch.

export const licks = {
  "paul-bostaph-raining-blood-double-bass": {
    "slug": "paul-bostaph-raining-blood-double-bass",
    "name": "Raining Blood Intro Double Bass Assault",
    ...
    "band": "Slayer",
    "song": "Raining Blood",
    "album": "Reign in Blood (1986) — live staple of Bostaph's tenure",
    ...
    "seo": {
      "title": "Paul Bostaph Raining Blood - Slayer Drum Tutorial | MetalForge",
      "description": "Learn Paul Bostaph's extreme double bass technique from Slayer's Raining Blood. Breakdown of 220 BPM heel-up double kick, hi-hat lock, and practice tips for thrash metal drumming.",
      "keywords": [
        "paul bostaph",
        "raining blood drums",
        "slayer drummer",
        "thrash metal double bass",
        "paul bostaph technique",
        "reign in blood drums",
        "extreme double bass tutorial"
      ]
    }
  },
  "paul-bostaph-disciple-speed-groove": {
    "slug": "paul-bostaph-disciple-speed-groove",
    "name": "Disciple Thrash Speed Groove",
    "shortName": "Disciple",
    "drummerId": 16,
    "drummerName": "Paul Bostaph",
    "drummerSlug": "paul-bostaph",
    ...
    "seo": {
      "title": "Paul Bostaph Disciple - Slayer Drum Tutorial | MetalForge",
      "description": "Learn Paul Bostaph's thrash speed groove from Slayer's Disciple. Kick precision, hi-hat dynamics, and thrash fill economy — technique guide and practice tips.",
      "keywords": [
        "paul bostaph",
        "disciple slayer drums",
        "slayer drummer",
        "thrash metal groove",
        "paul bostaph god hates us all",
        "slayer drum tutorial",
        "thrash drum technique"
      ]
    }
  },
  "paul-bostaph-war-ensemble-blast": {
    "slug": "paul-bostaph-war-ensemble-blast",
    "name": "War Ensemble Thrash Blast Pattern",
    "shortName": "War Ensemble",
    "drummerId": 16,
    "drummerName": "Paul Bostaph",
    "drummerSlug": "paul-bostaph",
    "band": "Slayer",
    "song": "War Ensemble",
    "album": "Seasons in the Abyss (1990) — live staple of Bostaph's tenure",
    "category": "blast-beat",
    "style": "thrash-metal",
    "difficulty": "expert",
    "difficultyRating": 5,
    ...
    "seo": {
      "title": "Paul Bostaph War Ensemble - Slayer Drum Tutorial | MetalForge",
      "description": "Learn Paul Bostaph's thrash blast technique from Slayer's War Ensemble. Blast-to-groove transitions, 210 BPM blast patterns, and stamina tips for extreme metal drumming.",
      "keywords": [
        "paul bostaph",
        "war ensemble drums",
        "slayer blast beat",
        ...
        "extreme metal drumming tutorial"
      ]
    }
  }
};
