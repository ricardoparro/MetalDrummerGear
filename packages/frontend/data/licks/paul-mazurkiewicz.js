// Signature licks — Paul Mazurkiewicz (slug: paul-mazurkiewicz)
// Per-drummer module. Issue #1184. New-file op — no shared-file conflict (#1056).

export const licks = {
  "paul-mazurkiewicz-hammer-smashed-face": {
    "slug": "paul-mazurkiewicz-hammer-smashed-face",
    "name": "Hammer Smashed Face Blast & Groove Blueprint",
    "shortName": "Hammer Smashed Face",
    "drummerId": 51,
    ...
    "tutorial": {
      "youtubeId": "KxcfdLzfrzg",
      "startTime": 0,
      "title": "Paul Mazurkiewicz (Cannibal Corpse) - 'Hammer Smashed Face' live drum cam",
    ...
    "seo": {
      "title": "Paul Mazurkiewicz Hammer Smashed Face - Cannibal Corpse Drum Lesson | MetalForge",
      "description": "Learn Paul Mazurkiewicz's blast-beat and groove blueprint from Cannibal Corpse's Hammer Smashed Face. Live drum cam, technique steps, and practice tips.",
      "keywords": [
        "paul mazurkiewicz",
  ...
  "paul-mazurkiewicz-tomb-of-the-mutilated": {
    "slug": "paul-mazurkiewicz-tomb-of-the-mutilated",
    "name": "Tomb of the Mutilated Double-Bass Assault",
    "shortName": "Tomb of the Mutilated",
    "drummerId": 51,
    "drummerName": "Paul Mazurkiewicz",
    "drummerSlug": "paul-mazurkiewicz",
    "band": "Cannibal Corpse",
    "song": "Tomb of the Mutilated",
    "album": "Tomb of the Mutilated (1992)",
    "category": "signature-pattern",
    "style": "death-metal",
    "difficulty": "expert",
    ...
    "seo": {
      "title": "Paul Mazurkiewicz Tomb of the Mutilated - Cannibal Corpse Drum Lesson | MetalForge",
      "description": "Learn Paul Mazurkiewicz's sustained double-bass assault from Cannibal Corpse's Tomb of the Mutilated. Technique steps and practice tips.",
      "keywords": [
        "paul mazurkiewicz",
  ...
  "paul-mazurkiewicz-evisceration-plague": {
    "slug": "paul-mazurkiewicz-evisceration-plague",
    "name": "Evisceration Plague Death-Metal Pocket Groove",
    "shortName": "Evisceration Plague",
    "drummerId": 51,
    "drummerName": "Paul Mazurkiewicz",
    "drummerSlug": "paul-mazurkiewicz",
    "band": "Cannibal Corpse",
    "song": "Evisceration Plague",
    "album": "Evisceration Plague (2009)",
    "category": "signature-pattern",
    "style": "death-metal",
    "difficulty": "advanced",
    "difficultyRating": 4,
    ...
    "tutorial": {
      "youtubeId": "ztzi8Dk9OmM",
      "startTime": 0,
      "title": "Paul Mazurkiewicz (Cannibal Corpse) - 'Evisceration Plague' live drum cam",
    ...
    "seo": {
      "title": "Paul Mazurkiewicz Evisceration Plague - Cannibal Corpse Drum Lesson | MetalForge",
      "description": "Learn Paul Mazurkiewicz's death metal pocket groove from Cannibal Corpse's Evisceration Plague. Live drum cam, technique steps, and practice tips.",
      "keywords": [
        "paul mazurkiewicz",
