// Signature licks — Raymond Herrera (slug: raymond-herrera)
// Per-drummer module extracted following the pattern from Issue #1056.
// Added as part of Issue #1212: SEO batch — industrial metal + tech-death tier.

export const licks = {
  "raymond-herrera-replica-double-bass": {
    "slug": "raymond-herrera-replica-double-bass",
    "name": "Replica Machine-Gun Double Bass",
    "shortName": "Replica",
    "drummerId": 19,
    ...
    "seo": {
      "title": "Raymond Herrera Replica Drum Tutorial - Fear Factory Double Bass | MetalForge",
      "description": "Learn Raymond Herrera's machine-gun double bass technique from Fear Factory's Replica (Demanufacture). Trigger setup, technique breakdown, and practice tips for industrial metal drumming.",
      "keywords": [
        "raymond herrera drums",
        "fear factory replica drums",
        "industrial metal drumming",
        "double bass technique",
        "fear factory demanufacture",
        "raymond herrera double bass",
        "triggered drum technique"
      ]
    }
  },
  "raymond-herrera-edgecrusher-groove": {
    "slug": "raymond-herrera-edgecrusher-groove",
    "name": "Edgecrusher Industrial Groove Pattern",
    "shortName": "Edgecrusher",
    "drummerId": 19,
    "drummerName": "Raymond Herrera",
    "drummerSlug": "raymond-herrera",
    "band": "Fear Factory",
    ...
    "seo": {
      "title": "Raymond Herrera Edgecrusher Drum Tutorial - Fear Factory Groove | MetalForge",
      "description": "Learn Raymond Herrera's industrial groove pattern and syncopated kick technique from Fear Factory's Edgecrusher. Technique breakdown and practice tips for industrial metal drumming.",
      "keywords": [
        "raymond herrera drums",
        "fear factory edgecrusher drums",
        "industrial metal groove",
        "fear factory obsolete",
        "groove metal drumming",
        "raymond herrera technique",
        "syncopated kick pattern"
      ]
    }
  },
  "raymond-herrera-linchpin-snare-bass": {
    "slug": "raymond-herrera-linchpin-snare-bass",
    "name": "Linchpin Snare & Bass Interplay",
    "shortName": "Linchpin",
    "drummerId": 19,
    "drummerName": "Raymond Herrera",
    "drummerSlug": "raymond-herrera",
    ...
    "seo": {
      "title": "Raymond Herrera Linchpin Drum Tutorial - Fear Factory Fills & Interplay | MetalForge",
      "description": "Learn Raymond Herrera's snare and bass drum interplay from Fear Factory's Linchpin. Fill technique, dynamic shifts, and practice tips for industrial metal drumming.",
      "keywords": [
        "raymond herrera drums",
        "fear factory linchpin drums",
        "industrial metal fills",
        "fear factory digimortal",
        "snare bass interplay",
        "raymond herrera fill technique",
        "industrial metal drum lesson"
      ]
    }
  }
};
