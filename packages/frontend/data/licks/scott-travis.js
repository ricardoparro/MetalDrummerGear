// Signature licks — Scott Travis (slug: scott-travis)
// Per-drummer module. Issue #1154 (split 1/2 of #1124). New-file op — no shared-file conflict (#1056).

export const licks = {
  "scott-travis-painkiller": {
    "slug": "scott-travis-painkiller",
    "name": "Painkiller Double-Bass Intro & Assault",
    ...
    "tutorial": {
      "youtubeId": "xZv2wVL4vfE",
      "startTime": 0,
      "title": "Judas Priest - Painkiller - Scott Travis (Isolated Drums)",
    ...
    "seo": {
      "title": "Scott Travis Painkiller Drums - Judas Priest Drum Lesson | MetalForge",
      "description": "Learn Scott Travis's legendary double-bass intro and assault from Judas Priest's Painkiller. Isolated drum video, technique steps, and practice tips.",
      "keywords": [
        "scott travis",
        "painkiller drums",
        "judas priest",
  ...
  "scott-travis-breaking-the-law": {
    "slug": "scott-travis-breaking-the-law",
    "name": "Breaking the Law Live Drive",
    ...
    "tutorial": {
      "youtubeId": "2WfaJKLn_No",
      "startTime": 0,
      "title": "Judas Priest - Breaking the Law (Live) - Isolated Drums",
      "description": "Scott Travis's live drum track for Breaking the Law, showing his powerful, locked-in groove"
    },
    "gearUsed": [
    ...
    "seo": {
      "title": "Scott Travis Breaking the Law Drums - Judas Priest Lesson | MetalForge",
      "description": "Learn Scott Travis's powerful live groove on Judas Priest's Breaking the Law. Live drum video, technique steps, and practice tips for feel and time.",
      "keywords": [
        "scott travis",
        "breaking the law drums",
        "judas priest",
        "rock groove",
        "heavy metal drumming",
        "british steel"
  ...
  "scott-travis-living-after-midnight": {
    "slug": "scott-travis-living-after-midnight",
    "name": "Living After Midnight Backbeat Power",
    "shortName": "Living After Midnight",
    "drummerId": 42,
    "drummerName": "Scott Travis",
    "drummerSlug": "scott-travis",
    "band": "Judas Priest",
    ...
    "tutorial": {
      "youtubeId": "q3fnmRf3nUo",
      "startTime": 0,
      "title": "Judas Priest - Living After Midnight (Live) - Isolated Drums",
      "description": "Scott Travis's live drum track for Living After Midnight, showing his powerful in-the-pocket backbeat"
    },
    "gearUsed": [
      { "name": "ddrum Dominion Series Kit", "type": "drums", "link": null },
      { "name": "Paiste RUDE & 2002 Cymbals", "type": "cymbals", "link": null },
    ...
    "seo": {
      "title": "Scott Travis Living After Midnight Drums - Judas Priest Lesson | MetalForge",
      "description": "Learn Scott Travis's powerful in-the-pocket backbeat on Judas Priest's Living After Midnight. Live drum video, technique steps, and practice tips.",
      "keywords": [
        "scott travis",
        "living after midnight drums",
        "judas priest",
        "backbeat groove",
        "heavy metal drumming",
        "british steel"
