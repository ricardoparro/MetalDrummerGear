...
export const metalSongs = [
  ...
  { id: 9, slug: "raining-blood", song: "Raining Blood", band: "Slayer", album: "Reign in Blood", year: 1986, bpm: 216, genre: "thrash-metal", drummer: "dave-lombardo", source: "GetSongBPM: 216 BPM (corrected from a prior 225 estimate)", metaTitle: "Raining Blood — 216 BPM | Thrash Drum Tempo | MetalForge" },
  { id: 10, slug: "angel-of-death", song: "Angel of Death", band: "Slayer", album: "Reign in Blood", year: 1986, bpm: 212, genre: "thrash-metal", drummer: "dave-lombardo", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "Angel of Death — 212 BPM | Thrash Drum Tempo | MetalForge" },
  ...
  { id: 20, slug: "unsainted", song: "Unsainted", band: "Slipknot", album: "We Are Not Your Kind", year: 2019, bpm: 145, genre: "nu-metal", drummer: "jay-weinberg", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "Unsainted — 145 BPM | Slipknot Drum Tempo | MetalForge" },
  { id: 21, slug: "walk", song: "Walk", band: "Pantera", album: "Vulgar Display of Power", year: 1992, bpm: 114, genre: "groove-metal", drummer: "vinnie-paul", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "Walk — 114 BPM | Pantera Drum Tempo | MetalForge" },
  ...
  { id: 52, slug: "laid-to-rest", song: "Laid to Rest", band: "Lamb of God", album: "Ashes of the Wake", year: 2004, bpm: 130, genre: "groove-metal", drummer: "chris-adler", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "Laid to Rest — 130 BPM | Lamb of God Drum Tempo | MetalForge" },
  ...
  { id: 66, slug: "the-trooper", song: "The Trooper", band: "Iron Maiden", album: "Piece of Mind", year: 1983, bpm: 160, genre: "heavy-metal", drummer: "nicko-mcbrain", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "The Trooper — 160 BPM | Iron Maiden Drum Tempo | MetalForge" },
  ...
  { id: 76, slug: "crystal-mountain", song: "Crystal Mountain", band: "Death", album: "Symbolic", year: 1995, bpm: 148, genre: "death-metal", drummer: "gene-hoglan", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "Crystal Mountain — 148 BPM | Death Drum Tempo | MetalForge", metaDescription: "Crystal Mountain drum tempo: 148 BPM (Thrash/Power range). Gene Hoglan's performance on Death's Symbolic (1995) — see the full tempo breakdown and how it compares to other death metal songs." },
  ...
  { id: 105, slug: "my-own-summer-shove-it", song: "My Own Summer (Shove It)", band: "Deftones", album: "Around the Fur", year: 1997, bpm: 98, genre: "alternative-metal", drummer: "abe-cunningham", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "My Own Summer (Shove It) — 98 BPM | Deftones Drum Tempo | MetalForge", metaDescription: "My Own Summer (Shove It) drum tempo: 98 BPM (Groove/Heavy range). Abe Cunningham's performance on Deftones' Around the Fur (1997) — see the full tempo breakdown and related alternative-metal tracks." },
  ...
  { id: 183, slug: "blackened", song: "Blackened", band: "Metallica", album: "...And Justice for All", year: 1988, bpm: 190, genre: "thrash-metal", drummer: "lars-ulrich", source: "tab/lesson tempo consensus (Ultimate Guitar, Songsterr, drum-cover community) cross-checked against the recording", metaTitle: "Blackened — 190 BPM | Thrash Drum Tempo | MetalForge" },
