...
export const SIGNATURE_LICKS = {
  ...
  // ===== Mike Mangini (id 52, Dream Theater) — #1050 (split 4/4 of #1044) =====
  'mike-mangini-on-the-backs-of-angels-groove': {
    slug: 'mike-mangini-on-the-backs-of-angels-groove',
    name: 'On the Backs of Angels Odd-Time Groove',
    shortName: 'On the Backs of Angels',
    drummerId: 52,
    drummerName: 'Mike Mangini',
    drummerSlug: 'mike-mangini',
    band: 'Dream Theater',
    song: 'On the Backs of Angels',
    ...
    bpm: 130,
    bpmDisplay: '~130 BPM',
    timeSignature: '4/4 with odd-time sections',
    description: "\"On the Backs of Angels\" was the lead single from A Dramatic Turn of Events, the 2011 album that introduced Mike Mangini as Dream Theater's drummer, and it carried enormous expectation: he was stepping into the seat of one of progressive metal's most revered players. Mangini answered with a performance that balances technical command and genuine musicality. The track moves through several distinct sections — a brooding intro, driving instrumental passages, soaring choruses and intricate unison figures with the guitar and keyboards — and Mangini's drumming threads them together with precise time, controlled double bass and tasteful fills that punctuate each transition without ever cluttering the arrangement. His command of odd-time figures is on full display, but what stands out is how naturally he makes them flow, locking the band's complex stops and accents while keeping the groove driving forward. For drummers, this song is a superb study in progressive-metal playing: navigating shifting meters and sectional changes, executing tight unison hits with the rest of the band, and choosing fills that serve the composition rather than show off. It develops your reading of song structure, your four-limb coordination through odd-time and metric shifts, and your ability to play complex material with a relaxed, musical feel. Mangini's double-bass work here is fast and even but always tasteful, and his cymbal choices clearly delineate each section, teaching the value of orchestration around the kit. Learning even sections of it sharpens your sense of dynamics and arrangement awareness — the discipline to lock the band's hits, drive the choruses, and pull back in the verses. As Mangini's recorded debut with Dream Theater, it is both a milestone performance and an ideal gateway into his technical-yet-musical approach, rewarding patient, section-by-section practice and a real focus on locking the band's unisons cleanly and confidently.",
    techniques: ['odd-time-signatures', 'double-bass', 'fill-techniques'],
    techniqueDetails: [
      'Navigate the shifting meters and sectional changes cleanly',
      'Lock tight unison hits with the guitar and keyboards',
      'Drive the choruses with fast, even, tasteful double bass',
      'Choose fills that punctuate transitions without cluttering',
      'Use cymbal orchestration to delineate each section clearly',
    ],
    tutorial: {
      youtubeId: 'oTJRivZTMLs',
      startTime: 0,
      title: 'Dream Theater - On The Backs Of Angels [OFFICIAL VIDEO]',
      description: "Mike Mangini's odd-time groove and unisons on On the Backs of Angels",
    },
    gearUsed: [
      { name: 'Pearl Reference Series Drums', type: 'drums', link: null },
      { name: 'Sabian HHX & AAX Cymbals', type: 'cymbals', link: null },
      { name: 'Pearl Demon Drive Double Pedal', type: 'pedals', link: null },
    ],
    learningTips: [
      'Practise each section in isolation before joining them together',
      'Count the odd-time passages until the band hits feel natural',
      'Keep the double bass even and relaxed rather than forcing speed',
      'Play along with the track to lock the unison accents precisely',
    ],
    seo: {
      title: 'Mike Mangini On the Backs of Angels - Dream Theater Drum Tutorial | MetalForge',
      description: "Learn Mike Mangini's odd-time groove from Dream Theater's On the Backs of Angels. Video, technique breakdown, and practice tips.",
      keywords: ['mike mangini', 'on the backs of angels drums', 'dream theater', 'progressive metal drumming', 'odd time signature', 'a dramatic turn of events'],
    },
  },
  'mike-mangini-the-looking-glass-groove': {
    slug: 'mike-mangini-the-looking-glass-groove',
    name: 'The Looking Glass Driving Groove',
    shortName: 'The Looking Glass',
    drummerId: 52,
    drummerName: 'Mike Mangini',
    drummerSlug: 'mike-mangini',
    band: 'Dream Theater',
    song: 'The Looking Glass',
    album: 'A Dramatic Turn of Events (2011)',
    category: 'main-groove',
    style: 'progressive-metal',
    difficulty: 'intermediate',
    ...
    bpmDisplay: '~140 BPM',
    timeSignature: '4/4',
    description: "\"The Looking Glass\" from A Dramatic Turn of Events is Dream Theater's affectionate nod to the classic Rush sound, and it gives Mike Mangini a chance to show a different, more straight-ahead side of his playing. Where much of his work with the band lives in complex odd time, this track rides a driving, mostly 4/4 rock groove with an irresistible forward momentum. Mangini's part is built on a solid backbeat, a busy but tasteful hi-hat and ride pattern, and a flowing series of fills that lift each section — the kind of melodic, around-the-kit fills that recall the great progressive-rock drummers who influenced the band. It is a reminder that technical players are at their best when they serve the song, and Mangini drives this one with energy and polish rather than complexity for its own sake. For drummers, \"The Looking Glass\" is an accessible and rewarding study in driving rock groove and fill vocabulary: holding a steady, energetic backbeat, developing smooth single-stroke fills that move musically around the toms, and using the ride and hi-hat to build intensity across the song. Because it sits largely in straight time, it is approachable for intermediate players while still offering plenty to study in feel, dynamics and fill phrasing. Learning it develops your pocket, your fill ideas and your sense of how to drive a song with momentum and taste. It also shows how Mangini adapts his enormous technique to a more song-oriented context — choosing the right fill in the right place, keeping the groove buoyant, and channelling the prog-rock tradition Dream Theater grew out of. It is an ideal track for working on energetic rock drumming and clean, musical fills, and it pairs beautifully with the band's more complex material as a study in restraint and forward drive.",
    techniques: ['groove-drumming', 'fill-techniques', 'single-stroke-roll'],
    techniqueDetails: [
      'Hold a steady, energetic 4/4 rock backbeat with forward drive',
      'Develop smooth single-stroke fills that move around the toms',
      'Build intensity using ride and hi-hat dynamics across sections',
      'Place melodic fills that lift each section without overplaying',
      'Keep the groove buoyant and song-serving rather than busy',
    ],
    tutorial: {
      youtubeId: '4Cf1CF6Avvc',
      startTime: 0,
      title: 'Dream Theater - The Looking Glass [OFFICIAL VIDEO]',
      description: "Mike Mangini's driving rock groove and fills on The Looking Glass",
    },
    gearUsed: [
      { name: 'Pearl Reference Series Drums', type: 'drums', link: null },
      { name: 'Sabian HHX & AAX Cymbals', type: 'cymbals', link: null },
    ...
    learningTips: [
      'Lock the backbeat to a metronome and focus on consistent momentum',
      'Practise single-stroke fills slowly for evenness around the kit',
      'Use the ride to lift the choruses and build dynamic intensity',
      'Play along with the track to capture the energetic, driving feel',
    ],
    seo: {
      title: 'Mike Mangini The Looking Glass - Dream Theater Drum Tutorial | MetalForge',
      description: "Learn Mike Mangini's driving rock groove and fills from Dream Theater's The Looking Glass. Video, technique breakdown, and practice tips.",
      keywords: ['mike mangini', 'the looking glass drums', 'dream theater', 'progressive metal drumming', 'rock groove tutorial', 'a dramatic turn of events'],
    },
  },
  'mike-mangini-breaking-all-illusions-feature': {
    slug: 'mike-mangini-breaking-all-illusions-feature',
    name: 'Breaking All Illusions Dynamic Feature',
    shortName: 'Breaking All Illusions',
    drummerId: 52,
    drummerName: 'Mike Mangini',
    drummerSlug: 'mike-mangini',
    band: 'Dream Theater',
    song: 'Breaking All Illusions',
    album: 'A Dramatic Turn of Events (2011)',
    category: 'signature-pattern',
    style: 'progressive-metal',
    difficulty: 'expert',
    ...
    bpmDisplay: '~125 BPM',
    timeSignature: 'mixed / odd-time',
    description: "\"Breaking All Illusions\" is the sprawling, twelve-minute epic that closes A Dramatic Turn of Events, and it is one of the deepest showcases of Mike Mangini's range as a progressive-metal drummer. The song journeys through delicate, atmospheric passages, heavy riff-driven sections, an extended instrumental workout and a soaring climax, and Mangini's drumming shapes every one of those movements. He moves from restrained, brush-light dynamics in the quiet sections to powerful double-bass-driven grooves and intricate odd-time figures in the instrumental passages, all while locking the band's many composed unison hits. This is expert-level playing not because of any single blistering moment but because of the sustained control, dynamic range and structural awareness required to carry a piece of this length and complexity. For drummers, the song is a graduate-level study in long-form progressive drumming: pacing yourself dynamically across many contrasting sections, executing odd-time grooves and metric shifts cleanly, locking tightly with the band through composed instrumental passages, and using the full dynamic range of the kit to serve the arrangement. It demands stamina, four-limb independence, and a strong grasp of song structure, since the drums must guide the listener through each transition. Learning it — even one movement at a time — develops your dynamic touch, your odd-time coordination and your ability to think like a composer behind the kit, choosing parts that build and release tension across a long arrangement. Mangini's performance here exemplifies the balance Dream Theater demands: enormous technical facility deployed entirely in service of the music. It is a long-term goal for serious progressive drummers and a masterclass in how to bring power, subtlety and structure to an extended, multi-section composition without ever losing the thread of the groove or the band's intricate, tightly composed unisons.",
    techniques: ['odd-time-signatures', 'double-bass', 'dynamics'],
    techniqueDetails: [
      'Pace your dynamics across many contrasting long-form sections',
      'Move from restrained quiet passages to heavy double-bass grooves',
      'Execute odd-time grooves and metric shifts cleanly throughout',
      'Lock tightly with the band through composed instrumental unisons',
      'Use the full dynamic range of the kit to guide each transition',
    ],
    tutorial: {
      youtubeId: 'HZlYCvamxKM',
      startTime: 0,
      title: 'Dream Theater - Breaking All Illusions (Audio)',
      description: "Mike Mangini's dynamic, long-form drumming on Breaking All Illusions",
    },
    gearUsed: [
      { name: 'Pearl Reference Series Drums', type: 'drums', link: null },
      { name: 'Sabian HHX & AAX Cymbals', type: 'cymbals', link: null },
    ...
    learningTips: [
      'Learn the song one movement at a time before stringing it together',
      'Map the dynamic arc so quiet and heavy sections truly contrast',
      'Drill the odd-time instrumental unisons slowly with the recording',
      'Build stamina gradually — the length is as demanding as the parts',
    ],
    seo: {
      title: 'Mike Mangini Breaking All Illusions - Dream Theater Drum Tutorial | MetalForge',
      description: "Learn Mike Mangini's dynamic long-form drumming from Dream Theater's Breaking All Illusions. Video, technique breakdown, and practice tips.",
      keywords: ['mike mangini', 'breaking all illusions drums', 'dream theater', 'progressive metal drumming', 'odd time signature', 'a dramatic turn of events'],
    },
  },

  // ===== Pete Sandoval (id 21, Morbid Angel) — #1050 (split 4/4 of #1044) =====
  'pete-sandoval-rapture-blast': {
    slug: 'pete-sandoval-rapture-blast',
    name: 'Rapture Blast-Beat Assault',
    shortName: 'Rapture',
    drummerId: 21,
    ...
    bpmDisplay: '~200 BPM',
    timeSignature: '4/4',
    description: "\"Rapture\" from Morbid Angel's 1993 album Covenant is a definitive showcase of Pete \"Commando\" Sandoval, the drummer who, more than almost anyone, codified the modern death-metal blast beat. Sandoval was a pioneer: his relentless, machine-precise blasting and his ability to drive a band at extreme tempos set the template that virtually every death-metal drummer since has studied. On \"Rapture\" he powers the song with blistering blast beats, rapid double bass and explosive transitions between blasting and heavy mid-paced grooves, his playing tight and controlled even at ferocious speed. What makes his approach instructive is the precision under that velocity — the blasts are even, the hands and feet stay locked, and the shifts between sections are sharp and deliberate rather than chaotic. For drummers, \"Rapture\" is a serious study in extreme-metal fundamentals: developing the hand speed and endurance to sustain blast beats, coordinating fast single strokes against driving double bass, and transitioning cleanly between blasting sections and groove-based passages. It demands real stamina, wrist and finger control, and an internal clock steady enough to hold tempo through the most intense passages. This is expert-level material that should be approached gradually — building blast speed slowly, focusing first on evenness and relaxation before chasing tempo, and isolating the transitions so they stay tight. Learning it connects you directly to the roots of death-metal drumming and to the technique of one of its most important innovators. Sandoval's playing on \"Rapture\" is a reminder that extreme speed only impresses when it is clean and controlled, and that the genre's foundational vocabulary — the blast beat, the double-bass drive, the abrupt sectional shifts — was built by players who combined raw aggression with genuine precision and discipline at the kit.",
    techniques: ['blast-beat', 'double-bass', 'extreme-speed'],
    techniqueDetails: [
      'Sustain even, machine-precise blast beats at extreme tempo',
      'Coordinate fast single strokes against driving double bass',
      'Transition cleanly between blasting and mid-paced grooves',
      'Keep hands and feet locked tightly under high velocity',
      'Hold a steady internal clock through the most intense passages',
    ],
    tutorial: {
      youtubeId: 'M0kjr1xesZ8',
      startTime: 0,
      title: 'Morbid Angel - Rapture (Official Video)',
      description: "Pete Sandoval's pioneering blast beats on Rapture",
    },
    gearUsed: [
      { name: 'ddrum Dios Series Drums', type: 'drums', link: null },
      { name: 'Sabian AAX Cymbals', type: 'cymbals', link: null },
      { name: 'ddrum Mercury Double Pedal', type: 'pedals', link: null },
    ],
    learningTips: [
      'Build blast speed slowly — prioritise evenness over raw tempo',
      'Stay relaxed in the wrists and forearms to avoid tension at speed',
      'Isolate the blast-to-groove transitions so they stay razor-tight',
      'Use a metronome to hold tempo through the most intense passages',
    ],
    seo: {
      title: 'Pete Sandoval Rapture - Morbid Angel Drum Tutorial | MetalForge',
      description: "Learn Pete Sandoval's pioneering death-metal blast beats from Morbid Angel's Rapture. Video, technique breakdown, and practice tips.",
      keywords: ['pete sandoval', 'rapture drums', 'morbid angel', 'death metal drumming', 'blast beat tutorial', 'covenant'],
    },
  },
  'pete-sandoval-immortal-rites-blast': {
    slug: 'pete-sandoval-immortal-rites-blast',
    name: 'Immortal Rites Blast Foundations',
    shortName: 'Immortal Rites',
    drummerId: 21,
    drummerName: 'Pete Sandoval',
    drummerSlug: 'pete-sandoval',
    band: 'Morbid Angel',
    ...
    bpmDisplay: '~190 BPM',
    timeSignature: '4/4',
    description: "\"Immortal Rites\" opens Morbid Angel's landmark 1989 debut Altars of Madness, an album widely regarded as one of the foundational records of death metal — and Pete Sandoval's drumming on it is a big part of why. As the opening track, it sets the tone for everything that follows: ferocious tempos, relentless blast beats and tight, riff-locked drumming that gave the genre its blueprint. Sandoval's playing here is raw and intense but already remarkably controlled for the era, driving the song through blasting verses, double-bass-fuelled riffs and sharp transitions that lock to Trey Azagthoth's churning guitar work. This is the sound of a drummer helping invent a vocabulary in real time, and studying it takes you to the very roots of extreme-metal drumming. For drummers, \"Immortal Rites\" is an essential study in death-metal fundamentals: building the speed and endurance for sustained blast beats, locking double-bass patterns to fast tremolo-picked riffs, and executing clean transitions between blasting and groove sections at high tempo. It develops your stamina, your hand-foot coordination, and your ability to play tight and aggressive without losing control. Because it comes from the genre's formative period, the parts are slightly more approachable than later, even-faster death metal, making it a great stepping-stone for advancing players working toward extreme speed. Learning it connects you to the origins of the style and to one of its true pioneers — the drummer whose blasting on this record influenced an entire generation. Sandoval's work on \"Immortal Rites\" proves that the building blocks of death-metal drumming — the blast, the double-bass drive, the riff-locked precision — were laid down with real intent and discipline, and it remains a rite of passage for any drummer serious about mastering the genre from its foundations upward.",
    techniques: ['blast-beat', 'double-bass', 'stamina'],
    techniqueDetails: [
      'Build the speed and endurance for sustained blast beats',
      'Lock double-bass patterns to fast tremolo-picked riffs',
      'Execute clean transitions between blasting and groove sections',
      'Drive the song tightly with the guitar at high tempo',
      'Stay aggressive yet controlled without losing precision',
    ],
    tutorial: {
      youtubeId: '1spDf2sbuxk',
      startTime: 0,
      title: 'Morbid Angel - Immortal Rites (Official Video)',
      description: "Pete Sandoval's foundational death-metal blasting on Immortal Rites",
    },
    gearUsed: [
      { name: 'ddrum Dios Series Drums', type: 'drums', link: null },
      { name: 'Sabian AAX Cymbals', type: 'cymbals', link: null },
    ...
    learningTips: [
      'Start blast practice at moderate tempo and build up patiently',
      'Lock the double bass to the riff by playing along with the track',
      'Drill the section transitions until they are clean and tight',
      'Focus on stamina with short, repeated blast intervals',
    ],
    seo: {
      title: 'Pete Sandoval Immortal Rites - Morbid Angel Drum Tutorial | MetalForge',
      description: "Learn Pete Sandoval's foundational death-metal blast beats from Morbid Angel's Immortal Rites. Video, technique breakdown, and practice tips.",
      keywords: ['pete sandoval', 'immortal rites drums', 'morbid angel', 'death metal drumming', 'blast beat tutorial', 'altars of madness'],
    },
  },
  'pete-sandoval-god-of-emptiness-groove': {
    slug: 'pete-sandoval-god-of-emptiness-groove',
    name: 'God of Emptiness Doom Groove',
    shortName: 'God of Emptiness',
    drummerId: 21,
    drummerName: 'Pete Sandoval',
    drummerSlug: 'pete-sandoval',
    band: 'Morbid Angel',
    song: 'God of Emptiness',
    album: 'Covenant (1993)',
    category: 'main-groove',
    style: 'death-metal',
    difficulty: 'intermediate',
    ...
    bpm: 80,
    bpmDisplay: '~80 BPM',
    timeSignature: '4/4 (half-time feel)',
    description: "\"God of Emptiness\" is the slow, crushing closer of Morbid Angel's Covenant, and it shows a completely different side of Pete Sandoval — the drummer best known for the fastest blast beats in death metal proving he could also be devastatingly heavy at a crawl. Where most of his recorded work lives at extreme tempo, here Sandoval plays a slow, doom-laden, half-time groove that lets every hit land with maximum weight. The famous main groove is deliberate and oppressive, built on heavy, spaced-out snare and kick placement that makes the song feel enormous and menacing. It is a perfect demonstration that great extreme-metal drummers understand dynamics and groove just as deeply as speed. For drummers, \"God of Emptiness\" is a valuable and surprisingly accessible study in heavy slow-tempo playing: holding a patient half-time groove without rushing, placing each snare and kick with authority and consistent tone, and using space to create atmosphere and dread. Because the tempo is slow, it is approachable for intermediate players, but playing it well is harder than it looks — slow tempos expose any unsteadiness, and the challenge is to keep the groove heavy, even and patient while resisting the urge to speed up. Learning it develops your time, your dynamic control and your appreciation for how powerful restraint can be, even from a player capable of the most extreme speed. It also rounds out an understanding of Sandoval's musicianship: the same drummer who helped define the blast beat could anchor one of death metal's heaviest slow grooves. Practising it teaches you that weight and menace come from placement and consistency, not just velocity, and it makes an ideal contrast piece alongside his faster, blast-driven material in any study of the genre's most influential drummer.",
    techniques: ['groove-drumming', 'dynamics', 'pocket'],
    techniqueDetails: [
      'Hold a patient, doom-laden half-time groove without rushing',
      'Place each snare and kick with authority and consistent tone',
      'Use space between hits to create atmosphere and dread',
      'Keep the slow tempo dead-steady to expose no unsteadiness',
      'Make the groove heavy through placement rather than speed',
    ],
    tutorial: {
      youtubeId: 'lyPvUIt_YWg',
      startTime: 0,
      title: 'Morbid Angel - God of Emptiness (Official Video)',
      description: "Pete Sandoval's crushing slow doom groove on God of Emptiness",
    },
    gearUsed: [
      { name: 'ddrum Dios Series Drums', type: 'drums', link: null },
      { name: 'Sabian AAX Cymbals', type: 'cymbals', link: null },
    ...
    learningTips: [
      'Play to a slow click — slow tempos expose any rushing instantly',
      'Focus on snare and kick tone so every hit lands with weight',
      'Leave the space in the groove; resist filling the gaps',
      'Use it as a dynamic contrast to faster blast-beat practice',
    ],
    seo: {
      title: 'Pete Sandoval God of Emptiness - Morbid Angel Drum Tutorial | MetalForge',
      description: "Learn Pete Sandoval's crushing slow doom groove from Morbid Angel's God of Emptiness. Video, technique breakdown, and practice tips.",
      keywords: ['pete sandoval', 'god of emptiness drums', 'morbid angel', 'death metal drumming', 'slow groove tutorial', 'covenant'],
    },
  },
};
