...
export const STUDIES = [
  {
    ...
    seoTitle: `Most-Used Drum & Cymbal Brands in Metal: An Analysis of ${MOST_USED_GEAR_BRANDS.totalDrummers} Verified Kits`,
    description:
      `A data-driven breakdown of which drum, cymbal, snare, stick, and pedal brands metal’s professional drummers actually play, counted across the ${MOST_USED_GEAR_BRANDS.totalDrummers} drummers documented on MetalForge.`,
  ...
  },
  {
    ...
    seoTitle: `Metal Tempo by Subgenre: Average BPM Across ${TEMPO_BY_SUBGENRE.totalSongs} Songs`,
    description:
      `Average, median, and max BPM for thrash, death, black, and 12 other metal subgenres, computed across the ${TEMPO_BY_SUBGENRE.totalSongs} songs in MetalForge’s tempo database, plus the 200+ BPM "hall of speed."`,
  ...
  },
  {
    ...
    seoTitle: `Which Brands Endorse the Most Metal Drummers? A ${DRUM_ENDORSEMENT_LANDSCAPE.totalDrummers}-Drummer Analysis`,
    description:
      `Which drum, cymbal, snare, stick, and pedal brands reach the most drummers across MetalForge’s ${DRUM_ENDORSEMENT_LANDSCAPE.totalDrummers}-drummer roster, signature-model counts by brand, and kit-brand patterns by genre.`,
  ...
  },
  {
    ...
    description:
      `How MetalForge’s ${KIT_CONFIGURATIONS.totalDrummers} documented metal drummers set up double-kick sound — physical double bass, double pedal, or twin single pedals — plus cymbal-setup size by genre.`,
