...
> Complete breakdown of Aquiles Priester's drum kit setup. Discover his Trick Drums configuration, Ufip cymbal arsenal, DW 9000 double-pedal, and the Brazilian power metal approach that powers Angra's most demanding live and studio performances.
...
- **Drums:** Trick Drums Trick Drums Custom (Custom lacquer (varies by tour) finish)
- **Snare:** Trick Drums Trick Drums Custom Snare, 14" x 6.5"
- **Cymbals:** Ufip — Ufip Series
- **Hardware / Pedals:** DW 9000 Series Double Pedal; DW 9000 Series Hi-Hat Stand; DW 9000 Series Heavy Duty Boom Stands; Roc-n-Soc Nitro Throne; Vater Fusion 55A
- **Heads:** Remo Coated Ambassador (batter), Remo Ambassador Snare Side (resonant)
- **Snare tuning:** Medium-high for live projection; medium for studio warmth

### The Trick Drums Custom Configuration

Trick Drums is a US custom manufacturer known for exceptional shell construction and hardware precision. Priester's current configuration is built around Trick's custom maple shells, which provide the low-end warmth and focused attack that power metal drumming demands — enough punch to cut through dense guitar walls without losing body in large live venues.
