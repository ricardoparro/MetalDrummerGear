...
> Complete breakdown of the drum kit, snare, cymbals, and hardware Jason Bittner used to record Shadows Fall's NWOAHM breakthrough The Art of Balance (2002). Mapex Saturn V kit, Zildjian cymbals, Mapex Falcon double pedal, Zeuss's production at Planet Z Studios, and the double-kick pattern behind "Idle Hands."
...
### Zildjian: Definition for a Genre Built on Dynamic Extremes
...
## The Record That Made NWOAHM a Genre

The Art of Balance is the album where the New Wave of American Heavy Metal stopped being a regional scene and became a commercially proven genre — and Jason Bittner's drumming, anchored by "Idle Hands," is one of the clearest reasons why. The double-kick pattern that opens the record set a technical standard that NWOAHM and metalcore drummers spent the following two decades referencing, and the dynamic range across the rest of the album demonstrated that the genre could be both aggressive and musically sophisticated.
