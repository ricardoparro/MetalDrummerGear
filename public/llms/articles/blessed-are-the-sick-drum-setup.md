...
A: "Blessed Are the Sick" (1991) is the pivotal transition record in Pete Sandoval's career and in death metal drumming history. It bridges the raw blast supremacy of "Altars of Madness" (1989) with the refined, nuanced power of "Covenant" (1993). By incorporating Egyptian and Middle Eastern rhythmic influences, slower atmospheric passages, and a wider dynamic vocabulary, the album pushed Pete from pure speed specialist to complete death metal drummer. It introduced polyrhythmic patterns and groove-based structures that influenced the entire Tampa death metal scene and created a template for death metal albums that wanted to sound ancient and atmospheric as well as brutal.

**Q: Was Blessed Are the Sick recorded with triggers or acoustic drums?**
