...
- **Drums:** Tama Tama Starclassic Performer (Starclassic Midnight Black finish)
- **Snare:** Tama Tama Starclassic Steel Snare, 14" x 6.5"
- **Cymbals:** Meinl — Meinl Byzance
- **Heads:** Remo Coated Ambassador (batter), Remo Ambassador Snare Side (resonant)
- **Snare tuning:** Medium-high tension for upper-frequency projection above orchestral mid-range
...
### Meinl Byzance: Articulation and Projection in Orchestral Context

The Meinl Byzance series was selected for *Death Cult Armageddon* based on a property that becomes critical only when drums must integrate with live orchestral recording: the Byzance's B20 bronze alloy and hand-hammering process produce a complex, warm tonality that avoids the harsh upper-frequency peaks common to cheaper production cymbals, yet retains sufficient definition to cut through dense, layered arrangements.
