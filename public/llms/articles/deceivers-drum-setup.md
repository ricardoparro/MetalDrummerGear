...
By Deceivers (2022), Erlandsson's Pearl signature snare had been an Arch Enemy constant for two decades — the co-designed 14" x 5.5" model that represents the most personal piece of his entire professional setup. The snare's 5.5" depth continues to deliver the crack and body combination that the albumcalls for: bright enough to cut through dense guitar arrangements, musical enough to integrate into Deceivers' compositionally varied passages.
