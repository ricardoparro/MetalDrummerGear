...
### Zildjian A Series: Polyrhythm Precision

For *Destroy Erase Improve*, Haake maintained the Zildjian A Series commitment that characterized his entire career before the *Nothing* (2002) era's Sabian transition. In DEI's rhythmic architecture, cymbal selection serves a crucial functional role beyond sound character: the hi-hat in particular is the 'true pulse' reference while kick and snare patterns cycle through complex polyrhythmic arcs.
