# Dirk Verbeuren's Drum Setup on Soilwork's 'Figure Number Five' (2003)

> The fan-favorite that closed out Soilwork's early-2000s run. Full breakdown of the Tama Starclassic Performer kit, Meinl Byzance cymbals, and Iron Cobra pedals Dirk Verbeuren used to record 'Figure Number Five' — frequently cited as one of the band's best albums.
...
### Dirk's Tama Starclassic Performer: Refining the Early Soilwork Sound
...
### Consistency Through the Studio Split

Verbeuren's snare on "Figure Number Five" was the same Tama Starclassic steel-shell model he used on "Natural Born Chaos" — chosen for the bright, focused crack needed to cut through Soilwork's layered guitar and keyboard production. Steel's tighter, more metallic overtone profile keeps the drum present in a mix built around melody as much as aggression.
