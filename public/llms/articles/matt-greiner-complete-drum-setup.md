...
> Complete breakdown of Matt Greiner's drum setup with August Burns Red. Pearl Reference Pure kit, Meinl Byzance cymbals, Pearl Demon Drive pedals, and Vic Firth signature sticks — the full gear guide for metalcore's most musical drummer.
...
- **Snare:** Pearl Pearl Matt Greiner Signature Snare, 14" x 6"
- **Cymbals:** Meinl — Meinl Byzance Series
- **Hardware / Pedals:** Pearl Demon Drive Double Pedal; Vic Firth Matt Greiner Signature; Remo Emperor Coated; Remo Powerstroke 3
- **Heads:** Remo Controlled Sound Coated (batter), Remo Ambassador Snare Side (resonant)
- **Snare tuning:** Medium-bright for articulation and rimshot power across the full dynamic range

### Matt's Pearl Reference Pure

Matt Greiner's Pearl Reference Pure kit in Piano Black is one of the finest production kits available for metalcore. The "Pure" designation refers to the classic tone-focused design of the Reference series — prioritizing natural shell resonance over extra reinforcement layers.
...
### The Signature Weapon: Pearl Matt Greiner Snare

The Pearl Matt Greiner Signature snare is purpose-built for metalcore. At 14" x 6", the depth provides extra body and projection — critical for cutting through two heavy guitars in a live ABR mix.
...
Matt Greiner's Meinl Byzance setup is built around the "Extra Dry" philosophy — cymbals with raw, unlathed surfaces that produce dark, dry, fast-decaying sounds ideal for dense metalcore production.
