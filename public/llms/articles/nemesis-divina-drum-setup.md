# Nemesis Divina Drum Setup: Frost's Black Metal Landmark (1996)

> Inside Frost's drum setup on Satyricon's Nemesis Divina (1996) — the Pearl Export kit, Paiste 2002 cymbals, and single-pedal blast beat technique that built Norwegian black metal's blast beat foundation at Waterfall Studios in Bergen.
...
### Pearl Export Steel: Raw Crack for an Icy Record
...
A: No. On Nemesis Divina, Frost played a single 22" bass drum with one pedal — there was no double bass drum in his setup yet. Every blast beat on the album, including the hyperspeed patterns on "The Pentagram Burns," was generated by one foot. That single-pedal discipline became the technical foundation for the double-kick blast beat technique he later developed, which is covered in detail in the [Frost Satyricon drum setup article](/articles/frost-satyricon-drum-setup).

**Q: Why is Nemesis Divina considered a black metal landmark?**

A: Nemesis Divina (1996) is widely cited as a black metal masterpiece and one of the genre's defining second-wave records — the album that moved Satyricon from the Norwegian underground to a defining name in extreme metal. Frost's playing on the record, especially "Mother North" and "The Pentagram Burns," established the primitive, hyperspeed blast beat foundation that would define his entire career, and the album's raw, icy Waterfall Studios production became a template other Norwegian bands studied closely.

**Q: What cymbals did Frost play on Nemesis Divina?**

A: Frost used Paiste 2002 series cymbals on Nemesis Divina — 14" hi-hats, 16" and 18" crashes, and a 20" ride — rather than the Zildjian A series he's known for today. Paiste 2002 was the dominant cymbal choice across the early Norwegian black metal scene, valued for a bright, aggressive tone that cut through dense, trebly guitar walls. Frost switched to Zildjian later in his career, a change documented alongside his full gear evolution in the [Frost Satyricon drum setup article](/articles/frost-satyricon-drum-setup).

**Q: How does Nemesis Divina compare to Mayhem's De Mysteriis Dom Sathanas?**
