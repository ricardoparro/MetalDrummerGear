...
- **Drums:** SJC SJC Custom Drums (Custom finishes across touring configurations finish)
- **Snare:** SJC SJC Custom Snare, 14" x 6.5"
- **Cymbals:** Zildjian — K Custom and A Custom Series
- **Hardware / Pedals:** DW 9000 Series Double Pedal; Roland SPD-SX Sampling Pad; Bass Drum Trigger System; Vic Firth American Classic 5B; Evans G2 Coated; Evans EMAD
- **Heads:** Evans UV1 Coated (batter), Evans Hazy 300 (resonant)
- **Snare tuning:** Medium-high for ghost note sensitivity and backbeat projection in djent mixes

### SJC Custom: Flagship Construction for Elite Djent

Travis Orbin's SJC Custom kit is built to the specifications that professional drummers designing their ideal acoustic instrument demand. SJC's custom shop line represents shells built to order — precisely specified ply counts, bearing edge profiles, and finish combinations that affect every acoustic parameter of the drum.
