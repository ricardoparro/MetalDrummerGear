...
The 14" x 6.5" Pearl Reference snare returned unchanged from the debut, tuned medium-high for articulation. What differs on "What the Dead Men Say" is how Bent used it — the album's more progressive, dynamically varied writing calls for more ghost notes and restrained backbeats on tracks like "The Defiant" alongside the full-force hits of "Catastrophist" and the title track.
