# What's In Navene Koperweis's Kit: Entheos Drummer Gear Breakdown

> Discover the complete drum setup of Navene Koperweis — Entheos drummer, ex-Animals as Leaders, and djent pioneer. DW Performance drums, Meinl Byzance cymbals, and DW 9000 double pedal. Full gear breakdown with era-by-era comparison.
...
- **Drums:** DW DW Performance Series (Custom (various) finish)
- **Snare:** DW DW Performance 14" x 6.5" Steel Snare, 14" x 6.5"
- **Cymbals:** Meinl — Meinl Byzance Series
- **Hardware / Pedals:** DW 9000 Series Double Pedal; DW 9000 Series Hi-Hat Stand; DW Throne; Vic Firth American Classic 5B
- **Heads:** Evans Genera HD Dry (batter), Evans Hazy 300 (resonant)
- **Snare tuning:** Medium-high, tight snare wires for djent articulation

### The DW Performance Series: Current Setup

Navene Koperweis currently plays DW Performance Series drums — the mid-tier flagship of Drum Workshop that sits between the professional Collector's Series and the entry-level Design Series. For session work with Machine Head and touring, the DW Performance provides the tonal consistency and road durability that demanding gig schedules require.
...
Navene Koperweis's current snare is the DW Performance 14" x 6.5" steel — a focused, cutting instrument that slices through Entheos's dense twin-guitar attack. Steel shells produce a brighter, more penetrating crack than wood, with tighter overtones that project without becoming harsh — essential when the drum has to be heard over heavily processed djent guitars.
...
While Navene Koperweis has played multiple drum kit brands across his career, his Meinl Byzance cymbals have remained constant — the one piece of his setup that appears in every era from early Entheos playthroughs to his most recent session and touring work. He is a verified Meinl Cymbals endorser.
