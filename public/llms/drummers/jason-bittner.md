...
| Name | Jason Bittner |
| Band | Shadows Fall / Overkill / Category 7 |
| All bands | Overkill, Shadows Fall, Category 7 |
| Genre | Thrash Metal / Heavy Metal |
| Country | USA |
| Primary brand | Mapex |
| Drum kit | Mapex Saturn V |
...
- **Shadows Fall** — 1999–2015
- **Category 7** — 2024–present (current)
...
> "Filling in for Charlie Benante was terrifying and amazing. Those are big shoes to fill."
>
...
Full breakdown: [Jason Bittner's pedal setup](https://metalforge.io/pedals/setups/jason-bittner).
