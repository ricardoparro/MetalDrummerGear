# Metal Drummer Signature & Endorsed Drumsticks — Complete List

This page indexes every verified signature or artist-endorsed drumstick model catalogued in MetalForge's drumsticks database — 29 entries, each sourced from a brand or retailer page and cross-referenced to the drummer who plays it.
...
## All 29 Drumstick Records

- Charlie Benante — [Vic Firth SBEN (Hickory, Signature (Vic Grip), budget)](https://metalforge.io/drumsticks/signature/charlie-benante)
- Dave Lombardo — [ProMark TX2BXN (American Hickory, Signature 2Bx, budget)](https://metalforge.io/drumsticks/signature/dave-lombardo)
- Danny Carey — [Vic Firth SDC (Hickory, Signature Series, budget)](https://metalforge.io/drumsticks/signature/danny-carey)
- Lars Ulrich — [Ahead Lars Ulrich Signature (LT) (Aluminum core with replaceable polyurethane/nylon sleeve, Signature, premium)](https://metalforge.io/drumsticks/signature/lars-ulrich)
- Matt Greiner — [Vic Firth SGRE (Hickory (dry-tumbled, unlacquered), Signature Series, budget)](https://metalforge.io/drumsticks/signature/matt-greiner)
- Nicko McBrain — [Vic Firth SNM (Hickory, Signature Series (beefed-up 5B), budget)](https://metalforge.io/drumsticks/signature/nicko-mcbrain)
- Vinnie Paul — [Vic Firth American Classic 5B (Hickory, 5B, budget)](https://metalforge.io/drumsticks/signature/vinnie-paul)
- Mario Duplantier — [Tama HMD (American Hickory, Mario Duplantier Signature, budget)](https://metalforge.io/drumsticks/signature/mario-duplantier)
- Eloy Casagrande — [ProMark TXECW (Hickory (raw, unlacquered), Eloy Casagrande Signature, budget)](https://metalforge.io/drumsticks/signature/eloy-casagrande)
- Mike Portnoy — [ProMark TXMP420XW-AG (Hickory with heat-activated ActiveGrip coating, Mike Portnoy ActiveGrip 420X (oversized 5A), budget)](https://metalforge.io/drumsticks/signature/mike-portnoy)
- Chris Adler — [ProMark TX5AXW (American Hickory, Chris Adler Signature (slightly longer 5A), budget)](https://metalforge.io/drumsticks/signature/chris-adler)
- Gene Hoglan — [ProMark Classic Forward 2B (TX2B family) (American Hickory, 2B, budget)](https://metalforge.io/drumsticks/signature/gene-hoglan)
- Tomas Haake — [Wincent WTHS (Hickory (stone-ground, wax-treated), Tomas Haake Signature, mid)](https://metalforge.io/drumsticks/signature/tomas-haake)
- Brann Dailor — [Vater 5B Wood Tip (Hickory, 5B, budget)](https://metalforge.io/drumsticks/signature/brann-dailor)
- Jay Weinberg — [Vater 908 (Hickory, Signature (blends 5A/5B), budget)](https://metalforge.io/drumsticks/signature/jay-weinberg)
- Matt Halpern — [ProMark TXMHW (Hickory, Signature (2B weight, plays like 5B), budget)](https://metalforge.io/drumsticks/signature/matt-halpern)
- Dirk Verbeuren — [Tama O-DVM2 (Japanese Oak, Dirk Verbeuren Signature (216B basis), budget)](https://metalforge.io/drumsticks/signature/dirk-verbeuren)
- Inferno — [Vic Firth American Classic Extreme 5B (Hickory, 5B, budget)](https://metalforge.io/drumsticks/signature/inferno)
- Alex Bent — [Vic Firth American Classic 5B (Hickory, 5B, budget)](https://metalforge.io/drumsticks/signature/alex-bent)
- Matt Garstka — [Vic Firth SGAR (Hickory (lacquered), Signature Series, budget)](https://metalforge.io/drumsticks/signature/matt-garstka)
- Joey Jordison — [ProMark TX515W (Hickory, Signature 515 (5A-class), budget)](https://metalforge.io/drumsticks/signature/joey-jordison)
- Aquiles Priester — [ProMark TX419W (American Hickory, Autograph 419 (2B-class), budget)](https://metalforge.io/drumsticks/signature/aquiles-priester)
- Ray Luzier — [Vic Firth SRL (Hickory, Signature (5B shaft, ROCK tip/taper), budget)](https://metalforge.io/drumsticks/signature/ray-luzier)
- Mikkey Dee — [Wincent Mikkey Dee Signature (W-MDS) (Kentucky hickory, UWP wax coating, 2B-style cut, budget)](https://metalforge.io/drumsticks/signature/mikkey-dee)
- Gavin Harrison — [Vic Firth SHAR2 (Hickory, royal blue matte grip area, Extended ROCK-style (longer/fatter than factory models), budget)](https://metalforge.io/drumsticks/signature/gavin-harrison)
- Mike Mangini — [Vater Mike Mangini's Wicked Piston (VHMMWP) (Hickory, Signature, budget)](https://metalforge.io/drumsticks/signature/mike-mangini)
- Derek Roddy — [Vater 5B (Hickory, 5B, budget)](https://metalforge.io/drumsticks/signature/derek-roddy)
- Jason Bittner — [ProMark Jason Bittner Signature 5BX (TX5BXN) (American Hickory, 5BX (between 5B and 2B), budget)](https://metalforge.io/drumsticks/signature/jason-bittner)
- Adrian Erlandsson — [Vic Firth American Classic Rock Nylon Tip (ROCKN) (Hickory, Rock (larger than 5B), budget)](https://metalforge.io/drumsticks/signature/adrian-erlandsson)

## Per-Drummer Signature Stick Markdown Files (29)
...
- [Vinnie Paul's Signature Sticks](https://metalforge.io/llms/drumsticks/signature/vinnie-paul.md) — Vic Firth American Classic 5B
...
- [Inferno's Signature Sticks](https://metalforge.io/llms/drumsticks/signature/inferno.md) — Vic Firth American Classic Extreme 5B
...
- [Derek Roddy's Signature Sticks](https://metalforge.io/llms/drumsticks/signature/derek-roddy.md) — Vater 5B
