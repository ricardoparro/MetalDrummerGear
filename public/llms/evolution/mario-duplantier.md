...
- **Drums:** Tama Starclassic Bubinga — bubinga shells: dual 22"×18" kicks, 10"/12"/13"/16"/18" toms *(switch from Gretsch — maximum projection for stadiums)*
- **Snare:** Tama S.L.P. 14"×6.5" G-Maple *(switch — matched shell to the main kit, consistent tonal character)*
...
A: Mario's current kit is the Tama Starclassic Bubinga, a bubinga shell kit with dual 22"×18" kicks and a Tama S.L.P. 14"×6.5" G-Maple snare. His cymbals are Meinl Byzance, pedals are Tama Iron Cobra 900 Power Glide, and sticks are his Tama Mario Duplantier Signature model.
