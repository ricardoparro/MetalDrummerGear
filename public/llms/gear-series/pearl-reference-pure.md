# Pearl Reference Pure — Drums / Kits | MetalForge

> The Pearl Reference Pure is a pro-grade drums / kits choice used by 5 metal drummers in the MetalForge database.

**Brand:** Pearl  
**Series:** Reference Pure  
**Category:** Drums / Kits  
...
See all 5 drummers on the [Pearl Reference Pure gear page](https://metalforge.io/gear/pearl/reference-pure/drummers-using).

## Gear Specifications

**Shell:** 6-ply Maple/Mahogany — deep resonance
**Lugs:** Free-floating for sustain
...
**Q: How much does the Pearl Reference Pure cost?**
A: The Pearl Reference Pure is estimated at $2,500–$8,000 street price. Actual pricing varies by retailer, finish, and configuration. Check Thomann (EU) or Sweetwater (US) for current deals.

**Q: Where can I find more Pearl gear used by pro metal drummers?**
A: MetalForge tracks all Pearl series used by professional metal drummers. Visit [https://metalforge.io/gear/pearl/reference-pure/drummers-using](https://metalforge.io/gear/pearl/reference-pure/drummers-using) for the full drummer list with exact configurations, or search MetalForge for more Pearl gear data.

---

*Source: [metalforge.io/gear/pearl/reference-pure/drummers-using](https://metalforge.io/gear/pearl/reference-pure/drummers-using) · Last updated: 2026-07-03*