...
## Metal Drummers Who Use the Pearl Reference

- **[Joey Jordison](https://metalforge.io/drummer/joey-jordison)** (Slipknot) — standard configuration
...
**Shell:** SST (Superior Shell Technology) — maple/mahogany composite
**Construction:** Reference-grade hardware throughout
**Type:** Acoustic Drum Kit

## Why Metal Drummers Choose the Pearl Reference

The Pearl Reference is one of the most respected drum kit series in professional metal drumming. Players including Joey Jordison (Slipknot), Ray Luzier (Korn), Matt Halpern (Periphery) choose this kit for its reliable maple construction and consistent tone across all dynamics. The Reference stands up to the physical demands of metal touring — heavy hitting, extreme tempos, and constant travel.
...
A: MetalForge tracks all Pearl series used by professional metal drummers. Visit [https://metalforge.io/gear/pearl/reference/drummers-using](https://metalforge.io/gear/pearl/reference/drummers-using) for the full drummer list with exact configurations, or search MetalForge for more Pearl gear data.
