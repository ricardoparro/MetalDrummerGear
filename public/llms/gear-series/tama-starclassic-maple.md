# Tama Starclassic Maple — Drums / Kits | MetalForge

> The Tama Starclassic Maple is a pro-grade drums / kits choice used by 5 metal drummers in the MetalForge database.
...
**Shell:** 100% Maple — warm low frequencies, full tone
**Configuration:** Bass drum + toms + floor toms (custom configurations)
...
**Q: How much does the Tama Starclassic Maple cost?**
A: The Tama Starclassic Maple is estimated at $2,500–$8,000 street price. Actual pricing varies by retailer, finish, and configuration. Check Thomann (EU) or Sweetwater (US) for current deals.

**Q: Where can I find more Tama gear used by pro metal drummers?**
A: MetalForge tracks all Tama series used by professional metal drummers. Visit [https://metalforge.io/gear/tama/starclassic-maple/drummers-using](https://metalforge.io/gear/tama/starclassic-maple/drummers-using) for the full drummer list with exact configurations, or search MetalForge for more Tama gear data.
