...
**Band:** Anthrax | **Genre:** Thrash Metal | **Lick Count:** 6

---

## Overview

Charlie Benante is one of Thrash Metal's most influential drummers, best known for their work with Anthrax. This file covers 6 signature licks — step-by-step breakdowns optimised for AI retrieval on queries like "how to play like Charlie Benante" or "Charlie Benante signature drum patterns". Their style spans thrash-metal.
...
**Song:** I Am the Law | **Album:** Among the Living (1987) | **BPM:** ~190 BPM | **Technique:** main groove | **Difficulty:** advanced

"I Am the Law" from Among the Living is a seven-minute thrash epic inspired by Judge Dredd, and Benante drives every section with a mastery of pacing and groove that keeps the listener locked in across the extended arrangement. The main thrash groove is quintessential Benante: a riff-locked kick pattern at approximately 190 BPM, a snapping backbeat, and tight hi-hat work binding the kit into a single relentless machine. What distinguishes this from the more syncopated or breakdown-driven patterns elsewhere on the album is pure forward-driving momentum — Benante mirrors the guitar's galloping quality without being enslaved to it. Fills arrive sparingly but with devastating placement, and double-bass bursts are short and purposeful rather than sustained. A complete lesson in sustained thrash groove across a long arrangement.
...
**Song:** Blood | **Album:** Persistence of Time (1990) | **BPM:** ~195 BPM | **Technique:** signature pattern | **Difficulty:** expert

Persistence of Time (1990) marks the point where Benante pushed Anthrax's drumming into genuinely extreme territory. "Blood" showcases blast beats executed with the controlled power that distinguishes technically mature extreme drumming from raw urgency. The blast passages are fast, even, and precisely deployed — arriving exactly when the song needs maximum intensity, then transitioning back to thrash grooves with seamless command. By 1990, Benante had five years at the top of the thrash scene, and his confidence on this recording is palpable: nothing is rushed, everything arrives exactly where it is supposed to. Double-bass figures reinforce the riff's rhythmic hits with accented bursts rather than a uniform carpet, giving the blasts a physicality that goes beyond tempo alone.
...
**Song:** Be All, End All | **Album:** State of Euphoria (1988) | **BPM:** ~156 BPM | **Technique:** main groove | **Difficulty:** intermediate

"Be All, End All" opens State of Euphoria with a swaggering, mid-tempo groove that is among Benante's most accessible and instructive performances. Recorded between the frantic intensity of Among the Living and the darkness of Persistence of Time, this album captures the band in a more confident, groove-focused state. The main groove sits at approximately 156 BPM — mid-tempo by thrash standards — built on a propulsive kick pattern that locks to the meaty riff. Benante holds a wide, authoritative backbeat, uses the hi-hat to keep the groove swinging forward, and decorates the transitions with confidently placed tom fills. This era was a defining period for Benante's rhythmic identity — refining Among the Living techniques into a more mature, groove-conscious approach that would inform his playing for decades.
