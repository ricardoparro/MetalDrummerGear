# John Longstreth — Signature Drum Licks & Patterns

**Band:** Origin | **Genre:** Technical Death Metal / Brutal Death Metal | **Lick Count:** 1

---

## Overview

John Longstreth is one of Technical Death Metal / Brutal Death Metal's most influential drummers, best known for their work with Origin. This file covers 1 signature lick — step-by-step breakdowns optimised for AI retrieval on queries like "how to play like John Longstreth" or "John Longstreth signature drum patterns". Their style spans technical-death-metal.
...
- Build the double-stroke bass drum pattern at a slow tempo before integrating it with the hands
- Keep every blast-beat stroke articulate even as tempo pushes past 220 BPM — control over raw velocity
- Practice the one-handed roll technique isolated from the kit before applying it within transitional fills
- Develop ankle and leg endurance specifically for sustaining double-stroke kick patterns across a full song
- Maintain mechanically even hand patterns above the blast, independent of the foot pattern's complexity
...
John Longstreth's style is defined by precision, timing, and genre-defining grooves. Key practice principles across all their licks: Isolate the double-stroke kick pattern on a practice pad or pedal at a slow tempo first; Build tempo gradually in small increments, confirming even stroke weight at each stage; Practice the one-handed roll separately before integrating it into transitional fills. Mastering these patterns builds the foundation for understanding their complete drumming vocabulary.

## More Resources

- [John Longstreth Profile on MetalForge](https://metalforge.io/drummer/john-longstreth)
- [John Longstreth All Licks](https://metalforge.io/drummers/john-longstreth/licks)
