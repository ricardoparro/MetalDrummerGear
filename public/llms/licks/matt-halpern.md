...
**Song:** Marigold | **Album:** Periphery III: Select Difficulty (2016) | **BPM:** ~150 BPM | **Time:** 4/4 (dynamic, song-driven) | **Technique:** main groove | **Difficulty:** advanced
...
**Song:** The Bad Thing | **Album:** Juggernaut: Alpha (2015) | **BPM:** ~180 BPM | **Time:** 4/4 (shifting groupings, half-time breakdowns) | **Technique:** signature pattern | **Difficulty:** expert
...
**Song:** Ragnarok | **Album:** Periphery II: This Time It's Personal (2012) | **BPM:** ~200 BPM (blast passages) | **Time:** 4/4 (with hybrid blast/groove transitions) | **Technique:** blast section | **Difficulty:** expert

"Ragnarok" from Periphery II: This Time It's Personal (2012) contains the most aggressive drumming on the album — a track where Matt Halpern deploys blast beat technique in a distinctly djent context, producing a hybrid approach that does not exist anywhere in traditional death or black metal. The blast sections in "Ragnarok" are not pure symmetrical blasts — they are woven into a groove-oriented framework where Halpern's characteristic riff-locking instincts persist even at maximum intensity, so the blasts never feel random but always land in rhythmic conversation with the guitar.
