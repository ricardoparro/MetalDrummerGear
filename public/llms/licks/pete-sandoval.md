# Pete Sandoval — Signature Drum Licks & Patterns

**Band:** Morbid Angel | **Genre:** Death Metal | **Lick Count:** 3

---

## Overview

Pete Sandoval is one of Death Metal's most influential drummers, best known for their work with Morbid Angel. This file covers 3 signature licks — step-by-step breakdowns optimised for AI retrieval on queries like "how to play like Pete Sandoval" or "Pete Sandoval signature drum patterns". Their style spans death-metal.
...
Pete Sandoval's style is defined by precision, timing, and genre-defining grooves. Key practice principles across all their licks: Build the blast beat slowly until the single strokes are perfectly even; Lock the kick to the snare hand so the blast stays articulate; Practise the blast-to-groove transitions on their own. Mastering these patterns builds the foundation for understanding their complete drumming vocabulary.

## More Resources

- [Pete Sandoval Profile on MetalForge](https://metalforge.io/drummer/pete-sandoval)
- [Pete Sandoval All Licks](https://metalforge.io/drummers/pete-sandoval/licks)
