# Bass Drum Pedals: The Complete Guide for Metal Drummers
...
### Set it up for the sound and speed you need
...
- [Bass Drum Pedal Drive Types: Chain vs Belt vs Direct Drive](https://metalforge.io/llms/pedals/drive-types.md) — Chain, belt, and direct drive bass drum pedals compared — feel, response, and power transfer — and why extreme metal gravitates to direct drive pedals like Axis and the Pearl Demon Drive.
- [Single vs Double Bass Pedal: Why Metal Lives on Two Beaters](https://metalforge.io/llms/pedals/single-vs-double.md) — Why metal drumming runs almost entirely on double bass pedals — plus how a slave pedal and drive shaft actually work to fire a second beater on one bass drum head.
- [How to Set Up and Tune a Bass Drum Pedal for Metal](https://metalforge.io/llms/pedals/setup-tuning.md) — Bass pedal spring tension, beater choice and angle (felt vs plastic vs wood), and longboard vs standard footboard length — including Tama Speed Cobra vs Iron Cobra.

## Pedal Brands on the Roster

- **Tama:** The single most common pedal brand across the verified metal roster — Iron Cobra (chain) and Speed Cobra (chain, longboard) cover most of the double-pedal roster. [Full brand page](https://metalforge.io/llms/pedals/brands/tama.md).
...
**Q: What bass drum pedal do most metal drummers use?**
A: There's no single pedal every metal drummer uses, but the verified roster skews heavily toward double pedals from Tama (Iron Cobra, Speed Cobra), Pearl (Demon Drive, Eliminator), and DW (5000/9000 Series), with direct-drive options like Axis reserved mostly for extreme-speed specialists.

**Q: Is direct drive better than chain drive for metal?**
A: Neither is strictly "better" — chain drive is the metal default, giving a natural, slightly cushioned feel that most drummers find comfortable and powerful. Direct drive removes all slack between footboard and beater for the fastest, most immediate response, which is why extreme metal drummers chasing sustained top-end speed often gravitate to it. See the drive types guide for the full comparison.

**Q: Do I need a double bass pedal for metal?**
A: For most metal styles, yes. Blast beats and constant sixteenth-note kick patterns are built around two beaters. Only doom, traditional heavy metal, and some groove metal primarily run single bass drum setups — see the single-vs-double guide for the full breakdown.

## All 56 Drummer Pedal Setups
...
| [Aquiles Priester](https://metalforge.io/pedals/setups/aquiles-priester) | Angra / W.A.S.P. | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/aquiles-priester.md) |
| [Art Cruz](https://metalforge.io/pedals/setups/art-cruz) | Lamb of God | Trick Pro 1-V | [Markdown](https://metalforge.io/llms/pedals/setups/art-cruz.md) |
...
| [Chris Adler](https://metalforge.io/pedals/setups/chris-adler) | Lamb of God | Mapex Falcon | [Markdown](https://metalforge.io/llms/pedals/setups/chris-adler.md) |
...
| [Daniel Erlandsson](https://metalforge.io/pedals/setups/daniel-erlandsson) | Arch Enemy | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/daniel-erlandsson.md) |
| [Daray](https://metalforge.io/pedals/setups/daray) | Dimmu Borgir / Vader | Pearl Demon XR | [Markdown](https://metalforge.io/llms/pedals/setups/daray.md) |
| [Dave Lombardo](https://metalforge.io/pedals/setups/dave-lombardo) | Slayer | Tama Iron Cobra 900 | [Markdown](https://metalforge.io/llms/pedals/setups/dave-lombardo.md) |
...
| [Flo Mounier](https://metalforge.io/pedals/setups/flo-mounier) | Cryptopsy | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/flo-mounier.md) |
...
| [Gene Hoglan](https://metalforge.io/pedals/setups/gene-hoglan) | Death / Testament / Dethklok | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/gene-hoglan.md) |
| [George Kollias](https://metalforge.io/pedals/setups/george-kollias) | Nile | Pearl Demon XR | [Markdown](https://metalforge.io/llms/pedals/setups/george-kollias.md) |
...
| [Jaska Raatikainen](https://metalforge.io/pedals/setups/jaska-raatikainen) | Children of Bodom | Pearl Eliminator | [Markdown](https://metalforge.io/llms/pedals/setups/jaska-raatikainen.md) |
| [Jason Bittner](https://metalforge.io/pedals/setups/jason-bittner) | Shadows Fall / Overkill / Category 7 | Mapex Falcon | [Markdown](https://metalforge.io/llms/pedals/setups/jason-bittner.md) |
...
| [Jocke Wallgren](https://metalforge.io/pedals/setups/jocke-wallgren) | Amon Amarth | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/jocke-wallgren.md) |
| [Joey Jordison](https://metalforge.io/pedals/setups/joey-jordison) | Slipknot | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/joey-jordison.md) |
| [John Otto](https://metalforge.io/pedals/setups/john-otto) | Limp Bizkit | Gibraltar G Class | [Markdown](https://metalforge.io/llms/pedals/setups/john-otto.md) |
| [Jon Dette](https://metalforge.io/pedals/setups/jon-dette) | Slayer | DW 9000 or Tama Iron Cobra Double Pedal | [Markdown](https://metalforge.io/llms/pedals/setups/jon-dette.md) |
| [Kevin Talley](https://metalforge.io/pedals/setups/kevin-talley) | Dying Fetus / Misery Index / Six Feet Under | Pearl Eliminator | [Markdown](https://metalforge.io/llms/pedals/setups/kevin-talley.md) |
...
| [Mike Mangini](https://metalforge.io/pedals/setups/mike-mangini) | Dream Theater | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/mike-mangini.md) |
...
| [Nicko McBrain](https://metalforge.io/pedals/setups/nicko-mcbrain) | Iron Maiden | Single Bass Drum Pedal | [Markdown](https://metalforge.io/llms/pedals/setups/nicko-mcbrain.md) |
| [Paul Bostaph](https://metalforge.io/pedals/setups/paul-bostaph) | Slayer | Pearl Eliminator | [Markdown](https://metalforge.io/llms/pedals/setups/paul-bostaph.md) |
| [Paul Mazurkiewicz](https://metalforge.io/pedals/setups/paul-mazurkiewicz) | Cannibal Corpse | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/paul-mazurkiewicz.md) |
...
| [Ryan Van Poederooyen](https://metalforge.io/pedals/setups/ryan-van-poederooyen) | Devin Townsend Project | Pearl Demon Drive | [Markdown](https://metalforge.io/llms/pedals/setups/ryan-van-poederooyen.md) |
...
- [Pedals Guide (live page)](https://metalforge.io/pedals)
- [All LLM Resources](https://metalforge.io/llms/index.md)
- [Site index](https://metalforge.io/llms.txt)

*Last updated: 2026-08-01 · 56 drummers, 3 reference guides · Source: [MetalForge.io](https://metalforge.io)*