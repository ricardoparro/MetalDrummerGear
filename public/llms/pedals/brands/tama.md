# Tama Bass Drum Pedals for Metal
...
- Hoshino Gakki also owns the Ibanez guitar brand

## Metal-Relevant Models

- **Iron Cobra:** Chain drive, standard-length footboard — the industry-standard double pedal since its 1993 launch, and the most common single model across the verified metal roster.
...
- [Live page](https://metalforge.io/pedals/brands/tama)
