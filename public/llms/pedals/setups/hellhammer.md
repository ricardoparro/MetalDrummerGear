# What Pedals Does Hellhammer Use? Full Setup

**Band:** Mayhem | **Configuration:** double | **Drive Type:** direct
...
Verified roster hardware entry: "Axis Double Pedal." Source: roster gear.hardware (verified: true; sources on the drummer record).
...
A: Hellhammer plays an Axis double pedal (direct-drive).

## More Resources

- [Full pedal setup page](https://metalforge.io/pedals/setups/hellhammer)
