# "Bleed" by Meshuggah — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Bleed" by Meshuggah.
> Optimised for queries like 'Bleed bpm', 'Bleed drummer', 'how fast is Bleed'.
...
- **Tempo note:** 12/8-over-4/4 polymeter at a 100 BPM pulse; often perceived as double-time (~200) due to the shifting accent pattern
...
Full drum-setup breakdown: [obZen Drum Setup: Tomas Haake's Legendary "Bleed" Gear Breakdown](https://metalforge.io/articles/obzen-drum-setup)

## FAQ

**Q: What BPM is Bleed?**
A: "Bleed" by Meshuggah is 100 BPM (Groove/Heavy tempo range). 12/8-over-4/4 polymeter at a 100 BPM pulse; often perceived as double-time (~200) due to the shifting accent pattern.

**Q: Who played drums on Bleed?**
A: Tomas Haake played drums on "Bleed" by Meshuggah, from the album obZen (2008).
...
- [New Millennium Cyanide Christ](https://metalforge.io/songs/new-millennium-cyanide-christ) — Meshuggah, 175 BPM
...
**Full song page:** [Bleed on MetalForge](https://metalforge.io/songs/bleed)
