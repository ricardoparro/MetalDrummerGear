# "Composure" by August Burns Red — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Composure" by August Burns Red.
> Optimised for queries like 'Composure bpm', 'Composure drummer', 'how fast is Composure'.

## Song Overview

- **Band:** August Burns Red
- **Album:** Constellations (2009)
- **BPM:** 159 (Thrash/Power, 130-169 BPM range)
- **Genre:** metalcore
- **Drummer:** [Matt Greiner](https://metalforge.io/drummer/matt-greiner)
...
Full drum-setup breakdown: [Matt Greiner's Drum Setup on August Burns Red's Constellations (2009)](https://metalforge.io/articles/constellations-drum-setup)

## Video

[August Burns Red - Composure (Matt Greiner Drum Playthrough)](https://www.youtube.com/watch?v=iSoU9fs4Umo)

## FAQ

**Q: What BPM is Composure?**
A: "Composure" by August Burns Red is 159 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Composure?**
A: Matt Greiner played drums on "Composure" by August Burns Red, from the album Constellations (2009).

## Source

SongBPM/GetSongBPM: 159 BPM
...
**Full song page:** [Composure on MetalForge](https://metalforge.io/songs/composure)
