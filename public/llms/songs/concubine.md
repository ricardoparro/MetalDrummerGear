# "Concubine" by Converge — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Concubine" by Converge.
> Optimised for queries like 'Concubine bpm', 'Concubine drummer', 'how fast is Concubine'.
...
- **Genre:** mathcore
- **Drummer:** [Ben Koller](https://metalforge.io/drummer/ben-koller)
...
Full drum-setup breakdown: [Ben Koller's Drum Setup on Converge's Jane Doe (2001)](https://metalforge.io/articles/jane-doe-drum-setup)

## Video

[Converge Concubine and Dark Horse Live GoPro drum cam Ben Koller](https://www.youtube.com/watch?v=5T4iTvQ8ZUg)

## FAQ

**Q: What BPM is Concubine?**
A: "Concubine" by Converge is 168 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Concubine?**
A: Ben Koller played drums on "Concubine" by Converge, from the album Jane Doe (2001).

## Source

SongBPM: 168 BPM; Koller's first Converge album
...
**Full song page:** [Concubine on MetalForge](https://metalforge.io/songs/concubine)
