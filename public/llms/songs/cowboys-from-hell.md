# "Cowboys from Hell" by Pantera — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Cowboys from Hell" by Pantera.
> Optimised for queries like 'Cowboys from Hell bpm', 'Cowboys from Hell drummer', 'how fast is Cowboys from Hell'.

## Song Overview

- **Band:** Pantera
- **Album:** Cowboys from Hell (1990)
- **BPM:** 118 (Groove/Heavy, 90-129 BPM range)
- **Genre:** groove-metal
...
[Pantera - Cowboys from Hell (Live Drum Cam)](https://www.youtube.com/watch?v=2DfYLar2QGI)

## FAQ

**Q: What BPM is Cowboys from Hell?**
A: "Cowboys from Hell" by Pantera is 118 BPM (Groove/Heavy tempo range, 90-129 BPM).

**Q: Who played drums on Cowboys from Hell?**
A: Vinnie Paul played drums on "Cowboys from Hell" by Pantera, from the album Cowboys from Hell (1990).
...
**Full song page:** [Cowboys from Hell on MetalForge](https://metalforge.io/songs/cowboys-from-hell)
