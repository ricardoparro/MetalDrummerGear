# "I Stand Alone" by Godsmack — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "I Stand Alone" by Godsmack.
> Optimised for queries like 'I Stand Alone bpm', 'I Stand Alone drummer', 'how fast is I Stand Alone'.

## Song Overview

- **Band:** Godsmack
- **Album:** Faceless (2003)
- **BPM:** 90 (Groove/Heavy, 90-129 BPM range)
- **Genre:** heavy-metal
- **Drummer:** [Shannon Larkin](https://metalforge.io/drummer/shannon-larkin)
...
Full drum-setup breakdown: [Faceless Drum Setup: Shannon Larkin's Gear on Godsmack's #1 Billboard Album (2003)](https://metalforge.io/articles/faceless-drum-setup)

## Video

[GODSMACK - I STAND ALONE - DRUM COVER BY MEYTAL COHEN](https://www.youtube.com/watch?v=NYNxFYZ4o5c)

## FAQ

**Q: What BPM is I Stand Alone?**
A: "I Stand Alone" by Godsmack is 90 BPM (Groove/Heavy tempo range, 90-129 BPM).

**Q: Who played drums on I Stand Alone?**
A: Shannon Larkin played drums on "I Stand Alone" by Godsmack, from the album Faceless (2003).

## Source

Corroborated against this app's own live /bpm tool database (App.js METAL_SONGS_DATABASE): 90 BPM; Larkin's first Godsmack studio album
...
**Full song page:** [I Stand Alone on MetalForge](https://metalforge.io/songs/i-stand-alone)
