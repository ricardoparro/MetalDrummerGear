# "Icarus Lives!" by Periphery — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Icarus Lives!" by Periphery.
> Optimised for queries like 'Icarus Lives! bpm', 'Icarus Lives! drummer', 'how fast is Icarus Lives!'.
...
- **Genre:** djent
- **Drummer:** [Matt Halpern](https://metalforge.io/drummer/matt-halpern)
...
[Icarus Lives - Periphery (Matt Halpern Masterclass, Drums/Bass)](https://www.youtube.com/watch?v=WjObrWs84iM)

## FAQ

**Q: What BPM is Icarus Lives!?**
A: "Icarus Lives!" by Periphery is 120 BPM (Groove/Heavy tempo range, 90-129 BPM).

**Q: Who played drums on Icarus Lives!?**
A: Matt Halpern played drums on "Icarus Lives!" by Periphery, from the album Periphery (2010).
...
- [The Bad Thing](https://metalforge.io/songs/the-bad-thing) — Periphery, 135 BPM
...
**Full song page:** [Icarus Lives! on MetalForge](https://metalforge.io/songs/icarus-lives)
