# "Indians" by Anthrax — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Indians" by Anthrax.
> Optimised for queries like 'Indians bpm', 'Indians drummer', 'how fast is Indians'.
...
[The Iconic Drumming Behind "Indians" | Anthrax](https://www.youtube.com/watch?v=OR6rUpbFOk0)

## FAQ

**Q: What BPM is Indians?**
A: "Indians" by Anthrax is 145 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Indians?**
A: Charlie Benante played drums on "Indians" by Anthrax, from the album Among the Living (1987).
...
**Full song page:** [Indians on MetalForge](https://metalforge.io/songs/indians)
