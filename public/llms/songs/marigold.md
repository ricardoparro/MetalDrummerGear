# "Marigold" by Periphery — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Marigold" by Periphery.
> Optimised for queries like 'Marigold bpm', 'Marigold drummer', 'how fast is Marigold'.

## Song Overview

- **Band:** Periphery
- **Album:** Periphery III: Select Difficulty (2016)
- **BPM:** 140 (Thrash/Power, 130-169 BPM range)
- **Genre:** djent
...
Full drum-setup breakdown: [Matt Halpern's Drum Setup on Periphery III: Select Difficulty (2016)](https://metalforge.io/articles/periphery-iii-drum-setup)

## Video

[Periphery - Marigold (Matt Halpern Drum Playthrough)](https://www.youtube.com/watch?v=DAOcYC2uEJk)

## FAQ

**Q: What BPM is Marigold?**
A: "Marigold" by Periphery is 140 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Marigold?**
A: Matt Halpern played drums on "Marigold" by Periphery, from the album Periphery III: Select Difficulty (2016).
...
**Full song page:** [Marigold on MetalForge](https://metalforge.io/songs/marigold)
