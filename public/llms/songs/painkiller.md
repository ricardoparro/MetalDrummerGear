# "Painkiller" by Judas Priest — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Painkiller" by Judas Priest.
> Optimised for queries like 'Painkiller bpm', 'Painkiller drummer', 'how fast is Painkiller'.
...
- **Genre:** heavy-metal
- **Drummer:** [Scott Travis](https://metalforge.io/drummer/scott-travis)
...
Full drum-setup breakdown: [Painkiller Drum Setup: Scott Travis's Speed Metal Revolution](https://metalforge.io/articles/painkiller-drum-setup)

## Video

[Judas Priest - Painkiller - Scott Travis (Isolated Drums)](https://www.youtube.com/watch?v=xZv2wVL4vfE)

## FAQ

**Q: What BPM is Painkiller?**
A: "Painkiller" by Judas Priest is 210 BPM (Death/Black tempo range, 170-250 BPM).

**Q: Who played drums on Painkiller?**
A: Scott Travis played drums on "Painkiller" by Judas Priest, from the album Painkiller (1990).

## Source

Tunebat/GetSongBPM half-time reading (103) doubled (corrected from a prior 171 estimate that understated the track's documented reputation as one of Priest's fastest recordings)
...
**Full song page:** [Painkiller on MetalForge](https://metalforge.io/songs/painkiller)
