# "Panic Attack" by Dream Theater — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Panic Attack" by Dream Theater.
> Optimised for queries like 'Panic Attack bpm', 'Panic Attack drummer', 'how fast is Panic Attack'.

## Song Overview

- **Band:** Dream Theater
- **Album:** Octavarium (2005)
- **BPM:** 168 (Thrash/Power, 130-169 BPM range)
...
Full drum-setup breakdown: [Octavarium Drum Setup — Mike Portnoy's 24-Minute Prog Landmark (Dream Theater, 2005)](https://metalforge.io/articles/octavarium-drum-setup)

## Video

[Mike Portnoy Plays "Panic Attack" | Dream Theater](https://www.youtube.com/watch?v=oa7oOdYPOSk)

## FAQ

**Q: What BPM is Panic Attack?**
A: "Panic Attack" by Dream Theater is 168 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Panic Attack?**
A: Mike Portnoy played drums on "Panic Attack" by Dream Theater, from the album Octavarium (2005).
...
**Full song page:** [Panic Attack on MetalForge](https://metalforge.io/songs/panic-attack)
