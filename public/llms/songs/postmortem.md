# "Postmortem" by Slayer — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Postmortem" by Slayer.
> Optimised for queries like 'Postmortem bpm', 'Postmortem drummer', 'how fast is Postmortem'.
...
- **Tempo note:** half-time verse ~90; the closing solo section pushes considerably faster
...
**Q: What BPM is Postmortem?**
A: "Postmortem" by Slayer is 90 BPM (Groove/Heavy tempo range). half-time verse ~90; the closing solo section pushes considerably faster.

**Q: Who played drums on Postmortem?**
A: Dave Lombardo played drums on "Postmortem" by Slayer, from the album Reign in Blood (1986).
...
**Full song page:** [Postmortem on MetalForge](https://metalforge.io/songs/postmortem)
