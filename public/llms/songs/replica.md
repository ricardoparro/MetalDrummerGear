# "Replica" by Fear Factory — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Replica" by Fear Factory.
> Optimised for queries like 'Replica bpm', 'Replica drummer', 'how fast is Replica'.
...
- **Drummer:** [Raymond Herrera](https://metalforge.io/drummer/raymond-herrera)
...
Full drum-setup breakdown: [Demanufacture Drum Setup: Raymond Herrera's 1995 Fear Factory Kit Breakdown](https://metalforge.io/articles/demanufacture-drum-setup)

## Video

[Fear Factory - Replica (Demanufacture)](https://www.youtube.com/watch?v=7RJsRQOneMY)

## FAQ

**Q: What BPM is Replica?**
A: "Replica" by Fear Factory is 112 BPM (Groove/Heavy tempo range, 90-129 BPM).

**Q: Who played drums on Replica?**
A: Raymond Herrera played drums on "Replica" by Fear Factory, from the album Demanufacture (1995).

## Source

GetSongBPM: 112 BPM; Modern Drummer's Herrera profile documents practicing this era's patterns at speeds up to 225 BPM
...
**Full song page:** [Replica on MetalForge](https://metalforge.io/songs/replica)
