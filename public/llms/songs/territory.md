# "Territory" by Sepultura — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Territory" by Sepultura.
> Optimised for queries like 'Territory bpm', 'Territory drummer', 'how fast is Territory'.
...
**Q: What BPM is Territory?**
A: "Territory" by Sepultura is 145 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Territory?**
A: Igor Cavalera played drums on "Territory" by Sepultura, from the album Chaos A.D. (1993).
...
**Full song page:** [Territory on MetalForge](https://metalforge.io/songs/territory)
