# "The Bad Thing" by Periphery — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "The Bad Thing" by Periphery.
> Optimised for queries like 'The Bad Thing bpm', 'The Bad Thing drummer', 'how fast is The Bad Thing'.

## Song Overview

- **Band:** Periphery
- **Album:** Juggernaut: Alpha (2015)
- **BPM:** 135 (Thrash/Power, 130-169 BPM range)
- **Genre:** djent
...
[Matt Halpern - Periphery - 'The Bad Thing' Drum Playthrough](https://www.youtube.com/watch?v=8dfZo-zmNaU)

## FAQ

**Q: What BPM is The Bad Thing?**
A: "The Bad Thing" by Periphery is 135 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on The Bad Thing?**
A: Matt Halpern played drums on "The Bad Thing" by Periphery, from the album Juggernaut: Alpha (2015).
...
**Full song page:** [The Bad Thing on MetalForge](https://metalforge.io/songs/the-bad-thing)
