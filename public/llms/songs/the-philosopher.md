# "The Philosopher" by Death — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "The Philosopher" by Death.
> Optimised for queries like 'The Philosopher bpm', 'The Philosopher drummer', 'how fast is The Philosopher'.
...
- **Genre:** death-metal
- **Drummer:** [Gene Hoglan](https://metalforge.io/drummer/gene-hoglan)
...
[Gene Hoglan - The Philosopher (Drum Playthrough)](https://www.youtube.com/watch?v=eGope68pHf0)

## FAQ

**Q: What BPM is The Philosopher?**
A: "The Philosopher" by Death is 140 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on The Philosopher?**
A: Gene Hoglan played drums on "The Philosopher" by Death, from the album Individual Thought Patterns (1993).
...
**Full song page:** [The Philosopher on MetalForge](https://metalforge.io/songs/the-philosopher)
