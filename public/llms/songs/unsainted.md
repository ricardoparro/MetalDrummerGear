# "Unsainted" by Slipknot — BPM, Drummer & Tempo | MetalForge

> Per-song AI citation reference: verified BPM, tempo tier, and recording drummer for "Unsainted" by Slipknot.
> Optimised for queries like 'Unsainted bpm', 'Unsainted drummer', 'how fast is Unsainted'.
...
Full drum-setup breakdown: [We Are Not Your Kind — Slipknot Drum Setup (Jay Weinberg, 2019)](https://metalforge.io/articles/we-are-not-your-kind-drum-setup)

## Video

[Jay Weinberg (Slipknot) - "Unsainted" Playthrough](https://www.youtube.com/watch?v=BqFLUAuk-do)

## FAQ

**Q: What BPM is Unsainted?**
A: "Unsainted" by Slipknot is 145 BPM (Thrash/Power tempo range, 130-169 BPM).

**Q: Who played drums on Unsainted?**
A: Jay Weinberg played drums on "Unsainted" by Slipknot, from the album We Are Not Your Kind (2019).
...
**Full song page:** [Unsainted on MetalForge](https://metalforge.io/songs/unsainted)
