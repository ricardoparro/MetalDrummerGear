...
- Pete Sandoval (Morbid Angel) — Pioneer of the hyper blast — /drummer/pete-sandoval
- George Kollias (Nile) — Known for sustained 280+ BPM blasts — /drummer/george-kollias
- Inferno (Behemoth) — Combines technicality with raw power — /drummer/inferno
...
- **Pedals:** Pearl Demon Drive — Ultra-smooth bearings for sustained high-speed playing
- **Pedals:** Tama Speed Cobra — Lightweight footboard for faster response
- **Pedals:** Axis A Longboard — Direct drive precision for extreme speeds
- **Snares:** Tama SLP Steel — Cutting attack that penetrates blast sections
- **Snares:** Pearl Sensitone Steel — Crisp response for fast snare work
...
- **Closed (Concert) Buzz Roll:** Tight, pressed bounces for a smooth, sustained orchestral-style roll
- **Open Buzz Roll:** Looser bounce with more separation between pulses, for a rawer, driving roll
- **Crescendo Roll:** Buzz roll built from quiet to loud, common as a build before a chorus or blast section
- **Buzz Roll Fill:** A short buzz roll used to fill a beat or half-beat, common in doom and sludge for tension before a riff hit
...
**Difficulty:** beginner | **BPM range:** 160-220+ BPM | **Category:** extreme
...
- **Classic D-Beat:** The original Discharge pattern - driving kick and off-beat snare under a steady hi-hat
- **Swedish D-Beat:** Faster, more distorted variation popularized by Wolfpack and Skitsystem
- **Blackened Crust D-Beat:** D-beat alternated or layered with blast beats and tremolo-picked riffing
- **Crossover D-Beat:** D-beat hybridized with thrash metal precision, as heard in crossover thrash
...
- **Snares:** Tama SLP Steel — Cutting, raw crack that suits D-beat's driving, unpolished character
...
- Dave Lombardo (Slayer) — Pioneer of thrash double bass — /drummer/dave-lombardo
- George Kollias (Nile) — Extreme speed and endurance master — /drummer/george-kollias
- Gene Hoglan (Death/Testament) — Technical precision and creativity — /drummer/gene-hoglan
- Joey Jordison (Slipknot) — Explosive power and speed — /drummer/joey-jordison
...
- **Pedals:** Tama Iron Cobra 900 — Industry standard for reliability and speed
- **Pedals:** DW 9000 Series — Smooth chain drive with excellent feel
- **Kicks:** 22" Bass Drums — Standard metal size for punch and speed
- **Kicks:** 20" Bass Drums — Faster response for extreme metal
...
- **Standard Double Paradiddle:** The base six-note pattern (RLRLRR LRLRLL) combining two extra singles with a closing double
- **Triple Paradiddle:** An eight-note extension adding yet another pair of singles before the closing double
- **Double Paradiddle-Diddle:** A double paradiddle with the closing double stroke replaced by two doubles for an even longer phrase
- **Linear Double Paradiddle:** The six-note sticking split between hands and feet so no limb repeats consecutively, common in progressive metal fills

### Masters

- Mike Mangini (Dream Theater) — Uses double-paradiddle-based sticking to build odd-time fills that shift against the underlying pulse — /drummer/mike-mangini
...
- **Sticks:** Practice sticks with rubber tips — Quiet repetition for isolating the closing double-stroke bounce at the end of the six-note phrase
...
- **Open Double Stroke Roll:** Slow, fully articulated RRLL strokes with clear separation between each note
- **Closed (Long) Roll:** Fast, tightly bounced double strokes blending into a sustained roll sound
- **Five/Six/Seven Stroke Roll:** Double-stroke-based roll rudiments capped with a single accented stroke
- **Double Stroke to Buzz Roll:** Progressively adding bounce pressure to turn controlled doubles into a multiple-bounce buzz roll
...
- **Single Drag Tap:** A single drag (two grace notes plus an accent) followed by an additional tap, forming a four-note phrase
- **Double Drag Tap:** Two consecutive drags followed by a final tap, extending the figure for longer accented passages
- **Drag Paradiddle:** A paradiddle sticking with a drag added before the first note, blending ornament and sticking pattern
- **Lesson 25:** A classic drum-corps exercise built almost entirely from single drag taps, used to build drag speed and consistency
...
- **Sticks:** Vic Firth American Classic 5A — Balanced rebound makes the quick double-bounce grace notes easier to control
- **Sticks:** Practice sticks with rubber tips — Quiet, low-fatigue repetition for isolating the soft grace-note bounce
...
- **Open Five Stroke Roll:** Slow, fully articulated RRLLR with clear separation between each of the five notes
- **Closed (Fast) Five Stroke Roll:** Tightly bounced doubles compressed toward a single roll sound, resolving on the accent
- **Mirrored Five Stroke Roll:** LLRRL version practiced equally so the roll can resolve from either leading hand
- **Accented Fill Five Stroke Roll:** The roll applied across snare and toms as a compact fill that resolves back into the groove
...
- **Single Flam Tap:** The base pattern - one flam and one tap per hand, alternating sides in a steady pulse
- **Flam Tap Fill:** The rudiment spread across snare and toms so each accented flam lands on a different drum
- **Double Flam Tap:** Two consecutive flam-tap pairs on the same hand before switching, used for longer accent groupings
- **Flam Tap into Flammed Paradiddle:** Transitioning flam tap phrasing directly into a flammed paradiddle for extended flam-based vocabulary

### Masters

- Mike Mangini (Dream Theater) — Applies flam-tap-based phrasing within drum-corps-rooted fills to add weight to specific notes — /drummer/mike-mangini
...
- **Sticks:** Practice sticks with rubber tips — Quiet, controlled repetition for isolating flam spacing and tap volume
...
- **Flam:** A single grace note plus main note struck almost simultaneously for a fat accent
- **Flam Tap:** A flam followed by a tap on the same hand, common in fill vocabulary
- **Flammed Paradiddle:** A paradiddle with a flam added to the accented strokes for extra weight
- **Flam Fill:** Flams applied across the toms for a fat, powerful fill sound
...
**Difficulty:** intermediate | **BPM range:** 120-220 BPM | **Category:** foundational
...
- **Single Foot Gallop:** The full long-short-short pattern played entirely on one bass drum pedal, as popularized by Nicko McBrain
- **Double Pedal Gallop:** The same rhythmic cell split across two feet on a double pedal to reduce single-foot workload
- **Thrash Gallop:** A faster, denser variation driving rapid palm-muted riffing in thrash metal
- **Hand-Foot Gallop:** The long note played on a cymbal or snare while the two short notes stay on the bass drum
...
- **Pedals:** Tama Iron Cobra 900 — Reliable single-pedal response for driving a full gallop pattern with one foot
- **Pedals:** Pearl Demon Drive — Direct-drive feel that keeps the two short notes of the gallop even at speed
...
- Chris Turner (Oceans Ate Alaska) — Weaves dense ghost-note patterns beneath polyrhythmic hand parts — /drummer/chris-turner
...
- **Snares:** Tama S.L.P. G-Maple — Sensitive head response for ghost note articulation
...
- **Snares:** High-tension snare heads — More bounce = better gravity blast response
- **Snares:** Shallow snares (5" or less) — Faster response and easier stick control
...
- Vinnie Paul (Pantera) — The godfather of groove metal — /drummer/vinnie-paul
- Chris Adler (Lamb of God) — Technical groove pioneer — /drummer/chris-adler
- Mario Duplantier (Gojira) — Heavy groove with environmental themes — /drummer/mario-duplantier
...
- **Drums:** Pearl Reference — Big low end for heavy grooves
- **Cymbals:** Sabian HHX — Dark wash without overwhelming the groove
- **Cymbals:** Meinl Byzance Dark — Complex without being distracting
...
- Tomas Haake (Meshuggah) — Polymetric limb independence defines Meshuggah's rhythmic identity — /drummer/tomas-haake
...
- **Full Heel-Toe:** Continuous heel-toe strokes on one foot for sustained, doubled-speed passages
- **Burst Heel-Toe:** Heel-toe strokes used only for short bursts of extra speed within an otherwise heel-up pattern
- **Double Pedal Heel-Toe:** Heel-toe applied to both feet on a double pedal for maximal sustained double bass output
- **Heel-Toe with Swivel:** Combining heel-toe rocking with ankle swivel rotation for even more strokes per motion
...
- **Four-Limb Linear:** All four limbs playing in sequence
- **Hand-Foot Linear:** Alternating between hands and feet
- **Linear Fills:** Fills with no overlapping strokes
- **Displaced Linear:** Linear patterns starting on different beats
...
- **Cymbals:** Dry cymbals — Quick decay allows linear patterns to speak
...
- **Tom Cascades:** Descending patterns across toms
- **Single Stroke Rolls:** Rapid alternating strokes for intensity
- **Paradiddle Fills:** Using paradiddle sticking around the kit
- **Flam Fills:** Flams on toms for fat, powerful sound
- **Blast Fill:** Brief blast beat used as fill
- **Linear Fills:** Non-overlapping hand and foot patterns

### Masters

- Dave Lombardo (Slayer) — Explosive thrash fills — /drummer/dave-lombardo
- Brann Dailor (Mastodon) — Complex melodic fills — /drummer/brann-dailor
- Mike Portnoy (Dream Theater) — Technical precision — /drummer/mike-portnoy
...
- **Toms:** Medium heads — Balance of attack and tone
...
- **Full Moeller Whip:** Complete down-up-tap motion generating multiple distinct strokes from one arm movement
- **Moeller for Feet:** Ankle-driven whip motion applied to double bass pedal work for sustained speed
- **Accented Moeller:** Using the whip's natural accent on the downstroke to build dynamic phrasing into fills
- **Moeller-Assisted Blast Beat:** Whip motion applied to single-stroke blast patterns for endurance over raw top speed
...
- **Sticks:** Vic Firth American Classic 5A — Balanced weight lets the whip motion and rebound do the work
...
- **Electronics:** DAW with click track — Program complex meter changes
...
**Difficulty:** advanced | **BPM range:** 200+ notes per minute | **Category:** extreme
...
- **Push-Pull:** Down stroke + upward flip for two notes per hand motion
- **Finger Control:** Using fingers to create bounce for rapid strokes
- **Moeller Technique:** Whipping motion that generates multiple strokes
- **Gravity Blast Application:** One-handed roll combined with surface bounce
...
- **Single Paradiddle:** The base RLRR LRLL pattern combining two singles and one double per hand
- **Double Paradiddle:** A six-note extension (RLRLRR LRLRLL) used for longer accent groupings
- **Paradiddle-Diddle:** A six-note pattern (RLRRLL) stacking two doubles after the initial singles
- **Linear Paradiddle:** Paradiddle sticking split between hands and feet so no limb repeats consecutively
...
- **Sticks:** Vic Firth American Classic 5A — Balanced weight helps keep the paradiddle's single and double strokes even
- **Sticks:** Practice sticks with rubber tips — Quiet repetition for isolating the "diddle" bounce without excess noise
...
- **Standard Paradiddle-Diddle:** The base six-note pattern (RLRRLL) combining a single pair with two closing doubles
- **Reverse Paradiddle-Diddle:** Sticking starts on the double-stroke portion before resolving into the single pair
- **Double Paradiddle-Diddle:** An eight-note extension adding an extra pair of singles before the two closing doubles
- **Linear Paradiddle-Diddle:** The six-note sticking split between hands and feet so no limb repeats consecutively
...
- **Sticks:** Vic Firth American Classic 5A — Balanced weight keeps the closing double strokes even with the opening single-stroke pair
...
- Tomas Haake (Meshuggah) — Master of complex polymetric patterns — /drummer/tomas-haake
- Danny Carey (Tool) — Incorporates Eastern rhythmic concepts — /drummer/danny-carey
- Mario Duplantier (Gojira) — Groove-focused polyrhythms — /drummer/mario-duplantier
- Matt Halpern (Periphery) — Djent-style polyrhythmic patterns — /drummer/matt-halpern
...
- **Electronics:** Loop pedal — Record one pattern, play another over it
...
- Mike Mangini (Dream Theater) — Drum corps background makes him the most rudiment-centric player in progressive metal — /drummer/mike-mangini
...
- **Sticks:** Practice sticks with rubber tips — Reduce bounce noise for quiet rudiment practice
...
- **Open Seven Stroke Roll:** Slow, fully articulated RRLLRRL with clear separation across all seven notes
- **Closed (Fast) Seven Stroke Roll:** Tightly bounced doubles compressed into a sustained roll sound, resolving on the accent
- **Mirrored Seven Stroke Roll:** LLRRLLR version practiced equally so the roll can resolve starting from either hand
- **Extended Fill Seven Stroke Roll:** The roll spread across snare and toms as a longer fill that still resolves precisely on the downbeat
...
- **Sticks:** Vic Firth American Classic 5A — Balanced rebound sustains control across the three double strokes before the final accent
...
- **Open Single Stroke Roll:** Slow, fully controlled alternating strokes used for building foundational evenness
- **Closed (Speed) Single Stroke Roll:** Tight, high-speed alternating strokes pushed toward maximum sustainable tempo
- **Single Stroke Four/Seven:** Single-stroke pattern grouped into fours or sevens for accent and phrasing practice
- **Hand-to-Foot Single Strokes:** Alternating strokes split between a hand and a foot, the building block of blast beat technique

### Masters

- Pete Sandoval (Morbid Angel) — Built the pioneering "hyper blast" on relentless single-stroke alternation between hands and feet — /drummer/pete-sandoval
...
- **Sticks:** Practice sticks with rubber tips — Quiet, low-fatigue repetition for building single-stroke speed
...
- **Open Six Stroke Roll:** Slow, fully articulated RLLRRL with clear separation between the single and double strokes
- **Closed (Fast) Six Stroke Roll:** Tightly bounced doubles compressed toward a single roll sound, bookended by clear single strokes
- **Mirrored Six Stroke Roll:** LRRLLR version practiced equally so the roll can start and resolve from either leading hand
- **Six Stroke Roll Fill:** The roll applied across snare and toms as a compact fill that resolves back onto the starting hand for a clean groove re-entry
...
- **Sticks:** Vic Firth American Classic 5A — Balanced rebound helps switch cleanly between the struck singles and bounced doubles in the pattern
...
**Difficulty:** intermediate | **BPM range:** Any | **Category:** production
...
Electronic triggers emerged in the 1980s with pioneers like Bill Bruford and Neil Peart using them for hybrid kits. In metal, triggered drums became standard in death metal by the mid-1990s as tempo demands exceeded what acoustic drums could reliably deliver. Bands like Fear Factory and Meshuggah embraced the mechanical precision of triggered sounds. Today, most touring metal bands use triggers, though the art lies in maintaining organic feel while gaining consistency.
...
- **Full Replacement:** Triggered sample fully replaces acoustic sound
- **Layered/Blended:** Triggered sample added to acoustic for enhancement
- **Multi-Zone:** Different samples for different hit locations
- **Velocity Sensitive:** Sample changes with hit intensity

### Masters

- Tomas Haake (Meshuggah) — Pioneered triggered precision in metal — /drummer/tomas-haake
- Gene Hoglan (Death/Testament) — Uses triggers while maintaining dynamic feel — /drummer/gene-hoglan
...
- **Triggers:** Roland RT-30K — Industry standard kick trigger
- **Triggers:** ddrum Acoustic Pro — Great for snare triggering
- **Triggers:** Triggera Krigg — Premium precision triggering
- **Modules:** Roland TM-2 — Compact, reliable, industry standard
- **Modules:** ddrum DDTi — Cost-effective with good features
- **Modules:** Roland TD-27 — Full-featured for complex setups
