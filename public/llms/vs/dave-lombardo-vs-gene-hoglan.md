# Dave Lombardo vs Gene Hoglan — Drum Kit Comparison

> Side-by-side gear comparison between Dave Lombardo (Slayer) and Gene Hoglan (Death / Testament / Dethklok).
...
Dave pioneered thrash metal drumming with relentless aggression and speed. Gene brought scientific precision to death metal with inhuman timing.

## Technique

Dave revolutionized double bass speed and blast beats in thrash. Gene invented the gravity blast and is known for impossibly tight timing.
...
Dave defined the Slayer sound that influenced all of extreme metal. Gene has been the backbone of Death, Testament, and countless legendary bands.

## Verdict

Two drummers who defined extreme metal drumming. Dave Lombardo is thrash metal royalty. Gene Hoglan is "The Atomic Clock." Together they represent the pinnacle of speed and precision.
...
**Q: What cymbals do Dave Lombardo and Gene Hoglan use?**
A: Dave Lombardo uses Paiste RUDE & 2002 Series (15" Sound Edge Hi-Hats, 18" & 19" Crashes, 22" Reign Power Ride, 18" China). Gene Hoglan uses Sabian AAX Series (15" Hi-Hats, 18" & 20" Crashes, 22" Ride, 20" China).

---

*Full comparison: [metalforge.io/vs/dave-lombardo-vs-gene-hoglan](https://metalforge.io/vs/dave-lombardo-vs-gene-hoglan)*
