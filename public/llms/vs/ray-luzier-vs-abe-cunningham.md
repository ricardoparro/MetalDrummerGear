# Ray Luzier vs Abe Cunningham — Drum Kit Comparison

> Side-by-side gear comparison between Ray Luzier (Korn) and Abe Cunningham (Deftones).
...
Ray brings session musician precision to Korn's heavy grooves. Abe delivers atmospheric, dynamic playing with emotional depth.

## Technique

Ray excels at tight, syncopated patterns with David Silveria's legacy. Abe masters dynamics and textural playing.
...
Ray maintains Korn's classic sound while adding technical flair. Abe helped define the Deftones' atmospheric metal approach.

## Verdict

Ray Luzier honors and evolves Korn's signature sound. Abe Cunningham pioneered atmospheric metal drumming. Both define alternative metal's evolution.
...
**Q: What cymbals do Ray Luzier and Abe Cunningham use?**
A: Ray Luzier uses Sabian AAX Series (14" Stage Hi-Hats, 18" & 19" X-Plosion Crashes, 21" Stage Ride, 18" AAXtreme China). Abe Cunningham uses Zildjian K Custom & A Custom Series (14" K Custom Hi-Hats, 18" & 20" K Custom Crashes, 22" K Custom Ride, 19" A Custom China).

---

*Full comparison: [metalforge.io/vs/ray-luzier-vs-abe-cunningham](https://metalforge.io/vs/ray-luzier-vs-abe-cunningham)*
