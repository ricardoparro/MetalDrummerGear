# Sean Reinert vs Martin Lopez — Drum Kit Comparison

> Side-by-side gear comparison between Sean Reinert (Death / Cynic) and Martin Lopez (Soen / ex-Opeth).
...
*Full comparison: [metalforge.io/vs/sean-reinert-vs-martin-lopez](https://metalforge.io/vs/sean-reinert-vs-martin-lopez)*
