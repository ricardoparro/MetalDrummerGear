...
// Issue #4737: link the /llms/snares/brands/<slug>.md files (generated by
// generate-llms-snares-brands.cjs) from this hub — those 6 files existed on
...
lines.push('');
lines.push('## How to Choose a Snare');
lines.push('');
...
lines.push('');
lines.push(`## Brand Pages (${SNARE_BRANDS.length})`);
lines.push('');
for (const brand of SNARE_BRANDS) {
  lines.push(`- [${brand.name}](${BASE}/llms/snares/brands/${brand.slug}.md) — ${brand.positioning}`);
}
lines.push('');
